...
template <typename NCT> struct PrivateAccumulatedDataFinal {
    ...
    PrivateAccumulatedDataFinal<CircuitTypes<Builder>> to_circuit_type(Builder& builder) const
    {
        ...
        PrivateAccumulatedDataFinal<CT> acc_data = {
    ...
    template <typename Builder> PrivateAccumulatedDataFinal<NativeTypes> to_native_type() const
    {
        static_assert(std::is_same<CircuitTypes<Builder>, NCT>::value);
        auto to_nt = [&](auto& e) { return aztec3::utils::types::to_nt<Builder>(e); };
        auto to_native_type = []<typename T>(T& e) { return e.template to_native_type<Builder>(); };

        PrivateAccumulatedDataFinal<NativeTypes> acc_data = {
