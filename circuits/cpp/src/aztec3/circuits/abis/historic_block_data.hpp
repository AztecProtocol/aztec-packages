...
template <typename NCT> struct HistoricalBlockData {
    ...
    boolean operator==(HistoricalBlockData<NCT> const& other) const
    {
    ...
    template <typename Builder> HistoricalBlockData<CircuitTypes<Builder>> to_circuit_type(Builder& builder) const
    {
        ...
        HistoricalBlockData<CircuitTypes<Builder>> data = {
    ...
    template <typename Builder> HistoricalBlockData<NativeTypes> to_native_type() const
    {
        static_assert(std::is_same<CircuitTypes<Builder>, NCT>::value);
        auto to_nt = [&](auto& e) { return aztec3::utils::types::to_nt<Builder>(e); };

        HistoricalBlockData<NativeTypes> data = {
