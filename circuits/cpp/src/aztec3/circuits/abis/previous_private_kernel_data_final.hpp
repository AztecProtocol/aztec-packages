...
template <typename NCT> struct PreviousPrivateKernelDataFinal {
    using fr = typename NCT::fr;
    using boolean = typename NCT::boolean;
    using VK = typename NCT::VK;
    using uint32 = typename NCT::uint32;

    PrivateKernelPublicInputsFinal<NCT> public_inputs{};  // TODO: not needed as already contained in proof?
    ...
    boolean operator==(PreviousPrivateKernelDataFinal<NCT> const& other) const
    {
    ...
    PreviousPrivateKernelDataFinal<CircuitTypes<Builder>> to_circuit_type(Builder& builder) const
    {
        ...
        PreviousPrivateKernelDataFinal<CircuitTypes<Builder>> data = {
