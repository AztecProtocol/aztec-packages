...
template <typename NCT> class PrivateCircuitPublicInputs {
  ...
  public:
    ...
    std::array<fr, NEW_L2_TO_L1_MSGS_LENGTH> l2_to_l1_msgs = zero_array<fr, NEW_L2_TO_L1_MSGS_LENGTH>();
    ...
    fr hash() const
    {
        ...
        spread_arr_into_vec(l2_to_l1_msgs, inputs);
...

{
    ...
    return os << "call_context: " << pis.call_context << "\n"
              ...
              << "l2_to_l1_msgs: " << pis.l2_to_l1_msgs << "\n"
...
template <typename NCT> class OptionalPrivateCircuitPublicInputs {
  ...
  public:
    ...
    std::array<opt_fr, NEW_L2_TO_L1_MSGS_LENGTH> l2_to_l1_msgs;
    ...
    OptionalPrivateCircuitPublicInputs<NCT>(std::optional<CallContext<NCT>> const& call_context,
                                            ...
                                            std::array<opt_fr, NEW_L2_TO_L1_MSGS_LENGTH> const& l2_to_l1_msgs,
    ...
    static OptionalPrivateCircuitPublicInputs<NCT> create()
    {
        ...
        new_inputs.l2_to_l1_msgs.fill(std::nullopt);
    ...
    template <typename Composer> void make_unused_inputs_zero(Composer& composer)
    {
        ...
        make_unused_array_elements_zero(composer, l2_to_l1_msgs);
    ...
    fr hash() const
    {
        ...
        spread_arr_opt_into_vec(l2_to_l1_msgs, inputs);
    ...
    PrivateCircuitPublicInputs<NCT> remove_optionality() const
    {
        ...
        return PrivateCircuitPublicInputs<NCT>{
            ...
            .l2_to_l1_msgs = map(l2_to_l1_msgs, get_value),
