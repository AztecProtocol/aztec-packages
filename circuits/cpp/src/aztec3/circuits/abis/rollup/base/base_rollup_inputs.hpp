...
template <typename NCT> struct BaseRollupInputs {
    ...
    std::array<std::array<fr, PUBLIC_DATA_TREE_HEIGHT>, 2 * STATE_TRANSITIONS_LENGTH>
        new_state_transitions_sibling_paths;
    std::array<std::array<fr, PUBLIC_DATA_TREE_HEIGHT>, 2 * STATE_READS_LENGTH> new_state_reads_sibling_paths;
