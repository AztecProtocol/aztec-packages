...
template <typename NCT> struct BaseRollupInputs {
    ...
    AppendOnlyTreeSnapshot<NCT> start_historical_blocks_tree_snapshot{};
    ...
    std::array<MembershipWitness<NCT, HISTORICAL_BLOCKS_TREE_HEIGHT>, KERNELS_PER_BASE_ROLLUP>
        historical_blocks_tree_root_membership_witnesses{};
    ...
    MSGPACK_FIELDS(kernel_data,
                   ...
                   start_historical_blocks_tree_snapshot,
