...
template <typename NCT> struct RootRollupPublicInputs {
    ...
    AppendOnlyTreeSnapshot<NCT> end_historical_blocks_tree_snapshot{};
    ...
    MSGPACK_FIELDS(end_aggregation_object,
                   ...
                   end_historical_blocks_tree_snapshot,
                   calldata_hash,
    ...
    fr hash() const
    {
        ...
        write(buf, start_historical_blocks_tree_snapshot);
        ...
        write(buf, end_historical_blocks_tree_snapshot);
