...
//  * @details The purpose of this test is to check the private kernel circuit given a valid app proof and a valid
//  previous
//  * private kernel proof. To avoid doing actual proof construction, we simply read in an arbitrary but valid proof and
//  a
//  * corresponding valid verification key from file. The same proof and vkey data is used for both the app and the
//  * previous kernel.
//  * @note The choice of app circuit (currently 'deposit') is entirely arbitrary and can be replaced with any other
//  valid
//  * app circuit.
//  */
