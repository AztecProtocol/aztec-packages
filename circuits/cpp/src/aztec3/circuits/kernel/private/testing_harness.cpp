    ...
    bool is_circuit)
{
    ...
    if (is_circuit) {
        ...
        private_circuit_public_inputs.historical_block_data.contract_tree_root = contract_tree_root;
        ...
        private_circuit_public_inputs = PrivateCircuitPublicInputs<NT>{
            ...
            .historical_block_data = HistoricalBlockData<NT>{ .contract_tree_root = contract_tree_root },
    ...
    bool is_circuit)
{
    ...
    mock_previous_kernel.public_inputs.constants = CombinedConstantData<NT>{
        .block_data =
            HistoricalBlockData<NT>{
                .note_hash_tree_root = private_circuit_public_inputs.historical_block_data.note_hash_tree_root,
                .contract_tree_root = private_circuit_public_inputs.historical_block_data.contract_tree_root,
            },
