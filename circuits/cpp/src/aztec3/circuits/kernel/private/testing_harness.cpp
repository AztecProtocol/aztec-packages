    ...
    bool is_circuit)
{
    ...
    const NT::fr private_circuit_vk_hash =
        stdlib::recursion::verification_key<CT::bn254>::hash_native(private_circuit_vk, GeneratorIndex::VK);
                                        ...
                                        KernelCircuitPublicInputs<NT> const& public_inputs)
{
    ...
    auto private_circuit_vk_hash =
        stdlib::recursion::verification_key<CT::bn254>::hash_native(private_inputs.private_call.vk, GeneratorIndex::VK);
