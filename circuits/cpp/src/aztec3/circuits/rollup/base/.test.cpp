...
{
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_no_new_contract_leafs");
...
{
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_contract_leaf_inserted");
...
{
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_contract_leaf_inserted_in_non_empty_snapshot_tree");
...
{
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_new_commitments_tree");
...
TEST_F(base_rollup_tests, native_new_nullifier_tree_empty)
{
     ...
     * RUN
     */
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_new_nullifier_tree_empty");
...
void nullifier_insertion_test(std::array<fr, KERNEL_NEW_NULLIFIERS_LENGTH * 2> new_nullifiers)
{
    ...
    DummyBuilder composer = DummyBuilder("base_rollup_tests__nullifier_insertion_test");
    std::array<PreviousKernelData<NT>, 2> kernel_data = { get_empty_kernel(), get_empty_kernel() };
    for (uint8_t i = 0; i < 2; i++) {
...
TEST_F(base_rollup_tests, native_new_nullifier_tree_sparse)
{
    ...
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_new_nullifier_tree_sparse");
...
TEST_F(base_rollup_tests, native_new_nullifier_tree_double_spend)
{
    ...
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_new_nullifier_tree_double_spend");
    BaseRollupInputs const empty_inputs = base_rollup_inputs_from_kernels({ get_empty_kernel(), get_empty_kernel() });
...
{
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_empty_block_calldata_hash");
...
TEST_F(base_rollup_tests, native_calldata_hash)
{
    ...
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_calldata_hash");
    BaseRollupInputs inputs = base_rollup_inputs_from_kernels(kernel_data);
    BaseOrMergeRollupPublicInputs outputs =
        aztec3::circuits::rollup::native_base_rollup::base_rollup_circuit(composer, inputs);
...
TEST_F(base_rollup_tests, native_compute_membership_historic_private_data_negative)
{
    ...
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_compute_membership_historic_private_data_negative");
    std::array<PreviousKernelData<NT>, 2> const kernel_data = { get_empty_kernel(), get_empty_kernel() };
    BaseRollupInputs inputs = base_rollup_inputs_from_kernels(kernel_data);
...
TEST_F(base_rollup_tests, native_compute_membership_historic_contract_tree_negative)
{
    ...
    DummyBuilder composer =
        DummyBuilder("base_rollup_tests__native_compute_membership_historic_contract_tree_negative");
    std::array<PreviousKernelData<NT>, 2> const kernel_data = { get_empty_kernel(), get_empty_kernel() };
    BaseRollupInputs inputs = base_rollup_inputs_from_kernels(kernel_data);
...
{
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_constants_dont_change");
    BaseRollupInputs inputs = base_rollup_inputs_from_kernels({ get_empty_kernel(), get_empty_kernel() });
    BaseOrMergeRollupPublicInputs outputs =
        aztec3::circuits::rollup::native_base_rollup::base_rollup_circuit(composer, inputs);
...
TEST_F(base_rollup_tests, native_aggregate)
{
    ...
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_aggregate");
    BaseRollupInputs inputs = base_rollup_inputs_from_kernels({ get_empty_kernel(), get_empty_kernel() });
    BaseOrMergeRollupPublicInputs const outputs =
        aztec3::circuits::rollup::native_base_rollup::base_rollup_circuit(composer, inputs);
...
{
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_subtree_height_is_0");
...
{
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_single_public_state_write");
    native_base_rollup::MerkleTree private_data_tree(PRIVATE_DATA_TREE_HEIGHT);
    native_base_rollup::MerkleTree contract_tree(CONTRACT_TREE_HEIGHT);
    stdlib::merkle_tree::MemoryStore public_data_tree_store;
    native_base_rollup::SparseTree public_data_tree(public_data_tree_store, PUBLIC_DATA_TREE_HEIGHT);
...
{
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_multiple_public_state_read_writes");
    native_base_rollup::MerkleTree private_data_tree(PRIVATE_DATA_TREE_HEIGHT);
    native_base_rollup::MerkleTree contract_tree(CONTRACT_TREE_HEIGHT);
    stdlib::merkle_tree::MemoryStore public_data_tree_store;
    native_base_rollup::SparseTree public_data_tree(public_data_tree_store, PUBLIC_DATA_TREE_HEIGHT);
...
{
    DummyBuilder composer = DummyBuilder("base_rollup_tests__native_invalid_public_state_read");
    native_base_rollup::MerkleTree private_data_tree(PRIVATE_DATA_TREE_HEIGHT);
    native_base_rollup::MerkleTree contract_tree(CONTRACT_TREE_HEIGHT);
    stdlib::merkle_tree::MemoryStore public_data_tree_store;
    native_base_rollup::SparseTree public_data_tree(public_data_tree_store, PUBLIC_DATA_TREE_HEIGHT);
