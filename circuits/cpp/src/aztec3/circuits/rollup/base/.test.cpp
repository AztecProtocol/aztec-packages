...
{
    DummyBuilder builder{ "base_rollup_tests__native_no_new_contract_leafs" };
...
{
    DummyBuilder builder{ "base_rollup_tests__native_contract_leaf_inserted" };
...
{
    DummyBuilder builder{ "base_rollup_tests__native_contract_leaf_inserted_in_non_empty_snapshot_tree" };
...
{
    DummyBuilder builder{ "base_rollup_tests__native_new_commitments_tree" };
...
TEST_F(base_rollup_tests, native_new_nullifier_tree_empty)
{
     ...
     * RUN
     */
    DummyBuilder builder{ "base_rollup_tests__native_new_nullifier_tree_empty" };
...
void nullifier_insertion_test(std::array<fr, MAX_NEW_NULLIFIERS_PER_TX * 2> new_nullifiers)
{
    ...
    DummyBuilder builder{ "base_rollup_tests__nullifier_insertion_test" };
    std::array<PreviousKernelData<NT>, 2> kernel_data = { get_empty_kernel(), get_empty_kernel() };
    for (uint8_t i = 0; i < 2; i++) {
...
TEST_F(base_rollup_tests, native_new_nullifier_tree_sparse)
{
    ...
    DummyBuilder builder{ "base_rollup_tests__native_new_nullifier_tree_sparse" };
...
{
    // Regression test caught when testing the typescript nullifier tree implementation
    DummyBuilder builder{ "base_rollup_tests__native_nullifier_tree_regression" };
...
TEST_F(base_rollup_tests, native_new_nullifier_tree_double_spend)
{
    ...
    DummyBuilder builder{ "base_rollup_tests__native_new_nullifier_tree_double_spend" };
    BaseRollupInputs const empty_inputs = base_rollup_inputs_from_kernels({ get_empty_kernel(), get_empty_kernel() });
...
{
    DummyBuilder builder{ "base_rollup_tests__native_empty_block_calldata_hash" };
...
TEST_F(base_rollup_tests, native_calldata_hash)
{
    ...
    DummyBuilder builder{ "base_rollup_tests__native_calldata_hash" };
    BaseRollupInputs inputs = base_rollup_inputs_from_kernels(kernel_data);
    BaseOrMergeRollupPublicInputs outputs =
        aztec3::circuits::rollup::native_base_rollup::base_rollup_circuit(builder, inputs);
...
TEST_F(base_rollup_tests, native_compute_membership_historic_private_data_negative)
{
    ...
    DummyBuilder builder{ "base_rollup_tests__native_compute_membership_historic_private_data_negative" };
    std::array<PreviousKernelData<NT>, 2> const kernel_data = { get_empty_kernel(), get_empty_kernel() };
    BaseRollupInputs inputs = base_rollup_inputs_from_kernels(kernel_data);
...
{
    // Test membership works for empty trees
    DummyBuilder builder{ "base_rollup_tests__native_compute_membership_historic_contract_tree_negative" };
    std::array<PreviousKernelData<NT>, 2> const kernel_data = { get_empty_kernel(), get_empty_kernel() };
    BaseRollupInputs inputs = base_rollup_inputs_from_kernels(kernel_data);
...
{
    DummyBuilder builder{ "base_rollup_tests__native_constants_dont_change" };
    BaseRollupInputs inputs = base_rollup_inputs_from_kernels({ get_empty_kernel(), get_empty_kernel() });
    BaseOrMergeRollupPublicInputs outputs =
        aztec3::circuits::rollup::native_base_rollup::base_rollup_circuit(builder, inputs);
...
TEST_F(base_rollup_tests, native_aggregate)
{
    ...
    DummyBuilder builder{ "base_rollup_tests__native_aggregate" };
    BaseRollupInputs inputs = base_rollup_inputs_from_kernels({ get_empty_kernel(), get_empty_kernel() });
    BaseOrMergeRollupPublicInputs const outputs =
        aztec3::circuits::rollup::native_base_rollup::base_rollup_circuit(builder, inputs);
...
{
    DummyBuilder builder{ "base_rollup_tests__native_subtree_height_is_0" };
...
{
    DummyBuilder builder{ "base_rollup_tests__native_single_public_state_read" };
    MemoryStore private_data_tree_store;
...
{
    DummyBuilder builder{ "base_rollup_tests__native_single_public_state_write" };
    MemoryStore private_data_tree_store;
    MerkleTree private_data_tree(private_data_tree_store, PRIVATE_DATA_TREE_HEIGHT);
...
{
    DummyBuilder builder{ "base_rollup_tests__native_multiple_public_state_read_writes" };
    MemoryStore private_data_tree_store;
    MerkleTree private_data_tree(private_data_tree_store, PRIVATE_DATA_TREE_HEIGHT);
...
{
    DummyBuilder builder{ "base_rollup_tests__native_invalid_public_state_read" };
    MemoryStore private_data_tree_store;
    MerkleTree private_data_tree(private_data_tree_store, PRIVATE_DATA_TREE_HEIGHT);
