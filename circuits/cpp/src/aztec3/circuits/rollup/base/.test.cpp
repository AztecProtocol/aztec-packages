...
#include <aztec3/circuits/abis/combined_old_tree_roots.hpp>
...
TEST_F(base_rollup_tests, test_compute_membership_historic_private_data)
{
    ...
    inputs.kernel_data[0].public_inputs.constants.old_tree_roots.private_old_tree_roots.private_data_tree_root = fr(0);
