...
void perform_historical_blocks_tree_membership_checks(DummyBuilder& builder, BaseRollupInputs const& baseRollupInputs)
{
    ...
    auto historical_root = baseRollupInputs.constants.start_historical_blocks_tree_roots_snapshot.root;
    ...
    for (size_t i = 0; i < 2; i++) {
        ...
        abis::MembershipWitness<NT, HISTORICAL_BLOCKS_TREE_HEIGHT> const historical_root_witness =
            baseRollupInputs.historical_blocks_tree_root_membership_witnesses[i];
