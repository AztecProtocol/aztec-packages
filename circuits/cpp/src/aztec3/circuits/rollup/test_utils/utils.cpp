                                                 ...
                                                 MerkleTree& l1_to_l2_msg_tree)
{
    ...
    MemoryStore historical_blocks_tree_store;
    MerkleTree historical_blocks_tree = MerkleTree(historical_blocks_tree_store, HISTORICAL_BLOCKS_TREE_HEIGHT);
    ...
    // create the original historical blocks tree leaf
    ...
    historical_blocks_tree.update_element(0, block_hash);

    ConstantRollupData const constantRollupData = { .start_historical_blocks_tree_roots_snapshot = {
                                                        .root = historical_blocks_tree.root(),
    ...
    baseRollupInputs.historical_blocks_tree_root_membership_witnesses[0] = {
        .leaf_index = 0,
        .sibling_path = get_sibling_path<HISTORICAL_BLOCKS_TREE_HEIGHT>(historical_blocks_tree, 0, 0),
    };
    baseRollupInputs.historical_blocks_tree_root_membership_witnesses[1] =
        baseRollupInputs.historical_blocks_tree_root_membership_witnesses[0];
                                        ...
                                        std::array<fr, NUMBER_OF_L1_L2_MESSAGES_PER_ROLLUP> l1_to_l2_messages)
{
    ...
    MemoryStore historical_blocks_tree_store;
    MerkleTree historical_blocks_tree(historical_blocks_tree_store, HISTORICAL_BLOCKS_TREE_HEIGHT);
    ...
    AppendOnlyTreeSnapshot const start_historical_blocks_tree_snapshot = {
        .root = historical_blocks_tree.root(),
        .next_available_leaf_index = 1,
    };

    // Blocks tree
    auto blocks_tree_sibling_path = get_sibling_path<HISTORICAL_BLOCKS_TREE_HEIGHT>(historical_blocks_tree, 1, 0);
    ...
    RootRollupInputs rootRollupInputs = {
        ...
        .start_historical_blocks_tree_snapshot = start_historical_blocks_tree_snapshot,
        .new_historical_blocks_tree_sibling_path = blocks_tree_sibling_path,
    };
