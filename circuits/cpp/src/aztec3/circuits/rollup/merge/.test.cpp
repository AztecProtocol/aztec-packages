...
{
    DummyBuilder composer = DummyBuilder("merge_rollup_tests__native_different_rollup_type_fails");
...
{
    DummyBuilder composer = DummyBuilder("merge_rollup_tests__native_different_rollup_height_fails");
    std::array<KernelData, 4> const kernels = {
        get_empty_kernel(), get_empty_kernel(), get_empty_kernel(), get_empty_kernel()
    };
    MergeRollupInputs mergeInput = get_merge_rollup_inputs(composer, kernels);
...
{
    DummyBuilder composer = DummyBuilder("merge_rollup_tests__native_constants_different_failure");
    std::array<KernelData, 4> const kernels = {
        get_empty_kernel(), get_empty_kernel(), get_empty_kernel(), get_empty_kernel()
    };
...
{
    DummyBuilder composerA = DummyBuilder("merge_rollup_tests__native_fail_if_previous_rollups_dont_follow_on_A");
    std::array<KernelData, 4> const kernels = {
        get_empty_kernel(), get_empty_kernel(), get_empty_kernel(), get_empty_kernel()
    };
    ...
    DummyBuilder composerC = DummyBuilder("merge_rollup_tests__native_fail_if_previous_rollups_dont_follow_on_C");
    auto inputC = inputs;
...
{
    DummyBuilder composer = DummyBuilder("merge_rollup_tests__native_rollup_fields_are_set_correctly");
    std::array<KernelData, 4> const kernels = {
        get_empty_kernel(), get_empty_kernel(), get_empty_kernel(), get_empty_kernel()
    };
    MergeRollupInputs inputs = get_merge_rollup_inputs(composer, kernels);
...
{
    DummyBuilder composer = DummyBuilder("merge_rollup_tests__native_start_and_end_snapshots");
    std::array<KernelData, 4> const kernels = {
        get_empty_kernel(), get_empty_kernel(), get_empty_kernel(), get_empty_kernel()
    };
    MergeRollupInputs inputs = get_merge_rollup_inputs(composer, kernels);
...
{
    DummyBuilder composer = DummyBuilder("merge_rollup_tests__native_calldata_hash");
...
{
    DummyBuilder composer = DummyBuilder("merge_rollup_tests__native_constants_dont_change");
    std::array<KernelData, 4> const kernels = {
        get_empty_kernel(), get_empty_kernel(), get_empty_kernel(), get_empty_kernel()
    };
    MergeRollupInputs inputs = get_merge_rollup_inputs(composer, kernels);
...
TEST_F(merge_rollup_tests, native_aggregate)
{
    ...
    DummyBuilder composer = DummyBuilder("merge_rollup_tests__native_aggregate");
    std::array<KernelData, 4> const kernels = {
        get_empty_kernel(), get_empty_kernel(), get_empty_kernel(), get_empty_kernel()
    };
    MergeRollupInputs inputs = get_merge_rollup_inputs(composer, kernels);
