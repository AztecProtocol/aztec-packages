...
RootRollupPublicInputs root_rollup_circuit(DummyBuilder& builder, RootRollupInputs const& rootRollupInputs)
{
    ...
    // Then insert the block into the historical blocks tree
    ...
    // Update the historical blocks tree
    auto end_historical_blocks_tree_snapshot = components::insert_subtree_to_snapshot_tree(
        builder,
        rootRollupInputs.start_historical_blocks_tree_snapshot,
        rootRollupInputs.new_historical_blocks_tree_sibling_path,
        fr::zero(),
        block_hash,
        0,
        format(ROOT_CIRCUIT_ERROR_MESSAGE_BEGINNING,
               "historical blocks tree roots not empty at location where subtree would be inserted"));
    ...
    RootRollupPublicInputs public_inputs = {
        ...
        .start_historical_blocks_tree_snapshot = rootRollupInputs.start_historical_blocks_tree_snapshot,
        .end_historical_blocks_tree_snapshot = end_historical_blocks_tree_snapshot,
