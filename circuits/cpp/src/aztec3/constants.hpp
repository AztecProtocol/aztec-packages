...
constexpr size_t MAX_KERNEL_PUBLIC_DATA_READS_PER_TX = 4;
...
constexpr size_t L1_TO_L2_MSG_SUBTREE_DEPTH = static_cast<size_t>(log2(NUMBER_OF_L1_L2_MESSAGES_PER_ROLLUP));
