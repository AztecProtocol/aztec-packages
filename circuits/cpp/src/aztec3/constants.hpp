...
constexpr size_t GET_NOTE_ORACLE_RETURN_LENGTH = READ_REQUESTS_LENGTH * MAX_NOTE_FIELDS_LENGTH + 2;
...
constexpr size_t PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH =
    CALL_CONTEXT_LENGTH + 1 + RETURN_VALUES_LENGTH + READ_REQUESTS_LENGTH + MAX_NEW_COMMITMENTS_PER_CALL +
    ...
    COMMITMENT_TREES_ROOTS_LENGTH + CONTRACT_DEPLOYMENT_DATA_LENGTH + 1 + 1;
...
// + COMMITMENT_TREES_ROOTS_LENGTH - 4
// + 2;
...
constexpr size_t PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH =
    ...
    COMMITMENT_TREES_ROOTS_LENGTH + 2;
