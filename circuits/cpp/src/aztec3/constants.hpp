...
constexpr size_t MAX_NEW_COMMITMENTS_PER_TX = PRIVATE_CALL_STACK_LENGTH * MAX_NEW_COMMITMENTS_PER_CALL;
constexpr size_t MAX_NEW_NULLIFIERS_PER_TX = PRIVATE_CALL_STACK_LENGTH * MAX_NEW_NULLIFIERS_PER_CALL;
...
constexpr size_t NULLIFIER_SUBTREE_DEPTH = static_cast<size_t>(log2(KERNELS_PER_ROLLUP * MAX_NEW_NULLIFIERS_PER_TX));
