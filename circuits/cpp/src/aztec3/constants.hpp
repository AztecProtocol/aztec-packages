...
constexpr size_t CONTRACT_STORAGE_UPDATE_REQUEST_SIZE = 3;
constexpr size_t CONTRACT_STORAGE_READ_SIZE = 2;

// CALL_CONTEXT_SIZE
// + ARGS_HASH
// + RETURN_VALUES_LENGTH
// + MAX_PUBLIC_DATA_UPDATE_REQUESTS_PER_CALL * CONTRACT_STORAGE_UPDATE_REQUEST_SIZE
// + MAX_PUBLIC_DATA_READS_PER_CALL * CONTRACT_STORAGE_READ_SIZE
...
constexpr size_t PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH =
    CALL_CONTEXT_SIZE + 1 + RETURN_VALUES_LENGTH +
    MAX_PUBLIC_DATA_UPDATE_REQUESTS_PER_CALL * CONTRACT_STORAGE_UPDATE_REQUEST_SIZE +
    MAX_PUBLIC_DATA_READS_PER_CALL * CONTRACT_STORAGE_READ_SIZE + MAX_PUBLIC_CALL_STACK_LENGTH_PER_CALL +
    MAX_NEW_COMMITMENTS_PER_CALL + MAX_NEW_NULLIFIERS_PER_CALL + MAX_NEW_L2_TO_L1_MSGS_PER_CALL +
    COMMITMENT_TREES_ROOTS_SIZE + 2;
