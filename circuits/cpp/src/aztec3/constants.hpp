...
constexpr size_t MAX_PUBLIC_DATA_WRITES_PER_CALL = 16;
...
constexpr size_t MAX_PUBLIC_DATA_WRITES_PER_TX = 16;
...
constexpr size_t MAX_NEW_NULLIFIERS_PER_BASE_ROLLUP = KERNELS_PER_BASE_ROLLUP * MAX_NEW_NULLIFIERS_PER_TX;
constexpr size_t NULLIFIERS_NUM_BYTES_PER_BASE_ROLLUP = MAX_NEW_NULLIFIERS_PER_BASE_ROLLUP * 32;
constexpr size_t MAX_PUBLIC_DATA_WRITES_PER_BASE_ROLLUP =
    KERNELS_PER_BASE_ROLLUP * MAX_PUBLIC_DATA_WRITES_PER_TX;
constexpr size_t PUBLIC_DATA_WRITES_NUM_BYTES_PER_BASE_ROLLUP =
    MAX_PUBLIC_DATA_WRITES_PER_BASE_ROLLUP * 64;  // old value, new value
constexpr size_t MAX_PUBLIC_DATA_READS_PER_BASE_ROLLUP = KERNELS_PER_BASE_ROLLUP * MAX_PUBLIC_DATA_READS_PER_TX;
...
static constexpr std::string generatorIndexDomain(GeneratorIndex idx)
{
    switch (idx) {
        ...
        case PUBLIC_DATA_WRITE:
            return "PUBLIC_DATA_WRITE";
        case FUNCTION_DATA:
...
constexpr size_t PRIVATE_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH =
    ...
    MAX_PUBLIC_CALL_STACK_LENGTH_PER_CALL + MAX_NEW_L2_TO_L1_MSGS_PER_CALL + NUM_FIELDS_PER_SHA256 +
    NUM_FIELDS_PER_SHA256 + 2   // + 2 for logs preimage lengths
    + BLOCK_HEADER_LENGTH + 3;  // + 3 for contract_deployment_data.hash(), chain_id, version

constexpr size_t STORAGE_WRITE_LENGTH = 3;
constexpr size_t STORAGE_READ_LENGTH = 2;
...
constexpr size_t PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH =
    ...
    MAX_PUBLIC_DATA_WRITES_PER_CALL * STORAGE_WRITE_LENGTH +
    MAX_PUBLIC_DATA_READS_PER_CALL * STORAGE_READ_LENGTH + MAX_PUBLIC_CALL_STACK_LENGTH_PER_CALL +
    ...
    BLOCK_HEADER_LENGTH + 2;     // + 2 for chain_id and version
...
constexpr size_t PUBLIC_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH =
    ...
    MAX_PUBLIC_DATA_WRITES_PER_CALL + MAX_PUBLIC_DATA_READS_PER_CALL + MAX_PUBLIC_CALL_STACK_LENGTH_PER_CALL +
    MAX_NEW_COMMITMENTS_PER_CALL + MAX_NEW_NULLIFIERS_PER_CALL + MAX_NEW_L2_TO_L1_MSGS_PER_CALL +
    NUM_FIELDS_PER_SHA256 +   // unencrypted_logs_hash (being represented by NUM_FIELDS_PER_SHA256)
    BLOCK_HEADER_LENGTH + 2;  // unencrypted_log_preimages_length + prover_address
