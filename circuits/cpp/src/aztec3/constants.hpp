...
constexpr size_t CALL_CONTEXT_LENGTH = 8;
...
constexpr size_t SIDE_EFFECT_LENGTH = 2;
constexpr size_t SIDE_EFFECT_LINKED_TO_NOTEHASH_LENGTH = 3;
constexpr size_t SIDE_EFFECT_WITH_RANGE_LENGTH = 3;
...
constexpr size_t PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH =
    ...
    MAX_PUBLIC_DATA_READS_PER_CALL * CONTRACT_STORAGE_READ_LENGTH +
    MAX_PUBLIC_CALL_STACK_LENGTH_PER_CALL * SIDE_EFFECT_WITH_RANGE_LENGTH +
    MAX_NEW_COMMITMENTS_PER_CALL * SIDE_EFFECT_LENGTH +
    MAX_NEW_NULLIFIERS_PER_CALL * SIDE_EFFECT_LINKED_TO_NOTEHASH_LENGTH +
    MAX_NEW_L2_TO_L1_MSGS_PER_CALL * SIDE_EFFECT_LENGTH + NUM_FIELDS_PER_SHA256 +
    1 +                              // + 1 for unencrypted logs preimage length
