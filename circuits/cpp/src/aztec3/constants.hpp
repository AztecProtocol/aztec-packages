...
constexpr size_t MAX_PUBLIC_DATA_UPDATE_REQUESTS_PER_BASE_ROLLUP =
...
constexpr size_t PUBLIC_DATA_WRITES_NUM_BYTES_PER_BASE_ROLLUP =
    MAX_PUBLIC_DATA_UPDATE_REQUESTS_PER_BASE_ROLLUP * 64;  // old value, new value
...
constexpr size_t HISTORICAL_BLOCKS_TREE_HEIGHT = 16;
...
constexpr size_t HISTORICAL_BLOCK_DATA_LENGTH = 7;
...
constexpr size_t PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH =
    ...
    + HISTORICAL_BLOCK_DATA_LENGTH + CONTRACT_DEPLOYMENT_DATA_LENGTH + 2;  // + 2 for chain_id and version
...
constexpr size_t PRIVATE_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH =
    ...
    MAX_PUBLIC_CALL_STACK_LENGTH_PER_CALL + MAX_NEW_L2_TO_L1_MSGS_PER_CALL + NUM_FIELDS_PER_SHA256 +
    NUM_FIELDS_PER_SHA256 + 2            // + 2 for logs preimage lengths
    + HISTORICAL_BLOCK_DATA_LENGTH + 3;  // + 3 for contract_deployment_data.hash(), chain_id, version
...
constexpr size_t PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH =
    ...
    HISTORICAL_BLOCK_DATA_LENGTH + 2;  // + 2 for chain_id and version
...
constexpr size_t PUBLIC_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH =
    ...
    HISTORICAL_BLOCK_DATA_LENGTH + 2;  // unencrypted_log_preimages_length + prover_address
