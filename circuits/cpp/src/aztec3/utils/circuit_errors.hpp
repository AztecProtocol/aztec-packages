...
enum CircuitErrorCode : uint16_t {
    ...
    PRIVATE_KERNEL__INVALID_SENDER_ADDRESS_BYTE_SIZE = 2017,
    PRIVATE_KERNEL__SENDER_ADDRESS_SENDER_PUBLIC_KEY_MISMATCH = 2018,
    PRIVATE_KERNEL__ECDSA_SIGNATURE_VERIFICATION_FAILED = 2019,
