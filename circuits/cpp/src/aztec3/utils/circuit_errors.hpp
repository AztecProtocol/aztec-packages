...
enum CircuitErrorCode : uint16_t {
    ...
    PRIVATE_KERNEL__READ_REQUEST_NOTE_HASH_TREE_ROOT_MISMATCH = 2018,
    ...
    PRIVATE_KERNEL__0TH_NULLIFIER_IS_ZERO = 2024,
    ...
    PUBLIC_KERNEL__CALL_CONTEXT_STORAGE_WRITES_PROHIBITED_FOR_STATIC_CALL = 3024,
    ...
    BASE__INVALID_PUBLIC_DATA_WRITES = 4006,
    ...
    NOTE_HASH_TREE_SNAPSHOT_MISMATCH = 7004,
    ...
    ARRAY_OVERFLOW = 7009,
    ARRAY_NOT_ZERO_RIGHT_PADDED = 7010,
