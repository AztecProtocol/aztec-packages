...
enum CircuitErrorCode : uint16_t {
    ...
    PRIVATE_KERNEL__NEW_NOTE_HASHES_PROHIBITED_IN_STATIC_CALL = 2005,
    ...
    PUBLIC_KERNEL__NEW_NOTE_HASHES_PROHIBITED_IN_STATIC_CALL = 3026,
    ...
    BASE__INCORRECT_NUM_OF_NEW_NOTE_HASHES = 4002,
