...
auto _compare_msgpack_tuples(const Tuple1& t1, const Tuple2& t2, std::index_sequence<I...>)
{
...
template <typename BoolLike, typename T> BoolLike msgpack_derived_equals(const T& obj1, const T& obj2)
{
    ...
    const_cast<T&>(obj1).msgpack([&](auto&... args1) {
        const_cast<T&>(obj2).msgpack([&](auto&... args2) {
