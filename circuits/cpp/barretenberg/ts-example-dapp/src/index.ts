...
// This is the double_verify_proof test. It's used here as an example of a 512k gate test that hits a lot of the stack.
// Triggered via the button click. This dapp also allows calling `window.runtTest(...)` to run custom alternatives.
const acir = inflate(
  base64ToUint8Array(
