  ...
  private:
    ...
    class AllEntities : public AllEntities_<DataType, HandleType, NUM_ALL_ENTITIES> {
      public:
        ...
        DataType& lagrange_second                   = std::get<1>(this->_data);
        DataType& lagrange_last                     = std::get<2>(this->_data);
        DataType& transcript_add                  = std::get<3 + 0>(this->_data);
        DataType& transcript_mul                  = std::get<3 + 1>(this->_data);
        DataType& transcript_eq                   = std::get<3 + 2>(this->_data);
        DataType& transcript_collision_check           = std::get<3 + 3>(this->_data);
        DataType& transcript_msm_transition       = std::get<3 + 4>(this->_data);
        ...
        DataType& precompute_pc                          = std::get<3 + 18>(this->_data);
        DataType& precompute_point_transition            = std::get<3 + 19>(this->_data);
        DataType& precompute_round                       = std::get<3 + 20>(this->_data);
        DataType& precompute_scalar_sum                  = std::get<3 + 21>(this->_data);
        DataType& precompute_s1hi                          = std::get<3 + 22>(this->_data);
        DataType& precompute_s1lo                          = std::get<3 + 23>(this->_data);
        DataType& precompute_s2hi                          = std::get<3 + 24>(this->_data);
        DataType& precompute_s2lo                          = std::get<3 + 25>(this->_data);
        DataType& precompute_s3hi                          = std::get<3 + 26>(this->_data);
        DataType& precompute_s3lo                          = std::get<3 + 27>(this->_data);
        DataType& precompute_s4hi                          = std::get<3 + 28>(this->_data);
        DataType& precompute_s4lo                          = std::get<3 + 29>(this->_data);
        DataType& precompute_skew                        = std::get<3 + 30>(this->_data);
        DataType& precompute_dx                          = std::get<3 + 31>(this->_data);
        DataType& precompute_dy                          = std::get<3 + 32>(this->_data);
        DataType& precompute_tx                          = std::get<3 + 33>(this->_data);
        DataType& precompute_ty                          = std::get<3 + 34>(this->_data);
        DataType& msm_transition                  = std::get<3 + 35>(this->_data);
        DataType& msm_add                         = std::get<3 + 36>(this->_data);
        DataType& msm_double                      = std::get<3 + 37>(this->_data);
        DataType& msm_skew                        = std::get<3 + 38>(this->_data);
        ...
        DataType& msm_add1                        = std::get<3 + 45>(this->_data);
        DataType& msm_add2                        = std::get<3 + 46>(this->_data);
        DataType& msm_add3                        = std::get<3 + 47>(this->_data);
        DataType& msm_add4                        = std::get<3 + 48>(this->_data);
        ...
        DataType& transcript_reset_accumulator    = std::get<3 + 70>(this->_data);
        DataType& precompute_select                            = std::get<3 + 71>(this->_data);
        ...
        DataType& transcript_mul_shift            = std::get<3 + 76>(this->_data);
        ...
        DataType& precompute_scalar_sum_shift            = std::get<2 + 81>(this->_data);
        DataType& precompute_s1hi_shift            = std::get<3 + 81>(this->_data);
        DataType& precompute_dx_shift                    = std::get<3 + 82>(this->_data);
        DataType& precompute_dy_shift                    = std::get<3 + 83>(this->_data);
        DataType& precompute_tx_shift                    = std::get<3 + 84>(this->_data);
        DataType& precompute_ty_shift                    = std::get<3 + 85>(this->_data);
        DataType& msm_transition_shift            = std::get<3 + 86>(this->_data);
        DataType& msm_add_shift                   = std::get<3 + 87>(this->_data);
        DataType& msm_double_shift                = std::get<3 + 88>(this->_data);
        DataType& msm_skew_shift                  = std::get<3 + 89>(this->_data);
        ...
        DataType& msm_add1_shift                  = std::get<3 + 94>(this->_data);
        DataType& msm_pc_shift                      = std::get<3 + 95>(this->_data);
        DataType& precompute_pc_shift                    = std::get<3 + 96>(this->_data);
        DataType& transcript_pc_shift               = std::get<3 + 97>(this->_data);
        DataType& precompute_round_shift                 = std::get<3 + 98>(this->_data);
        DataType& transcript_accumulator_empty_shift= std::get<3 + 99>(this->_data);
        DataType& precompute_select_shift                      = std::get<3 + 100>(this->_data);
