...
lives on [`sb/sumcheck-webgpu`](https://github.com/AztecProtocol/aztec-packages/tree/sb/sumcheck-webgpu),
[`sb/multipass-sumcheck-opt`](https://github.com/AztecProtocol/aztec-packages/tree/sb/multipass-sumcheck-opt) and
[`sb/skipping-sumcheck-webgpu`](https://github.com/AztecProtocol/aztec-packages/tree/sb/skipping-sumcheck-webgpu),
**not** on `sb/integrate-wgpu-msm`. Status,
...
constant are checked against [`sb/skipping-sumcheck-webgpu`](https://github.com/AztecProtocol/aztec-packages/tree/sb/skipping-sumcheck-webgpu).
