...
Checked against the tree on [`sb/integrate-wgpu-msm`](https://github.com/AztecProtocol/aztec-packages/tree/sb/integrate-wgpu-msm) (last full audit
...
**The canonical branch is [`sb/integrate-wgpu-msm`](https://github.com/AztecProtocol/aztec-packages/tree/sb/integrate-wgpu-msm).**

| Branch | Author | Purpose |
| --- | --- | --- |
| **[`sb/integrate-wgpu-msm`](https://github.com/AztecProtocol/aztec-packages/tree/sb/integrate-wgpu-msm)** ★ | suyash | **Canonical.** Full `MsmV2`/`BatchMsmV2` stack wired into the Chonk browser prover + the multi-device bench harness. |
| [`sb/webgpu-msm-fresh`](https://github.com/AztecProtocol/aztec-packages/tree/sb/webgpu-msm-fresh) | suyash | Clean, PR-ready **6-commit spine** (hook → pipeline+bridge → bb.js opt-in flag → BN254 batch route → chonk harness) on a fresh `merge-train/spartan` base. |
| [`sb/msm-webgpu`](https://github.com/AztecProtocol/aztec-packages/tree/sb/msm-webgpu) | suyash | The **original port** the whole family forks from: WebGPU BN254 bridge + bb.js binding + MSM dev page. |
| [`sb/investigate-wgpu-static`](https://github.com/AztecProtocol/aztec-packages/tree/sb/investigate-wgpu-static) | suyash | M8 **static level-plan**. Correct but a net e2e wash; **parked** (§7.3). |
| `worktree-batch-msm-webgpu` | suyash | **BatchMsmV2** dev line; now an ancestor of the canonical branch. |
| [`wip/move-bucket-walk-to-gpu`](https://github.com/AztecProtocol/aztec-packages/tree/wip/move-bucket-walk-to-gpu) | suyash | **PARKED / BROKEN** — the `f2cc` commit breaks MSM correctness (§7.7); kept as a marker. |
| [`zw/webgpu-msm`](https://github.com/AztecProtocol/aztec-packages/tree/zw/webgpu-msm) | zac | Zac's clean squashed v2 — bucket-reduction pipeline, addition-schedule combine, CPU/GPU work-split planner. |
| [`zw/msm-webgpu-experiments-v2`](https://github.com/AztecProtocol/aztec-packages/tree/zw/msm-webgpu-experiments-v2), [`zw/webgpu-compilation`](https://github.com/AztecProtocol/aztec-packages/tree/zw/webgpu-compilation), [`zw/msm-webgpu-experiments-backup`](https://github.com/AztecProtocol/aztec-packages/tree/zw/msm-webgpu-experiments-backup), [`zw/msm-webgpu-mont-mul-bench`](https://github.com/AztecProtocol/aztec-packages/tree/zw/msm-webgpu-mont-mul-bench) | zac | Experiment lines: addition-schedule combine, shader codegen / field arithmetic (`pk` inverse, Karatsuba/Yuval montmul microbench), per-pass dump drivers. |
| [`sb/sumcheck-webgpu`](https://github.com/AztecProtocol/aztec-packages/tree/sb/sumcheck-webgpu), [`sb/multipass-sumcheck-opt`](https://github.com/AztecProtocol/aztec-packages/tree/sb/multipass-sumcheck-opt), [`sb/skipping-sumcheck-webgpu`](https://github.com/AztecProtocol/aztec-packages/tree/sb/skipping-sumcheck-webgpu) | suyash | **GPU sumcheck** (§7.9). The *skipping* branch is the most complete of the three. |
...
**Layout** ([`barretenberg/ts/src/msm_webgpu/`](https://github.com/AztecProtocol/aztec-packages/tree/sb/integrate-wgpu-msm/barretenberg/ts/src/msm_webgpu) on the canonical branch, plus the C++ side):
...
**Upstreaming:** start from **[`sb/webgpu-msm-fresh`](https://github.com/AztecProtocol/aztec-packages/tree/sb/webgpu-msm-fresh)** (the clean 6-commit
