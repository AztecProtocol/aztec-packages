...
Releases are driven by git tags. The version is derived from the latest reachable version tag (e.g. `v5.0.0`). Nightly tags are created automatically and trigger `./bootstrap.sh release` to build and deploy.
