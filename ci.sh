...
function print_usage {
  ...
  echo_cmd "gate-count-update"     "Spin up an EC2 instance to refresh pinned barretenberg gate counts and push the diff."
...
case "$cmd" in
  ...
  gate-count-update)
    ...
    bootstrap_ec2 "./bootstrap.sh ci-gate-count-update"
    ;;
  barretenberg-debug)
