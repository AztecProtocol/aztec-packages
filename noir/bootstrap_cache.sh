...
../../build-system/s3-cache-scripts/cache-download.sh noir-nargo-$NATIVE_HASH.tar.gz > /dev/null

echo -e "\033[1mRetrieving nargo from remote cache...\033[0m"
PACKAGES_HASH=$(AZTEC_CACHE_REBUILD_PATTERNS="../barretenberg/cpp/.rebuild_patterns .rebuild_patterns_packages" ../../build-system/s3-cache-scripts/compute-content-hash.sh)
