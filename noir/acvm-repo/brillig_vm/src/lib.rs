...
//             MemoryAddress::from(registers.len() - 1)
//         };
...
//         opcodes.push(Opcode::JumpIf { condition: MemoryAddress::from(2), location: 3 });
...
//             Opcode::JumpIfNot { condition: MemoryAddress::from(2), location: 1 };
