...
fn inject_compute_note_hash_and_nullifier(
    ...
    // We don't have a reasonable location for the source code of this autogenerated function, so we simply pass an
    // empty span. This function should not produce errors anyway so this should not matter.
