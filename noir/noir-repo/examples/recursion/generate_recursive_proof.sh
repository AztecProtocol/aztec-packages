...
$BACKEND write_vk_ultra_honk -b ./target/sum.json -o ./target/sum_key
...
$BACKEND write_vk_ultra_honk -b ./target/recurse_leaf.json -o ./target/recurse_leaf_key
...
$BACKEND write_vk_ultra_honk -b ./target/recurse_node.json -o ./target/recurse_node_key
