...
```sh
bb write_vk -b ./target/<noir_artifact_name>.json -o ./target
bb write_contract -k ./target/vk
```

</TabItem>
<TabItem value="UltraPlonk (deprecated)">

```sh
bb OLD_API write_vk -b ./target/<noir_artifact_name>.json
bb OLD_API contract
```
...
bb prove --oracle-hash keccak -b ./target/<circuit-name>.json -w ./target/<witness-name> -o ./target
```
...
```bash
nargo execute <witness-name>
bb OLD_API prove -b ./target/<circuit-name>.json -w ./target/<witness-name> -o ./target/proof
```
