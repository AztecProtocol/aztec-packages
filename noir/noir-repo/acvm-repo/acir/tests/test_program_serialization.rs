...
fn simple_brillig_foreign_call() {
    ...
    let expected_serialization: Vec<u8> = vec![
        31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 173, 80, 49, 10, 192, 32, 12, 52, 45, 45, 165, 163, 47,
        ...
        188, 250, 213, 76, 75, 158, 22, 178, 10, 122, 241, 91, 216, 164, 1, 0, 0,
    ];
...
fn complex_brillig_foreign_call() {
    ...
    let bytes = Program::serialize_program(&program);
    let expected_serialization: Vec<u8> = vec![
        31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 213, 84, 75, 10, 132, 48, 12, 77, 90, 199, 145, 89, 206,
        9, 6, 102, 14, 208, 241, 4, 222, 69, 220, 41, 186, 244, 248, 90, 140, 24, 159, 5, 23, 86,
        208, 7, 37, 253, 228, 243, 146, 144, 50, 77, 200, 198, 197, 178, 127, 136, 52, 34, 253,
        ...
        244, 246, 124, 191, 105, 41, 241, 92, 246, 1, 33, 147, 102, 123, 69, 5, 0, 0,
    ];
