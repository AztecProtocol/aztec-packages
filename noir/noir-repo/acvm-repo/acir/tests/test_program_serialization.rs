...
fn simple_brillig_foreign_call() {
    ...
    let expected_serialization: Vec<u8> = vec![
        ...
        184, 39, 105, 111, 176, 151, 217, 161, 75, 135, 136, 30, 63, 42, 82, 144, 8, 47, 245, 65,
        ...
        186, 248, 251, 160, 221, 170, 146, 64, 191, 39, 215, 60, 3, 47, 3, 169, 230, 21, 251, 164,
        1, 0, 0,
    ];
...
fn complex_brillig_foreign_call() {
    ...
    let expected_serialization: Vec<u8> = vec![
        31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 213, 84, 75, 10, 131, 64, 12, 77, 102, 90, 43, 93, 246,
        4, 133, 246, 0, 211, 158, 192, 187, 136, 59, 69, 151, 158, 94, 116, 48, 131, 241, 233, 70,
        ...
        55, 27, 124, 191, 104, 42, 111, 40, 121, 15, 148, 238, 228, 47, 65, 5, 0, 0,
    ];
