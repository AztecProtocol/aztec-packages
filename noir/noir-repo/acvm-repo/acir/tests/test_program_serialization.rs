...
fn simple_brillig_foreign_call() {
    ...
    let expected_serialization: Vec<u8> = vec![
        ...
        209, 31, 248, 25, 7, 23, 7, 17, 223, 175, 96, 2, 65, 131, 139, 30, 132, 75, 238, 224, 72,
        2, 170, 227, 107, 5, 216, 63, 200, 52, 115, 144, 230, 144, 205, 30, 44, 156, 203, 50, 124,
        223, 107, 108, 128, 139, 106, 113, 217, 141, 252, 10, 30, 225, 103, 126, 136, 197, 167,
        188, 250, 149, 24, 49, 105, 90, 48, 42, 102, 64, 215, 189, 158, 1, 0, 0,
    ];
...
fn complex_brillig_foreign_call() {
    ...
    let bytes = Program::serialize_program(&program);
    let expected_serialization: Vec<u8> = vec![
        31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 213, 84, 73, 14, 131, 48, 12, 180, 19, 74, 81, 111, 253,
        65, 165, 246, 1, 41, 47, 224, 47, 136, 27, 8, 142, 60, 31, 34, 140, 48, 67, 56, 17, 36,
        176, 20, 57, 139, 151, 241, 88, 14, 211, 36, 217, 184, 88, 246, 15, 209, 70, 180, 191, 183,
        180, 150, 217, 182, 16, 237, 142, 201, 159, 227, 197, 114, 103, 97, 52, 55, 192, 104, 79,
        192, 72, 170, 255, 23, 236, 119, 204, 190, 68, 229, 207, 6, 230, 39, 161, 105, 190, 82, 57,
        63, 69, 103, 72, 180, 119, 50, 180, 29, 188, 149, 224, 196, 250, 168, 31, 8, 68, 152, 193,
        251, 37, 209, 202, 204, 93, 170, 128, 48, 36, 127, 169, 18, 203, 182, 233, 234, 170, 183,
        96, 138, 88, 191, 106, 255, 131, 119, 6, 191, 0, 59, 250, 211, 10, 89, 113, 192, 110, 63,
        228, 155, 22, 66, 103, 146, 7, 175, 77, 219, 56, 51, 5, 0, 0,
    ];
