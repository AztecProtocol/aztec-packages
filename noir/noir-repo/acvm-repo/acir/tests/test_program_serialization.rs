...
fn fixed_base_scalar_mul_circuit() {
    ...
    let expected_serialization: Vec<u8> = vec![
        31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 77, 138, 81, 10, 0, 48, 8, 66, 87, 219, 126, 118, 234,
        29, 61, 43, 3, 5, 121, 34, 207, 86, 231, 162, 198, 157, 124, 228, 71, 157, 220, 232, 161,
        227, 226, 206, 214, 95, 221, 74, 0, 7, 249, 204, 219, 105, 0, 0, 0,
    ];
...
fn pedersen_circuit() {
    ...
    let expected_serialization: Vec<u8> = vec![
        31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 93, 74, 133, 9, 0, 0, 8, 179, 240, 255, 139, 197, 6,
        113, 48, 150, 8, 13, 9, 226, 248, 84, 125, 217, 198, 83, 144, 79, 127, 117, 247, 255, 43,
        56, 71, 252, 254, 8, 105, 0, 0, 0,
    ];
...
fn schnorr_verify_circuit() {
    ...
    let expected_serialization: Vec<u8> = vec![
        ...
        228, 191, 219, 82, 168, 63, 63, 181, 183, 197, 223, 177, 131, 191, 181, 183, 149, 69, 159,
        ...
        146, 187, 150, 221, 179, 226, 142, 141, 155, 53, 238, 86, 104, 186, 231, 255, 243, 7, 66,
        5, 194, 255, 233, 3, 0, 0,
    ];
