...
struct BlackBoxOp {
  ...
  std::variant<Sha256, Blake2s, Blake3, Keccak256, Keccakf1600, EcdsaSecp256k1,
               ...
               FixedBaseScalarMul, EmbeddedCurveAdd, BigIntAdd, BigIntSub,
               BigIntMul, BigIntDiv, BigIntFromLeBytes, BigIntToLeBytes,
...
struct BrilligOpcode {
  ...
  std::variant<BinaryFieldOp, BinaryIntOp, Cast, JumpIfNot, JumpIf, Jump,
               CalldataCopy, Call, Const, Return, ForeignCall, Mov, Load, Store,
               BlackBox, Trap, Stop>
      value;
...
struct BlackBoxFuncCall {
  ...
  struct Keccak256VariableLength {
    ...
    friend bool operator==(const Keccak256VariableLength &,
                           const Keccak256VariableLength &);
    std::vector<uint8_t> bincodeSerialize() const;
  ...
  std::variant<AND, XOR, RANGE, SHA256, Blake2s, Blake3, SchnorrVerify,
               ...
               FixedBaseScalarMul, EmbeddedCurveAdd, Keccak256,
               Keccak256VariableLength, Keccakf1600, RecursiveAggregation,
...
template <>
template <typename Serializer>
void serde::Serializable<Program::BinaryIntOp::SignedDiv>::serialize(
    const Program::BinaryIntOp::SignedDiv &obj, Serializer &serializer) {}

template <>
template <typename Deserializer>
Program::BinaryIntOp::SignedDiv
serde::Deserializable<Program::BinaryIntOp::SignedDiv>::deserialize(
    Deserializer &deserializer) {
  ...
  inline bool operator==(const BinaryIntOp::UnsignedDiv &lhs,
                         const BinaryIntOp::UnsignedDiv &rhs) {
    return true;
  }

  inline std::vector<uint8_t>
  BinaryIntOp::UnsignedDiv::bincodeSerialize() const {
    auto serializer = serde::BincodeSerializer();
    serde::Serializable<BinaryIntOp::UnsignedDiv>::serialize(*this, serializer);
    return std::move(serializer).bytes();
  }

  inline BinaryIntOp::UnsignedDiv
  BinaryIntOp::UnsignedDiv::bincodeDeserialize(std::vector<uint8_t> input) {
    auto deserializer = serde::BincodeDeserializer(input);
    auto value = serde::Deserializable<BinaryIntOp::UnsignedDiv>::deserialize(
        deserializer);
    if (deserializer.get_buffer_offset() < input.size()) {
      throw serde::deserialization_error("Some input bytes were not read");
    }
  ...
  template <>
  template <typename Serializer>
  void serde::Serializable<Program::BinaryIntOp::UnsignedDiv>::serialize(
      const Program::BinaryIntOp::UnsignedDiv &obj, Serializer &serializer) {}

  template <>
  template <typename Deserializer>
  Program::BinaryIntOp::UnsignedDiv
  serde::Deserializable<Program::BinaryIntOp::UnsignedDiv>::deserialize(
      Deserializer & deserializer) {
    ...
    inline BinaryIntOp::Equals BinaryIntOp::Equals::bincodeDeserialize(
  ...
  serde::Deserializable<Program::BinaryIntOp::And>::deserialize(Deserializer &
                                                                deserializer) {
  ...
  serde::Deserializable<Program::BinaryIntOp::Or>::deserialize(Deserializer &
                                                               deserializer) {
  ...
  serde::Deserializable<Program::BinaryIntOp::Xor>::deserialize(Deserializer &
                                                                deserializer) {
  ...
  serde::Deserializable<Program::BinaryIntOp::Shl>::deserialize(Deserializer &
                                                                deserializer) {
  ...
  serde::Deserializable<Program::BinaryIntOp::Shr>::deserialize(Deserializer &
                                                                deserializer) {
  ...
  serde::Deserializable<Program::BlackBoxFuncCall>::deserialize(Deserializer &
                                                                deserializer) {
    deserializer.increase_container_depth();
  ...
  inline std::vector<uint8_t>
  BlackBoxFuncCall::SHA256::bincodeSerialize() const {
    auto serializer = serde::BincodeSerializer();
  ...
  serde::Deserializable<Program::BlackBoxFuncCall::SchnorrVerify>::deserialize(
    ...
    obj.public_key_y =
        serde::Deserializable<decltype(obj.public_key_y)>::deserialize(
            deserializer);
    obj.signature = serde::Deserializable<decltype(obj.signature)>::deserialize(
        deserializer);
    obj.message =
  ...
  template <typename Serializer>
  void
  serde::Serializable<Program::BlackBoxFuncCall::PedersenCommitment>::serialize(
      const Program::BlackBoxFuncCall::PedersenCommitment &obj,
      Serializer &serializer) {
    serde::Serializable<decltype(obj.inputs)>::serialize(obj.inputs,
                                                         serializer);
  ...
  template <typename Serializer>
  void
  serde::Serializable<Program::BlackBoxFuncCall::FixedBaseScalarMul>::serialize(
      const Program::BlackBoxFuncCall::FixedBaseScalarMul &obj,
      Serializer &serializer) {
  ...
  Program::BlackBoxFuncCall::EmbeddedCurveAdd serde::Deserializable<
      Program::BlackBoxFuncCall::EmbeddedCurveAdd>::deserialize(Deserializer &
                                                                deserializer) {
  ...
  inline std::vector<uint8_t>
  BlackBoxFuncCall::Keccak256VariableLength::bincodeSerialize() const {
    auto serializer = serde::BincodeSerializer();
    serde::Serializable<BlackBoxFuncCall::Keccak256VariableLength>::serialize(
        *this, serializer);
    return std::move(serializer).bytes();
  }

  inline BlackBoxFuncCall::Keccak256VariableLength
  BlackBoxFuncCall::Keccak256VariableLength::bincodeDeserialize(
      std::vector<uint8_t> input) {
    auto deserializer = serde::BincodeDeserializer(input);
    auto value = serde::Deserializable<
        BlackBoxFuncCall::Keccak256VariableLength>::deserialize(deserializer);
    if (deserializer.get_buffer_offset() < input.size()) {
      throw serde::deserialization_error("Some input bytes were not read");
    }
    return value;
  ...
  template <>
  template <typename Serializer>
  void serde::Serializable<Program::BlackBoxFuncCall::Keccak256VariableLength>::
      serialize(const Program::BlackBoxFuncCall::Keccak256VariableLength &obj,
                Serializer &serializer) {
    serde::Serializable<decltype(obj.inputs)>::serialize(obj.inputs,
                                                         serializer);
  ...
  template <>
  template <typename Deserializer>
  Program::BlackBoxFuncCall::Keccak256VariableLength
  serde::Deserializable<Program::BlackBoxFuncCall::Keccak256VariableLength>::
      deserialize(Deserializer & deserializer) {
  ...
  template <typename Serializer>
  void
  serde::Serializable<Program::BlackBoxFuncCall::BigIntFromLeBytes>::serialize(
      const Program::BlackBoxFuncCall::BigIntFromLeBytes &obj,
      Serializer &serializer) {
    serde::Serializable<decltype(obj.inputs)>::serialize(obj.inputs,
                                                         serializer);
  ...
  Program::BlackBoxFuncCall::BigIntFromLeBytes serde::Deserializable<
      Program::BlackBoxFuncCall::BigIntFromLeBytes>::deserialize(Deserializer &
                                                                 deserializer) {
  ...
  Program::BlackBoxFuncCall::BigIntToLeBytes serde::Deserializable<
      Program::BlackBoxFuncCall::BigIntToLeBytes>::deserialize(Deserializer &
                                                               deserializer) {
  ...
  template <typename Serializer>
  void
  serde::Serializable<Program::BlackBoxFuncCall::Sha256Compression>::serialize(
      const Program::BlackBoxFuncCall::Sha256Compression &obj,
      Serializer &serializer) {
    serde::Serializable<decltype(obj.inputs)>::serialize(obj.inputs,
                                                         serializer);
  ...
  Program::BlackBoxFuncCall::Sha256Compression serde::Deserializable<
      Program::BlackBoxFuncCall::Sha256Compression>::deserialize(Deserializer &
                                                                 deserializer) {
  ...
  serde::Deserializable<Program::BrilligInputs>::deserialize(Deserializer &
                                                             deserializer) {
    deserializer.increase_container_depth();
  ...
  serde::Deserializable<Program::BrilligOpcode>::deserialize(Deserializer &
                                                             deserializer) {
    deserializer.increase_container_depth();
  ...
  serde::Deserializable<Program::BrilligOpcode::JumpIfNot>::deserialize(
    ...
    obj.condition = serde::Deserializable<decltype(obj.condition)>::deserialize(
        deserializer);
  ...
  serde::Deserializable<Program::BrilligOutputs>::deserialize(Deserializer &
                                                              deserializer) {
    deserializer.increase_container_depth();
  ...
  serde::Deserializable<Program::ExpressionWidth>::deserialize(Deserializer &
                                                               deserializer) {
    deserializer.increase_container_depth();
  ...
  serde::Deserializable<Program::FunctionInput>::deserialize(Deserializer &
                                                             deserializer) {
    deserializer.increase_container_depth();
  ...
  serde::Deserializable<Program::HeapValueType>::deserialize(Deserializer &
                                                             deserializer) {
    deserializer.increase_container_depth();
  ...
  serde::Deserializable<Program::MemoryAddress>::deserialize(Deserializer &
                                                             deserializer) {
    deserializer.increase_container_depth();
  ...
  template <>
  template <typename Serializer>
  void serde::Serializable<Program::Opcode>::serialize(
      const Program::Opcode &obj, Serializer &serializer) {
    serializer.increase_container_depth();
    serde::Serializable<decltype(obj.value)>::serialize(obj.value, serializer);
    serializer.decrease_container_depth();
  }
  ...
  serde::Deserializable<Program::Opcode::Directive>::deserialize(Deserializer &
                                                                 deserializer) {
  ...
  serde::Deserializable<Program::Opcode::Brillig>::deserialize(Deserializer &
                                                               deserializer) {
  ...
  serde::Deserializable<Program::Opcode::MemoryOp>::deserialize(Deserializer &
                                                                deserializer) {
  ...
  template <typename Deserializer>
  Program::Opcode::Call
  serde::Deserializable<Program::Opcode::Call>::deserialize(Deserializer &
                                                            deserializer) {
  ...
  serde::Deserializable<Program::OpcodeLocation>::deserialize(Deserializer &
                                                              deserializer) {
    deserializer.increase_container_depth();
  ...
  serde::Deserializable<Program::PublicInputs>::deserialize(Deserializer &
                                                            deserializer) {
    deserializer.increase_container_depth();
  ...
  template <>
  template <typename Serializer>
  void serde::Serializable<Program::Value>::serialize(const Program::Value &obj,
                                                      Serializer &serializer) {
    serializer.increase_container_depth();
  ...
  template <>
  template <typename Deserializer>
  Program::Value serde::Deserializable<Program::Value>::deserialize(
      Deserializer & deserializer) {
    deserializer.increase_container_depth();
    Program::Value obj;
    obj.inner =
        serde::Deserializable<decltype(obj.inner)>::deserialize(deserializer);
    deserializer.decrease_container_depth();
    return obj;
  }
  ...
  serde::Deserializable<Program::ValueOrArray>::deserialize(Deserializer &
                                                            deserializer) {
    deserializer.increase_container_depth();
