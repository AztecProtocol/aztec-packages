...
template <>
template <typename Serializer>
void serde::Serializable<Program::BinaryIntOp::SignedDiv>::serialize(const Program::BinaryIntOp::SignedDiv &obj, Serializer &serializer) {
}

template <>
template <typename Deserializer>
Program::BinaryIntOp::SignedDiv serde::Deserializable<Program::BinaryIntOp::SignedDiv>::deserialize(Deserializer &deserializer) {
...
template <>
template <typename Serializer>
void serde::Serializable<Program::BinaryIntOp::UnsignedDiv>::serialize(const Program::BinaryIntOp::UnsignedDiv &obj, Serializer &serializer) {
}

template <>
template <typename Deserializer>
Program::BinaryIntOp::UnsignedDiv serde::Deserializable<Program::BinaryIntOp::UnsignedDiv>::deserialize(Deserializer &deserializer) {
