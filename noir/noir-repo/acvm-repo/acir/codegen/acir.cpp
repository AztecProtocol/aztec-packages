...
struct BlackBoxFuncCall {
  ...
  std::variant<AES128Encrypt, AND, XOR, RANGE, SHA256, Blake2s, Blake3,
               ...
               EcdsaSecp256r1, FixedBaseScalarMul, VariableBaseScalarMul,
               EmbeddedCurveAdd, Keccak256, Keccakf1600, RecursiveAggregation,
...
struct BlackBoxOp {
  ...
  std::variant<AES128Encrypt, Sha256, Blake2s, Blake3, Keccak256, Keccakf1600,
               ...
               VariableBaseScalarMul, EmbeddedCurveAdd, BigIntAdd, BigIntSub,
