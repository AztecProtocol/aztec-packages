...
template <>
template <typename Serializer>
void serde::Serializable<Program::FunctionInput::Constant>::serialize(const Program::FunctionInput::Constant &obj, Serializer &serializer) {
    serde::Serializable<decltype(obj.value)>::serialize(obj.value, serializer);
}

template <>
template <typename Deserializer>
Program::FunctionInput::Constant serde::Deserializable<Program::FunctionInput::Constant>::deserialize(Deserializer &deserializer) {
...
template <>
template <typename Serializer>
void serde::Serializable<Program::FunctionInput::Witness>::serialize(const Program::FunctionInput::Witness &obj, Serializer &serializer) {
    serde::Serializable<decltype(obj.value)>::serialize(obj.value, serializer);
}

template <>
template <typename Deserializer>
Program::FunctionInput::Witness serde::Deserializable<Program::FunctionInput::Witness>::deserialize(Deserializer &deserializer) {
