...
$NARGO_BACKEND_PATH write_vk -b $mul_dir/target/1_mul.json -k $KEYS/1_mul 
...
$NARGO_BACKEND_PATH write_vk -b $assert_statement_dir/target/assert_statement.json -k $KEYS/assert_statement
...
$NARGO_BACKEND_PATH write_vk -b $recursion_dir/target/recursion.json -k $KEYS/recursion
