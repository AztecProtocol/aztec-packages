...
$NARGO_BACKEND_PATH write_vk_ultra_honk -b $mul_dir/target/1_mul.json -o $KEYS/1_mul
...
$NARGO_BACKEND_PATH write_vk_ultra_honk -b $assert_statement_dir/target/assert_statement.json -o $KEYS/assert_statement
...
$NARGO_BACKEND_PATH write_vk_ultra_honk -b $recursion_dir/target/recursion.json -o $KEYS/recursion
