...
class AsyncMessageProcessor {
  public:
    ...
    Napi::Promise process_message(const Napi::CallbackInfo& info)
    {
        ...
        if (!open) {
            ...
            auto* op = new azteclabs::kvdb::AsyncOperation(env, deferred, [data, this, length](msgpack::sbuffer& buf) {
  ...
  private:
    azteclabs::kvdb::messaging::MessageDispatcher dispatcher;
                           ...
                           bool unique = false)
    {
        dispatcher.register_target(
            ...
            [=](msgpack::object& obj, msgpack::sbuffer& buffer) {
                ...
                azteclabs::kvdb::messaging::MsgHeader header(req_msg.header.messageId);
                azteclabs::kvdb::messaging::TypedMessage<R> resp_msg(msgType, header, response);
