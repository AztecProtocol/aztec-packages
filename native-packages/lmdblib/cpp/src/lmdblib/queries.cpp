...
namespace azteclabs::lmdblib::lmdb_queries {

void put_value(
    Key& key, Value& data, const LMDBDatabase& db, azteclabs::lmdblib::LMDBWriteTransaction& tx, bool duplicatesPermitted)
{
    MDB_val dbKey;
...
void put_value(Key& key,
               ...
               azteclabs::lmdblib::LMDBWriteTransaction& tx,
...
void delete_value(Key& key, const LMDBDatabase& db, azteclabs::lmdblib::LMDBWriteTransaction& tx)
{
    MDB_val dbKey;
    dbKey.mv_size = key.size();
    dbKey.mv_data = (void*)key.data();
...
void delete_value(Key& key, Value& value, const LMDBDatabase& db, azteclabs::lmdblib::LMDBWriteTransaction& tx)
{
    MDB_val dbKey;
    dbKey.mv_size = key.size();
    dbKey.mv_data = (void*)key.data();
...
bool get_value(Key& key, Value& data, const LMDBDatabase& db, const azteclabs::lmdblib::LMDBTransaction& tx)
{
    MDB_val dbKey;
    dbKey.mv_size = key.size();
    dbKey.mv_data = (void*)key.data();
...
bool get_value(Key& key, uint64_t& data, const LMDBDatabase& db, const azteclabs::lmdblib::LMDBTransaction& tx)
{
    MDB_val dbKey;
    dbKey.mv_size = key.size();
    dbKey.mv_data = (void*)key.data();
