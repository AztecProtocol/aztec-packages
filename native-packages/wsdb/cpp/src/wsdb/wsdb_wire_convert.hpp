...
tree_db_stats_to_wire(const azteclabs::wsdb::merkle_tree::TreeDBStats &d) {
...
inline azteclabs::wsdb::merkle_tree::TreeDBStats
...
tree_meta_to_wire(const azteclabs::wsdb::merkle_tree::TreeMeta &d) {
  return {.name = d.name,
          .depth = d.depth,
          .size = d.size,
...
inline azteclabs::wsdb::merkle_tree::TreeMeta
...
world_state_db_stats_to_wire(const azteclabs::wsdb::world_state::WorldStateDBStats &d) {
...
inline azteclabs::wsdb::world_state::WorldStateDBStats
...
world_state_meta_to_wire(const azteclabs::wsdb::world_state::WorldStateMeta &d) {
...
inline azteclabs::wsdb::world_state::WorldStateMeta
...
inline azteclabs::wsdb::world_state::WorldStateStatusSummary
...
inline azteclabs::wsdb::world_state::WorldStateStatusFull
