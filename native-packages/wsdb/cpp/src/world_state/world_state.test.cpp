...
TEST_F(WorldStateTest, GetInitialTreeInfoForAllTrees)
{
...

    {
        ...
        EXPECT_EQ(info.meta.root, azteclabs::wsdb::fr("0x18935581a8ed73d08ffd00386fba55ba6c89f3ab848a76b8fedfa9034cee0454"));
    }

    {
        ...
        EXPECT_EQ(info.meta.root, azteclabs::wsdb::fr("0x2590f2aab19dd791700b4a43d3f52bb88ef2409a3731da8e848663559202e4c6"));
    }

    {
        ...
        EXPECT_EQ(info.meta.root, azteclabs::wsdb::fr("0x1bef38b621017d3c7416663d0cd81369424560710526a3fbaaec13e356b9d084"));
    }

    {
        ...
        EXPECT_EQ(info.meta.root, azteclabs::wsdb::fr("0x0fef6d80d31109ddb56d6b3f607cbc9c0af0bff3ea0d43e8f278983c64c11f7a"));
    }

    {
        ...
        assert_leaf_value(
            ws, WorldStateRevision::committed(), MerkleTreeId::ARCHIVE, 0, azteclabs::wsdb::fr(GENESIS_BLOCK_HEADER_HASH));
    }
}
...
TEST_F(WorldStateTest, GetStateReference)
{
...

    {
        auto state_ref = ws.get_state_reference(WorldStateRevision::committed());
        {
            ...
            EXPECT_EQ(
                snapshot,
                std::make_pair(azteclabs::wsdb::fr("0x18935581a8ed73d08ffd00386fba55ba6c89f3ab848a76b8fedfa9034cee0454"), 128UL));
        }

        {
            ...
            EXPECT_EQ(
                snapshot,
                std::make_pair(azteclabs::wsdb::fr("0x2590f2aab19dd791700b4a43d3f52bb88ef2409a3731da8e848663559202e4c6"), 0UL));
        }

        {
            ...
            EXPECT_EQ(
                snapshot,
                std::make_pair(azteclabs::wsdb::fr("0x1bef38b621017d3c7416663d0cd81369424560710526a3fbaaec13e356b9d084"), 128UL));
        }

        {
            ...
            EXPECT_EQ(
                snapshot,
                std::make_pair(azteclabs::wsdb::fr("0x0fef6d80d31109ddb56d6b3f607cbc9c0af0bff3ea0d43e8f278983c64c11f7a"), 0UL));
        }
    }

    {
...

        {
            ...
            EXPECT_EQ(
                snapshot,
                std::make_pair(azteclabs::wsdb::fr("0x278449ce779093eaaa1bd9fc608f7ed7b595417710e2baf359e1488650967f47"), 1UL));
        }
...
TEST_F(WorldStateTest, ForkingAtBlock0AndAdvancingCanonicalState)
{
    ...
    assert_leaf_value<azteclabs::wsdb::fr>(ws, WorldStateRevision{ .includeUncommitted = false }, MerkleTreeId::ARCHIVE, 1, 1);
