 ...
 *
 * The macros are defined inside an `#ifndef THROW` guard so callers (e.g.
 * barretenberg's own try_catch_shim.hpp) can predefine them before this
 * header is reached and we yield to whichever variant the parent project
 * wants.
 */
