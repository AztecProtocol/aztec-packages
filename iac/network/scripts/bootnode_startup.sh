...
JSON=\$(curl -s https://raw.githubusercontent.com/AztecProtocol/networks/main/network_config.json)
export BOOTSTRAP_NODES=\$(echo "\$JSON" | jq -r '.$NETWORK_NAME.bootnodes | join(",")')
