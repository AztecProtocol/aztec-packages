...
RPC_CLOUD_ARMOR_POLICY_NAME = "${RPC_CLOUD_ARMOR_POLICY_NAME}"
RPC_INGRESS_SESSION_AFFINITY = "${RPC_INGRESS_SESSION_AFFINITY}"
RPC_INGRESS_LOG_SAMPLE_RATE = ${RPC_INGRESS_LOG_SAMPLE_RATE}
