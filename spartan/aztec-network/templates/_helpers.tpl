...
{{- if .Values.ethereum.externalBaseUrl -}}
{{ .Values.ethereum.externalBaseUrl }}:{{ .Values.ethereum.service.port }}
{{- else -}}
...
{{- if .Values.pxe.externalBaseUrl -}}
{{ .Values.pxe.externalBaseUrl }}:{{ .Values.pxe.service.port }}
{{- else -}}
...
{{- if .Values.bootNode.externalBaseUrl -}}
{{ .Values.bootNode.externalBaseUrl }}:{{ .Values.bootNode.service.nodePort }}
{{- else -}}
