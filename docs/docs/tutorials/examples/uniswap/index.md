...
5. We will assume that token portals and token bridges for the input and output tokens must exist. These are what we built in the [token bridge tutorial](../../../../tutorials/codealong/contract_tutorials/advanced/token_bridge/0_setup.md).
...
This code works alongside a token portal that you can learn to build [in this tutorial](../../../../tutorials/codealong/contract_tutorials/advanced/token_bridge/0_setup.md).
