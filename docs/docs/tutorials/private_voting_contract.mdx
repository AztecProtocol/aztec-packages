...
<Test hidden mode="replace" begin="4" end="5" file="index.ts">
    
```ts
const pxe = createPXEClient("http://aztec:8080");
```
...
<Test file="src/main.nr" mode="replace" begin="3" end="-1">
...
<Test file="src/main.nr" mode="insert" at="3">
...
<Test mode="compare" file="src/main.nr">
...
<Test mode="insert" at="-1" file="src/main.nr">
...
<Test mode="replace" begin="1" end="3" file="src/main.nr">
