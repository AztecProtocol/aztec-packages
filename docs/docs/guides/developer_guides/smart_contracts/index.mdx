...
3.  [Profile](./profiling_transactions.md) the functions in your contract to get
    a sense of how long generating client side proofs will take
4.  Write function tests [using the TXE](./testing_contracts/testing.md) and end-to-end
