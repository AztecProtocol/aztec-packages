...
Then to register the recipient's [complete address](../../../../learn/concepts/accounts/keys.md#complete-address) in PXE we would call `registerRecipient` PXE endpoint using [Aztec.js](../../../aztecjs/main.md):
