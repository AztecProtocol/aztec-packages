...
A detailed explanation of the transaction lifecycle can be found [here](/aztec/aztec/concepts/transactions.md#simple-example-of-the-private-transaction-lifecycle).
...
#### Storage "slot"
Storage slots are more literal for public storage, a place where a value is stored. For private storage, a storage slot is logical (more [here](/aztec/aztec/concepts/storage/index.md#private-state-slots---slots-arent-real)).
...
### Apply
Try the [Token tutorial](/tutorials/tutorials/contract_tutorials/token_contract.md) to see what notes can achieve. In this section you will also find other tutorials using notes in different ways.

### Further reading
- [Storage Trees](/aztec/aztec/concepts/storage/trees)
