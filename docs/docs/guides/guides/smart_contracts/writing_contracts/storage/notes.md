...
Storage slots are more literal for public storage, a place where a value is stored. For private storage, a storage slot is logical (more [here](/aztec/concepts/storage/index.md)).
...
- [Public and Private state](/aztec/concepts/state_model)
...
- [Storage Trees](/aztec/concepts/storage/trees)
