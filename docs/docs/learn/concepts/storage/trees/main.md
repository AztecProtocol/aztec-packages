...
It can also be used to find information about notes, public state, and contracts that were included in a certain block using [inclusion and non-inclusion proofs](../../../../developers/contracts/writing_a_contract/historical_data/archive_tree/how_to_prove_history.md).
