...
Get started with the [Developer Getting Started Guide](developers/getting_started_on_sandbox.md).

## Learn how Aztec works

Learn the core concepts that make up the Aztec Protocol with the [Aztec Learning Journey](learn/index.md).
