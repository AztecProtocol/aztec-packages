...
The archive tree is an append-only Merkle tree that stores the headers of all previous blocks in the chain as its leaves.
...
HistoricalAccessTree[<b>Archive Tree</b><br>used to validate user-generated proofs and access historical data]
...
It can also be used to find information about notes, public state, and contracts that were included in a certain block using [inclusion and non-inclusion proofs](../../../dev_docs/contracts/syntax/historical_access/how_to_access_history).
