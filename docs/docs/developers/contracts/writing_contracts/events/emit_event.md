...
#include_code encrypted_import /aztec-nr/address-note/src/address_note.nr rust
...
#include_code unencrypted_import /noir-contracts/contracts/test_contract/src/main.nr rust

### Call emit_unencrypted_log

After importing, you can call the function:

#include_code emit_unencrypted /noir-contracts/contracts/test_contract/src/main.nr rust
...
#include_code value-note-def /aztec-nr/value-note/src/value_note.nr
