...
#include_code note_interface /aztec-nr/aztec/src/note/note_interface.nr rust

#include_code serialize /noir-protocol-circuits/src/crates/types/src/traits.nr rust

#include_code deserialize /noir-protocol-circuits/src/crates/types/src/traits.nr rust
...
Like for public state, we define the struct to have context and a storage slot. You can view the implementation [here](https://github.com/AztecProtocol/aztec-packages/blob/master/aztec-nr/aztec/src/state_vars/singleton.nr).
...
#include_code storage-singleton-declaration /noir-contracts/contracts/docs_example_contract/src/main.nr rust

### `new`

As part of the initialization of the `Storage` struct, the `Singleton` is created as follows at the specified storage slot.

#include_code start_vars_singleton /noir-contracts/contracts/docs_example_contract/src/main.nr rust
...
An unconstrained method to check whether the Singleton has been initialized or not. It takes an optional owner and returns a boolean. You can view the implementation [here](https://github.com/AztecProtocol/aztec-packages/blob/#include_aztec_version/aztec-nr/aztec/src/state_vars/singleton.nr).

#include_code singleton_is_initialized /noir-contracts/contracts/docs_example_contract/src/main.nr rust
...
#include_code state_vars-SingletonReplace /noir-contracts/contracts/docs_example_contract/src/main.nr rust
...
#include_code state_vars-SingletonGet /noir-contracts/contracts/docs_example_contract/src/main.nr rust
...
#include_code initialize-immutable-singleton /noir-contracts/contracts/docs_example_contract/src/main.nr rust

Once initialized, an ImmutableSingleton's value remains unchangeable. This method can only be called once.

### `is_initialized`

An unconstrained method to check if the ImmutableSingleton has been initialized. Takes an optional owner and returns a boolean. You can find the implementation [here](https://github.com/AztecProtocol/aztec-packages/blob/#include_aztec_version/aztec-nr/aztec/src/state_vars/immutable_singleton.nr).
...
#include_code get_note-immutable-singleton /noir-contracts/contracts/docs_example_contract/src/main.nr rust
...
You can view the implementation [here](https://github.com/AztecProtocol/aztec-packages/blob/#include_aztec_version/aztec-nr/aztec/src/state_vars/set.nr).
...
#include_code storage-set-declaration /noir-contracts/contracts/docs_example_contract/src/main.nr rust
...
#include_code storage-set-init /noir-contracts/contracts/docs_example_contract/src/main.nr rust
...
#include_code insert /aztec-nr/easy-private-state/src/easy_private_state.nr rust
...
#include_code insert_from_public /noir-contracts/contracts/token_contract/src/main.nr rust
...
#include_code remove /aztec-nr/easy-private-state/src/easy_private_state.nr rust
...
#include_code view_notes /aztec-nr/value-note/src/balance_utils.nr rust

There's also a limit on the maximum number of notes that can be returned in one go. To find the current limit, refer to [this file](https://github.com/AztecProtocol/aztec-packages/blob/#include_aztec_version/noir-protocol-circuits/src/crates/types/src/constants.nr) and look for `MAX_NOTES_PER_PAGE`.
...
You can view the implementation [here](https://github.com/AztecProtocol/aztec-packages/blob/#include_aztec_version/aztec-nr/aztec/src/note/note_getter_options.nr).
...
#include_code state_vars-NoteGetterOptionsSelectSortOffset /noir-contracts/contracts/docs_example_contract/src/options.nr rust
...
#include_code state_vars-CardNote /noir-contracts/contracts/docs_example_contract/src/types/card_note.nr rust
...
#include_code state_vars-NoteGetterOptionsMultiSelects /noir-contracts/contracts/docs_example_contract/src/options.nr rust
...
#include_code state_vars-OptionFilter /noir-contracts/contracts/docs_example_contract/src/options.nr rust

We can use it as a filter to further reduce the number of the final notes:

#include_code state_vars-NoteGetterOptionsFilter /noir-contracts/contracts/docs_example_contract/src/options.nr rust
...
#include_code state_vars-NoteGetterOptionsPickOne /noir-contracts/contracts/docs_example_contract/src/options.nr rust
...
#include_code state_vars-NoteGetterOptionsComparatorExampleNoir /noir-contracts/contracts/docs_example_contract/src/main.nr rust
