...
#include_code storage-minters-declaration /noir-contracts/contracts/docs_example_contract/src/main.nr rust

And then when initializing it in the `Storage::init` function we can do it as follows:

#include_code storage-minters-init /noir-contracts/contracts/docs_example_contract/src/main.nr rust
...
#include_code read_admin /noir-contracts/contracts/token_contract/src/main.nr rust
...
#include_code read_minter /noir-contracts/contracts/token_contract/src/main.nr rust
...
#include_code write_admin /noir-contracts/contracts/token_contract/src/main.nr rust

#### Writing to our `minters` example

#include_code write_minter /noir-contracts/contracts/token_contract/src/main.nr rust
...
You can find the details of `StablePublicState` in the implementation [here](https://github.com/AztecProtocol/aztec-packages/blob/#include_aztec_version/aztec-nr/aztec/src/state_vars/stable_public_state.nr).

### `new`

Is done exactly like the `PublicState` struct, but with the `StablePublicState` struct.

#include_code storage-stable-declaration /noir-contracts/contracts/docs_example_contract/src/main.nr rust

#include_code storage-stable-init /noir-contracts/contracts/docs_example_contract/src/main.nr rust

### `initialize`

#include_code initialize_decimals /noir-contracts/contracts/token_contract/src/main.nr rust
...
#include_code read_decimals_public /noir-contracts/contracts/token_contract/src/main.nr rust

### `read_private`

Reading the value is like `PublicState`, simply with `read_private` instead of `read`. This part can only be executed in private.

#include_code read_decimals_private /noir-contracts/contracts/token_contract/src/main.nr rust
