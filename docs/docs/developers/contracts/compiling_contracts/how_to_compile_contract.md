...
Below is typescript code generated from the [Token](https://github.com/AztecProtocol/aztec-packages/blob/master/noir-contracts/contracts/token_contract/src/main.nr) contract:
...
Below is an example interface, also generated from the [Token](https://github.com/AztecProtocol/aztec-packages/blob/master/noir-contracts/contracts/token_contract/src/main.nr) contract:
