...
There are many common patterns have been devised by the Aztec core engineering team and the work of the external community as we build Aztec.nr contracts internally (see some of them [here](https://github.com/AztecProtocol/aztec-packages/tree/master/noir-contracts)).
...
#include_code assert_valid_authwit_public /aztec-nr/authwit/src/auth.nr rust
...
contract Bridge {
    ...
    fn burn_token_private(
        ...
        ...
    #include_code call_assert_token_is_same /noir-contracts/contracts/token_bridge_contract/src/main.nr raw
    }
    #include_code assert_token_is_same /noir-contracts/contracts/token_bridge_contract/src/main.nr raw
}
```
...
#include_code address_note_def aztec-nr/address-note/src/address_note.nr rust
...
#include_code compute_note_hash_and_nullifier_placeholder /noir-contracts/contracts/token_bridge_contract/src/main.nr rust
...
#include_code compute_note_hash_and_nullifier /noir-contracts/contracts/token_contract/src/main.nr rust
