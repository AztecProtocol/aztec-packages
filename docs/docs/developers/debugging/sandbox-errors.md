...
You can have a look at our current constants/limitations in [constants.nr](https://github.com/AztecProtocol/aztec-packages/blob/master/noir-protocol-circuits/src/crates/types/src/constants.nr)
