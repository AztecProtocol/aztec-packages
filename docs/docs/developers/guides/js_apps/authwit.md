...
This page assumes you have authwit set up correctly in your contract. To learn how to do that, [go here](../smart_contracts/how_to_use_authwit.md).
...
This is expected to be used alongside [private authwits in Aztec.nr contract](../smart_contracts/how_to_use_authwit.md#private-functions).
...
This is expected to be used alongside [public authwits in Aztec.nr contract](../smart_contracts/how_to_use_authwit.md#public-functions).
...
- [Authwits in Aztec.nr](../smart_contracts/how_to_use_authwit.md)
