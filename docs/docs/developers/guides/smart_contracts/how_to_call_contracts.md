...
:::info
Public functions always execute after private execution completes. Learn more in the [concepts overview](../../../aztec/index.md).
:::

### Use other call types

Explore additional call types for specialized use cases in the [call types reference](../../../aztec/concepts/call_types.md).
