...
tags: [aztec.nr]
sidebar_position: 0
description: Learn the fundamentals of writing smart contracts on Aztec using aztec.nr, including contract structure, storage, constructors, and function declarations.
---
