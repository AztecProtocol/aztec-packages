...
token_portal_content_hash_lib = { git="https://github.com/AztecProtocol/aztec-packages/", tag="#include_aztec_version", directory="noir-contracts/contracts/token_portal_content_hash_lib" }
```
