...
#include_code exit_to_l1_public /noir-contracts/contracts/token_bridge_contract/src/main.nr rust
...
#include_code assert_token_is_same /noir-contracts/contracts/token_bridge_contract/src/main.nr rust
...
#include_code read_token /noir-contracts/contracts/token_bridge_contract/src/main.nr rust

And the `compute_note_hash_and_nullifier` required on every contract:

```rust
#include_code compute_note_hash_and_nullifier_placeholder /noir-contracts/contracts/token_bridge_contract/src/main.nr raw
}
```
