...
Public function calls can be caught failing locally similar to how we catch private function calls. For this example, we use a [`TokenContract`](https://github.com/AztecProtocol/aztec-packages/blob/master/noir-contracts/contracts/token_contract/src/main.nr) instead of a private one.
...
#include_code value-note-def aztec-nr/value-note/src/value_note.nr rust
...
#include_code is-time-equal noir-contracts/contracts/test_contract/src/main.nr rust
