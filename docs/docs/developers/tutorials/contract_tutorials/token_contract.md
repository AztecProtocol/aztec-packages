...
```rust
#include_code start /docs/examples/tutorials/private_token_contract/src/main.nr raw
...
```rust
#include_code imports /docs/examples/tutorials/private_token_contract/src/main.nr raw
}
```
...
```rust
#include_code public_storage /docs/examples/tutorials/private_token_contract/src/main.nr raw
}
```
...
#include_code setup /docs/examples/tutorials/private_token_contract/src/main.nr rust
...
#include_code mint_public /docs/examples/tutorials/private_token_contract/src/main.nr rust
...
#include_code transfer_public /docs/examples/tutorials/private_token_contract/src/main.nr rust
...
#include_code transfer_ownership /docs/examples/tutorials/private_token_contract/src/main.nr rust
...
#include_code storage /docs/examples/tutorials/private_token_contract/src/main.nr rust
...
#include_code public_to_private /docs/examples/tutorials/private_token_contract/src/main.nr rust

And the helper function:

#include_code _deduct_public_balance /docs/examples/tutorials/private_token_contract/src/main.nr rust
...
#include_code transfer_private /docs/examples/tutorials/private_token_contract/src/main.nr rust
...
#include_code check_balances /docs/examples/tutorials/private_token_contract/src/main.nr rust
...
#include_code _assert_is_owner /docs/examples/tutorials/private_token_contract/src/main.nr rust
...
#include_code mint_private /docs/examples/tutorials/private_token_contract/src/main.nr rust
...
#include_code private_to_public /docs/examples/tutorials/private_token_contract/src/main.nr rust
