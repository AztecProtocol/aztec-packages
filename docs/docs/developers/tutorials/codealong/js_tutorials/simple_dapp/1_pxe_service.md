...
The [Aztec Sandbox](.././../../reference/environment_reference/sandbox-reference.md) runs a local PXE and an Aztec Node, both connected to a local Ethereum development node like Anvil.
...
Make sure the [Sandbox is running](../../../../developers/getting_started.md) and run the example
