...
The easiest way to compile the contract is with `aztec-nargo` and `aztec-compile-contract`. Run the following commands in the directory with your Nargo.toml file:
