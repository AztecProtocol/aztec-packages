---
title: Aztec Virtual Machine (AVM)
description: Introduction to the Aztec Virtual Machine used for public execution in the Aztec protocol
---
...
- **[Memory Model](./avm/memory)**: Learn about memory, storage, and type tags
- **[Addressing Modes](./avm/addressing)**: Understand direct, indirect, and relative addressing
- **[Wire Formats](./avm/wire-format)**: How instructions are encoded in bytecode
- **[Gas Metering](./avm/gas)**: Explore how gas costs are calculated and charged
- **[Instruction Set](./avm/isa)**: Complete reference for all AVM instructions
