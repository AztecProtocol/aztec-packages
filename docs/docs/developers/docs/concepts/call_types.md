...
For this reason it is encouraged to try to avoid public function calls and instead privately read [Shared State](../guides/aztec-nr/how_to_define_storage.md#delayed-public-mutable) when possible.
