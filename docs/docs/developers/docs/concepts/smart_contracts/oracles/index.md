...
Looking for a hands-on guide? You can learn how to use oracles in a smart contract [here](../../../guides/smart-contracts/advanced/how_to_use_capsules.md).
