...
The Aztec network consists of several types of nodes, each serving a specific purpose:
...
- You want to interact with the network in a privacy-preserving way
- You want to support the network infrastructure
- You need reliable, self-hosted access to network data
...
[Learn more about syncing best practices →](./syncing_best_practices.md)
...
- [Useful Commands](./reference/useful_commands.md) - Common operational commands
- [Operator FAQ](./reference/operator_faq.md) - Frequently asked questions for node operators
- [Reacting to Upgrades](./reference/reacting_to_upgrades.md) - How to handle network upgrades
