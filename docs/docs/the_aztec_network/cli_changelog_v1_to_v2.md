---
sidebar_position: 6
title: CLI reference changelog (v1.2.1 to v2.0.1)
description: Comprehensive changelog of configuration changes between Aztec CLI versions 1.2.1 and 2.0.1, covering removed options, new features, and behavioral changes.
---

This guide documents all configuration changes between Aztec CLI versions 1.2.1 and 2.0.1.
...
**Migration**: Create keystore directory, change singular to plural. Use `*_ADDRESSES` for remote signers. See [Advanced Keystore Guide](./advanced_keystore_guide.md).
...
```bash
# All removed in v2.0.1 (moved to sandbox only)
...
| Flag | Environment Variable | v1.2.1 | v2.0.1 |
|------|---------------------|--------|--------|
...
- See [Advanced Keystore Guide](./advanced_keystore_guide.md)
...
- [How to Run a Sequencer Node](./guides/run_nodes/how_to_run_sequencer.md) - Updated setup instructions
- [Advanced Keystore Usage](./advanced_keystore_guide.md) - Keystore configuration
