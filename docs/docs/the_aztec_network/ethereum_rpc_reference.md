---
sidebar_position: 5
title: Ethereum RPC calls used by Aztec nodes
description: A comprehensive reference of Ethereum RPC calls used by different Aztec node components, including archiver, sequencer, prover, validator, and slasher nodes.
---
