...
After starting your bootnode, you'll need to obtain its ENR to share with others. Check your node's logs for the ENR output, which will be displayed during startup.
