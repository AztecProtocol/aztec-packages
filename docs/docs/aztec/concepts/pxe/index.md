...
- [Run more than one PXE on your local machine](../../../build/guides/local_env/run_more_than_one_pxe_sandbox.md)
- [Use in-built oracles including oracles for arbitrary data](../../../build/guides/smart_contracts/writing_contracts/how_to_pop_capsules.md)
