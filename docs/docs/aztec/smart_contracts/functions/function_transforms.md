...
- They can be used to generate bindings for interacting with the contract (read [here](../../../build/guides/smart_contracts/how_to_compile_contract.md) to learn how to create TypeScript bindings)
