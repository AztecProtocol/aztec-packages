...
Aztec-nargo and aztec CLI are command-line tool allowing you to compile smart contracts. See the [compiling contracts](../../guides/developer_guides/smart_contracts/how_to_compile_contract.md) page for more information.