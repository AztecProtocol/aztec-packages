...
- Components of the private context, such as inputs, historical block data, and contract deployment data
...
Another structure that is contained within the context is the Historical Block Data object. This object is a special one as it contains all of the roots of Aztec's data trees.

#include_code historical-block-data /yarn-project/aztec-nr/aztec/src/abi.nr rust
