...
As an app developer, the [Aztec RPC Server interface](../api/main) provides you with access to the user's accounts and their private state, as well as a connection to the network for accessing public global state.
