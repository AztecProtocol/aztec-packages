...
You cannot call a private function from a public function, but you can use a [slow updates tree](../../concepts/foundation/communication/public_private_calls/slow_updates_tree.md) to read historic public state and stage writes to public state from a private function. 
