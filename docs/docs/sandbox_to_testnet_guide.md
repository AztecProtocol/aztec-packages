...
The testnet is version dependent. It is currently running version `<AlphaTestnetVersion />`. Maintain version consistency when interacting with the testnet to reduce errors.
