...
**Migration**: Create keystore directory, change singular to plural. Use `*_ADDRESSES` for remote signers. See [Advanced Keystore Guide](../../keystore/).
...
- See [Advanced Keystore Guide](../../keystore/)
...
- [How to Run a Sequencer Node](../../setup/sequencer-setup.md) - Updated setup instructions
- [Advanced Keystore Usage](../../keystore/) - Keystore configuration
- [Ethereum RPC Calls Reference](../ethereum-rpc-reference.md) - Infrastructure requirements
