...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251228/noir-projects/aztec-nr/uint-note/src/uint_note.nr#L27-L34" target="_blank" rel="noopener noreferrer">Source code: noir-projects/aztec-nr/uint-note/src/uint_note.nr#L27-L34</a></sub></sup>
...
The [lifecycle module](https://github.com/AztecProtocol/aztec-packages/tree/v3.0.0-nightly.20251228/noir-projects/aztec-nr/aztec/src/note/lifecycle.nr) contains functions for note management:
...
Notes must implement the `NoteHash` trait from [note_interface.nr](https://github.com/AztecProtocol/aztec-packages/tree/v3.0.0-nightly.20251228/noir-projects/aztec-nr/aztec/src/note/note_interface.nr):
