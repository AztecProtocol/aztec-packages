...
For the complete list of AVM opcodes, see the [AVM ISA Quick Reference](https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-rc.2/yarn-project/simulator/docs/avm/avm-isa-quick-reference.md).
