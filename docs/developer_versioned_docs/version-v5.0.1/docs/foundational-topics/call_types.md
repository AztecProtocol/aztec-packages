...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.1/noir-projects/noir-contracts/contracts/app/lending_contract/src/main.nr#L104-L106" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/lending_contract/src/main.nr#L104-L106</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.1/noir-projects/aztec-nr/aztec/src/public_checks.nr#L29-L38" target="_blank" rel="noopener noreferrer">Source code: noir-projects/aztec-nr/aztec/src/public_checks.nr#L29-L38</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.1/noir-projects/aztec-nr/aztec/src/public_checks.nr#L6-L40" target="_blank" rel="noopener noreferrer">Source code: noir-projects/aztec-nr/aztec/src/public_checks.nr#L6-L40</a></sub></sup>
...
```toml
[dependencies]
public_checks = { git = "https://github.com/AztecProtocol/aztec-packages/", tag = "v5.0.1", directory = "noir-projects/noir-contracts/contracts/standard/public_checks_contract" }
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.1/noir-projects/noir-contracts/contracts/fees/fpc_contract/src/main.nr#L153-L160" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/fees/fpc_contract/src/main.nr#L153-L160</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.1/yarn-project/end-to-end/src/automine/card_game.test.ts#L128-L130" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/automine/card_game.test.ts#L128-L130</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.1/yarn-project/end-to-end/src/automine/token/crowdfunding_and_claim.test.ts#L222-L226" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/automine/token/crowdfunding_and_claim.test.ts#L222-L226</a></sub></sup>
