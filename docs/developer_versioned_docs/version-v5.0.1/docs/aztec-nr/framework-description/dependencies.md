...
```toml
address_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v5.0.1", directory="address-note" }
```
...
```toml
field_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v5.0.1", directory="field-note" }
```
...
```toml
uint_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v5.0.1", directory="uint-note" }
```
...
```toml
balance_set = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v5.0.1", directory="balance-set" }
```
...
```toml
compressed_string = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v5.0.1", directory="compressed-string" }
```
...
For example, if your CLI is `vv5.0.1`, change:
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-nr/", tag="vv5.0.1", directory="aztec" }
```
