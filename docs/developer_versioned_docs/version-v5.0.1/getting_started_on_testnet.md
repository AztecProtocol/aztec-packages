...
:::warning
Testnet is version-dependent. It is currently running version `5.0.1`. Maintain version consistency when interacting with the testnet to avoid errors.
:::
...
export SPONSORED_FPC_ADDRESS=0x1441491b59934ec64f8c98f17c91f23c01ca2a45dbb35caf123146ec76f9970c
```
