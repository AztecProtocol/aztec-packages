...
```bash
npm install @aztec/aztec.js@5.0.0-nightly.20260308
```
...
```bash
npm install @aztec/aztec.js@5.0.0-nightly.20260308 \
  @aztec/accounts@5.0.0-nightly.20260308 \
  @aztec/wallets@5.0.0-nightly.20260308 \
  @aztec/noir-contracts.js@5.0.0-nightly.20260308
```
