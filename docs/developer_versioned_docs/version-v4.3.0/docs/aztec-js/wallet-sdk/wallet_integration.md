...
- `BaseWallet` source: [`yarn-project/wallet-sdk/src/base-wallet/base_wallet.ts`](https://github.com/AztecProtocol/aztec-packages/blob/v4.3.0/yarn-project/wallet-sdk/src/base-wallet/base_wallet.ts) at v4.3.0.
- `BackgroundConnectionHandler` source: [`yarn-project/wallet-sdk/src/extension/handlers/background_connection_handler.ts`](https://github.com/AztecProtocol/aztec-packages/blob/v4.3.0/yarn-project/wallet-sdk/src/extension/handlers/background_connection_handler.ts) at v4.3.0.
- Wallet SDK README at v4.3.0: [`yarn-project/wallet-sdk/README.md`](https://github.com/AztecProtocol/aztec-packages/blob/v4.3.0/yarn-project/wallet-sdk/README.md).
