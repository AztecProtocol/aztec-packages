...
- Capability type definitions: [`yarn-project/aztec.js/src/wallet/capabilities.ts`](https://github.com/AztecProtocol/aztec-packages/blob/v4.3.0/yarn-project/aztec.js/src/wallet/capabilities.ts) at v4.3.0.
- `WalletManager` source: [`yarn-project/wallet-sdk/src/manager/wallet_manager.ts`](https://github.com/AztecProtocol/aztec-packages/blob/v4.3.0/yarn-project/wallet-sdk/src/manager/wallet_manager.ts) at v4.3.0.
