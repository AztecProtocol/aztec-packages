...
```toml
compressed_string = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.3.0", directory="compressed-string" }
```
...
For example, if your CLI is `vv4.3.0`, change:
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-nr/", tag="vv4.3.0", directory="aztec" }
```
