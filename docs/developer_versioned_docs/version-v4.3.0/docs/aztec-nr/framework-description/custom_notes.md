...
```toml
# In Nargo.toml
uint_note = { git="https://github.com/AztecProtocol/aztec-nr", tag="v4.3.0", directory="uint-note" }
```
...
```toml
# In Nargo.toml
field_note = { git="https://github.com/AztecProtocol/aztec-nr", tag="v4.3.0", directory="field-note" }
```
...
```toml
# In Nargo.toml
address_note = { git="https://github.com/AztecProtocol/aztec-nr", tag="v4.3.0", directory="address-note" }
```
...
#[external("utility")]
unconstrained fn get_private_nfts(owner: AztecAddress, page_index: u32) -> ([Field; MAX_NOTES_PER_PAGE], bool) {
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.3.0/noir-projects/noir-contracts/contracts/app/nft_contract/src/main.nr#L255-L272" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/nft_contract/src/main.nr#L255-L272</a></sub></sup>
