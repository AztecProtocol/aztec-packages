...
This tutorial is compatible with the Aztec version `v4.3.0`. Install the correct version with `VERSION=4.3.0 bash -i <(curl -sL https://install.aztec.network/4.3.0/aztec-install)`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
