...
```bash
npm install @aztec/aztec.js@4.0.0-nightly.20260208
```
...
```bash
npm install @aztec/aztec.js@4.0.0-nightly.20260208 \
  @aztec/accounts@4.0.0-nightly.20260208 \
  @aztec/test-wallet@4.0.0-nightly.20260208 \
  @aztec/noir-contracts.js@4.0.0-nightly.20260208
```
