...
```toml
protocol = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v4.0.0-nightly.20260208", directory="noir-projects/noir-protocol-circuits/crates/types"}
```
...
```toml
field_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.0.0-nightly.20260208", directory="field-note" }
```
...
```toml
uint_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.0.0-nightly.20260208", directory="uint-note" }
```
...
```toml
compressed_string = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.0.0-nightly.20260208", directory="compressed-string" }
```
