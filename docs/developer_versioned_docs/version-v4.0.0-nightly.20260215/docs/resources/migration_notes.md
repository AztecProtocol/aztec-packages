...
For example, to install version `4.0.0-nightly.20260215`:
```bash
VERSION=4.0.0-nightly.20260215 bash -i <(curl -sL https://install.aztec.network/4.0.0-nightly.20260215)
```
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v4.0.0-nightly.20260215", directory="yarn-project/aztec-nr/aztec" }
```
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v4.0.0-nightly.20260215", directory="yarn-project/aztec-nr/aztec" }
protocol = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v4.0.0-nightly.20260215", directory="yarn-project/noir-protocol-circuits/crates/types"}
```
