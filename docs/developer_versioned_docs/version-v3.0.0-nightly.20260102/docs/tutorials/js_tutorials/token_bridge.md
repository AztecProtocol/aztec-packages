...
Before starting, make sure you have the Aztec local network running at version v3.0.0-nightly.20260102. Check out [the local network guide](../../../getting_started_on_local_network.md) for setup instructions.
...
yarn add @aztec/aztec.js@3.0.0-nightly.20260102 @aztec/accounts@3.0.0-nightly.20260102 @aztec/stdlib@3.0.0-nightly.20260102 @aztec/test-wallet@3.0.0-nightly.20260102 tsx
```
...
```toml
[dependencies]
aztec = { git = "https://github.com/AztecProtocol/aztec-nr", tag = "v3.0.0-nightly.20260102", directory = "aztec" }
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/nft.nr#L1-L9" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/nft.nr#L1-L9</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/main.nr#L44-L50" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/main.nr#L44-L50</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/main.nr#L69-L75" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/main.nr#L69-L75</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/main.nr#L36-L42" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/main.nr#L36-L42</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/main.nr#L52-L67" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/main.nr#L52-L67</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/main.nr#L77-L94" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/main.nr#L77-L94</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft_bridge/src/main.nr#L52-L65" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft_bridge/src/main.nr#L52-L65</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/contracts/NFTPortal.sol#L35-L69" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/contracts/NFTPortal.sol#L35-L69</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L3-L57" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L3-L57</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L59-L82" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L59-L82</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L84-L97" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L84-L97</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L99-L115" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L99-L115</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L117-L131" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L117-L131</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L133-L148" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L133-L148</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L150-L176" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L150-L176</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L178-L200" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L178-L200</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L202-L211" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L202-L211</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L213-L237" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L213-L237</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L239-L260" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L239-L260</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L262-L317" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L262-L317</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20260102/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L319-L334" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L319-L334</a></sub></sup>
