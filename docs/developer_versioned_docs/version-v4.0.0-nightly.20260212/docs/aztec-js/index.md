...
```bash
npm install @aztec/aztec.js@4.0.0-nightly.20260212
```
...
```bash
npm install @aztec/aztec.js@4.0.0-nightly.20260212 \
  @aztec/accounts@4.0.0-nightly.20260212 \
  @aztec/wallets@4.0.0-nightly.20260212 \
  @aztec/noir-contracts.js@4.0.0-nightly.20260212
```
