...
- Current version: `v4.0.0-nightly.20260212`
- Update with `aztec-up 4.0.0-nightly.20260212`
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v4.0.0-nightly.20260212/noir-projects/noir-contracts/contracts).
...
+value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v4.0.0-nightly.20260212", directory="noir-projects/aztec-nr/value-note" }
```
...
+"@aztec/accounts": "v4.0.0-nightly.20260212",
