...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.2.0/docs/examples/webapp-tutorial/vite.config.ts#L1-L56" target="_blank" rel="noopener noreferrer">Source code: docs/examples/webapp-tutorial/vite.config.ts#L1-L56</a></sub></sup>
