...
```rust title="logging_imports" showLineNumbers 
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.2.0/docs/examples/contracts/logging_example/src/main.nr#L5-L11" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/logging_example/src/main.nr#L5-L11</a></sub></sup>
...
```rust title="log_all_levels" showLineNumbers 
#[external("private")]
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.2.0/docs/examples/contracts/logging_example/src/main.nr#L48-L66" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/logging_example/src/main.nr#L48-L66</a></sub></sup>
...
```rust title="log_simple" showLineNumbers 
// Simple messages (no arguments)
info_log("Private function called");
debug_log("Checkpoint reached in private function");
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.2.0/docs/examples/contracts/logging_example/src/main.nr#L23-L27" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/logging_example/src/main.nr#L23-L27</a></sub></sup>
...
```rust title="log_format_patterns" showLineNumbers 
#[external("private")]
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.2.0/docs/examples/contracts/logging_example/src/main.nr#L68-L80" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/logging_example/src/main.nr#L68-L80</a></sub></sup>


:::note
Format arguments must be `Field` values. Use `.to_field()` to convert addresses and other types:

```rust title="log_address" showLineNumbers 
#[external("private")]
fn log_with_address(sender: AztecAddress) {
    info_log_format("Sender: {0}", [sender.to_field()]);
}
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.2.0/docs/examples/contracts/logging_example/src/main.nr#L33-L38" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/logging_example/src/main.nr#L33-L38</a></sub></sup>
...
```rust title="log_public" showLineNumbers 
#[external("public")]
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.2.0/docs/examples/contracts/logging_example/src/main.nr#L40-L46" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/logging_example/src/main.nr#L40-L46</a></sub></sup>
