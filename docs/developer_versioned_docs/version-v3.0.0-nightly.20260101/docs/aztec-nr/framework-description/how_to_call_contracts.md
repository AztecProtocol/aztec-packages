...
```toml
[dependencies]
token = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v3.0.0-nightly.20260101", directory="noir-projects/noir-contracts/contracts/app/token_contract" }
```
