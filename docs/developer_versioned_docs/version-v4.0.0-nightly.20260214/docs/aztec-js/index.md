...
```bash
npm install @aztec/aztec.js@4.0.0-nightly.20260214
```
...
```bash
npm install @aztec/aztec.js@4.0.0-nightly.20260214 \
  @aztec/accounts@4.0.0-nightly.20260214 \
  @aztec/wallets@4.0.0-nightly.20260214 \
  @aztec/noir-contracts.js@4.0.0-nightly.20260214
```
