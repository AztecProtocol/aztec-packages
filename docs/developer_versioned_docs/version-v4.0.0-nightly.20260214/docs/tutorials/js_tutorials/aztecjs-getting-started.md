...
Before starting, make sure to be running Aztec local network at version 4.0.0-nightly.20260214. Check out [the guide](../../tutorials/local_network.md) for info about that.
...
```sh
yarn add @aztec/aztec.js@4.0.0-nightly.20260214 @aztec/accounts@4.0.0-nightly.20260214 @aztec/noir-contracts.js@4.0.0-nightly.20260214 @aztec/wallets@4.0.0-nightly.20260214
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260214/docs/examples/ts/aztecjs_getting_started/index.ts#L1-L11" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L1-L11</a></sub></sup>
...
Now that we have our accounts loaded, let's deploy a pre-compiled token contract from the Aztec library. You can find the full code for the contract [here (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v4.0.0-nightly.20260214/noir-projects/noir-contracts/contracts/app/token_contract/src).
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260214/docs/examples/ts/aztecjs_getting_started/index.ts#L13-L23" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L13-L23</a></sub></sup>
...
await token.methods
  ...
  .send({ from: alice.address });
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260214/docs/examples/ts/aztecjs_getting_started/index.ts#L25-L29" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L25-L29</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260214/docs/examples/ts/aztecjs_getting_started/index.ts#L31-L40" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L31-L40</a></sub></sup>
...
console.log(`Bob's balance: ${bobBalance}`);
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260214/docs/examples/ts/aztecjs_getting_started/index.ts#L42-L48" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L42-L48</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260214/docs/examples/ts/aztecjs_getting_started/index.ts#L50-L52" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L50-L52</a></sub></sup>
...
console.log(`Bob's balance: ${bobBalance}`);
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260214/docs/examples/ts/aztecjs_getting_started/index.ts#L54-L62" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L54-L62</a></sub></sup>
