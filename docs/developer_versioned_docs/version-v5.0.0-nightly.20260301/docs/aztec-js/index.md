...
```bash
npm install @aztec/aztec.js@5.0.0-nightly.20260301
```
...
```bash
npm install @aztec/aztec.js@5.0.0-nightly.20260301 \
  @aztec/accounts@5.0.0-nightly.20260301 \
  @aztec/wallets@5.0.0-nightly.20260301 \
  @aztec/noir-contracts.js@5.0.0-nightly.20260301
```
