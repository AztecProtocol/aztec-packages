...
- Current version: `v5.0.0-nightly.20260301`
- Update with `aztec-up 5.0.0-nightly.20260301`
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v5.0.0-nightly.20260301/noir-projects/noir-contracts/contracts).
...
+aztec = { git="https://github.com/AztecProtocol/aztec-packages", tag="v5.0.0-nightly.20260301", directory="noir-projects/aztec-nr/aztec" }
-value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v0.7.5", directory="noir-projects/aztec-nr/value-note" }
+value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v5.0.0-nightly.20260301", directory="noir-projects/aztec-nr/value-note" }
```
...
+"@aztec/accounts": "v5.0.0-nightly.20260301",
