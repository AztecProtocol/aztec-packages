...
```toml
compressed_string = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v5.0.0-rc.1", directory="compressed-string" }
```
...
For example, if your CLI is `vv5.0.0-rc.1`, change:
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-nr/", tag="vv5.0.0-rc.1", directory="aztec" }
```
