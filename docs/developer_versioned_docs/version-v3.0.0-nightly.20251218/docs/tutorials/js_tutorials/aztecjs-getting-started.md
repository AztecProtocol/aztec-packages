...
Before starting, make sure to be running Aztec local network at version 3.0.0-nightly.20251218. Check out [the guide](../../tutorials/local_network.md) for info about that.
...
```sh
yarn add @aztec/aztec.js@3.0.0-nightly.20251218 @aztec/accounts@3.0.0-nightly.20251218 @aztec/noir-contracts.js@3.0.0-nightly.20251218
```
