...
- Current version: `v3.0.0-nightly.20251227`
- Update with `aztec-up 3.0.0-nightly.20251227`
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v3.0.0-nightly.20251227/noir-projects/noir-contracts/contracts).
...
+aztec = { git="https://github.com/AztecProtocol/aztec-packages", tag="v3.0.0-nightly.20251227", directory="noir-projects/aztec-nr/aztec" }
-value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v0.7.5", directory="noir-projects/aztec-nr/value-note" }
+value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v3.0.0-nightly.20251227", directory="noir-projects/aztec-nr/value-note" }
```
...
+"@aztec/accounts": "v3.0.0-nightly.20251227",
