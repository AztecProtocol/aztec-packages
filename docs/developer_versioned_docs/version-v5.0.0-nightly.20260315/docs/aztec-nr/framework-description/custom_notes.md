...
```toml
# In Nargo.toml
uint_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v5.0.0-nightly.20260315", directory="noir-projects/aztec-nr/uint-note" }
```
...
```toml
# In Nargo.toml
field_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v5.0.0-nightly.20260315", directory="noir-projects/aztec-nr/field-note" }
```
