...
- Current version: `v5.0.0-nightly.20260303`
- Update with `aztec-up 5.0.0-nightly.20260303`
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v5.0.0-nightly.20260303/noir-projects/noir-contracts/contracts).
...
+value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v5.0.0-nightly.20260303", directory="noir-projects/aztec-nr/value-note" }
```
...
+"@aztec/accounts": "v5.0.0-nightly.20260303",
