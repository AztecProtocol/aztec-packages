...
For example, to install version `5.0.0-nightly.20260303`:
```bash
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v5.0.0-nightly.20260303", directory="yarn-project/aztec-nr/aztec" }
```
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v5.0.0-nightly.20260303", directory="yarn-project/aztec-nr/aztec" }
protocol = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v5.0.0-nightly.20260303", directory="yarn-project/noir-protocol-circuits/crates/types"}
```
