...
For example, to install version `5.0.0-nightly.20260309`:
```bash
VERSION=5.0.0-nightly.20260309 bash -i <(curl -sL https://install.aztec.network/5.0.0-nightly.20260309)
```
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v5.0.0-nightly.20260309", directory="yarn-project/aztec-nr/aztec" }
```
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v5.0.0-nightly.20260309", directory="yarn-project/aztec-nr/aztec" }
protocol = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v5.0.0-nightly.20260309", directory="yarn-project/noir-protocol-circuits/crates/types"}
```
