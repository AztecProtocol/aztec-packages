...
The [lifecycle module](https://github.com/AztecProtocol/aztec-packages/tree/v5.0.0-nightly.20260317/noir-projects/aztec-nr/aztec/src/note/lifecycle.nr) contains functions for note management:
...
Notes must implement the `NoteHash` trait from [note_interface.nr](https://github.com/AztecProtocol/aztec-packages/tree/v5.0.0-nightly.20260317/noir-projects/aztec-nr/aztec/src/note/note_interface.nr):
