...
This tutorial is compatible with the Aztec version `v5.0.0-nightly.20260312`. Install the correct version with `VERSION=5.0.0-nightly.20260312 bash -i <(curl -sL https://install.aztec.network/5.0.0-nightly.20260312)`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
...
balance_set = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v5.0.0-nightly.20260312", directory="balance-set" }
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260312/docs/examples/contracts/counter_contract/src/main.nr#L7-L16" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/counter_contract/src/main.nr#L7-L16</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260312/docs/examples/contracts/counter_contract/src/main.nr#L18-L23" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/counter_contract/src/main.nr#L18-L23</a></sub></sup>
