...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v3.0.0-nightly.20251223", directory="noir-projects/aztec-nr/aztec" }
```
...
```toml
address_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v3.0.0-nightly.20251223", directory="noir-projects/aztec-nr/address-note" }
```
...
```toml
easy_private_state = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v3.0.0-nightly.20251223", directory="noir-projects/aztec-nr/easy-private-state" }
```
...
```toml
protocol_types = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v3.0.0-nightly.20251223", directory="noir-projects/noir-protocol-circuits/crates/types"}
```
...
```toml
value_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v3.0.0-nightly.20251223", directory="noir-projects/aztec-nr/value-note" }
```
