...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.3.0-rc.1/yarn-project/stdlib/src/gas/gas_settings.ts#L26-L35" target="_blank" rel="noopener noreferrer">Source code: yarn-project/stdlib/src/gas/gas_settings.ts#L26-L35</a></sub></sup>
