...
```toml
address_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.3.0-rc.1", directory="address-note" }
```
...
```toml
field_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.3.0-rc.1", directory="field-note" }
```
...
```toml
uint_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.3.0-rc.1", directory="uint-note" }
```
...
```toml
compressed_string = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.3.0-rc.1", directory="compressed-string" }
```
...
For example, if your CLI is `vv4.3.0-rc.1`, change:
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-nr/", tag="vv4.3.0-rc.1", directory="aztec" }
```
