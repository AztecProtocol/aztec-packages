...
```toml
protocol = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v4.2.0", directory="noir-projects/noir-protocol-circuits/crates/types"}
```
...
```toml
address_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v4.2.0", directory="noir-projects/aztec-nr/address-note" }
```
...
```toml
field_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.2.0", directory="field-note" }
```
...
```toml
compressed_string = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.2.0", directory="compressed-string" }
```
