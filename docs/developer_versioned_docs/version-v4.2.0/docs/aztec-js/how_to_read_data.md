...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.2.0/docs/examples/ts/aztecjs_connection/index.ts#L144-L150" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_connection/index.ts#L144-L150</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.2.0/docs/examples/ts/aztecjs_advanced/index.ts#L326-L333" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L326-L333</a></sub></sup>
...
const { result: privateBalance } = await token.methods
  ...
  .simulate({ from: aliceAddress });
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.2.0/docs/examples/ts/aztecjs_advanced/index.ts#L431-L436" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L431-L436</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.2.0/docs/examples/ts/aztecjs_advanced/index.ts#L335-L341" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L335-L341</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.2.0/docs/examples/ts/aztecjs_advanced/index.ts#L400-L406" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L400-L406</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.2.0/docs/examples/ts/aztecjs_advanced/index.ts#L422-L424" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L422-L424</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.2.0/yarn-project/end-to-end/src/e2e_event_logs.test.ts#L140-L157" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_event_logs.test.ts#L140-L157</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.2.0/docs/examples/ts/aztecjs_advanced/index.ts#L426-L429" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L426-L429</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.2.0/yarn-project/end-to-end/src/e2e_event_logs.test.ts#L71-L90" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_event_logs.test.ts#L71-L90</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.2.0/docs/examples/ts/aztecjs_advanced/index.ts#L277-L306" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L277-L306</a></sub></sup>
