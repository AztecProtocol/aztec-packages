...
```toml
[dependencies]
token = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v5.0.0-nightly.20260302", directory="noir-projects/noir-contracts/contracts/app/token_contract" }
```
