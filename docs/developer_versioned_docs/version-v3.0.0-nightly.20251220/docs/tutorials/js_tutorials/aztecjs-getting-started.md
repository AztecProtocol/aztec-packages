...
Before starting, make sure to be running Aztec local network at version 3.0.0-nightly.20251220. Check out [the guide](../../tutorials/local_network.md) for info about that.
...
```sh
yarn add @aztec/aztec.js@3.0.0-nightly.20251220 @aztec/accounts@3.0.0-nightly.20251220 @aztec/noir-contracts.js@3.0.0-nightly.20251220 @aztec/test-wallet@3.0.0-nightly.20251220
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251220/docs/examples/ts/aztecjs_getting_started/index.ts#L1-L13" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L1-L13</a></sub></sup>
...
Now that we have our accounts loaded, let's deploy a pre-compiled token contract from the Aztec library. You can find the full code for the contract [here (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v3.0.0-nightly.20251220/noir-projects/noir-contracts/contracts/app/token_contract/src).
...
const token = await TokenContract.deploy(
  ...
  .deployed();
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251220/docs/examples/ts/aztecjs_getting_started/index.ts#L15-L27" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L15-L27</a></sub></sup>
...
await token.methods
  ...
  .wait();
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251220/docs/examples/ts/aztecjs_getting_started/index.ts#L29-L34" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L29-L34</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251220/docs/examples/ts/aztecjs_getting_started/index.ts#L36-L45" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L36-L45</a></sub></sup>
...
console.log(`Bob's balance: ${bobBalance}`);
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251220/docs/examples/ts/aztecjs_getting_started/index.ts#L47-L56" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L47-L56</a></sub></sup>
...
await token.methods
  ...
  .wait();
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251220/docs/examples/ts/aztecjs_getting_started/index.ts#L58-L63" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L58-L63</a></sub></sup>
...
console.log(`Bob's balance: ${bobBalance}`);
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251220/docs/examples/ts/aztecjs_getting_started/index.ts#L65-L74" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_getting_started/index.ts#L65-L74</a></sub></sup>
