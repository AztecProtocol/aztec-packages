...
const contract = await StatefulTestContract.deploy(wallet, owner, 42)
  ...
  .deployed();
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260111/yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L42-L46" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L42-L46</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260111/yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L61-L64" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L61-L64</a></sub></sup>
...
const token = await TokenContract.deploy(wallet, owner, 'TOKEN', 'TKN', 18)
  ...
  .deployed();
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260111/yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L72-L76" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L72-L76</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260111/yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L51-L55" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L51-L55</a></sub></sup>
