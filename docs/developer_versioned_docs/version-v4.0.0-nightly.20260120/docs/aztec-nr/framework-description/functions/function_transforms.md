...
- [Aztec.nr macro source code](https://github.com/AztecProtocol/aztec-packages/tree/v4.0.0-nightly.20260120/noir-projects/aztec-nr/aztec/src/macros) - for those who want to see the actual transformation implementation
