...
The complete code for this tutorial is available in the [docs/examples](https://github.com/AztecProtocol/aztec-packages/tree/v5.0.0-nightly.20260318/docs/examples) directory. Clone it to follow along or use it as a reference.
:::
...
- Aztec CLI (version v5.0.0-nightly.20260318)
- Nargo
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260318/docs/examples/circuits/hello_circuit/src/main.nr#L1-L10" target="_blank" rel="noopener noreferrer">Source code: docs/examples/circuits/hello_circuit/src/main.nr#L1-L10</a></sub></sup>
...
[dependencies]
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260318/docs/examples/circuits/hello_circuit/Nargo.toml#L1-L8" target="_blank" rel="noopener noreferrer">Source code: docs/examples/circuits/hello_circuit/Nargo.toml#L1-L8</a></sub></sup>
...
bb_proof_verification = { git = "https://github.com/AztecProtocol/aztec-packages/", tag = "v5.0.0-nightly.20260318", directory = "barretenberg/noir/bb_proof_verification" }
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260318/docs/examples/contracts/recursive_verification_contract/src/main.nr#L1-L78" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/recursive_verification_contract/src/main.nr#L1-L78</a></sub></sup>
...
```json
{
  ...
  "dependencies": {
    "@aztec/accounts": "5.0.0-nightly.20260318",
    "@aztec/aztec.js": "5.0.0-nightly.20260318",
    "@aztec/bb.js": "5.0.0-nightly.20260318",
    "@aztec/kv-store": "5.0.0-nightly.20260318",
    "@aztec/noir-contracts.js": "5.0.0-nightly.20260318",
    "@aztec/noir-noir_js": "5.0.0-nightly.20260318",
    "@aztec/pxe": "5.0.0-nightly.20260318",
    "@aztec/wallets": "5.0.0-nightly.20260318",
    "tsx": "^4.20.6"
  },
  "devDependencies": {
    "@types/node": "^22.0.0"
...
exit();
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260318/docs/examples/ts/recursive_verification/scripts/generate_data.ts#L1-L74" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/recursive_verification/scripts/generate_data.ts#L1-L74</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260318/docs/examples/ts/recursive_verification/index.ts#L1-L123" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/recursive_verification/index.ts#L1-L123</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260318/docs/examples/ts/recursive_verification/scripts/sponsored_fpc.ts#L1-L16" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/recursive_verification/scripts/sponsored_fpc.ts#L1-L16</a></sub></sup>
...
If you want to run all commands at once, or if you're starting fresh, here's the complete workflow. You can also reference the [full working example](https://github.com/AztecProtocol/aztec-packages/tree/v5.0.0-nightly.20260318/docs/examples) in the main repository.
