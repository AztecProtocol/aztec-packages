...
- [Aztec.nr macro source code](https://github.com/AztecProtocol/aztec-packages/tree/v5.0.0-nightly.20260318/noir-projects/aztec-nr/aztec/src/macros) - for those who want to see the actual transformation implementation
