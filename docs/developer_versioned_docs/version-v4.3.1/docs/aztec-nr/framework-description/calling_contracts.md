...
```toml
[dependencies]
token = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v4.3.1", directory="noir-projects/noir-contracts/contracts/app/token_contract" }
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.3.1/noir-projects/noir-contracts/contracts/app/lending_contract/src/main.nr#L218-L220" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/lending_contract/src/main.nr#L218-L220</a></sub></sup>
