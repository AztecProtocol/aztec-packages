...
For the complete list of AVM opcodes, see the [AVM ISA Quick Reference](https://github.com/AztecProtocol/aztec-packages/blob/v4.3.1/yarn-project/simulator/docs/avm/avm-isa-quick-reference.md).
