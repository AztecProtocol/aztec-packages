...
**Links**: [Interface](https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.1-patch.0/l1-contracts/src/core/interfaces/messagebridge/IInbox.sol), [Implementation](https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.1-patch.0/l1-contracts/src/core/messagebridge/Inbox.sol).
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.1-patch.0/l1-contracts/src/core/interfaces/messagebridge/IInbox.sol#L35-L48" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/src/core/interfaces/messagebridge/IInbox.sol#L35-L48</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.1-patch.0/l1-contracts/src/core/interfaces/messagebridge/IInbox.sol#L50-L62" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/src/core/interfaces/messagebridge/IInbox.sol#L50-L62</a></sub></sup>
