...
```toml
protocol = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v4.0.0-devnet.1-patch.0", directory="noir-projects/noir-protocol-circuits/crates/types"}
```
...
```toml
field_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.0.0-devnet.1-patch.0", directory="field-note" }
```
...
```toml
uint_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.0.0-devnet.1-patch.0", directory="uint-note" }
```
...
```toml
balance_set = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.0.0-devnet.1-patch.0", directory="balance-set" }
```
...
```toml
compressed_string = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.0.0-devnet.1-patch.0", directory="compressed-string" }
```
