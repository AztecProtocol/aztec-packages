...
- See all `TestEnvironment` methods [here](https://github.com/AztecProtocol/aztec-packages/blob/4.1.3/noir-projects/aztec-nr/aztec/src/test/helpers/test_environment.nr)
