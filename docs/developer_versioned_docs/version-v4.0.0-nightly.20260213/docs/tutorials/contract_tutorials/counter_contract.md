...
This tutorial is compatible with the Aztec version `v4.0.0-nightly.20260213`. Install the correct version with `VERSION=4.0.0-nightly.20260213 bash -i <(curl -sL https://install.aztec.network/4.0.0-nightly.20260213)`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260213/docs/examples/contracts/counter_contract/src/main.nr#L18-L23" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/counter_contract/src/main.nr#L18-L23</a></sub></sup>
