...
- See all `TestEnvironment` methods [here](https://github.com/AztecProtocol/aztec-packages/blob/v3.0.4/noir-projects/aztec-nr/aztec/src/test/helpers/test_environment.nr)
