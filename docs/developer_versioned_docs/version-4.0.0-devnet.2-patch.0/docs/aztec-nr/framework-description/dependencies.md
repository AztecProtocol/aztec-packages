...
```toml
protocol = { git="https://github.com/AztecProtocol/aztec-packages/", tag="4.0.0-devnet.2-patch.0", directory="noir-projects/noir-protocol-circuits/crates/types"}
```
...
```toml
address_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="4.0.0-devnet.2-patch.0", directory="noir-projects/aztec-nr/address-note" }
```
...
```toml
field_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="4.0.0-devnet.2-patch.0", directory="field-note" }
```
...
```toml
uint_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="4.0.0-devnet.2-patch.0", directory="uint-note" }
```
...
```toml
compressed_string = { git="https://github.com/AztecProtocol/aztec-nr/", tag="4.0.0-devnet.2-patch.0", directory="compressed-string" }
```
