...
- See all `TestEnvironment` methods [here](https://github.com/AztecProtocol/aztec-packages/blob/4.0.0-devnet.2-patch.0/noir-projects/aztec-nr/aztec/src/test/helpers/test_environment.nr)
