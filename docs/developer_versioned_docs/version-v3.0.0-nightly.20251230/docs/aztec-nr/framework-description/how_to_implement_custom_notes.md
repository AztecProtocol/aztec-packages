...
```toml
# In Nargo.toml
value_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v3.0.0-nightly.20251230", directory="noir-projects/smart-contracts/value-note" }
```
...
```toml
# In Nargo.toml
address_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v3.0.0-nightly.20251230", directory="noir-projects/smart-contracts/address-note" }
```
