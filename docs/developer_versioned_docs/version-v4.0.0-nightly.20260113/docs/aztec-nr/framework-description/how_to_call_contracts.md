...
```toml
[dependencies]
token = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v4.0.0-nightly.20260113", directory="noir-projects/noir-contracts/contracts/app/token_contract" }
```
