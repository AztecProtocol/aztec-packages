...
- See all `TestEnvironment` methods [here](https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260113/noir-projects/aztec-nr/aztec/src/test/helpers/test_environment.nr)
