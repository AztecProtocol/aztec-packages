...
<<<<<<< HEAD:docs/developer_versioned_docs/version-v4.1.0-rc.2/docs/resources/migration_notes.md
## TBD
=======
## 4.2.0
...
>>>>>>> dec97a2d55 (docs: backfill v4.2.0 migration notes (#22612)):docs/developer_versioned_docs/version-v4.2.0/docs/resources/migration_notes.md
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="next", directory="yarn-project/aztec-nr/aztec" }
```
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="next", directory="yarn-project/aztec-nr/aztec" }
protocol = { git="https://github.com/AztecProtocol/aztec-packages/", tag="next", directory="yarn-project/noir-protocol-circuits/crates/types"}
```
