...
- Current version: `v4.1.0-rc.2`
- Update with `aztec-up 4.1.0-rc.2`
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v4.1.0-rc.2/noir-projects/noir-contracts/contracts).
...
+value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v4.1.0-rc.2", directory="noir-projects/aztec-nr/value-note" }
```
