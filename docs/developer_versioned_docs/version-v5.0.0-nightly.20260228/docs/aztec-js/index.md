...
```bash
npm install @aztec/aztec.js@5.0.0-nightly.20260228
```
...
```bash
npm install @aztec/aztec.js@5.0.0-nightly.20260228 \
  @aztec/accounts@5.0.0-nightly.20260228 \
  @aztec/wallets@5.0.0-nightly.20260228 \
  @aztec/noir-contracts.js@5.0.0-nightly.20260228
```
