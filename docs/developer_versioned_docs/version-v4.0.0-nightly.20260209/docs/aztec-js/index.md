...
```bash
npm install @aztec/aztec.js@4.0.0-nightly.20260209
```
...
```bash
npm install @aztec/aztec.js@4.0.0-nightly.20260209 \
  @aztec/accounts@4.0.0-nightly.20260209 \
  @aztec/test-wallet@4.0.0-nightly.20260209 \
  @aztec/noir-contracts.js@4.0.0-nightly.20260209
```
