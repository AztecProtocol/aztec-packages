...
:::info
If you're new to Aztec and want to understand local development first, check out the [sandbox guide](./getting_started_on_sandbox.md).
:::
...
You can check the transaction status on [devnet aztecscan](https://devnet.aztecscan.xyz).
...
- **New to Aztec?** Start with the [sandbox guide](./getting_started_on_sandbox.md) for faster development
