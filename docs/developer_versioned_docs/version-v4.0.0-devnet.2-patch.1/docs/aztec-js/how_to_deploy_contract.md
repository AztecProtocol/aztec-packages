...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_advanced/index.ts#L30-L40" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L30-L40</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_advanced/index.ts#L42-L59" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L42-L59</a></sub></sup>

Here's a complete example from the test suite:

```typescript title="deploy_basic" showLineNumbers
const contract = await StatefulTestContract.deploy(wallet, owner, 42).send({
  from: defaultAccountAddress,
});
```

> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L42-L44" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L42-L44</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_advanced/index.ts#L61-L75" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L61-L75</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L59-L62" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L59-L62</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_advanced/index.ts#L250-L271" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L250-L271</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L81-L89" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L81-L89</a></sub></sup>
...
const instance = await deployMethod.getInstance({
  contractAddressSalt: deploymentSalt,
});
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_advanced/index.ts#L77-L92" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L77-L92</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_advanced/index.ts#L129-L147" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L129-L147</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_connection/index.ts#L91-L103" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_connection/index.ts#L91-L103</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L70-L74" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L70-L74</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_advanced/index.ts#L208-L229" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L208-L229</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_advanced/index.ts#L231-L248" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L231-L248</a></sub></sup>
...
await new BatchCall(wallet, [deployMethod, publicCall]).send({
  from: defaultAccountAddress,
});
```

> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L127-L135" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L127-L135</a></sub></sup>
...
const classMetadata = await wallet.getContractClassMetadata(
  metadata.instance!.currentContractClassId,
);
const isPublished = classMetadata.isContractClassPubliclyRegistered;
```

> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L49-L53" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_deploy_contract/deploy_method.test.ts#L49-L53</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_advanced/index.ts#L94-L105" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L94-L105</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_advanced/index.ts#L107-L123" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L107-L123</a></sub></sup>
...
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-devnet.2-patch.1/docs/examples/ts/aztecjs_advanced/index.ts#L173-L192" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_advanced/index.ts#L173-L192</a></sub></sup>
