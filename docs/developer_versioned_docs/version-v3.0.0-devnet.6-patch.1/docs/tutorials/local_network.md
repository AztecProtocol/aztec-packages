...
- Current version: `v3.0.0-devnet.6-patch.1`
- Update with `aztec-up 3.0.0-devnet.6-patch.1`
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v3.0.0-devnet.6-patch.1/noir-projects/noir-contracts/contracts).
...
+value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v3.0.0-devnet.6-patch.1", directory="noir-projects/aztec-nr/value-note" }
```
