...
```toml
[dependencies]
token = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v5.0.0-nightly.20260219", directory="noir-projects/noir-contracts/contracts/app/token_contract" }
```
