...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260219/yarn-project/aztec.js/src/account/account.ts#L23-L34" target="_blank" rel="noopener noreferrer">Source code: yarn-project/aztec.js/src/account/account.ts#L23-L34</a></sub></sup>
