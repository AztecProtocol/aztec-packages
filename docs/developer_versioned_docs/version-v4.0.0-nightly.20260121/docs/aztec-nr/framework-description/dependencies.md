...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v4.0.0-nightly.20260121", directory="noir-projects/aztec-nr/aztec" }
```
...
```toml
protocol_types = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v4.0.0-nightly.20260121", directory="noir-projects/noir-protocol-circuits/crates/types"}
```
...
```toml
field_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.0.0-nightly.20260121", directory="field-note" }
```
...
```toml
uint_note = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.0.0-nightly.20260121", directory="uint-note" }
```
...
```toml
compressed_string = { git="https://github.com/AztecProtocol/aztec-nr/", tag="v4.0.0-nightly.20260121", directory="compressed-string" }
```
