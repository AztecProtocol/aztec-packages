...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.1.0/noir-projects/aztec-nr/uint-note/src/uint_note.nr#L29-L36" target="_blank" rel="noopener noreferrer">Source code: noir-projects/aztec-nr/uint-note/src/uint_note.nr#L29-L36</a></sub></sup>
...
The [lifecycle module](https://github.com/AztecProtocol/aztec-packages/tree/v5.1.0/noir-projects/aztec-nr/aztec/src/note/lifecycle.nr) contains functions for note management:
...
Notes must implement the `NoteHash` trait from [note_interface.nr](https://github.com/AztecProtocol/aztec-packages/tree/v5.1.0/noir-projects/aztec-nr/aztec/src/note/note_interface.nr):
