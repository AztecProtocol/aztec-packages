...
```toml
[dependencies]
token = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v5.0.0-nightly.20260319", directory="noir-projects/noir-contracts/contracts/app/token_contract" }
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260319/noir-projects/noir-contracts/contracts/app/lending_contract/src/main.nr#L255-L257" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/lending_contract/src/main.nr#L255-L257</a></sub></sup>
