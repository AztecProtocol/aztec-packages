...
const tx = await bananaCoin.methods
  ...
  .wait();
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260124/yarn-project/end-to-end/src/e2e_fees/sponsored_payments.test.ts#L57-L69" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_fees/sponsored_payments.test.ts#L57-L69</a></sub></sup>
...
const receiptForAlice = await bananaCoin.methods
  ...
  .wait();
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.0.0-nightly.20260124/yarn-project/end-to-end/src/composed/e2e_local_network_example.test.ts#L184-L194" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_local_network_example.test.ts#L184-L194</a></sub></sup>
