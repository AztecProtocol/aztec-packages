...
- `simulateUtility(call: FunctionCall, __namedParameters: SimulateUtilityOpts) => Promise<UtilitySimulationResult>` - Simulates the execution of a contract utility function.
