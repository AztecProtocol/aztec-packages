...
These requirements are for building the software. Running a node has different requirements—see [Running a Full Node](./running_a_node.md).
...
See [Running a Full Node](./running_a_node.md) for complete setup instructions.
...
- Use your custom build to [run a full node](./running_a_node.md)
- Set up [monitoring](../operation/monitoring.md) for your node
- Review the [CLI reference](../reference/cli_reference.md) for configuration options
