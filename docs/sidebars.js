...
// Check if learn directory exists (for version compatibility)
const learnDirExists = fs.existsSync(path.join(__dirname, "docs", "learn"));
...
const sidebar = {
  ...
  learnSidebar: [
    {
      type: "html",
      value: '<span class="sidebar-title">Learning Journey</span>',
      className: "sidebar-title",
    },
    {
      type: "doc",
    ...
    {
      type: "html",
      value: '<span class="sidebar-title">Modules</span>',
      className: "sidebar-title",
    },
    {
      type: "autogenerated",
