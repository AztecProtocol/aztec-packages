...
const sidebar = {
  ...
  learnSidebar: [
    ...
    },
    {
      ...
      items: [
        {
          type: "autogenerated",
          dirName: "learn/1_why_aztec",
        },
      ],
    },
    {
      type: "category",
      label: "2: The Privacy Mindset",
      items: [
        {
          type: "autogenerated",
          dirName: "learn/2_privacy_mindset",
        },
      ],
    },
    {
      type: "category",
      label: "3: The Hybrid Execution Model",
      items: [
        {
          type: "autogenerated",
          dirName: "learn/3_hybrid_execution_model",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        "learn/contract_development/contract_structure",
        {
          type: "ref",
          id: "developers/docs/guides/smart_contracts/how_to_define_storage",
        },
      ],
    },
  ],
  ...
  nodesSidebar: [
    ...
    {
      type: "doc",
      id: "the_aztec_network/reference/reacting_to_upgrades",
    },
    {
      type: "doc",
