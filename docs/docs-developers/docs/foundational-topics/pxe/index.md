...
<!-- NOTE: combine with state_management -->
...
Oracles are pieces of data that are injected into a smart contract function from the client side. You can read more about why and how they work in the [smart contracts section](../../aztec-nr/framework-description/advanced/protocol_oracles.md).
