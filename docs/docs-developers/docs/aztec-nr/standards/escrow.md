...
For a complete private escrow project scaffold with lifecycle phases, role pseudonyms, and encrypted manifest handoff, see the [Private Escrow Kit](../../tutorials/private-escrow-kit/index.md) guide.
