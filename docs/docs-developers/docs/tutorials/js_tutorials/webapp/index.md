...
- The app connects to a local Aztec network or devnet via browser extension wallet
...
- A local Aztec network running (`aztec start --local-network`), **or** access to the Aztec devnet
