...
- Node.js 22+
- Chrome browser
- The webapp-tutorial project set up (for testing)
...
3. Click **Load unpacked** and select the `test-extension` folder
4. Start the dApp with `yarn dev` and open `http://localhost:5173`
5. Select "Browser Wallet" to connect
...
| **Network** | Local development | Devnet (or any network) |
...
- [BaseWallet Source](https://github.com/AztecProtocol/aztec-packages/blob/master/yarn-project/wallet-sdk/src/base-wallet/base_wallet.ts) - The class you extend
:::
