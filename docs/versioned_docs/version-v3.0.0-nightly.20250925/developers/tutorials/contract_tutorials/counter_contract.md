...
This tutorial is compatible with the Aztec version `v3.0.0-nightly.20250925`. Install the correct version with `aztec-up -v 3.0.0-nightly.20250925`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250925/noir-projects/noir-contracts/contracts/test/counter_contract/src/main.nr#L34-L41" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/test/counter_contract/src/main.nr#L34-L41</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250925/noir-projects/noir-contracts/contracts/test/counter_contract/src/main.nr#L72-L77" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/test/counter_contract/src/main.nr#L72-L77</a></sub></sup>
