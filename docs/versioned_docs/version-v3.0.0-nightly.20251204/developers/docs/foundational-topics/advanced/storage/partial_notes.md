...
:::warning
We need to use different randomness for Bob's note here to avoid potential privacy leak (see [description](https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251204/noir-projects/noir-contracts/contracts/app/token_contract/src/main.nr#L491) of `setup_refund` function)
:::
...
fn fee_entrypoint_private(max_fee: u128, authwit_nonce: Field) {
    ...
    self.set_as_teardown(FPC::at(self.address)._complete_refund(
        accepted_asset,
        partial_note,
        max_fee,
    ));
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251204/noir-projects/noir-contracts/contracts/fees/fpc_contract/src/main.nr#L78-L108" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/fees/fpc_contract/src/main.nr#L78-L108</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251204/noir-projects/noir-contracts/contracts/fees/fpc_contract/src/main.nr#L112-L134" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/fees/fpc_contract/src/main.nr#L112-L134</a></sub></sup>
