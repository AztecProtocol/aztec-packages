...
```rust
enqueue_event_for_validation(contract_address, event_type_id, serialized_event, MAX_EVENT_SERIALIZED_LEN>, event_commitment, tx_hash, recipient, log_index_in_tx, tx_index_in_block, );
```
