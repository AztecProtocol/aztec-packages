...
- Understanding of [account concepts](../../../aztec/concepts/accounts/index.md)
...
```bash
yarn add @aztec/aztec.js@3.0.0-nightly.20250922 @aztec/accounts@3.0.0-nightly.20250922
```
...
- Learn about [account abstraction](../../../aztec/concepts/accounts/index.md)
