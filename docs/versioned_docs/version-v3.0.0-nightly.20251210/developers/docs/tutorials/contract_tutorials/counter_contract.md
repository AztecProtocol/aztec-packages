...
This tutorial is compatible with the Aztec version `v3.0.0-nightly.20251210`. Install the correct version with `aztec-up -v 3.0.0-nightly.20251210`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251210/docs/examples/contracts/counter_contract/src/main.nr#L18-L23" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/counter_contract/src/main.nr#L18-L23</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251210/docs/examples/contracts/counter_contract/src/main.nr#L25-L35" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/counter_contract/src/main.nr#L25-L35</a></sub></sup>
...
fn increment(owner: AztecAddress) {
    ...
    self.storage.counters.at(owner).add(1).deliver(owner, MessageDelivery.CONSTRAINED_ONCHAIN);
}
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251210/docs/examples/contracts/counter_contract/src/main.nr#L37-L43" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/counter_contract/src/main.nr#L37-L43</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251210/docs/examples/contracts/counter_contract/src/main.nr#L45-L50" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/counter_contract/src/main.nr#L45-L50</a></sub></sup>
