...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v1.1.3/l1-contracts/src/core/interfaces/messagebridge/IOutbox.sol#L22-L32" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/src/core/interfaces/messagebridge/IOutbox.sol#L22-L32</a></sub></sup>
...
function hasMessageBeenConsumedAtBlockAndIndex(uint256 _l2BlockNumber, uint256 _leafIndex)
  ...
  returns (bool);
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v1.1.3/l1-contracts/src/core/interfaces/messagebridge/IOutbox.sol#L54-L65" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/src/core/interfaces/messagebridge/IOutbox.sol#L54-L65</a></sub></sup>
