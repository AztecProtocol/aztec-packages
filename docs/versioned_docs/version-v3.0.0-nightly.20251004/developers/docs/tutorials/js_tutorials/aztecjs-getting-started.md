...
Before starting, make sure to be running Aztec sandbox at version 3.0.0-nightly.20251004. Check out [the guide](../../guides/local_env/sandbox.md) for info about that.
...
```sh
yarn add @aztec/aztec.js@3.0.0-nightly.20251004 @aztec/accounts@3.0.0-nightly.20251004 @aztec/noir-contracts.js@3.0.0-nightly.20251004
```
