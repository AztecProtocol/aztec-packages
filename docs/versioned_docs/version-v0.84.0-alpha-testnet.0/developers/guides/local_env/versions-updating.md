...
- Current version: `v0.84.0-alpha-testnet.0`
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v0.84.0-alpha-testnet.0/noir-projects/noir-contracts/contracts).
...
+value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v0.84.0-alpha-testnet.0", directory="noir-projects/aztec-nr/value-note" }
```
...
+"@aztec/accounts": "v0.84.0-alpha-testnet.0",
