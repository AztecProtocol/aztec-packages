...
Before starting, make sure you have the Aztec local network running at version v3.0.0-nightly.20251203. Check out [the local network guide](../../../getting_started_on_local_network.md) for setup instructions.
...
yarn add @aztec/aztec.js@3.0.0-nightly.20251203 @aztec/accounts@3.0.0-nightly.20251203 @aztec/stdlib@3.0.0-nightly.20251203 @aztec/test-wallet@3.0.0-nightly.20251203 tsx
```
...
```toml
[dependencies]
aztec = { git = "https://github.com/AztecProtocol/aztec-packages/", tag = "v3.0.0-nightly.20251203", directory = "noir-projects/aztec-nr/aztec" }
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/nft.nr#L1-L16" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/nft.nr#L1-L16</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/nft.nr#L18-L24" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/contracts/aztec/nft/src/nft.nr#L18-L24</a></sub></sup>
...
pub contract NFTPunk {
    ...
    struct Storage<Context> {
        ...
        owners: PrivateSet<NFTNote, Context>,
    }
    #[external("public")]
    #[initializer]
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L3-L57" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L3-L57</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L59-L82" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L59-L82</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L84-L97" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L84-L97</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L99-L115" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L99-L115</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L117-L131" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L117-L131</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L133-L148" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L133-L148</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L150-L176" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L150-L176</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L178-L200" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L178-L200</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L202-L211" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L202-L211</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L213-L237" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L213-L237</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L239-L260" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L239-L260</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L262-L317" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L262-L317</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251203/docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L319-L334" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/token_bridge_contract/scripts/index.ts#L319-L334</a></sub></sup>
