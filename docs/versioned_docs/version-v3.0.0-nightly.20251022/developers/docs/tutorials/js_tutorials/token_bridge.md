...
This tutorial is compatible with the Aztec version `v3.0.0-nightly.20251022`. Install the correct version with `aztec-up -v 3.0.0-nightly.20251022`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/l1-contracts/test/portals/TokenPortal.sol#L47-L57" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L47-L57</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/l1-contracts/test/portals/TokenPortal.sol#L79-L90" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L79-L90</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L53-L67" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L53-L67</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L69-L90" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L69-L90</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L117-L142" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L117-L142</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/l1-contracts/test/portals/TokenPortal.sol#L111-L147" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L111-L147</a></sub></sup>
...
Make sure you are using version v3.0.0-nightly.20251022 of the sandbox. Install with `aztec-up 3.0.0-nightly.20251022`.
...
yarn add @aztec/aztec.js@3.0.0-nightly.20251022 @aztec/noir-contracts.js@3.0.0-nightly.20251022 @aztec/l1-artifacts@3.0.0-nightly.20251022 @aztec/accounts@3.0.0-nightly.20251022 @aztec/ethereum@3.0.0-nightly.20251022 @types/node typescript@^5.0.4 viem@^2.22.8 tsx
touch tsconfig.json
touch index.ts
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L2-L28" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L2-L28</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L29-L74" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L29-L74</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L101-L106" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L101-L106</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L109-L117" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L109-L117</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L131-L136" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L131-L136</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L139-L141" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L139-L141</a></sub></sup>
...
await l2TokenContract.methods.mint_to_public(ownerAztecAddress, 0n).send({ from: ownerAztecAddress }).wait();
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L161-L168" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L161-L168</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L171-L180" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L171-L180</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251022/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L184-L198" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L184-L198</a></sub></sup>
