...
- Current version: `v0.82.2-alpha-testnet.4`
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v0.82.2-alpha-testnet.4/noir-projects/noir-contracts/contracts).
...
+value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v0.82.2-alpha-testnet.4", directory="noir-projects/aztec-nr/value-note" }
```
