...
:::info
Public functions always execute after private execution completes. Learn more in the [concepts overview](../../foundational-topics/index.md).
:::

### Use other call types

Explore additional call types for specialized use cases in the [call types reference](../../foundational-topics/call_types.md).
