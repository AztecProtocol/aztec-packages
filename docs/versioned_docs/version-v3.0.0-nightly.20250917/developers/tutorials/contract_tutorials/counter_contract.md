...
This tutorial is compatible with the Aztec version `v3.0.0-nightly.20250917`. Install the correct version with `aztec-up -v 3.0.0-nightly.20250917`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250917/noir-projects/noir-contracts/contracts/test/counter_contract/src/main.nr#L75-L80" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/test/counter_contract/src/main.nr#L75-L80</a></sub></sup>
