...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v0.87.9/noir-projects/aztec-nr/aztec/src/prelude.nr#L1-L22" target="_blank" rel="noopener noreferrer">Source code: noir-projects/aztec-nr/aztec/src/prelude.nr#L1-L22</a></sub></sup>
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v0.87.9", directory="yarn-project/aztec-nr/aztec" }
```
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v0.87.9", directory="yarn-project/aztec-nr/aztec" }
protocol_types = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v0.87.9", directory="yarn-project/noir-protocol-circuits/crates/types"}
```
