...
This tutorial is compatible with the Aztec version `v3.0.0-nightly.20251011`. Install the correct version with `aztec-up -v 3.0.0-nightly.20251011`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251011/l1-contracts/test/portals/TokenPortal.sol#L47-L57" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L47-L57</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251011/l1-contracts/test/portals/TokenPortal.sol#L79-L90" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L79-L90</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251011/l1-contracts/test/portals/TokenPortal.sol#L111-L147" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L111-L147</a></sub></sup>
...
Make sure you are using version v3.0.0-nightly.20251011 of the sandbox. Install with `aztec-up 3.0.0-nightly.20251011`.
...
yarn add @aztec/aztec.js@3.0.0-nightly.20251011 @aztec/noir-contracts.js@3.0.0-nightly.20251011 @aztec/l1-artifacts@3.0.0-nightly.20251011 @aztec/accounts@3.0.0-nightly.20251011 @aztec/ethereum@3.0.0-nightly.20251011 @types/node typescript@^5.0.4 viem@^2.22.8 tsx
touch tsconfig.json
touch index.ts
```
