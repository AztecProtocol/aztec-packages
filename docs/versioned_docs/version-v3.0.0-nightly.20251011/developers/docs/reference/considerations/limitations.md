...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251011/noir-projects/noir-protocol-circuits/crates/types/src/constants.nr#L30-L99" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-protocol-circuits/crates/types/src/constants.nr#L30-L99</a></sub></sup>
