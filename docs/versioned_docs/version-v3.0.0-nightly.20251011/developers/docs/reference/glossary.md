...
Read more and review the source code [here](https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251011/yarn-project/aztec.js).
...
To run your own node see [here](../../../the_aztec_network/index.md).
