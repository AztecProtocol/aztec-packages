...
- Current version: `v3.0.0-nightly.20251011`
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v3.0.0-nightly.20251011/noir-projects/noir-contracts/contracts).
...
+value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v3.0.0-nightly.20251011", directory="noir-projects/aztec-nr/value-note" }
```
...
+"@aztec/accounts": "v3.0.0-nightly.20251011",
