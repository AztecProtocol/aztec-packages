...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v2.1.12/yarn-project/end-to-end/src/composed/docs_examples.test.ts#L51-L53" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/docs_examples.test.ts#L51-L53</a></sub></sup>
