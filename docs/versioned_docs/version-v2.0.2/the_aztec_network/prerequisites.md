...
**Used by:**
- [Full node guide](./running_a_node.md)
...
**Used by:**
- [Sequencer guide](./sequencer_management.md)
- [Prover guide](./running_a_prover.md)
...
- [Run a Full Node →](./running_a_node.md) (CLI Method)
- [Run a Sequencer Node →](./sequencer_management.md) (Docker Compose Method)
- [Run a Prover Node →](./running_a_prover.md) (Docker Compose Method)
