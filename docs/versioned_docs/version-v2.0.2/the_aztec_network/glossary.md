...
The Aztec network, a rollup scaling solution built on top of Ethereum L1. L2 processes transactions off-chain and submits validity proofs to L1.
...
A scaling solution that processes transactions off-chain and submits compressed data and validity proofs to L1. Aztec is a zkRollup with privacy features.
...
- [Advanced Keystore Guide](./advanced_keystore_guide.md) - Detailed keystore configuration options
- [CLI Reference](./reference/cli_reference.md) - Complete command-line interface documentation
