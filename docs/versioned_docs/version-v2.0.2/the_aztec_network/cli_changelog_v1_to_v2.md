---
id: cli_changelog_v1_to_v2
sidebar_position: 6
title: CLI Changelog (v1.2.1 to v2.0.2)
description: Comprehensive changelog of configuration changes between Aztec CLI versions 1.2.1 and 2.0.2, covering removed options, new features, and behavioral changes.
---

This guide documents all configuration changes between Aztec CLI versions 1.2.1 and 2.0.2.
...
- [How to Run a Sequencer Node](./sequencer_management.md) - Updated setup instructions
