...
- See all `TestEnvironment` methods [here](https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/noir-projects/smart-contracts/aztec/src/test/helpers/test_environment.nr)
:::
