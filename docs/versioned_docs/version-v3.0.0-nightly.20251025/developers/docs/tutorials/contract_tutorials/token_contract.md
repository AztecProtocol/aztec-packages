...
- Aztec toolchain installed (`aztec-up -v 3.0.0-nightly.20251025`)
...
yarn add @aztec/aztec.js@v3.0.0-nightly.20251025 @aztec/accounts@v3.0.0-nightly.20251025 @aztec/test-wallet@v3.0.0-nightly.20251025 @aztec/kv-store@v3.0.0-nightly.20251025
...
fn setup() {
    ...
    storage.owner.write(context.msg_sender().unwrap());
}
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L31-L38" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L31-L38</a></sub></sup>
...
fn mint_public(employee: AztecAddress, amount: u64) {
    ...
    assert_eq(context.msg_sender().unwrap(), storage.owner.read(), "Only Giggle can mint BOB tokens");
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L40-L50" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L40-L50</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L52-L66" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L52-L66</a></sub></sup>
...
fn transfer_ownership(new_owner: AztecAddress) {
    assert_eq(context.msg_sender().unwrap(), storage.owner.read(), "Only current admin can transfer ownership");
    storage.owner.write(new_owner);
}
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L68-L74" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L68-L74</a></sub></sup>
...
```toml
[dependencies]
easy_private_state = { git = "https://github.com/AztecProtocol/aztec-packages/", tag = "v3.0.0-nightly.20251025", directory = "noir-projects/aztec-nr/easy-private-state" }
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L18-L29" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L18-L29</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L76-L85" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L76-L85</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L87-L95" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L87-L95</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L98-L107" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L98-L107</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L109-L119" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L109-L119</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L121-L127" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L121-L127</a></sub></sup>
...
fn mint_private(employee: AztecAddress, amount: u64) {
    ...
    BobToken::at(context.this_address())
        ._assert_is_owner(context.msg_sender().unwrap())
        .enqueue(&mut context);
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L129-L140" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L129-L140</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251025/docs/examples/contracts/bob_token_contract/src/main.nr#L143-L161" target="_blank" rel="noopener noreferrer">Source code: docs/examples/contracts/bob_token_contract/src/main.nr#L143-L161</a></sub></sup>
