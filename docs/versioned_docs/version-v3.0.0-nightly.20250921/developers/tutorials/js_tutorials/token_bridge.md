...
This tutorial is compatible with the Aztec version `v3.0.0-nightly.20250921`. Install the correct version with `aztec-up -v 3.0.0-nightly.20250921`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/l1-contracts/test/portals/TokenPortal.sol#L51-L61" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L51-L61</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/l1-contracts/test/portals/TokenPortal.sol#L83-L94" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L83-L94</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L60-L74" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L60-L74</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L76-L97" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L76-L97</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L128-L153" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L128-L153</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/l1-contracts/test/portals/TokenPortal.sol#L115-L151" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L115-L151</a></sub></sup>
...
Make sure you are using version v3.0.0-nightly.20250921 of the sandbox. Install with `aztec-up 3.0.0-nightly.20250921`.
...
yarn add @aztec/aztec.js@3.0.0-nightly.20250921 @aztec/noir-contracts.js@3.0.0-nightly.20250921 @aztec/l1-artifacts@3.0.0-nightly.20250921 @aztec/accounts@3.0.0-nightly.20250921 @aztec/ethereum@3.0.0-nightly.20250921 @types/node typescript@^5.0.4 viem@^2.22.8 tsx
touch tsconfig.json
touch index.ts
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L2-L30" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L2-L30</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L31-L76" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L31-L76</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L96-L101" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L96-L101</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L104-L112" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L104-L112</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L115-L124" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L115-L124</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L126-L131" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L126-L131</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L139-L154" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L139-L154</a></sub></sup>
...
await l2TokenContract.methods.mint_to_public(ownerAztecAddress, 0n).send({ from: ownerAztecAddress }).wait();
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L156-L163" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L156-L163</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L166-L175" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L166-L175</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L179-L193" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L179-L193</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L195-L211" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L195-L211</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250921/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L213-L228" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L213-L228</a></sub></sup>
