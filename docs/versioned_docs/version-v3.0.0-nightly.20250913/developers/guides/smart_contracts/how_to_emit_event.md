...
You can find the implementation of event logging [here](https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250913/noir-projects/aztec-nr/aztec/src/messages/logs/event.nr)
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250913/noir-projects/noir-contracts/contracts/test/test_log_contract/src/main.nr#L65-L70" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/test/test_log_contract/src/main.nr#L65-L70</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250913/noir-projects/noir-contracts/contracts/test/test_contract/src/main.nr#L370-L374" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/test/test_contract/src/main.nr#L370-L374</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250913/yarn-project/end-to-end/src/e2e_ordering.test.ts#L24-L31" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_ordering.test.ts#L24-L31</a></sub></sup>
