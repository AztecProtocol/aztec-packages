...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v2.1.6/noir-projects/noir-contracts/contracts/app/token_contract/src/main.nr#L303-L310" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_contract/src/main.nr#L303-L310</a></sub></sup>
...
You can find the implementation of event logging [here](https://github.com/AztecProtocol/aztec-packages/blob/v2.1.6/noir-projects/aztec-nr/aztec/src/messages/logs/event.nr)
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v2.1.6/noir-projects/noir-contracts/contracts/test/test_log_contract/src/main.nr#L64-L69" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/test/test_log_contract/src/main.nr#L64-L69</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v2.1.6/noir-projects/noir-contracts/contracts/test/test_contract/src/main.nr#L365-L369" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/test/test_contract/src/main.nr#L365-L369</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v2.1.6/yarn-project/end-to-end/src/e2e_ordering.test.ts#L24-L31" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_ordering.test.ts#L24-L31</a></sub></sup>
