...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v2.1.6/noir-projects/noir-contracts/contracts/app/card_game_contract/src/cards.nr#L46-L53" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/card_game_contract/src/cards.nr#L46-L53</a></sub></sup>
...
:::tip
You can find all of the methods available in the `TestEnvironment` [here (Github link)](https://github.com/AztecProtocol/aztec-packages/blob/v2.1.6/noir-projects/aztec-nr/aztec/src/test/helpers/test_environment.nr).
:::
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v2.1.6/noir-projects/noir-contracts/contracts/test/counter_contract/src/main.nr#L97-L136" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/test/counter_contract/src/main.nr#L97-L136</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v2.1.6/noir-projects/noir-contracts/contracts/test/counter_contract/src/main.nr#L90-L95" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/test/counter_contract/src/main.nr#L90-L95</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v2.1.6/noir-projects/noir-contracts/contracts/app/token_contract/src/test/utils.nr#L79-L91" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_contract/src/test/utils.nr#L79-L91</a></sub></sup>
