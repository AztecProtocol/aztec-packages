...
This tutorial is compatible with the Aztec version `v3.0.0-nightly.20251014`. Install the correct version with `aztec-up -v 3.0.0-nightly.20251014`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/l1-contracts/test/portals/TokenPortal.sol#L47-L57" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L47-L57</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/l1-contracts/test/portals/TokenPortal.sol#L79-L90" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L79-L90</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L53-L67" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L53-L67</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L69-L90" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L69-L90</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L117-L140" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr#L117-L140</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/l1-contracts/test/portals/TokenPortal.sol#L111-L147" target="_blank" rel="noopener noreferrer">Source code: l1-contracts/test/portals/TokenPortal.sol#L111-L147</a></sub></sup>
...
Make sure you are using version v3.0.0-nightly.20251014 of the sandbox. Install with `aztec-up 3.0.0-nightly.20251014`.
...
yarn add @aztec/aztec.js@3.0.0-nightly.20251014 @aztec/noir-contracts.js@3.0.0-nightly.20251014 @aztec/l1-artifacts@3.0.0-nightly.20251014 @aztec/accounts@3.0.0-nightly.20251014 @aztec/ethereum@3.0.0-nightly.20251014 @types/node typescript@^5.0.4 viem@^2.22.8 tsx
touch tsconfig.json
touch index.ts
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L2-L29" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L2-L29</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L30-L75" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L30-L75</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L102-L107" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L102-L107</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L110-L118" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L110-L118</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L132-L137" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L132-L137</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L140-L142" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L140-L142</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L145-L160" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L145-L160</a></sub></sup>
...
await l2TokenContract.methods.mint_to_public(ownerAztecAddress, 0n).send({ from: ownerAztecAddress }).wait();
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L162-L169" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L162-L169</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L172-L181" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L172-L181</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L185-L199" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L185-L199</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L201-L217" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L201-L217</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251014/yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L219-L234" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/composed/e2e_token_bridge_tutorial_test.test.ts#L219-L234</a></sub></sup>
