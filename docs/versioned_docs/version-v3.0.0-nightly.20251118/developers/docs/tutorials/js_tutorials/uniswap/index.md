...
:::note
This JavaScript in this tutorial is for the local network and will need adjustments if deploying to testnet. Install the local network [here](../../../../getting_started_on_local_network.md).
:::
