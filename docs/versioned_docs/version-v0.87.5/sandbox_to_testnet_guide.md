...
The testnet is version dependent. It is currently running version `0.87.5`. Maintain version consistency when interacting with the testnet to reduce errors.
