...
```toml
protocol_types = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v0.82.2-alpha-testnet.5", directory="noir-projects/noir-protocol-circuits/crates/types"}
```
