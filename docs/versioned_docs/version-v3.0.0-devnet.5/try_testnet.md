...
If you are interested in connecting to devnet, please refer to [this page](./developers/getting_started_on_devnet.md).
...
- Follow the [getting started on devnet guide](./developers/getting_started_on_devnet.md)
