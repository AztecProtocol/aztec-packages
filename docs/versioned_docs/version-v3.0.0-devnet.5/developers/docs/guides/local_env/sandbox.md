...
- [Sandbox PXE Proving](#sandbox-pxe-proving)
  - [Sandbox in Proving Mode](#sandbox-in-proving-mode)
    - [Usage](#usage)
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v3.0.0-devnet.5/noir-projects/noir-contracts/contracts).
...
+"@aztec/accounts": "v3.0.0-devnet.5",
