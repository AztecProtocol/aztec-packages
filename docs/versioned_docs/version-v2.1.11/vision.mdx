...
sidebar_position: 0
description: Learn about Aztec's vision to build a fully programmable private ZK-rollup on Ethereum, focusing on privacy, accessibility, and trustlessness.
---
