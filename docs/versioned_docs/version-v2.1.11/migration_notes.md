...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v2.1.11", directory="yarn-project/aztec-nr/aztec" }
```
...
```toml
aztec = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v2.1.11", directory="yarn-project/aztec-nr/aztec" }
protocol_types = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v2.1.11", directory="yarn-project/noir-protocol-circuits/crates/types"}
```
