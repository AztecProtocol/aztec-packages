...
```toml
address_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v3.0.0-nightly.20251119", directory="noir-projects/aztec-nr/address-note" }
```
...
```toml
protocol_types = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v3.0.0-nightly.20251119", directory="noir-projects/noir-protocol-circuits/crates/types"}
```
