...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v0.87.8/playground/vite.config.ts#L70-L76" target="_blank" rel="noopener noreferrer">Source code: playground/vite.config.ts#L70-L76</a></sub></sup>
