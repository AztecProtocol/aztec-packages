...
The equivalent using aztec.js - get sponsored fpc address (helper functions [here](https://github.com/AztecProtocol/aztec-packages/blob/v0.87.8/yarn-project/aztec/src/sandbox/sponsored_fpc.ts)) and use payment method:
...
(See also the [aztec-wallet](https://github.com/AztecProtocol/aztec-packages/blob/v0.87.8/yarn-project/cli-wallet/src/cmds/bridge_fee_juice.ts#L32) implementation to initialise a fee juice portal manager)
...
- [`aztec.js` source](https://github.com/AztecProtocol/aztec-packages/blob/v0.87.8/yarn-project/aztec.js)
- [Glossary](../../../glossary)
