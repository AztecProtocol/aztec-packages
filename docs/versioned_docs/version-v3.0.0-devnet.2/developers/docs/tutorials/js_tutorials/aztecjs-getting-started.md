...
Before starting, make sure to be running Aztec sandbox at version 3.0.0-devnet.2. Check out [the guide](../../guides/local_env/sandbox.md) for info about that.
...
```sh
yarn add @aztec/aztec.js@3.0.0-devnet.2 @aztec/accounts@3.0.0-devnet.2 @aztec/noir-contracts.js@3.0.0-devnet.2
```
...
We want to [connect to our running sandbox](../../guides/aztec-js/how_to_connect_to_sandbox.md) and import the test accounts into a new wallet. Let's call them Alice and Bob (of course). Create an `index.ts` with it:
