...
This tutorial is compatible with the Aztec version `v3.0.0-nightly.20251001`. Install the correct version with `aztec-up -v 3.0.0-nightly.20251001`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
...
value_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v3.0.0-nightly.20251001", directory="noir-projects/aztec-nr/value-note"}
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251001/docs/examples/tutorials/counter_contract/src/main.nr#L7-L14" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/counter_contract/src/main.nr#L7-L14</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251001/docs/examples/tutorials/counter_contract/src/main.nr#L16-L21" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/counter_contract/src/main.nr#L16-L21</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251001/docs/examples/tutorials/counter_contract/src/main.nr#L23-L31" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/counter_contract/src/main.nr#L23-L31</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251001/docs/examples/tutorials/counter_contract/src/main.nr#L33-L40" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/counter_contract/src/main.nr#L33-L40</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251001/docs/examples/tutorials/counter_contract/src/main.nr#L42-L47" target="_blank" rel="noopener noreferrer">Source code: docs/examples/tutorials/counter_contract/src/main.nr#L42-L47</a></sub></sup>
