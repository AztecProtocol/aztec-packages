...
This tutorial is compatible with the Aztec version `v1.1.4`. Install the correct version with `aztec-up -v 1.1.4`. Or if you'd like to use a different version, you can find the relevant tutorial by clicking the version dropdown at the top of the page.
...
uint_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v1.1.4", directory="noir-projects/aztec-nr/uint-note" }
router = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v1.1.4", directory="noir-projects/noir-contracts/contracts/protocol/router_contract" }
```
...
The `aztec::protocol_types` can be browsed [here (GitHub link)](https://github.com/AztecProtocol/aztec-packages/blob/v1.1.4/noir-projects/noir-protocol-circuits/crates/types/src). And like rust dependencies, the relative path inside the dependency corresponds to `address::AztecAddress`.
...
use token::Token;
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v1.1.4/noir-projects/noir-contracts/contracts/app/crowdfunding_contract/src/main.nr#L9-L25" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/crowdfunding_contract/src/main.nr#L9-L25</a></sub></sup>


Like before, you can find these and other `aztec::protocol_types` [here (GitHub link)](https://github.com/AztecProtocol/aztec-packages/blob/v1.1.4/noir-projects/noir-protocol-circuits/crates/types/src).
...
```
token = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v1.1.4", directory="noir-projects/noir-contracts/contracts/app/token_contract" }
```
...
For comparison, the full Crowdfunding contract can be found [here (GitHub link)](https://github.com/AztecProtocol/aztec-packages/blob/v1.1.4/noir-projects/noir-contracts/contracts/app/crowdfunding_contract).
...
See [claim_contract (GitHub link)](https://github.com/AztecProtocol/aztec-packages/blob/v1.1.4/noir-projects/noir-contracts/contracts/claim_contract).
