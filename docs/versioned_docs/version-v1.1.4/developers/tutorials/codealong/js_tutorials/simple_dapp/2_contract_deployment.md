...
compressed_string = {git="https://github.com/AztecProtocol/aztec-packages/", tag="v1.1.4", directory="noir-projects/aztec-nr/compressed-string"}
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v1.1.4/noir-projects/noir-contracts/contracts/app/token_contract/src/main.nr#L1-L728" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/token_contract/src/main.nr#L1-L728</a></sub></sup>
...
The `Token` contract also requires some helper files. You can view the files [here (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v1.1.4/noir-projects/noir-contracts/contracts/app/token_contract/src). Copy the `types.nr` and the `types` folder into `contracts/token/src`.
