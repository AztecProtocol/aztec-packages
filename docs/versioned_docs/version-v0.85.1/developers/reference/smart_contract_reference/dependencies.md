...
```toml
easy_private_state = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v0.85.1", directory="noir-projects/aztec-nr/easy-private-state" }
```
...
```toml
protocol_types = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v0.85.1", directory="noir-projects/noir-protocol-circuits/crates/types"}
```
...
```toml
value_note = { git="https://github.com/AztecProtocol/aztec-packages/", tag="v0.85.1", directory="noir-projects/aztec-nr/value-note" }
```
