...
- [Token Portal (L1)](https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251006/l1-contracts/test/portals/TokenPortal.sol)
- [Token Bridge (L2)](https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20251006/noir-projects/noir-contracts/contracts/app/token_bridge_contract/src/main.nr)
