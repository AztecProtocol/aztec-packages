...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250914/yarn-project/end-to-end/src/e2e_token_contract/transfer_in_private.test.ts#L32-L36" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_token_contract/transfer_in_private.test.ts#L32-L36</a></sub></sup>
