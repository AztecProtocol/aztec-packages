...
`aztec-up -v 3.0.0-nightly.20250914`
...
[dependencies]
aztec = { git = "https://github.com/AztecProtocol/aztec-packages/", tag = "v3.0.0-nightly.20250914", directory = "noir-projects/aztec-nr/aztec" }
easy_private_state = { git = "https://github.com/AztecProtocol/aztec-packages/", tag = "v3.0.0-nightly.20250914", directory = "noir-projects/aztec-nr/easy-easy_private-state" }
```
