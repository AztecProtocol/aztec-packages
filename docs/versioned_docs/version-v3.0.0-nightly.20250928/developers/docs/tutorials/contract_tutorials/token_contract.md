...
- Aztec toolchain installed (`aztec-up -v 3.0.0-nightly.20250928`)
...
yarn add @aztec/aztec.js@v3.0.0-nightly.20250928 @aztec/accounts@v3.0.0-nightly.20250928 @aztec/test-wallet@v3.0.0-nightly.20250928 @aztec/kv-store@v3.0.0-nightly.20250928
...
[dependencies]
aztec = { git = "https://github.com/AztecProtocol/aztec-packages/", tag = "v3.0.0-nightly.20250928", directory = "noir-projects/aztec-nr/aztec" }
```
...
```toml
[dependencies]
easy_private_state = { git = "https://github.com/AztecProtocol/aztec-packages/", tag = "v3.0.0-nightly.20250928", directory = "noir-projects/aztec-nr/easy-private-state" }
```
