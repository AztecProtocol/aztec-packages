...
/// Oracles module
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v0.87.2/noir-projects/aztec-nr/aztec/src/oracle/mod.nr#L1-L3" target="_blank" rel="noopener noreferrer">Source code: noir-projects/aztec-nr/aztec/src/oracle/mod.nr#L1-L3</a></sub></sup>
