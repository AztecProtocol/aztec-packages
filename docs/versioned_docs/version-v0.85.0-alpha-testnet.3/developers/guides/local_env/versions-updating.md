...
- Current version: `v0.85.0-alpha-testnet.3`
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v0.85.0-alpha-testnet.3/noir-projects/noir-contracts/contracts).
...
+value_note = { git="https://github.com/AztecProtocol/aztec-packages", tag="v0.85.0-alpha-testnet.3", directory="noir-projects/aztec-nr/value-note" }
```
...
+"@aztec/accounts": "v0.85.0-alpha-testnet.3",
