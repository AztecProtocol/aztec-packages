...
This guide assumes you have an Aztec app on sandbox and you wish to deploy it onto testnet. If you have never worked with sandbox or testnet, you might want to check out the [getting started on testnet guide](./developers/getting_started/getting_started_on_sandbox.md).
...
You can find a full flow in the [getting started on testnet](./developers/getting_started/getting_started_on_sandbox.md) guide.
