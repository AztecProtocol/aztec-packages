...
The equivalent using aztec.js - get sponsored fpc address (helper functions [here](https://github.com/AztecProtocol/aztec-packages/blob/v1.2.0/yarn-project/aztec/src/sandbox/sponsored_fpc.ts)) and use payment method:
...
- [`aztec.js` source](https://github.com/AztecProtocol/aztec-packages/blob/v1.2.0/yarn-project/aztec.js)
- [Glossary](../../../glossary)
