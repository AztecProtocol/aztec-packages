...
:::warning
The testnet is version dependent. It is currently running version `2.1.2`. Maintain version consistency when interacting with the testnet to reduce errors.
:::
