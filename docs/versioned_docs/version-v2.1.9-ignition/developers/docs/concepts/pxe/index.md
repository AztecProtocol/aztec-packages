...
- [Run more than one PXE on your local machine](../../../../developers/docs/guides/local_env/sandbox.md#running-multiple-pxes-in-the-sandbox)
- [Use in-built oracles including oracles for arbitrary data](../../../../developers/docs/guides/smart_contracts/advanced/how_to_use_capsules.md)
