...
- Current version: `v3.0.0-nightly.20251027`
...
Code referenced in the documentation is sourced from contracts within [this directory (GitHub link)](https://github.com/AztecProtocol/aztec-packages/tree/v3.0.0-nightly.20251027/noir-projects/noir-contracts/contracts).
...
+"@aztec/accounts": "v3.0.0-nightly.20251027",
