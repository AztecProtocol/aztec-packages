...
Before starting, make sure to be running Aztec sandbox at version 2.0.3. Check out [the guide](../../guides/local_env/sandbox.md) for info about that.
...
```sh
yarn add @aztec/aztec.js@2.0.3 @aztec/accounts@2.0.3 @aztec/noir-contracts.js@2.0.3
```
