...
Before starting, make sure to be running Aztec sandbox at version 2.1.5. Check out [the guide](../../guides/local_env/sandbox.md) for info about that.
...
```sh
yarn add @aztec/aztec.js@2.1.5 @aztec/accounts@2.1.5 @aztec/noir-contracts.js@2.1.5
```
