...
- Aztec toolchain installed (`aztec-up -v 3.0.0-nightly.20250920`)
...
```bash
yarn init
yarn add @aztec/aztec.js@v3.0.0-nightly.20250920 @aztec/accounts@v3.0.0-nightly.20250920
...
```toml
[dependencies]
easy_private_state = { git = "https://github.com/AztecProtocol/aztec-packages/", tag = "v3.0.0-nightly.20250920", directory = "noir-projects/aztec-nr/easy-private-state" }
```
