...
:::tip
For complex cross-chain or integration testing, see the [TypeScript testing guide](../js_apps/how_to_test.md).
:::
...
For complex end-to-end tests, use [TypeScript testing](../js_apps/how_to_test.md) with `aztec.js`.
...
- See all `TestEnvironment` methods [here](https://github.com/AztecProtocol/aztec-packages/blob/v3.0.0-nightly.20250920/noir-projects/aztec-nr/aztec/src/test/helpers/test_environment.nr)
:::
