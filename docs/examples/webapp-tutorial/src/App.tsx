    ...
    <LogProvider>
      <div className="app">
        <header>
          ...
          />
          {network === 'devnet' && account && <AccountInfo address={account} />}
        </header>
        ...
        <main>
          ...
          {/* Devnet: Single-player mode with wallet extension */}
          {network === 'devnet' && phase === 'connect' && (
            <WalletConnect
              network={network}
          ...
          {network === 'devnet' && phase === 'lobby' && wallet && account && (
            <GameLobby
          ...
          {network === 'devnet' && phase === 'playing' && wallet && account && contract && (
