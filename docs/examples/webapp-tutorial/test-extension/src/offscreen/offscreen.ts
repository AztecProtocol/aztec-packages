...
import { DEVNET_NODE_URL, MessageTypes, AZTEC_PACKAGES_VERSION, log } from '../config';
...
async function ensurePXE(nodeUrl: string = DEVNET_NODE_URL): Promise<{ pxe: PXE; node: AztecNode }> {
