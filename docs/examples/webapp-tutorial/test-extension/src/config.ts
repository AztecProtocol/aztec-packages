 ...
 * Uses devnet for all operations with SponsoredFPC for fee payment.
 */

/** Devnet Aztec node URL */
export const DEVNET_NODE_URL = 'https://v4-devnet-2.aztec-labs.com';

/** Current @aztec/* package version. Address derivation depends on matching SchnorrAccountContract artifacts. */
export const AZTEC_PACKAGES_VERSION = '4.0.0-devnet.2-patch.1';
