...
- Understand the basic keystore structure from the [sequencer setup guide](../setup/sequencer-setup.md)
...
See [Key Storage Methods](./storage-methods.md) for detailed instructions.
...
See [Advanced Configuration Patterns](./advanced-patterns.md) for examples.
...
**First time creating a keystore?** Start with the [Creating Validator Keystores guide](./creating-keystores.md) to learn how to use the Aztec CLI to generate keystores for sequencers and provers.

Once you have a basic keystore, explore the [Key Storage Methods](./storage-methods.md) guide to understand advanced options like remote signers and encrypted keystores. Then check out [Advanced Configuration Patterns](./advanced-patterns.md) for complex deployment scenarios.
