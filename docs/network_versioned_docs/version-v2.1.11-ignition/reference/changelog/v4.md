...
<<<<<<< HEAD:docs/network_versioned_docs/version-v2.1.11-ignition/reference/changelog/v4.md
=======
```bash
...
>>>>>>> cbb09bcc85 (fix(docs): restore operator changelog v4.md and add v4.2 to sidebar (#22609)):docs/network_versioned_docs/version-v4.2.0/reference/changelog/v4.md
## Changed defaults
