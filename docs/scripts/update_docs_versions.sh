...
#
# Examples:
#   ./update_docs_versions.sh           # Updates developer_versions.json
#   ./update_docs_versions.sh developer # Updates developer_versions.json
#   ./update_docs_versions.sh network   # Updates network_versions.json
...
# Path to versions.json and versioned_docs for the specified instance
