...
const INSTRUCTION_SET_RAW = [
    ...
    },
    {
        ...
        "Summary": "Type cast",
        "Details": "Cast a word in memory based on the `dst-tag` specified in the bytecode. Truncates when casting to a smaller type, left-zero-pads when casting to a larger type.",
        "Tag checks": "",
