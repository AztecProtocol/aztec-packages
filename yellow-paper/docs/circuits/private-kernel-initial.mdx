...
| `note_hash_read_request_contexts`           | [`[NoteHashReadRequestContext; C]`](#notehashreadrequestcontext)                     | Requests to prove the note hashes being read exist.                         |
| `nullifier_read_requests`                   | [`[NullifierReadRequest; C]`](./private-function#nullifierreadrequest)               | Requests to prove the nullifiers being read exist.                          |
