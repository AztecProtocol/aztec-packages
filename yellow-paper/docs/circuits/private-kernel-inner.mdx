...
class PrivateFunctionPublicInputs {
    ...
    note_hash_read_requests: List~NoteHashReadRequest~
    nullifier_read_requests: List~NullifierReadRequest~
...
PrivateFunctionPublicInputs *-- NoteHashReadRequest: note_hash_read_requests
PrivateFunctionPublicInputs *-- NullifierReadRequest: nullifier_read_requests
...
CallContext .. NoteHashReadRequestContext: storage_contract_address\n== contract_address
...
class NoteHashReadRequest {
    note_hash: field
    counter: field
}
NoteHashReadRequest ..> NoteHashReadRequestContext: note_hash_read_requests\n->note_hash_read_request_contexts

class NullifierReadRequest {
    nullifier: field
    counter: field
}
...
class NoteHashReadRequestContext {
    note_hash: field
    counter: field
    contract_address: AztecAddress
}
...
class TransientAccumulatedData {
  ...
  note_hash_read_request_contexts: List~NoteHashReadRequestContext~
  nullifier_read_requests: List~NullifierReadRequest~
...
NoteHashReadRequestContext --* TransientAccumulatedData: note_hash_read_request_contexts
NullifierReadRequest --* TransientAccumulatedData: nullifier_read_requests
