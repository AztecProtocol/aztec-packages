...
contract BlakeOptZKTest is TestBaseHonkZK {
    BlakeHonkZKVerifier referenceVerifier;

    function setUp() public override {
        super.setUp();

        referenceVerifier = new BlakeHonkZKVerifier();
        verifier = IVerifier(address(new BlakeOptZKHonkVerifier()));
