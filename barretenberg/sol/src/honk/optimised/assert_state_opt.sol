...
uint256 constant REAL_NUMBER_PUBLIC_INPUTS = 17 - 16;
...
contract AssertStateOpt is IVerifier {
    ...
    uint256 internal constant ACCUMULATOR = 0x200;
    ...
    function verify(bytes calldata, bytes32[] calldata) public override returns (bool) {
        ...
        assembly {
            ...
            function loadVk() {
              ...
              mstore(q_l_x_loc, 0x26da9a1c96e115b786eddfc3bb7651db3b292be255a4acff0a9e1b01793d9d25)
              mstore(q_l_y_loc, 0x150dc3674f99f42e6bc566bfd4b0a9ada3a490a4a3b44b6147580f77faf193ec)
              mstore(q_r_x_loc, 0x25cd1288572ad7e374cc7d51a51df66fb5337dabc0366aa2b95c3a8a748f230a)
              mstore(q_r_y_loc, 0x19cb9c0e93cfb93c6192b81737d8fda5734df4a9f7863f4877b424b954c6bf91)
              mstore(q_o_x_loc, 0x1904de48ec6c7235c917773fadf78241f5d6ed0ec36ca3abed2f8a5ab17781c5)
              mstore(q_o_y_loc, 0x1af0acb5d80f158ce82a4c661d39b132d8d694b2dc7088d712d24d978ed9e7a2)
              mstore(q_4_x_loc, 0x057fff28e7165e4aea7be1e43029eafd8e7d664faf1cb3cf8b28b2c69af2cf64)
              mstore(q_4_y_loc, 0x3024e93f07a22ce55ee9357764f15ae9d789adf146bce86accd413788f20d994)
              mstore(q_m_x_loc, 0x2167c1a5b300f55c71dff5cecc1db5c86f6aa84b77a18fe47364be92f4b09e58)
              mstore(q_m_y_loc, 0x00888b45a5eaf37ceda8bedad1a14a7ee6961eaee401e3b5634aeea9dde64cfb)
              mstore(q_c_x_loc, 0x0e7991628b4d97e3454d7dc5bd2942738c18ea0d17c7d6e635706ff5e825d6e1)
              mstore(q_c_y_loc, 0x2dd66ce0a84fde8efa38845245f5cb2f3c28bd25aef452482dd760ad3fa72ccd)
              mstore(q_arith_x_loc, 0x1b8b2b79c9d890b12e41f93c10977846bf1434ae8fd0344ae9c49f86c0cb20b1)
              mstore(q_arith_y_loc, 0x074072e572d7127be1018c3dbef76429489f899d8b8c445a2022da610e9bf4da)
              mstore(q_delta_range_x_loc, 0x0300663ac938bd6a9c66020aaff5716c5cf0841e8c7310f03248954f609af154)
              mstore(q_delta_range_y_loc, 0x056bea83cf39779bde29dc650517dbe65318b8e0b3ae718cdfd024cceb5af847)
              mstore(q_elliptic_x_loc, 0x191ff5584ff8009607369f797b99fb08fa410ba17bd69eaebd6b9e01492ae48e)
              mstore(q_elliptic_y_loc, 0x282398a44df904752366e7031e2ce7ab55cf72c074fa5409dfbd2f5c78cce0c8)
              mstore(q_aux_x_loc, 0x21d5334a4747a775618fcc947e7c9cbe849e4ac90f0361b9352ef86d02a9f410)
              mstore(q_aux_y_loc, 0x13434060976085913bfc8cc21a4215a3bebd9e7d3e4acb9cb34c923f83c0c1db)
              ...
              mstore(q_poseidon2_external_x_loc, 0x2c8c0953dcc7cc96a1c6140c23c4647607289ecf1b6e0db8ae1228a5bb91614b)
              mstore(q_poseidon2_external_y_loc, 0x22bab1b6d3616392f583c8f2aed8a30eed8b361f319a0fa69e81013c020973f7)
              mstore(q_poseidon2_internal_x_loc, 0x2e9f808391ab789a4ab3535811011dbe1c6f8744e1d54c948f8d627d538fb965)
              mstore(q_poseidon2_internal_y_loc, 0x089a480cc0c16c07ec1621b2917fbf6130f90c4da39e70a7213c6ebbf8768e05)
              mstore(sigma_1_x_loc, 0x10f81f86907852e61af5eff9a46756becde439e867b1f1994190e7c5bcb7c72a)
              mstore(sigma_1_y_loc, 0x2c7220fe9432309a230ab186dd38f26d5da2b85f3113175aa07436ceeac247d7)
              mstore(sigma_2_x_loc, 0x1fe2d8e69fd9722c59f837deea7171413f5bd73dfe9bc18b0b21f157d2958080)
              mstore(sigma_2_y_loc, 0x0c5c3d0d2b7645390bb2903d327e46e7ffd0db8343e8e97affbc5f4a618cebe9)
              mstore(sigma_3_x_loc, 0x196d306bae1399470f25d7720c4cc48eff168be290be388b850eea9a7059795a)
              mstore(sigma_3_y_loc, 0x0ebc3fb8b04e79a3c337138176deff6b646d023a57a5b9fb6c74c4d65faf0c9e)
              mstore(sigma_4_x_loc, 0x1c6843e63802ecd316fdd57916d7fb1376fb98d76e91e51d8c13df256e546259)
              mstore(sigma_4_y_loc, 0x171ea8a08aeeeee0f14ab9f76a48c84b966ec98789371d5fb5cfff8503ce7ed8)
              // TODO: in the proog pointers above swap id and table - to line up with how they actually should be
              mstore(table_1_x_loc, 0x0450f8716810dff987300c3bc10a892b1c1c2637db3f8fecd9d8bb38442cc468)
              mstore(table_1_y_loc, 0x10005567f9eb3d3a97098baa0d71c65db2bf83f8a194086a4cca39916b578faf)
              mstore(table_2_x_loc, 0x103bcf2cf468d53c71d57b5c0ab31231e12e1ce3a444583203ea04c16ec69eb2)
              mstore(table_2_y_loc, 0x0c5d6e7a8b0b14d4ed8f51217ae8af4207277f4116e0af5a9268b38a5d34910b)
              mstore(table_3_x_loc, 0x187b9371870f579be414054241d418f5689db2f6cbfabe968378fd68e9b280c0)
              mstore(table_3_y_loc, 0x0964ab30f99cb72cc59d0f621604926cfebfcff535f724f619bb0e7a4853dbdb)
              mstore(table_4_x_loc, 0x132b76a71278e567595f3aaf837a72eb0ab515191143e5a3c8bd587526486628)
              mstore(table_4_y_loc, 0x2c6b2a0de0a3fefdfc4fb4f3b8381d2c37ccc495848c2887f98bfbaca776ca39)
              mstore(id_1_x_loc, 0x271aa5500efa6cae8cb47cf0b0317c58265f388473fdf38446cbf0dc84d96e0e)
              mstore(id_1_y_loc, 0x242673d20a1073ee28be699fb913388c09bbb0446856e9654e3184d3ad0429c3)
              mstore(id_2_x_loc, 0x2abb07ce267805f1ce2b9e7a24954d8cfa89401fed405bfb78d0de2be1e336e0)
              mstore(id_2_y_loc, 0x26e4347d01c80b8071421814f8076a645f9ef346b7815a26a1499c54840251bf)
              mstore(id_3_x_loc, 0x28c0acfecba62df92c5480b9226e57d9a879ab4ba16da777b036902955e87e99)
              mstore(id_3_y_loc, 0x031af1b9c39e13828b20b5175e412a979689ead924bbd9855fdfa89c06e9fdd6)
              mstore(id_4_x_loc, 0x113c1db47535873fd05bd4740d057e9e7883ba886d1c4dd862b928152f5511df)
              mstore(id_4_y_loc, 0x21930f74379704dc7aa088e48b7f6cc00164c4961261aef81e23739ba9399b51)
              ...
              mstore(lagrange_last_x_loc, 0x222a00990c265db917ccf6e4381cdea5d16200fda7af5265690cacda94ae7131)
              mstore(lagrange_last_y_loc, 0x198a29bf1f6391c8487a4423a79256ef4609b87d44bedb68d26a4d64700443ea)
            }
           ...
           let shifted_scalar := 0
           {
            ...
            /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
            {
                ...
                // Store x at 0x00 and log
                mstore(0x00, mload(ACCUMULATOR))
                log1(0x00, 0x20, 0x01)

                // Store y at 0x00 (overwrite) and log
                mstore(0x00, mload(add(ACCUMULATOR, 0x20)))
                log1(0x00, 0x20, 0x02)

                // p_0
                mcopy(0x00, ACCUMULATOR, 0x40)
                // G1_0 — first G1 point (working one)
                // mstore(0x00, 1629903041176906428281718007698265259042557354442794002472607546900456654682)
                // mstore(0x20, 16063349778272165714613318253608032793331067051458881017300450811598141818086)
