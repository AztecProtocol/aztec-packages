...
# This flow is essentially the GoblinUltraHonk equivalent to the UltraPlonk "prove and verify". This functionality is accessed via the goblin "accumulate" mechanism.
