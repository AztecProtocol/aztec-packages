---
name: vm2-audit-t1-multi-phase-selector-mismatch
...
| Item | Value |
|------|-------|
| Skill | `vm2-audit-t1-multi-phase-selector-mismatch` |
| Target | `{path audited}` |
...
- **ID**: `vm2-audit-t1-multi-phase-selector-mismatch`
...
Write `vm2-audit-t1-multi-phase-selector-mismatch.json` to the output directory:
