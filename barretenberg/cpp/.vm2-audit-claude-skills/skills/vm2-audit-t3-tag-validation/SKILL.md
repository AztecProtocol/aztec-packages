---
name: vm2-audit-t3-tag-validation
...
| Item | Value |
|------|-------|
| Skill | `vm2-audit-t3-tag-validation` |
| Target | `{path audited}` |
...
- **ID**: `vm2-audit-t3-tag-validation-{filename}-{line}-{issue-type}`
...
Write `vm2-audit-t3-tag-validation.json` to specified output directory:
