---
name: vm2-audit-t2-error-aggregation
...
| Item | Value |
|------|-------|
| Skill | `vm2-audit-t2-error-aggregation` |
| Target | `{path audited}` |
...
### Finding Format
- **ID**: `vm2-audit-t2-error-aggregation-{filename}-{line}-{issue-type}`
...
Write `vm2-audit-t2-error-aggregation.json` to output directory:
```json
{
  "skill": "vm2-audit-t2-error-aggregation",
