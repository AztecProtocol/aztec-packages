---
name: vm2-audit-t2-mutual-exclusivity
...
| Item | Value |
|------|-------|
| Skill | `vm2-audit-t2-mutual-exclusivity` |
| Target | `{path}` |
| Files Scanned | `{n}` |
| Findings | `{e.g., "2 Critical, 1 High" or "None"}` |
| Status | `COMPLETED_WITH_FINDINGS` / `COMPLETED_NO_FINDINGS` / `ERROR` |

**Finding fields**: ID (`vm2-audit-t2-mutual-exclusivity`), Severity, File:line, Description, Fix

### JSON File (required)

Write `vm2-audit-t2-mutual-exclusivity.json` to output directory:
```json
{
  "skill": "vm2-audit-t2-mutual-exclusivity",
...
```
For no findings: `{"skill": "vm2-audit-t2-mutual-exclusivity", "status": "COMPLETED_NO_FINDINGS", "findings": []}`