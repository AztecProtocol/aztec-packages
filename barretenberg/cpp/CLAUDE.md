...
3. **Generated constants** - Run `barretenberg/cpp/scripts/remake-constants.sh` (regenerates the committed
   `aztec_constants.hpp`). The TypeScript and Solidity projections (`constants.gen.ts`, `ConstantsGen.sol`) are
   generated during their components' builds, and `constants_gen.pil` is generated by `scripts/avm2_gen.sh` — none
   of those need a manual step.
