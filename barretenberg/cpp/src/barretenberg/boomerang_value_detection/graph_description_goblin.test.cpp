...
TEST_F(BoomerangGoblinRecursiveVerifierTests, graph_description_basic)
{
    ...
    translator_pairing_points.P0._x.fix_witness();
    translator_pairing_points.P0._y.fix_witness();
    translator_pairing_points.P1._x.fix_witness();
    translator_pairing_points.P1._y.fix_witness();
