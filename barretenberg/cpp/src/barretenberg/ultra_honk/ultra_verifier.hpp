...
template <typename Flavor, class IO> class UltraVerifier_ {
  public:
     ...
     *   returns UltraVerifierOutput with bool result
     * - Recursive: Calls reduce_to_claims() and returns UltraRecursiveVerifierOutput with pairing
     *   points for deferred verification in outer circuit
