...
template class OinkVerifier<DualUltraFlavor>;
template class OinkVerifier<DualUltraZKFlavor>;
template class OinkVerifier<MegaFlavor>;
template class OinkVerifier<MegaZKFlavor>;
template class OinkVerifier<DualMegaFlavor>;
template class OinkVerifier<DualMegaZKFlavor>;
...
template class OinkVerifier<DualUltraRecursiveFlavor_<UltraCircuitBuilder>>;
template class OinkVerifier<DualUltraRecursiveFlavor_<MegaCircuitBuilder>>;
template class OinkVerifier<DualUltraZKRecursiveFlavor_<UltraCircuitBuilder>>;
template class OinkVerifier<DualUltraZKRecursiveFlavor_<MegaCircuitBuilder>>;
template class OinkVerifier<DualMegaRecursiveFlavor_<UltraCircuitBuilder>>;
template class OinkVerifier<DualMegaRecursiveFlavor_<MegaCircuitBuilder>>;
template class OinkVerifier<DualMegaZKRecursiveFlavor_<UltraCircuitBuilder>>;
template class OinkVerifier<DualMegaZKRecursiveFlavor_<MegaCircuitBuilder>>;
