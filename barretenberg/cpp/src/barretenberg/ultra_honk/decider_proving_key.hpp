...
template <IsHonkFlavor Flavor> class DeciderProvingKey_ {
  ...
  public:
                       ...
                       std::shared_ptr<typename Flavor::CommitmentKey> commitment_key = nullptr)
    {
        ...
        info("creating decider proving key");
        ...
        }
        {
            ...
            if (IsGoblinFlavor<Flavor> && !is_structured) {
...
#endif
                    info("allocating gate selectors");
...
#endif
                    info("allocating non-gate selectors");
...
#endif
                    info("allocating ecc op wires and selector");
...
#endif
                    info("allocating table polynomials");
...
#endif
                    info("allocating sigmas and ids");
                ...
                }
                {
                    ...
                    info("allocating lookup read counts and tags");
                ...
                }
                {
                    ...
                    info("allocating lookup and databus inverses");
...
#endif
                    info("allocating lagrange polynomials");
...
#endif
        info("constructing prover instance after trace populate");
...
#endif
            info("constructing databus polynomials");
...
#endif
            info("constructing lookup table polynomials");
...
#endif
            info("constructing lookup read counts");
