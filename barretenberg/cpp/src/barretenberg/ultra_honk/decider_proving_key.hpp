...
template <IsUltraOrMegaHonk Flavor> class DeciderProvingKey_ {
  ...
  public:
    ...
    {
        BB_BENCH_TRACY_NAME("DeciderProvingKey(Circuit&)");
        ...
        {
            BB_BENCH_TRACY_NAME("allocating proving key");
        ...
        {
            BB_BENCH_TRACY_NAME("constructing prover instance after trace populate");

            // If Goblin, construct the databus polynomials
            if constexpr (IsMegaFlavor<Flavor>) {
                BB_BENCH_TRACY_NAME("constructing databus polynomials");
        ...
        {
            BB_BENCH_TRACY_NAME("constructing lookup table polynomials");
        ...
        {
            BB_BENCH_TRACY_NAME("constructing lookup read counts");
