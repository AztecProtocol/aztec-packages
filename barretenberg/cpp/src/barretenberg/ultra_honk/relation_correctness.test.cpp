...
//     for (size_t i = 1; i < Flavor::MINI_CIRCUIT_SIZE - 1; i += 2) {
//         // P.x
//         prover_polynomials.x_lo_y_hi[i] = FF(engine.get_random_uint256() & ((uint256_t(1) << LOW_WIDE_LIMB_WIDTH) -
//         1)); prover_polynomials.x_hi_z_1[i] = FF(engine.get_random_uint256() & ((uint256_t(1) <<
//         HIGH_WIDE_LIMB_WIDTH) - 1));

//         // P.y
//         prover_polynomials.y_lo_z_2[i] = FF(engine.get_random_uint256() & ((uint256_t(1) << LOW_WIDE_LIMB_WIDTH) -
//         1)); prover_polynomials.x_lo_y_hi[i + 1] =
...
//         prover_polynomials.p_y_high_limbs[i] = uint256_t(prover_polynomials.x_lo_y_hi[i + 1]).slice(0,
//         NUM_LIMB_BITS); prover_polynomials.p_y_high_limbs[i + 1] =
...
//         prover_polynomials.z_low_limbs[i + 1] = uint256_t(prover_polynomials.y_lo_z_2[i + 1]).slice(0,
//         NUM_LIMB_BITS); prover_polynomials.z_high_limbs[i] =
