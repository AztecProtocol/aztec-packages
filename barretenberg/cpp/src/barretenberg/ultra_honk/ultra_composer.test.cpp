 ...
 *
 */
TEST_F(UltraHonkComposerTests, Toy)
{
    ...
    // }
    // idx = 0;
    // for (auto& coeff : prover.instance->proving_key.id_1) {
    //     info("idx = ", idx);
    //     info(coeff);
    //     idx++;
    // }
    ...
    for (size_t idx = 0; idx < prover.instance->proving_key.circuit_size; ++idx) {
        ...
        // info("val2 = ", prover.instance->proving_key.id_2[idx]);
        // info("val3 = ", prover.instance->proving_key.sigma_3[idx]);
        // info("val3 = ", prover.instance->proving_key.id_3[idx]);
        // info("val4 = ", prover.instance->proving_key.sigma_4[idx]);
    }
