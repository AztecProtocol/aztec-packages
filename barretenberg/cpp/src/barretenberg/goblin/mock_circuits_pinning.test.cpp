...
//             GoblinMockCircuits::construct_mock_recursion_kernel_circuit(kernel_circuit, function_accum,
//             kernel_accum); GoblinUltraComposer composer; auto instance =
//             composer.create_prover_instance(kernel_circuit); if (large) {
//                 EXPECT_EQ(instance->proving_key->log_circuit_size, 17);
//             } else {
//                 EXPECT_EQ(instance->proving_key->log_circuit_size, 17);
//             };
