...
// WORKTODO(Luke) remove this once we're using GoblinUltra properly
// This is a hack to use Ultra instead of GoblinUltra in DSL, this should just be goblin.hpp in the final version
...
class GoblinHack {
    ...
    using GUHFlavor = proof_system::honk::flavor::Ultra; // TEMPORARY HACK
