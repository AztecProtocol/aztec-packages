...
class KernelIONative {
  public:
     ...
     */
    static KernelIONative from_proof(const std::vector<NativeFF>& proof, size_t num_public_inputs)
    {
        KernelIONative result;
...
class HidingKernelIONative {
  public:
     ...
     * @param num_public_inputs Total number of public inputs in the proof
     */
    static HidingKernelIONative from_proof(const std::vector<NativeFF>& proof, size_t num_public_inputs)
    {
        HidingKernelIONative result;
        size_t idx = num_public_inputs - PUBLIC_INPUTS_SIZE;
