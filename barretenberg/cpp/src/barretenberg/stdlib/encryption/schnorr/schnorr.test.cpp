...
/**
 * @test Test circuit verifying a Schnorr signature generated by \see{crypto::schnorr::schnorr_verify_signature}.
...
TEST(stdlib_schnorr, schnorr_verify_signature)
{
    ...
    for (size_t i : test_lengths) {
        ...
        crypto::schnorr::schnorr_signature signature =
            crypto::schnorr::schnorr_construct_signature<Blake2sHasher, grumpkin::fq, grumpkin::fr, grumpkin::g1>(
                message_string, account);

        bool first_result =
            crypto::schnorr::schnorr_verify_signature<Blake2sHasher, grumpkin::fq, grumpkin::fr, grumpkin::g1>(
...
TEST(stdlib_schnorr, verify_signature_failure)
{
    ...
    // create key pair 1
    crypto::schnorr::schnorr_key_pair<grumpkin::fr, grumpkin::g1> account1;
    account1.private_key = grumpkin::fr::random_element();
    account1.public_key = grumpkin::g1::one * account1.private_key;

    // create key pair 2
    crypto::schnorr::schnorr_key_pair<grumpkin::fr, grumpkin::g1> account2;
