...
TEST(stdlib_ecdsa, verify_signature)
{
    ...
    crypto::ecdsa::key_pair<curve_::fr, curve_::g1> account;
    account.private_key = curve_::fr::random_element();
    account.public_key = curve_::g1::one * account.private_key;

    crypto::ecdsa::signature signature =
        crypto::ecdsa::construct_signature<Sha256Hasher, curve_::fq, curve_::fr, curve_::g1>(message_string, account);

    bool first_result = crypto::ecdsa::verify_signature<Sha256Hasher, curve_::fq, curve_::fr, curve_::g1>(
    ...
    stdlib::ecdsa::signature<Builder> sig{ curve_::byte_array_ct(&builder, rr),
    ...
    curve_::bool_ct signature_result =
        stdlib::ecdsa::verify_signature<Builder, curve_, curve_::fq_ct, curve_::bigfr_ct, curve_::g1_bigfr_ct>(
...
TEST(stdlib_ecdsa, verify_signature_noassert_succeed)
{
    ...
    curve_::bool_ct signature_result =
        stdlib::ecdsa::verify_signature_noassert<Builder, curve_, curve_::fq_ct, curve_::bigfr_ct, curve_::g1_bigfr_ct>(
            message, public_key, sig);
