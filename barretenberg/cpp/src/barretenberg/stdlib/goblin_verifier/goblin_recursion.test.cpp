...
TEST_F(GoblinRecursionTests, Vanilla)
{
    ...
    for (size_t circuit_idx = 0; circuit_idx < NUM_CIRCUITS; ++circuit_idx) {
        ...
        function_circuit.add_pairing_point_accum(stdlib::recursion::init_default_agg_obj_indices(function_circuit));
        ...
        kernel_circuit.add_pairing_point_accum(stdlib::recursion::init_default_agg_obj_indices(kernel_circuit));
