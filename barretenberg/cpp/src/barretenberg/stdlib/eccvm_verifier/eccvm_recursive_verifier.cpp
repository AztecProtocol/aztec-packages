...
//     commitments.gemini_masking_poly = transcript->template
//     receive_from_prover<Commitment>("Gemini:masking_poly_comm");
...
//  */
// void ECCVMRecursiveVerifier::compute_translation_opening_claims(const std::vector<Commitment>&
