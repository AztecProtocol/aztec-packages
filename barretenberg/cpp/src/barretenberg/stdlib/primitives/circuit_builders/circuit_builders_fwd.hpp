...
template <size_t BS> class MegaZKFlavor_;
...
template <typename BuilderType> class DualMegaRecursiveFlavor_;
template <typename BuilderType> class DualMegaZKRecursiveFlavor_;
