...
//         grumpkin_element<Builder> group_element = grumpkin_element<Builder>::from_witness(&builder,
//         group_element_val); this->check_conversion(group_element, /* valid circuit */ false);
//     }
