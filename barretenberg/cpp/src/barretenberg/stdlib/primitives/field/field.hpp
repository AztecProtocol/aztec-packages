...
template <typename Builder_> class field_t {
  public:
    ...
    template <typename B> friend void mark_witness_as_logic(const field_t<B>& field);
    template <typename B> friend void mark_witness_as_aes128(const field_t<B>& field);
