 ...
 */
template <typename Builder, typename BigGroupType, bool _use_bigfield = false> class BigGroupBase {
  private:
    ...
    // the field of scalars acting on biggroup_t
    using big_scalar_t =
      ...
      public:
        ...
        ExecutionHandler set(Builder* builder)
        {
            ...
            case 2: {
                ...
                biggroup_t bg_new(this->bg().get_value());
                bg_new = this->bg();
                                              ...
                                              Instruction& instruction)
        {
            ...
            stack.push_back(
                ExecutionHandler(instruction.arguments.element.scalar,
                                 ...
                                 biggroup_t(static_cast<AffineElement>(instruction.arguments.element.value))));
                                                      ...
                                                      Instruction& instruction)
        {
            ...
            if (VarianceRNG.next() & 1) {
                ...
                biggroup_t biggroup(static_cast<AffineElement>(instruction.arguments.element.value));
...
template <typename Builder>
using BigGroupBN254BFBase = BigGroupBase<Builder, bb::stdlib::bn254<Builder>, /*_use_bigfield=*/true>;
