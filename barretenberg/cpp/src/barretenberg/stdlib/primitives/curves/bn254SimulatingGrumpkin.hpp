...
template <typename CircuitBuilder> struct bn254SimulatingGrumpkin {
    ...
    using Group = element<CircuitBuilder, BaseField, ScalarField, GroupNative>; // will Group native work?
    using Element = Group;
    ...
    using bigfr_ct = bigfield<CircuitBuilder, bb::Bn254FqParams>;
