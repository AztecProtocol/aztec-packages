...
TEST(stdlib_blake2b, test_single_block)
{
    Builder builder;
    std::string input =
    ...
    byte_array_ct output = stdlib::Blake2b<Builder>::hash(input_arr);

    auto expected = crypto::blake2b(input_v);
...
TEST(stdlib_blake2b, test_double_block)
{
    Builder builder;
    std::string input = "abcdefghijklmnopqrstuvwxyz0123456789abcdefghijklmnopqrstuvwxyz0123456789abcdefghijklmnopqrstuv"
                        "wxyz0123456789abcdefghijklmnopqrstuvwxyz0123456789abcdefghijklmnopqrstuvwxyz0123456789";
    std::vector<uint8_t> input_v(input.begin(), input.end());
...
TEST(stdlib_blake2b, test_witness_and_constant)
{
    Builder builder;
...
TEST(stdlib_blake2b, test_multiple_sized_blocks)
{
