...
template <typename Params, typename Builder> class Poseidon2PermutationClassic {
  public:
    ...
    static State goblin_permutation(Builder* builder, const State& input);
    /**
...
extern template class Poseidon2PermutationClassic<crypto::Poseidon2Bn254ScalarFieldParams, GoblinUltraCircuitBuilder>;
