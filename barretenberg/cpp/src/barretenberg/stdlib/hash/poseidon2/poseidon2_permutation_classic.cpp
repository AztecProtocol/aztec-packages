#include "poseidon2_permutation_classic.hpp"
...
void Poseidon2PermutationClassic<Params, Builder>::add_round_constants(
    State& input, const typename Poseidon2PermutationClassic<Params, Builder>::RoundConstants& rc)
{
...
template <typename Params, typename Builder> void Poseidon2PermutationClassic<Params, Builder>::apply_sbox(State& input)
{
    for (auto& in : input) {
...
template <typename Params, typename Builder>
void Poseidon2PermutationClassic<Params, Builder>::apply_single_sbox(field_t<Builder>& input)
{
...
template <typename Params, typename Builder>
void Poseidon2PermutationClassic<Params, Builder>::matrix_multiplication_internal(State& input)
{
    // for t = 4
    auto sum = input[0];
...
template <typename Params, typename Builder>
typename Poseidon2PermutationClassic<Params, Builder>::State Poseidon2PermutationClassic<Params, Builder>::
    goblin_permutation(Builder* builder, const typename Poseidon2PermutationClassic<Params, Builder>::State& input)
{
    // deep copy
    ...
    for (size_t i = 0; i < rounds_f_beginning; ++i) {
        poseidon2_external_gate_<FF> in{ current_state[0].witness_index,
                                         ...
                                         i };
        ((GoblinUltraCircuitBuilder*)builder)->create_poseidon2_external_gate(in);
    ...
    for (size_t i = rounds_f_beginning; i < p_end; ++i) {
        poseidon2_internal_gate_<FF> in{ current_state[0].witness_index,
                                         ...
                                         current_state[3].witness_index,
                                         i };
        ((GoblinUltraCircuitBuilder*)builder)->create_poseidon2_internal_gate(in);
    ...
    ((GoblinUltraCircuitBuilder*)builder)->create_poseidon2_end_gate(in);
 ...
 */
template <typename Params, typename Builder>
typename Poseidon2PermutationClassic<Params, Builder>::State Poseidon2PermutationClassic<Params, Builder>::permutation(
    Builder* builder, const typename Poseidon2PermutationClassic<Params, Builder>::State& input)
{
    // deep copy
    State current_state(input);
    NativeState current_native_state;
 ...
 */
template <typename Params, typename Builder>
void Poseidon2PermutationClassic<Params, Builder>::initial_external_matrix_multiplication(
    Builder* builder, typename Poseidon2PermutationClassic<Params, Builder>::State& state)
{
...
template class Poseidon2PermutationClassic<crypto::Poseidon2Bn254ScalarFieldParams, GoblinUltraCircuitBuilder>;
template class Poseidon2PermutationClassic<crypto::Poseidon2Bn254ScalarFieldParams, UltraCircuitBuilder>;
