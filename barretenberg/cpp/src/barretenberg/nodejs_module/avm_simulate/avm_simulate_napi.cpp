...
Napi::Value AvmSimulateNapi::simulate(const Napi::CallbackInfo& info)
{
    ...
    if (info.Length() < 3) {
        throw Napi::TypeError::New(
            env, "Wrong number of arguments. Expected 3 arguments: inputs Buffer, contractProvider object, and worldStateHandle.");
    }
    ...
    auto* op = new AsyncOperation(env, deferred, [data, instance_tsfn, class_tsfn, ws_ptr](msgpack::sbuffer& result_buffer) {
