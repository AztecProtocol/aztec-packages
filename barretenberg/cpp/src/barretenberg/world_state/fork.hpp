...
using AppendOnlyHashPolicy = crypto::merkle_tree::AztecMerkleHashPolicy;
...
using NullifierTree =
    crypto::merkle_tree::ContentAddressedIndexedTree<NullifierStore, crypto::merkle_tree::NullifierMerkleHashPolicy>;
...
using PublicDataTree =
    crypto::merkle_tree::ContentAddressedIndexedTree<PublicDataStore, crypto::merkle_tree::PublicDataMerkleHashPolicy>;
