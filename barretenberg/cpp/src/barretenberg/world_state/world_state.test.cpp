...
TEST_F(WorldStateTest, GetInitialTreeInfoForAllTrees)
{
...

    {
        ...
        EXPECT_EQ(info.meta.root, bb::fr("0x0ad385c733f09879d005b1c483468232813916924a93cb305f26f9772908efa5"));
    }
...

    {
        ...
        EXPECT_EQ(info.meta.root, bb::fr("0x0c38b50018e675c7b3d40d20f250c710d9c565a28ed5cd1fbe057ac9b5902192"));
    }
...
TEST_F(WorldStateTest, GetStateReference)
{
...

    {
        auto state_ref = ws.get_state_reference(WorldStateRevision::committed());
        {
            ...
            EXPECT_EQ(
                snapshot,
                std::make_pair(bb::fr("0x0ad385c733f09879d005b1c483468232813916924a93cb305f26f9772908efa5"), 128UL));
        }
...

        {
            ...
            EXPECT_EQ(
                snapshot,
                std::make_pair(bb::fr("0x0c38b50018e675c7b3d40d20f250c710d9c565a28ed5cd1fbe057ac9b5902192"), 128UL));
        }
...
TEST_F(WorldStateTest, SyncExternalBlockFromEmpty)
{
    ...
    StateReference block_state_ref = {
        { MerkleTreeId::NULLIFIER_TREE,
          { fr("0x0010e22315e53af6e65f99b9ce2b0f7b71d19bfd7b126405b52131fee84260e8"), 129 } },
        { MerkleTreeId::NOTE_HASH_TREE,
          { fr("0x25c4ef02ba2bec9490376d5b56b8f1a8e5bcf5ecff91636e76660b68c2a9952d"), 1 } },
        { MerkleTreeId::PUBLIC_DATA_TREE,
          { fr("0x2b70015583348ad6701a8e610a4b89c38b41e8e3abccb2bc837e3b8818c18c82"), 129 } },
        { MerkleTreeId::L1_TO_L2_MESSAGE_TREE,
