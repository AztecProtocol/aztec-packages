...
TEST_F(WorldStateTest, NullifierBatchInsert)
{
    ...
    std::vector<std::pair<NullifierLeafValue, crypto::merkle_tree::index_t>> expected_sorted_leaves = {
        { NullifierLeafValue(180), 2 }, { NullifierLeafValue(150), 0 }, { NullifierLeafValue(142), 1 }
    };
