/**
 * @brief Comparison benchmark: current vs pre-regression pippenger implementations
 *
 ...
 *
 * AVM-like batch config: 2618 wire polys of size 2^21, committed in batches of 32.
 */
...
// AVM-like: 32 polys of size 2^21 (one batch worth from ~2618 wire polys committed in batches of 32)
// Also test smaller configs for comparison
#define BATCH_ARGS Args({ 32, 1 << 19 })->Args({ 32, 1 << 21 })
