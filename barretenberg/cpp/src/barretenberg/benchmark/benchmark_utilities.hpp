...
//             root_ct, merkle_tree::create_witness_hash_path(builder, merkle_tree.get_hash_path(idx)), value_ct,
//             idx_ct);
//     }
// }
...
//  * @brief Performs proof constuction for benchmarks based on a provided circuit function
//  *
//  * @details This function assumes state.range refers to num_iterations which is the number of times to perform a
//  given
