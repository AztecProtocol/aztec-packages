 ...
 */
void construct_proof_ultra_iters(State& state, void (*test_circuit_function)(UltraBuilder&, size_t)) noexcept
{
    bench_utils::construct_proof_with_specified_num_iterations<UltraPlonk>(state, test_circuit_function);
}

void construct_proof_ultra_gates(State& state, void (*test_circuit_function)(UltraBuilder&, size_t)) noexcept
{
...
// BENCHMARK_CAPTURE(construct_proof_ultra_iters, sha256, &bench_utils::generate_sha256_test_circuit<UltraBuilder>)
//     ->DenseRange(MIN_NUM_ITERATIONS, MAX_NUM_ITERATIONS)
//     ->Repetitions(NUM_REPETITIONS)
//     ->Unit(::benchmark::kMillisecond);
// BENCHMARK_CAPTURE(construct_proof_ultra_iters, keccak, &bench_utils::generate_keccak_test_circuit<UltraBuilder>)
//     ->DenseRange(MIN_NUM_ITERATIONS, MAX_NUM_ITERATIONS)
//     ->Repetitions(NUM_REPETITIONS)
//     ->Unit(::benchmark::kMillisecond);
// BENCHMARK_CAPTURE(construct_proof_ultra_iters,
//                   ecdsa_verification,
