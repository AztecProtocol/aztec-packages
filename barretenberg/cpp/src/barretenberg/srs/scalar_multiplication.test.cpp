...
TYPED_TEST(ScalarMultiplicationTests, RadixSort)
{
    ...
    scalar_multiplication::compute_wnaf_states<Curve>(
        state.point_schedule, state.skew_table, state.round_counts, { scalars, target_degree }, target_degree);
...
TYPED_TEST(ScalarMultiplicationTests, OversizedInputs)
{
    ...
    Element first =
        scalar_multiplication::pippenger<Curve>({ scalars, target_degree }, monomials, target_degree, state);
    ...
    Element second =
        scalar_multiplication::pippenger<Curve>({ scalars, target_degree }, monomials, target_degree, state_2);
...
TYPED_TEST(ScalarMultiplicationTests, PippengerZeroPoints)
{
    ...
    Element result = scalar_multiplication::pippenger<Curve>({ scalars, 0 }, points, 0, state);
...
TYPED_TEST(ScalarMultiplicationTests, PippengerMulByZero)
{
    ...
    Element result = scalar_multiplication::pippenger<Curve>({ scalars, 1 }, points, 1, state);
