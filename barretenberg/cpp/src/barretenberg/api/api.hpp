...
class API {
  public:
    ...
    struct Flags {
        ...
        std::string verifier_target;          // target verification environment (evm, noir-recursive, starknet, etc.)
        ...
        bool is_hiding_kernel{ false };         // chonk-only: compute VK as MegaZKFlavor (hiding kernel) vs MegaFlavor
