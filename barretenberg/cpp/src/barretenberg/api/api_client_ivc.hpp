...
class ClientIVCAPI : public API {
  ...
  public:
    void prove(const Flags& flags, const std::string& input_path, const std::string& output_dir);
    ...
    bool prove_and_verify(const std::string& input_path);
    ...
    bool check_precomputed_vks(const Flags& flags, const std::string& input_path);
