...
// Old version - self-contained in scalar_multiplication_old namespace
...
namespace bb::scalar_multiplication_old {
...
{
    BB_BENCH_NAME("old::transform_scalars");
...
{
    BB_BENCH_NAME("old::get_work_units");
...
{
    BB_BENCH_NAME("old::add_affine_points");
...
{
    BB_BENCH_NAME("old::jacobian_pippenger");
...
{
    BB_BENCH_NAME("old::affine_pippenger");
                                                             ...
                                                             const size_t bits_per_slice) noexcept
{
    ...
    const size_t num_zero_entries = scalar_multiplication_old::process_buckets_count_zero_entries(
...
{
    BB_BENCH_NAME("old::batch_multi_scalar_mul");
...
template class bb::scalar_multiplication_old::MSM<bb::curve::Grumpkin>;
template class bb::scalar_multiplication_old::MSM<bb::curve::BN254>;
