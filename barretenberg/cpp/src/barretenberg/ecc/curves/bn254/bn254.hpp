...
class BN254 {
  public:
    ...
    // BN254's scalar field has a multiplicative subgroup of order 2^28. It is generated by 5^{r / 2^28}. The generator
    // below is 5^{r / 2^8} (so it has order 8). To avoid inversion in the recursive verifier, we also store the inverse
