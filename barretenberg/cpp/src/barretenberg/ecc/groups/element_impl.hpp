...
<<<<<<< HEAD:circuits/cpp/barretenberg/cpp/src/barretenberg/ecc/groups/element_impl.hpp
#include "element.hpp"
...
>>>>>>> origin/master:barretenberg/cpp/src/barretenberg/ecc/groups/element_impl.hpp
    ...
    template <class Fq, class Fr, class T>
    constexpr element<Fq, Fr, T>::operator affine_element<Fq, Fr, T>() const noexcept
    {
    ...
    template <class Fq, class Fr, class T>
    element<Fq, Fr, T> element<Fq, Fr, T>::operator*=(const Fr& exponent) noexcept
    {
