...
class UltraCircuitChecker {
  ...
  private:
    ...
    #ifdef ULTRA_FUZZ
    static bool UltraCircuitChecker::relaxed_check_aux_relation(UltraCircuitBuilder &builder);
    static bool UltraCircuitChecker::relaxed_check_delta_range_relation(UltraCircuitBuilder &builder);
    #endif
