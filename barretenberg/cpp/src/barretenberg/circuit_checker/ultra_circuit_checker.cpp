...
template <> auto UltraCircuitChecker::init_empty_values<UltraCircuitBuilder_<UltraExecutionTrace>>()
{
...
template bool UltraCircuitChecker::check<UltraCircuitBuilder_<UltraExecutionTrace>>(
    const UltraCircuitBuilder_<UltraExecutionTrace>& builder_in);
