...
/**
 * @brief Partial specialization for recursive MultiMegaRecursiveFlavor (any builder type).
 */
...
/**
 * @brief Partial specialization for recursive MultiMegaZKRecursiveFlavor (any builder type).
 */
template <typename BuilderType>
