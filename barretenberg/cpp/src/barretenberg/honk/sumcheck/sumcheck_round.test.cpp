...
//                 .beta = FF::random_element(), .gamma = FF::random_element(), .public_input_delta =
//                 FF::random_element()
//             };
...
//     auto tuple_of_tuples = std::make_tuple(std::make_tuple(univariate_1), std::make_tuple(univariate_2,
//     univariate_3));
