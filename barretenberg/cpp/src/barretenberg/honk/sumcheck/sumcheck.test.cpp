...
ProverPolynomials construct_ultra_full_polynomials(auto& input_polynomials)
{
    ...
    full_polynomials.q_double = input_polynomials[9];
    full_polynomials.q_aux = input_polynomials[10];
    full_polynomials.q_lookup = input_polynomials[11];
    full_polynomials.sigma_1 = input_polynomials[12];
    full_polynomials.sigma_2 = input_polynomials[13];
    full_polynomials.sigma_3 = input_polynomials[14];
    full_polynomials.sigma_4 = input_polynomials[15];
    full_polynomials.id_1 = input_polynomials[16];
    full_polynomials.id_2 = input_polynomials[17];
    full_polynomials.id_3 = input_polynomials[18];
    full_polynomials.id_4 = input_polynomials[19];
    full_polynomials.table_1 = input_polynomials[20];
    full_polynomials.table_2 = input_polynomials[21];
    full_polynomials.table_3 = input_polynomials[22];
    full_polynomials.table_4 = input_polynomials[23];
    full_polynomials.lagrange_first = input_polynomials[24];
    full_polynomials.lagrange_last = input_polynomials[25];
    full_polynomials.w_l = input_polynomials[26];
    full_polynomials.w_r = input_polynomials[27];
    full_polynomials.w_o = input_polynomials[28];
    full_polynomials.w_4 = input_polynomials[29];
    full_polynomials.sorted_accum = input_polynomials[30];
    full_polynomials.z_perm = input_polynomials[31];
    full_polynomials.z_lookup = input_polynomials[32];
    full_polynomials.table_1_shift = input_polynomials[33];
    full_polynomials.table_2_shift = input_polynomials[34];
    full_polynomials.table_3_shift = input_polynomials[35];
    full_polynomials.table_4_shift = input_polynomials[36];
    full_polynomials.w_l_shift = input_polynomials[37];
    full_polynomials.w_r_shift = input_polynomials[38];
    full_polynomials.w_o_shift = input_polynomials[39];
    full_polynomials.w_4_shift = input_polynomials[40];
    full_polynomials.sorted_accum_shift = input_polynomials[41];
    full_polynomials.z_perm_shift = input_polynomials[42];
    full_polynomials.z_lookup_shift = input_polynomials[43];
