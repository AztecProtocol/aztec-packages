                           ...
                           size_t size_override = 0)
{
    ...
    // For ZK flavors with top-of-trace masking, the grand product starts after the disabled rows.
    constexpr size_t gp_start =
        (Flavor::HasZK && UseRowDisablingPolynomial<Flavor>) ? NUM_DISABLED_ROWS_IN_SUMCHECK : 0;
