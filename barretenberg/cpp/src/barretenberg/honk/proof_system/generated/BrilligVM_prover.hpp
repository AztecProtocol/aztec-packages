...
template <typename Flavor> class BrilligVMProver_ {
  ...
  public:
    explicit BrilligVMProver_(std::shared_ptr<ProvingKey> input_key, std::shared_ptr<PCSCommitmentKey> commitment_key);
...
extern template class BrilligVMProver_<honk::flavor::BrilligVMFlavor>;

using BrilligVMProver = BrilligVMProver_<honk::flavor::BrilligVMFlavor>;
