...
template <typename Flavor> class ExampleRelationProver_ {
  ...
  public:
    explicit ExampleRelationProver_(std::shared_ptr<ProvingKey> input_key,
...
extern template class ExampleRelationProver_<honk::flavor::ExampleRelationFlavor>;

using ExampleRelationProver = ExampleRelationProver_<honk::flavor::ExampleRelationFlavor>;
