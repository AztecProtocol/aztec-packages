...
#include "ExampleRelation_prover.hpp"
...
/**
 * Create ExampleRelationProver_ from proving key, witness and manifest.
 *
 ...
 *
 */
template <typename Flavor> void ExampleRelationProver_<Flavor>::compute_wire_commitments()
{
 ...
 *
 */
template <typename Flavor> void ExampleRelationProver_<Flavor>::execute_preamble_round()
{
 ...
 *
 */
template <typename Flavor> void ExampleRelationProver_<Flavor>::execute_wire_commitments_round()
{
    auto wire_polys = key->get_wires();
    auto labels = commitment_labels.get_wires();
    for (size_t idx = 0; idx < wire_polys.size(); ++idx) {
 ...
 *
 */
template <typename Flavor> void ExampleRelationProver_<Flavor>::execute_relation_check_rounds()
{
 ...
 *
 * */
template <typename Flavor> void ExampleRelationProver_<Flavor>::execute_univariatization_round()
{
 ...
 * */
template <typename Flavor> void ExampleRelationProver_<Flavor>::execute_pcs_evaluation_round()
{
 ...
 * */
template <typename Flavor> void ExampleRelationProver_<Flavor>::execute_shplonk_batched_quotient_round()
{
 ...
 * */
template <typename Flavor> void ExampleRelationProver_<Flavor>::execute_shplonk_partial_evaluation_round()
{
...
template <typename Flavor> plonk::proof& ExampleRelationProver_<Flavor>::construct_proof()
{
...
template class ExampleRelationProver_<honk::flavor::ExampleRelationFlavor>;
