...
template <typename Flavor> // WORKTODO: this is a duplicate method?
void compute_permutation_grand_products([[maybe_unused]] std::shared_ptr<typename Flavor::ProvingKey>& key,
