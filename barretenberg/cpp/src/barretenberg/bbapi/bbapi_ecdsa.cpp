...
EcdsaSecp256k1ComputePublicKey::Response EcdsaSecp256k1ComputePublicKey::execute(BBApiRequest& request) &&
{
    (void)request;
    return { secp256k1::g1::one * private_key };
}

EcdsaSecp256k1ConstructSignature::Response EcdsaSecp256k1ConstructSignature::execute(BBApiRequest& request) &&
{
    (void)request;
...
EcdsaSecp256k1RecoverPublicKey::Response EcdsaSecp256k1RecoverPublicKey::execute(BBApiRequest& request) &&
{
    (void)request;
...
EcdsaSecp256k1VerifySignature::Response EcdsaSecp256k1VerifySignature::execute(BBApiRequest& request) &&
{
    (void)request;
...
EcdsaSecp256r1ComputePublicKey::Response EcdsaSecp256r1ComputePublicKey::execute(BBApiRequest& request) &&
{
    (void)request;
    return { secp256r1::g1::one * private_key };
}

EcdsaSecp256r1ConstructSignature::Response EcdsaSecp256r1ConstructSignature::execute(BBApiRequest& request) &&
{
    (void)request;
...
EcdsaSecp256r1RecoverPublicKey::Response EcdsaSecp256r1RecoverPublicKey::execute(BBApiRequest& request) &&
{
    (void)request;
...
EcdsaSecp256r1VerifySignature::Response EcdsaSecp256r1VerifySignature::execute(BBApiRequest& request) &&
{
    (void)request;
