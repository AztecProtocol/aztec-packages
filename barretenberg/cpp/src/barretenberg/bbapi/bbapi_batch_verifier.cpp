...
ChonkBatchVerifierCancelBySource::Response ChonkBatchVerifierCancelBySource::execute(BBApiRequest& request) &&
{
    BB_BENCH_NAME(MSGPACK_SCHEMA_NAME);
    ...
    uint32_t count = request.batch_verifier_service->cancel_by_source(source);
