...
GrumpkinGetRandomFr::Response GrumpkinGetRandomFr::execute(BBApiRequest& request) &&
{
    (void)request;
    return { bb::fr::random_element() };
}

GrumpkinReduce512::Response GrumpkinReduce512::execute(BBApiRequest& request) &&
{
    (void)request;
...
Secp256k1GetRandomFr::Response Secp256k1GetRandomFr::execute(BBApiRequest& request) &&
{
    (void)request;
    return { secp256k1::fr::random_element() };
}

Secp256k1Reduce512::Response Secp256k1Reduce512::execute(BBApiRequest& request) &&
{
    (void)request;
    auto bigint_input = from_buffer<uint512_t>(input.data());
...
Bn254FrSqrt::Response Bn254FrSqrt::execute(BBApiRequest& request) &&
{
    (void)request;
