...
// The generated field aliases live in the wire sub-namespace. Named one by one rather than pulled
// in wholesale, so a wire type can never shadow a domain type of the same name.
using wire::Fq;
using wire::Fr;
using wire::Secp256k1Fq;
using wire::Secp256k1Fr;
using wire::Secp256r1Fq;
using wire::Secp256r1Fr;
using wire::Uint256;
