...
std::tuple<std::optional<SumcheckChonk::RecursiveVerifierAccumulator>,
           std::vector<SumcheckChonk::PairingPoints>,
 ...
 * being SumcheckChonk. ECCVM is not affected by the concerns above, randomness being added to wires at proving time
 ...
 * `SumcheckChonk::hide_op_queue_accumulation_result()` and SmallSubgroupIPA in ECCVM.
 *
