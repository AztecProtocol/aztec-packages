...
/**
 * @brief Run Chonk verification up to but not including IPA.
 * @details Verifies MegaZK proof, databus consistency, and Goblin proof,
 * returning the IPA claim for deferred batch verification.
 */
...
/**
 * @brief Stub for recursive mode (reduce_to_ipa_claim is only used in native batch verification).
 */
template <>
