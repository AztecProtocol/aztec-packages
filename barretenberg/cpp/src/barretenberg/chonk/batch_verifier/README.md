...
A high-throughput service for verifying Chonk IVC proofs. Proofs are batched for amortized IPA verification.
...
```
  ...
  │                                                      │
  │   Owns IPABatchProcessor + FIFO writer               │
  │                                                      │
  │  ┌──────────────────────────────────────────┐       │
  │  │ IPABatchProcessor                        │       │
  │  │                                          │       │
  │  │ Phase 1: parallel reduce to IPA claims   │       │
  │  │ Phase 2: batch IPA verify (1 MSM)        │       │
  │  │ Phase 3: emit OK or bisect on failure    │       │
  │  └──────────────────┬───────────────────────┘       │
  │                     ▼                                │
  │              VerifyResult                            │
  │                     │                                │
...
Submit a proof for batch verification.
...
## Batch Pipeline (IPABatchProcessor)
...
chonk/batch_verifier/              ← this directory
  ...
  ipa_batch_processor.hpp/cpp       # 3-phase batch pipeline
