...
contract HonkVerifier is IVerifier {
    ...
    uint256 internal constant q_poseidon2_external_x_loc = 0x960;
    uint256 internal constant q_poseidon2_external_y_loc = 0x980;
    uint256 internal constant q_poseidon2_internal_x_loc = 0x9e0;
    uint256 internal constant q_poseidon2_internal_y_loc = 0xa00;
    ...
    function verify(bytes calldata, bytes32[] calldata) public override returns (bool) {
        ...
        assembly {
            ...
            function loadVk() {
              ...
              mstore(q_l_x_loc, {{ vk_q_l_x }})
              mstore(q_l_y_loc, {{ vk_q_l_y }})
              mstore(q_r_x_loc, {{ vk_q_r_x }})
              mstore(q_r_y_loc, {{ vk_q_r_y }})
              mstore(q_o_x_loc, {{ vk_q_o_x }})
              mstore(q_o_y_loc, {{ vk_q_o_y }})
              mstore(q_4_x_loc, {{ vk_q_4_x }})
              mstore(q_4_y_loc, {{ vk_q_4_y }})
              mstore(q_m_x_loc, {{ vk_q_m_x }})
              mstore(q_m_y_loc, {{ vk_q_m_y }})
              mstore(q_c_x_loc, {{ vk_q_c_x }})
              mstore(q_c_y_loc, {{ vk_q_c_y }})
              mstore(q_arith_x_loc, {{ vk_q_arith_x }})
              mstore(q_arith_y_loc, {{ vk_q_arith_y }})
              mstore(q_delta_range_x_loc, {{ vk_q_delta_range_x }})
              mstore(q_delta_range_y_loc, {{ vk_q_delta_range_y }})
              mstore(q_elliptic_x_loc, {{ vk_q_elliptic_x }})
              mstore(q_elliptic_y_loc, {{ vk_q_elliptic_y }})
              mstore(q_aux_x_loc, {{ vk_q_aux_x }})
              mstore(q_aux_y_loc, {{ vk_q_aux_y }})
              mstore(q_lookup_x_loc, {{ vk_q_lookup_x }})
              mstore(q_lookup_y_loc, {{ vk_q_lookup_y }})
              mstore(q_poseidon2_external_x_loc, {{ vk_q_poseidon2_external_x }})
              mstore(q_poseidon2_external_y_loc, {{ vk_q_poseidon2_external_y }})
              mstore(q_poseidon2_internal_x_loc, {{ vk_q_poseidon2_internal_x }})
              mstore(q_poseidon2_internal_y_loc, {{ vk_q_poseidon2_internal_y }})
              mstore(sigma_1_x_loc, {{ vk_sigma_1_x }})
              mstore(sigma_1_y_loc, {{ vk_sigma_1_y }})
              mstore(sigma_2_x_loc, {{ vk_sigma_2_x }})
              mstore(sigma_2_y_loc, {{ vk_sigma_2_y }})
              mstore(sigma_3_x_loc, {{ vk_sigma_3_x }})
              mstore(sigma_3_y_loc, {{ vk_sigma_3_y }})
              mstore(sigma_4_x_loc, {{ vk_sigma_4_x }})
              mstore(sigma_4_y_loc, {{ vk_sigma_4_y }})
              // TODO: in the proog pointers above swap id and table - to line up with how they actually should be
              mstore(table_1_x_loc, {{ vk_table_1_x }})
              mstore(table_1_y_loc, {{ vk_table_1_y }})
              mstore(table_2_x_loc, {{ vk_table_2_x }})
              mstore(table_2_y_loc, {{ vk_table_2_y }})
              mstore(table_3_x_loc, {{ vk_table_3_x }})
              mstore(table_3_y_loc, {{ vk_table_3_y }})
              mstore(table_4_x_loc, {{ vk_table_4_x }})
              mstore(table_4_y_loc, {{ vk_table_4_y }})
              mstore(id_1_x_loc, {{ vk_id_1_x }})
              mstore(id_1_y_loc, {{ vk_id_1_y }})
              mstore(id_2_x_loc, {{ vk_id_2_x }})
              mstore(id_2_y_loc, {{ vk_id_2_y }})
              mstore(id_3_x_loc, {{ vk_id_3_x }})
              mstore(id_3_y_loc, {{ vk_id_3_y }})
              mstore(id_4_x_loc, {{ vk_id_4_x }})
              mstore(id_4_y_loc, {{ vk_id_4_y }})
              mstore(lagrange_first_x_loc, {{ vk_lagrange_first_x }})
              mstore(lagrange_first_y_loc, {{ vk_lagrange_first_y }})
              mstore(lagrange_last_x_loc, {{ vk_lagrange_last_x }})
              mstore(lagrange_last_y_loc, {{ vk_lagrange_last_y }})
            }
           ...
           let shifted_scalar := 0
           {
            ...
            loadVk()
            {
                ...
                mcopy(G1_LOCATION, q_poseidon2_external_x_loc, 0x40)
                mstore(SCALAR_LOCATION, mload(BATCH_SCALAR_12_LOC))
                precomp_success_flag := and(precomp_success_flag, staticcall(gas(), 7, G1_LOCATION, 0x60, ACCUMULATOR_2, 0x40))
                precomp_success_flag := and(precomp_success_flag, staticcall(gas(), 6, ACCUMULATOR, 0x80, ACCUMULATOR, 0x40))

                // Accumulator = accumulator + scalar[13] * vk[12]
                mcopy(G1_LOCATION, q_poseidon2_internal_x_loc, 0x40)
