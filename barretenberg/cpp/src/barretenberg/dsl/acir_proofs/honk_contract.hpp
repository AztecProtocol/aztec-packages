...
#include "barretenberg/third_party/inja/inja.hpp"
#include <filesystem>
#include <sstream>
    ...
    function verify(bytes calldata, bytes32[] calldata) public override returns (bool) {
        ...
        assembly {
            ...
            function loadVk() {
              ...
              mstore(q_l_x_loc, {{ vk.q_l_x }})
              mstore(q_l_y_loc, {{ vk.q_l_y }})
              mstore(q_r_x_loc, {{ vk.q_r_x }})
              mstore(q_r_y_loc, {{ vk.q_r_y }})
              mstore(q_o_x_loc, {{ vk.q_o_x }})
              mstore(q_o_y_loc, {{ vk.q_o_y }})
              mstore(q_4_x_loc, {{ vk.q_4_x }})
              mstore(q_4_y_loc, {{ vk.q_4_y }})
              mstore(q_m_x_loc, {{ vk.q_m_x }})
              mstore(q_m_y_loc, {{ vk.q_m_y }})
              mstore(q_c_x_loc, {{ vk.q_c_x }})
              mstore(q_c_y_loc, {{ vk.q_c_y }})
              mstore(q_arith_x_loc, {{ vk.q_arith_x }})
              mstore(q_arith_y_loc, {{ vk.q_arith_y }})
              mstore(q_delta_range_x_loc, {{ vk.q_delta_range_x }})
              mstore(q_delta_range_y_loc, {{ vk.q_delta_range_y }})
              mstore(q_elliptic_x_loc, {{ vk.q_elliptic_x }})
              mstore(q_elliptic_y_loc, {{ vk.q_elliptic_y }})
              mstore(q_aux_x_loc, {{ vk.q_aux_x }})
              mstore(q_aux_y_loc, {{ vk.q_aux_y }})
              mstore(q_lookup_x_loc, {{ vk.q_lookup_x }})
              mstore(q_lookup_y_loc, {{ vk.q_lookup_y }})
              mstore(q_poseidon2_external_x_loc, {{ vk.q_poseidon2_external_x }})
              mstore(q_poseidon2_external_y_loc, {{ vk.q_poseidon2_external_y }})
              mstore(q_poseidon2_internal_x_loc, {{ vk.q_poseidon2_internal_x }})
              mstore(q_poseidon2_internal_y_loc, {{ vk.q_poseidon2_internal_y }})
              mstore(sigma_1_x_loc, {{ vk.sigma_1_x }})
              mstore(sigma_1_y_loc, {{ vk.sigma_1_y }})
              mstore(sigma_2_x_loc, {{ vk.sigma_2_x }})
              mstore(sigma_2_y_loc, {{ vk.sigma_2_y }})
              mstore(sigma_3_x_loc, {{ vk.sigma_3_x }})
              mstore(sigma_3_y_loc, {{ vk.sigma_3_y }})
              mstore(sigma_4_x_loc, {{ vk.sigma_4_x }})
              mstore(sigma_4_y_loc, {{ vk.sigma_4_y }})
              // TODO: in the proog pointers above swap id and table - to line up with how they actually should be
              mstore(table_1_x_loc, {{ vk.table_1_x }})
              mstore(table_1_y_loc, {{ vk.table_1_y }})
              mstore(table_2_x_loc, {{ vk.table_2_x }})
              mstore(table_2_y_loc, {{ vk.table_2_y }})
              mstore(table_3_x_loc, {{ vk.table_3_x }})
              mstore(table_3_y_loc, {{ vk.table_3_y }})
              mstore(table_4_x_loc, {{ vk.table_4_x }})
              mstore(table_4_y_loc, {{ vk.table_4_y }})
              mstore(id_1_x_loc, {{ vk.id_1_x }})
              mstore(id_1_y_loc, {{ vk.id_1_y }})
              mstore(id_2_x_loc, {{ vk.id_2_x }})
              mstore(id_2_y_loc, {{ vk.id_2_y }})
              mstore(id_3_x_loc, {{ vk.id_3_x }})
              mstore(id_3_y_loc, {{ vk.id_3_y }})
              mstore(id_4_x_loc, {{ vk.id_4_x }})
              mstore(id_4_y_loc, {{ vk.id_4_y }})
              mstore(lagrange_first_x_loc, {{ vk.lagrange_first_x }})
              mstore(lagrange_first_y_loc, {{ vk.lagrange_first_y }})
              mstore(lagrange_last_x_loc, {{ vk.lagrange_last_x }})
              mstore(lagrange_last_y_loc, {{ vk.lagrange_last_y }})
            }
...
inline std::string get_honk_solidity_verifier(auto const& verification_key)
{
    ...
    context["vk"]["q_l_x"] = field_to_hex(verification_key->q_l.x);
    context["vk"]["q_l_y"] = field_to_hex(verification_key->q_l.y);
    context["vk"]["q_r_x"] = field_to_hex(verification_key->q_r.x);
    context["vk"]["q_r_y"] = field_to_hex(verification_key->q_r.y);
    context["vk"]["q_o_x"] = field_to_hex(verification_key->q_o.x);
    context["vk"]["q_o_y"] = field_to_hex(verification_key->q_o.y);
    context["vk"]["q_4_x"] = field_to_hex(verification_key->q_4.x);
    context["vk"]["q_4_y"] = field_to_hex(verification_key->q_4.y);
    context["vk"]["q_m_x"] = field_to_hex(verification_key->q_m.x);
    context["vk"]["q_m_y"] = field_to_hex(verification_key->q_m.y);
    context["vk"]["q_c_x"] = field_to_hex(verification_key->q_c.x);
    context["vk"]["q_c_y"] = field_to_hex(verification_key->q_c.y);
    context["vk"]["q_arith_x"] = field_to_hex(verification_key->q_arith.x);
    context["vk"]["q_arith_y"] = field_to_hex(verification_key->q_arith.y);
    context["vk"]["q_delta_range_x"] = field_to_hex(verification_key->q_delta_range.x);
    context["vk"]["q_delta_range_y"] = field_to_hex(verification_key->q_delta_range.y);
    context["vk"]["q_elliptic_x"] = field_to_hex(verification_key->q_elliptic.x);
    context["vk"]["q_elliptic_y"] = field_to_hex(verification_key->q_elliptic.y);
    context["vk"]["q_aux_x"] = field_to_hex(verification_key->q_aux.x);
    context["vk"]["q_aux_y"] = field_to_hex(verification_key->q_aux.y);
    context["vk"]["q_lookup_x"] = field_to_hex(verification_key->q_lookup.x);
    context["vk"]["q_lookup_y"] = field_to_hex(verification_key->q_lookup.y);
    context["vk"]["q_poseidon2_external_x"] = field_to_hex(verification_key->q_poseidon2_external.x);
    context["vk"]["q_poseidon2_external_y"] = field_to_hex(verification_key->q_poseidon2_external.y);
    context["vk"]["q_poseidon2_internal_x"] = field_to_hex(verification_key->q_poseidon2_internal.x);
    context["vk"]["q_poseidon2_internal_y"] = field_to_hex(verification_key->q_poseidon2_internal.y);
    context["vk"]["sigma_1_x"] = field_to_hex(verification_key->sigma_1.x);
    context["vk"]["sigma_1_y"] = field_to_hex(verification_key->sigma_1.y);
    context["vk"]["sigma_2_x"] = field_to_hex(verification_key->sigma_2.x);
    context["vk"]["sigma_2_y"] = field_to_hex(verification_key->sigma_2.y);
    context["vk"]["sigma_3_x"] = field_to_hex(verification_key->sigma_3.x);
    context["vk"]["sigma_3_y"] = field_to_hex(verification_key->sigma_3.y);
    context["vk"]["sigma_4_x"] = field_to_hex(verification_key->sigma_4.x);
    context["vk"]["sigma_4_y"] = field_to_hex(verification_key->sigma_4.y);
    context["vk"]["table_1_x"] = field_to_hex(verification_key->table_1.x);
    context["vk"]["table_1_y"] = field_to_hex(verification_key->table_1.y);
    context["vk"]["table_2_x"] = field_to_hex(verification_key->table_2.x);
    context["vk"]["table_2_y"] = field_to_hex(verification_key->table_2.y);
    context["vk"]["table_3_x"] = field_to_hex(verification_key->table_3.x);
    context["vk"]["table_3_y"] = field_to_hex(verification_key->table_3.y);
    context["vk"]["table_4_x"] = field_to_hex(verification_key->table_4.x);
    context["vk"]["table_4_y"] = field_to_hex(verification_key->table_4.y);
    context["vk"]["id_1_x"] = field_to_hex(verification_key->id_1.x);
    context["vk"]["id_1_y"] = field_to_hex(verification_key->id_1.y);
    context["vk"]["id_2_x"] = field_to_hex(verification_key->id_2.x);
    context["vk"]["id_2_y"] = field_to_hex(verification_key->id_2.y);
    context["vk"]["id_3_x"] = field_to_hex(verification_key->id_3.x);
    context["vk"]["id_3_y"] = field_to_hex(verification_key->id_3.y);
    context["vk"]["id_4_x"] = field_to_hex(verification_key->id_4.x);
    context["vk"]["id_4_y"] = field_to_hex(verification_key->id_4.y);
    context["vk"]["lagrange_first_x"] = field_to_hex(verification_key->lagrange_first.x);
    context["vk"]["lagrange_first_y"] = field_to_hex(verification_key->lagrange_first.y);
    context["vk"]["lagrange_last_x"] = field_to_hex(verification_key->lagrange_last.x);
    context["vk"]["lagrange_last_y"] = field_to_hex(verification_key->lagrange_last.y);

    // Below code can be used during development to make changes to .sol template without recompiling
    // Create honk_contract.sol file in same directory and copy the above template to it
    // std::filesystem::path source_dir = std::filesystem::path(__FILE__).parent_path();
    // std::filesystem::path template_path = source_dir / "honk_contract.sol";
    // return env.render_file(template_path.string(), context);

    return templateEnv.render(HONK_CONTRACT_SOURCE, context);
}
