...
WASM_EXPORT void acir_prove_and_verify_ultra_honk(uint8_t const* acir_vec, uint8_t const* witness_vec, bool* result)
{
    ...
    auto proving_key = std::make_shared<ProverInstance_<UltraFlavor>>(builder);
...
WASM_EXPORT void acir_prove_and_verify_mega_honk(uint8_t const* acir_vec, uint8_t const* witness_vec, bool* result)
{
    ...
    auto proving_key = std::make_shared<ProverInstance_<MegaFlavor>>(builder);
                                          ...
                                          uint8_t** out)
{
    ...
    UltraZKProver prover = [&] {
        ...
        auto builder = acir_format::create_circuit<UltraCircuitBuilder>(program, metadata);
        auto proving_key = std::make_shared<ProverInstance_<UltraZKFlavor>>(builder);
                                              ...
                                              uint8_t** out)
{
    ...
    UltraKeccakProver prover = [&] {
        ...
        auto proving_key = std::make_shared<ProverInstance_<UltraKeccakFlavor>>(builder);
                                                 ...
                                                 uint8_t** out)
{
    ...
    UltraKeccakZKProver prover = [&] {
        ...
        auto proving_key = std::make_shared<ProverInstance_<UltraKeccakZKFlavor>>(builder);
