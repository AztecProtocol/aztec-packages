...
WASM_EXPORT void acir_get_circuit_sizes(uint8_t const* acir_vec,
                                        ...
                                        uint32_t* subgroup)
{
    const acir_format::ProgramMetadata metadata{ .is_rollup_flavor = *is_rollup_flavor, .size_hint = 1 << 19 };
...
{
    const acir_format::ProgramMetadata metadata{ .is_rollup_flavor = false };
