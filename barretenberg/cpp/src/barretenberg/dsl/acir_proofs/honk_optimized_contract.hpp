...
contract HonkVerifier is IVerifier {
    ...
    uint256 internal constant  Q_LOOKUP_X_LOC  =  0x6e0 ;
    uint256 internal constant  Q_LOOKUP_Y_LOC  =  0x700 ;
    uint256 internal constant  Q_ARITH_X_LOC  =  0x760 ;
    uint256 internal constant  Q_ARITH_Y_LOC  =  0x780 ;
    uint256 internal constant  Q_DELTA_RANGE_X_LOC  =  0x7e0 ;
    uint256 internal constant  Q_DELTA_RANGE_Y_LOC  =  0x800 ;
    uint256 internal constant  Q_ELLIPTIC_X_LOC  =  0x860 ;
    uint256 internal constant  Q_ELLIPTIC_Y_LOC  =  0x880 ;
    uint256 internal constant  Q_MEMORY_X_LOC  =  0x8e0 ;
    uint256 internal constant  Q_MEMORY_Y_LOC  =  0x900 ;
    uint256 internal constant  Q_NNF_X_LOC  =  0x960 ;
    uint256 internal constant  Q_NNF_Y_LOC  =  0x980 ;
    uint256 internal constant  Q_POSEIDON_2_EXTERNAL_X_LOC  =  0x9e0 ;
    uint256 internal constant  Q_POSEIDON_2_EXTERNAL_Y_LOC  =  0xa00 ;
    uint256 internal constant  Q_POSEIDON_2_INTERNAL_X_LOC  =  0xa60 ;
    uint256 internal constant  Q_POSEIDON_2_INTERNAL_Y_LOC  =  0xa80 ;
    uint256 internal constant  SIGMA_1_X_LOC  =  0xae0 ;
    uint256 internal constant  SIGMA_1_Y_LOC  =  0xb00 ;
    uint256 internal constant  SIGMA_2_X_LOC  =  0xb60 ;
    uint256 internal constant  SIGMA_2_Y_LOC  =  0xb80 ;
    uint256 internal constant  SIGMA_3_X_LOC  =  0xbe0 ;
    uint256 internal constant  SIGMA_3_Y_LOC  =  0xc00 ;
    uint256 internal constant  SIGMA_4_X_LOC  =  0xc60 ;
    uint256 internal constant  SIGMA_4_Y_LOC  =  0xc80 ;
    uint256 internal constant  ID_1_X_LOC  =  0xce0 ;
    uint256 internal constant  ID_1_Y_LOC  =  0xd00 ;
    uint256 internal constant  ID_2_X_LOC  =  0xd60 ;
    uint256 internal constant  ID_2_Y_LOC  =  0xd80 ;
    uint256 internal constant  ID_3_X_LOC  =  0xde0 ;
    uint256 internal constant  ID_3_Y_LOC  =  0xe00 ;
    uint256 internal constant  ID_4_X_LOC  =  0xe60 ;
    uint256 internal constant  ID_4_Y_LOC  =  0xe80 ;
    uint256 internal constant  TABLE_1_X_LOC  =  0xee0 ;
    uint256 internal constant  TABLE_1_Y_LOC  =  0xf00 ;
    uint256 internal constant  TABLE_2_X_LOC  =  0xf60 ;
    uint256 internal constant  TABLE_2_Y_LOC  =  0xf80 ;
    uint256 internal constant  TABLE_3_X_LOC  =  0xfe0 ;
    uint256 internal constant  TABLE_3_Y_LOC  =  0x1000 ;
    uint256 internal constant  TABLE_4_X_LOC  =  0x1060 ;
    uint256 internal constant  TABLE_4_Y_LOC  =  0x1080 ;
    uint256 internal constant  LAGRANGE_FIRST_X_LOC  =  0x10e0 ;
    uint256 internal constant  LAGRANGE_FIRST_Y_LOC  =  0x1100 ;
    uint256 internal constant  LAGRANGE_LAST_X_LOC  =  0x1160 ;
    uint256 internal constant  LAGRANGE_LAST_Y_LOC  =  0x1180 ;

    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*                       PROOF INDICIES                       */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  PAIRING_POINT_0  =  0x11e0 ;
    uint256 internal constant  PAIRING_POINT_1  =  0x1200 ;
    uint256 internal constant  PAIRING_POINT_2  =  0x1220 ;
    uint256 internal constant  PAIRING_POINT_3  =  0x1240 ;
    uint256 internal constant  PAIRING_POINT_4  =  0x1260 ;
    uint256 internal constant  PAIRING_POINT_5  =  0x1280 ;
    uint256 internal constant  PAIRING_POINT_6  =  0x12a0 ;
    uint256 internal constant  PAIRING_POINT_7  =  0x12c0 ;
    uint256 internal constant  PAIRING_POINT_8  =  0x12e0 ;
    uint256 internal constant  PAIRING_POINT_9  =  0x1300 ;
    uint256 internal constant  PAIRING_POINT_10  =  0x1320 ;
    uint256 internal constant  PAIRING_POINT_11  =  0x1340 ;
    uint256 internal constant  PAIRING_POINT_12  =  0x1360 ;
    uint256 internal constant  PAIRING_POINT_13  =  0x1380 ;
    uint256 internal constant  PAIRING_POINT_14  =  0x13a0 ;
    uint256 internal constant  PAIRING_POINT_15  =  0x13c0 ;
    uint256 internal constant  W_L_X0_LOC  =  0x13e0 ;
    uint256 internal constant  W_L_X1_LOC  =  0x1400 ;
    uint256 internal constant  W_L_Y0_LOC  =  0x1420 ;
    uint256 internal constant  W_L_Y1_LOC  =  0x1440 ;
    uint256 internal constant  W_R_X0_LOC  =  0x1460 ;
    uint256 internal constant  W_R_X1_LOC  =  0x1480 ;
    uint256 internal constant  W_R_Y0_LOC  =  0x14a0 ;
    uint256 internal constant  W_R_Y1_LOC  =  0x14c0 ;
    uint256 internal constant  W_O_X0_LOC  =  0x14e0 ;
    uint256 internal constant  W_O_X1_LOC  =  0x1500 ;
    uint256 internal constant  W_O_Y0_LOC  =  0x1520 ;
    uint256 internal constant  W_O_Y1_LOC  =  0x1540 ;
    uint256 internal constant  LOOKUP_READ_COUNTS_X0_LOC  =  0x1560 ;
    uint256 internal constant  LOOKUP_READ_COUNTS_X1_LOC  =  0x1580 ;
    uint256 internal constant  LOOKUP_READ_COUNTS_Y0_LOC  =  0x15a0 ;
    uint256 internal constant  LOOKUP_READ_COUNTS_Y1_LOC  =  0x15c0 ;
    uint256 internal constant  LOOKUP_READ_TAGS_X0_LOC  =  0x15e0 ;
    uint256 internal constant  LOOKUP_READ_TAGS_X1_LOC  =  0x1600 ;
    uint256 internal constant  LOOKUP_READ_TAGS_Y0_LOC  =  0x1620 ;
    uint256 internal constant  LOOKUP_READ_TAGS_Y1_LOC  =  0x1640 ;
    uint256 internal constant  W_4_X0_LOC  =  0x1660 ;
    uint256 internal constant  W_4_X1_LOC  =  0x1680 ;
    uint256 internal constant  W_4_Y0_LOC  =  0x16a0 ;
    uint256 internal constant  W_4_Y1_LOC  =  0x16c0 ;
    uint256 internal constant  LOOKUP_INVERSES_X0_LOC  =  0x16e0 ;
    uint256 internal constant  LOOKUP_INVERSES_X1_LOC  =  0x1700 ;
    uint256 internal constant  LOOKUP_INVERSES_Y0_LOC  =  0x1720 ;
    uint256 internal constant  LOOKUP_INVERSES_Y1_LOC  =  0x1740 ;
    uint256 internal constant  Z_PERM_X0_LOC  =  0x1760 ;
    uint256 internal constant  Z_PERM_X1_LOC  =  0x1780 ;
    uint256 internal constant  Z_PERM_Y0_LOC  =  0x17a0 ;
    uint256 internal constant  Z_PERM_Y1_LOC  =  0x17c0 ;

    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*           PROOF INDICIES - SUMCHECK UNIVARIATES            */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_0_LOC  =  0x17e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_1_LOC  =  0x1800 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_2_LOC  =  0x1820 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_3_LOC  =  0x1840 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_4_LOC  =  0x1860 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_5_LOC  =  0x1880 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_6_LOC  =  0x18a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_7_LOC  =  0x18c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_8_LOC  =  0x18e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_9_LOC  =  0x1900 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_10_LOC  =  0x1920 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_11_LOC  =  0x1940 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_12_LOC  =  0x1960 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_13_LOC  =  0x1980 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_14_LOC  =  0x19a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_15_LOC  =  0x19c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_16_LOC  =  0x19e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_17_LOC  =  0x1a00 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_18_LOC  =  0x1a20 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_19_LOC  =  0x1a40 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_20_LOC  =  0x1a60 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_21_LOC  =  0x1a80 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_22_LOC  =  0x1aa0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_23_LOC  =  0x1ac0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_24_LOC  =  0x1ae0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_25_LOC  =  0x1b00 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_26_LOC  =  0x1b20 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_0_27_LOC  =  0x1b40 ;
    ...
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_8_LOC  =  0x1c60 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_9_LOC  =  0x1c80 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_10_LOC  =  0x1ca0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_11_LOC  =  0x1cc0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_12_LOC  =  0x1ce0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_13_LOC  =  0x1d00 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_14_LOC  =  0x1d20 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_15_LOC  =  0x1d40 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_16_LOC  =  0x1d60 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_17_LOC  =  0x1d80 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_18_LOC  =  0x1da0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_19_LOC  =  0x1dc0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_20_LOC  =  0x1de0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_21_LOC  =  0x1e00 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_22_LOC  =  0x1e20 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_23_LOC  =  0x1e40 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_24_LOC  =  0x1e60 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_25_LOC  =  0x1e80 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_26_LOC  =  0x1ea0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_1_27_LOC  =  0x1ec0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_0_LOC  =  0x1ee0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_1_LOC  =  0x1f00 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_2_LOC  =  0x1f20 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_3_LOC  =  0x1f40 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_4_LOC  =  0x1f60 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_5_LOC  =  0x1f80 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_6_LOC  =  0x1fa0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_7_LOC  =  0x1fc0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_8_LOC  =  0x1fe0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_9_LOC  =  0x2000 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_10_LOC  =  0x2020 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_11_LOC  =  0x2040 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_12_LOC  =  0x2060 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_13_LOC  =  0x2080 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_14_LOC  =  0x20a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_15_LOC  =  0x20c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_16_LOC  =  0x20e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_17_LOC  =  0x2100 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_18_LOC  =  0x2120 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_19_LOC  =  0x2140 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_20_LOC  =  0x2160 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_21_LOC  =  0x2180 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_22_LOC  =  0x21a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_23_LOC  =  0x21c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_24_LOC  =  0x21e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_25_LOC  =  0x2200 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_26_LOC  =  0x2220 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_2_27_LOC  =  0x2240 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_0_LOC  =  0x2260 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_1_LOC  =  0x2280 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_2_LOC  =  0x22a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_3_LOC  =  0x22c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_4_LOC  =  0x22e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_5_LOC  =  0x2300 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_6_LOC  =  0x2320 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_7_LOC  =  0x2340 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_8_LOC  =  0x2360 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_9_LOC  =  0x2380 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_10_LOC  =  0x23a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_11_LOC  =  0x23c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_12_LOC  =  0x23e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_13_LOC  =  0x2400 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_14_LOC  =  0x2420 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_15_LOC  =  0x2440 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_16_LOC  =  0x2460 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_17_LOC  =  0x2480 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_18_LOC  =  0x24a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_19_LOC  =  0x24c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_20_LOC  =  0x24e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_21_LOC  =  0x2500 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_22_LOC  =  0x2520 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_23_LOC  =  0x2540 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_24_LOC  =  0x2560 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_25_LOC  =  0x2580 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_26_LOC  =  0x25a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_3_27_LOC  =  0x25c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_0_LOC  =  0x25e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_1_LOC  =  0x2600 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_2_LOC  =  0x2620 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_3_LOC  =  0x2640 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_4_LOC  =  0x2660 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_5_LOC  =  0x2680 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_6_LOC  =  0x26a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_7_LOC  =  0x26c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_8_LOC  =  0x26e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_9_LOC  =  0x2700 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_10_LOC  =  0x2720 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_11_LOC  =  0x2740 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_12_LOC  =  0x2760 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_13_LOC  =  0x2780 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_14_LOC  =  0x27a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_15_LOC  =  0x27c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_16_LOC  =  0x27e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_17_LOC  =  0x2800 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_18_LOC  =  0x2820 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_19_LOC  =  0x2840 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_20_LOC  =  0x2860 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_21_LOC  =  0x2880 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_22_LOC  =  0x28a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_23_LOC  =  0x28c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_24_LOC  =  0x28e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_25_LOC  =  0x2900 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_26_LOC  =  0x2920 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_4_27_LOC  =  0x2940 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_0_LOC  =  0x2960 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_1_LOC  =  0x2980 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_2_LOC  =  0x29a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_3_LOC  =  0x29c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_4_LOC  =  0x29e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_5_LOC  =  0x2a00 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_6_LOC  =  0x2a20 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_7_LOC  =  0x2a40 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_8_LOC  =  0x2a60 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_9_LOC  =  0x2a80 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_10_LOC  =  0x2aa0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_11_LOC  =  0x2ac0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_12_LOC  =  0x2ae0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_13_LOC  =  0x2b00 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_14_LOC  =  0x2b20 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_15_LOC  =  0x2b40 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_16_LOC  =  0x2b60 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_17_LOC  =  0x2b80 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_18_LOC  =  0x2ba0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_19_LOC  =  0x2bc0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_20_LOC  =  0x2be0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_21_LOC  =  0x2c00 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_22_LOC  =  0x2c20 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_23_LOC  =  0x2c40 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_24_LOC  =  0x2c60 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_25_LOC  =  0x2c80 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_26_LOC  =  0x2ca0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_5_27_LOC  =  0x2cc0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_0_LOC  =  0x2ce0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_1_LOC  =  0x2d00 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_2_LOC  =  0x2d20 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_3_LOC  =  0x2d40 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_4_LOC  =  0x2d60 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_5_LOC  =  0x2d80 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_6_LOC  =  0x2da0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_7_LOC  =  0x2dc0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_8_LOC  =  0x2de0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_9_LOC  =  0x2e00 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_10_LOC  =  0x2e20 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_11_LOC  =  0x2e40 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_12_LOC  =  0x2e60 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_13_LOC  =  0x2e80 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_14_LOC  =  0x2ea0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_15_LOC  =  0x2ec0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_16_LOC  =  0x2ee0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_17_LOC  =  0x2f00 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_18_LOC  =  0x2f20 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_19_LOC  =  0x2f40 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_20_LOC  =  0x2f60 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_21_LOC  =  0x2f80 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_22_LOC  =  0x2fa0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_23_LOC  =  0x2fc0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_24_LOC  =  0x2fe0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_25_LOC  =  0x3000 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_26_LOC  =  0x3020 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_6_27_LOC  =  0x3040 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_0_LOC  =  0x3060 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_1_LOC  =  0x3080 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_2_LOC  =  0x30a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_3_LOC  =  0x30c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_4_LOC  =  0x30e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_5_LOC  =  0x3100 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_6_LOC  =  0x3120 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_7_LOC  =  0x3140 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_8_LOC  =  0x3160 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_9_LOC  =  0x3180 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_10_LOC  =  0x31a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_11_LOC  =  0x31c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_12_LOC  =  0x31e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_13_LOC  =  0x3200 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_14_LOC  =  0x3220 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_15_LOC  =  0x3240 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_16_LOC  =  0x3260 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_17_LOC  =  0x3280 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_18_LOC  =  0x32a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_19_LOC  =  0x32c0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_20_LOC  =  0x32e0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_21_LOC  =  0x3300 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_22_LOC  =  0x3320 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_23_LOC  =  0x3340 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_24_LOC  =  0x3360 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_25_LOC  =  0x3380 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_26_LOC  =  0x33a0 ;
    uint256 internal constant  SUMCHECK_UNIVARIATE_7_27_LOC  =  0x33c0 ;

    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*           PROOF INDICIES - SUMCHECK EVALUATIONS            */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  QM_EVAL_LOC  =  0x33e0 ;
    uint256 internal constant  QC_EVAL_LOC  =  0x3400 ;
    uint256 internal constant  QL_EVAL_LOC  =  0x3420 ;
    uint256 internal constant  QR_EVAL_LOC  =  0x3440 ;
    uint256 internal constant  QO_EVAL_LOC  =  0x3460 ;
    uint256 internal constant  Q4_EVAL_LOC  =  0x3480 ;
    uint256 internal constant  QLOOKUP_EVAL_LOC  =  0x34a0 ;
    uint256 internal constant  QARITH_EVAL_LOC  =  0x34c0 ;
    uint256 internal constant  QRANGE_EVAL_LOC  =  0x34e0 ;
    uint256 internal constant  QELLIPTIC_EVAL_LOC  =  0x3500 ;
    uint256 internal constant  QMEMORY_EVAL_LOC  =  0x3520 ;
    uint256 internal constant  QNNF_EVAL_LOC  =  0x3540 ;
    uint256 internal constant  QPOSEIDON2_EXTERNAL_EVAL_LOC  =  0x3560 ;
    uint256 internal constant  QPOSEIDON2_INTERNAL_EVAL_LOC  =  0x3580 ;
    uint256 internal constant  SIGMA1_EVAL_LOC  =  0x35a0 ;
    uint256 internal constant  SIGMA2_EVAL_LOC  =  0x35c0 ;
    uint256 internal constant  SIGMA3_EVAL_LOC  =  0x35e0 ;
    uint256 internal constant  SIGMA4_EVAL_LOC  =  0x3600 ;
    uint256 internal constant  ID1_EVAL_LOC  =  0x3620 ;
    uint256 internal constant  ID2_EVAL_LOC  =  0x3640 ;
    uint256 internal constant  ID3_EVAL_LOC  =  0x3660 ;
    uint256 internal constant  ID4_EVAL_LOC  =  0x3680 ;
    uint256 internal constant  TABLE1_EVAL_LOC  =  0x36a0 ;
    uint256 internal constant  TABLE2_EVAL_LOC  =  0x36c0 ;
    uint256 internal constant  TABLE3_EVAL_LOC  =  0x36e0 ;
    uint256 internal constant  TABLE4_EVAL_LOC  =  0x3700 ;
    uint256 internal constant  LAGRANGE_FIRST_EVAL_LOC  =  0x3720 ;
    uint256 internal constant  LAGRANGE_LAST_EVAL_LOC  =  0x3740 ;
    uint256 internal constant  W1_EVAL_LOC  =  0x3760 ;
    uint256 internal constant  W2_EVAL_LOC  =  0x3780 ;
    uint256 internal constant  W3_EVAL_LOC  =  0x37a0 ;
    uint256 internal constant  W4_EVAL_LOC  =  0x37c0 ;
    uint256 internal constant  Z_PERM_EVAL_LOC  =  0x37e0 ;
    uint256 internal constant  LOOKUP_INVERSES_EVAL_LOC  =  0x3800 ;
    uint256 internal constant  LOOKUP_READ_COUNTS_EVAL_LOC  =  0x3820 ;
    uint256 internal constant  LOOKUP_READ_TAGS_EVAL_LOC  =  0x3840 ;
    uint256 internal constant  W1_SHIFT_EVAL_LOC  =  0x3860 ;
    uint256 internal constant  W2_SHIFT_EVAL_LOC  =  0x3880 ;
    uint256 internal constant  W3_SHIFT_EVAL_LOC  =  0x38a0 ;
    uint256 internal constant  W4_SHIFT_EVAL_LOC  =  0x38c0 ;
    uint256 internal constant  Z_PERM_SHIFT_EVAL_LOC  =  0x38e0 ;

    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*           PROOF INDICIES - GEMINI FOLDING COMMS            */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_0_X0_LOC  =  0x3900 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_0_X1_LOC  =  0x3920 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_0_Y0_LOC  =  0x3940 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_0_Y1_LOC  =  0x3960 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_1_X0_LOC  =  0x3980 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_1_X1_LOC  =  0x39a0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_1_Y0_LOC  =  0x39c0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_1_Y1_LOC  =  0x39e0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_2_X0_LOC  =  0x3a00 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_2_X1_LOC  =  0x3a20 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_2_Y0_LOC  =  0x3a40 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_2_Y1_LOC  =  0x3a60 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_3_X0_LOC  =  0x3a80 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_3_X1_LOC  =  0x3aa0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_3_Y0_LOC  =  0x3ac0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_3_Y1_LOC  =  0x3ae0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_4_X0_LOC  =  0x3b00 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_4_X1_LOC  =  0x3b20 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_4_Y0_LOC  =  0x3b40 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_4_Y1_LOC  =  0x3b60 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_5_X0_LOC  =  0x3b80 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_5_X1_LOC  =  0x3ba0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_5_Y0_LOC  =  0x3bc0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_5_Y1_LOC  =  0x3be0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_6_X0_LOC  =  0x3c00 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_6_X1_LOC  =  0x3c20 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_6_Y0_LOC  =  0x3c40 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_6_Y1_LOC  =  0x3c60 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_7_X0_LOC  =  0x3c80 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_7_X1_LOC  =  0x3ca0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_7_Y0_LOC  =  0x3cc0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_7_Y1_LOC  =  0x3ce0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_8_X0_LOC  =  0x3d00 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_8_X1_LOC  =  0x3d20 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_8_Y0_LOC  =  0x3d40 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_8_Y1_LOC  =  0x3d60 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_9_X0_LOC  =  0x3d80 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_9_X1_LOC  =  0x3da0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_9_Y0_LOC  =  0x3dc0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_9_Y1_LOC  =  0x3de0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_10_X0_LOC  =  0x3e00 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_10_X1_LOC  =  0x3e20 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_10_Y0_LOC  =  0x3e40 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_10_Y1_LOC  =  0x3e60 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_11_X0_LOC  =  0x3e80 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_11_X1_LOC  =  0x3ea0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_11_Y0_LOC  =  0x3ec0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_11_Y1_LOC  =  0x3ee0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_12_X0_LOC  =  0x3f00 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_12_X1_LOC  =  0x3f20 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_12_Y0_LOC  =  0x3f40 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_12_Y1_LOC  =  0x3f60 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_13_X0_LOC  =  0x3f80 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_13_X1_LOC  =  0x3fa0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_13_Y0_LOC  =  0x3fc0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_13_Y1_LOC  =  0x3fe0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_14_X0_LOC  =  0x4000 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_14_X1_LOC  =  0x4020 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_14_Y0_LOC  =  0x4040 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_14_Y1_LOC  =  0x4060 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_15_X0_LOC  =  0x4080 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_15_X1_LOC  =  0x40a0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_15_Y0_LOC  =  0x40c0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_15_Y1_LOC  =  0x40e0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_16_X0_LOC  =  0x4100 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_16_X1_LOC  =  0x4120 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_16_Y0_LOC  =  0x4140 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_16_Y1_LOC  =  0x4160 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_17_X0_LOC  =  0x4180 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_17_X1_LOC  =  0x41a0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_17_Y0_LOC  =  0x41c0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_17_Y1_LOC  =  0x41e0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_18_X0_LOC  =  0x4200 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_18_X1_LOC  =  0x4220 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_18_Y0_LOC  =  0x4240 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_18_Y1_LOC  =  0x4260 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_19_X0_LOC  =  0x4280 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_19_X1_LOC  =  0x42a0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_19_Y0_LOC  =  0x42c0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_19_Y1_LOC  =  0x42e0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_20_X0_LOC  =  0x4300 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_20_X1_LOC  =  0x4320 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_20_Y0_LOC  =  0x4340 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_20_Y1_LOC  =  0x4360 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_21_X0_LOC  =  0x4380 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_21_X1_LOC  =  0x43a0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_21_Y0_LOC  =  0x43c0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_21_Y1_LOC  =  0x43e0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_22_X0_LOC  =  0x4400 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_22_X1_LOC  =  0x4420 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_22_Y0_LOC  =  0x4440 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_22_Y1_LOC  =  0x4460 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_23_X0_LOC  =  0x4480 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_23_X1_LOC  =  0x44a0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_23_Y0_LOC  =  0x44c0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_23_Y1_LOC  =  0x44e0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_24_X0_LOC  =  0x4500 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_24_X1_LOC  =  0x4520 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_24_Y0_LOC  =  0x4540 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_24_Y1_LOC  =  0x4560 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_25_X0_LOC  =  0x4580 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_25_X1_LOC  =  0x45a0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_25_Y0_LOC  =  0x45c0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_25_Y1_LOC  =  0x45e0 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_26_X0_LOC  =  0x4600 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_26_X1_LOC  =  0x4620 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_26_Y0_LOC  =  0x4640 ;
    uint256 internal constant  GEMINI_FOLD_UNIVARIATE_26_Y1_LOC  =  0x4660 ;

    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*        PROOF INDICIES - GEMINI FOLDING EVALUATIONS         */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  GEMINI_A_EVAL_0  =  0x4680 ;
    uint256 internal constant  GEMINI_A_EVAL_1  =  0x46a0 ;
    uint256 internal constant  GEMINI_A_EVAL_2  =  0x46c0 ;
    uint256 internal constant  GEMINI_A_EVAL_3  =  0x46e0 ;
    uint256 internal constant  GEMINI_A_EVAL_4  =  0x4700 ;
    uint256 internal constant  GEMINI_A_EVAL_5  =  0x4720 ;
    uint256 internal constant  GEMINI_A_EVAL_6  =  0x4740 ;
    uint256 internal constant  GEMINI_A_EVAL_7  =  0x4760 ;
    uint256 internal constant  GEMINI_A_EVAL_8  =  0x4780 ;
    uint256 internal constant  GEMINI_A_EVAL_9  =  0x47a0 ;
    uint256 internal constant  GEMINI_A_EVAL_10  =  0x47c0 ;
    uint256 internal constant  GEMINI_A_EVAL_11  =  0x47e0 ;
    uint256 internal constant  GEMINI_A_EVAL_12  =  0x4800 ;
    uint256 internal constant  GEMINI_A_EVAL_13  =  0x4820 ;
    uint256 internal constant  GEMINI_A_EVAL_14  =  0x4840 ;
    uint256 internal constant  GEMINI_A_EVAL_15  =  0x4860 ;
    uint256 internal constant  GEMINI_A_EVAL_16  =  0x4880 ;
    uint256 internal constant  GEMINI_A_EVAL_17  =  0x48a0 ;
    uint256 internal constant  GEMINI_A_EVAL_18  =  0x48c0 ;
    uint256 internal constant  GEMINI_A_EVAL_19  =  0x48e0 ;
    uint256 internal constant  GEMINI_A_EVAL_20  =  0x4900 ;
    uint256 internal constant  GEMINI_A_EVAL_21  =  0x4920 ;
    uint256 internal constant  GEMINI_A_EVAL_22  =  0x4940 ;
    uint256 internal constant  GEMINI_A_EVAL_23  =  0x4960 ;
    uint256 internal constant  GEMINI_A_EVAL_24  =  0x4980 ;
    uint256 internal constant  GEMINI_A_EVAL_25  =  0x49a0 ;
    uint256 internal constant  GEMINI_A_EVAL_26  =  0x49c0 ;
    uint256 internal constant  GEMINI_A_EVAL_27  =  0x49e0 ;
    uint256 internal constant  SHPLONK_Q_X0_LOC  =  0x4a00 ;
    uint256 internal constant  SHPLONK_Q_X1_LOC  =  0x4a20 ;
    uint256 internal constant  SHPLONK_Q_Y0_LOC  =  0x4a40 ;
    uint256 internal constant  SHPLONK_Q_Y1_LOC  =  0x4a60 ;
    uint256 internal constant  KZG_QUOTIENT_X0_LOC  =  0x4a80 ;
    uint256 internal constant  KZG_QUOTIENT_X1_LOC  =  0x4aa0 ;
    uint256 internal constant  KZG_QUOTIENT_Y0_LOC  =  0x4ac0 ;
    uint256 internal constant  KZG_QUOTIENT_Y1_LOC  =  0x4ae0 ;
    ...
    /*                         CHALLENGES                         */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  ETA_CHALLENGE  =  0x4b00 ;
    uint256 internal constant  ETA_TWO_CHALLENGE  =  0x4b20 ;
    uint256 internal constant  ETA_THREE_CHALLENGE  =  0x4b40 ;
    uint256 internal constant  BETA_CHALLENGE  =  0x4b60 ;
    uint256 internal constant  GAMMA_CHALLENGE  =  0x4b80 ;
    uint256 internal constant  RHO_CHALLENGE  =  0x4ba0 ;
    uint256 internal constant  GEMINI_R_CHALLENGE  =  0x4bc0 ;
    uint256 internal constant  SHPLONK_NU_CHALLENGE  =  0x4be0 ;
    uint256 internal constant  SHPLONK_Z_CHALLENGE  =  0x4c00 ;
    uint256 internal constant  PUBLIC_INPUTS_DELTA_NUMERATOR_CHALLENGE  =  0x4c20 ;
    uint256 internal constant  PUBLIC_INPUTS_DELTA_DENOMINATOR_CHALLENGE  =  0x4c40 ;
    uint256 internal constant  ALPHA_CHALLENGE_0  =  0x4c60 ;
    uint256 internal constant  ALPHA_CHALLENGE_1  =  0x4c80 ;
    uint256 internal constant  ALPHA_CHALLENGE_2  =  0x4ca0 ;
    uint256 internal constant  ALPHA_CHALLENGE_3  =  0x4cc0 ;
    uint256 internal constant  ALPHA_CHALLENGE_4  =  0x4ce0 ;
    uint256 internal constant  ALPHA_CHALLENGE_5  =  0x4d00 ;
    uint256 internal constant  ALPHA_CHALLENGE_6  =  0x4d20 ;
    uint256 internal constant  ALPHA_CHALLENGE_7  =  0x4d40 ;
    uint256 internal constant  ALPHA_CHALLENGE_8  =  0x4d60 ;
    uint256 internal constant  ALPHA_CHALLENGE_9  =  0x4d80 ;
    uint256 internal constant  ALPHA_CHALLENGE_10  =  0x4da0 ;
    uint256 internal constant  ALPHA_CHALLENGE_11  =  0x4dc0 ;
    uint256 internal constant  ALPHA_CHALLENGE_12  =  0x4de0 ;
    uint256 internal constant  ALPHA_CHALLENGE_13  =  0x4e00 ;
    uint256 internal constant  ALPHA_CHALLENGE_14  =  0x4e20 ;
    uint256 internal constant  ALPHA_CHALLENGE_15  =  0x4e40 ;
    uint256 internal constant  ALPHA_CHALLENGE_16  =  0x4e60 ;
    uint256 internal constant  ALPHA_CHALLENGE_17  =  0x4e80 ;
    uint256 internal constant  ALPHA_CHALLENGE_18  =  0x4ea0 ;
    uint256 internal constant  ALPHA_CHALLENGE_19  =  0x4ec0 ;
    uint256 internal constant  ALPHA_CHALLENGE_20  =  0x4ee0 ;
    uint256 internal constant  ALPHA_CHALLENGE_21  =  0x4f00 ;
    uint256 internal constant  ALPHA_CHALLENGE_22  =  0x4f20 ;
    uint256 internal constant  ALPHA_CHALLENGE_23  =  0x4f40 ;
    uint256 internal constant  ALPHA_CHALLENGE_24  =  0x4f60 ;
    uint256 internal constant  ALPHA_CHALLENGE_25  =  0x4f80 ;
    uint256 internal constant  ALPHA_CHALLENGE_26  =  0x4fa0 ;
    uint256 internal constant  GATE_CHALLENGE_0  =  0x4fc0 ;
    uint256 internal constant  GATE_CHALLENGE_1  =  0x4fe0 ;
    uint256 internal constant  GATE_CHALLENGE_2  =  0x5000 ;
    uint256 internal constant  GATE_CHALLENGE_3  =  0x5020 ;
    uint256 internal constant  GATE_CHALLENGE_4  =  0x5040 ;
    uint256 internal constant  GATE_CHALLENGE_5  =  0x5060 ;
    uint256 internal constant  GATE_CHALLENGE_6  =  0x5080 ;
    uint256 internal constant  GATE_CHALLENGE_7  =  0x50a0 ;
    uint256 internal constant  GATE_CHALLENGE_8  =  0x50c0 ;
    uint256 internal constant  GATE_CHALLENGE_9  =  0x50e0 ;
    uint256 internal constant  GATE_CHALLENGE_10  =  0x5100 ;
    uint256 internal constant  GATE_CHALLENGE_11  =  0x5120 ;
    uint256 internal constant  GATE_CHALLENGE_12  =  0x5140 ;
    uint256 internal constant  GATE_CHALLENGE_13  =  0x5160 ;
    uint256 internal constant  GATE_CHALLENGE_14  =  0x5180 ;
    uint256 internal constant  GATE_CHALLENGE_15  =  0x51a0 ;
    uint256 internal constant  GATE_CHALLENGE_16  =  0x51c0 ;
    uint256 internal constant  GATE_CHALLENGE_17  =  0x51e0 ;
    uint256 internal constant  GATE_CHALLENGE_18  =  0x5200 ;
    uint256 internal constant  GATE_CHALLENGE_19  =  0x5220 ;
    uint256 internal constant  GATE_CHALLENGE_20  =  0x5240 ;
    uint256 internal constant  GATE_CHALLENGE_21  =  0x5260 ;
    uint256 internal constant  GATE_CHALLENGE_22  =  0x5280 ;
    uint256 internal constant  GATE_CHALLENGE_23  =  0x52a0 ;
    uint256 internal constant  GATE_CHALLENGE_24  =  0x52c0 ;
    uint256 internal constant  GATE_CHALLENGE_25  =  0x52e0 ;
    uint256 internal constant  GATE_CHALLENGE_26  =  0x5300 ;
    uint256 internal constant  GATE_CHALLENGE_27  =  0x5320 ;
    uint256 internal constant  SUM_U_CHALLENGE_0  =  0x5340 ;
    uint256 internal constant  SUM_U_CHALLENGE_1  =  0x5360 ;
    uint256 internal constant  SUM_U_CHALLENGE_2  =  0x5380 ;
    uint256 internal constant  SUM_U_CHALLENGE_3  =  0x53a0 ;
    uint256 internal constant  SUM_U_CHALLENGE_4  =  0x53c0 ;
    uint256 internal constant  SUM_U_CHALLENGE_5  =  0x53e0 ;
    uint256 internal constant  SUM_U_CHALLENGE_6  =  0x5400 ;
    uint256 internal constant  SUM_U_CHALLENGE_7  =  0x5420 ;
    uint256 internal constant  SUM_U_CHALLENGE_8  =  0x5440 ;
    uint256 internal constant  SUM_U_CHALLENGE_9  =  0x5460 ;
    uint256 internal constant  SUM_U_CHALLENGE_10  =  0x5480 ;
    uint256 internal constant  SUM_U_CHALLENGE_11  =  0x54a0 ;
    uint256 internal constant  SUM_U_CHALLENGE_12  =  0x54c0 ;
    uint256 internal constant  SUM_U_CHALLENGE_13  =  0x54e0 ;
    uint256 internal constant  SUM_U_CHALLENGE_14  =  0x5500 ;
    uint256 internal constant  SUM_U_CHALLENGE_15  =  0x5520 ;
    uint256 internal constant  SUM_U_CHALLENGE_16  =  0x5540 ;
    uint256 internal constant  SUM_U_CHALLENGE_17  =  0x5560 ;
    uint256 internal constant  SUM_U_CHALLENGE_18  =  0x5580 ;
    uint256 internal constant  SUM_U_CHALLENGE_19  =  0x55a0 ;
    uint256 internal constant  SUM_U_CHALLENGE_20  =  0x55c0 ;
    uint256 internal constant  SUM_U_CHALLENGE_21  =  0x55e0 ;
    uint256 internal constant  SUM_U_CHALLENGE_22  =  0x5600 ;
    uint256 internal constant  SUM_U_CHALLENGE_23  =  0x5620 ;
    uint256 internal constant  SUM_U_CHALLENGE_24  =  0x5640 ;
    uint256 internal constant  SUM_U_CHALLENGE_25  =  0x5660 ;
    uint256 internal constant  SUM_U_CHALLENGE_26  =  0x5680 ;
    uint256 internal constant  SUM_U_CHALLENGE_27  =  0x56a0 ;
    ...
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  BARYCENTRIC_LAGRANGE_DENOMINATOR_0_LOC  =  0x56c0 ;
    uint256 internal constant  BARYCENTRIC_LAGRANGE_DENOMINATOR_1_LOC  =  0x56e0 ;
    uint256 internal constant  BARYCENTRIC_LAGRANGE_DENOMINATOR_2_LOC  =  0x5700 ;
    uint256 internal constant  BARYCENTRIC_LAGRANGE_DENOMINATOR_3_LOC  =  0x5720 ;
    uint256 internal constant  BARYCENTRIC_LAGRANGE_DENOMINATOR_4_LOC  =  0x5740 ;
    uint256 internal constant  BARYCENTRIC_LAGRANGE_DENOMINATOR_5_LOC  =  0x5760 ;
    uint256 internal constant  BARYCENTRIC_LAGRANGE_DENOMINATOR_6_LOC  =  0x5780 ;
    uint256 internal constant  BARYCENTRIC_LAGRANGE_DENOMINATOR_7_LOC  =  0x57a0 ;
    uint256 internal constant  BARYCENTRIC_DOMAIN_0_LOC  =  0x57c0 ;
    uint256 internal constant  BARYCENTRIC_DOMAIN_1_LOC  =  0x57e0 ;
    uint256 internal constant  BARYCENTRIC_DOMAIN_2_LOC  =  0x5800 ;
    uint256 internal constant  BARYCENTRIC_DOMAIN_3_LOC  =  0x5820 ;
    uint256 internal constant  BARYCENTRIC_DOMAIN_4_LOC  =  0x5840 ;
    uint256 internal constant  BARYCENTRIC_DOMAIN_5_LOC  =  0x5860 ;
    uint256 internal constant  BARYCENTRIC_DOMAIN_6_LOC  =  0x5880 ;
    uint256 internal constant  BARYCENTRIC_DOMAIN_7_LOC  =  0x58a0 ;
    uint256 internal constant  BARYCENTRIC_DENOMINATOR_INVERSES_0_LOC  =  0x58c0 ;
    uint256 internal constant  BARYCENTRIC_DENOMINATOR_INVERSES_1_LOC  =  0x58e0 ;
    uint256 internal constant  BARYCENTRIC_DENOMINATOR_INVERSES_2_LOC  =  0x5900 ;
    uint256 internal constant  BARYCENTRIC_DENOMINATOR_INVERSES_3_LOC  =  0x5920 ;
    uint256 internal constant  BARYCENTRIC_DENOMINATOR_INVERSES_4_LOC  =  0x5940 ;
    uint256 internal constant  BARYCENTRIC_DENOMINATOR_INVERSES_5_LOC  =  0x5960 ;
    uint256 internal constant  BARYCENTRIC_DENOMINATOR_INVERSES_6_LOC  =  0x5980 ;
    uint256 internal constant  BARYCENTRIC_DENOMINATOR_INVERSES_7_LOC  =  0x59a0 ;
    ...
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  SUBRELATION_EVAL_0_LOC  =  0x59c0 ;
    uint256 internal constant  SUBRELATION_EVAL_1_LOC  =  0x59e0 ;
    uint256 internal constant  SUBRELATION_EVAL_2_LOC  =  0x5a00 ;
    uint256 internal constant  SUBRELATION_EVAL_3_LOC  =  0x5a20 ;
    uint256 internal constant  SUBRELATION_EVAL_4_LOC  =  0x5a40 ;
    uint256 internal constant  SUBRELATION_EVAL_5_LOC  =  0x5a60 ;
    uint256 internal constant  SUBRELATION_EVAL_6_LOC  =  0x5a80 ;
    uint256 internal constant  SUBRELATION_EVAL_7_LOC  =  0x5aa0 ;
    uint256 internal constant  SUBRELATION_EVAL_8_LOC  =  0x5ac0 ;
    uint256 internal constant  SUBRELATION_EVAL_9_LOC  =  0x5ae0 ;
    uint256 internal constant  SUBRELATION_EVAL_10_LOC  =  0x5b00 ;
    uint256 internal constant  SUBRELATION_EVAL_11_LOC  =  0x5b20 ;
    uint256 internal constant  SUBRELATION_EVAL_12_LOC  =  0x5b40 ;
    uint256 internal constant  SUBRELATION_EVAL_13_LOC  =  0x5b60 ;
    uint256 internal constant  SUBRELATION_EVAL_14_LOC  =  0x5b80 ;
    uint256 internal constant  SUBRELATION_EVAL_15_LOC  =  0x5ba0 ;
    uint256 internal constant  SUBRELATION_EVAL_16_LOC  =  0x5bc0 ;
    uint256 internal constant  SUBRELATION_EVAL_17_LOC  =  0x5be0 ;
    uint256 internal constant  SUBRELATION_EVAL_18_LOC  =  0x5c00 ;
    uint256 internal constant  SUBRELATION_EVAL_19_LOC  =  0x5c20 ;
    uint256 internal constant  SUBRELATION_EVAL_20_LOC  =  0x5c40 ;
    uint256 internal constant  SUBRELATION_EVAL_21_LOC  =  0x5c60 ;
    uint256 internal constant  SUBRELATION_EVAL_22_LOC  =  0x5c80 ;
    uint256 internal constant  SUBRELATION_EVAL_23_LOC  =  0x5ca0 ;
    uint256 internal constant  SUBRELATION_EVAL_24_LOC  =  0x5cc0 ;
    uint256 internal constant  SUBRELATION_EVAL_25_LOC  =  0x5ce0 ;
    uint256 internal constant  SUBRELATION_EVAL_26_LOC  =  0x5d00 ;
    uint256 internal constant  SUBRELATION_EVAL_27_LOC  =  0x5d20 ;
    ...
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  FINAL_ROUND_TARGET_LOC  =  0x5d40 ;
    uint256 internal constant  POW_PARTIAL_EVALUATION_LOC  =  0x5d60 ;
    uint256 internal constant  AUX_NON_NATIVE_FIELD_IDENTITY  =  0x5d80 ;
    uint256 internal constant  AUX_LIMB_ACCUMULATOR_IDENTITY  =  0x5da0 ;
    uint256 internal constant  AUX_RAM_CONSISTENCY_CHECK_IDENTITY  =  0x5dc0 ;
    uint256 internal constant  AUX_ROM_CONSISTENCY_CHECK_IDENTITY  =  0x5de0 ;
    uint256 internal constant  AUX_MEMORY_CHECK_IDENTITY  =  0x5e00 ;
    ...
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_0_LOC  =  0x5e20 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_1_LOC  =  0x5e40 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_2_LOC  =  0x5e60 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_3_LOC  =  0x5e80 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_4_LOC  =  0x5ea0 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_5_LOC  =  0x5ec0 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_6_LOC  =  0x5ee0 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_7_LOC  =  0x5f00 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_8_LOC  =  0x5f20 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_9_LOC  =  0x5f40 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_10_LOC  =  0x5f60 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_11_LOC  =  0x5f80 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_12_LOC  =  0x5fa0 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_13_LOC  =  0x5fc0 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_14_LOC  =  0x5fe0 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_15_LOC  =  0x6000 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_16_LOC  =  0x6020 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_17_LOC  =  0x6040 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_18_LOC  =  0x6060 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_19_LOC  =  0x6080 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_20_LOC  =  0x60a0 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_21_LOC  =  0x60c0 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_22_LOC  =  0x60e0 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_23_LOC  =  0x6100 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_24_LOC  =  0x6120 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_25_LOC  =  0x6140 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_26_LOC  =  0x6160 ;
    uint256 internal constant  POWERS_OF_EVALUATION_CHALLENGE_27_LOC  =  0x6180 ;
    ...
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_0_LOC  =  0x61a0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_1_LOC  =  0x61c0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_2_LOC  =  0x61e0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_3_LOC  =  0x6200 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_4_LOC  =  0x6220 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_5_LOC  =  0x6240 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_6_LOC  =  0x6260 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_7_LOC  =  0x6280 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_8_LOC  =  0x62a0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_9_LOC  =  0x62c0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_10_LOC  =  0x62e0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_11_LOC  =  0x6300 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_12_LOC  =  0x6320 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_13_LOC  =  0x6340 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_14_LOC  =  0x6360 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_15_LOC  =  0x6380 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_16_LOC  =  0x63a0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_17_LOC  =  0x63c0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_18_LOC  =  0x63e0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_19_LOC  =  0x6400 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_20_LOC  =  0x6420 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_21_LOC  =  0x6440 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_22_LOC  =  0x6460 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_23_LOC  =  0x6480 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_24_LOC  =  0x64a0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_25_LOC  =  0x64c0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_26_LOC  =  0x64e0 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_27_LOC  =  0x6500 ;
    uint256 internal constant  INVERTED_GEMINI_DENOMINATOR_28_LOC  =  0x6520 ;
    ...
    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*      SHPLEMINI - RUNTIME MEMORY - BATCH ACCUMULATORS       */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  BATCH_ACCUMULATOR_0_LOC  =  0x6540 ;
    uint256 internal constant  BATCH_ACCUMULATOR_1_LOC  =  0x6560 ;
    uint256 internal constant  BATCH_ACCUMULATOR_2_LOC  =  0x6580 ;
    uint256 internal constant  BATCH_ACCUMULATOR_3_LOC  =  0x65a0 ;
    uint256 internal constant  BATCH_ACCUMULATOR_4_LOC  =  0x65c0 ;
    uint256 internal constant  BATCH_ACCUMULATOR_5_LOC  =  0x65e0 ;
    uint256 internal constant  BATCH_ACCUMULATOR_6_LOC  =  0x6600 ;
    uint256 internal constant  BATCH_ACCUMULATOR_7_LOC  =  0x6620 ;
    uint256 internal constant  BATCH_ACCUMULATOR_8_LOC  =  0x6640 ;
    ...
    uint256 internal constant  BATCH_SCALAR_69_LOC  =  0x6f00 ;
    uint256 internal constant  BATCH_SCALAR_70_LOC  =  0x6f20 ;
    uint256 internal constant  BATCH_SCALAR_71_LOC  =  0x6f40 ;
    uint256 internal constant  BATCH_SCALAR_72_LOC  =  0x6f60 ;
    uint256 internal constant  BATCH_SCALAR_73_LOC  =  0x6f80 ;
    ...
    /*          SHPLEMINI - RUNTIME MEMORY - INVERSIONS           */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_0_LOC  =  0x6fa0 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_1_LOC  =  0x6fc0 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_2_LOC  =  0x6fe0 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_3_LOC  =  0x7000 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_4_LOC  =  0x7020 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_5_LOC  =  0x7040 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_6_LOC  =  0x7060 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_7_LOC  =  0x7080 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_8_LOC  =  0x70a0 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_9_LOC  =  0x70c0 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_10_LOC  =  0x70e0 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_11_LOC  =  0x7100 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_12_LOC  =  0x7120 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_13_LOC  =  0x7140 ;
    uint256 internal constant  BATCH_EVALUATION_ACCUMULATOR_INVERSION_14_LOC  =  0x7160 ;

    uint256 internal constant  BATCHED_EVALUATION_LOC  =  0x7180 ;
    uint256 internal constant  CONSTANT_TERM_ACCUMULATOR_LOC  =  0x71a0 ;

    uint256 internal constant  POS_INVERTED_DENOMINATOR  =  0x71c0 ;
    uint256 internal constant  NEG_INVERTED_DENOMINATOR  =  0x71e0 ;

    // LOG_N challenge pow minus u
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_0_LOC  =  0x7200 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_1_LOC  =  0x7220 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_2_LOC  =  0x7240 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_3_LOC  =  0x7260 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_4_LOC  =  0x7280 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_5_LOC  =  0x72a0 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_6_LOC  =  0x72c0 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_7_LOC  =  0x72e0 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_8_LOC  =  0x7300 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_9_LOC  =  0x7320 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_10_LOC  =  0x7340 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_11_LOC  =  0x7360 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_12_LOC  =  0x7380 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_13_LOC  =  0x73a0 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_14_LOC  =  0x73c0 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_15_LOC  =  0x73e0 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_16_LOC  =  0x7400 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_17_LOC  =  0x7420 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_18_LOC  =  0x7440 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_19_LOC  =  0x7460 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_20_LOC  =  0x7480 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_21_LOC  =  0x74a0 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_22_LOC  =  0x74c0 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_23_LOC  =  0x74e0 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_24_LOC  =  0x7500 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_25_LOC  =  0x7520 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_26_LOC  =  0x7540 ;
    uint256 internal constant  INVERTED_CHALLENEGE_POW_MINUS_U_27_LOC  =  0x7560 ;

    // LOG_N pos_inverted_off
    uint256 internal constant  POS_INVERTED_DENOM_0_LOC  =  0x7580 ;
    uint256 internal constant  POS_INVERTED_DENOM_1_LOC  =  0x75a0 ;
    uint256 internal constant  POS_INVERTED_DENOM_2_LOC  =  0x75c0 ;
    uint256 internal constant  POS_INVERTED_DENOM_3_LOC  =  0x75e0 ;
    uint256 internal constant  POS_INVERTED_DENOM_4_LOC  =  0x7600 ;
    uint256 internal constant  POS_INVERTED_DENOM_5_LOC  =  0x7620 ;
    uint256 internal constant  POS_INVERTED_DENOM_6_LOC  =  0x7640 ;
    uint256 internal constant  POS_INVERTED_DENOM_7_LOC  =  0x7660 ;
    uint256 internal constant  POS_INVERTED_DENOM_8_LOC  =  0x7680 ;
    uint256 internal constant  POS_INVERTED_DENOM_9_LOC  =  0x76a0 ;
    uint256 internal constant  POS_INVERTED_DENOM_10_LOC  =  0x76c0 ;
    uint256 internal constant  POS_INVERTED_DENOM_11_LOC  =  0x76e0 ;
    uint256 internal constant  POS_INVERTED_DENOM_12_LOC  =  0x7700 ;
    uint256 internal constant  POS_INVERTED_DENOM_13_LOC  =  0x7720 ;
    uint256 internal constant  POS_INVERTED_DENOM_14_LOC  =  0x7740 ;
    uint256 internal constant  POS_INVERTED_DENOM_15_LOC  =  0x7760 ;
    uint256 internal constant  POS_INVERTED_DENOM_16_LOC  =  0x7780 ;
    uint256 internal constant  POS_INVERTED_DENOM_17_LOC  =  0x77a0 ;
    uint256 internal constant  POS_INVERTED_DENOM_18_LOC  =  0x77c0 ;
    uint256 internal constant  POS_INVERTED_DENOM_19_LOC  =  0x77e0 ;
    uint256 internal constant  POS_INVERTED_DENOM_20_LOC  =  0x7800 ;
    uint256 internal constant  POS_INVERTED_DENOM_21_LOC  =  0x7820 ;
    uint256 internal constant  POS_INVERTED_DENOM_22_LOC  =  0x7840 ;
    uint256 internal constant  POS_INVERTED_DENOM_23_LOC  =  0x7860 ;
    uint256 internal constant  POS_INVERTED_DENOM_24_LOC  =  0x7880 ;
    uint256 internal constant  POS_INVERTED_DENOM_25_LOC  =  0x78a0 ;
    uint256 internal constant  POS_INVERTED_DENOM_26_LOC  =  0x78c0 ;
    uint256 internal constant  POS_INVERTED_DENOM_27_LOC  =  0x78e0 ;

    // LOG_N neg_inverted_off
    uint256 internal constant  NEG_INVERTED_DENOM_0_LOC  =  0x7900 ;
    uint256 internal constant  NEG_INVERTED_DENOM_1_LOC  =  0x7920 ;
    uint256 internal constant  NEG_INVERTED_DENOM_2_LOC  =  0x7940 ;
    uint256 internal constant  NEG_INVERTED_DENOM_3_LOC  =  0x7960 ;
    uint256 internal constant  NEG_INVERTED_DENOM_4_LOC  =  0x7980 ;
    uint256 internal constant  NEG_INVERTED_DENOM_5_LOC  =  0x79a0 ;
    uint256 internal constant  NEG_INVERTED_DENOM_6_LOC  =  0x79c0 ;
    uint256 internal constant  NEG_INVERTED_DENOM_7_LOC  =  0x79e0 ;
    uint256 internal constant  NEG_INVERTED_DENOM_8_LOC  =  0x7a00 ;
    uint256 internal constant  NEG_INVERTED_DENOM_9_LOC  =  0x7a20 ;
    uint256 internal constant  NEG_INVERTED_DENOM_10_LOC  =  0x7a40 ;
    uint256 internal constant  NEG_INVERTED_DENOM_11_LOC  =  0x7a60 ;
    uint256 internal constant  NEG_INVERTED_DENOM_12_LOC  =  0x7a80 ;
    uint256 internal constant  NEG_INVERTED_DENOM_13_LOC  =  0x7aa0 ;
    uint256 internal constant  NEG_INVERTED_DENOM_14_LOC  =  0x7ac0 ;
    uint256 internal constant  NEG_INVERTED_DENOM_15_LOC  =  0x7ae0 ;
    uint256 internal constant  NEG_INVERTED_DENOM_16_LOC  =  0x7b00 ;
    uint256 internal constant  NEG_INVERTED_DENOM_17_LOC  =  0x7b20 ;
    uint256 internal constant  NEG_INVERTED_DENOM_18_LOC  =  0x7b40 ;
    uint256 internal constant  NEG_INVERTED_DENOM_19_LOC  =  0x7b60 ;
    uint256 internal constant  NEG_INVERTED_DENOM_20_LOC  =  0x7b80 ;
    uint256 internal constant  NEG_INVERTED_DENOM_21_LOC  =  0x7ba0 ;
    uint256 internal constant  NEG_INVERTED_DENOM_22_LOC  =  0x7bc0 ;
    uint256 internal constant  NEG_INVERTED_DENOM_23_LOC  =  0x7be0 ;
    uint256 internal constant  NEG_INVERTED_DENOM_24_LOC  =  0x7c00 ;
    uint256 internal constant  NEG_INVERTED_DENOM_25_LOC  =  0x7c20 ;
    uint256 internal constant  NEG_INVERTED_DENOM_26_LOC  =  0x7c40 ;
    uint256 internal constant  NEG_INVERTED_DENOM_27_LOC  =  0x7c60 ;

    uint256 internal constant  FOLD_POS_EVALUATIONS_0_LOC  =  0x7c80 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_1_LOC  =  0x7ca0 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_2_LOC  =  0x7cc0 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_3_LOC  =  0x7ce0 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_4_LOC  =  0x7d00 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_5_LOC  =  0x7d20 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_6_LOC  =  0x7d40 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_7_LOC  =  0x7d60 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_8_LOC  =  0x7d80 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_9_LOC  =  0x7da0 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_10_LOC  =  0x7dc0 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_11_LOC  =  0x7de0 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_12_LOC  =  0x7e00 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_13_LOC  =  0x7e20 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_14_LOC  =  0x7e40 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_15_LOC  =  0x7e60 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_16_LOC  =  0x7e80 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_17_LOC  =  0x7ea0 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_18_LOC  =  0x7ec0 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_19_LOC  =  0x7ee0 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_20_LOC  =  0x7f00 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_21_LOC  =  0x7f20 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_22_LOC  =  0x7f40 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_23_LOC  =  0x7f60 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_24_LOC  =  0x7f80 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_25_LOC  =  0x7fa0 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_26_LOC  =  0x7fc0 ;
    uint256 internal constant  FOLD_POS_EVALUATIONS_27_LOC  =  0x7fe0 ;
    ...
    uint256 internal constant  LATER_SCRATCH_SPACE  =  0x8000 ;
        ...
        assembly {
            ...
            /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
            {
                ...
                {
                    {
                        ...
                        */
...

                        {
                            ...
                            memory_identity := mulmod(memory_identity, mulmod(mload(QMEMORY_EVAL_LOC), mload(POW_PARTIAL_EVALUATION_LOC), p), p)
...

                {
                    ...
                    nnf_identity := mulmod(nnf_identity, mulmod(mload(QNNF_EVAL_LOC), mload(POW_PARTIAL_EVALUATION_LOC), p), p)
                ...
                */
                {
                    ...
                    mstore(SUBRELATION_EVAL_24_LOC, mulmod(q_pos_by_scaling, addmod(v1, sub(p, mload(W1_SHIFT_EVAL_LOC)), p), p))

                    let v2 := addmod(mulmod(u2, POS_INTENAL_MATRIX_D_1, p), u_sum, p)

                    mstore(SUBRELATION_EVAL_25_LOC, mulmod(q_pos_by_scaling, addmod(v2, sub(p, mload(W2_SHIFT_EVAL_LOC)), p), p))

                    let v3 := addmod(mulmod(u3, POS_INTENAL_MATRIX_D_2, p), u_sum, p)

                    mstore(SUBRELATION_EVAL_26_LOC, mulmod(q_pos_by_scaling, addmod(v3, sub(p, mload(W3_SHIFT_EVAL_LOC)), p), p))

                    let v4 := addmod(mulmod(u4, POS_INTENAL_MATRIX_D_3, p), u_sum, p)
                    mstore(SUBRELATION_EVAL_27_LOC, mulmod(q_pos_by_scaling, addmod(v4, sub(p, mload(W4_SHIFT_EVAL_LOC)), p), p))
                }
           ...
           let shifted_scalar := 0
           {
            ...
            let constant_term_acc := mulmod(mload(FOLD_POS_EVALUATIONS_0_LOC), mload(POS_INVERTED_DENOM_0_LOC), p)
            {
                ...
                let shplonk_z := mload(SHPLONK_Z_CHALLENGE)
                let scalars_loc := BATCH_SCALAR_42_LOC
