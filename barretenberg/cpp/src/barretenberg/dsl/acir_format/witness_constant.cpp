                                                   ...
                                                   Builder& builder)
{
    ...
    if (!has_valid_witness_assignments) {
        if (!input_infinite.is_constant) {
            builder.assert_equal(builder.add_variable(fr(1)), input_infinite.index);
            ...
            builder.assert_equal(builder.add_variable(g1.x), input_x.index);
            builder.assert_equal(builder.add_variable(g1.y), input_y.index);
        }
    }
