...
inline constexpr size_t ROOT_ROLLUP_GATE_COUNT = 6351844;
    ...
    const PredicateTestCase& mode = PredicateTestCase::ConstantTrue)
{
    ...
    if constexpr (std::is_same_v<RecursiveFlavor, bb::UltraRecursiveFlavor_<UltraCircuitBuilder>>) {
        ...
        return std::make_tuple(857060, 0);
    } else {
...
inline constexpr size_t INIT_KERNEL_GATE_COUNT = 13665;
...
inline constexpr size_t INNER_KERNEL_GATE_COUNT_HN = 31284;
...
inline constexpr size_t TAIL_KERNEL_GATE_COUNT = 17419;
...
inline constexpr size_t HIDING_KERNEL_GATE_COUNT = 39723;
