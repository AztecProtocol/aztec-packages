...
template <typename Builder> inline constexpr size_t ECDSA_SECP256K1 = 42290 + ZERO_GATE;
template <typename Builder>
inline constexpr size_t ECDSA_SECP256R1 = 72518 + ZERO_GATE + (IsMegaBuilder<Builder> ? 2 : 0);
