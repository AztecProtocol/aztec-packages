    ...
    const PredicateTestCase& mode = PredicateTestCase::ConstantTrue)
{
    ...
    if constexpr (std::is_same_v<RecursiveFlavor, bb::UltraRecursiveFlavor_<UltraCircuitBuilder>>) {
        ...
        return std::make_tuple(768694, 0);
    } else {
...
inline constexpr size_t CHONK_RECURSION_GATES = 1478577;
...
inline constexpr size_t INIT_KERNEL_GATE_COUNT = 24553;
...
inline constexpr size_t INNER_KERNEL_GATE_COUNT_HN = 59539;
...
inline constexpr size_t TAIL_KERNEL_GATE_COUNT = 32393;
...
inline constexpr size_t HIDING_KERNEL_GATE_COUNT = 35790;
