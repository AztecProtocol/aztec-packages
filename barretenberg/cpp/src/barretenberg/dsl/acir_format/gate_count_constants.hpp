    ...
    const PredicateTestCase& mode = PredicateTestCase::ConstantTrue)
{
    ...
    if constexpr (std::is_same_v<RecursiveFlavor, bb::UltraRecursiveFlavor_<UltraCircuitBuilder>>) {
        ...
        return std::make_tuple(771238, 0);
    } else {
...
inline constexpr size_t CHONK_RECURSION_GATES = 1483019;
...
inline constexpr size_t INIT_KERNEL_GATE_COUNT = 18350;
...
inline constexpr size_t INNER_KERNEL_GATE_COUNT_HN = 43392;
...
inline constexpr size_t TAIL_KERNEL_GATE_COUNT = 23902;
...
inline constexpr size_t HIDING_KERNEL_GATE_COUNT = 26330;
