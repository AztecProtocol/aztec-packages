...
inline constexpr size_t CHONK_RECURSION_GATES = 2368396;
...
inline constexpr size_t HIDING_KERNEL_GATE_COUNT = 37105;
...
inline constexpr size_t ECCVM_RECURSIVE_VERIFIER_GATE_COUNT = 214908;

// ========================================
// Goblin AVM Recursive Verifier Constants
// ========================================

inline constexpr size_t GOBLIN_AVM_GATE_COUNT = 3316633;
inline constexpr size_t FINALIZED_GOBLIN_AVM_GATE_COUNT = 3316649;
