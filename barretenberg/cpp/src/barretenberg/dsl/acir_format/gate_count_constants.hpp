...
inline constexpr size_t CHONK_RECURSION_GATES = 2368687;
...
inline constexpr size_t GOBLIN_AVM_GATE_COUNT = 3326152;
inline constexpr size_t FINALIZED_GOBLIN_AVM_GATE_COUNT = 3326168;
