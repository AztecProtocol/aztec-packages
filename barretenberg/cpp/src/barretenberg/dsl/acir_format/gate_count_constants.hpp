...
template <typename Builder> inline constexpr size_t LOGIC_AND_32 = 2950 + ZERO_GATE + MEGA_OFFSET<Builder>;
...
inline constexpr size_t CHONK_RECURSION_GATES = 2541245;
