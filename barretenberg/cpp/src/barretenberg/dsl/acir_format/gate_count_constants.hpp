    ...
    const PredicateTestCase& mode = PredicateTestCase::ConstantTrue)
{
    ...
    if constexpr (std::is_same_v<RecursiveFlavor, bb::UltraRecursiveFlavor_<UltraCircuitBuilder>>) {
        ...
        return std::make_tuple(901039, 0);
    } else {
...
inline constexpr size_t CHONK_RECURSION_GATES = 1616793;
...
inline constexpr size_t HIDING_KERNEL_GATE_COUNT = 39725;
inline constexpr size_t HIDING_KERNEL_ECC_ROWS = 4905 + MSM_ROWS_OFFSET;
inline constexpr size_t HIDING_KERNEL_ULTRA_OPS = 339;
