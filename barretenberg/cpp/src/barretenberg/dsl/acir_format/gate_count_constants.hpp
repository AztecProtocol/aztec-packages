...
inline constexpr size_t ROOT_ROLLUP_GATE_COUNT = 12904758;
    ...
    const PredicateTestCase& mode = PredicateTestCase::ConstantTrue)
{
    ...
    if constexpr (std::is_same_v<RecursiveFlavor, bb::UltraRecursiveFlavor_<UltraCircuitBuilder>>) {
        ...
        return std::make_tuple(781610, 0);
    } else {
...
inline constexpr size_t CHONK_RECURSION_GATES = 1490295;
...
inline constexpr size_t INIT_KERNEL_GATE_COUNT = 24961;
...
inline constexpr size_t INNER_KERNEL_GATE_COUNT_HN = 60259;
...
inline constexpr size_t TAIL_KERNEL_GATE_COUNT = 32754;
...
inline constexpr size_t HIDING_KERNEL_GATE_COUNT = 36127;
...
inline constexpr size_t ECCVM_RECURSIVE_VERIFIER_GATE_COUNT = 221529;
