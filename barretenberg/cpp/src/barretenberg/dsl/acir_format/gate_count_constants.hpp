...
inline constexpr size_t ROOT_ROLLUP_GATE_COUNT = 12904701;
    ...
    const PredicateTestCase& mode = PredicateTestCase::ConstantTrue)
{
    ...
    if constexpr (std::is_same_v<RecursiveFlavor, bb::UltraRecursiveFlavor_<UltraCircuitBuilder>>) {
        ...
        return std::make_tuple(781592, 0);
    } else {
...
inline constexpr size_t CHONK_RECURSION_GATES = 1487726;
...
inline constexpr size_t INIT_KERNEL_GATE_COUNT = 24966;
...
inline constexpr size_t INNER_KERNEL_GATE_COUNT_HN = 60269;
...
inline constexpr size_t TAIL_KERNEL_GATE_COUNT = 32759;
...
inline constexpr size_t HIDING_KERNEL_GATE_COUNT = 36132;
...
inline constexpr size_t ECCVM_RECURSIVE_VERIFIER_GATE_COUNT = 220630;
