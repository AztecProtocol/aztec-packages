...
inline constexpr size_t HIDING_KERNEL_GATE_COUNT = 70403;
inline constexpr size_t HIDING_KERNEL_ECC_ROWS = 4575 + MSM_ROWS_OFFSET;
inline constexpr size_t HIDING_KERNEL_ULTRA_OPS = 312;
