...
//      *
//      */
//     static Builder construct_mock_UH_recursion_app_circuit(const std::shared_ptr<ClientIVC>& ivc, const bool
//     tamper_vk)
//     {
//         AcirProgram program;
...
//     auto [app_circuit, app_vk] = construct_mock_app_circuit(ivc);
...
//     logic) AcirProgram program_1 = construct_mock_kernel_program(ivc->verification_queue); Builder kernel_1 =
//     acir_format::create_circuit<Builder>(program_1, metadata);
