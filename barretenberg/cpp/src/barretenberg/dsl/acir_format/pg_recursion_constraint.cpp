                                                                ...
                                                                const bool is_kernel)
{
    ...
    if (is_kernel) {
        ...
        BB_ASSERT_EQ(verification_type == Chonk::QUEUE_TYPE::PG || verification_type == Chonk::QUEUE_TYPE::PG_TAIL ||
        ...
        BB_ASSERT_EQ(verification_type == Chonk::QUEUE_TYPE::OINK || verification_type == Chonk::QUEUE_TYPE::PG, true);
