...
class ProofSurgeon {
  ...
  public:
    ...
    static std::string construct_recursion_inputs_toml_data(std::vector<FF>& proof, const auto& verification_key)
    {
        ...
        const size_t num_public_inputs_to_extract = verification_key.num_public_inputs - bb::PAIRING_POINT_ACCUM_SIZE;
                                                                ...
                                                                const size_t num_public_inputs)
    {
        ...
        const size_t num_public_inputs_to_extract = num_public_inputs - bb::PAIRING_POINT_ACCUM_SIZE;
