...
static_assert(TranslatorFlavor::PROOF_LENGTH == 488, "Translator proof size changed - update constants.nr");
...
static_assert(ChonkProof::PROOF_LENGTH == 1637, "CHONK_PROOF_LENGTH changed - update constants.nr");
