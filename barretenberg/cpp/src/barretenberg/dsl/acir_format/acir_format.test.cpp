...
//     witness_values = {
//         fr(0), fr(1), fr(2), fr(3), fr(4), fr(5), fr(6), fr(7), fr(8), fr(9), fr(10), fr(11), fr(12), fr(13),
//         fr(-91),
//     };
...
//     AcirFormat constraint_system =
//         circuit_buf_to_acir_format(std::move(program_bytes), UltraCircuitBuilder::ACIR_OFFSET);
...
//     auto builder = create_circuit<UltraCircuitBuilder>(acir_program);
...
//     points.push_back(WitnessOrConstant<bb::fr>::from_index(1 + Builder::ACIR_OFFSET)); // x
//     points.push_back(WitnessOrConstant<bb::fr>::from_index(2 + Builder::ACIR_OFFSET)); // y
//     points.push_back(WitnessOrConstant<bb::fr>::from_index(3 + Builder::ACIR_OFFSET)); // is_infinite

//     std::vector<WitnessOrConstant<bb::fr>> scalars;
//     scalars.push_back(WitnessOrConstant<bb::fr>::from_index(4 + Builder::ACIR_OFFSET)); // scalar_lo
//     scalars.push_back(WitnessOrConstant<bb::fr>::from_index(5 + Builder::ACIR_OFFSET)); // scalar_hi

//     MultiScalarMul msm_constraint{
//         .points = points,
//         .scalars = scalars,
//         .predicate = WitnessOrConstant<bb::fr>::from_index(6 + Builder::ACIR_OFFSET),
//         .out_point_x = 7 + Builder::ACIR_OFFSET,
//         .out_point_y = 8 + Builder::ACIR_OFFSET,
//         .out_point_is_infinite = 9 + Builder::ACIR_OFFSET,
//     };
...
//         .input1_x = WitnessOrConstant<bb::fr>::from_index(1 + Builder::ACIR_OFFSET),
//         .input1_y = WitnessOrConstant<bb::fr>::from_index(2 + Builder::ACIR_OFFSET),
//         .input1_infinite = WitnessOrConstant<bb::fr>::from_index(3 + Builder::ACIR_OFFSET),
//         .input2_x = WitnessOrConstant<bb::fr>::from_index(4 + Builder::ACIR_OFFSET),
//         .input2_y = WitnessOrConstant<bb::fr>::from_index(5 + Builder::ACIR_OFFSET),
//         .input2_infinite = WitnessOrConstant<bb::fr>::from_index(6 + Builder::ACIR_OFFSET),
//         .predicate = WitnessOrConstant<bb::fr>::from_index(7 + Builder::ACIR_OFFSET),
//         .result_x = 8 + Builder::ACIR_OFFSET,
//         .result_y = 9 + Builder::ACIR_OFFSET,
//         .result_infinite = 10 + Builder::ACIR_OFFSET,
//     };
