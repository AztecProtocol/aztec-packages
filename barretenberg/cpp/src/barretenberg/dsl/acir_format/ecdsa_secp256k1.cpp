...
crypto::ecdsa::ecdsa_signature ecdsa_convert_signature(Builder& builder, std::vector<uint32_t> signature)
{

    crypto::ecdsa::ecdsa_signature signature_cr;
                                        ...
                                        bool has_valid_witness_assignments)
{
    ...
    stdlib::ecdsa::ecdsa_signature<Builder> sig{ stdlib::byte_array<Builder>(&builder, rr),
    ...
    bool_ct signature_result =
        stdlib::ecdsa::ecdsa_verify_signature_prehashed_message_noassert<Builder,
                                                                         secp256k1_ct,
...
template <typename Builder> void dummy_ecdsa_constraint(Builder& builder, EcdsaSecp256k1Constraint const& input)
{
    ...
    crypto::ecdsa::ecdsa_key_pair<secp256k1_ct::fr, secp256k1_ct::g1> account;
    ...
    crypto::ecdsa::ecdsa_signature signature =
        crypto::ecdsa::ecdsa_construct_signature<Sha256Hasher, secp256k1_ct::fq, secp256k1_ct::fr, secp256k1_ct::g1>(
