...
class AvmExecutionTests : public ::testing::Test {
  ...
  protected:
    ...
    void SetUp() override
    {
        ...
        public_inputs_vec.at(STORAGE_ADDRESS_PCPI_OFFSET) = 0xdeadbeef;
    };
     ...
     */
    std::vector<Row> gen_trace_from_instr(std::vector<uint8_t> bytecode)
    {
        std::vector<FF> calldata{};
...
TEST_F(AvmExecutionTests, kernelOutputEmitOpcodes)
{
    ...
    FF expected_hash = FF(std::string("0x0033abf72942c15c620302dfb4abb8290e86739f11eea752fab7c8a9292fd245"));
