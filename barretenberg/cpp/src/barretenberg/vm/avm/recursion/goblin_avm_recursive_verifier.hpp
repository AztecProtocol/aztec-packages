...
// template <typename Flavor> class GoblinAvmRecursiveVerifier_ {
...
//   public:
//     explicit GoblinAvmRecursiveVerifier_(Builder* builder,
//                                          const std::shared_ptr<NativeVerificationKey>& native_verification_key);
//     explicit GoblinAvmRecursiveVerifier_(Builder* builder, const std::shared_ptr<VerificationKey>& vkey);
