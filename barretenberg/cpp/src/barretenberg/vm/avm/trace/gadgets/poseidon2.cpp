...
AvmPoseidon2TraceBuilder::Poseidon2TraceEntry gen_poseidon_perm_entry(std::array<FF, 4> const& input, uint32_t clk)
{
    ...
    return AvmPoseidon2TraceBuilder::Poseidon2TraceEntry{
        clk, input, current_state, first_ext, interm_round_vals,
    };
}
