...
template <typename FF_> class poseidon2_fullImpl {
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        const auto poseidon2_full_NEXT_INPUT_IS_PREV_OUTPUT_SEL = new_term.poseidon2_full_execute_poseidon_perm_shift *
                                                                  (FF(1) - new_term.poseidon2_full_start_poseidon) *
        ...
        }
        {
            ...
            auto tmp =
                new_term.poseidon2_full_execute_poseidon_perm * (FF(1) - new_term.poseidon2_full_execute_poseidon_perm);
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = new_term.poseidon2_full_sel_poseidon *
                       ((FF(1) - new_term.poseidon2_full_end_poseidon) - new_term.poseidon2_full_execute_poseidon_perm);
            tmp *= scaling_factor;
