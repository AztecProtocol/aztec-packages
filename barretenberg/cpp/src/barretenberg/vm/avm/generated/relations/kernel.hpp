...
template <typename FF_> class kernelImpl {
  public:
    ...
    {
        const auto alias_kernel_NOT_LAST = (FF(1) - new_term.main_sel_last);

        {
            using Accumulator = typename std::tuple_element_t<0, ContainerOverSubrelations>;
            auto tmp = (alias_kernel_NOT_LAST *
        ...
        }
        {
            ...
            auto tmp = (alias_kernel_NOT_LAST * (new_term.kernel_nullifier_exists_write_offset_shift -
        ...
        }
        {
            ...
            auto tmp =
                (alias_kernel_NOT_LAST * (new_term.kernel_nullifier_non_exists_write_offset_shift -
        ...
        }
        {
            ...
            auto tmp = (alias_kernel_NOT_LAST * (new_term.kernel_sload_write_offset_shift -
        ...
        }
        {
            ...
            auto tmp = (alias_kernel_NOT_LAST * (new_term.kernel_sstore_write_offset_shift -
