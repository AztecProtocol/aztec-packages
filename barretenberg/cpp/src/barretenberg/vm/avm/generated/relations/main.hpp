...
template <typename FF_> class mainImpl {
  public:
    ...
    {
        const auto alias_constants_SENDER_SELECTOR = FF(0);
        const auto alias_constants_ADDRESS_SELECTOR = FF(1);
        const auto alias_constants_STORAGE_ADDRESS_SELECTOR = FF(1);
        const auto alias_constants_FUNCTION_SELECTOR_SELECTOR = FF(2);
        const auto alias_constants_CHAIN_ID_SELECTOR = FF(29);
        const auto alias_constants_VERSION_SELECTOR = FF(30);
        const auto alias_constants_BLOCK_NUMBER_SELECTOR = FF(31);
        const auto alias_constants_TIMESTAMP_SELECTOR = FF(33);
        const auto alias_constants_COINBASE_SELECTOR = FF(34);
        const auto alias_constants_FEE_PER_DA_GAS_SELECTOR = FF(36);
        const auto alias_constants_FEE_PER_L2_GAS_SELECTOR = FF(37);
        const auto alias_constants_TRANSACTION_FEE_SELECTOR = FF(41);
        const auto alias_constants_START_NOTE_HASH_EXISTS_WRITE_OFFSET = FF(0);
        const auto alias_constants_START_NULLIFIER_EXISTS_OFFSET = FF(16);
        const auto alias_constants_START_NULLIFIER_NON_EXISTS_OFFSET = FF(32);
        const auto alias_constants_START_L1_TO_L2_MSG_EXISTS_WRITE_OFFSET = FF(48);
        const auto alias_constants_START_SSTORE_WRITE_OFFSET = FF(64);
        const auto alias_constants_START_SLOAD_WRITE_OFFSET = FF(96);
        const auto alias_constants_START_EMIT_NOTE_HASH_WRITE_OFFSET = FF(128);
        const auto alias_constants_START_EMIT_NULLIFIER_WRITE_OFFSET = FF(144);
        const auto alias_constants_START_EMIT_L2_TO_L1_MSG_WRITE_OFFSET = FF(160);
        const auto alias_constants_START_EMIT_UNENCRYPTED_LOG_WRITE_OFFSET = FF(162);
        const auto alias_constants_misc_INTERNAL_CALL_SPACE_ID = FF(255);
        const auto alias_main_KERNEL_INPUT_SELECTORS =
        ...
        const auto alias_main_KERNEL_OUTPUT_SELECTORS =
        ...
        const auto alias_main_SEL_ALU_W_TAG = new_term.main_sel_op_cast;
        const auto alias_main_SEL_ALL_ALU = (alias_main_SEL_ALU_R_TAG + alias_main_SEL_ALU_W_TAG);
        const auto alias_main_SEL_ALL_LEFTGAS = (new_term.main_sel_op_dagasleft + new_term.main_sel_op_l2gasleft);
        const auto alias_main_SEL_ALL_BINARY =
            ((new_term.main_sel_op_and + new_term.main_sel_op_or) + new_term.main_sel_op_xor);
        const auto alias_main_SEL_ALL_GADGET =
        ...
        const auto alias_main_SEL_ALL_MEMORY = (new_term.main_sel_op_cmov + new_term.main_sel_op_mov);
        const auto alias_main_SEL_ALL_MEM_SLICE =
            (new_term.main_sel_op_calldata_copy + new_term.main_sel_op_external_return);
        const auto alias_main_OPCODE_SELECTORS =
            ((((((((new_term.main_sel_op_fdiv + alias_main_SEL_ALL_ALU) + alias_main_SEL_ALL_BINARY) +
                  alias_main_SEL_ALL_MEMORY) +
                 alias_main_SEL_ALL_GADGET) +
                alias_main_KERNEL_INPUT_SELECTORS) +
               alias_main_KERNEL_OUTPUT_SELECTORS) +
              alias_main_SEL_ALL_LEFTGAS) +
             alias_main_SEL_ALL_MEM_SLICE);
        ...
        }
        {
            ...
            auto tmp = (alias_main_KERNEL_INPUT_SELECTORS * (FF(1) - new_term.main_sel_q_kernel_lookup));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (alias_main_KERNEL_OUTPUT_SELECTORS * (FF(1) - new_term.main_sel_q_kernel_output_lookup));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = ((((FF(1) - new_term.main_sel_first) * (FF(1) - new_term.main_sel_op_halt)) *
                         alias_main_OPCODE_SELECTORS) *
        ...
        }
        {
            ...
            auto tmp = ((FF(1) - alias_main_INTERNAL_CALL_STACK_SELECTORS) *
        ...
        }
        {
            ...
            auto tmp = ((new_term.main_sel_op_internal_call + new_term.main_sel_op_internal_return) *
                        (new_term.main_space_id - alias_constants_misc_INTERNAL_CALL_SPACE_ID));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (alias_main_OPCODE_SELECTORS * (new_term.main_call_ptr - new_term.main_space_id));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_alu -
                        ((alias_main_SEL_ALL_ALU * (FF(1) - new_term.main_tag_err)) * (FF(1) - new_term.main_op_err)));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (alias_main_SEL_ALU_R_TAG * (new_term.main_alu_in_tag - new_term.main_r_in_tag));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (alias_main_SEL_ALU_W_TAG * (new_term.main_alu_in_tag - new_term.main_w_in_tag));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp =
                (new_term.main_sel_op_address * (new_term.kernel_kernel_in_offset - alias_constants_ADDRESS_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_storage_address *
                        (new_term.kernel_kernel_in_offset - alias_constants_STORAGE_ADDRESS_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp =
                (new_term.main_sel_op_sender * (new_term.kernel_kernel_in_offset - alias_constants_SENDER_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_function_selector *
                        (new_term.kernel_kernel_in_offset - alias_constants_FUNCTION_SELECTOR_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_transaction_fee *
                        (new_term.kernel_kernel_in_offset - alias_constants_TRANSACTION_FEE_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_chain_id *
                        (new_term.kernel_kernel_in_offset - alias_constants_CHAIN_ID_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp =
                (new_term.main_sel_op_version * (new_term.kernel_kernel_in_offset - alias_constants_VERSION_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_block_number *
                        (new_term.kernel_kernel_in_offset - alias_constants_BLOCK_NUMBER_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_timestamp *
                        (new_term.kernel_kernel_in_offset - alias_constants_TIMESTAMP_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_coinbase *
                        (new_term.kernel_kernel_in_offset - alias_constants_COINBASE_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_fee_per_da_gas *
                        (new_term.kernel_kernel_in_offset - alias_constants_FEE_PER_DA_GAS_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_fee_per_l2_gas *
                        (new_term.kernel_kernel_in_offset - alias_constants_FEE_PER_L2_GAS_SELECTOR));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_note_hash_exists *
                        (new_term.kernel_kernel_out_offset - (alias_constants_START_NOTE_HASH_EXISTS_WRITE_OFFSET +
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_emit_note_hash *
                        (new_term.kernel_kernel_out_offset - (alias_constants_START_EMIT_NOTE_HASH_WRITE_OFFSET +
                                                              new_term.kernel_emit_note_hash_write_offset)));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_nullifier_exists *
                        (new_term.kernel_kernel_out_offset -
                         ((new_term.main_ib * (alias_constants_START_NULLIFIER_EXISTS_OFFSET +
                                               new_term.kernel_nullifier_exists_write_offset)) +
                          ((FF(1) - new_term.main_ib) * (alias_constants_START_NULLIFIER_NON_EXISTS_OFFSET +
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_emit_nullifier *
                        (new_term.kernel_kernel_out_offset - (alias_constants_START_EMIT_NULLIFIER_WRITE_OFFSET +
                                                              new_term.kernel_emit_nullifier_write_offset)));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_l1_to_l2_msg_exists *
                        (new_term.kernel_kernel_out_offset - (alias_constants_START_L1_TO_L2_MSG_EXISTS_WRITE_OFFSET +
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_emit_unencrypted_log *
                        (new_term.kernel_kernel_out_offset - (alias_constants_START_EMIT_UNENCRYPTED_LOG_WRITE_OFFSET +
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_emit_l2_to_l1_msg *
                        (new_term.kernel_kernel_out_offset - (alias_constants_START_EMIT_L2_TO_L1_MSG_WRITE_OFFSET +
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_sload *
                        (new_term.kernel_kernel_out_offset -
                         (alias_constants_START_SLOAD_WRITE_OFFSET + new_term.kernel_sload_write_offset)));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_op_sstore *
                        (new_term.kernel_kernel_out_offset -
                         (alias_constants_START_SSTORE_WRITE_OFFSET + new_term.kernel_sstore_write_offset)));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (alias_main_KERNEL_OUTPUT_SELECTORS *
