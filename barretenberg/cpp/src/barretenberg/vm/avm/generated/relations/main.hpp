...
template <typename FF_> class mainImpl {
  public:
    ...
    static constexpr std::array<size_t, 98> SUBRELATION_PARTIAL_LENGTHS = {
        2, 3, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
        3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
        3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 5, 4, 4, 3, 3, 3, 3, 4, 3, 4, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 3
    };
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        const auto main_SEL_ALL_CTRL_FLOW = new_term.main_sel_op_jump + new_term.main_sel_op_jumpi +
                                            new_term.main_sel_op_internal_call + new_term.main_sel_op_internal_return +
                                            new_term.main_sel_op_external_call + new_term.main_sel_op_static_call +
                                            new_term.main_sel_op_external_return + new_term.main_sel_op_external_revert;
        const auto main_SEL_ALU_R_TAG = new_term.main_sel_op_add + new_term.main_sel_op_sub + new_term.main_sel_op_mul +
                                        new_term.main_sel_op_div + new_term.main_sel_op_not + new_term.main_sel_op_eq +
                                        new_term.main_sel_op_lt + new_term.main_sel_op_lte + new_term.main_sel_op_shr +
        ...
        const auto main_SEL_ALL_BINARY = new_term.main_sel_op_and + new_term.main_sel_op_or + new_term.main_sel_op_xor;
        const auto main_SEL_ALL_GADGET = new_term.main_sel_op_radix_be + new_term.main_sel_op_sha256 +
                                         new_term.main_sel_op_poseidon2 + new_term.main_sel_op_keccak +
                                         new_term.main_sel_op_ecadd + new_term.main_sel_op_msm;
        const auto main_SEL_ALL_MEMORY = new_term.main_sel_op_mov + new_term.main_sel_op_set;
        const auto main_KERNEL_INPUT_SELECTORS =
            new_term.main_sel_op_address + new_term.main_sel_op_sender + new_term.main_sel_op_transaction_fee +
            new_term.main_sel_op_chain_id + new_term.main_sel_op_version + new_term.main_sel_op_block_number +
            new_term.main_sel_op_timestamp + new_term.main_sel_op_fee_per_l2_gas + new_term.main_sel_op_fee_per_da_gas +
        ...
        const auto main_KERNEL_OUTPUT_SELECTORS =
            ...
            new_term.main_sel_op_nullifier_exists + new_term.main_sel_op_emit_nullifier +
            new_term.main_sel_op_l1_to_l2_msg_exists + new_term.main_sel_op_emit_unencrypted_log +
            new_term.main_sel_op_emit_l2_to_l1_msg + new_term.main_sel_op_sload + new_term.main_sel_op_sstore;
        const auto main_OPCODE_SELECTORS =
            new_term.main_sel_op_fdiv + new_term.main_sel_op_calldata_copy +
            new_term.main_sel_op_get_contract_instance + new_term.main_sel_op_returndata_size +
            new_term.main_sel_op_returndata_copy + new_term.main_sel_op_debug_log + main_SEL_ALL_ALU +
            main_SEL_ALL_BINARY + main_SEL_ALL_MEMORY + main_SEL_ALL_GADGET + main_SEL_ALL_LEFTGAS +
            main_SEL_ALL_CTRL_FLOW + main_KERNEL_INPUT_SELECTORS + main_KERNEL_OUTPUT_SELECTORS;
        ...
        }
        {
            ...
            auto tmp = (new_term.main_sel_execution_end_shift - new_term.main_sel_execution_row *
                                                                    (FF(1) - new_term.main_sel_execution_row_shift) *
        ...
        }
        {
            ...
            auto tmp = new_term.main_sel_op_emit_unencrypted_log * (FF(1) - new_term.main_sel_op_emit_unencrypted_log);
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp =
                new_term.main_sel_op_jumpi * ((new_term.main_id * new_term.main_inv - FF(1)) + new_term.main_id_zero);
            tmp *= scaling_factor;
...
template <typename FF> class main : public Relation<mainImpl<FF>> {
  public:
    static constexpr const std::string_view NAME = "main";
