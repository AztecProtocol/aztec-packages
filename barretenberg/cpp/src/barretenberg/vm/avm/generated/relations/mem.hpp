  ...
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        const auto mem_IND_OP = new_term.mem_sel_resolve_ind_addr_a + new_term.mem_sel_resolve_ind_addr_b +
                                new_term.mem_sel_resolve_ind_addr_c + new_term.mem_sel_resolve_ind_addr_d;
        ...
        }
        {
            ...
            auto tmp =
                (new_term.mem_sel_mem - (mem_SEL_DIRECT_MEM_OP_A + mem_SEL_DIRECT_MEM_OP_B + mem_SEL_DIRECT_MEM_OP_C +
                                         mem_SEL_DIRECT_MEM_OP_D + new_term.mem_sel_resolve_ind_addr_a +
                                         new_term.mem_sel_resolve_ind_addr_b + new_term.mem_sel_resolve_ind_addr_c +
                                         new_term.mem_sel_resolve_ind_addr_d + new_term.mem_sel_op_slice));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (FF(1) - new_term.main_sel_first) * new_term.mem_sel_mem_shift * (FF(1) - new_term.mem_sel_mem);
            tmp *= scaling_factor;
...
template <typename FF> class mem : public Relation<memImpl<FF>> {
  public:
    static constexpr const std::string_view NAME = "mem";
