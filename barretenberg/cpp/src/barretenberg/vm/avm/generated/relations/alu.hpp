  ...
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        const auto alu_CMP_GADGET_GT =
            new_term.alu_op_lt + new_term.alu_op_lte + new_term.alu_op_div + new_term.alu_op_shr + new_term.alu_op_shl;
        const auto alu_MAX_BITS = new_term.alu_u1_tag * FF(1) + new_term.alu_u8_tag * FF(8) +
                                  new_term.alu_u16_tag * FF(16) + new_term.alu_u32_tag * FF(32) +
                                  new_term.alu_u64_tag * FF(64) + new_term.alu_u128_tag * FF(128);
        const auto alu_MAX_BITS_POW = new_term.alu_u1_tag * FF(2) + new_term.alu_u8_tag * FF(256) +
                                      new_term.alu_u16_tag * FF(65536) + new_term.alu_u32_tag * FF(4294967296UL) +
        ...
        const auto alu_LIMB_BITS_POW = new_term.alu_u8_tag * FF(16) + new_term.alu_u16_tag * FF(256) +
                                       new_term.alu_u32_tag * FF(65536) + new_term.alu_u64_tag * FF(4294967296UL) +
...

        {
            ...
            auto tmp = (new_term.alu_sel_alu -
                        (new_term.alu_op_add + new_term.alu_op_sub + new_term.alu_op_mul + new_term.alu_op_not +
                         new_term.alu_op_eq + new_term.alu_op_cast + new_term.alu_op_lt + new_term.alu_op_lte +
                         new_term.alu_op_shr + new_term.alu_op_shl + new_term.alu_op_div));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = new_term.alu_sel_alu *
                       ((new_term.alu_u1_tag + new_term.alu_u8_tag + new_term.alu_u16_tag + new_term.alu_u32_tag +
                         new_term.alu_u64_tag + new_term.alu_u128_tag + new_term.alu_ff_tag) -
                        FF(1));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = (new_term.alu_in_tag -
                        (constants_MEM_TAG_U1 * new_term.alu_u1_tag + constants_MEM_TAG_U8 * new_term.alu_u8_tag +
                         constants_MEM_TAG_U16 * new_term.alu_u16_tag + constants_MEM_TAG_U32 * new_term.alu_u32_tag +
                         constants_MEM_TAG_U64 * new_term.alu_u64_tag + constants_MEM_TAG_U128 * new_term.alu_u128_tag +
        ...
        }
        {
            ...
            auto tmp =
                (new_term.alu_range_check_sel -
                 ((FF(1) - new_term.alu_ff_tag) * (new_term.alu_op_add + new_term.alu_op_sub + new_term.alu_op_mul +
                                                   new_term.alu_op_cast + new_term.alu_op_div) +
        ...
        }
        {
            ...
            auto tmp = (new_term.alu_range_check_input_value -
        ...
        }
        {
            ...
            auto tmp = (new_term.alu_range_check_num_bits -
                        ((new_term.alu_op_add + new_term.alu_op_sub + new_term.alu_op_mul + new_term.alu_op_cast +
                          new_term.alu_op_div) *
        ...
        }
        {
            ...
            auto tmp =
                (FF(1) - new_term.alu_ff_tag) * new_term.alu_op_div *
                (alu_PRODUCT - ((new_term.alu_c_lo - new_term.alu_remainder) + alu_MAX_BITS_POW * new_term.alu_c_hi));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp =
                new_term.alu_op_cast * ((new_term.alu_ia - new_term.alu_a_lo) - alu_MAX_BITS_POW * new_term.alu_a_hi);
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp =
                new_term.alu_op_shr * ((new_term.alu_ia - new_term.alu_a_lo) - new_term.alu_b_pow * new_term.alu_a_hi);
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = new_term.alu_op_shl *
                       ((new_term.alu_ia - new_term.alu_a_lo) - new_term.alu_max_bits_sub_b_pow * new_term.alu_a_hi);
            tmp *= scaling_factor;
