...
template <typename FF_> class poseidon2Impl {
  public:
    ...
    static constexpr std::array<size_t, 277> SUBRELATION_PARTIAL_LENGTHS = {
        3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7,
    ...
    template <typename AllEntities> inline static bool skip(const AllEntities& in)
    {
        ...
        return (((new_term.poseidon2_sel_poseidon_perm * new_term.poseidon2_sel_poseidon_perm_mem_op) *
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        }
        {
            ...
            auto tmp = ((FF(1) - new_term.poseidon2_sel_poseidon_perm) *
                        (new_term.poseidon2_sel_poseidon_perm_mem_op + new_term.poseidon2_sel_poseidon_perm_immediate));
            tmp *= scaling_factor;
