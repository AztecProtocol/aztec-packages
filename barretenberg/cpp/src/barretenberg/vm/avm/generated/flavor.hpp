...
<<<<<<< HEAD
    static constexpr size_t NUM_WITNESS_ENTITIES = 709;
=======
<<<<<<< HEAD
    static constexpr size_t NUM_WITNESS_ENTITIES = 705;
>>>>>>> eb84583b4d (Rebase on master and run codegen)
    static constexpr size_t NUM_SHIFTED_ENTITIES = 58;
    static constexpr size_t NUM_WIRES = NUM_WITNESS_ENTITIES + NUM_PRECOMPUTED_ENTITIES;
    // We have two copies of the witness entities, so we subtract the number of fixed ones (they have no shift), one for
    // the unshifted and one for the shifted
<<<<<<< HEAD
    static constexpr size_t NUM_ALL_ENTITIES = 788;
=======
    static constexpr size_t NUM_ALL_ENTITIES = 784;
=======
