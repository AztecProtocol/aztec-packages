...
AvmCircuitBuilder::ProverPolynomials AvmCircuitBuilder::compute_polynomials() const
{
    ...
    for (size_t i = 0; i < rows.size(); i++) {
        ...
        polys.main_emit_l2_to_l1_msg_write_offset.set_if_valid_index(i, rows[i].main_emit_l2_to_l1_msg_write_offset);
        ...
        polys.main_emit_unencrypted_log_write_offset.set_if_valid_index(i,
                                                                        rows[i].main_emit_unencrypted_log_write_offset);
        ...
        polys.main_l1_to_l2_msg_exists_write_offset.set_if_valid_index(i,
                                                                       rows[i].main_l1_to_l2_msg_exists_write_offset);
        ...
        polys.main_note_hash_exist_write_offset.set_if_valid_index(i, rows[i].main_note_hash_exist_write_offset);
        polys.main_nullifier_exists_write_offset.set_if_valid_index(i, rows[i].main_nullifier_exists_write_offset);
        polys.main_nullifier_non_exists_write_offset.set_if_valid_index(i,
                                                                        rows[i].main_nullifier_non_exists_write_offset);
        ...
        polys.main_sel_op_get_contract_instance.set_if_valid_index(i, rows[i].main_sel_op_get_contract_instance);
