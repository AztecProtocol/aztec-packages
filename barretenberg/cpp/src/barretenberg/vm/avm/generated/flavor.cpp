...
AvmFlavor::AllConstRefValues::AllConstRefValues(
    ...
    , perm_l2_start_gas_inv(il[658])
    , perm_da_start_gas_inv(il[659])
    , perm_l2_end_gas_inv(il[660])
    , perm_da_end_gas_inv(il[661])
    , perm_pos_mem_read_a_inv(il[662])
    , perm_pos_mem_read_b_inv(il[663])
    , perm_pos_mem_read_c_inv(il[664])
    , perm_pos_mem_read_d_inv(il[665])
    , perm_pos_mem_write_a_inv(il[666])
    , perm_pos_mem_write_b_inv(il[667])
    , perm_pos_mem_write_c_inv(il[668])
    , perm_pos_mem_write_d_inv(il[669])
    , perm_slice_mem_inv(il[670])
    , perm_main_alu_inv(il[671])
    , perm_main_bin_inv(il[672])
    , perm_main_conv_inv(il[673])
    , perm_main_sha256_inv(il[674])
    , perm_main_pos2_perm_inv(il[675])
    , perm_main_slice_inv(il[676])
    , perm_main_mem_a_inv(il[677])
    , perm_main_mem_b_inv(il[678])
    , perm_main_mem_c_inv(il[679])
    , perm_main_mem_d_inv(il[680])
    , perm_main_mem_ind_addr_a_inv(il[681])
    , perm_main_mem_ind_addr_b_inv(il[682])
    , perm_main_mem_ind_addr_c_inv(il[683])
    , perm_main_mem_ind_addr_d_inv(il[684])
    , lookup_rng_chk_pow_2_inv(il[685])
    , lookup_rng_chk_diff_inv(il[686])
    , lookup_rng_chk_0_inv(il[687])
    , lookup_rng_chk_1_inv(il[688])
    , lookup_rng_chk_2_inv(il[689])
    , lookup_rng_chk_3_inv(il[690])
    , lookup_rng_chk_4_inv(il[691])
    , lookup_rng_chk_5_inv(il[692])
    , lookup_rng_chk_6_inv(il[693])
    , lookup_rng_chk_7_inv(il[694])
    , lookup_pow_2_0_inv(il[695])
    , lookup_pow_2_1_inv(il[696])
    , lookup_byte_lengths_inv(il[697])
    , lookup_byte_operations_inv(il[698])
    , lookup_opcode_gas_inv(il[699])
    , kernel_output_lookup_inv(il[700])
    , lookup_into_kernel_inv(il[701])
    , lookup_cd_value_inv(il[702])
    , lookup_ret_value_inv(il[703])
    , incl_main_tag_err_inv(il[704])
    , incl_mem_tag_err_inv(il[705])
    , binary_acc_ia_shift(il[706])
    , binary_acc_ib_shift(il[707])
    , binary_acc_ic_shift(il[708])
    , binary_mem_tag_ctr_shift(il[709])
    , binary_op_id_shift(il[710])
    , cmp_a_hi_shift(il[711])
    , cmp_a_lo_shift(il[712])
    , cmp_b_hi_shift(il[713])
    , cmp_b_lo_shift(il[714])
    , cmp_cmp_rng_ctr_shift(il[715])
    , cmp_op_gt_shift(il[716])
    , cmp_p_sub_a_hi_shift(il[717])
    , cmp_p_sub_a_lo_shift(il[718])
    , cmp_p_sub_b_hi_shift(il[719])
    , cmp_p_sub_b_lo_shift(il[720])
    , cmp_sel_rng_chk_shift(il[721])
    , main_da_gas_remaining_shift(il[722])
    , main_emit_l2_to_l1_msg_write_offset_shift(il[723])
    , main_emit_note_hash_write_offset_shift(il[724])
    , main_emit_nullifier_write_offset_shift(il[725])
    , main_emit_unencrypted_log_write_offset_shift(il[726])
    , main_internal_return_ptr_shift(il[727])
    , main_l1_to_l2_msg_exists_write_offset_shift(il[728])
    , main_l2_gas_remaining_shift(il[729])
    , main_note_hash_exist_write_offset_shift(il[730])
    , main_nullifier_exists_write_offset_shift(il[731])
    , main_nullifier_non_exists_write_offset_shift(il[732])
    , main_pc_shift(il[733])
    , main_sel_execution_end_shift(il[734])
    , main_sel_execution_row_shift(il[735])
    , main_sload_write_offset_shift(il[736])
    , main_sstore_write_offset_shift(il[737])
    , mem_glob_addr_shift(il[738])
    , mem_rw_shift(il[739])
    , mem_sel_mem_shift(il[740])
    , mem_tag_shift(il[741])
    , mem_tsp_shift(il[742])
    , mem_val_shift(il[743])
    , slice_addr_shift(il[744])
    , slice_clk_shift(il[745])
    , slice_cnt_shift(il[746])
    , slice_col_offset_shift(il[747])
    , slice_sel_cd_cpy_shift(il[748])
    , slice_sel_mem_active_shift(il[749])
    , slice_sel_return_shift(il[750])
    , slice_sel_start_shift(il[751])
    , slice_space_id_shift(il[752])
{}
