...
<<<<<<< HEAD
    ...
    , main_sel_op_jump(il[204])
    , main_sel_op_jumpi(il[205])
    , main_sel_op_keccak(il[206])
    , main_sel_op_l1_to_l2_msg_exists(il[207])
    , main_sel_op_l2gasleft(il[208])
    , main_sel_op_lt(il[209])
    , main_sel_op_lte(il[210])
    , main_sel_op_mov(il[211])
    , main_sel_op_msm(il[212])
    , main_sel_op_mul(il[213])
    , main_sel_op_not(il[214])
    , main_sel_op_note_hash_exists(il[215])
    , main_sel_op_nullifier_exists(il[216])
    , main_sel_op_or(il[217])
    , main_sel_op_pedersen(il[218])
    , main_sel_op_pedersen_commit(il[219])
    , main_sel_op_poseidon2(il[220])
    , main_sel_op_radix_le(il[221])
    , main_sel_op_sender(il[222])
    , main_sel_op_set(il[223])
    , main_sel_op_sha256(il[224])
    , main_sel_op_shl(il[225])
    , main_sel_op_shr(il[226])
    , main_sel_op_sload(il[227])
    , main_sel_op_sstore(il[228])
    , main_sel_op_storage_address(il[229])
    , main_sel_op_sub(il[230])
    , main_sel_op_timestamp(il[231])
    , main_sel_op_transaction_fee(il[232])
    , main_sel_op_version(il[233])
    , main_sel_op_xor(il[234])
    , main_sel_q_kernel_lookup(il[235])
    , main_sel_q_kernel_output_lookup(il[236])
    , main_sel_resolve_ind_addr_a(il[237])
    , main_sel_resolve_ind_addr_b(il[238])
    , main_sel_resolve_ind_addr_c(il[239])
    , main_sel_resolve_ind_addr_d(il[240])
    , main_sel_returndata(il[241])
    , main_sel_rng_16(il[242])
    , main_sel_rng_8(il[243])
    , main_sel_slice_gadget(il[244])
    , main_side_effect_counter(il[245])
    , main_sload_write_offset(il[246])
    , main_space_id(il[247])
    , main_sstore_write_offset(il[248])
    , main_tag_err(il[249])
    , main_w_in_tag(il[250])
    , mem_addr(il[251])
    , mem_clk(il[252])
    , mem_diff(il[253])
    , mem_glob_addr(il[254])
    , mem_last(il[255])
    , mem_lastAccess(il[256])
    , mem_one_min_inv(il[257])
    , mem_r_in_tag(il[258])
    , mem_rw(il[259])
    , mem_sel_mem(il[260])
    , mem_sel_mov_ia_to_ic(il[261])
    , mem_sel_mov_ib_to_ic(il[262])
    , mem_sel_op_a(il[263])
    , mem_sel_op_b(il[264])
    , mem_sel_op_c(il[265])
    , mem_sel_op_cmov(il[266])
    , mem_sel_op_d(il[267])
    , mem_sel_op_poseidon_read_a(il[268])
    , mem_sel_op_poseidon_read_b(il[269])
    , mem_sel_op_poseidon_read_c(il[270])
    , mem_sel_op_poseidon_read_d(il[271])
    , mem_sel_op_poseidon_write_a(il[272])
    , mem_sel_op_poseidon_write_b(il[273])
    , mem_sel_op_poseidon_write_c(il[274])
    , mem_sel_op_poseidon_write_d(il[275])
    , mem_sel_op_slice(il[276])
    , mem_sel_resolve_ind_addr_a(il[277])
    , mem_sel_resolve_ind_addr_b(il[278])
    , mem_sel_resolve_ind_addr_c(il[279])
    , mem_sel_resolve_ind_addr_d(il[280])
    , mem_sel_rng_chk(il[281])
    , mem_skip_check_tag(il[282])
    , mem_space_id(il[283])
    , mem_tag(il[284])
    , mem_tag_err(il[285])
    , mem_tsp(il[286])
    ...
    , mem_w_in_tag(il[288])
    , pedersen_clk(il[289])
    , pedersen_input(il[290])
    , pedersen_output(il[291])
    , pedersen_sel_pedersen(il[292])
    ...
    , range_check_alu_rng_chk(il[573])
    , range_check_clk(il[574])
    , range_check_cmp_hi_bits_rng_chk(il[575])
    , range_check_cmp_lo_bits_rng_chk(il[576])
    , range_check_dyn_diff(il[577])
    , range_check_dyn_rng_chk_bits(il[578])
    , range_check_dyn_rng_chk_pow_2(il[579])
    , range_check_gas_da_rng_chk(il[580])
    , range_check_gas_l2_rng_chk(il[581])
    , range_check_is_lte_u112(il[582])
    , range_check_is_lte_u128(il[583])
    , range_check_is_lte_u16(il[584])
    , range_check_is_lte_u32(il[585])
    , range_check_is_lte_u48(il[586])
    , range_check_is_lte_u64(il[587])
    , range_check_is_lte_u80(il[588])
    , range_check_is_lte_u96(il[589])
    , range_check_mem_rng_chk(il[590])
    , range_check_rng_chk_bits(il[591])
    , range_check_sel_lookup_0(il[592])
    , range_check_sel_lookup_1(il[593])
    , range_check_sel_lookup_2(il[594])
    , range_check_sel_lookup_3(il[595])
    , range_check_sel_lookup_4(il[596])
    , range_check_sel_lookup_5(il[597])
    , range_check_sel_lookup_6(il[598])
    , range_check_sel_rng_chk(il[599])
    , range_check_u16_r0(il[600])
    , range_check_u16_r1(il[601])
    , range_check_u16_r2(il[602])
    , range_check_u16_r3(il[603])
    , range_check_u16_r4(il[604])
    , range_check_u16_r5(il[605])
    , range_check_u16_r6(il[606])
    , range_check_u16_r7(il[607])
    , range_check_value(il[608])
    , sha256_clk(il[609])
    , sha256_input(il[610])
    , sha256_output(il[611])
    , sha256_sel_sha256_compression(il[612])
    , sha256_state(il[613])
    , slice_addr(il[614])
    , slice_clk(il[615])
    , slice_cnt(il[616])
    , slice_col_offset(il[617])
    , slice_one_min_inv(il[618])
    , slice_sel_cd_cpy(il[619])
    , slice_sel_mem_active(il[620])
    , slice_sel_return(il[621])
    , slice_sel_start(il[622])
    , slice_space_id(il[623])
    , slice_val(il[624])
    , lookup_rng_chk_pow_2_counts(il[625])
    , lookup_rng_chk_diff_counts(il[626])
    , lookup_rng_chk_0_counts(il[627])
    , lookup_rng_chk_1_counts(il[628])
    , lookup_rng_chk_2_counts(il[629])
    , lookup_rng_chk_3_counts(il[630])
    , lookup_rng_chk_4_counts(il[631])
    , lookup_rng_chk_5_counts(il[632])
    , lookup_rng_chk_6_counts(il[633])
    , lookup_rng_chk_7_counts(il[634])
    , lookup_pow_2_0_counts(il[635])
    , lookup_pow_2_1_counts(il[636])
    , lookup_byte_lengths_counts(il[637])
    , lookup_byte_operations_counts(il[638])
    , lookup_opcode_gas_counts(il[639])
    , kernel_output_lookup_counts(il[640])
    , lookup_into_kernel_counts(il[641])
    , lookup_cd_value_counts(il[642])
    , lookup_ret_value_counts(il[643])
    , incl_main_tag_err_counts(il[644])
    , incl_mem_tag_err_counts(il[645])
    , perm_rng_mem_inv(il[646])
    , perm_rng_cmp_lo_inv(il[647])
    , perm_rng_cmp_hi_inv(il[648])
    , perm_rng_alu_inv(il[649])
    , perm_cmp_alu_inv(il[650])
    , perm_rng_gas_l2_inv(il[651])
    , perm_rng_gas_da_inv(il[652])
    , perm_pos_mem_read_a_inv(il[653])
    , perm_pos_mem_read_b_inv(il[654])
    , perm_pos_mem_read_c_inv(il[655])
    , perm_pos_mem_read_d_inv(il[656])
    , perm_pos_mem_write_a_inv(il[657])
    , perm_pos_mem_write_b_inv(il[658])
    , perm_pos_mem_write_c_inv(il[659])
    , perm_pos_mem_write_d_inv(il[660])
    , perm_slice_mem_inv(il[661])
    , perm_main_alu_inv(il[662])
    , perm_main_bin_inv(il[663])
    , perm_main_conv_inv(il[664])
    , perm_main_pos2_perm_inv(il[665])
    , perm_main_pedersen_inv(il[666])
    , perm_main_slice_inv(il[667])
    , perm_main_mem_a_inv(il[668])
    , perm_main_mem_b_inv(il[669])
    , perm_main_mem_c_inv(il[670])
    , perm_main_mem_d_inv(il[671])
    , perm_main_mem_ind_addr_a_inv(il[672])
    , perm_main_mem_ind_addr_b_inv(il[673])
    , perm_main_mem_ind_addr_c_inv(il[674])
    , perm_main_mem_ind_addr_d_inv(il[675])
    , lookup_rng_chk_pow_2_inv(il[676])
    , lookup_rng_chk_diff_inv(il[677])
    , lookup_rng_chk_0_inv(il[678])
    , lookup_rng_chk_1_inv(il[679])
    , lookup_rng_chk_2_inv(il[680])
    , lookup_rng_chk_3_inv(il[681])
    , lookup_rng_chk_4_inv(il[682])
    , lookup_rng_chk_5_inv(il[683])
    , lookup_rng_chk_6_inv(il[684])
    , lookup_rng_chk_7_inv(il[685])
    , lookup_pow_2_0_inv(il[686])
    , lookup_pow_2_1_inv(il[687])
    , lookup_byte_lengths_inv(il[688])
    , lookup_byte_operations_inv(il[689])
    , lookup_opcode_gas_inv(il[690])
    , kernel_output_lookup_inv(il[691])
    , lookup_into_kernel_inv(il[692])
    , lookup_cd_value_inv(il[693])
    , lookup_ret_value_inv(il[694])
    , incl_main_tag_err_inv(il[695])
    , incl_mem_tag_err_inv(il[696])
    , binary_acc_ia_shift(il[697])
    , binary_acc_ib_shift(il[698])
    , binary_acc_ic_shift(il[699])
    , binary_mem_tag_ctr_shift(il[700])
    , binary_op_id_shift(il[701])
    , cmp_a_hi_shift(il[702])
    , cmp_a_lo_shift(il[703])
    , cmp_b_hi_shift(il[704])
    , cmp_b_lo_shift(il[705])
    , cmp_cmp_rng_ctr_shift(il[706])
    , cmp_op_gt_shift(il[707])
    , cmp_p_sub_a_hi_shift(il[708])
    , cmp_p_sub_a_lo_shift(il[709])
    , cmp_p_sub_b_hi_shift(il[710])
    , cmp_p_sub_b_lo_shift(il[711])
    , cmp_sel_rng_chk_shift(il[712])
    , main_da_gas_remaining_shift(il[713])
    , main_emit_l2_to_l1_msg_write_offset_shift(il[714])
    , main_emit_note_hash_write_offset_shift(il[715])
    , main_emit_nullifier_write_offset_shift(il[716])
    , main_emit_unencrypted_log_write_offset_shift(il[717])
    , main_internal_return_ptr_shift(il[718])
    , main_l1_to_l2_msg_exists_write_offset_shift(il[719])
    , main_l2_gas_remaining_shift(il[720])
    , main_note_hash_exist_write_offset_shift(il[721])
    , main_nullifier_exists_write_offset_shift(il[722])
    , main_nullifier_non_exists_write_offset_shift(il[723])
    , main_pc_shift(il[724])
    , main_sel_execution_row_shift(il[725])
...
=======
    ...
    , main_sel_op_static_call(il[227])
