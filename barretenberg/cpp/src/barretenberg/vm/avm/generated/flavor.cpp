...
AvmFlavor::AllConstRefValues::AllConstRefValues(
    ...
    , main_sel_gas_accounting_active(il[184])
    ...
    , main_sel_op_emit_l2_to_l1_msg(il[203])
    , main_sel_op_emit_note_hash(il[204])
    , main_sel_op_emit_nullifier(il[205])
    , main_sel_op_emit_unencrypted_log(il[206])
    , main_sel_op_eq(il[207])
    , main_sel_op_external_call(il[208])
    , main_sel_op_external_return(il[209])
    , main_sel_op_fdiv(il[210])
    , main_sel_op_fee_per_da_gas(il[211])
    , main_sel_op_fee_per_l2_gas(il[212])
    , main_sel_op_function_selector(il[213])
    , main_sel_op_get_contract_instance(il[214])
    , main_sel_op_halt(il[215])
    , main_sel_op_internal_call(il[216])
    , main_sel_op_internal_return(il[217])
    , main_sel_op_jump(il[218])
    , main_sel_op_jumpi(il[219])
    , main_sel_op_keccak(il[220])
    , main_sel_op_l1_to_l2_msg_exists(il[221])
    , main_sel_op_l2gasleft(il[222])
    , main_sel_op_lt(il[223])
    , main_sel_op_lte(il[224])
    , main_sel_op_mov(il[225])
    , main_sel_op_mul(il[226])
    , main_sel_op_not(il[227])
    , main_sel_op_note_hash_exists(il[228])
    , main_sel_op_nullifier_exists(il[229])
    , main_sel_op_or(il[230])
    , main_sel_op_pedersen(il[231])
    ...
    , main_sel_op_storage_address(il[240])
    , main_sel_op_sub(il[241])
    , main_sel_op_timestamp(il[242])
    , main_sel_op_transaction_fee(il[243])
    , main_sel_op_version(il[244])
    , main_sel_op_xor(il[245])
    , main_sel_q_kernel_lookup(il[246])
    , main_sel_q_kernel_output_lookup(il[247])
    , main_sel_resolve_ind_addr_a(il[248])
    , main_sel_resolve_ind_addr_b(il[249])
    , main_sel_resolve_ind_addr_c(il[250])
    , main_sel_resolve_ind_addr_d(il[251])
    , main_sel_returndata(il[252])
    , main_sel_rng_16(il[253])
    , main_sel_rng_8(il[254])
    , main_sel_slice_gadget(il[255])
    ...
    , sha256_clk(il[583])
    , sha256_input(il[584])
    , sha256_output(il[585])
    , sha256_sel_sha256_compression(il[586])
    , sha256_state(il[587])
    , slice_addr(il[588])
    , slice_clk(il[589])
    , slice_cnt(il[590])
    , slice_col_offset(il[591])
    , slice_one_min_inv(il[592])
    , slice_sel_cd_cpy(il[593])
    , slice_sel_mem_active(il[594])
    , slice_sel_return(il[595])
    , slice_sel_start(il[596])
    , slice_space_id(il[597])
    , slice_val(il[598])
    , lookup_byte_lengths_counts(il[599])
    , lookup_byte_operations_counts(il[600])
    , lookup_opcode_gas_counts(il[601])
    , range_check_l2_gas_hi_counts(il[602])
    , range_check_l2_gas_lo_counts(il[603])
    , range_check_da_gas_hi_counts(il[604])
    , range_check_da_gas_lo_counts(il[605])
    , lookup_cd_value_counts(il[606])
    , lookup_ret_value_counts(il[607])
    , kernel_output_lookup_counts(il[608])
    , lookup_into_kernel_counts(il[609])
    , incl_main_tag_err_counts(il[610])
    , incl_mem_tag_err_counts(il[611])
    , lookup_mem_rng_chk_lo_counts(il[612])
    , lookup_mem_rng_chk_mid_counts(il[613])
    , lookup_mem_rng_chk_hi_counts(il[614])
    , lookup_pow_2_0_counts(il[615])
    , lookup_pow_2_1_counts(il[616])
    , lookup_u8_0_counts(il[617])
    , lookup_u8_1_counts(il[618])
    , lookup_u16_0_counts(il[619])
    , lookup_u16_1_counts(il[620])
    , lookup_u16_2_counts(il[621])
    , lookup_u16_3_counts(il[622])
    , lookup_u16_4_counts(il[623])
    , lookup_u16_5_counts(il[624])
    , lookup_u16_6_counts(il[625])
    , lookup_u16_7_counts(il[626])
    , lookup_u16_8_counts(il[627])
    , lookup_u16_9_counts(il[628])
    , lookup_u16_10_counts(il[629])
    , lookup_u16_11_counts(il[630])
    , lookup_u16_12_counts(il[631])
    , lookup_u16_13_counts(il[632])
    , lookup_u16_14_counts(il[633])
    , lookup_div_u16_0_counts(il[634])
    , lookup_div_u16_1_counts(il[635])
    , lookup_div_u16_2_counts(il[636])
    , lookup_div_u16_3_counts(il[637])
    , lookup_div_u16_4_counts(il[638])
    , lookup_div_u16_5_counts(il[639])
    , lookup_div_u16_6_counts(il[640])
    , lookup_div_u16_7_counts(il[641])
    , perm_pos_mem_read_a(il[642])
    , perm_pos_mem_read_b(il[643])
    , perm_pos_mem_read_c(il[644])
    , perm_pos_mem_read_d(il[645])
    , perm_pos_mem_write_a(il[646])
    , perm_pos_mem_write_b(il[647])
    , perm_pos_mem_write_c(il[648])
    , perm_pos_mem_write_d(il[649])
    , perm_slice_mem(il[650])
    , perm_main_alu(il[651])
    , perm_main_bin(il[652])
    , perm_main_conv(il[653])
    , perm_main_pos2_perm(il[654])
    , perm_main_pedersen(il[655])
    , perm_main_slice(il[656])
    , perm_main_mem_a(il[657])
    , perm_main_mem_b(il[658])
    , perm_main_mem_c(il[659])
    , perm_main_mem_d(il[660])
    , perm_main_mem_ind_addr_a(il[661])
    , perm_main_mem_ind_addr_b(il[662])
    , perm_main_mem_ind_addr_c(il[663])
    , perm_main_mem_ind_addr_d(il[664])
    , lookup_byte_lengths(il[665])
    , lookup_byte_operations(il[666])
    , lookup_opcode_gas(il[667])
    , range_check_l2_gas_hi(il[668])
    , range_check_l2_gas_lo(il[669])
    , range_check_da_gas_hi(il[670])
    , range_check_da_gas_lo(il[671])
    , lookup_cd_value(il[672])
    , lookup_ret_value(il[673])
    , kernel_output_lookup(il[674])
    , lookup_into_kernel(il[675])
    , incl_main_tag_err(il[676])
    , incl_mem_tag_err(il[677])
    , lookup_mem_rng_chk_lo(il[678])
    , lookup_mem_rng_chk_mid(il[679])
    , lookup_mem_rng_chk_hi(il[680])
    , lookup_pow_2_0(il[681])
    , lookup_pow_2_1(il[682])
    , lookup_u8_0(il[683])
    , lookup_u8_1(il[684])
    , lookup_u16_0(il[685])
    , lookup_u16_1(il[686])
    ...
    , lookup_u16_8(il[693])
    , lookup_u16_9(il[694])
    , lookup_u16_10(il[695])
    , lookup_u16_11(il[696])
    , lookup_u16_12(il[697])
    , lookup_u16_13(il[698])
    , lookup_u16_14(il[699])
    , lookup_div_u16_0(il[700])
    , lookup_div_u16_1(il[701])
    , lookup_div_u16_2(il[702])
    , lookup_div_u16_3(il[703])
    , lookup_div_u16_4(il[704])
    , lookup_div_u16_5(il[705])
    , lookup_div_u16_6(il[706])
    , lookup_div_u16_7(il[707])
    , alu_a_hi_shift(il[708])
    , alu_a_lo_shift(il[709])
    , alu_b_hi_shift(il[710])
    , alu_b_lo_shift(il[711])
    , alu_cmp_rng_ctr_shift(il[712])
    , alu_div_u16_r0_shift(il[713])
    , alu_div_u16_r1_shift(il[714])
    , alu_div_u16_r2_shift(il[715])
    , alu_div_u16_r3_shift(il[716])
    , alu_div_u16_r4_shift(il[717])
    , alu_div_u16_r5_shift(il[718])
    , alu_div_u16_r6_shift(il[719])
    , alu_div_u16_r7_shift(il[720])
    , alu_op_add_shift(il[721])
    , alu_op_cast_shift(il[722])
    , alu_op_cast_prev_shift(il[723])
    , alu_op_div_shift(il[724])
    , alu_op_mul_shift(il[725])
    , alu_op_shl_shift(il[726])
    , alu_op_shr_shift(il[727])
    , alu_op_sub_shift(il[728])
    , alu_p_sub_a_hi_shift(il[729])
    , alu_p_sub_a_lo_shift(il[730])
    , alu_p_sub_b_hi_shift(il[731])
    , alu_p_sub_b_lo_shift(il[732])
    , alu_sel_alu_shift(il[733])
    , alu_sel_cmp_shift(il[734])
    , alu_sel_div_rng_chk_shift(il[735])
    , alu_sel_rng_chk_shift(il[736])
    , alu_sel_rng_chk_lookup_shift(il[737])
    , alu_u16_r0_shift(il[738])
    , alu_u16_r1_shift(il[739])
    , alu_u16_r2_shift(il[740])
    , alu_u16_r3_shift(il[741])
    , alu_u16_r4_shift(il[742])
    , alu_u16_r5_shift(il[743])
    , alu_u16_r6_shift(il[744])
    , alu_u8_r0_shift(il[745])
    , alu_u8_r1_shift(il[746])
    , binary_acc_ia_shift(il[747])
    , binary_acc_ib_shift(il[748])
    , binary_acc_ic_shift(il[749])
    , binary_mem_tag_ctr_shift(il[750])
    , binary_op_id_shift(il[751])
    , kernel_emit_l2_to_l1_msg_write_offset_shift(il[752])
    , kernel_emit_note_hash_write_offset_shift(il[753])
    , kernel_emit_nullifier_write_offset_shift(il[754])
    , kernel_emit_unencrypted_log_write_offset_shift(il[755])
    , kernel_l1_to_l2_msg_exists_write_offset_shift(il[756])
    , kernel_note_hash_exist_write_offset_shift(il[757])
    , kernel_nullifier_exists_write_offset_shift(il[758])
    , kernel_nullifier_non_exists_write_offset_shift(il[759])
    , kernel_side_effect_counter_shift(il[760])
    , kernel_sload_write_offset_shift(il[761])
    , kernel_sstore_write_offset_shift(il[762])
    , main_da_gas_remaining_shift(il[763])
    , main_internal_return_ptr_shift(il[764])
    , main_l2_gas_remaining_shift(il[765])
    , main_pc_shift(il[766])
    , mem_glob_addr_shift(il[767])
    , mem_rw_shift(il[768])
    , mem_sel_mem_shift(il[769])
    , mem_tag_shift(il[770])
    , mem_tsp_shift(il[771])
    , mem_val_shift(il[772])
    , slice_addr_shift(il[773])
    , slice_clk_shift(il[774])
    , slice_cnt_shift(il[775])
    , slice_col_offset_shift(il[776])
    , slice_sel_cd_cpy_shift(il[777])
    , slice_sel_mem_active_shift(il[778])
    , slice_sel_return_shift(il[779])
    , slice_sel_start_shift(il[780])
    , slice_space_id_shift(il[781])
{}
