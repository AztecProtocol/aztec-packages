...
#include "barretenberg/relations/generated/avm/avm_cmp.hpp"
...
class AvmCircuitBuilder {
  public:
    ...
    static constexpr size_t num_fixed_columns = 188;
    static constexpr size_t num_polys = 169;
    std::vector<Row> rows;
    ...
    ProverPolynomials compute_polynomials()
    {
        ...
        for (size_t i = 0; i < rows.size(); i++) {
            ...
            polys.avm_cmp_cmp_clk[i] = rows[i].avm_cmp_cmp_clk;
            polys.avm_cmp_ia[i] = rows[i].avm_cmp_ia;
            polys.avm_cmp_ib[i] = rows[i].avm_cmp_ib;
            polys.avm_cmp_ic[i] = rows[i].avm_cmp_ic;
            polys.avm_cmp_lt_sel[i] = rows[i].avm_cmp_lt_sel;
            polys.avm_cmp_lte_sel[i] = rows[i].avm_cmp_lte_sel;
            polys.avm_cmp_cmp_sel[i] = rows[i].avm_cmp_cmp_sel;
            polys.avm_cmp_input_ia[i] = rows[i].avm_cmp_input_ia;
            polys.avm_cmp_input_ib[i] = rows[i].avm_cmp_input_ib;
            polys.avm_cmp_a_lo[i] = rows[i].avm_cmp_a_lo;
            polys.avm_cmp_a_hi[i] = rows[i].avm_cmp_a_hi;
            polys.avm_cmp_b_lo[i] = rows[i].avm_cmp_b_lo;
            polys.avm_cmp_b_hi[i] = rows[i].avm_cmp_b_hi;
            polys.avm_cmp_borrow[i] = rows[i].avm_cmp_borrow;
            polys.avm_cmp_p_lo[i] = rows[i].avm_cmp_p_lo;
            polys.avm_cmp_p_hi[i] = rows[i].avm_cmp_p_hi;
            polys.avm_cmp_p_sub_a_lo[i] = rows[i].avm_cmp_p_sub_a_lo;
            polys.avm_cmp_p_sub_a_hi[i] = rows[i].avm_cmp_p_sub_a_hi;
            polys.avm_cmp_p_a_borrow[i] = rows[i].avm_cmp_p_a_borrow;
            polys.avm_cmp_p_sub_b_lo[i] = rows[i].avm_cmp_p_sub_b_lo;
            polys.avm_cmp_p_sub_b_hi[i] = rows[i].avm_cmp_p_sub_b_hi;
            polys.avm_cmp_p_b_borrow[i] = rows[i].avm_cmp_p_b_borrow;
            polys.avm_cmp_res_lo[i] = rows[i].avm_cmp_res_lo;
            polys.avm_cmp_res_hi[i] = rows[i].avm_cmp_res_hi;
            polys.avm_cmp_lt_query[i] = rows[i].avm_cmp_lt_query;
            ...
            polys.avm_main_cmp_sel[i] = rows[i].avm_main_cmp_sel;
...
=======
            ...
            polys.perm_main_cmp[i] = rows[i].perm_main_cmp;
...
>>>>>>> 7a982d52c (feat: init avm cmp)
    ...
    [[maybe_unused]] bool check_circuit()
    {
        ...
        if (!evaluate_relation.template operator()<Avm_vm::avm_cmp<FF>>("avm_cmp",
                                                                        Avm_vm::get_relation_label_avm_cmp)) {
            return false;
        }
        ...
        if (!evaluate_logderivative.template operator()<perm_main_cmp_relation<FF>>("PERM_MAIN_CMP")) {
            return false;
        }
