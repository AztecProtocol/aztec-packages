...
template <typename FF> struct AvmFullRow {
    ...
    FF poseidon2_input_addr_1{};
    FF poseidon2_input_addr_2{};
    FF poseidon2_input_addr_3{};
    ...
    FF poseidon2_output_addr_1{};
    FF poseidon2_output_addr_2{};
    FF poseidon2_output_addr_3{};
...
class AvmCircuitBuilder {
  public:
    ...
    static constexpr size_t num_fixed_columns = 748;
    static constexpr size_t num_polys = 678;
    std::vector<Row> rows;
    ...
    ProverPolynomials compute_polynomials()
    {
        ...
        for (size_t i = 0; i < rows.size(); i++) {
            ...
            polys.mem_sel_op_gadget_a[i] = rows[i].mem_sel_op_gadget_a;
            polys.mem_sel_op_gadget_b[i] = rows[i].mem_sel_op_gadget_b;
            polys.mem_sel_op_gadget_c[i] = rows[i].mem_sel_op_gadget_c;
            polys.mem_sel_op_gadget_d[i] = rows[i].mem_sel_op_gadget_d;
            ...
            polys.poseidon2_input_addr_1[i] = rows[i].poseidon2_input_addr_1;
            polys.poseidon2_input_addr_2[i] = rows[i].poseidon2_input_addr_2;
            polys.poseidon2_input_addr_3[i] = rows[i].poseidon2_input_addr_3;
            polys.poseidon2_mem_addr_a[i] = rows[i].poseidon2_mem_addr_a;
            polys.poseidon2_mem_addr_b[i] = rows[i].poseidon2_mem_addr_b;
            polys.poseidon2_mem_addr_c[i] = rows[i].poseidon2_mem_addr_c;
            polys.poseidon2_mem_addr_d[i] = rows[i].poseidon2_mem_addr_d;
            polys.poseidon2_mem_op[i] = rows[i].poseidon2_mem_op;
            polys.poseidon2_output_addr[i] = rows[i].poseidon2_output_addr;
            polys.poseidon2_output_addr_1[i] = rows[i].poseidon2_output_addr_1;
            polys.poseidon2_output_addr_2[i] = rows[i].poseidon2_output_addr_2;
            polys.poseidon2_output_addr_3[i] = rows[i].poseidon2_output_addr_3;
            polys.poseidon2_r_in_tag[i] = rows[i].poseidon2_r_in_tag;
            polys.poseidon2_read_line[i] = rows[i].poseidon2_read_line;
            polys.poseidon2_sel_poseidon_perm[i] = rows[i].poseidon2_sel_poseidon_perm;
            polys.poseidon2_w_in_tag[i] = rows[i].poseidon2_w_in_tag;
            polys.poseidon2_write_line[i] = rows[i].poseidon2_write_line;
        ...
        polys.poseidon2_a_0_shift = Polynomial(polys.poseidon2_a_0.shifted());
        polys.poseidon2_a_1_shift = Polynomial(polys.poseidon2_a_1.shifted());
        polys.poseidon2_a_2_shift = Polynomial(polys.poseidon2_a_2.shifted());
        polys.poseidon2_a_3_shift = Polynomial(polys.poseidon2_a_3.shifted());
        polys.poseidon2_write_line_shift = Polynomial(polys.poseidon2_write_line.shifted());
    ...
    [[maybe_unused]] bool check_circuit()
    {
        ...
        auto perm_pos_mem_a = [=]() {
            return evaluate_logderivative.template operator()<perm_pos_mem_a_relation<FF>>("PERM_POS_MEM_A");
        };

        auto perm_pos_mem_b = [=]() {
            return evaluate_logderivative.template operator()<perm_pos_mem_b_relation<FF>>("PERM_POS_MEM_B");
        };

        auto perm_pos_mem_c = [=]() {
            return evaluate_logderivative.template operator()<perm_pos_mem_c_relation<FF>>("PERM_POS_MEM_C");
        };

        auto perm_pos_mem_d = [=]() {
            return evaluate_logderivative.template operator()<perm_pos_mem_d_relation<FF>>("PERM_POS_MEM_D");
        };
        ...
        relation_futures.emplace_back(std::async(std::launch::async, perm_pos_mem_a));

        relation_futures.emplace_back(std::async(std::launch::async, perm_pos_mem_b));

        relation_futures.emplace_back(std::async(std::launch::async, perm_pos_mem_c));

        relation_futures.emplace_back(std::async(std::launch::async, perm_pos_mem_d));
