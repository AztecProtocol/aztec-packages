  ...
  public:
    ...
    class AllConstRefValues {
      public:
        ...
        AllConstRefValues(DataType main_clk,
                          DataType main_sel_first,
                          DataType kernel_kernel_inputs,
                          DataType kernel_kernel_value_out,
                          DataType kernel_kernel_side_effect_out,
                          DataType kernel_kernel_metadata_out,
                          DataType main_calldata,
                          DataType alu_a_hi,
                          DataType alu_a_lo,
                          DataType alu_b_hi,
                          DataType alu_b_lo,
                          ...
                          DataType alu_cf,
                          DataType alu_clk,
                          DataType alu_cmp_rng_ctr,
                          DataType alu_div_u16_r0,
                          DataType alu_div_u16_r1,
                          DataType alu_div_u16_r2,
                          DataType alu_div_u16_r3,
                          DataType alu_div_u16_r4,
                          DataType alu_div_u16_r5,
                          DataType alu_div_u16_r6,
                          DataType alu_div_u16_r7,
                          DataType alu_divisor_hi,
                          DataType alu_divisor_lo,
                          DataType alu_ff_tag,
                          DataType alu_ia,
                          DataType alu_ib,
                          DataType alu_ic,
                          DataType alu_in_tag,
                          DataType alu_op_add,
                          DataType alu_op_cast,
                          DataType alu_op_cast_prev,
                          DataType alu_op_div,
                          DataType alu_op_div_a_lt_b,
                          DataType alu_op_div_std,
                          DataType alu_op_eq,
                          DataType alu_op_eq_diff_inv,
                          DataType alu_op_lt,
                          DataType alu_op_lte,
                          DataType alu_op_mul,
                          DataType alu_op_not,
                          ...
                          DataType alu_op_shr,
                          DataType alu_op_sub,
                          DataType alu_p_a_borrow,
                          DataType alu_p_b_borrow,
                          DataType alu_p_sub_a_hi,
                          DataType alu_p_sub_a_lo,
                          DataType alu_p_sub_b_hi,
                          DataType alu_p_sub_b_lo,
                          DataType alu_partial_prod_hi,
                          DataType alu_partial_prod_lo,
                          DataType alu_quotient_hi,
                          DataType alu_quotient_lo,
                          DataType alu_remainder,
                          DataType alu_res_hi,
                          DataType alu_res_lo,
                          DataType alu_sel_alu,
                          DataType alu_sel_cmp,
                          DataType alu_sel_div_rng_chk,
                          DataType alu_sel_rng_chk,
                          DataType alu_sel_rng_chk_lookup,
                          DataType alu_sel_shift_which,
                          DataType alu_shift_lt_bit_len,
                          DataType alu_t_sub_s_bits,
                          DataType alu_two_pow_s,
                          DataType alu_two_pow_t_sub_s,
                          DataType alu_u128_tag,
                          DataType alu_u16_r0,
                          DataType alu_u16_r1,
                          DataType alu_u16_r10,
                          DataType alu_u16_r11,
                          DataType alu_u16_r12,
                          DataType alu_u16_r13,
                          DataType alu_u16_r14,
                          DataType alu_u16_r2,
                          DataType alu_u16_r3,
                          DataType alu_u16_r4,
                          DataType alu_u16_r5,
                          ...
                          DataType alu_u16_r8,
                          DataType alu_u16_r9,
                          DataType alu_u16_tag,
                          DataType alu_u32_tag,
                          DataType alu_u64_tag,
                          DataType alu_u8_r0,
                          DataType alu_u8_r1,
                          DataType alu_u8_tag,
                          DataType binary_acc_ia,
                          DataType binary_acc_ib,
                          DataType binary_acc_ic,
                          DataType binary_clk,
                          DataType binary_ia_bytes,
                          DataType binary_ib_bytes,
                          DataType binary_ic_bytes,
                          DataType binary_in_tag,
                          DataType binary_mem_tag_ctr,
                          DataType binary_mem_tag_ctr_inv,
                          DataType binary_op_id,
                          DataType binary_sel_bin,
                          DataType binary_start,
                          DataType byte_lookup_sel_bin,
                          DataType byte_lookup_table_byte_lengths,
                          DataType byte_lookup_table_in_tags,
                          DataType byte_lookup_table_input_a,
                          DataType byte_lookup_table_input_b,
                          DataType byte_lookup_table_op_id,
                          DataType byte_lookup_table_output,
                          DataType conversion_clk,
                          DataType conversion_input,
                          DataType conversion_num_limbs,
                          DataType conversion_radix,
                          DataType conversion_sel_to_radix_le,
                          DataType gas_da_gas_fixed_table,
                          DataType gas_l2_gas_fixed_table,
                          DataType gas_sel_gas_cost,
                          DataType keccakf1600_clk,
                          DataType keccakf1600_input,
                          DataType keccakf1600_output,
                          DataType keccakf1600_sel_keccakf1600,
                          DataType kernel_emit_l2_to_l1_msg_write_offset,
                          DataType kernel_emit_note_hash_write_offset,
                          DataType kernel_emit_nullifier_write_offset,
                          DataType kernel_emit_unencrypted_log_write_offset,
                          DataType kernel_kernel_in_offset,
                          DataType kernel_kernel_out_offset,
                          DataType kernel_l1_to_l2_msg_exists_write_offset,
                          DataType kernel_note_hash_exist_write_offset,
                          DataType kernel_nullifier_exists_write_offset,
                          DataType kernel_nullifier_non_exists_write_offset,
                          DataType kernel_q_public_input_kernel_add_to_table,
                          DataType kernel_q_public_input_kernel_out_add_to_table,
                          DataType kernel_side_effect_counter,
                          DataType kernel_sload_write_offset,
                          DataType kernel_sstore_write_offset,
                          DataType main_abs_da_rem_gas_hi,
                          DataType main_abs_da_rem_gas_lo,
                          DataType main_abs_l2_rem_gas_hi,
                          DataType main_abs_l2_rem_gas_lo,
                          DataType main_alu_in_tag,
                          DataType main_bin_op_id,
                          DataType main_call_ptr,
                          DataType main_da_gas_op_cost,
                          DataType main_da_gas_remaining,
                          DataType main_da_out_of_gas,
                          DataType main_ia,
                          DataType main_ib,
                          DataType main_ic,
                          DataType main_id,
                          DataType main_id_zero,
                          DataType main_ind_addr_a,
                          DataType main_ind_addr_b,
                          DataType main_ind_addr_c,
                          DataType main_ind_addr_d,
                          DataType main_internal_return_ptr,
                          DataType main_inv,
                          DataType main_l2_gas_op_cost,
                          DataType main_l2_gas_remaining,
                          DataType main_l2_out_of_gas,
                          DataType main_mem_addr_a,
                          DataType main_mem_addr_b,
                          DataType main_mem_addr_c,
                          DataType main_mem_addr_d,
                          DataType main_op_err,
                          DataType main_opcode_val,
                          DataType main_pc,
                          DataType main_r_in_tag,
                          DataType main_rwa,
                          DataType main_rwb,
                          DataType main_rwc,
                          DataType main_rwd,
                          DataType main_sel_alu,
                          DataType main_sel_bin,
                          DataType main_sel_gas_accounting_active,
                          DataType main_sel_last,
                          DataType main_sel_mem_op_a,
                          DataType main_sel_mem_op_activate_gas,
                          DataType main_sel_mem_op_b,
                          DataType main_sel_mem_op_c,
                          DataType main_sel_mem_op_d,
                          DataType main_sel_mov_ia_to_ic,
                          DataType main_sel_mov_ib_to_ic,
                          DataType main_sel_op_add,
                          DataType main_sel_op_address,
                          DataType main_sel_op_and,
                          DataType main_sel_op_block_number,
                          DataType main_sel_op_cast,
                          DataType main_sel_op_chain_id,
                          DataType main_sel_op_cmov,
                          DataType main_sel_op_coinbase,
                          DataType main_sel_op_dagasleft,
                          DataType main_sel_op_div,
                          DataType main_sel_op_emit_l2_to_l1_msg,
                          DataType main_sel_op_emit_note_hash,
                          DataType main_sel_op_emit_nullifier,
                          DataType main_sel_op_emit_unencrypted_log,
                          DataType main_sel_op_eq,
                          DataType main_sel_op_external_call,
                          DataType main_sel_op_fdiv,
                          DataType main_sel_op_fee_per_da_gas,
                          DataType main_sel_op_fee_per_l2_gas,
                          DataType main_sel_op_function_selector,
                          DataType main_sel_op_get_contract_instance,
                          DataType main_sel_op_halt,
                          DataType main_sel_op_internal_call,
                          DataType main_sel_op_internal_return,
                          DataType main_sel_op_jump,
                          DataType main_sel_op_jumpi,
                          DataType main_sel_op_keccak,
                          DataType main_sel_op_l1_to_l2_msg_exists,
                          DataType main_sel_op_l2gasleft,
                          DataType main_sel_op_lt,
                          DataType main_sel_op_lte,
                          DataType main_sel_op_mov,
                          DataType main_sel_op_mul,
                          DataType main_sel_op_not,
                          DataType main_sel_op_note_hash_exists,
                          DataType main_sel_op_nullifier_exists,
                          DataType main_sel_op_or,
                          DataType main_sel_op_pedersen,
                          DataType main_sel_op_poseidon2,
                          DataType main_sel_op_radix_le,
                          DataType main_sel_op_sender,
                          DataType main_sel_op_sha256,
                          DataType main_sel_op_shl,
                          DataType main_sel_op_shr,
                          DataType main_sel_op_sload,
                          DataType main_sel_op_sstore,
                          DataType main_sel_op_storage_address,
                          DataType main_sel_op_sub,
                          DataType main_sel_op_timestamp,
                          DataType main_sel_op_transaction_fee,
                          DataType main_sel_op_version,
                          DataType main_sel_op_xor,
                          DataType main_sel_q_kernel_lookup,
                          DataType main_sel_q_kernel_output_lookup,
                          DataType main_sel_resolve_ind_addr_a,
                          DataType main_sel_resolve_ind_addr_b,
                          DataType main_sel_resolve_ind_addr_c,
                          DataType main_sel_resolve_ind_addr_d,
                          DataType main_sel_rng_16,
                          DataType main_sel_rng_8,
                          DataType main_space_id,
                          DataType main_tag_err,
                          DataType main_w_in_tag,
                          DataType mem_addr,
                          DataType mem_clk,
                          DataType mem_diff_hi,
                          DataType mem_diff_lo,
                          DataType mem_diff_mid,
                          DataType mem_glob_addr,
                          DataType mem_last,
                          DataType mem_lastAccess,
                          DataType mem_one_min_inv,
                          DataType mem_r_in_tag,
                          DataType mem_rw,
                          DataType mem_sel_mem,
                          DataType mem_sel_mov_ia_to_ic,
                          DataType mem_sel_mov_ib_to_ic,
                          DataType mem_sel_op_a,
                          DataType mem_sel_op_b,
                          DataType mem_sel_op_c,
                          DataType mem_sel_op_cmov,
                          DataType mem_sel_op_d,
                          DataType mem_sel_resolve_ind_addr_a,
                          DataType mem_sel_resolve_ind_addr_b,
                          DataType mem_sel_resolve_ind_addr_c,
                          DataType mem_sel_resolve_ind_addr_d,
                          DataType mem_sel_rng_chk,
                          DataType mem_skip_check_tag,
                          DataType mem_space_id,
                          DataType mem_tag,
                          DataType mem_tag_err,
                          DataType mem_tsp,
                          DataType mem_val,
                          DataType mem_w_in_tag,
                          DataType pedersen_clk,
                          DataType pedersen_input,
                          DataType pedersen_output,
                          DataType pedersen_sel_pedersen,
                          DataType poseidon2_clk,
                          DataType poseidon2_input,
                          DataType poseidon2_output,
                          DataType poseidon2_sel_poseidon_perm,
                          DataType powers_power_of_2,
                          DataType sha256_clk,
                          DataType sha256_input,
                          DataType sha256_output,
                          DataType sha256_sel_sha256_compression,
                          DataType sha256_state,
                          DataType perm_main_alu,
                          DataType perm_main_bin,
                          DataType perm_main_conv,
                          DataType perm_main_pos2_perm,
                          DataType perm_main_pedersen,
                          DataType perm_main_mem_a,
                          DataType perm_main_mem_b,
                          DataType perm_main_mem_c,
                          DataType perm_main_mem_d,
                          DataType perm_main_mem_ind_addr_a,
                          DataType perm_main_mem_ind_addr_b,
                          DataType perm_main_mem_ind_addr_c,
                          DataType perm_main_mem_ind_addr_d,
                          DataType lookup_byte_lengths,
                          DataType lookup_byte_operations,
                          DataType lookup_opcode_gas,
                          DataType range_check_l2_gas_hi,
                          DataType range_check_l2_gas_lo,
                          DataType range_check_da_gas_hi,
                          DataType range_check_da_gas_lo,
                          DataType kernel_output_lookup,
                          DataType lookup_into_kernel,
                          DataType incl_main_tag_err,
                          DataType incl_mem_tag_err,
                          DataType lookup_mem_rng_chk_lo,
                          DataType lookup_mem_rng_chk_mid,
                          DataType lookup_mem_rng_chk_hi,
                          DataType lookup_pow_2_0,
                          DataType lookup_pow_2_1,
                          DataType lookup_u8_0,
                          DataType lookup_u8_1,
                          DataType lookup_u16_0,
                          DataType lookup_u16_1,
                          DataType lookup_u16_2,
                          DataType lookup_u16_3,
                          DataType lookup_u16_4,
                          DataType lookup_u16_5,
                          DataType lookup_u16_6,
                          DataType lookup_u16_7,
                          DataType lookup_u16_8,
                          DataType lookup_u16_9,
                          DataType lookup_u16_10,
                          DataType lookup_u16_11,
                          DataType lookup_u16_12,
                          DataType lookup_u16_13,
                          DataType lookup_u16_14,
                          DataType lookup_div_u16_0,
                          DataType lookup_div_u16_1,
                          DataType lookup_div_u16_2,
                          DataType lookup_div_u16_3,
                          DataType lookup_div_u16_4,
                          DataType lookup_div_u16_5,
                          DataType lookup_div_u16_6,
                          DataType lookup_div_u16_7,
                          DataType lookup_byte_lengths_counts,
                          DataType lookup_byte_operations_counts,
                          DataType lookup_opcode_gas_counts,
                          DataType range_check_l2_gas_hi_counts,
                          DataType range_check_l2_gas_lo_counts,
                          DataType range_check_da_gas_hi_counts,
                          DataType range_check_da_gas_lo_counts,
                          DataType kernel_output_lookup_counts,
                          DataType lookup_into_kernel_counts,
                          DataType incl_main_tag_err_counts,
                          DataType incl_mem_tag_err_counts,
                          DataType lookup_mem_rng_chk_lo_counts,
                          DataType lookup_mem_rng_chk_mid_counts,
                          DataType lookup_mem_rng_chk_hi_counts,
                          DataType lookup_pow_2_0_counts,
                          DataType lookup_pow_2_1_counts,
                          DataType lookup_u8_0_counts,
                          DataType lookup_u8_1_counts,
                          DataType lookup_u16_0_counts,
                          DataType lookup_u16_1_counts,
                          DataType lookup_u16_2_counts,
                          DataType lookup_u16_3_counts,
                          DataType lookup_u16_4_counts,
                          DataType lookup_u16_5_counts,
                          DataType lookup_u16_6_counts,
                          DataType lookup_u16_7_counts,
                          DataType lookup_u16_8_counts,
                          DataType lookup_u16_9_counts,
                          DataType lookup_u16_10_counts,
                          DataType lookup_u16_11_counts,
                          DataType lookup_u16_12_counts,
                          DataType lookup_u16_13_counts,
                          DataType lookup_u16_14_counts,
                          DataType lookup_div_u16_0_counts,
                          DataType lookup_div_u16_1_counts,
                          DataType lookup_div_u16_2_counts,
                          DataType lookup_div_u16_3_counts,
                          DataType lookup_div_u16_4_counts,
                          DataType lookup_div_u16_5_counts,
                          DataType lookup_div_u16_6_counts,
                          DataType lookup_div_u16_7_counts,
                          DataType alu_a_hi_shift,
                          DataType alu_a_lo_shift,
                          DataType alu_b_hi_shift,
                          DataType alu_b_lo_shift,
                          DataType alu_cmp_rng_ctr_shift,
                          DataType alu_div_u16_r0_shift,
                          DataType alu_div_u16_r1_shift,
                          DataType alu_div_u16_r2_shift,
                          DataType alu_div_u16_r3_shift,
                          DataType alu_div_u16_r4_shift,
                          DataType alu_div_u16_r5_shift,
                          DataType alu_div_u16_r6_shift,
                          DataType alu_div_u16_r7_shift,
                          DataType alu_op_add_shift,
                          DataType alu_op_cast_prev_shift,
                          DataType alu_op_cast_shift,
                          DataType alu_op_div_shift,
                          DataType alu_op_mul_shift,
                          DataType alu_op_shl_shift,
                          DataType alu_op_shr_shift,
                          DataType alu_op_sub_shift,
                          DataType alu_p_sub_a_hi_shift,
                          DataType alu_p_sub_a_lo_shift,
                          DataType alu_p_sub_b_hi_shift,
                          DataType alu_p_sub_b_lo_shift,
                          DataType alu_sel_alu_shift,
                          DataType alu_sel_cmp_shift,
                          DataType alu_sel_div_rng_chk_shift,
                          DataType alu_sel_rng_chk_lookup_shift,
                          DataType alu_sel_rng_chk_shift,
                          DataType alu_u16_r0_shift,
                          DataType alu_u16_r1_shift,
                          DataType alu_u16_r2_shift,
                          DataType alu_u16_r3_shift,
                          DataType alu_u16_r4_shift,
                          DataType alu_u16_r5_shift,
                          DataType alu_u16_r6_shift,
                          DataType alu_u8_r0_shift,
                          DataType alu_u8_r1_shift,
                          DataType binary_acc_ia_shift,
                          DataType binary_acc_ib_shift,
                          DataType binary_acc_ic_shift,
                          DataType binary_mem_tag_ctr_shift,
                          DataType binary_op_id_shift,
                          DataType kernel_emit_l2_to_l1_msg_write_offset_shift,
                          DataType kernel_emit_note_hash_write_offset_shift,
                          DataType kernel_emit_nullifier_write_offset_shift,
                          DataType kernel_emit_unencrypted_log_write_offset_shift,
                          DataType kernel_l1_to_l2_msg_exists_write_offset_shift,
                          DataType kernel_note_hash_exist_write_offset_shift,
                          DataType kernel_nullifier_exists_write_offset_shift,
                          DataType kernel_nullifier_non_exists_write_offset_shift,
                          DataType kernel_side_effect_counter_shift,
                          DataType kernel_sload_write_offset_shift,
                          DataType kernel_sstore_write_offset_shift,
                          DataType main_da_gas_remaining_shift,
                          DataType main_internal_return_ptr_shift,
                          DataType main_l2_gas_remaining_shift,
                          DataType main_pc_shift,
                          DataType mem_glob_addr_shift,
                          DataType mem_rw_shift,
                          DataType mem_sel_mem_shift,
                          DataType mem_tag_shift,
                          DataType mem_tsp_shift,
                          DataType mem_val_shift)
            : main_clk(main_clk)
            , main_sel_first(main_sel_first)
            , kernel_kernel_inputs(kernel_kernel_inputs)
            , kernel_kernel_value_out(kernel_kernel_value_out)
            , kernel_kernel_side_effect_out(kernel_kernel_side_effect_out)
            , kernel_kernel_metadata_out(kernel_kernel_metadata_out)
            , main_calldata(main_calldata)
            , alu_a_hi(alu_a_hi)
            , alu_a_lo(alu_a_lo)
            , alu_b_hi(alu_b_hi)
            , alu_b_lo(alu_b_lo)
            ...
            , alu_cf(alu_cf)
            , alu_clk(alu_clk)
            , alu_cmp_rng_ctr(alu_cmp_rng_ctr)
            , alu_div_u16_r0(alu_div_u16_r0)
            , alu_div_u16_r1(alu_div_u16_r1)
            , alu_div_u16_r2(alu_div_u16_r2)
            , alu_div_u16_r3(alu_div_u16_r3)
            , alu_div_u16_r4(alu_div_u16_r4)
            , alu_div_u16_r5(alu_div_u16_r5)
            , alu_div_u16_r6(alu_div_u16_r6)
            , alu_div_u16_r7(alu_div_u16_r7)
            , alu_divisor_hi(alu_divisor_hi)
            , alu_divisor_lo(alu_divisor_lo)
            , alu_ff_tag(alu_ff_tag)
            , alu_ia(alu_ia)
            , alu_ib(alu_ib)
            , alu_ic(alu_ic)
            , alu_in_tag(alu_in_tag)
            , alu_op_add(alu_op_add)
            , alu_op_cast(alu_op_cast)
            , alu_op_cast_prev(alu_op_cast_prev)
            , alu_op_div(alu_op_div)
            , alu_op_div_a_lt_b(alu_op_div_a_lt_b)
            , alu_op_div_std(alu_op_div_std)
            , alu_op_eq(alu_op_eq)
            , alu_op_eq_diff_inv(alu_op_eq_diff_inv)
            , alu_op_lt(alu_op_lt)
            , alu_op_lte(alu_op_lte)
            , alu_op_mul(alu_op_mul)
            , alu_op_not(alu_op_not)
            , alu_op_shl(alu_op_shl)
            , alu_op_shr(alu_op_shr)
            , alu_op_sub(alu_op_sub)
            , alu_p_a_borrow(alu_p_a_borrow)
            , alu_p_b_borrow(alu_p_b_borrow)
            , alu_p_sub_a_hi(alu_p_sub_a_hi)
            , alu_p_sub_a_lo(alu_p_sub_a_lo)
            , alu_p_sub_b_hi(alu_p_sub_b_hi)
            , alu_p_sub_b_lo(alu_p_sub_b_lo)
            , alu_partial_prod_hi(alu_partial_prod_hi)
            , alu_partial_prod_lo(alu_partial_prod_lo)
            , alu_quotient_hi(alu_quotient_hi)
            , alu_quotient_lo(alu_quotient_lo)
            , alu_remainder(alu_remainder)
            , alu_res_hi(alu_res_hi)
            , alu_res_lo(alu_res_lo)
            , alu_sel_alu(alu_sel_alu)
            , alu_sel_cmp(alu_sel_cmp)
            , alu_sel_div_rng_chk(alu_sel_div_rng_chk)
            , alu_sel_rng_chk(alu_sel_rng_chk)
            , alu_sel_rng_chk_lookup(alu_sel_rng_chk_lookup)
            , alu_sel_shift_which(alu_sel_shift_which)
            , alu_shift_lt_bit_len(alu_shift_lt_bit_len)
            , alu_t_sub_s_bits(alu_t_sub_s_bits)
            , alu_two_pow_s(alu_two_pow_s)
            , alu_two_pow_t_sub_s(alu_two_pow_t_sub_s)
            , alu_u128_tag(alu_u128_tag)
            , alu_u16_r0(alu_u16_r0)
            , alu_u16_r1(alu_u16_r1)
            , alu_u16_r10(alu_u16_r10)
            , alu_u16_r11(alu_u16_r11)
            , alu_u16_r12(alu_u16_r12)
            , alu_u16_r13(alu_u16_r13)
            , alu_u16_r14(alu_u16_r14)
            , alu_u16_r2(alu_u16_r2)
            , alu_u16_r3(alu_u16_r3)
            , alu_u16_r4(alu_u16_r4)
            , alu_u16_r5(alu_u16_r5)
            , alu_u16_r6(alu_u16_r6)
            , alu_u16_r7(alu_u16_r7)
            , alu_u16_r8(alu_u16_r8)
            , alu_u16_r9(alu_u16_r9)
            , alu_u16_tag(alu_u16_tag)
            , alu_u32_tag(alu_u32_tag)
            , alu_u64_tag(alu_u64_tag)
            , alu_u8_r0(alu_u8_r0)
            , alu_u8_r1(alu_u8_r1)
            , alu_u8_tag(alu_u8_tag)
            , binary_acc_ia(binary_acc_ia)
            , binary_acc_ib(binary_acc_ib)
            , binary_acc_ic(binary_acc_ic)
            , binary_clk(binary_clk)
            , binary_ia_bytes(binary_ia_bytes)
            , binary_ib_bytes(binary_ib_bytes)
            , binary_ic_bytes(binary_ic_bytes)
            , binary_in_tag(binary_in_tag)
            , binary_mem_tag_ctr(binary_mem_tag_ctr)
            , binary_mem_tag_ctr_inv(binary_mem_tag_ctr_inv)
            , binary_op_id(binary_op_id)
            , binary_sel_bin(binary_sel_bin)
            , binary_start(binary_start)
            , byte_lookup_sel_bin(byte_lookup_sel_bin)
            , byte_lookup_table_byte_lengths(byte_lookup_table_byte_lengths)
            , byte_lookup_table_in_tags(byte_lookup_table_in_tags)
            , byte_lookup_table_input_a(byte_lookup_table_input_a)
            , byte_lookup_table_input_b(byte_lookup_table_input_b)
            , byte_lookup_table_op_id(byte_lookup_table_op_id)
            , byte_lookup_table_output(byte_lookup_table_output)
            , conversion_clk(conversion_clk)
            , conversion_input(conversion_input)
            , conversion_num_limbs(conversion_num_limbs)
            , conversion_radix(conversion_radix)
            , conversion_sel_to_radix_le(conversion_sel_to_radix_le)
            , gas_da_gas_fixed_table(gas_da_gas_fixed_table)
            , gas_l2_gas_fixed_table(gas_l2_gas_fixed_table)
            , gas_sel_gas_cost(gas_sel_gas_cost)
            , keccakf1600_clk(keccakf1600_clk)
            , keccakf1600_input(keccakf1600_input)
            , keccakf1600_output(keccakf1600_output)
            , keccakf1600_sel_keccakf1600(keccakf1600_sel_keccakf1600)
            , kernel_emit_l2_to_l1_msg_write_offset(kernel_emit_l2_to_l1_msg_write_offset)
            , kernel_emit_note_hash_write_offset(kernel_emit_note_hash_write_offset)
            , kernel_emit_nullifier_write_offset(kernel_emit_nullifier_write_offset)
            , kernel_emit_unencrypted_log_write_offset(kernel_emit_unencrypted_log_write_offset)
            , kernel_kernel_in_offset(kernel_kernel_in_offset)
            , kernel_kernel_out_offset(kernel_kernel_out_offset)
            , kernel_l1_to_l2_msg_exists_write_offset(kernel_l1_to_l2_msg_exists_write_offset)
            , kernel_note_hash_exist_write_offset(kernel_note_hash_exist_write_offset)
            , kernel_nullifier_exists_write_offset(kernel_nullifier_exists_write_offset)
            , kernel_nullifier_non_exists_write_offset(kernel_nullifier_non_exists_write_offset)
            , kernel_q_public_input_kernel_add_to_table(kernel_q_public_input_kernel_add_to_table)
            , kernel_q_public_input_kernel_out_add_to_table(kernel_q_public_input_kernel_out_add_to_table)
            , kernel_side_effect_counter(kernel_side_effect_counter)
            , kernel_sload_write_offset(kernel_sload_write_offset)
            , kernel_sstore_write_offset(kernel_sstore_write_offset)
            , main_abs_da_rem_gas_hi(main_abs_da_rem_gas_hi)
            , main_abs_da_rem_gas_lo(main_abs_da_rem_gas_lo)
            , main_abs_l2_rem_gas_hi(main_abs_l2_rem_gas_hi)
            , main_abs_l2_rem_gas_lo(main_abs_l2_rem_gas_lo)
            , main_alu_in_tag(main_alu_in_tag)
            , main_bin_op_id(main_bin_op_id)
            , main_call_ptr(main_call_ptr)
            , main_da_gas_op_cost(main_da_gas_op_cost)
            , main_da_gas_remaining(main_da_gas_remaining)
            , main_da_out_of_gas(main_da_out_of_gas)
            , main_ia(main_ia)
            , main_ib(main_ib)
            , main_ic(main_ic)
            , main_id(main_id)
            , main_id_zero(main_id_zero)
            , main_ind_addr_a(main_ind_addr_a)
            , main_ind_addr_b(main_ind_addr_b)
            , main_ind_addr_c(main_ind_addr_c)
            , main_ind_addr_d(main_ind_addr_d)
            , main_internal_return_ptr(main_internal_return_ptr)
            , main_inv(main_inv)
            , main_l2_gas_op_cost(main_l2_gas_op_cost)
            , main_l2_gas_remaining(main_l2_gas_remaining)
            , main_l2_out_of_gas(main_l2_out_of_gas)
            , main_mem_addr_a(main_mem_addr_a)
            , main_mem_addr_b(main_mem_addr_b)
            , main_mem_addr_c(main_mem_addr_c)
            , main_mem_addr_d(main_mem_addr_d)
            , main_op_err(main_op_err)
            , main_opcode_val(main_opcode_val)
            , main_pc(main_pc)
            , main_r_in_tag(main_r_in_tag)
            , main_rwa(main_rwa)
            , main_rwb(main_rwb)
            , main_rwc(main_rwc)
            , main_rwd(main_rwd)
            , main_sel_alu(main_sel_alu)
            , main_sel_bin(main_sel_bin)
            , main_sel_gas_accounting_active(main_sel_gas_accounting_active)
            , main_sel_last(main_sel_last)
            , main_sel_mem_op_a(main_sel_mem_op_a)
            , main_sel_mem_op_activate_gas(main_sel_mem_op_activate_gas)
            , main_sel_mem_op_b(main_sel_mem_op_b)
            , main_sel_mem_op_c(main_sel_mem_op_c)
            , main_sel_mem_op_d(main_sel_mem_op_d)
            , main_sel_mov_ia_to_ic(main_sel_mov_ia_to_ic)
            , main_sel_mov_ib_to_ic(main_sel_mov_ib_to_ic)
            , main_sel_op_add(main_sel_op_add)
            , main_sel_op_address(main_sel_op_address)
            , main_sel_op_and(main_sel_op_and)
            , main_sel_op_block_number(main_sel_op_block_number)
            , main_sel_op_cast(main_sel_op_cast)
            , main_sel_op_chain_id(main_sel_op_chain_id)
            , main_sel_op_cmov(main_sel_op_cmov)
            , main_sel_op_coinbase(main_sel_op_coinbase)
            , main_sel_op_dagasleft(main_sel_op_dagasleft)
            , main_sel_op_div(main_sel_op_div)
            , main_sel_op_emit_l2_to_l1_msg(main_sel_op_emit_l2_to_l1_msg)
            , main_sel_op_emit_note_hash(main_sel_op_emit_note_hash)
            , main_sel_op_emit_nullifier(main_sel_op_emit_nullifier)
            , main_sel_op_emit_unencrypted_log(main_sel_op_emit_unencrypted_log)
            , main_sel_op_eq(main_sel_op_eq)
            , main_sel_op_external_call(main_sel_op_external_call)
            , main_sel_op_fdiv(main_sel_op_fdiv)
            , main_sel_op_fee_per_da_gas(main_sel_op_fee_per_da_gas)
            , main_sel_op_fee_per_l2_gas(main_sel_op_fee_per_l2_gas)
            , main_sel_op_function_selector(main_sel_op_function_selector)
            , main_sel_op_get_contract_instance(main_sel_op_get_contract_instance)
            , main_sel_op_halt(main_sel_op_halt)
            , main_sel_op_internal_call(main_sel_op_internal_call)
            , main_sel_op_internal_return(main_sel_op_internal_return)
            , main_sel_op_jump(main_sel_op_jump)
            , main_sel_op_jumpi(main_sel_op_jumpi)
            , main_sel_op_keccak(main_sel_op_keccak)
            , main_sel_op_l1_to_l2_msg_exists(main_sel_op_l1_to_l2_msg_exists)
            , main_sel_op_l2gasleft(main_sel_op_l2gasleft)
            , main_sel_op_lt(main_sel_op_lt)
            , main_sel_op_lte(main_sel_op_lte)
            , main_sel_op_mov(main_sel_op_mov)
            , main_sel_op_mul(main_sel_op_mul)
            , main_sel_op_not(main_sel_op_not)
            , main_sel_op_note_hash_exists(main_sel_op_note_hash_exists)
            , main_sel_op_nullifier_exists(main_sel_op_nullifier_exists)
            , main_sel_op_or(main_sel_op_or)
            , main_sel_op_pedersen(main_sel_op_pedersen)
            , main_sel_op_poseidon2(main_sel_op_poseidon2)
            , main_sel_op_radix_le(main_sel_op_radix_le)
            , main_sel_op_sender(main_sel_op_sender)
            , main_sel_op_sha256(main_sel_op_sha256)
            , main_sel_op_shl(main_sel_op_shl)
            , main_sel_op_shr(main_sel_op_shr)
            , main_sel_op_sload(main_sel_op_sload)
            , main_sel_op_sstore(main_sel_op_sstore)
            , main_sel_op_storage_address(main_sel_op_storage_address)
            , main_sel_op_sub(main_sel_op_sub)
            , main_sel_op_timestamp(main_sel_op_timestamp)
            , main_sel_op_transaction_fee(main_sel_op_transaction_fee)
            , main_sel_op_version(main_sel_op_version)
            , main_sel_op_xor(main_sel_op_xor)
            , main_sel_q_kernel_lookup(main_sel_q_kernel_lookup)
            , main_sel_q_kernel_output_lookup(main_sel_q_kernel_output_lookup)
            , main_sel_resolve_ind_addr_a(main_sel_resolve_ind_addr_a)
            , main_sel_resolve_ind_addr_b(main_sel_resolve_ind_addr_b)
            , main_sel_resolve_ind_addr_c(main_sel_resolve_ind_addr_c)
            , main_sel_resolve_ind_addr_d(main_sel_resolve_ind_addr_d)
            , main_sel_rng_16(main_sel_rng_16)
            , main_sel_rng_8(main_sel_rng_8)
            , main_space_id(main_space_id)
            , main_tag_err(main_tag_err)
            , main_w_in_tag(main_w_in_tag)
            , mem_addr(mem_addr)
            , mem_clk(mem_clk)
            , mem_diff_hi(mem_diff_hi)
            , mem_diff_lo(mem_diff_lo)
            , mem_diff_mid(mem_diff_mid)
            , mem_glob_addr(mem_glob_addr)
            , mem_last(mem_last)
            , mem_lastAccess(mem_lastAccess)
            , mem_one_min_inv(mem_one_min_inv)
            , mem_r_in_tag(mem_r_in_tag)
            , mem_rw(mem_rw)
            , mem_sel_mem(mem_sel_mem)
            , mem_sel_mov_ia_to_ic(mem_sel_mov_ia_to_ic)
            , mem_sel_mov_ib_to_ic(mem_sel_mov_ib_to_ic)
            , mem_sel_op_a(mem_sel_op_a)
            , mem_sel_op_b(mem_sel_op_b)
            , mem_sel_op_c(mem_sel_op_c)
            , mem_sel_op_cmov(mem_sel_op_cmov)
            , mem_sel_op_d(mem_sel_op_d)
            , mem_sel_resolve_ind_addr_a(mem_sel_resolve_ind_addr_a)
            , mem_sel_resolve_ind_addr_b(mem_sel_resolve_ind_addr_b)
            , mem_sel_resolve_ind_addr_c(mem_sel_resolve_ind_addr_c)
            , mem_sel_resolve_ind_addr_d(mem_sel_resolve_ind_addr_d)
            , mem_sel_rng_chk(mem_sel_rng_chk)
            , mem_skip_check_tag(mem_skip_check_tag)
            , mem_space_id(mem_space_id)
            , mem_tag(mem_tag)
            , mem_tag_err(mem_tag_err)
            , mem_tsp(mem_tsp)
            , mem_val(mem_val)
            , mem_w_in_tag(mem_w_in_tag)
            , pedersen_clk(pedersen_clk)
            , pedersen_input(pedersen_input)
            , pedersen_output(pedersen_output)
            , pedersen_sel_pedersen(pedersen_sel_pedersen)
            , poseidon2_clk(poseidon2_clk)
            , poseidon2_input(poseidon2_input)
            , poseidon2_output(poseidon2_output)
            , poseidon2_sel_poseidon_perm(poseidon2_sel_poseidon_perm)
            , powers_power_of_2(powers_power_of_2)
            , sha256_clk(sha256_clk)
            , sha256_input(sha256_input)
            , sha256_output(sha256_output)
            , sha256_sel_sha256_compression(sha256_sel_sha256_compression)
            , sha256_state(sha256_state)
            , perm_main_alu(perm_main_alu)
            , perm_main_bin(perm_main_bin)
            , perm_main_conv(perm_main_conv)
            , perm_main_pos2_perm(perm_main_pos2_perm)
            , perm_main_pedersen(perm_main_pedersen)
            , perm_main_mem_a(perm_main_mem_a)
            , perm_main_mem_b(perm_main_mem_b)
            , perm_main_mem_c(perm_main_mem_c)
            , perm_main_mem_d(perm_main_mem_d)
            , perm_main_mem_ind_addr_a(perm_main_mem_ind_addr_a)
            , perm_main_mem_ind_addr_b(perm_main_mem_ind_addr_b)
            , perm_main_mem_ind_addr_c(perm_main_mem_ind_addr_c)
            , perm_main_mem_ind_addr_d(perm_main_mem_ind_addr_d)
            , lookup_byte_lengths(lookup_byte_lengths)
            , lookup_byte_operations(lookup_byte_operations)
            , lookup_opcode_gas(lookup_opcode_gas)
            , range_check_l2_gas_hi(range_check_l2_gas_hi)
            , range_check_l2_gas_lo(range_check_l2_gas_lo)
            , range_check_da_gas_hi(range_check_da_gas_hi)
            , range_check_da_gas_lo(range_check_da_gas_lo)
            , kernel_output_lookup(kernel_output_lookup)
            , lookup_into_kernel(lookup_into_kernel)
            , incl_main_tag_err(incl_main_tag_err)
            , incl_mem_tag_err(incl_mem_tag_err)
            , lookup_mem_rng_chk_lo(lookup_mem_rng_chk_lo)
            , lookup_mem_rng_chk_mid(lookup_mem_rng_chk_mid)
            , lookup_mem_rng_chk_hi(lookup_mem_rng_chk_hi)
            , lookup_pow_2_0(lookup_pow_2_0)
            , lookup_pow_2_1(lookup_pow_2_1)
            , lookup_u8_0(lookup_u8_0)
            , lookup_u8_1(lookup_u8_1)
            , lookup_u16_0(lookup_u16_0)
            , lookup_u16_1(lookup_u16_1)
            , lookup_u16_2(lookup_u16_2)
            , lookup_u16_3(lookup_u16_3)
            , lookup_u16_4(lookup_u16_4)
            , lookup_u16_5(lookup_u16_5)
            , lookup_u16_6(lookup_u16_6)
            , lookup_u16_7(lookup_u16_7)
            , lookup_u16_8(lookup_u16_8)
            , lookup_u16_9(lookup_u16_9)
            , lookup_u16_10(lookup_u16_10)
            , lookup_u16_11(lookup_u16_11)
            , lookup_u16_12(lookup_u16_12)
            , lookup_u16_13(lookup_u16_13)
            , lookup_u16_14(lookup_u16_14)
            , lookup_div_u16_0(lookup_div_u16_0)
            , lookup_div_u16_1(lookup_div_u16_1)
            , lookup_div_u16_2(lookup_div_u16_2)
            , lookup_div_u16_3(lookup_div_u16_3)
            , lookup_div_u16_4(lookup_div_u16_4)
            , lookup_div_u16_5(lookup_div_u16_5)
            , lookup_div_u16_6(lookup_div_u16_6)
            , lookup_div_u16_7(lookup_div_u16_7)
            , lookup_byte_lengths_counts(lookup_byte_lengths_counts)
            , lookup_byte_operations_counts(lookup_byte_operations_counts)
            , lookup_opcode_gas_counts(lookup_opcode_gas_counts)
            , range_check_l2_gas_hi_counts(range_check_l2_gas_hi_counts)
            , range_check_l2_gas_lo_counts(range_check_l2_gas_lo_counts)
            , range_check_da_gas_hi_counts(range_check_da_gas_hi_counts)
            , range_check_da_gas_lo_counts(range_check_da_gas_lo_counts)
            , kernel_output_lookup_counts(kernel_output_lookup_counts)
            , lookup_into_kernel_counts(lookup_into_kernel_counts)
            , incl_main_tag_err_counts(incl_main_tag_err_counts)
            , incl_mem_tag_err_counts(incl_mem_tag_err_counts)
            , lookup_mem_rng_chk_lo_counts(lookup_mem_rng_chk_lo_counts)
            , lookup_mem_rng_chk_mid_counts(lookup_mem_rng_chk_mid_counts)
            , lookup_mem_rng_chk_hi_counts(lookup_mem_rng_chk_hi_counts)
            , lookup_pow_2_0_counts(lookup_pow_2_0_counts)
            , lookup_pow_2_1_counts(lookup_pow_2_1_counts)
            , lookup_u8_0_counts(lookup_u8_0_counts)
            , lookup_u8_1_counts(lookup_u8_1_counts)
            , lookup_u16_0_counts(lookup_u16_0_counts)
            , lookup_u16_1_counts(lookup_u16_1_counts)
            , lookup_u16_2_counts(lookup_u16_2_counts)
            , lookup_u16_3_counts(lookup_u16_3_counts)
            , lookup_u16_4_counts(lookup_u16_4_counts)
            , lookup_u16_5_counts(lookup_u16_5_counts)
            , lookup_u16_6_counts(lookup_u16_6_counts)
            , lookup_u16_7_counts(lookup_u16_7_counts)
            , lookup_u16_8_counts(lookup_u16_8_counts)
            , lookup_u16_9_counts(lookup_u16_9_counts)
            , lookup_u16_10_counts(lookup_u16_10_counts)
            , lookup_u16_11_counts(lookup_u16_11_counts)
            , lookup_u16_12_counts(lookup_u16_12_counts)
            , lookup_u16_13_counts(lookup_u16_13_counts)
            , lookup_u16_14_counts(lookup_u16_14_counts)
            , lookup_div_u16_0_counts(lookup_div_u16_0_counts)
            , lookup_div_u16_1_counts(lookup_div_u16_1_counts)
            , lookup_div_u16_2_counts(lookup_div_u16_2_counts)
            , lookup_div_u16_3_counts(lookup_div_u16_3_counts)
            , lookup_div_u16_4_counts(lookup_div_u16_4_counts)
            , lookup_div_u16_5_counts(lookup_div_u16_5_counts)
            , lookup_div_u16_6_counts(lookup_div_u16_6_counts)
            , lookup_div_u16_7_counts(lookup_div_u16_7_counts)
            , alu_a_hi_shift(alu_a_hi_shift)
            , alu_a_lo_shift(alu_a_lo_shift)
            , alu_b_hi_shift(alu_b_hi_shift)
            , alu_b_lo_shift(alu_b_lo_shift)
            , alu_cmp_rng_ctr_shift(alu_cmp_rng_ctr_shift)
            , alu_div_u16_r0_shift(alu_div_u16_r0_shift)
            , alu_div_u16_r1_shift(alu_div_u16_r1_shift)
            , alu_div_u16_r2_shift(alu_div_u16_r2_shift)
            , alu_div_u16_r3_shift(alu_div_u16_r3_shift)
            , alu_div_u16_r4_shift(alu_div_u16_r4_shift)
            , alu_div_u16_r5_shift(alu_div_u16_r5_shift)
            , alu_div_u16_r6_shift(alu_div_u16_r6_shift)
            , alu_div_u16_r7_shift(alu_div_u16_r7_shift)
            , alu_op_add_shift(alu_op_add_shift)
            , alu_op_cast_prev_shift(alu_op_cast_prev_shift)
            , alu_op_cast_shift(alu_op_cast_shift)
            , alu_op_div_shift(alu_op_div_shift)
            , alu_op_mul_shift(alu_op_mul_shift)
            , alu_op_shl_shift(alu_op_shl_shift)
            , alu_op_shr_shift(alu_op_shr_shift)
            , alu_op_sub_shift(alu_op_sub_shift)
            , alu_p_sub_a_hi_shift(alu_p_sub_a_hi_shift)
            , alu_p_sub_a_lo_shift(alu_p_sub_a_lo_shift)
            , alu_p_sub_b_hi_shift(alu_p_sub_b_hi_shift)
            , alu_p_sub_b_lo_shift(alu_p_sub_b_lo_shift)
            , alu_sel_alu_shift(alu_sel_alu_shift)
            , alu_sel_cmp_shift(alu_sel_cmp_shift)
            , alu_sel_div_rng_chk_shift(alu_sel_div_rng_chk_shift)
            , alu_sel_rng_chk_lookup_shift(alu_sel_rng_chk_lookup_shift)
            , alu_sel_rng_chk_shift(alu_sel_rng_chk_shift)
            , alu_u16_r0_shift(alu_u16_r0_shift)
            , alu_u16_r1_shift(alu_u16_r1_shift)
            , alu_u16_r2_shift(alu_u16_r2_shift)
            , alu_u16_r3_shift(alu_u16_r3_shift)
            , alu_u16_r4_shift(alu_u16_r4_shift)
            , alu_u16_r5_shift(alu_u16_r5_shift)
            , alu_u16_r6_shift(alu_u16_r6_shift)
            , alu_u8_r0_shift(alu_u8_r0_shift)
            , alu_u8_r1_shift(alu_u8_r1_shift)
            , binary_acc_ia_shift(binary_acc_ia_shift)
            , binary_acc_ib_shift(binary_acc_ib_shift)
            , binary_acc_ic_shift(binary_acc_ic_shift)
            , binary_mem_tag_ctr_shift(binary_mem_tag_ctr_shift)
            , binary_op_id_shift(binary_op_id_shift)
            , kernel_emit_l2_to_l1_msg_write_offset_shift(kernel_emit_l2_to_l1_msg_write_offset_shift)
            , kernel_emit_note_hash_write_offset_shift(kernel_emit_note_hash_write_offset_shift)
            , kernel_emit_nullifier_write_offset_shift(kernel_emit_nullifier_write_offset_shift)
            , kernel_emit_unencrypted_log_write_offset_shift(kernel_emit_unencrypted_log_write_offset_shift)
            , kernel_l1_to_l2_msg_exists_write_offset_shift(kernel_l1_to_l2_msg_exists_write_offset_shift)
            , kernel_note_hash_exist_write_offset_shift(kernel_note_hash_exist_write_offset_shift)
            , kernel_nullifier_exists_write_offset_shift(kernel_nullifier_exists_write_offset_shift)
            , kernel_nullifier_non_exists_write_offset_shift(kernel_nullifier_non_exists_write_offset_shift)
            , kernel_side_effect_counter_shift(kernel_side_effect_counter_shift)
            , kernel_sload_write_offset_shift(kernel_sload_write_offset_shift)
            , kernel_sstore_write_offset_shift(kernel_sstore_write_offset_shift)
            , main_da_gas_remaining_shift(main_da_gas_remaining_shift)
            , main_internal_return_ptr_shift(main_internal_return_ptr_shift)
            , main_l2_gas_remaining_shift(main_l2_gas_remaining_shift)
            , main_pc_shift(main_pc_shift)
            , mem_glob_addr_shift(mem_glob_addr_shift)
            , mem_rw_shift(mem_rw_shift)
            , mem_sel_mem_shift(mem_sel_mem_shift)
            , mem_tag_shift(mem_tag_shift)
            , mem_tsp_shift(mem_tsp_shift)
            , mem_val_shift(mem_val_shift)
        {}
    };
    ...
    class ProverPolynomials : public AllEntities<Polynomial> {
      public:
        ...
        {
            return AllConstRefValues(main_clk[row_idx],
