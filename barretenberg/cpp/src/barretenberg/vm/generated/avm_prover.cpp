...
=======
    witness_commitments.perm_slice_mem = commitment_key->commit(key->perm_slice_mem);
    ...
    witness_commitments.perm_main_slice = commitment_key->commit(key->perm_main_slice);
    ...
    witness_commitments.lookup_ret_value = commitment_key->commit(key->lookup_ret_value);
    ...
    // Send all commitments to the verifier
    transcript->send_to_verifier(commitment_labels.perm_slice_mem, witness_commitments.perm_slice_mem);
    ...
    transcript->send_to_verifier(commitment_labels.perm_main_slice, witness_commitments.perm_main_slice);
    ...
    transcript->send_to_verifier(commitment_labels.lookup_ret_value, witness_commitments.lookup_ret_value);
