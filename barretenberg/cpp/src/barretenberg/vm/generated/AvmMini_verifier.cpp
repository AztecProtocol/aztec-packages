    ...
    namespace bb
{
    ...
    bool AvmMiniVerifier::verify_proof(const plonk::proof& proof)
    {
        ...
        commitments.memTrace_m_clk =
            transcript->template receive_from_prover<Commitment>(commitment_labels.memTrace_m_clk);
        ...
        commitments.memTrace_m_tag =
            transcript->template receive_from_prover<Commitment>(commitment_labels.memTrace_m_tag);
        commitments.memTrace_m_val =
            transcript->template receive_from_prover<Commitment>(commitment_labels.memTrace_m_val);
        ...
        commitments.memTrace_m_rw =
            transcript->template receive_from_prover<Commitment>(commitment_labels.memTrace_m_rw);
        ...
        commitments.aluChip_alu_ia =
            transcript->template receive_from_prover<Commitment>(commitment_labels.aluChip_alu_ia);
        commitments.aluChip_alu_ib =
            transcript->template receive_from_prover<Commitment>(commitment_labels.aluChip_alu_ib);
        commitments.aluChip_alu_ic =
            transcript->template receive_from_prover<Commitment>(commitment_labels.aluChip_alu_ic);
        ...
        commitments.aluChip_alu_cf =
            transcript->template receive_from_prover<Commitment>(commitment_labels.aluChip_alu_cf);
        ...
        commitments.avmMini_in_tag =
            transcript->template receive_from_prover<Commitment>(commitment_labels.avmMini_in_tag);
        commitments.avmMini_op_err =
            transcript->template receive_from_prover<Commitment>(commitment_labels.avmMini_op_err);
