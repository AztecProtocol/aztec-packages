...
const size_t SCOPED_LOG_HASH_LENGTH = LOG_HASH_LENGTH + 1;
const size_t ENCRYPTED_LOG_HASH_LENGTH = 4;
const size_t SCOPED_ENCRYPTED_LOG_HASH_LENGTH = ENCRYPTED_LOG_HASH_LENGTH + 1;
...
const size_t PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH =
    ...
    (ENCRYPTED_LOG_HASH_LENGTH * MAX_ENCRYPTED_LOGS_PER_CALL) + (LOG_HASH_LENGTH * MAX_UNENCRYPTED_LOGS_PER_CALL) +
...
const size_t COMBINED_ACCUMULATED_DATA_LENGTH =
    MAX_NEW_NOTE_HASHES_PER_TX + MAX_NEW_NULLIFIERS_PER_TX + MAX_NEW_L2_TO_L1_MSGS_PER_TX + 6 +
