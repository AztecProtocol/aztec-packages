...
const size_t MAX_KEY_VALIDATION_REQUESTS_PER_TX = 64;
...
const size_t KEY_VALIDATION_REQUEST_LENGTH = 3;
const size_t SCOPED_KEY_VALIDATION_REQUEST_LENGTH = KEY_VALIDATION_REQUEST_LENGTH + 1;
...
const size_t VALIDATION_REQUESTS_LENGTH = ROLLUP_VALIDATION_REQUESTS_LENGTH +
