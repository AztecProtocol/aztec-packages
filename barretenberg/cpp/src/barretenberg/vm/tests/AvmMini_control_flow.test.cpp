...
TEST_F(AvmMiniControlFlowTests, simpleCall)
{
    ...
    EXPECT_EQ(halt_row->avmMini_pc, FF(4));
...
// TEST_F(AvmMiniControlFlowTests, subtractionFF)
// {
...
// TEST_F(AvmMiniControlFlowTests, multiplicationFF)
// {
...
// TEST_F(AvmMiniControlFlowTests, multiplicationByZeroFF)
// {
...
// TEST_F(AvmMiniControlFlowTests, divisionFF)
// {
...
// TEST_F(AvmMiniControlFlowTests, divisionNumeratorZeroFF)
// {
...
// TEST_F(AvmMiniControlFlowTests, divisionByZeroErrorFF)
// {
//     trace_builder.callDataCopy(0, 1, 0, std::vector<FF>{ 15 });
...
// TEST_F(AvmMiniControlFlowTests, arithmeticFFWithError)
// {
