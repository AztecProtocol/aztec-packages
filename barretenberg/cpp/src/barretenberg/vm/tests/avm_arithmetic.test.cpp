                              ...
                              avm_trace::AvmMemoryTag tag)
{
    ...
    trace_builder.op_set(a, addr_a, tag);
    trace_builder.op_set(b, addr_b, tag);
...
std::vector<Row> gen_mutated_trace_add(FF const& a, FF const& b, FF const& c_mutated, avm_trace::AvmMemoryTag tag)
{
    ...
    trace_builder.op_set(uint128_t{ b }, 1, tag);
...
{
    // trace_builder
    trace_builder.op_set(62, 0, AvmMemoryTag::U8);
    trace_builder.op_set(29, 1, AvmMemoryTag::U8);
...
{
    // trace_builder
    trace_builder.op_set(159, 0, AvmMemoryTag::U8);
    trace_builder.op_set(100, 1, AvmMemoryTag::U8);
...
{
    // trace_builder
    trace_builder.op_set(162, 0, AvmMemoryTag::U8);
    trace_builder.op_set(29, 1, AvmMemoryTag::U8);
...
{
    // trace_builder
    trace_builder.op_set(5, 0, AvmMemoryTag::U8);
    trace_builder.op_set(29, 1, AvmMemoryTag::U8);
...
{
    // trace_builder
    trace_builder.op_set(13, 0, AvmMemoryTag::U8);
    trace_builder.op_set(15, 1, AvmMemoryTag::U8);
...
{
    // trace_builder
    trace_builder.op_set(200, 0, AvmMemoryTag::U8);
    trace_builder.op_set(170, 1, AvmMemoryTag::U8);
...
{
    // trace_builder
    trace_builder.op_set(1775, 119, AvmMemoryTag::U16);
    trace_builder.op_set(33005, 546, AvmMemoryTag::U16);
...
{
    // trace_builder
    trace_builder.op_set(UINT16_MAX - 982, 0, AvmMemoryTag::U16);
    trace_builder.op_set(1000, 1, AvmMemoryTag::U16);
...
{
    // trace_builder
    trace_builder.op_set(200, 0, AvmMemoryTag::U16);
    trace_builder.op_set(245, 1, AvmMemoryTag::U16);
...
{
    // trace_builder
    trace_builder.op_set(512, 0, AvmMemoryTag::U16);
    trace_builder.op_set(1024, 1, AvmMemoryTag::U16);
...
{
    // trace_builder
    trace_builder.op_set(1000000000, 8, AvmMemoryTag::U32);
    trace_builder.op_set(1234567891, 9, AvmMemoryTag::U32);
...
{
    // trace_builder
    trace_builder.op_set(UINT32_MAX - 1293, 8, AvmMemoryTag::U32);
    trace_builder.op_set(2293, 9, AvmMemoryTag::U32);
...
{
    // trace_builder
    trace_builder.op_set(1345678991, 8, AvmMemoryTag::U32);
    trace_builder.op_set(1234567891, 9, AvmMemoryTag::U32);
...
{
    // trace_builder
    trace_builder.op_set(UINT32_MAX - 99, 8, AvmMemoryTag::U32);
    trace_builder.op_set(3210987654, 9, AvmMemoryTag::U32);
...
{
    // trace_builder
    trace_builder.op_set(11111, 0, AvmMemoryTag::U32);
    trace_builder.op_set(11111, 1, AvmMemoryTag::U32);
...
{
    // trace_builder
    trace_builder.op_set(11 << 25, 0, AvmMemoryTag::U32);
    trace_builder.op_set(13 << 22, 1, AvmMemoryTag::U32);
...
TEST_F(AvmArithmeticTestsU64, addition)
{
    ...
    // trace_builder
    trace_builder.op_set(a, 8, AvmMemoryTag::U64);
    trace_builder.op_set(b, 9, AvmMemoryTag::U64);
...
TEST_F(AvmArithmeticTestsU64, additionCarry)
{
    ...
    // trace_builder
    trace_builder.op_set(a, 0, AvmMemoryTag::U64);
    trace_builder.op_set(b, 1, AvmMemoryTag::U64);
...
{
    // trace_builder
    trace_builder.op_set(999888777, 0, AvmMemoryTag::U64);
    trace_builder.op_set(555444333, 1, AvmMemoryTag::U64);
...
TEST_F(AvmArithmeticTestsU128, addition)
{
    ...
    // trace_builder
    trace_builder.op_set(a, 8, AvmMemoryTag::U128);
    trace_builder.op_set(b, 9, AvmMemoryTag::U128);
...
{
    // trace_builder
    trace_builder.op_set(0x38D64BF685FFBLLU, 0, AvmMemoryTag::U128);
    trace_builder.op_set(0x1F92C762C98DFLLU, 1, AvmMemoryTag::U128);
...
TEST_F(AvmArithmeticTestsU128, multiplicationOverflow)
{
    ...
    // trace_builder
    trace_builder.op_set(a, 0, AvmMemoryTag::U128);
    trace_builder.op_set(b, 1, AvmMemoryTag::U128);
