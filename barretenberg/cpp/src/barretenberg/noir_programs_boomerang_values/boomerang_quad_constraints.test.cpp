 ...
 */
static std::optional<size_t> find_quad_gate(MegaCircuitBuilder& builder, fr expected_q_m)
{
 ...
 */
static std::pair<AcirFormat, MegaCircuitBuilder> build_mixed_quad_logic_range_circuit()
{
    QuadConstraint quad{
        .a = 0,
        .b = 1,
 ...
 */
static std::pair<AcirFormat, MegaCircuitBuilder> build_simple_quad_circuit()
{
    QuadConstraint quad{
        .a = 0,
        .b = 1,
 ...
 *          a=2, b=3, c=2, d=11
 */
static std::pair<AcirFormat, MegaCircuitBuilder> build_full_equation_quad_circuit()
{
    QuadConstraint quad{
        .a = 0,
        .b = 1,
