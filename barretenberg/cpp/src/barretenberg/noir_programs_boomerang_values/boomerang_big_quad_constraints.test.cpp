...
TEST_F(BoomerangBigQuadConstraintsTests, FullSerializationPipeline_1Mul3Linear)
{
    ...
    auto builder = create_circuit<MegaCircuitBuilder>(acir_prog);
 ...
 */
static std::pair<AcirFormat, MegaCircuitBuilder> build_simple_big_quad_circuit()
{
    Acir::Expression expr{
        .mul_terms = { std::make_tuple(fr_to_bytes(fr(1)), Acir::Witness{ .value = 0 }, Acir::Witness{ .value = 1 }),
                       std::make_tuple(fr_to_bytes(fr(1)), Acir::Witness{ .value = 2 }, Acir::Witness{ .value = 3 }) },
 ...
 */
static std::optional<size_t> find_big_quad_first_gate(MegaCircuitBuilder& builder)
{
 ...
 */
static std::pair<AcirFormat, MegaCircuitBuilder> build_3gate_big_quad_circuit()
{
    Acir::Expression expr{
        .mul_terms = { std::make_tuple(fr_to_bytes(fr(1)), Acir::Witness{ .value = 0 }, Acir::Witness{ .value = 1 }),
                       std::make_tuple(fr_to_bytes(fr(1)), Acir::Witness{ .value = 2 }, Acir::Witness{ .value = 3 }),
 ...
 */
static std::vector<size_t> find_big_quad_gate_chain(MegaCircuitBuilder& builder)
{
