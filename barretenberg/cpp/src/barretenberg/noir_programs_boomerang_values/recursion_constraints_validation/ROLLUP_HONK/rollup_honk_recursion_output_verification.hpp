...
// ROLLUP_HONK Output (RollupIO reconstruct_from_public + PairingPoints::aggregate).
// Promoted from Phase 3 cursor dump / rollup_honk_functions_analysis.txt.
...
namespace RollupHonkRecursionValidation::Output {

static constexpr recursion_helpers::FunctionFingerprint ARITH_TOTAL = {
    32943, 0x2dce00dfaa8b2f7aULL, 0x29c5fd98ee8b3fb5ULL, recursion_helpers::SCANNER_FINGERPRINT_SIZE
};
static constexpr recursion_helpers::FunctionFingerprint NNF_TOTAL = {
    18184, 0x8532e80b0fef3fa6ULL, 0xfc3edd99d397770cULL, recursion_helpers::SCANNER_FINGERPRINT_SIZE
};
...
OutputValidationResult validate_output(CircuitBuilder& builder,
                                       ...
                                       const HonkRecursionValidation::KZG::KZGValidationResult& previous)
{
