...
// Measured Phase 3 promote: ARITH 2663 @ 1709 → 4372; residual 79 → Oink @ 4451; NNF setup 1736.
// Same absolute pins as baseline HONK for this mock VK shape; Oink+ body differs (HasZK).

#include "barretenberg/dsl/acir_format/recursion_constraint.hpp"
#include "barretenberg/noir_programs_boomerang_values/recursion_constraints_helper.hpp"

namespace HonkZKRecursionValidation::VkDeserialize {

static constexpr size_t PRIMITIVE_START_ARITH = 1709;
static constexpr size_t OINK_ARITH_START = 4451;
                                                             ...
                                                             size_t nnf_start = 0)
{
    ...
    const size_t region_hi = arith_start + ARITH.gate_count;
