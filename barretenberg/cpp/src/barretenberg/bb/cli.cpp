...
int parse_and_run_cli_command(int argc, char* argv[])
{
    ...
    const auto add_small_circuit_option = [&](CLI::App* subcommand) {
        return subcommand->add_flag("--small_circuit", flags.small_circuit, "Use a small circuit proof.");
    };
    ...
    add_small_circuit_option(prove);
    ...
    add_small_circuit_option(write_vk);
    ...
    add_small_circuit_option(verify);
