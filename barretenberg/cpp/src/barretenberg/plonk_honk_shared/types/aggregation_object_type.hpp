...
constexpr uint32_t PAIRING_POINT_ACCUM_SIZE = 16;
// PairingPointAccumulatorIndices represents an array of 16 witness indices pointing to the nested aggregation object.
using PairingPointAccumulatorIndices = std::array<uint32_t, PAIRING_POINT_ACCUM_SIZE>;
...
using PairingPointAccumPubInputIndices = std::array<uint32_t, PAIRING_POINT_ACCUM_SIZE>;
} // namespace bb