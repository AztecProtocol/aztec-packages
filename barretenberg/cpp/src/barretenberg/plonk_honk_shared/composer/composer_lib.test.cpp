...
// /**
//  * @brief A test to demonstrate that lookup read counts/tags are computed correctly for a simple 'hand-computable'
//  case
...
//     // The uint32 XOR lookup table is constructed for 6 bit operands via double for loop that iterates through the
//     left
//     // operand externally (0 to 63) then the right operand internally (0 to 63). Computing (1 XOR 5) will thus result
//     in
//     // 1 lookup from the (1*64 + 5)th index in the table and 5 lookups from the (0*64 + 0)th index (for the remaining
//     5
