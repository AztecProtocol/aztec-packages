 ...
 * @param circuit
 */
void UltraVanillaClientIVC::instantiate_stdlib_verification_queue(
 ...
 */
void UltraVanillaClientIVC::perform_recursive_verification_and_databus_consistency_checks(
 ...
 * @param circuit
 */
void UltraVanillaClientIVC::process_recursive_merge_verification_queue(ClientCircuit& circuit)
{
 ...
 * @param circuit
 */
void UltraVanillaClientIVC::complete_kernel_circuit_logic(ClientCircuit& circuit)
{
 ...
 */
void UltraVanillaClientIVC::accumulate(ClientCircuit& circuit,
 ...
 * @return HonkProof
 */
HonkProof UltraVanillaClientIVC::decider_prove() const
{
    vinfo("prove decider...");
 ...
 */
std::vector<std::shared_ptr<MegaFlavor::VerificationKey>> UltraVanillaClientIVC::precompute_folding_verification_keys(
