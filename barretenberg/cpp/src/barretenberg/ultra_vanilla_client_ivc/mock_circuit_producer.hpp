...
//  * circuits are size 2^17. Circuits produced are alternatingly app and kernel. Mock databus data is passed between
//  the
...
//   public:
//     UltraVanillaClientIVC(bool large_first_app = true)
