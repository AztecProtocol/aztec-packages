...
{
    acir_format::AcirProgram program = acir_format::AcirProgram{ this->constraint_system };
    bb::UltraCircuitBuilder builder = acir_format::create_circuit<bb::UltraCircuitBuilder>(program);
...
smt_solver::Solver AcirToSmtLoader::get_smt_solver()
{
    ...
    return smt_solver::Solver(circuit_info.modulus, smt_circuit::default_solver_config, 16, 255);
}
