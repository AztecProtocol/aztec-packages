...
// /**
//  * @brief Test Shplemini with ZK data consisting of a hiding polynomial generated by GeminiProver and Libra
//  polynomials
...
//     libra_commitments[2] = verifier_transcript->template
//     receive_from_prover<Commitment>("Libra:quotient_commitment");

//     // Used to verify the consistency of the evaluations of the concatenated libra polynomial, big sum polynomial,
//     and
...
//     // Generate Sumcheck challenge, current implementation of Sumcheck Round Univariates batching in Shplemini
//     assumes
