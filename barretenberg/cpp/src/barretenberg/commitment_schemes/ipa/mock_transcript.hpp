 ...
 * also store elements received from the prover and has vestigal hash buffers. (The hash buffers exist only because ipa
 * uses them, as they are methods for the `Transcript` class.)
 *
 */
