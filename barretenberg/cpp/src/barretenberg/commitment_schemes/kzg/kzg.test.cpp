...
TYPED_TEST(KZGTest, single)
{
    ...
    bool result = KZG::reduce_verify(this->vk(), opening_claim, verifier_transcript);
...
TYPED_TEST(KZGTest, GeminiShplonkKzgWithShift)
{
    ...
    bool result = KZG::reduce_verify(this->vk(), shplonk_verifier_claim, verifier_transcript);
