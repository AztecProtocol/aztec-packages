  ...
  public:
    ...
    std::array<ChallengeType, sizeof...(Strings)> get_challenges(const Strings&... labels)
    {
        ...
        for (size_t i = 0; i < num_challenges; i++) {
            // TODO(https://github.com/AztecProtocol/barretenberg/issues/741): Optimize this by truncating hash to
            // 128 bits or by splitting hash into 2 challenges.
            /*
            ...
            // copy half of the hash to lower 128 bits of challenge Note: because of how read() from buffers to
            fields works (in field_declarations.hpp), we use the later half of the buffer
