    ...
    requires IsGoblinFlavor<Flavor>
{
    ...
    // PP in PK
    proving_key.polynomials.calldata = public_calldata.share();
    proving_key.polynomials.calldata_read_counts = calldata_read_counts.share();
    proving_key.polynomials.return_data = public_return_data.share();
    proving_key.polynomials.return_data_read_counts = return_data_read_counts.share();
    proving_key.polynomials.databus_id = databus_id.share();
}
...
void ProverInstance_<Flavor>::construct_table_polynomials(Circuit& circuit, size_t dyadic_circuit_size)
{
    ...
    // PP in PK
    proving_key.polynomials.table_1 = table_polynomials[0].share();
    proving_key.polynomials.table_2 = table_polynomials[1].share();
    proving_key.polynomials.table_3 = table_polynomials[2].share();
    proving_key.polynomials.table_4 = table_polynomials[3].share();
}
