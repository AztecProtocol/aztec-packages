    ...
    requires IsGoblinFlavor<Flavor>
{
    ...
    this->proving_key.calldata = public_calldata.share();
    this->proving_key.calldata_read_counts = calldata_read_counts.share();
    this->proving_key.return_data = public_return_data.share();
    this->proving_key.return_data_read_counts = return_data_read_counts.share();
    this->proving_key.databus_id = databus_id.share();
}
...
void ProverInstance_<Flavor>::construct_table_polynomials(Circuit& circuit, size_t dyadic_circuit_size)
{
    ...
    this->proving_key.table_1 = table_polynomials[0].share();
    this->proving_key.table_2 = table_polynomials[1].share();
    this->proving_key.table_3 = table_polynomials[2].share();
    this->proving_key.table_4 = table_polynomials[3].share();
}
