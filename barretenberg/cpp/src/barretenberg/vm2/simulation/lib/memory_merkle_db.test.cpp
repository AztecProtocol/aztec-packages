...
using bb::world_state::WorldState;
...
using MerkleTreeId = crypto::merkle_tree::MerkleTreeId;
...
class MemoryMerkleDBEquivalenceTest : public ::testing::Test {
  protected:
    ...
    {
        const TreeSnapshots mem_snap = mem->get_tree_roots();
    ...
    void check_snapshot(MerkleTreeId tree_id, const AppendOnlyTreeSnapshot& mem_snap)
    {
