...
using Tree = IndexedMemoryTree<LeafValue, aztec::AztecMerkleHashPolicy>;
using UpdatableTree = IndexedMemoryTree<UpdatableLeafValue, aztec::AztecMerkleHashPolicy>;
