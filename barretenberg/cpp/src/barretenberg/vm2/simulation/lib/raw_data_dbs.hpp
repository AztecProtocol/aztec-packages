...
class HintedRawContractDB final : public ContractDBInterface {
  ...
  private:
    ...
    unordered_flat_map<std::pair<AztecAddress, FF>, std::string> debug_function_names;
};
