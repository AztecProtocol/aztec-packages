...
TEST(AvmSimulationAluTest, Mul)
{
    ...
    EXPECT_CALL(range_check, assert_range(0, 64)).Times(1);
...
TEST(AvmSimulationAluTest, MulOverflow)
{
    ...
    EXPECT_CALL(range_check, assert_range(1, 64)).Times(1);
...
TEST(AvmSimulationAluTest, MulOverflowU128)
{
    ...
    EXPECT_CALL(range_check, assert_range((uint128_t(1) << 64) - 6, 64)).Times(1);
