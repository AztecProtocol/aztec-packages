 ...
 * validating their existence through nullifier checks, and performing
 * contract update validation. It is used by both the GetContractInstance
 * opcode and bytecode retrieval functionality.
 */
