...
INSTANTIATE_LOOKUP(lookup_contract_instance_retrieval_check_protocol_address_range_relation);
INSTANTIATE_LOOKUP(lookup_contract_instance_retrieval_read_derived_address_from_public_inputs_relation);
