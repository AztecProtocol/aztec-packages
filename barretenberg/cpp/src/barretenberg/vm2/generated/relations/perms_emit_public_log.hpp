...
/////////////////// perm_emit_public_log_read_mem ///////////////////

struct perm_emit_public_log_read_mem_settings_ {
    ...
    static constexpr std::array<ColumnAndShifts, COLUMNS_PER_SET> SRC_COLUMNS = {
        ColumnAndShifts::emit_public_log_execution_clk, ColumnAndShifts::emit_public_log_space_id,
        ColumnAndShifts::emit_public_log_log_address,   ColumnAndShifts::emit_public_log_value,
        ColumnAndShifts::emit_public_log_tag,           ColumnAndShifts::precomputed_zero
    };
...
using perm_emit_public_log_read_mem_settings = permutation_settings<perm_emit_public_log_read_mem_settings_>;
template <typename FF_>
using perm_emit_public_log_read_mem_relation = permutation_relation_base<FF_, perm_emit_public_log_read_mem_settings>;
