                                       ...
                                       [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::to_radix_mem_sel_dst_out_of_range_err)) *
                   (FF(1) - static_cast<View>(in.get(C::to_radix_mem_sel_dst_out_of_range_err)));
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::to_radix_mem_sel_radix_lt_2_err)) *
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::to_radix_mem_sel_radix_gt_256_err)) *
    ...
    { // LAST_ROW_VALID_COMPUTATION
        ...
        auto tmp = CView(to_radix_mem_SEL_NO_ERR) *
                   (FF(1) - static_cast<View>(in.get(C::to_radix_mem_sel_num_limbs_is_zero))) *
    ...
    { // LAST_ROW_NUM_LIMBS_ZERO
        ...
        auto tmp = static_cast<View>(in.get(C::to_radix_mem_sel)) *
                   static_cast<View>(in.get(C::to_radix_mem_sel_num_limbs_is_zero)) *
    ...
    { // LAST_ROW_ERR_COMPUTATION
        ...
        auto tmp = static_cast<View>(in.get(C::to_radix_mem_sel)) * static_cast<View>(in.get(C::to_radix_mem_err)) *
                   (FF(1) - static_cast<View>(in.get(C::to_radix_mem_sel_num_limbs_is_zero))) *
                   (static_cast<View>(in.get(C::to_radix_mem_last)) - FF(1));
    ...
    }
    {
        ...
        auto tmp =
            (static_cast<View>(in.get(C::to_radix_mem_sel_should_exec)) -
             static_cast<View>(in.get(C::to_radix_mem_sel)) * (FF(1) - static_cast<View>(in.get(C::to_radix_mem_err))) *
                 (FF(1) - static_cast<View>(in.get(C::to_radix_mem_sel_num_limbs_is_zero))));
