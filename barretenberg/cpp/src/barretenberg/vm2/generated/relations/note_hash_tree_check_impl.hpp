                                               ...
                                               [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    [[maybe_unused]] const auto& constants_NOTE_HASH_TREE_HEIGHT =
        note_hash_tree_check_detail::constants_NOTE_HASH_TREE_HEIGHT_v<FF_>;
    [[maybe_unused]] const auto&
        constants_AVM_PUBLIC_INPUTS_PREVIOUS_NON_REVERTIBLE_ACCUMULATED_DATA_NULLIFIERS_ROW_IDX =
            note_hash_tree_check_detail::
                constants_AVM_PUBLIC_INPUTS_PREVIOUS_NON_REVERTIBLE_ACCUMULATED_DATA_NULLIFIERS_ROW_IDX_v<FF_>;
    [[maybe_unused]] const auto& constants_AVM_PUBLIC_INPUTS_AVM_ACCUMULATED_DATA_NOTE_HASHES_ROW_IDX =
        note_hash_tree_check_detail::constants_AVM_PUBLIC_INPUTS_AVM_ACCUMULATED_DATA_NOTE_HASHES_ROW_IDX_v<FF_>;
    [[maybe_unused]] const auto& constants_DOM_SEP__SILOED_NOTE_HASH =
        note_hash_tree_check_detail::constants_DOM_SEP__SILOED_NOTE_HASH_v<FF_>;
    [[maybe_unused]] const auto& constants_DOM_SEP__UNIQUE_NOTE_HASH =
        note_hash_tree_check_detail::constants_DOM_SEP__UNIQUE_NOTE_HASH_v<FF_>;
    [[maybe_unused]] const auto& constants_DOM_SEP__NOTE_HASH_NONCE =
        note_hash_tree_check_detail::constants_DOM_SEP__NOTE_HASH_NONCE_v<FF_>;
    [[maybe_unused]] const auto& constants_DOM_SEP__MERKLE_HASH =
        note_hash_tree_check_detail::constants_DOM_SEP__MERKLE_HASH_v<FF_>;
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::note_hash_tree_check_sel_silo)) *
                   (FF(1) - static_cast<View>(in.get(C::note_hash_tree_check_sel_silo)));
        std::get<3>(evals) += (tmp * scaling_factor);
    }
    {
        using View = typename std::tuple_element_t<4, ContainerOverSubrelations>::View;
        auto tmp = static_cast<View>(in.get(C::note_hash_tree_check_sel_unique)) *
                   (FF(1) - static_cast<View>(in.get(C::note_hash_tree_check_sel_unique)));
        std::get<4>(evals) += (tmp * scaling_factor);
    }
    {
        using View = typename std::tuple_element_t<5, ContainerOverSubrelations>::View;
        auto tmp = static_cast<View>(in.get(C::note_hash_tree_check_discard)) *
    ...
    { // DISABLE_SILOING_ON_READ
        ...
        auto tmp = CView(note_hash_tree_check_READ) * static_cast<View>(in.get(C::note_hash_tree_check_sel_silo));
    ...
    { // DISABLE_UNIQUENESS_ON_READ
        ...
        auto tmp = CView(note_hash_tree_check_READ) * static_cast<View>(in.get(C::note_hash_tree_check_sel_unique));
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::note_hash_tree_check_write)) *
                   static_cast<View>(in.get(C::note_hash_tree_check_prev_leaf_value));
    ...
    { // MERKLE_HASH_SEPARATOR_CONSTANT
        ...
        auto tmp = static_cast<View>(in.get(C::note_hash_tree_check_sel)) *
                   (static_cast<View>(in.get(C::note_hash_tree_check_merkle_hash_separator)) -
    ...
    }
    {
        ...
        auto tmp = (static_cast<View>(in.get(C::note_hash_tree_check_write)) *
                        (FF(1) - static_cast<View>(in.get(C::note_hash_tree_check_discard))) -
                    static_cast<View>(in.get(C::note_hash_tree_check_sel_write_to_public_inputs)));
        std::get<22>(evals) += (tmp * scaling_factor);
    }
    {
        using View = typename std::tuple_element_t<23, ContainerOverSubrelations>::View;
        auto tmp = static_cast<View>(in.get(C::note_hash_tree_check_sel_write_to_public_inputs)) *
