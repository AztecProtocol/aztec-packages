...
INSTANTIATE_LOOKUP(lookup_tx_context_public_inputs_read_reverted_relation);
...
INSTANTIATE_LOOKUP(lookup_tx_context_public_inputs_write_public_log_count_relation);
