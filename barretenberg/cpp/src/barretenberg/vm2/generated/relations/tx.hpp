...
template <typename FF_> class txImpl {
  public:
    ...
    static constexpr std::array<size_t, 66> SUBRELATION_PARTIAL_LENGTHS = {
        ...
        5, 3, 3, 3, 3, 4, 5, 3, 3, 3, 3, 3, 3, 3, 5, 4, 3, 4, 3, 2, 4, 4, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3
    };
...
template <typename FF> class tx : public Relation<txImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_NULLIFIER_TREE_SIZE_INCREMENT = 44;
    static constexpr size_t SR_NULLIFIER_EMITTED_COUNT_INCREMENT = 45;
