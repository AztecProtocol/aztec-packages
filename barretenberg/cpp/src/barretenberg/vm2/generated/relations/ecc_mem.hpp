  ...
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        }
        {
            ...
            auto tmp = in.get(C::ecc_add_mem_sel_p_on_curve_err) * (FF(1) - in.get(C::ecc_add_mem_sel_p_on_curve_err));
            tmp *= scaling_factor;
            std::get<4>(evals) += typename Accumulator::View(tmp);
        }
        {
            using Accumulator = typename std::tuple_element_t<5, ContainerOverSubrelations>;
            auto tmp = in.get(C::ecc_add_mem_sel_q_on_curve_err) * (FF(1) - in.get(C::ecc_add_mem_sel_q_on_curve_err));
            tmp *= scaling_factor;
        ...
        { // P_ON_CURVE_CHECK
            ...
            auto tmp = in.get(C::ecc_add_mem_sel) * (in.get(C::ecc_add_mem_p_is_on_curve_eqn) *
                                                         ((FF(1) - in.get(C::ecc_add_mem_sel_p_on_curve_err)) *
                                                              (FF(1) - in.get(C::ecc_add_mem_p_on_curve_eqn_inv)) +
                                                          in.get(C::ecc_add_mem_p_on_curve_eqn_inv)) -
                                                     in.get(C::ecc_add_mem_sel_p_on_curve_err));
            tmp *= scaling_factor;
        ...
        { // Q_ON_CURVE_CHECK
            ...
            auto tmp = in.get(C::ecc_add_mem_sel) * (in.get(C::ecc_add_mem_q_is_on_curve_eqn) *
                                                         ((FF(1) - in.get(C::ecc_add_mem_sel_q_on_curve_err)) *
                                                              (FF(1) - in.get(C::ecc_add_mem_q_on_curve_eqn_inv)) +
                                                          in.get(C::ecc_add_mem_q_on_curve_eqn_inv)) -
                                                     in.get(C::ecc_add_mem_sel_q_on_curve_err));
            tmp *= scaling_factor;
