...
struct lookup_nullifier_check_updated_low_leaf_poseidon2_settings_ {
    ...
    static constexpr std::string_view RELATION_NAME = "nullifier_check";
    static constexpr size_t LOOKUP_TUPLE_SIZE = 5;
    static constexpr Column SRC_SELECTOR = Column::nullifier_check_sel_insert;
    static constexpr Column DST_SELECTOR = Column::poseidon2_hash_start;
...
struct lookup_nullifier_check_low_leaf_merkle_check_settings_ {
    ...
    static constexpr std::array<ColumnAndShifts, LOOKUP_TUPLE_SIZE> SRC_COLUMNS = {
        ColumnAndShifts::nullifier_check_sel_insert,
        ColumnAndShifts::nullifier_check_low_leaf_hash,
        ColumnAndShifts::nullifier_check_updated_low_leaf_hash,
...
struct lookup_nullifier_check_write_nullifier_to_public_inputs_settings_ {
    ...
    static constexpr Column SRC_SELECTOR = Column::nullifier_check_sel_write_to_public_inputs;
