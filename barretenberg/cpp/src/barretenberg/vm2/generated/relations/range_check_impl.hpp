                                      ...
                                      [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::range_check_sel_sha256)) *
                   (FF(1) - static_cast<View>(in.get(C::range_check_sel_sha256)));
    ...
    }
    {
        ...
        auto tmp =
            (static_cast<View>(in.get(C::range_check_sel_keccak)) + static_cast<View>(in.get(C::range_check_sel_gt)) +
             ...
             static_cast<View>(in.get(C::range_check_sel_sha256))) *
