                                    ...
                                    [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    const auto constants_DOM_SEP__INT_WRITTEN_PUBLIC_DATA_SLOT_LEAF = FF(4178345146UL);
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::execution_sel_gas_sstore)) *
                   (static_cast<View>(in.get(C::execution_written_slots_leaf_separator)) -
                    CView(constants_DOM_SEP__INT_WRITTEN_PUBLIC_DATA_SLOT_LEAF));
