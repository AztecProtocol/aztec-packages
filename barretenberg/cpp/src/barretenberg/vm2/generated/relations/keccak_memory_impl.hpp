                                        ...
                                        [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    { // SEL_ON_START_OR_END
        ...
        auto tmp = (static_cast<View>(in.get(C::keccak_memory_start_read)) +
                    ...
                    static_cast<View>(in.get(C::keccak_memory_end))) *
    ...
    { // TRACE_CONTINUITY
        ...
        auto tmp =
            (FF(1) - CView(keccak_memory_LATCH_CONDITION)) *
            (static_cast<View>(in.get(C::keccak_memory_sel)) - static_cast<View>(in.get(C::keccak_memory_sel_shift)));
        std::get<2>(evals) += (tmp * scaling_factor);
    }
    { // START_AFTER_LATCH
        using View = typename std::tuple_element_t<3, ContainerOverSubrelations>::View;
        auto tmp = static_cast<View>(in.get(C::keccak_memory_sel_shift)) *
                   ((static_cast<View>(in.get(C::keccak_memory_start_read_shift)) +
                     static_cast<View>(in.get(C::keccak_memory_start_write_shift))) -
    ...
    { // END
        ...
        auto tmp = (static_cast<View>(in.get(C::keccak_memory_end)) -
    ...
    { // CTR_INCREMENT
        ...
        auto tmp =
            static_cast<View>(in.get(C::keccak_memory_sel)) * (FF(1) - CView(keccak_memory_LATCH_CONDITION)) *
    ...
    { // TAG_ERROR_PROPAGATION
        ...
        auto tmp = (FF(1) - CView(keccak_memory_LATCH_CONDITION)) *
                   (static_cast<View>(in.get(C::keccak_memory_tag_error)) -
    ...
    { // MEM_ADDR_INCREMENT
        ...
        auto tmp = static_cast<View>(in.get(C::keccak_memory_sel)) * (FF(1) - CView(keccak_memory_LATCH_CONDITION)) *
    ...
    { // VAL01
        ...
        auto tmp =
            (static_cast<View>(in.get(C::keccak_memory_val_1_)) -
             (FF(1) - CView(keccak_memory_LATCH_CONDITION)) * static_cast<View>(in.get(C::keccak_memory_val_0__shift)));
        std::get<22>(evals) += (tmp * scaling_factor);
    }
    { // VAL02
        using View = typename std::tuple_element_t<23, ContainerOverSubrelations>::View;
        auto tmp =
            (static_cast<View>(in.get(C::keccak_memory_val_2_)) -
             (FF(1) - CView(keccak_memory_LATCH_CONDITION)) * static_cast<View>(in.get(C::keccak_memory_val_1__shift)));
        std::get<23>(evals) += (tmp * scaling_factor);
    }
    { // VAL03
        using View = typename std::tuple_element_t<24, ContainerOverSubrelations>::View;
        auto tmp =
            (static_cast<View>(in.get(C::keccak_memory_val_3_)) -
             (FF(1) - CView(keccak_memory_LATCH_CONDITION)) * static_cast<View>(in.get(C::keccak_memory_val_2__shift)));
        std::get<24>(evals) += (tmp * scaling_factor);
    }
    { // VAL04
        using View = typename std::tuple_element_t<25, ContainerOverSubrelations>::View;
        auto tmp =
            (static_cast<View>(in.get(C::keccak_memory_val_4_)) -
             (FF(1) - CView(keccak_memory_LATCH_CONDITION)) * static_cast<View>(in.get(C::keccak_memory_val_3__shift)));
        std::get<25>(evals) += (tmp * scaling_factor);
    }
    { // VAL05
        using View = typename std::tuple_element_t<26, ContainerOverSubrelations>::View;
        auto tmp =
            (static_cast<View>(in.get(C::keccak_memory_val_5_)) -
             (FF(1) - CView(keccak_memory_LATCH_CONDITION)) * static_cast<View>(in.get(C::keccak_memory_val_4__shift)));
        std::get<26>(evals) += (tmp * scaling_factor);
    }
    { // VAL06
        using View = typename std::tuple_element_t<27, ContainerOverSubrelations>::View;
        auto tmp =
            (static_cast<View>(in.get(C::keccak_memory_val_6_)) -
             (FF(1) - CView(keccak_memory_LATCH_CONDITION)) * static_cast<View>(in.get(C::keccak_memory_val_5__shift)));
        std::get<27>(evals) += (tmp * scaling_factor);
    }
    { // VAL07
        using View = typename std::tuple_element_t<28, ContainerOverSubrelations>::View;
        auto tmp =
            (static_cast<View>(in.get(C::keccak_memory_val_7_)) -
    ...
    { // VAL08
        ...
        auto tmp =
            (static_cast<View>(in.get(C::keccak_memory_val_8_)) -
             (FF(1) - CView(keccak_memory_LATCH_CONDITION)) * static_cast<View>(in.get(C::keccak_memory_val_7__shift)));
        std::get<29>(evals) += (tmp * scaling_factor);
    }
    { // VAL09
        using View = typename std::tuple_element_t<30, ContainerOverSubrelations>::View;
        auto tmp =
            (static_cast<View>(in.get(C::keccak_memory_val_9_)) -
             (FF(1) - CView(keccak_memory_LATCH_CONDITION)) * static_cast<View>(in.get(C::keccak_memory_val_8__shift)));
        std::get<30>(evals) += (tmp * scaling_factor);
    }
    { // VAL10
        using View = typename std::tuple_element_t<31, ContainerOverSubrelations>::View;
        auto tmp =
            (static_cast<View>(in.get(C::keccak_memory_val_10_)) -
             (FF(1) - CView(keccak_memory_LATCH_CONDITION)) * static_cast<View>(in.get(C::keccak_memory_val_9__shift)));
