...
INSTANTIATE_LOOKUP(lookup_nullifier_check_low_leaf_poseidon2_0_relation);
INSTANTIATE_LOOKUP(lookup_nullifier_check_low_leaf_poseidon2_1_relation);
INSTANTIATE_LOOKUP(lookup_nullifier_check_updated_low_leaf_poseidon2_0_relation);
INSTANTIATE_LOOKUP(lookup_nullifier_check_updated_low_leaf_poseidon2_1_relation);
...
INSTANTIATE_LOOKUP(lookup_nullifier_check_new_leaf_poseidon2_0_relation);
INSTANTIATE_LOOKUP(lookup_nullifier_check_new_leaf_poseidon2_1_relation);
