...
template class note_hash_tree_checkImpl<AvmFlavorSettings::FF>;
ACCUMULATE(note_hash_tree_checkImpl, AvmFlavor, SumcheckTupleOfUnivariatesOverSubrelations, ExtendedEdge); // Prover.
ACCUMULATE(note_hash_tree_checkImpl, AvmFlavor, SumcheckArrayOfValuesOverSubrelations, EvaluationEdge);    // Verifier.
