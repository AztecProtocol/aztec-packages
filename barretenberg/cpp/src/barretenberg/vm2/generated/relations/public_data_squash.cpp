...
template class public_data_squashImpl<AvmFlavorSettings::FF>;
ACCUMULATE(public_data_squashImpl, AvmFlavor, SumcheckTupleOfUnivariatesOverSubrelations, ExtendedEdge); // Prover.
ACCUMULATE(public_data_squashImpl, AvmFlavor, SumcheckArrayOfValuesOverSubrelations, EvaluationEdge);    // Verifier.
