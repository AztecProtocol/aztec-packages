...
struct lookup_alu_register_tag_value_settings_ {
    ...
    static constexpr auto DST_EXPRS = std::make_tuple(ColumnExpression(ColumnAndShifts::alu_ia),
                                                      ...
                                                      ColumnExpression(ColumnAndShifts::alu_sel_err));
...
struct lookup_alu_range_check_decomposition_a_lo_settings_ {
    ...
    static constexpr auto SRC_SELECTOR_EXPR = ColumnExpression(ColumnAndShifts::alu_sel_decompose_a);
    static constexpr auto DST_SELECTOR_EXPR = ColumnExpression(ColumnAndShifts::range_check_sel);
    static constexpr auto SRC_EXPRS =
        std::make_tuple(ColumnExpression(ColumnAndShifts::alu_a_lo), ColumnExpression(ColumnAndShifts::alu_a_lo_bits));
...
struct lookup_alu_range_check_decomposition_a_hi_settings_ {
    ...
    static constexpr auto DST_SELECTOR_EXPR = ColumnExpression(ColumnAndShifts::range_check_sel);
    static constexpr auto SRC_EXPRS =
        std::make_tuple(ColumnExpression(ColumnAndShifts::alu_a_hi), ColumnExpression(ColumnAndShifts::alu_a_hi_bits));
    static constexpr auto DST_EXPRS = std::make_tuple(ColumnExpression(ColumnAndShifts::range_check_value),
                                                      ColumnExpression(ColumnAndShifts::range_check_rng_chk_bits));
...
struct lookup_alu_range_check_decomposition_b_lo_settings_ {
    ...
    static constexpr std::string_view RELATION_NAME = "alu";
    static constexpr size_t LOOKUP_TUPLE_SIZE = 2;
    static constexpr auto SRC_SELECTOR_EXPR = ColumnExpression(ColumnAndShifts::alu_sel_mul_div_u128);
    static constexpr auto DST_SELECTOR_EXPR = ColumnExpression(ColumnAndShifts::range_check_sel);
...
struct lookup_alu_gt_div_remainder_settings_ {
    ...
    static constexpr std::string_view RELATION_NAME = "alu";
    static constexpr size_t LOOKUP_TUPLE_SIZE = 3;
    static constexpr auto SRC_SELECTOR_EXPR = ColumnExpression(ColumnAndShifts::alu_sel_div_no_0_err);
    static constexpr auto DST_SELECTOR_EXPR = ColumnExpression(ColumnAndShifts::gt_sel);
    static constexpr auto SRC_EXPRS = std::make_tuple(ColumnExpression(ColumnAndShifts::alu_ib),
                                                      ColumnExpression(ColumnAndShifts::alu_helper1),
                                                      ColumnExpression(ColumnAndShifts::alu_sel_op_div));
...
struct lookup_alu_shifts_two_pow_settings_ {
    ...
    static constexpr std::string_view RELATION_NAME = "alu";
    static constexpr size_t LOOKUP_TUPLE_SIZE = 2;
    static constexpr auto SRC_SELECTOR_EXPR = ColumnExpression(ColumnAndShifts::alu_sel_shift_ops_no_overflow);
    static constexpr auto DST_SELECTOR_EXPR = ColumnExpression(ColumnAndShifts::precomputed_sel_range_8);
    static constexpr auto SRC_EXPRS = std::make_tuple(ColumnExpression(ColumnAndShifts::alu_shift_lo_bits),
                                                      ColumnExpression(ColumnAndShifts::alu_two_pow_shift_lo_bits));
    static constexpr auto DST_EXPRS = std::make_tuple(ColumnExpression(ColumnAndShifts::precomputed_clk),
