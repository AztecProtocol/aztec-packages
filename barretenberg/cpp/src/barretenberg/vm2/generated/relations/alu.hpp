                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        const auto alu_EXPECTED_C_TAG =
            (in.get(C::alu_sel_op_add) + in.get(C::alu_sel_op_sub) + in.get(C::alu_sel_op_mul) +
             in.get(C::alu_sel_op_div) + in.get(C::alu_sel_op_fdiv) + in.get(C::alu_sel_op_truncate)) *
                in.get(C::alu_ia_tag) +
        ...
        const auto alu_DIV_OPS_NON_U128 =
            alu_DIV_OPS * ((alu_IS_NOT_U128 + in.get(C::alu_sel_is_ff)) - alu_IS_NOT_U128 * in.get(C::alu_sel_is_ff));
        ...
        { // ALU_FDIV_DIV_NON_U128
            ...
            auto tmp = alu_DIV_OPS_NON_U128 * (FF(1) - in.get(C::alu_sel_err)) *
                       (in.get(C::alu_ib) * in.get(C::alu_ic) -
