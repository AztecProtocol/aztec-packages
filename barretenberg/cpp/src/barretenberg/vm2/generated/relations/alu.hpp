...
template <typename FF_> class aluImpl {
  public:
    ...
    static constexpr std::array<size_t, 18> SUBRELATION_PARTIAL_LENGTHS = { 3, 3, 3, 2, 5, 3, 4, 3, 4,
                                                                            5, 3, 3, 2, 3, 3, 3, 3, 5 };
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        const auto alu_CHECK_TAG_FF = in.get(C::alu_sel_op_lt) + in.get(C::alu_sel_op_lte);
        ...
        }
        {
            ...
            auto tmp = (in.get(C::alu_sel_lt_ops) - (in.get(C::alu_sel_op_lt) + in.get(C::alu_sel_op_lte)));
            tmp *= scaling_factor;
