...
template <typename FF_> class aluImpl {
  public:
    ...
    static constexpr std::array<size_t, 52> SUBRELATION_PARTIAL_LENGTHS = { 3, 3, 3, 3, 2, 2, 5, 5, 4, 3, 6, 3, 3,
                                                                            6, 3, 6, 3, 5, 3, 5, 3, 3, 3, 5, 3, 6,
                                                                            3, 2, 5, 3, 6, 3, 3, 3, 3, 3, 3, 3, 4,
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        { // DIV_0_ERR
            ...
            auto tmp = (in.get(C::alu_sel_op_div) *
                            ((in.get(C::alu_ib) * (in.get(C::alu_sel_div_0_err) * (FF(1) - in.get(C::alu_b_inv)) +
                                                   in.get(C::alu_b_inv)) +
                              in.get(C::alu_sel_div_0_err)) -
                             FF(1)) +
                        in.get(C::alu_sel_div_0_err) * (in.get(C::alu_sel_div_0_err) - in.get(C::alu_sel_op_div)));
            tmp *= scaling_factor;
        ...
        { // ALU_DIV_U128
            ...
            auto tmp =
                in.get(C::alu_sel_div_u128) * (FF(1) - in.get(C::alu_sel_err)) *
...
template <typename FF> class alu : public Relation<aluImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_AB_TAGS_CHECK = 10;
    static constexpr size_t SR_ALU_ADD_SUB = 13;
    static constexpr size_t SR_ALU_MUL_NON_U128 = 15;
    static constexpr size_t SR_A_DECOMPOSITION = 17;
    static constexpr size_t SR_B_DECOMPOSITION = 18;
    static constexpr size_t SR_ALU_MUL_U128 = 19;
    static constexpr size_t SR_DIV_0_ERR = 23;
    static constexpr size_t SR_ALU_DIV_NON_U128 = 25;
    static constexpr size_t SR_ALU_DIV_U128 = 28;
    static constexpr size_t SR_EQ_OP_MAIN = 30;
    static constexpr size_t SR_LT_SWAP_INPUTS_A = 36;
    static constexpr size_t SR_LT_SWAP_INPUTS_B = 37;
    static constexpr size_t SR_LTE_NEGATE_RESULT_C = 38;
    static constexpr size_t SR_NOT_OP_MAIN = 40;
    static constexpr size_t SR_NOT_OP_TAG_ERROR = 41;
