...
template <typename FF_> class aluImpl {
  public:
    ...
    static constexpr std::array<size_t, 62> SUBRELATION_PARTIAL_LENGTHS = {
        3, 3, 3, 3, 3, 2, 5, 5, 4, 3, 3, 4, 6, 3, 6, 5, 3, 3, 4, 3, 3, 6, 3, 6, 3, 5, 3, 3, 3, 6, 6,
        3, 3, 5, 6, 3, 6, 3, 3, 3, 3, 3, 3, 3, 4, 3, 4, 6, 6, 5, 2, 4, 3, 3, 3, 3, 2, 2, 3, 3, 4, 3
    };
...
template <typename FF> class alu : public Relation<aluImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_SHIFTS_LO_BITS = 51;
    static constexpr size_t SR_SEL_TRUNC_NON_TRIVIAL = 56;
    static constexpr size_t SR_SEL_TRUNCATE = 57;
    static constexpr size_t SR_TRUNC_TRIVIAL_CASE = 58;
    static constexpr size_t SR_SMALL_TRUNC_VAL_IS_LO = 59;
    static constexpr size_t SR_TRUNC_LO_128_DECOMPOSITION = 60;
    static constexpr size_t SR_TRUNC_MID_BITS = 61;
};
