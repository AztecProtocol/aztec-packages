  ...
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        { // CLASS_ID_NEXT_ROW
            ...
            auto tmp = execution_NOT_LAST_EXEC * execution_DEFAULT_CTX_ROW *
                       (in.get(C::execution_class_id_shift) - in.get(C::execution_class_id));
            tmp *= scaling_factor;
...
template <typename FF> class context : public Relation<contextImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_CLASS_ID_NEXT_ROW = 21;
