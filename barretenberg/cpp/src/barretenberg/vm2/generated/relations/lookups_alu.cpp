...
INSTANTIATE_LOOKUP(lookup_alu_range_check_mul_u128_a_lo_relation);
INSTANTIATE_LOOKUP(lookup_alu_range_check_mul_u128_a_hi_relation);
INSTANTIATE_LOOKUP(lookup_alu_range_check_mul_u128_b_lo_relation);
INSTANTIATE_LOOKUP(lookup_alu_range_check_mul_u128_b_hi_relation);
