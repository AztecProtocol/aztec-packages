...
struct lookup_public_data_check_write_public_data_to_public_inputs_settings_ {
    ...
    static constexpr auto SRC_EXPRS = std::make_tuple(ColumnExpression(ColumnAndShifts::public_data_check_write_idx),
                                                      ColumnExpression(ColumnAndShifts::public_data_check_leaf_slot),
                                                      ColumnExpression(ColumnAndShifts::public_data_check_final_value));
...
struct lookup_public_data_check_write_writes_length_to_public_inputs_settings_ {
    ...
    static constexpr auto SRC_SELECTOR_EXPR = ColumnExpression(ColumnAndShifts::public_data_check_end);
    static constexpr auto DST_SELECTOR_EXPR = ColumnExpression(ColumnAndShifts::public_inputs_sel);
    static constexpr auto SRC_EXPRS =
        std::make_tuple(ColumnExpression(ColumnAndShifts::public_data_check_length_pi_idx),
                        ColumnExpression(ColumnAndShifts::public_data_check_public_data_writes_length));
    static constexpr auto DST_EXPRS = std::make_tuple(ColumnExpression(ColumnAndShifts::precomputed_clk),
                                                      ColumnExpression(ColumnAndShifts::public_inputs_cols_0_));
