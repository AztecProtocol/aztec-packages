...
template <typename FF_> class cd_hashingImpl {
  public:
    using FF = FF_;
...
template <typename FF> class cd_hashing : public Relation<cd_hashingImpl<FF>> {
  public:
    static constexpr const std::string_view NAME = "cd_hashing";
