                                       ...
                                       [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    { // TRACE_CONTINUITY
        ...
        auto tmp =
            ...
            (static_cast<View>(in.get(C::merkle_check_sel)) - static_cast<View>(in.get(C::merkle_check_sel_shift)));
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::merkle_check_sel)) *
                   (static_cast<View>(in.get(C::merkle_check_const_three)) - FF(3));
        std::get<19>(evals) += (tmp * scaling_factor);
    }
    { // PROPAGATE_MERKLE_HASH_SEPARATOR
        using View = typename std::tuple_element_t<20, ContainerOverSubrelations>::View;
        auto tmp = (FF(1) - CView(merkle_check_LATCH_CONDITION)) *
                   (static_cast<View>(in.get(C::merkle_check_merkle_hash_separator_shift)) -
                    static_cast<View>(in.get(C::merkle_check_merkle_hash_separator)));
