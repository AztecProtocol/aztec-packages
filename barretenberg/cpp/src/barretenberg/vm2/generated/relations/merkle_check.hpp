...
template <typename FF_> class merkle_checkImpl {
  public:
    ...
    static constexpr std::array<size_t, 23> SUBRELATION_PARTIAL_LENGTHS = { 3, 3, 3, 5, 4, 3, 3, 3, 3, 3, 4, 3,
...
template <typename FF> class merkle_check : public Relation<merkle_checkImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_NO_ACTIVITY_ON_FIRST_ROW = 6;
    ...
    static std::string get_subrelation_label(size_t index)
    {
        ...
        case SR_NO_ACTIVITY_ON_FIRST_ROW:
            return "NO_ACTIVITY_ON_FIRST_ROW";
