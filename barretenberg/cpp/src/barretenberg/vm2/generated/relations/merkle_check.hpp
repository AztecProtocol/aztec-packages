...
template <typename FF_> class merkle_checkImpl {
  public:
    ...
    static constexpr std::array<size_t, 23> SUBRELATION_PARTIAL_LENGTHS = { 3, 3, 3, 4, 5, 3, 3, 3, 4, 4, 4, 4,
...
template <typename FF> class merkle_check : public Relation<merkle_checkImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_END_IFF_REM_PATH_EMPTY = 4;
    ...
    static constexpr size_t SR_FINAL_INDEX_IS_ODD_BOOLEAN = 14;
    ...
    static std::string get_subrelation_label(size_t index)
    {
        ...
        case SR_FINAL_INDEX_IS_ODD_BOOLEAN:
            return "FINAL_INDEX_IS_ODD_BOOLEAN";
