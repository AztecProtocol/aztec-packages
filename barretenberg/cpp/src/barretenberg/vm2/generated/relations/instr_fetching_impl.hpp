                                         ...
                                         [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    BB_BENCH_NESTED_NAME("accumulate/instr_fetching");
                 ...
                 (in.get(C::instr_fetching_sel_op_dc_0) *
                  ...
                  in.get(C::instr_fetching_sel_op_dc_11) *
                      (in.get(C::instr_fetching_bd5) * FF(72057594037927936UL) +
                       ...
                       in.get(C::instr_fetching_bd8) * FF(4294967296UL) + in.get(C::instr_fetching_bd9) * FF(16777216) +
                       in.get(C::instr_fetching_bd10) * FF(65536) + in.get(C::instr_fetching_bd11) * FF(256) +
                       in.get(C::instr_fetching_bd12) * FF(1)) +
