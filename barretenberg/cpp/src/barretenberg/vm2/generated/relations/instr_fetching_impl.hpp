                                         ...
                                         [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::instr_fetching_opcode_out_of_range)) *
                   (FF(1) - static_cast<View>(in.get(C::instr_fetching_opcode_out_of_range)));
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::instr_fetching_tag_out_of_range)) *
                   (FF(1) - static_cast<View>(in.get(C::instr_fetching_tag_out_of_range)));
