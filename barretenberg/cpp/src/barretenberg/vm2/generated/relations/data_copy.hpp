...
template <typename FF_> class data_copyImpl {
  public:
    ...
    static constexpr std::array<size_t, 36> SUBRELATION_PARTIAL_LENGTHS = { 3, 3, 2, 3, 3, 3, 3, 5, 3, 6, 3, 5,
                                                                            5, 3, 3, 4, 7, 5, 3, 3, 4, 6, 3, 3,
                                                                            6, 6, 3, 4, 5, 4, 5, 5, 6, 5, 5, 6 };
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        const auto data_copy_MAX_READ_INDEX =
            ...
            (FF(1) - in.get(C::data_copy_src_data_size_is_lt)) *
                (in.get(C::data_copy_offset) + in.get(C::data_copy_copy_size));
        ...
        const auto data_copy_WRITE_CNT_MINUS_ONE = (in.get(C::data_copy_copy_size) - FF(1));
        ...
        }
        {
            ...
            auto tmp = data_copy_SEL * in.get(C::data_copy_sel_start) * (FF(1) - in.get(C::data_copy_tag_check_err)) *
                       (in.get(C::data_copy_copy_size_mem_tag) - constants_MEM_TAG_U32);
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp = data_copy_SEL * in.get(C::data_copy_sel_start) * (FF(1) - in.get(C::data_copy_tag_check_err)) *
                       (in.get(C::data_copy_offset_mem_tag) - constants_MEM_TAG_U32);
            tmp *= scaling_factor;
...
template <typename FF> class data_copy : public Relation<data_copyImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_END_AFTER_START = 20;
    static constexpr size_t SR_END_WRITE_CONDITION = 21;
    static constexpr size_t SR_END_ON_ERR = 22;
    static constexpr size_t SR_INIT_READ_COUNT = 25;
    static constexpr size_t SR_DECR_COPY_SIZE = 27;
    static constexpr size_t SR_INCR_WRITE_ADDR = 28;
