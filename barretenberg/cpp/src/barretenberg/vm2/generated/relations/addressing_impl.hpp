                                     ...
                                     [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    BB_BENCH_NESTED_NAME("accumulate/addressing");
...

    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_relative_wire_0_) * (FF(1) - in.get(C::execution_sel_op_is_relative_wire_0_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_relative_wire_1_) * (FF(1) - in.get(C::execution_sel_op_is_relative_wire_1_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_relative_wire_2_) * (FF(1) - in.get(C::execution_sel_op_is_relative_wire_2_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_relative_wire_3_) * (FF(1) - in.get(C::execution_sel_op_is_relative_wire_3_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_relative_wire_4_) * (FF(1) - in.get(C::execution_sel_op_is_relative_wire_4_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_relative_wire_5_) * (FF(1) - in.get(C::execution_sel_op_is_relative_wire_5_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_relative_wire_6_) * (FF(1) - in.get(C::execution_sel_op_is_relative_wire_6_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_relative_wire_7_) * (FF(1) - in.get(C::execution_sel_op_is_relative_wire_7_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_indirect_wire_0_) * (FF(1) - in.get(C::execution_sel_op_is_indirect_wire_0_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_indirect_wire_1_) * (FF(1) - in.get(C::execution_sel_op_is_indirect_wire_1_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_indirect_wire_2_) * (FF(1) - in.get(C::execution_sel_op_is_indirect_wire_2_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_indirect_wire_3_) * (FF(1) - in.get(C::execution_sel_op_is_indirect_wire_3_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_indirect_wire_4_) * (FF(1) - in.get(C::execution_sel_op_is_indirect_wire_4_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_indirect_wire_5_) * (FF(1) - in.get(C::execution_sel_op_is_indirect_wire_5_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_indirect_wire_6_) * (FF(1) - in.get(C::execution_sel_op_is_indirect_wire_6_));
        tmp *= scaling_factor;
    ...
    }
    {
        ...
        auto tmp =
            in.get(C::execution_sel_op_is_indirect_wire_7_) * (FF(1) - in.get(C::execution_sel_op_is_indirect_wire_7_));
        tmp *= scaling_factor;
    ...
    { // NUM_RELATIVE_INV_CHECK
        ...
        auto tmp = ((execution_NUM_RELATIVE_X *
                         (execution_NUM_RELATIVE_E * (FF(1) - execution_NUM_RELATIVE_Y) + execution_NUM_RELATIVE_Y) -
                     FF(1)) +
    ...
    { // RELATIVE_OVERFLOW_RESULT_0
        ...
        auto tmp =
            (in.get(C::execution_overflow_range_check_result_0_) -
             in.get(C::execution_sel_op_is_relative_effective_0_) *
                 (((FF(1) - in.get(C::execution_sel_relative_overflow_0_)) *
                       ((FF(2) * in.get(C::execution_two_to_32) - FF(2) * in.get(C::execution_op_after_relative_0_)) -
                        FF(1)) +
    ...
    { // RELATIVE_OVERFLOW_RESULT_1
        ...
        auto tmp =
            (in.get(C::execution_overflow_range_check_result_1_) -
             in.get(C::execution_sel_op_is_relative_effective_1_) *
                 (((FF(1) - in.get(C::execution_sel_relative_overflow_1_)) *
                       ((FF(2) * in.get(C::execution_two_to_32) - FF(2) * in.get(C::execution_op_after_relative_1_)) -
                        FF(1)) +
    ...
    { // RELATIVE_OVERFLOW_RESULT_2
        ...
        auto tmp =
            (in.get(C::execution_overflow_range_check_result_2_) -
             in.get(C::execution_sel_op_is_relative_effective_2_) *
                 (((FF(1) - in.get(C::execution_sel_relative_overflow_2_)) *
                       ((FF(2) * in.get(C::execution_two_to_32) - FF(2) * in.get(C::execution_op_after_relative_2_)) -
                        FF(1)) +
    ...
    { // RELATIVE_OVERFLOW_RESULT_3
        ...
        auto tmp =
            (in.get(C::execution_overflow_range_check_result_3_) -
             in.get(C::execution_sel_op_is_relative_effective_3_) *
                 (((FF(1) - in.get(C::execution_sel_relative_overflow_3_)) *
                       ((FF(2) * in.get(C::execution_two_to_32) - FF(2) * in.get(C::execution_op_after_relative_3_)) -
                        FF(1)) +
    ...
    { // RELATIVE_OVERFLOW_RESULT_4
        ...
        auto tmp =
            (in.get(C::execution_overflow_range_check_result_4_) -
             in.get(C::execution_sel_op_is_relative_effective_4_) *
                 (((FF(1) - in.get(C::execution_sel_relative_overflow_4_)) *
                       ((FF(2) * in.get(C::execution_two_to_32) - FF(2) * in.get(C::execution_op_after_relative_4_)) -
                        FF(1)) +
    ...
    { // RELATIVE_OVERFLOW_RESULT_5
        ...
        auto tmp =
            (in.get(C::execution_overflow_range_check_result_5_) -
             in.get(C::execution_sel_op_is_relative_effective_5_) *
                 (((FF(1) - in.get(C::execution_sel_relative_overflow_5_)) *
                       ((FF(2) * in.get(C::execution_two_to_32) - FF(2) * in.get(C::execution_op_after_relative_5_)) -
                        FF(1)) +
    ...
    { // RELATIVE_OVERFLOW_RESULT_6
        ...
        auto tmp =
            (in.get(C::execution_overflow_range_check_result_6_) -
             in.get(C::execution_sel_op_is_relative_effective_6_) *
                 (((FF(1) - in.get(C::execution_sel_relative_overflow_6_)) *
                       ((FF(2) * in.get(C::execution_two_to_32) - FF(2) * in.get(C::execution_op_after_relative_6_)) -
                        FF(1)) +
