...
struct lookup_context_ctx_stack_call_settings_ {
    ...
    static constexpr auto SRC_EXPRS =
        std::make_tuple(ColumnExpression(ColumnAndShifts::execution_next_context_id),
    ...
    static constexpr auto DST_EXPRS =
        std::make_tuple(ColumnExpression(ColumnAndShifts::context_stack_entered_context_id),
                        ...
                        ColumnExpression(ColumnAndShifts::context_stack_bytecode_id),
                        ...
                        ColumnExpression(ColumnAndShifts::context_stack_note_hash_tree_root),
                        ColumnExpression(ColumnAndShifts::context_stack_note_hash_tree_size),
                        ColumnExpression(ColumnAndShifts::context_stack_num_note_hashes_emitted),
                        ColumnExpression(ColumnAndShifts::context_stack_nullifier_tree_root),
                        ColumnExpression(ColumnAndShifts::context_stack_nullifier_tree_size),
                        ColumnExpression(ColumnAndShifts::context_stack_num_nullifiers_emitted),
                        ColumnExpression(ColumnAndShifts::context_stack_public_data_tree_root),
                        ColumnExpression(ColumnAndShifts::context_stack_public_data_tree_size),
                        ColumnExpression(ColumnAndShifts::context_stack_written_public_data_slots_tree_root),
                        ColumnExpression(ColumnAndShifts::context_stack_written_public_data_slots_tree_size),
                        ColumnExpression(ColumnAndShifts::context_stack_num_unencrypted_logs),
                        ColumnExpression(ColumnAndShifts::context_stack_num_l2_to_l1_messages));
...
struct lookup_context_ctx_stack_rollback_settings_ {
    ...
    static constexpr auto SRC_EXPRS =
        std::make_tuple(ColumnExpression(ColumnAndShifts::execution_context_id),
                        ...
                        ColumnExpression(ColumnAndShifts::execution_bytecode_id_shift),
                        ...
                        ColumnExpression(ColumnAndShifts::execution_prev_note_hash_tree_root_shift),
                        ColumnExpression(ColumnAndShifts::execution_prev_note_hash_tree_size_shift),
                        ColumnExpression(ColumnAndShifts::execution_prev_num_note_hashes_emitted_shift),
                        ColumnExpression(ColumnAndShifts::execution_prev_nullifier_tree_root_shift),
                        ColumnExpression(ColumnAndShifts::execution_prev_nullifier_tree_size_shift),
                        ColumnExpression(ColumnAndShifts::execution_prev_num_nullifiers_emitted_shift),
                        ColumnExpression(ColumnAndShifts::execution_prev_public_data_tree_root_shift),
                        ColumnExpression(ColumnAndShifts::execution_prev_public_data_tree_size_shift),
                        ColumnExpression(ColumnAndShifts::execution_prev_written_public_data_slots_tree_root_shift),
                        ColumnExpression(ColumnAndShifts::execution_prev_written_public_data_slots_tree_size_shift),
                        ColumnExpression(ColumnAndShifts::execution_prev_num_unencrypted_logs_shift),
                        ColumnExpression(ColumnAndShifts::execution_prev_num_l2_to_l1_messages_shift));
    static constexpr auto DST_EXPRS =
        std::make_tuple(ColumnExpression(ColumnAndShifts::context_stack_entered_context_id),
                        ColumnExpression(ColumnAndShifts::context_stack_context_id),
                        ColumnExpression(ColumnAndShifts::context_stack_parent_id),
