...
INSTANTIATE_LOOKUP(lookup_indexed_tree_check_silo_poseidon2_relation);
...
INSTANTIATE_LOOKUP(lookup_indexed_tree_check_low_leaf_poseidon2_0_relation);
INSTANTIATE_LOOKUP(lookup_indexed_tree_check_low_leaf_poseidon2_1_relation);
INSTANTIATE_LOOKUP(lookup_indexed_tree_check_updated_low_leaf_poseidon2_0_relation);
INSTANTIATE_LOOKUP(lookup_indexed_tree_check_updated_low_leaf_poseidon2_1_relation);
INSTANTIATE_LOOKUP(lookup_indexed_tree_check_low_leaf_merkle_check_relation);
INSTANTIATE_LOOKUP(lookup_indexed_tree_check_new_leaf_poseidon2_0_relation);
INSTANTIATE_LOOKUP(lookup_indexed_tree_check_new_leaf_poseidon2_1_relation);
INSTANTIATE_LOOKUP(lookup_indexed_tree_check_new_leaf_merkle_check_relation);
INSTANTIATE_LOOKUP(lookup_indexed_tree_check_write_value_to_public_inputs_relation);
