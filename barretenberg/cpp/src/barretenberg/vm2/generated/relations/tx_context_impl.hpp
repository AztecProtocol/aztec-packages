                                     ...
                                     [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    const auto constants_AVM_WRITTEN_PUBLIC_DATA_SLOTS_TREE_INITIAL_ROOT =
        FF(uint256_t{ 13835568930173632787UL, 11373218967491442555UL, 4627596537860364778UL, 274334309122216743UL });
    ...
    const auto constants_AVM_RETRIEVED_BYTECODES_TREE_INITIAL_ROOT =
        FF(uint256_t{ 18029251189887741473UL, 10749229437498904921UL, 14793489241644188647UL, 2318901730889315618UL });
