...
template <typename FF_> class note_hash_tree_checkImpl {
  public:
    ...
    static constexpr std::array<size_t, 18> SUBRELATION_PARTIAL_LENGTHS = { 3, 3, 3, 3, 3, 3, 3, 4, 3,
                                                                            3, 4, 3, 3, 3, 4, 3, 3, 4 };
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        }
        {
            ...
            auto tmp =
                ...
                (((FF(0) - in.get(C::note_hash_tree_check_unique_note_hash)) * in.get(C::note_hash_tree_check_write) +
        ...
        }
        {
            ...
            auto tmp = in.get(C::note_hash_tree_check_write) * (in.get(C::note_hash_tree_check_siloed_note_hash) -
        ...
        }
        {
            ...
            auto tmp = (in.get(C::note_hash_tree_check_sel) * in.get(C::note_hash_tree_check_write) *
