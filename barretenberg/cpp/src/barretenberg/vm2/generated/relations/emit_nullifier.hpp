...
template <typename FF_> class emit_nullifierImpl {
  public:
    ...
    static constexpr std::array<size_t, 10> SUBRELATION_PARTIAL_LENGTHS = { 3, 5, 4, 4, 3, 3, 3, 4, 4, 4 };
...
template <typename FF> class emit_nullifier : public Relation<emit_nullifierImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_EMIT_NULLIFIER_TREE_ROOT_NOT_CHANGED = 7;
    static constexpr size_t SR_EMIT_NULLIFIER_TREE_SIZE_INCREASE = 8;
    static constexpr size_t SR_EMIT_NULLIFIER_NUM_NULLIFIERS_EMITTED_INCREASE = 9;
