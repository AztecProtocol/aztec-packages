                                  ...
                                  [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    }
    {
        ...
        auto tmp =
            static_cast<View>(in.get(C::bitwise_start_keccak)) * (FF(1) - static_cast<View>(in.get(C::bitwise_start)));
    ...
    }
    {
        ...
        auto tmp =
            static_cast<View>(in.get(C::bitwise_start_sha256)) * (FF(1) - static_cast<View>(in.get(C::bitwise_start)));
