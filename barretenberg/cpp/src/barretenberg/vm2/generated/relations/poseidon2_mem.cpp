...
template class poseidon2_memImpl<AvmFlavorSettings::FF>;
ACCUMULATE(poseidon2_memImpl, AvmFlavor, SumcheckTupleOfUnivariatesOverSubrelations, ExtendedEdge);   // Prover.
ACCUMULATE(poseidon2_memImpl, AvmFlavor, SumcheckArrayOfValuesOverSubrelations, EvaluationEdge);      // Verifier.
ACCUMULATE(poseidon2_memImpl, AvmFlavor, SumcheckArrayOfValuesOverSubrelations, AvmCheckCircuitEdge); // Check circuit.
ACCUMULATE(poseidon2_memImpl,
           AvmFlavor,
