...
INSTANTIATE_LOOKUP(lookup_external_call_is_l2_gas_left_gt_alllocated_relation);
INSTANTIATE_LOOKUP(lookup_external_call_is_da_gas_left_gt_alllocated_relation);
