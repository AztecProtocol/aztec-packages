                             ...
                             [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    }
    {
        ...
        auto tmp = (static_cast<View>(in.get(C::gt_sel_addressing)) + static_cast<View>(in.get(C::gt_sel_alu)) +
                    static_cast<View>(in.get(C::gt_sel_gas)) + static_cast<View>(in.get(C::gt_sel_others))) *
