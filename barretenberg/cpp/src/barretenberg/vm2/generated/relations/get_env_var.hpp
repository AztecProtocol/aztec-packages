...
template <typename FF_> class get_env_varImpl {
  public:
    ...
    static constexpr std::array<size_t, 12> SUBRELATION_PARTIAL_LENGTHS = { 3, 5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4 };
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        { // SHOULD_TRY_TO_GET_ENV_IF_NO_ERRORS
            ...
            auto tmp = execution_TRY_GET_ENV_VAR * (FF(1) - in.get(C::execution_opcode_error)) *
        ...
        { // SET_OUTPUT_REGISTER_TO_0_ON_ERROR
            ...
            auto tmp = in.get(C::execution_sel) * (FF(1) - in.get(C::execution_sel_should_get_env_var)) *
