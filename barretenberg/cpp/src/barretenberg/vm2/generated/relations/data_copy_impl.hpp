                                    ...
                                    [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    const auto data_copy_SEL_PERFORM_COPY =
        in.get(C::data_copy_start_no_err) * (FF(1) - in.get(C::data_copy_sel_write_count_is_zero)) +
        in.get(C::data_copy_sel) * (FF(1) - in.get(C::data_copy_start));
    ...
    }
    {
        ...
        auto tmp =
            static_cast<View>(in.get(C::data_copy_start)) * (FF(1) - static_cast<View>(in.get(C::data_copy_start)));
        std::get<2>(evals) += (tmp * scaling_factor);
    }
    {
        using View = typename std::tuple_element_t<3, ContainerOverSubrelations>::View;
        auto tmp = static_cast<View>(in.get(C::data_copy_end)) * (FF(1) - static_cast<View>(in.get(C::data_copy_end)));
        std::get<3>(evals) += (tmp * scaling_factor);
    }
    { // SEL_ON_START_OR_END
        using View = typename std::tuple_element_t<4, ContainerOverSubrelations>::View;
        auto tmp = (static_cast<View>(in.get(C::data_copy_start)) + static_cast<View>(in.get(C::data_copy_end))) *
    ...
    { // TRACE_CONTINUITY
        ...
        auto tmp = (FF(1) - CView(data_copy_LATCH_CONDITION)) *
                   (static_cast<View>(in.get(C::data_copy_sel)) - static_cast<View>(in.get(C::data_copy_sel_shift)));
    ...
    { // START_AFTER_LATCH
        ...
        auto tmp = static_cast<View>(in.get(C::data_copy_sel_shift)) *
                   (static_cast<View>(in.get(C::data_copy_start_shift)) - CView(data_copy_LATCH_CONDITION));
    ...
    }
    {
        ...
        auto tmp =
            (static_cast<View>(in.get(C::data_copy_sel_cd_copy_start)) -
             static_cast<View>(in.get(C::data_copy_start)) * static_cast<View>(in.get(C::data_copy_sel_cd_copy)));
    ...
    }
    {
        ...
        auto tmp = (static_cast<View>(in.get(C::data_copy_sel_rd_copy_start)) -
                    static_cast<View>(in.get(C::data_copy_start)) *
                        (FF(1) - static_cast<View>(in.get(C::data_copy_sel_cd_copy))));
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::data_copy_start)) *
    ...
    }
    {
        ...
        auto tmp = (static_cast<View>(in.get(C::data_copy_read_addr_upper_bound)) -
                    static_cast<View>(in.get(C::data_copy_start)) *
                        (static_cast<View>(in.get(C::data_copy_src_addr)) + CView(data_copy_READ_INDEX_UPPER_BOUND)));
        std::get<11>(evals) += (tmp * scaling_factor);
    }
    {
        using View = typename std::tuple_element_t<12, ContainerOverSubrelations>::View;
        auto tmp = (static_cast<View>(in.get(C::data_copy_clamped_read_index_upper_bound)) -
                    static_cast<View>(in.get(C::data_copy_start)) *
                        (CView(data_copy_READ_INDEX_UPPER_BOUND) *
                             (FF(1) - static_cast<View>(in.get(C::data_copy_src_reads_exceed_mem))) +
                         (static_cast<View>(in.get(C::data_copy_mem_size)) -
                          static_cast<View>(in.get(C::data_copy_src_addr))) *
                             static_cast<View>(in.get(C::data_copy_src_reads_exceed_mem))));
    ...
    }
    {
        ...
        auto tmp =
            (static_cast<View>(in.get(C::data_copy_write_addr_upper_bound)) -
             static_cast<View>(in.get(C::data_copy_start)) * (static_cast<View>(in.get(C::data_copy_dst_addr)) +
    ...
    }
    {
        ...
        auto tmp = (static_cast<View>(in.get(C::data_copy_start_no_err)) -
                    static_cast<View>(in.get(C::data_copy_start)) *
                        (FF(1) - static_cast<View>(in.get(C::data_copy_dst_out_of_range_err))));
    ...
    { // END_IF_WRITE_IS_ZERO
        ...
        auto tmp = static_cast<View>(in.get(C::data_copy_start_no_err)) *
                   static_cast<View>(in.get(C::data_copy_sel_write_count_is_zero)) *
                   (static_cast<View>(in.get(C::data_copy_end)) - FF(1));
    ...
    { // END_WRITE_CONDITION
        ...
        auto tmp = CView(data_copy_SEL_PERFORM_COPY) *
                   ((CView(data_copy_WRITE_COUNT_MINUS_ONE) *
                         (static_cast<View>(in.get(C::data_copy_end)) *
    ...
    { // END_ON_ERR
        ...
        auto tmp = static_cast<View>(in.get(C::data_copy_start)) *
                   static_cast<View>(in.get(C::data_copy_dst_out_of_range_err)) *
                   (static_cast<View>(in.get(C::data_copy_end)) - FF(1));
    ...
    { // INIT_READS_LEFT
        ...
        auto tmp = static_cast<View>(in.get(C::data_copy_start_no_err)) *
                   ...
                   (static_cast<View>(in.get(C::data_copy_reads_left)) -
                    (static_cast<View>(in.get(C::data_copy_clamped_read_index_upper_bound)) -
                     static_cast<View>(in.get(C::data_copy_offset))) *
                        static_cast<View>(in.get(C::data_copy_sel_has_reads)));
    ...
    { // DECR_COPY_SIZE
        ...
        auto tmp = static_cast<View>(in.get(C::data_copy_sel)) * (FF(1) - static_cast<View>(in.get(C::data_copy_end))) *
    ...
    { // INIT_READ_ADDR
        ...
        auto tmp =
            static_cast<View>(in.get(C::data_copy_start_no_err)) *
            (FF(1) - static_cast<View>(in.get(C::data_copy_sel_write_count_is_zero))) *
    ...
    { // INCR_READ_ADDR
        ...
        auto tmp = static_cast<View>(in.get(C::data_copy_sel)) *
                   ...
                   (FF(1) - static_cast<View>(in.get(C::data_copy_end))) *
    ...
    { // PADDING_PROPAGATION
        ...
        auto tmp = (FF(1) - static_cast<View>(in.get(C::data_copy_end))) *
                   static_cast<View>(in.get(C::data_copy_padding)) *
