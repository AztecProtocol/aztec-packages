...
struct perm_execution_dispatch_get_contract_instance_settings_ {
    ...
    static constexpr Column SRC_SELECTOR = Column::execution_sel_get_contract_instance;
    ...
    static constexpr std::array<ColumnAndShifts, COLUMNS_PER_SET> SRC_COLUMNS = {
        ColumnAndShifts::precomputed_clk,      ColumnAndShifts::execution_register_0_,
        ColumnAndShifts::execution_rop_1_,     ColumnAndShifts::execution_rop_2_,
        ColumnAndShifts::execution_context_id, ColumnAndShifts::execution_sel_opcode_error
    };
    static constexpr std::array<ColumnAndShifts, COLUMNS_PER_SET> DST_COLUMNS = {
        ColumnAndShifts::get_contract_instance_clk,        ColumnAndShifts::get_contract_instance_contract_address,
        ColumnAndShifts::get_contract_instance_dst_offset, ColumnAndShifts::get_contract_instance_member_enum,
        ColumnAndShifts::get_contract_instance_space_id,   ColumnAndShifts::get_contract_instance_error
    };
};
