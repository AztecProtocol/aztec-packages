...
struct lookup_addressing_relative_overflow_result_0_settings_ {
    ...
    static constexpr Column SRC_SELECTOR = Column::execution_sel_op_is_relative_valid_base_0_;
...
struct lookup_addressing_relative_overflow_result_1_settings_ {
    ...
    static constexpr std::string_view RELATION_NAME = "addressing";
    static constexpr size_t LOOKUP_TUPLE_SIZE = 3;
    static constexpr Column SRC_SELECTOR = Column::execution_sel_op_is_relative_valid_base_1_;
    static constexpr Column DST_SELECTOR = Column::gt_sel_addressing;
...
struct lookup_addressing_relative_overflow_result_2_settings_ {
    ...
    static constexpr std::string_view RELATION_NAME = "addressing";
    static constexpr size_t LOOKUP_TUPLE_SIZE = 3;
    static constexpr Column SRC_SELECTOR = Column::execution_sel_op_is_relative_valid_base_2_;
    static constexpr Column DST_SELECTOR = Column::gt_sel_addressing;
...
struct lookup_addressing_relative_overflow_result_3_settings_ {
    ...
    static constexpr std::string_view RELATION_NAME = "addressing";
    static constexpr size_t LOOKUP_TUPLE_SIZE = 3;
    static constexpr Column SRC_SELECTOR = Column::execution_sel_op_is_relative_valid_base_3_;
    static constexpr Column DST_SELECTOR = Column::gt_sel_addressing;
...
struct lookup_addressing_relative_overflow_result_4_settings_ {
    ...
    static constexpr std::string_view RELATION_NAME = "addressing";
    static constexpr size_t LOOKUP_TUPLE_SIZE = 3;
    static constexpr Column SRC_SELECTOR = Column::execution_sel_op_is_relative_valid_base_4_;
    static constexpr Column DST_SELECTOR = Column::gt_sel_addressing;
...
struct lookup_addressing_relative_overflow_result_5_settings_ {
    ...
    static constexpr std::string_view RELATION_NAME = "addressing";
    static constexpr size_t LOOKUP_TUPLE_SIZE = 3;
    static constexpr Column SRC_SELECTOR = Column::execution_sel_op_is_relative_valid_base_5_;
    static constexpr Column DST_SELECTOR = Column::gt_sel_addressing;
...
struct lookup_addressing_relative_overflow_result_6_settings_ {
    ...
    static constexpr std::string_view RELATION_NAME = "addressing";
    static constexpr size_t LOOKUP_TUPLE_SIZE = 3;
    static constexpr Column SRC_SELECTOR = Column::execution_sel_op_is_relative_valid_base_6_;
    static constexpr Column DST_SELECTOR = Column::gt_sel_addressing;
