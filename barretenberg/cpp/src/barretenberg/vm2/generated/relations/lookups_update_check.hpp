...
/////////////////// lookup_update_check_update_hash_poseidon2_0 ///////////////////

class lookup_update_check_update_hash_poseidon2_0_settings {
  public:
    static constexpr std::string_view NAME = "LOOKUP_UPDATE_CHECK_UPDATE_HASH_POSEIDON2_0";
    ...
    static constexpr Column COUNTS = Column::lookup_update_check_update_hash_poseidon2_0_counts;
    static constexpr Column INVERSES = Column::lookup_update_check_update_hash_poseidon2_0_inv;
    static constexpr std::array<ColumnAndShifts, LOOKUP_TUPLE_SIZE> SRC_COLUMNS = {
        ColumnAndShifts::update_check_update_delay,
        ColumnAndShifts::update_check_update_pre_class,
        ColumnAndShifts::update_check_update_post_class,
    ...
    {
        return (in._update_check_hash_not_zero() == 1 || in._poseidon2_hash_start() == 1);
    }
    ...
    {
        return std::forward_as_tuple(in._lookup_update_check_update_hash_poseidon2_0_inv(),
                                     in._lookup_update_check_update_hash_poseidon2_0_counts(),
                                     in._update_check_hash_not_zero(),
                                     in._poseidon2_hash_start(),
                                     in._update_check_update_delay(),
                                     in._update_check_update_pre_class(),
                                     in._update_check_update_post_class(),
...
class lookup_update_check_update_hash_poseidon2_0_relation
    : public GenericLookupRelation<lookup_update_check_update_hash_poseidon2_0_settings, FF_> {
  public:
    using Settings = lookup_update_check_update_hash_poseidon2_0_settings;
    static constexpr std::string_view NAME = lookup_update_check_update_hash_poseidon2_0_settings::NAME;
    static constexpr std::string_view RELATION_NAME =
        lookup_update_check_update_hash_poseidon2_0_settings::RELATION_NAME;

    template <typename AllEntities> inline static bool skip(const AllEntities& in)
    {
        return in.lookup_update_check_update_hash_poseidon2_0_inv.is_zero();
    }
...
/////////////////// lookup_update_check_update_hash_poseidon2_1 ///////////////////

class lookup_update_check_update_hash_poseidon2_1_settings {
  public:
    static constexpr std::string_view NAME = "LOOKUP_UPDATE_CHECK_UPDATE_HASH_POSEIDON2_1";
    static constexpr std::string_view RELATION_NAME = "update_check";
    ...
    static constexpr Column COUNTS = Column::lookup_update_check_update_hash_poseidon2_1_counts;
    static constexpr Column INVERSES = Column::lookup_update_check_update_hash_poseidon2_1_inv;
    static constexpr std::array<ColumnAndShifts, LOOKUP_TUPLE_SIZE> SRC_COLUMNS = {
        ColumnAndShifts::update_check_update_block_of_change,
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in._lookup_update_check_update_hash_poseidon2_1_inv(),
                                     in._lookup_update_check_update_hash_poseidon2_1_counts(),
                                     in._update_check_hash_not_zero(),
...
template <typename FF_>
class lookup_update_check_update_hash_poseidon2_1_relation
    : public GenericLookupRelation<lookup_update_check_update_hash_poseidon2_1_settings, FF_> {
  public:
    using Settings = lookup_update_check_update_hash_poseidon2_1_settings;
    static constexpr std::string_view NAME = lookup_update_check_update_hash_poseidon2_1_settings::NAME;
    static constexpr std::string_view RELATION_NAME =
        lookup_update_check_update_hash_poseidon2_1_settings::RELATION_NAME;

    template <typename AllEntities> inline static bool skip(const AllEntities& in)
    {
        return in.lookup_update_check_update_hash_poseidon2_1_inv.is_zero();
    }
...
class lookup_update_check_block_of_change_cmp_range_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in._update_check_sel() == 1 || in._range_check_sel() == 1);
    }
