...
INSTANTIATE_LOOKUP(lookup_retrieved_bytecodes_tree_check_low_leaf_poseidon2_relation);
INSTANTIATE_LOOKUP(lookup_retrieved_bytecodes_tree_check_updated_low_leaf_poseidon2_relation);
INSTANTIATE_LOOKUP(lookup_retrieved_bytecodes_tree_check_low_leaf_merkle_check_relation);
INSTANTIATE_LOOKUP(lookup_retrieved_bytecodes_tree_check_low_leaf_class_id_validation_relation);
INSTANTIATE_LOOKUP(lookup_retrieved_bytecodes_tree_check_low_leaf_next_class_id_validation_relation);
INSTANTIATE_LOOKUP(lookup_retrieved_bytecodes_tree_check_new_leaf_poseidon2_relation);
