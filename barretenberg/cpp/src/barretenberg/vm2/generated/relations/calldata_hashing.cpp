...
template class calldata_hashingImpl<AvmFlavorSettings::FF>;
ACCUMULATE(calldata_hashingImpl, AvmFlavor, SumcheckTupleOfUnivariatesOverSubrelations, ExtendedEdge); // Prover.
ACCUMULATE(calldata_hashingImpl, AvmFlavor, SumcheckArrayOfValuesOverSubrelations, EvaluationEdge);    // Verifier.
