...
template <typename FF_> class executionImpl {
  public:
    ...
    static constexpr std::array<size_t, 95> SUBRELATION_PARTIAL_LENGTHS = {
        3, 3, 3, 2, 3, 3, 3, 3, 3, 3, 2, 2, 2, 3, 3, 3, 3, 3, 3, 3, 3, 4, 4, 3, 3, 3, 3, 3, 3, 3, 2, 3,
...
template <typename FF> class execution : public Relation<executionImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_DYN_GAS_ID_DECOMPOSITION = 18;
    static constexpr size_t SR_NUM_P_LIMBS_CEIL = 21;
    static constexpr size_t SR_DYN_L2_FACTOR_TO_RADIX_BE = 22;
    static constexpr size_t SR_DYN_DA_GAS_IS_ZERO = 28;
    static constexpr size_t SR_DYN_L2_GAS_IS_ZERO = 29;
    static constexpr size_t SR_SUBTRACE_ID_DECOMPOSITION = 45;
    static constexpr size_t SR_EXEC_OP_ID_DECOMPOSITION = 67;
    static constexpr size_t SR_PC_NEXT_ROW_INT_CALL_JUMP = 68;
    static constexpr size_t SR_PC_NEXT_ROW_JUMPI = 69;
    static constexpr size_t SR_MOV_SAME_VALUE = 70;
    static constexpr size_t SR_MOV_SAME_TAG = 71;
    static constexpr size_t SR_SUCCESS_COPY_WRITE_REG = 72;
    static constexpr size_t SR_SUCCESS_COPY_U1_TAG = 73;
    static constexpr size_t SR_RETURNDATA_SIZE_WRITE_REG = 74;
    static constexpr size_t SR_RETURNDATA_SIZE_U32_TAG = 75;
    static constexpr size_t SR_PUBLIC_DATA_TREE_ROOT_NOT_CHANGED = 76;
    static constexpr size_t SR_PUBLIC_DATA_TREE_SIZE_NOT_CHANGED = 77;
    static constexpr size_t SR_WRITTEN_PUBLIC_DATA_SLOTS_TREE_ROOT_NOT_CHANGED = 78;
    static constexpr size_t SR_WRITTEN_PUBLIC_DATA_SLOTS_TREE_SIZE_NOT_CHANGED = 79;
    static constexpr size_t SR_NOTE_HASH_TREE_ROOT_NOT_CHANGED = 80;
    static constexpr size_t SR_NOTE_HASH_TREE_SIZE_NOT_CHANGED = 81;
    static constexpr size_t SR_NUM_NOTE_HASHES_EMITTED_NOT_CHANGED = 82;
    static constexpr size_t SR_NULLIFIER_TREE_ROOT_NOT_CHANGED = 83;
    static constexpr size_t SR_NULLIFIER_TREE_SIZE_NOT_CHANGED = 84;
    static constexpr size_t SR_NUM_NULLIFIERS_EMITTED_NOT_CHANGED = 85;
    static constexpr size_t SR_NUM_PUBLIC_LOGS_NOT_CHANGED = 86;
    static constexpr size_t SR_NUM_L2_TO_L1_MESSAGES_NOT_CHANGED = 87;
    static constexpr size_t SR_RETRIEVED_BYTECODES_TREE_ROOT_NOT_CHANGED = 88;
    static constexpr size_t SR_RETRIEVED_BYTECODES_TREE_SIZE_NOT_CHANGED = 89;
    static constexpr size_t SR_INFALLIBLE_OPCODES_SUCCESS = 91;
    static constexpr size_t SR_NO_OPCODE_ERROR_IF_NOT_EXECUTING = 92;
