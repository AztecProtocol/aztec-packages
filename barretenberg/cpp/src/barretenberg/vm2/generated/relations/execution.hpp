...
template <typename FF_> class executionImpl {
  public:
    ...
    static constexpr std::array<size_t, 93> SUBRELATION_PARTIAL_LENGTHS = {
        3, 3, 3, 2, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 4, 4, 3, 3, 3, 3, 3, 3, 3,
...
template <typename FF> class execution : public Relation<executionImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_DYN_DA_GAS_IS_ZERO = 26;
    static constexpr size_t SR_DYN_L2_GAS_IS_ZERO = 27;
    static constexpr size_t SR_SUBTRACE_ID_DECOMPOSITION = 43;
    static constexpr size_t SR_EXEC_OP_ID_DECOMPOSITION = 65;
    static constexpr size_t SR_PC_NEXT_ROW_INT_CALL_JUMP = 66;
    static constexpr size_t SR_PC_NEXT_ROW_JUMPI = 67;
    static constexpr size_t SR_MOV_SAME_VALUE = 68;
    static constexpr size_t SR_MOV_SAME_TAG = 69;
    static constexpr size_t SR_SUCCESS_COPY_WRITE_REG = 70;
    static constexpr size_t SR_SUCCESS_COPY_U1_TAG = 71;
    static constexpr size_t SR_RETURNDATA_SIZE_WRITE_REG = 72;
    static constexpr size_t SR_RETURNDATA_SIZE_U32_TAG = 73;
    static constexpr size_t SR_PUBLIC_DATA_TREE_ROOT_NOT_CHANGED = 74;
    static constexpr size_t SR_PUBLIC_DATA_TREE_SIZE_NOT_CHANGED = 75;
    static constexpr size_t SR_WRITTEN_PUBLIC_DATA_SLOTS_TREE_ROOT_NOT_CHANGED = 76;
    static constexpr size_t SR_WRITTEN_PUBLIC_DATA_SLOTS_TREE_SIZE_NOT_CHANGED = 77;
    static constexpr size_t SR_NOTE_HASH_TREE_ROOT_NOT_CHANGED = 78;
    static constexpr size_t SR_NOTE_HASH_TREE_SIZE_NOT_CHANGED = 79;
    static constexpr size_t SR_NUM_NOTE_HASHES_EMITTED_NOT_CHANGED = 80;
    ...
    static constexpr size_t SR_INFALLIBLE_OPCODES_SUCCESS = 89;
