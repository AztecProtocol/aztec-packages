...
template <typename FF_> class executionImpl {
  public:
    ...
    static constexpr std::array<size_t, 62> SUBRELATION_PARTIAL_LENGTHS = {
        3, 3, 3, 3, 4, 3, 3, 3, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
...
template <typename FF> class execution : public Relation<executionImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_SUBTRACE_ID_DECOMPOSITION = 24;
    static constexpr size_t SR_EXEC_OP_ID_DECOMPOSITION = 43;
    static constexpr size_t SR_DYN_GAS_ID_DECOMPOSITION = 50;
    static constexpr size_t SR_PC_NEXT_ROW_INT_CALL_JUMP = 52;
    static constexpr size_t SR_PC_NEXT_ROW_JUMPI = 53;
    static constexpr size_t SR_MOV_SAME_VALUE = 54;
    static constexpr size_t SR_MOV_SAME_TAG = 55;
    static constexpr size_t SR_SUCCESS_COPY_WRITE_REG = 56;
    static constexpr size_t SR_SUCCESS_COPY_U1_TAG = 57;
    static constexpr size_t SR_RETURNDATA_SIZE_WRITE_REG = 58;
    static constexpr size_t SR_RETURNDATA_SIZE_U32_TAG = 59;
};
