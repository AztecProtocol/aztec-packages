...
template <typename FF_> class executionImpl {
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        const auto constants_AVM_EXEC_OP_ID_L1_TO_L2_MESSAGE_EXISTS = FF(262144);
...
template <typename FF> class execution : public Relation<executionImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_EXEC_OP_ID_DECOMPOSITION = 42;
    static constexpr size_t SR_DYN_GAS_ID_DECOMPOSITION = 49;
    static constexpr size_t SR_PC_NEXT_ROW_INT_CALL_JUMP = 51;
    static constexpr size_t SR_PC_NEXT_ROW_JUMPI = 52;
    static constexpr size_t SR_MOV_SAME_VALUE = 53;
    static constexpr size_t SR_MOV_SAME_TAG = 54;
    static constexpr size_t SR_SUCCESS_COPY_WRITE_REG = 55;
    static constexpr size_t SR_SUCCESS_COPY_U1_TAG = 56;
    static constexpr size_t SR_RETURNDATA_SIZE_WRITE_REG = 57;
    static constexpr size_t SR_RETURNDATA_SIZE_U32_TAG = 58;
};
