                                          ...
                                          [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    const auto emit_public_log_START_PUBLIC_INDEX =
        constants_AVM_PUBLIC_INPUTS_AVM_ACCUMULATED_DATA_PUBLIC_LOGS_ROW_IDX +
        constants_FLAT_PUBLIC_LOGS_HEADER_LENGTH + in.get(C::emit_public_log_prev_num_public_log_fields);
    ...
    { // SEL_TOGGLED_AT_START_END
        using View = typename std::tuple_element_t<3, ContainerOverSubrelations>::View;
        auto tmp =
            (static_cast<View>(in.get(C::emit_public_log_start)) + static_cast<View>(in.get(C::emit_public_log_end))) *
            (FF(1) - static_cast<View>(in.get(C::emit_public_log_sel)));
    ...
    { // TRACE_CONTINUITY
        ...
        auto tmp = (FF(1) - static_cast<View>(in.get(C::precomputed_first_row))) *
                   (FF(1) - static_cast<View>(in.get(C::emit_public_log_sel))) *
                   static_cast<View>(in.get(C::emit_public_log_sel_shift));
    ...
    { // COMPUTATION_FINISH_AT_END
        ...
        auto tmp = CView(emit_public_log_NOT_END) * (FF(1) - static_cast<View>(in.get(C::emit_public_log_sel_shift)));
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::emit_public_log_start)) *
                   (static_cast<View>(in.get(C::emit_public_log_max_public_logs_payload_length)) -
    ...
    { // DISABLED_MEM_READ_VALUE_ZERO
        ...
        auto tmp = (static_cast<View>(in.get(C::emit_public_log_sel)) -
                    static_cast<View>(in.get(C::emit_public_log_sel_should_read_memory))) *
