...
class round_constant_lookup_settings {
  public:
    static constexpr std::string_view NAME = "ROUND_CONSTANT";
    ...
    static constexpr Column COUNTS = Column::round_constant_counts;
    static constexpr Column INVERSES = Column::round_constant_inv;
...
class round_constant_relation : public GenericLookupRelation<round_constant_lookup_settings, FF_> {
  public:
    using Settings = round_constant_lookup_settings;
    static constexpr std::string_view NAME = round_constant_lookup_settings::NAME;
    static constexpr std::string_view RELATION_NAME = round_constant_lookup_settings::RELATION_NAME;

    template <typename AllEntities> inline static bool skip(const AllEntities& in)
    {
        return in.round_constant_inv.is_zero();
    }
