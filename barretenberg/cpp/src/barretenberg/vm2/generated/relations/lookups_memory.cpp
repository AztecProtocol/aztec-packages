...
INSTANTIATE_LOOKUP(lookup_memory_range_check_limb_0_relation);
INSTANTIATE_LOOKUP(lookup_memory_range_check_limb_1_relation);
INSTANTIATE_LOOKUP(lookup_memory_range_check_limb_2_relation);
INSTANTIATE_LOOKUP(lookup_memory_tag_max_bits_relation);
INSTANTIATE_LOOKUP(lookup_memory_range_check_write_tagged_value_relation);
