                                       ...
                                       [[maybe_unused]] const FF_& scaling_factor)
{
    ...
    const auto constants_DOM_SEP__INT_CLASS_ID_LEAF = FF(4188413753UL);
    ...
    }
    {
        ...
        auto tmp = static_cast<View>(in.get(C::bc_retrieval_sel)) *
                   (static_cast<View>(in.get(C::bc_retrieval_class_id_leaf_separator)) -
                    CView(constants_DOM_SEP__INT_CLASS_ID_LEAF));
