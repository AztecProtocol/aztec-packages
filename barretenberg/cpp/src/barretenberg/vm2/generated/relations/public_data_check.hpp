...
template <typename FF> class public_data_check : public Relation<public_data_checkImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_EXISTS_FLAG_CHECK = 16;
    static constexpr size_t SR_NEXT_SLOT_IS_ZERO_CHECK = 18;
    static constexpr size_t SR_LOW_LEAF_VALUE_UPDATE = 19;
    static constexpr size_t SR_LOW_LEAF_NEXT_INDEX_UPDATE = 20;
    static constexpr size_t SR_LOW_LEAF_NEXT_SLOT_UPDATE = 21;
    static constexpr size_t SR_VALUE_IS_CORRECT = 23;
    static constexpr size_t SR_UPDATE_ROOT_VALIDATION = 25;
    static constexpr size_t SR_WRITE_IDX_INITIAL_VALUE = 27;
    static constexpr size_t SR_WRITE_IDX_INCREMENT = 30;
