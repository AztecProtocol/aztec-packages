...
class AvmFlavor {
  public:
    ...
    static constexpr size_t NUM_WITNESS_ENTITIES = 875;
    static constexpr size_t NUM_SHIFTED_ENTITIES = 123;
    static constexpr size_t NUM_WIRES = NUM_WITNESS_ENTITIES + NUM_PRECOMPUTED_ENTITIES;
    // We have two copies of the witness entities, so we subtract the number of fixed ones (they have no shift), one for
    // the unshifted and one for the shifted
    static constexpr size_t NUM_ALL_ENTITIES = 1042;
    ...
    using LookupRelations_ = std::tuple<
        ...
        lookup_merkle_check_leaf_index_fits_in_64_bits_relation<FF_>,
