...
struct AvmFlavorVariables {
    ...
    static constexpr size_t NUM_SHIFTED_ENTITIES = 338;
    ...
    using LookupRelations_ = flat_tuple::tuple<
        ...
        lookup_data_copy_data_index_upper_bound_gt_relation<FF_>,
        lookup_data_copy_offset_gt_data_index_upper_bound_relation<FF_>,
