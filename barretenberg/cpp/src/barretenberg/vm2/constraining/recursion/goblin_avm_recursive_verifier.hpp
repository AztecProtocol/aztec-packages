  ...
  public:
                                          ...
                                          const PairingPoints& input_points_accumulator) const
    {
        ...
        InnerProverOutput inner_output = construct_and_prove_inner_recursive_verification_circuit(
            stdlib_proof, public_inputs, input_points_accumulator);
        ...
        RecursiveAvmGoblinOutput result = construct_outer_recursive_verification_circuit(
            stdlib_proof, public_inputs, input_points_accumulator, inner_output);
        ...
        const InnerProverOutput& inner_output) const
    {
        ...
        auto mega_verifier_output = mega_verifier.verify_proof(mega_proof, input_points_accumulator);
