...
constexpr std::array<WireOpCode, 25> WIRE_OPCODES = {
...
constexpr std::array<uint32_t, 25> OPERATION_IDS = {
...
constexpr std::array<C, 25> SELECTOR_COLUMNS = {
    C::execution_sel_execute_get_env_var,
    C::execution_sel_execute_set,
    C::execution_sel_execute_set,
    C::execution_sel_execute_set,
    C::execution_sel_execute_set,
    C::execution_sel_execute_set,
