...
constexpr std::array<WireOpCode, 22> WIRE_OPCODES = {
    ...
    WireOpCode::DEBUGLOG,     WireOpCode::NULLIFIEREXISTS,
};
...
constexpr std::array<uint32_t, 22> OPERATION_IDS = {
    ...
    AVM_EXEC_OP_ID_DEBUGLOG,     AVM_EXEC_OP_ID_NULLIFIEREXISTS,
};
...
constexpr std::array<C, 22> SELECTOR_COLUMNS = {
    ...
    C::execution_sel_debug_log,     C::execution_sel_nullifier_exists,
};
