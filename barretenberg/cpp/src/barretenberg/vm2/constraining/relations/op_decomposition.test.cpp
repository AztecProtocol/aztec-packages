...
The bytecode chunk consists of the opcode, addressing mode, and 7 operands.
...
Hence we deal with 8 values: addressing_mode, op1, op2, op3, op4, op5, op6, op7
We refer to these 8 values, including addressing_mode, as 'operands' from now on for ease of reading.
...
Below, we denote the 8 operands [addressing_mode, op1, ..., op7]. An operand layout is a
