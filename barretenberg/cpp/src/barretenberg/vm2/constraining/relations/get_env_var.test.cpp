...
TEST(GetEnvVarConstrainingTest, OutputRegisterIsZeroOnError)
{
    ...
    TestTraceContainer trace({
        { { C::precomputed_first_row, 1 } },
        // Not getting env var, register[0] should be 0
        { { C::execution_sel, 1 },
          { C::execution_sel_should_get_env_var, 0 },
          { C::execution_register_0_, 0 },
          { C::execution_rop_1_, 0 } }, // ADDRESS enum
        // Getting env var, register[0] can be non-zero
        { { C::execution_sel, 1 },
          { C::execution_sel_should_get_env_var, 1 },
...
// TEST(GetEnvVarConstrainingTest, PublicInputsCol0Lookup)
//{
//     // Test public inputs lookup using col0 (most global variables)
//     TestTraceContainer trace({
//         { { C::precomputed_first_row, 1 } },
//         // PI lookup enabled, not feePerL2Gas, use col0
//         { { C::execution_sel, 1 },
//           { C::execution_sel_envvar_pi_lookup, 1 },
//           { C::execution_is_feeperl2gas, 0 },
//           { C::execution_register_0_, 12345 },
//           { C::execution_value_from_pi_col0, 12345 },
//           { C::execution_value_from_pi_col1, 67890 } },
//         // PI lookup disabled
//         { { C::execution_sel, 1 },
...
//     });
//
//     check_interaction<get_env_var>(trace, 4);
//
//     // Negative test: PI lookup enabled, not feePerL2Gas, but register != col0
//     trace.set(C::execution_register_0_, 1, 99999);
//     EXPECT_THROW_WITH_MESSAGE(check_relation<get_env_var>(trace, 4), "get_env_var");
// }

// TEST(GetEnvVarConstrainingTest, PublicInputsCol1Lookup)
//{
//     // Test public inputs lookup using col1 (feePerL2Gas only)
//     TestTraceContainer trace({
//         { { C::precomputed_first_row, 1 } },
//         // PI lookup enabled, feePerL2Gas, use col1
//         { { C::execution_sel, 1 },
//           { C::execution_sel_envvar_pi_lookup, 1 },
//           { C::execution_is_feeperl2gas, 1 },
//           { C::execution_register_0_, 67890 },
//           { C::execution_value_from_pi_col0, 12345 },
//           { C::execution_value_from_pi_col1, 67890 } },
//         // PI lookup disabled
//         { { C::execution_sel, 1 },
...
//     });
//
//     check_relation<get_env_var>(trace, 5);
//
//     // Negative test: PI lookup enabled, feePerL2Gas, but register != col1
//     trace.set(C::execution_register_0_, 1, 99999);
//     EXPECT_THROW_WITH_MESSAGE(check_relation<get_env_var>(trace, 5), "get_env_var");
// }
//
...
// TEST(GetEnvVarConstrainingTest, ComplexScenarioMultipleEnvVars)
//{
...
//           { C::execution_is_dagasleft, 0 },
//           { C::execution_sel_envvar_pi_lookup, 0 },
//           { C::execution_register_0_, FF(uint64_t(0x1111111111111111)) },
//           { C::execution_contract_address, FF(uint64_t(0x1111111111111111)) } },
//         // Row 2: Get CHAINID via PI lookup
//         { { C::execution_sel, 1 },
//           { C::execution_sel_should_resolve_address, 1 },
//           { C::execution_sel_addressing_error, 0 },
//           { C::execution_opcode_error, 0 },
...
//           { C::execution_is_dagasleft, 0 },
//           { C::execution_sel_envvar_pi_lookup, 1 },
//           { C::execution_envvar_pi_row_idx, 3 }, // CHAINID row
//           { C::execution_register_0_, 31337 },
//           { C::execution_value_from_pi_col0, 31337 },
//           { C::execution_value_from_pi_col1, 999 } },
//         // Row 3: Get L2GASLEFT
//         { { C::execution_sel, 1 },
//           { C::execution_sel_should_resolve_address, 1 },
//           { C::execution_sel_addressing_error, 0 },
...
//           { C::execution_is_dagasleft, 0 },
//           { C::execution_sel_envvar_pi_lookup, 0 },
//           { C::execution_register_0_, 8000 },
//           { C::execution_l2_gas_limit, 10000 },
//           { C::execution_l2_gas_used, 2000 } },
//         // Row 4: Error case - invalid enum
//         { { C::execution_sel, 1 },
//           { C::execution_sel_should_resolve_address, 1 },
//           { C::execution_sel_addressing_error, 0 },
//           { C::execution_opcode_error, 1 }, // Invalid enum
//           { C::execution_sel_should_get_env_var, 0 },
//           { C::execution_register_0_, 0 } }, // Should be 0 on error
//         { { C::execution_sel, 1 }, { C::execution_last, 1 } },
//         { { C::execution_sel, 0 } },
//     });
//
...
// }
//
// TEST(GetEnvVarConstrainingTest, FeePerL2GasSpecialCase)
//{
//     // Test the special case where feePerL2Gas uses col1 instead of col0
//     TestTraceContainer trace({
//         { { C::precomputed_first_row, 1 } },
//         // Getting feePerL2Gas (should use col1)
//         { { C::execution_sel, 1 },
//           { C::execution_sel_envvar_pi_lookup, 1 },
//           { C::execution_is_feeperl2gas, 1 },
//           { C::execution_register_0_, 250 },          // Fee per L2 gas from col1
//           { C::execution_value_from_pi_col0, 100 },   // Fee per DA gas in col0
//           { C::execution_value_from_pi_col1, 250 } }, // Fee per L2 gas in col1
//         // Getting feePerDaGas (should use col0)
//         { { C::execution_sel, 1 },
//           { C::execution_sel_envvar_pi_lookup, 1 },
//           { C::execution_is_feeperl2gas, 0 },
//           { C::execution_register_0_, 100 }, // Fee per DA gas from col0
//           { C::execution_value_from_pi_col0, 100 },
//           { C::execution_value_from_pi_col1, 250 } },
//         { { C::execution_sel, 1 }, { C::execution_last, 1 } },
//         { { C::execution_sel, 0 } },
//     });
//
//     check_relation<get_env_var>(trace, 4, 5);
//
//     // Negative test: feePerL2Gas should use col1 but register matches col0
//     trace.set(C::execution_register_0_, 1, 100);
//     EXPECT_THROW_WITH_MESSAGE(check_relation<get_env_var>(trace, 5), "get_env_var");
// }
//
