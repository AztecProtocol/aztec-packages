...
TEST_F(CalldataHashingConstrainingTest, SingleCalldataHashOneRow)
{
    ...
    auto trace = TestTraceContainer::from_rows({
        ...
        {
            .calldata_hashing_calldata_size = 2,
            .calldata_hashing_context_id = 1,
            .calldata_hashing_index_0_ = 0,
            .calldata_hashing_index_1_ = 1,
            .calldata_hashing_index_2_ = 2,
            .calldata_hashing_input_0_ = GENERATOR_INDEX__PUBLIC_CALLDATA,
            .calldata_hashing_input_1_ = 1,
            .calldata_hashing_input_2_ = 2,
            .calldata_hashing_input_len = 3,
            .calldata_hashing_latch = 1,
            .calldata_hashing_output_hash = hash,
            .calldata_hashing_rounds_rem = 1,
            .calldata_hashing_sel = 1,
            .calldata_hashing_sel_not_padding_1 = 1,
            .calldata_hashing_sel_not_padding_2 = 1,
            .calldata_hashing_sel_not_start = 0,
            .calldata_hashing_start = 1,
        },
    });
...
TEST_F(CalldataHashingConstrainingTest, SingleCalldataHashOneElt)
{
    ...
    auto trace = TestTraceContainer::from_rows({
        { .precomputed_first_row = 1 },
        {
            .calldata_hashing_calldata_size = 1,
            .calldata_hashing_context_id = 1,
            .calldata_hashing_index_0_ = 0,
            .calldata_hashing_index_1_ = 1,
            .calldata_hashing_index_2_ = 2,
            .calldata_hashing_input_0_ = GENERATOR_INDEX__PUBLIC_CALLDATA,
            .calldata_hashing_input_1_ = 2,
            .calldata_hashing_input_2_ = 0,
            .calldata_hashing_input_len = 2,
            .calldata_hashing_latch = 1,
            .calldata_hashing_output_hash = hash,
            .calldata_hashing_rounds_rem = 1,
            .calldata_hashing_sel = 1,
            .calldata_hashing_sel_not_padding_1 = 1,
            .calldata_hashing_sel_not_padding_2 = 0,
            .calldata_hashing_sel_not_start = 0,
            .calldata_hashing_start = 1,
        },
    });
...
TEST_F(CalldataHashingConstrainingTestTraceHelper, NegativeOutputHash)
{
    ...
    auto trace = TestTraceContainer::from_rows({
        { .precomputed_first_row = 1 },
        {
            .calldata_hashing_calldata_size = 5,
            .calldata_hashing_context_id = 1,
            .calldata_hashing_index_0_ = 0,
            .calldata_hashing_index_1_ = 1,
            .calldata_hashing_index_2_ = 2,
            .calldata_hashing_input_0_ = GENERATOR_INDEX__PUBLIC_CALLDATA,
            .calldata_hashing_input_1_ = calldata_fields[0],
            .calldata_hashing_input_2_ = calldata_fields[1],
            .calldata_hashing_input_len = 6,
            .calldata_hashing_latch = 0,
            .calldata_hashing_rounds_rem = 2,
            .calldata_hashing_sel = 1,
            .calldata_hashing_sel_not_padding_1 = 1,
            .calldata_hashing_sel_not_padding_2 = 1,
            .calldata_hashing_sel_not_start = 0,
        ...
        },
        {
            .calldata_hashing_calldata_size = 5,
            .calldata_hashing_context_id = 1,
            .calldata_hashing_index_0_ = 3,
            .calldata_hashing_index_1_ = 4,
            .calldata_hashing_index_2_ = 5,
            .calldata_hashing_input_0_ = calldata_fields[2],
            .calldata_hashing_input_1_ = calldata_fields[3],
            .calldata_hashing_input_2_ = calldata_fields[4],
            .calldata_hashing_input_len = 6,
            .calldata_hashing_latch = 1,
            .calldata_hashing_rounds_rem = 1,
            .calldata_hashing_sel = 1,
            .calldata_hashing_sel_not_padding_1 = 1,
            .calldata_hashing_sel_not_padding_2 = 1,
            .calldata_hashing_sel_not_start = 1,
        },
    });
...
TEST_F(CalldataHashingConstrainingTestTraceHelper, NegativePoseidonInteraction)
{
    ...
    auto trace = TestTraceContainer::from_rows({
        { .precomputed_first_row = 1 },
        {
            .calldata_hashing_calldata_size = 10,
            .calldata_hashing_context_id = 1,
            .calldata_hashing_index_0_ = 0,
            .calldata_hashing_index_1_ = 1,
            .calldata_hashing_index_2_ = 2,
            ...
            .calldata_hashing_input_1_ = calldata_fields[0],
            .calldata_hashing_input_2_ = calldata_fields[1],
            .calldata_hashing_input_len = 11,
            .calldata_hashing_latch = 0,
            .calldata_hashing_rounds_rem = 4,
            .calldata_hashing_sel = 1,
            .calldata_hashing_sel_not_padding_1 = 1,
            .calldata_hashing_sel_not_padding_2 = 1,
            .calldata_hashing_sel_not_start = 0,
        ...
        },
        {
            .calldata_hashing_calldata_size = 10,
            .calldata_hashing_context_id = 1,
            .calldata_hashing_index_0_ = 6,
            .calldata_hashing_index_1_ = 7,
            .calldata_hashing_index_2_ = 8,
            .calldata_hashing_input_0_ = calldata_fields[5],
            .calldata_hashing_input_1_ = calldata_fields[6],
            .calldata_hashing_input_2_ = calldata_fields[7],
            .calldata_hashing_input_len = 11,
            .calldata_hashing_latch = 0,
            .calldata_hashing_rounds_rem = 2,
            .calldata_hashing_sel = 1,
        ...
        },
        {
            .calldata_hashing_calldata_size = 10,
            .calldata_hashing_context_id = 1,
            .calldata_hashing_index_0_ = 9,
            .calldata_hashing_index_1_ = 10,
            .calldata_hashing_index_2_ = 11,
            .calldata_hashing_input_0_ = calldata_fields[8],
            .calldata_hashing_input_1_ = calldata_fields[9],
            .calldata_hashing_input_2_ = 0,
            .calldata_hashing_input_len = 11,
            .calldata_hashing_latch = 1,
            .calldata_hashing_rounds_rem = 1,
