    ...
    for (const auto& ex_event_ptr : ex_events) {
        ...
        trace.set(row,
                  { {
                      ...
                      { C::execution_parent_calldata_addr, ex_event.context_event.parent_cd_addr },
                      { C::execution_parent_calldata_size, ex_event.context_event.parent_cd_size_addr },
                      { C::execution_last_child_returndata_addr, ex_event.context_event.last_child_rd_addr },
