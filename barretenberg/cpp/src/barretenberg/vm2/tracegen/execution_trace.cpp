...
constexpr size_t NUM_OPERANDS = 6;
constexpr std::array<Column, NUM_OPERANDS> OPERAND_COLUMNS = {
    C::execution_op_0_, C::execution_op_1_, C::execution_op_2_,
    C::execution_op_3_, C::execution_op_4_, C::execution_op_5_,
};
...
constexpr std::array<Column, NUM_OPERANDS> RESOLVED_OPERAND_COLUMNS = {
    C::execution_rop_0_, C::execution_rop_1_, C::execution_rop_2_,
    C::execution_rop_3_, C::execution_rop_4_, C::execution_rop_5_,
};

constexpr size_t NUM_REGISTERS = 7;
constexpr std::array<Column, NUM_REGISTERS> REGISTER_COLUMNS = {
    C::execution_reg1, C::execution_reg2, C::execution_reg3, C::execution_reg4,
    C::execution_reg5, C::execution_reg6, C::execution_reg7,
};
constexpr std::array<Column, NUM_REGISTERS> REGISTER_MEM_TAG_COLUMNS = {
    C::execution_mem_tag1, C::execution_mem_tag2, C::execution_mem_tag3, C::execution_mem_tag4,
    C::execution_mem_tag5, C::execution_mem_tag6, C::execution_mem_tag7,
};
constexpr std::array<Column, NUM_REGISTERS> REGISTER_IS_WRITE_COLUMNS = {
    C::execution_rw1, C::execution_rw2, C::execution_rw3, C::execution_rw4,
    C::execution_rw5, C::execution_rw6, C::execution_rw7,
};
constexpr std::array<Column, NUM_REGISTERS> REGISTER_MEM_OP_COLUMNS = {
    C::execution_mem_op1, C::execution_mem_op2, C::execution_mem_op3, C::execution_mem_op4,
    C::execution_mem_op5, C::execution_mem_op6, C::execution_mem_op7,
};
    ...
    const simulation::EventEmitterInterface<simulation::ExecutionEvent>::Container& ex_events, TraceContainer& trace)
{
    ...
    for (const auto& ex_event : ex_events) {
        ...
        trace.set(row,
                  { {
                      { C::execution_sel_should_resolve_address, should_resolve_address ? 1 : 0 },
