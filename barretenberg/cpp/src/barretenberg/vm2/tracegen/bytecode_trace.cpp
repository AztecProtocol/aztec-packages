    ...
    for (const auto& event : events) {
        trace.set(row,
                  { {
                      ...
                      { C::bc_retrieval_class_id, event.class_id },
    ...
    TraceContainer& trace)
{
    ...
    for (const auto& event : events) {
        const auto class_id = event.class_id;
        ...
        trace.set(row,
                  { {
                      ...
                      { C::instr_fetching_class_id, class_id },
