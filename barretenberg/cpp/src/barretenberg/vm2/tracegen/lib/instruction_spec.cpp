...
const std::unordered_map<ExecutionOpCode, SubtraceInfo> SUBTRACE_INFO_MAP = {
    ...
    { ExecutionOpCode::NULLIFIEREXISTS,
      { .subtrace_selector = SubtraceSel::EXECUTION, .subtrace_operation_id = AVM_EXEC_OP_ID_NULLIFIEREXISTS } },
    { ExecutionOpCode::EMITNULLIFIER,
      { .subtrace_selector = SubtraceSel::EXECUTION, .subtrace_operation_id = AVM_EXEC_OP_ID_EMITNULLIFIER } },
    // KeccakF1600
