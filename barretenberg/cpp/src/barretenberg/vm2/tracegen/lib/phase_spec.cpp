    ...
    { TransactionPhase::SETUP,
      {
          ...
          .write_pi_offset = 0, // Write offset is 0 for public call requests
    ...
    { TransactionPhase::NR_NOTE_INSERTION,
      {
          ...
          .read_pi_length_offset = AVM_PUBLIC_INPUTS_PREVIOUS_NON_REVERTIBLE_ACCUMULATED_DATA_ARRAY_LENGTHS_ROW_IDX,
      } },
