...
const InteractionDefinition Sha256TraceBuilder::interactions =
    InteractionDefinition()
        ...
        .add<lookup_sha256_range_rhs_w_7_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_rhs_w_18_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_rhs_w_3_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_rhs_w_17_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_rhs_w_19_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_rhs_w_10_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_rhs_e_6_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_rhs_e_11_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_rhs_e_25_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_rhs_a_2_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_rhs_a_13_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_rhs_a_22_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        // Range checks for modulo add
        .add<lookup_sha256_range_comp_w_lhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_w_rhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_next_a_lhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_next_a_rhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_next_e_lhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_next_e_rhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_a_lhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_a_rhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_b_lhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_b_rhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_c_lhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_c_rhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_d_lhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_d_rhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_e_lhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_e_rhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_f_lhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_f_rhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_g_lhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_g_rhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_h_lhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel)
        .add<lookup_sha256_range_comp_h_rhs_settings, InteractionType::LookupGeneric>(Column::range_check_sel);
