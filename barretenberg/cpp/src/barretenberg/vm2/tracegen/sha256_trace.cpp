...
void Sha256TraceBuilder::set_helper_cols(std::array<uint32_t, 16> prev_w_helpers, TraceContainer& trace)
{
...
void Sha256TraceBuilder::set_state_cols(std::array<uint32_t, 8> state, TraceContainer& trace)
{
...
void Sha256TraceBuilder::set_init_state_cols(std::array<uint32_t, 8> init_state, TraceContainer& trace)
{
    for (size_t i = 0; i < 8; i++) {
...
void Sha256TraceBuilder::into_limbs_with_witness(
    uint64_t a, const uint8_t b, TraceContainer& trace, Column c_lhs, Column c_rhs)
{
    ...
    const uint32_t val, const uint8_t shift, TraceContainer& trace, Column c_result, Column c_lhs, Column c_rhs)
{
    ...
    into_limbs_with_witness(val, shift, trace, c_lhs, c_rhs);
...
uint32_t Sha256TraceBuilder::compute_w_with_witness(std::array<uint32_t, 16> prev_w_helpers, TraceContainer& trace)
{
    ...
    uint32_t rot_7 =
        ror_with_witness(prev_w_helpers[1], 7, trace, C::sha256_w_15_rotr_7, C::sha256_lhs_w_7, C::sha256_rhs_w_7);
    // Compute ror(w[i - 15], 18)
    uint32_t rot_18 =
        ror_with_witness(prev_w_helpers[1], 18, trace, C::sha256_w_15_rotr_18, C::sha256_lhs_w_18, C::sha256_rhs_w_18);
    // Compute (w[i - 15] >> 3)
    uint32_t shift_3 =
        shr_with_witness(prev_w_helpers[1], 3, trace, C::sha256_w_15_rshift_3, C::sha256_lhs_w_3, C::sha256_rhs_w_3);
    ...
    uint32_t rot_17 =
        ror_with_witness(prev_w_helpers[14], 17, trace, C::sha256_w_2_rotr_17, C::sha256_lhs_w_17, C::sha256_rhs_w_17);
    // Compute ror(wi - 2, 19)
    uint32_t rot_19 =
        ror_with_witness(prev_w_helpers[14], 19, trace, C::sha256_w_2_rotr_19, C::sha256_lhs_w_19, C::sha256_rhs_w_19);
    // Compute (w[i - 2] >> 10)
    uint32_t shift_10 = shr_with_witness(
        prev_w_helpers[14], 10, trace, C::sha256_w_2_rshift_10, C::sha256_lhs_w_10, C::sha256_rhs_w_10);
    ...
    into_limbs_with_witness(computed_w, 32, trace, C::sha256_computed_w_lhs, C::sha256_computed_w_rhs);
...
std::array<uint32_t, 8> Sha256TraceBuilder::compute_compression_with_witness(
    std::array<uint32_t, 8> state, uint32_t round_w, uint32_t round_constant, TraceContainer& trace, uint32_t row)
{
    ...
    // Compute ror(e, 6)
    uint32_t rot_6 = ror_with_witness(state[4], 6, trace, C::sha256_e_rotr_6, C::sha256_lhs_e_6, C::sha256_rhs_e_6);
    // Compute ror(e, 11)
    uint32_t rot_11 =
        ror_with_witness(state[4], 11, trace, C::sha256_e_rotr_11, C::sha256_lhs_e_11, C::sha256_rhs_e_11);
    // Compute ror(e, 25)
    uint32_t rot_25 =
        ror_with_witness(state[4], 25, trace, C::sha256_e_rotr_25, C::sha256_lhs_e_25, C::sha256_rhs_e_25);
    ...
    // Compute ror(a, 2)
    uint32_t rot_2 = ror_with_witness(state[0], 2, trace, C::sha256_a_rotr_2, C::sha256_lhs_a_2, C::sha256_rhs_a_2);
    // Compute ror(a, 13)
    uint32_t rot_13 =
        ror_with_witness(state[0], 13, trace, C::sha256_a_rotr_13, C::sha256_lhs_a_13, C::sha256_rhs_a_13);
    // Compute ror(a, 22)
    uint32_t rot_22 =
        ror_with_witness(state[0], 22, trace, C::sha256_a_rotr_22, C::sha256_lhs_a_22, C::sha256_rhs_a_22);
    ...
    into_limbs_with_witness(next_a, 32, trace, C::sha256_next_a_lhs, C::sha256_next_a_rhs);
    ...
    into_limbs_with_witness(next_e, 32, trace, C::sha256_next_e_lhs, C::sha256_next_e_rhs);
...
void Sha256TraceBuilder::compute_sha256_output(std::array<uint32_t, 8> state,
                                               std::array<uint32_t, 8> init_state,
                                               TraceContainer& trace)
{
    uint32_t counter = 0;
    for (auto [init, state] : zip_view(init_state, state)) {
        uint64_t output = static_cast<uint64_t>(init) + static_cast<uint64_t>(state);
        into_limbs_with_witness(output, 32, trace, output_cols[counter], output_cols[counter + 1]);
        counter += 2;
    }
}
    ...
    TraceContainer& trace)
{
    ...
    for (const auto& event : events) {
        ...
        for (size_t i = 0; i < 64; i++) {
            ...
            round_state = compute_compression_with_witness(round_state, round_w, round_constants[i], trace, row);
