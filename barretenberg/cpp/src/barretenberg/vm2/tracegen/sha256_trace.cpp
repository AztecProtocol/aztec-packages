    ...
    for (const auto& event : events) {
        ...
        trace.set(row,
                  { {
                      ...
                      // Output Values - reuse the already-computed output_*_rhs values from compute_sha256_output
                      { C::sha256_memory_register_0_, trace.get(C::sha256_output_a_rhs, row) },
                      { C::sha256_memory_register_1_, trace.get(C::sha256_output_b_rhs, row) },
                      { C::sha256_memory_register_2_, trace.get(C::sha256_output_c_rhs, row) },
                      { C::sha256_memory_register_3_, trace.get(C::sha256_output_d_rhs, row) },
                      { C::sha256_memory_register_4_, trace.get(C::sha256_output_e_rhs, row) },
                      { C::sha256_memory_register_5_, trace.get(C::sha256_output_f_rhs, row) },
                      { C::sha256_memory_register_6_, trace.get(C::sha256_output_g_rhs, row) },
                      { C::sha256_memory_register_7_, trace.get(C::sha256_output_h_rhs, row) },
                      // Output Memory Tags
