...
const InteractionDefinition Sha256TraceBuilder::interactions =
    InteractionDefinition()
        ...
        // Bitwise operations
        .add<InteractionType::LookupGeneric, lookup_sha256_w_s_0_xor_0_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_w_s_0_xor_1_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_w_s_1_xor_0_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_w_s_1_xor_1_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_s_1_xor_0_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_s_1_xor_1_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_ch_and_0_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_ch_and_1_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_ch_xor_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_s_0_xor_0_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_s_0_xor_1_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_maj_and_0_settings>(C::bitwise_start)
        .add<InteractionType::LookupGeneric, lookup_sha256_maj_and_1_settings>(C::bitwise_start)
        ...
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_w_7_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_w_18_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_w_3_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_w_17_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_w_19_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_w_10_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_e_6_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_e_11_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_e_25_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_a_2_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_a_13_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_rhs_a_22_settings>(C::gt_sel)
        ...
        .add<InteractionType::LookupGeneric, lookup_sha256_range_comp_w_rhs_settings>(C::gt_sel)
        .add<InteractionType::LookupIntoIndexedByRow, lookup_sha256_range_comp_next_a_lhs_settings>()
        .add<InteractionType::LookupGeneric, lookup_sha256_range_comp_next_a_rhs_settings>(C::gt_sel)
        .add<InteractionType::LookupIntoIndexedByRow, lookup_sha256_range_comp_next_e_lhs_settings>()
        .add<InteractionType::LookupGeneric, lookup_sha256_range_comp_next_e_rhs_settings>(C::gt_sel)
        // Output rhs GT checks (output lhs uses boolean constraints, no lookup needed)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_comp_a_rhs_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_comp_b_rhs_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_comp_c_rhs_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_comp_d_rhs_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_comp_e_rhs_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_comp_f_rhs_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_comp_g_rhs_settings>(C::gt_sel)
        .add<InteractionType::LookupGeneric, lookup_sha256_range_comp_h_rhs_settings>(C::gt_sel);
