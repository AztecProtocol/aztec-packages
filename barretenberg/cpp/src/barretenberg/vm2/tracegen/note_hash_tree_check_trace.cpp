    ...
    process_with_discard(events, [&](const simulation::NoteHashTreeReadWriteEvent& event, bool discard) {
        ...
        trace.set(row,
                  { { { C::note_hash_tree_check_sel, 1 },
                      ...
                      { C::note_hash_tree_check_siloing_separator, DOM_SEP__SILOED_NOTE_HASH },
                      ...
                      { C::note_hash_tree_check_nonce_separator, DOM_SEP__NOTE_HASH_NONCE },
                      { C::note_hash_tree_check_unique_note_hash_separator, DOM_SEP__UNIQUE_NOTE_HASH },
