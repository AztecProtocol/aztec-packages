    ...
    TraceContainer& trace)
{
        ...
        for (size_t i = 0; i < num_perm_events; i++) {
            ...
            trace.set(row,
                      { {
                          ...
                          { C::poseidon2_hash_num_perm_rounds_rem_min_one_inv,
                            num_perm_events - i - 1 }, // Will be batch inverted.
    ...
    trace.invert_columns({ { C::poseidon2_hash_num_perm_rounds_rem_min_one_inv } });
}
