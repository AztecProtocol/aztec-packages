...
std::vector<std::function<void()>> AvmTraceGenHelper::build_precomputed_columns_jobs(TraceContainer& trace)
{
...
std::vector<std::function<void()>> AvmTraceGenHelper::build_public_inputs_columns_jobs(
    TraceContainer& trace, const PublicInputs& public_inputs)
{
    return std::vector<std::function<void()>>{
        [&]() {
            PublicInputsTraceBuilder public_inputs_builder;
...
std::vector<std::function<void()>> AvmTraceGenHelper::build_fill_trace_columns_jobs(
    TraceContainer& trace, simulation::EventsContainer&& events)
{
    return std::vector<std::function<void()>>{
        [&]() {
        ...
        [&]() {
            ...
            AVM_TRACK_TIME("tracegen/class_id_derivation", class_id_builder.process(events.class_id_derivation, trace));
        ...
        [&]() {
            ...
            AVM_TRACK_TIME("tracegen/sha256_compression", sha256_builder.process(events.sha256_compression, trace));
        ...
        [&]() {
            EccTraceBuilder ecc_builder;
            AVM_TRACK_TIME("tracegen/ecc_add_memory", ecc_builder.process_add_with_memory(events.ecc_add_mem, trace));
        ...
        [&]() {
            Poseidon2TraceBuilder poseidon2_builder;
            AVM_TRACK_TIME("tracegen/poseidon2_permutation_with_memory",
        ...
        [&]() {
            ...
            AVM_TRACK_TIME("tracegen/context_stack", context_stack_builder.process(events.context_stack, trace));
            clear_events(events.context_stack);
        },
        [&]() {
            NoteHashTreeCheckTraceBuilder note_hash_tree_check_trace_builder;
            AVM_TRACK_TIME("tracegen/note_hash_tree_check",
        ...
        [&]() {
            ...
            AVM_TRACK_TIME(
                "tracegen/l1_to_l2_message_tree_check",
                l1_to_l2_message_tree_check_trace_builder.process(events.l1_to_l2_msg_tree_check_events, trace));
        ...
        [&]() {
            ...
            AVM_TRACK_TIME(
                "tracegen/retrieved_bytecodes_tree_check",
                retrieved_bytecodes_tree_check_builder.process(events.retrieved_bytecodes_tree_check_events, trace));
