...
//         // z1 and z2
//         prover_polynomials.x_hi_z_1.at(i + 1) = FF(engine.get_random_uint256() & ((uint256_t(1) << Z_LIMB_WIDTH) -
//         1)); prover_polynomials.y_lo_z_2.at(i + 1) = FF(engine.get_random_uint256() & ((uint256_t(1) << Z_LIMB_WIDTH)
//         - 1));

//         // Slice P.x into chunks
//         prover_polynomials.p_x_low_limbs.at(i) = uint256_t(prover_polynomials.x_lo_y_hi.at(i)).slice(0,
//         NUM_LIMB_BITS); prover_polynomials.p_x_low_limbs.at(i + 1) =
