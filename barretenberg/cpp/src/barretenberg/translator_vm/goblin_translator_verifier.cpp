    ...
    namespace bb
{
    ...
    void GoblinTranslatorVerifier::put_translation_data_in_relation_parameters(
        const uint256_t& evaluation_input_x, const BF& batching_challenge_v, const uint256_t& accumulated_result)
    {
    ...
    bool GoblinTranslatorVerifier::verify_proof(const plonk::proof& proof)
    {
        ...
        commitments.z_low_limbs_range_constraint_0 =
            receive_commitment(commitment_labels.z_low_limbs_range_constraint_0);
        commitments.z_low_limbs_range_constraint_1 =
            receive_commitment(commitment_labels.z_low_limbs_range_constraint_1);
        commitments.z_low_limbs_range_constraint_2 =
            receive_commitment(commitment_labels.z_low_limbs_range_constraint_2);
        commitments.z_low_limbs_range_constraint_3 =
            receive_commitment(commitment_labels.z_low_limbs_range_constraint_3);
        commitments.z_low_limbs_range_constraint_4 =
            receive_commitment(commitment_labels.z_low_limbs_range_constraint_4);
        ...
        commitments.z_high_limbs_range_constraint_0 =
            receive_commitment(commitment_labels.z_high_limbs_range_constraint_0);
        commitments.z_high_limbs_range_constraint_1 =
            receive_commitment(commitment_labels.z_high_limbs_range_constraint_1);
        commitments.z_high_limbs_range_constraint_2 =
            receive_commitment(commitment_labels.z_high_limbs_range_constraint_2);
        commitments.z_high_limbs_range_constraint_3 =
            receive_commitment(commitment_labels.z_high_limbs_range_constraint_3);
        commitments.z_high_limbs_range_constraint_4 =
            receive_commitment(commitment_labels.z_high_limbs_range_constraint_4);
        ...
        // unrolled protocol.
        auto pairing_points =
            ZeroMorphVerifier_<Flavor::Curve>::verify(commitments.get_unshifted(),
    ...
    bool GoblinTranslatorVerifier::verify_translation(const TranslationEvaluations& translation_evaluations)
    {
        ...
        const auto& reconstruct_value_from_eccvm_evaluations =
            [&](const TranslationEvaluations& translation_evaluations, auto& relation_parameters) {
