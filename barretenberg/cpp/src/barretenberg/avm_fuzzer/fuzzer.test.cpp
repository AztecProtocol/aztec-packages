...
TEST(fuzz, EQ8)
{
    ...
    auto result = get_result_of_instruction(eq_instruction);
    EXPECT_EQ(result, 0);
}
...
TEST(fuzz, LT8)
{
    ...
    auto result = get_result_of_instruction(lt_instruction);
    EXPECT_EQ(result, 0);
}
...
TEST(fuzz, LTE8)
{
    ...
    auto result = get_result_of_instruction(lte_instruction);
    EXPECT_EQ(result, 0);
}
