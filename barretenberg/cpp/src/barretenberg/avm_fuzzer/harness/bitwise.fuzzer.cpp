    ...
    for (uint8_t i = 1; i < 17; i++) {
        trace.set(i,
                  { {
                      ...
                      { Column::bitwise_start, 0 },
                      { Column::bitwise_sel_get_ctr, 0 },
                      { Column::bitwise_end, 0 },
                      { Column::bitwise_acc_ia, 0 },
                      { Column::bitwise_acc_ib, 0 },
                      { Column::bitwise_acc_ic, 0 },
                      { Column::bitwise_ia_byte, 0 },
                      { Column::bitwise_ib_byte, 0 },
                      { Column::bitwise_ic_byte, 0 },
                      ...
                      { Column::bitwise_ctr, 0 },
                      { Column::bitwise_ctr_min_one_inv, 0 },
