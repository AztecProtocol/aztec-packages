#include "plonk_ultra_circuit_builder.hpp"
...
template <typename Arithmetization> void PlonkUltraCircuitBuilder_<Arithmetization>::finalize_circuit()
{
    /**
...
void PlonkUltraCircuitBuilder_<Arithmetization>::add_gates_to_ensure_all_polys_are_non_zero()
{
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_add_gate(const add_triple_<FF>& in)
{
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_big_add_gate(const add_quad_<FF>& in,
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_big_add_gate_with_bit_extraction(const add_quad_<FF>& in)
{
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_big_mul_gate(const mul_quad_<FF>& in)
{
    this->assert_valid_variables({ in.a, in.b, in.c, in.d });
...
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_balanced_add_gate(const add_quad_<FF>& in)
{
    this->assert_valid_variables({ in.a, in.b, in.c, in.d });
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_mul_gate(const mul_triple_<FF>& in)
{
    this->assert_valid_variables({ in.a, in.b, in.c });
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_bool_gate(const uint32_t variable_index)
{
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_poly_gate(const poly_triple_<FF>& in)
{
    this->assert_valid_variables({ in.a, in.b, in.c });
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_ecc_add_gate(const ecc_add_gate_<FF>& in)
{
    /**
     * gate structure:
     * | 1  | 2  | 3  | 4  |
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_ecc_dbl_gate(const ecc_dbl_gate_<FF>& in)
{
    /**
     * gate structure:
     * | 1  | 2  | 3  | 4  |
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::fix_witness(const uint32_t witness_index, const FF& witness_value)
{
...
template <typename Arithmetization>
uint32_t PlonkUltraCircuitBuilder_<Arithmetization>::put_constant_variable(const FF& variable)
{
...
template <typename Arithmetization>
plookup::BasicTable& PlonkUltraCircuitBuilder_<Arithmetization>::get_table(const plookup::BasicTableId id)
{
...
template <typename Arithmetization>
plookup::ReadData<uint32_t> PlonkUltraCircuitBuilder_<Arithmetization>::create_gates_from_plookup_accumulators(
 ...
 **/
template <typename Arithmetization>
typename PlonkUltraCircuitBuilder_<Arithmetization>::RangeList PlonkUltraCircuitBuilder_<
    Arithmetization>::create_range_list(const uint64_t target_range)
{
    RangeList result;
...
template <typename Arithmetization>
std::vector<uint32_t> PlonkUltraCircuitBuilder_<Arithmetization>::decompose_into_default_range(
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_new_range_constraint(const uint32_t variable_index,
...
template <typename Arithmetization> void PlonkUltraCircuitBuilder_<Arithmetization>::process_range_list(RangeList& list)
{
...
template <typename Arithmetization> void PlonkUltraCircuitBuilder_<Arithmetization>::process_range_lists()
{
...
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_sort_constraint(const std::vector<uint32_t>& variable_index)
{
    constexpr size_t gate_width = NUM_WIRES;
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_dummy_gate(
...
// multiples of three
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_dummy_constraints(const std::vector<uint32_t>& variable_index)
{
...
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_sort_constraint_with_edges(
...
template <typename Arithmetization>
std::vector<uint32_t> PlonkUltraCircuitBuilder_<Arithmetization>::decompose_into_default_range_better_for_oddlimbnum(
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::apply_aux_selectors(const AUX_SELECTORS type)
{
 ...
 **/
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::range_constrain_two_limbs(const uint32_t lo_idx,
...
template <typename Arithmetization>
std::array<uint32_t, 2> PlonkUltraCircuitBuilder_<Arithmetization>::decompose_non_native_field_double_width_limb(
...
template <typename Arithmetization>
std::array<uint32_t, 2> PlonkUltraCircuitBuilder_<Arithmetization>::evaluate_non_native_field_multiplication(
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::process_non_native_field_multiplications()
{
...
template <typename Arithmetization>
std::array<uint32_t, 2> PlonkUltraCircuitBuilder_<Arithmetization>::queue_partial_non_native_field_multiplication(
...
template <typename Arithmetization>
std::array<uint32_t, 5> PlonkUltraCircuitBuilder_<Arithmetization>::evaluate_non_native_field_addition(
...
template <typename Arithmetization>
std::array<uint32_t, 5> PlonkUltraCircuitBuilder_<Arithmetization>::evaluate_non_native_field_subtraction(
    add_simple limb0, add_simple limb1, add_simple limb2, add_simple limb3, std::tuple<uint32_t, uint32_t, FF> limbp)
{
    const auto& x_0 = std::get<0>(limb0).first;
    const auto& x_1 = std::get<0>(limb1).first;
 ...
 */
template <typename Arithmetization> void PlonkUltraCircuitBuilder_<Arithmetization>::create_ROM_gate(RomRecord& record)
{
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_sorted_ROM_gate(RomRecord& record)
{
    record.record_witness = this->add_variable(0);
...
template <typename Arithmetization>
size_t PlonkUltraCircuitBuilder_<Arithmetization>::create_ROM_array(const size_t array_size)
{
 ...
 * @param record Stores details of this read operation. Mutated by this fn!
 */
template <typename Arithmetization> void PlonkUltraCircuitBuilder_<Arithmetization>::create_RAM_gate(RamRecord& record)
{
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_sorted_RAM_gate(RamRecord& record)
{
    record.record_witness = this->add_variable(0);
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::create_final_sorted_RAM_gate(RamRecord& record,
 ...
 */
template <typename Arithmetization>
size_t PlonkUltraCircuitBuilder_<Arithmetization>::create_RAM_array(const size_t array_size)
{
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::init_RAM_element(const size_t ram_id,
...
template <typename Arithmetization>
uint32_t PlonkUltraCircuitBuilder_<Arithmetization>::read_RAM_array(const size_t ram_id, const uint32_t index_witness)
{
    ASSERT(ram_arrays.size() > ram_id);
    RamTranscript& ram_array = ram_arrays[ram_id];
...
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::write_RAM_array(const size_t ram_id,
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::set_ROM_element(const size_t rom_id,
                                                                 const size_t index_value,
                                                                 const uint32_t value_witness)
{
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::set_ROM_element_pair(const size_t rom_id,
                                                                      const size_t index_value,
 ...
 */
template <typename Arithmetization>
uint32_t PlonkUltraCircuitBuilder_<Arithmetization>::read_ROM_array(const size_t rom_id, const uint32_t index_witness)
{
    ASSERT(rom_arrays.size() > rom_id);
    RomTranscript& rom_array = rom_arrays[rom_id];
    const uint32_t index = static_cast<uint32_t>(uint256_t(this->get_variable(index_witness)));
...
template <typename Arithmetization>
std::array<uint32_t, 2> PlonkUltraCircuitBuilder_<Arithmetization>::read_ROM_array_pair(const size_t rom_id,
                                                                                        const uint32_t index_witness)
{
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::process_ROM_array(const size_t rom_id)
{
 ...
 */
template <typename Arithmetization>
void PlonkUltraCircuitBuilder_<Arithmetization>::process_RAM_array(const size_t ram_id)
{
    RamTranscript& ram_array = ram_arrays[ram_id];
...
template <typename Arithmetization> void PlonkUltraCircuitBuilder_<Arithmetization>::process_ROM_arrays()
{
    for (size_t i = 0; i < rom_arrays.size(); ++i) {
        process_ROM_array(i);
    }
}
template <typename Arithmetization> void PlonkUltraCircuitBuilder_<Arithmetization>::process_RAM_arrays()
{
...
template <typename Arithmetization> uint256_t PlonkUltraCircuitBuilder_<Arithmetization>::hash_circuit()
{
    finalize_circuit();
...
template class PlonkUltraCircuitBuilder_<UltraArith<bb::fr>>;
template class PlonkUltraCircuitBuilder_<UltraHonkArith<bb::fr>>;
// To enable this we need to template plookup
// template class PlonkUltraCircuitBuilder_<grumpkin::fr>;
