...
template <typename FF_> class TranslatorNonNativeFieldShortRelationImpl {
  public:
    using FF = FF_;
...
using TranslatorNonNativeFieldShortRelation = Relation<TranslatorNonNativeFieldShortRelationImpl<FF>>;
