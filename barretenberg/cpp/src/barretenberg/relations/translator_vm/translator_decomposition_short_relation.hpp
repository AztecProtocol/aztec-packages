...
template <typename FF_> class TranslatorDecompositionShortRelationImpl {
  public:
    using FF = FF_;
...
using TranslatorDecompositionShortRelation = Relation<TranslatorDecompositionShortRelationImpl<FF>>;
