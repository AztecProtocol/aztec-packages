...
TEST_F(TranslatorRelationConsistency, AccumulatorTransferRelation)
{
    const auto run_test = [](bool random_inputs) {
        ...
        expected_values[0] =
            lagrange_odd_in_minicircuit * (accumulators_binary_limbs_0 - accumulators_binary_limbs_0_shift);
        expected_values[1] =
            lagrange_odd_in_minicircuit * (accumulators_binary_limbs_1 - accumulators_binary_limbs_1_shift);
        expected_values[2] =
            lagrange_odd_in_minicircuit * (accumulators_binary_limbs_2 - accumulators_binary_limbs_2_shift);
        expected_values[3] =
            lagrange_odd_in_minicircuit * (accumulators_binary_limbs_3 - accumulators_binary_limbs_3_shift);
...
//             (p_x_low_limbs + p_x_low_limbs_shift * shift + p_x_high_limbs * shiftx2 + p_x_high_limbs_shift *
//             shiftx3);
//         auto reconstructed_p_y =
//             (p_y_low_limbs + p_y_low_limbs_shift * shift + p_y_high_limbs * shiftx2 + p_y_high_limbs_shift *
//             shiftx3);
...
//             (accumulators_binary_limbs_0 + accumulators_binary_limbs_1 * shift + accumulators_binary_limbs_2 *
//             shiftx2 +
