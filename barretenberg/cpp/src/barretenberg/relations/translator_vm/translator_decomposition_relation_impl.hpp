                                                         ...
                                                         const FF& scaling_factor)
{
    ...
    auto even_and_not_noop_range = lagrange_even_in_minicircuit * (no_op + minus_one);
    ...
    auto tmp_10 = ((z_low_limbs_range_constraint_0_shift + z_low_limbs_range_constraint_1_shift * MICRO_LIMB_SHIFT +
                   ...
                   z_low_limbs_shift);
    tmp_10 *= even_and_not_noop_range;
    ...
    auto tmp_11 =
        ((z_high_limbs_range_constraint_0 + z_high_limbs_range_constraint_1 * MICRO_LIMB_SHIFT +
         ...
         z_high_limbs);
    tmp_11 *= even_and_not_noop_range;
    ...
    auto tmp_12 = ((z_high_limbs_range_constraint_0_shift + z_high_limbs_range_constraint_1_shift * MICRO_LIMB_SHIFT +
                   ...
                   z_high_limbs_shift);
    tmp_12 *= even_and_not_noop_range;
    tmp_12 *= scaling_factor;
    std::get<11>(accumulators) += tmp_12;

    // WORKTODO: 12 -15 have to be tweaked for the no-op region
    ...
    tmp_13 *= even_and_not_noop_range; //* (1 - no_op);
    ...
    tmp_14 *= even_and_not_noop_range; //* (1 - no_op);
    ...
    tmp_15 *= even_and_not_noop_range; //* (1 - no_op);
    ...
    tmp_16 *= even_and_not_noop_range; //* (1 - no_op);
    ...
    tmp_17 *= even_and_not_noop_range;
    ...
    tmp_18 *= even_and_not_noop_range;
    ...
    tmp_19 *= even_and_not_noop_range;
    ...
    tmp_20 *= even_and_not_noop_range;
    ...
    auto tmp_21 = ((relation_wide_limbs_range_constraint_0 + relation_wide_limbs_range_constraint_1 * MICRO_LIMB_SHIFT +
                   ...
                   relation_wide_limbs);
    tmp_21 *= even_and_not_noop_range;
    ...
    tmp_22 *= even_and_not_noop_range;
    ...
    tmp_23 *= even_and_not_noop_range;
    ...
    tmp_24 *= even_and_not_noop_range;
    ...
    tmp_25 *= even_and_not_noop_range;
    ...
    tmp_26 *= even_and_not_noop_range;
    ...
    tmp_27 *= even_and_not_noop_range;
    ...
    tmp_28 *= even_and_not_noop_range;
    ...
    tmp_29 *= even_and_not_noop_range;
    ...
    tmp_30 *= even_and_not_noop_range;
    ...
    tmp_31 *= even_and_not_noop_range;
    ...
    tmp_32 *= even_and_not_noop_range;
    ...
    tmp_33 *= even_and_not_noop_range;
    ...
    tmp_34 *= even_and_not_noop_range;
    ...
    tmp_35 *= even_and_not_noop_range;
    ...
    tmp_36 *= even_and_not_noop_range;
    ...
    tmp_37 *= even_and_not_noop_range;
    ...
    tmp_38 *= even_and_not_noop_range;
    ...
    tmp_39 *= even_and_not_noop_range;
    ...
    tmp_40 *= even_and_not_noop_range;
    ...
    tmp_41 *= even_and_not_noop_range;
    ...
    tmp_42 *= even_and_not_noop_range;
    ...
    tmp_43 *= even_and_not_noop_range;
    ...
    tmp_44 *= even_and_not_noop_range;
    ...
    tmp_45 *= even_and_not_noop_range;
    ...
    tmp_46 *= even_and_not_noop_range;
    ...
    tmp_47 *= even_and_not_noop_range;
    ...
    tmp_48 *= even_and_not_noop_range;
