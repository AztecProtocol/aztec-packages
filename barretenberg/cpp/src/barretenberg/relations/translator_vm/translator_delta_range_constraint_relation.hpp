...
template <typename FF_> class TranslatorDeltaRangeConstraintRelationImpl {
  public:
    ...
    static constexpr size_t RELATION_LENGTH = 65; // degree((lagrange_last-1) * D(D - 1)(D - 2)(D - 3)) = 5

    static constexpr std::array<size_t, 10> SUBRELATION_PARTIAL_LENGTHS{
        64, // ordered_range_constraints_0 step in {0,1,2,3} subrelation
        64, // ordered_range_constraints_1 step in {0,1,2,3} subrelation
        64, // ordered_range_constraints_2 step in {0,1,2,3} subrelation
        64, // ordered_range_constraints_3 step in {0,1,2,3} subrelation
        64, // ordered_range_constraints_4 step in {0,1,2,3} subrelation
        34, // ordered_range_constraints_0 ends with defined maximum value subrelation
