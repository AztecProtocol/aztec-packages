...
// AllEntities-shaped input for Poseidon2 relation manual tests — generator-emitted std::array
// storage with EntityId-keyed access. Only the fields each test sets are non-zero; everything
// else stays default-initialised to FF(0).
...
TEST_F(RelationManual, Poseidon2ExternalRelationZeros)
{
    ...
    all_poseidon_values[EntityId::q_poseidon2_external] = 1;
...
TEST_F(RelationManual, Poseidon2ExternalRelationRandom)
{
    ...
    AllPoseidonValues all_poseidon_values{};
    all_poseidon_values[EntityId::q_poseidon2_external] = 1;
    all_poseidon_values[EntityId::q_l] = 6;
    all_poseidon_values[EntityId::q_r] = 9;
    all_poseidon_values[EntityId::q_o] = 8;
    all_poseidon_values[EntityId::q_4] = 3;
    all_poseidon_values[EntityId::w_l] = 5;
    all_poseidon_values[EntityId::w_r] = 4;
    all_poseidon_values[EntityId::w_o] = 1;
    all_poseidon_values[EntityId::w_4] = 7;
    all_poseidon_values[EntityId::w_l_shift] = 3763355;
    all_poseidon_values[EntityId::w_r_shift] = 3031011;
    all_poseidon_values[EntityId::w_o_shift] = 2270175;
    all_poseidon_values[EntityId::w_4_shift] = 1368540;
...
TEST_F(RelationManual, Poseidon2InternalRelationZeros)
{
    ...
    Accumulator acc{ 0, 0, 0, 0 };
    AllPoseidonValues all_poseidon_values{};
    all_poseidon_values[EntityId::q_poseidon2_internal] = 1;
...
TEST_F(RelationManual, Poseidon2InternalRelationRandom)
{
    ...
    AllPoseidonValues all_poseidon_values{};
    all_poseidon_values[EntityId::q_poseidon2_internal] = 1;
    all_poseidon_values[EntityId::q_l] = 5;
    all_poseidon_values[EntityId::w_l] = 1;
    all_poseidon_values[EntityId::w_r] = 2;
    all_poseidon_values[EntityId::w_o] = 3;
    all_poseidon_values[EntityId::w_4] = 4;
    all_poseidon_values[EntityId::w_l_shift] =
        FF(std::string("0x122d9ce41e83c533318954d77a4ebc40eb729f6543ebd5f2e4ecb175ced3bc74"));
    all_poseidon_values[EntityId::w_r_shift] =
        FF(std::string("0x185028b6d489be7c029367a14616776b33bf2eada9bb370950d6719f68b5067f"));
    all_poseidon_values[EntityId::w_o_shift] =
        FF(std::string("0x00fce289a96b3f4a18562d0ef0ab76ca165e613222aa0c24501377003c5622a8"));
    all_poseidon_values[EntityId::w_4_shift] =
