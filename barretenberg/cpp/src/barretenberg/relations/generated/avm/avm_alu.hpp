  ...
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        // Contribution 3
        {
            ...
            auto tmp = ((avm_alu_cf * (-avm_alu_cf + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<3>(evals) += tmp;
        }
        // Contribution 4
        {
            ...
            auto tmp = ((avm_alu_ff_tag * (-avm_alu_ff_tag + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<4>(evals) += tmp;
        }
        // Contribution 5
        {
            ...
            auto tmp = ((avm_alu_u8_tag * (-avm_alu_u8_tag + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<5>(evals) += tmp;
        }
        // Contribution 6
        {
            ...
            auto tmp = ((avm_alu_u16_tag * (-avm_alu_u16_tag + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<6>(evals) += tmp;
        }
        // Contribution 7
        {
            ...
            auto tmp = ((avm_alu_u32_tag * (-avm_alu_u32_tag + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<7>(evals) += tmp;
        }
        // Contribution 8
        {
            ...
            auto tmp = ((avm_alu_u64_tag * (-avm_alu_u64_tag + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<8>(evals) += tmp;
        }
        // Contribution 9
        {
            ...
            auto tmp = ((avm_alu_u128_tag * (-avm_alu_u128_tag + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<9>(evals) += tmp;
        }
        // Contribution 10
        ...
        // Contribution 14
        {
            ...
            auto tmp = (((avm_alu_ff_tag * avm_alu_op_mul) * ((avm_alu_ia * avm_alu_ib) - avm_alu_ic)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 20
        {
            ...
            auto tmp = ((avm_alu_op_not * avm_alu_ff_tag) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 22
        {
            ...
            auto tmp = (((avm_alu_cmp_sel + avm_alu_op_eq) * (avm_alu_ic * (-avm_alu_ic + FF(1)))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 26
        {
            ...
            auto tmp = ((avm_alu_p_a_borrow * (-avm_alu_p_a_borrow + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 29
        {
            ...
            auto tmp = ((avm_alu_p_b_borrow * (-avm_alu_p_b_borrow + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 32
        {
            ...
            auto tmp = (((avm_alu_res_lo -
                          (((((avm_alu_a_lo - avm_alu_b_lo) - FF(1)) +
                             (avm_alu_borrow * FF(uint256_t{ 0UL, 0UL, 1UL, 0UL }))) *
        ...
        // Contribution 34
        {
            ...
            auto tmp = ((((avm_alu_cmp_rng_ctr_shift - avm_alu_cmp_rng_ctr) + FF(1)) * avm_alu_cmp_rng_ctr) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 35
        {
            ...
            auto tmp = (((avm_alu_cmp_rng_ctr_shift - FF(4)) * avm_alu_cmp_sel) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 36
        {
            ...
            auto tmp = ((avm_alu_rng_chk_sel * (-avm_alu_rng_chk_sel + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 37
        {
            ...
            auto tmp = ((avm_alu_rng_chk_sel * avm_alu_cmp_sel) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 42
        {
            ...
            auto tmp = (((avm_alu_a_lo_shift - avm_alu_b_lo) * avm_alu_rng_chk_sel_shift) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 43
        {
            ...
            auto tmp = (((avm_alu_a_hi_shift - avm_alu_b_hi) * avm_alu_rng_chk_sel_shift) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 44
        {
            ...
            auto tmp = (((avm_alu_b_lo_shift - avm_alu_p_sub_a_lo) * avm_alu_rng_chk_sel_shift) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 45
        {
            ...
            auto tmp = (((avm_alu_b_hi_shift - avm_alu_p_sub_a_hi) * avm_alu_rng_chk_sel_shift) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 46
        {
            ...
            auto tmp = (((avm_alu_p_sub_a_lo_shift - avm_alu_p_sub_b_lo) * avm_alu_rng_chk_sel_shift) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 47
        {
            ...
            auto tmp = (((avm_alu_p_sub_a_hi_shift - avm_alu_p_sub_b_hi) * avm_alu_rng_chk_sel_shift) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 48
        {
            ...
            auto tmp = (((avm_alu_p_sub_b_lo_shift - avm_alu_res_lo) * avm_alu_rng_chk_sel_shift) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 49
        {
            ...
            auto tmp = (((avm_alu_p_sub_b_hi_shift - avm_alu_res_hi) * avm_alu_rng_chk_sel_shift) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 52
        {
            ...
            auto tmp = ((avm_alu_op_cast * (avm_alu_a_lo_shift - avm_alu_p_sub_a_lo)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 53
        {
            ...
            auto tmp = ((avm_alu_op_cast * (avm_alu_a_hi_shift - avm_alu_p_sub_a_hi)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 54
        {
            ...
            auto tmp = ((((avm_alu_op_mul * avm_alu_u128_tag) + avm_alu_op_cast) * avm_alu_alu_sel_shift) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 59
        {
            ...
            auto tmp = ((avm_alu_shift_lt_bit_len * (-avm_alu_shift_lt_bit_len + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 62
        {
            ...
            auto tmp = ((avm_alu_op_shr * (avm_alu_ic - (avm_alu_b_hi * avm_alu_shift_lt_bit_len))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 66
        {
            ...
            auto tmp = ((avm_alu_op_div_a_lt_b * (-avm_alu_op_div_a_lt_b + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 67
        {
            ...
            auto tmp = ((avm_alu_op_div_a_lt_b * (avm_alu_a_lo - ((avm_alu_ib - avm_alu_ia) - FF(1)))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 68
        {
            ...
            auto tmp = ((avm_alu_op_div_a_lt_b * avm_alu_ic) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 69
        {
            ...
            auto tmp = ((avm_alu_op_div_a_lt_b * (avm_alu_ia - avm_alu_remainder)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 70
        {
            ...
            auto tmp = ((avm_alu_op_div_std * (-avm_alu_op_div_std + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 74
        {
            ...
            auto tmp =
                ((avm_alu_op_div_std * ((((avm_alu_divisor_lo * avm_alu_quotient_lo) +
        ...
        // Contribution 75
        {
            ...
            auto tmp = ((avm_alu_op_div_std * (avm_alu_b_hi - ((avm_alu_ib - avm_alu_remainder) - FF(1)))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 76
        {
            ...
            auto tmp = (((avm_alu_cmp_rng_ctr_shift - FF(2)) * avm_alu_op_div_std) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 77
        {
            ...
            auto tmp = ((avm_alu_rng_chk_sel * avm_alu_op_div_std) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 79
        {
            ...
            auto tmp = ((avm_alu_div_rng_chk_selector * (-avm_alu_div_rng_chk_selector + FF(1))) - FF(0));
            tmp *= scaling_factor;
