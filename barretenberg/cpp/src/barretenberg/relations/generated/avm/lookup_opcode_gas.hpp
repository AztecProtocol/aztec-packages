...
class lookup_opcode_gas_lookup_settings {
  public:
    ...
    {
        return (in.avm_main_opcode_active == 1 || in.avm_gas_add_to_gas_lookup_table == 1);
    }
    ...
    static inline auto compute_inverse_exists(const AllEntities& in)
    {
        ...
        const auto is_operation = View(in.avm_main_opcode_active);
        const auto is_table_entry = View(in.avm_gas_add_to_gas_lookup_table);
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        ...
        return std::forward_as_tuple(in.lookup_opcode_gas,
                                     ...
                                     in.avm_main_opcode_active,
                                     in.avm_gas_add_to_gas_lookup_table,
                                     in.avm_main_opcode_idx,
