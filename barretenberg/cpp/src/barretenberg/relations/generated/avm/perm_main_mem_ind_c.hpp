...
in.avm_mem_val
    ...
    template <typename FF_> using perm_main_mem_ind_c_relation = GenericPermutationRelation<perm_main_mem_ind_c_permutation_settings, FF_>; 
