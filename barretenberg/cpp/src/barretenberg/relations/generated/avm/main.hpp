  ...
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        // Contribution 2
        {
            ...
            auto tmp =
                ((main_gas_cost_active * ((main_l2_gas_remaining_shift - main_l2_gas_remaining) + main_l2_gas_op)) -
                 FF(0));
            tmp *= scaling_factor;
            std::get<2>(evals) += tmp;
        }
        // Contribution 3
        {
            ...
            auto tmp =
                ((main_gas_cost_active * ((main_da_gas_remaining_shift - main_da_gas_remaining) + main_da_gas_op)) -
                 FF(0));
            tmp *= scaling_factor;
            std::get<3>(evals) += tmp;
        }
        // Contribution 4
        {
            ...
            auto tmp = (((-main_gas_cost_active + FF(1)) * main_l2_gas_op) - FF(0));
            tmp *= scaling_factor;
            std::get<4>(evals) += tmp;
        }
        // Contribution 5
        {
            ...
            auto tmp = (((-main_gas_cost_active + FF(1)) * main_da_gas_op) - FF(0));
            tmp *= scaling_factor;
            std::get<5>(evals) += tmp;
        }
        // Contribution 6
        {
            ...
            auto tmp =
                ((main_gas_cost_active * ((((-(main_l2_out_of_gas * FF(2)) + FF(1)) * main_l2_gas_remaining_shift) -
        ...
        // Contribution 7
        {
            ...
            auto tmp =
                ((main_gas_cost_active * ((((-(main_da_out_of_gas * FF(2)) + FF(1)) * main_da_gas_remaining_shift) -
        ...
        // Contribution 8
        {
            ...
            auto tmp = ((main_sel_op_sender * (-main_sel_op_sender + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<8>(evals) += tmp;
        }
        // Contribution 9
        {
            ...
            auto tmp = ((main_sel_op_address * (-main_sel_op_address + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<9>(evals) += tmp;
        }
        // Contribution 10
        {
            ...
            auto tmp = ((main_sel_op_storage_address * (-main_sel_op_storage_address + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 11
        {
            ...
            auto tmp = ((main_sel_op_chain_id * (-main_sel_op_chain_id + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 12
        {
            ...
            auto tmp = ((main_sel_op_version * (-main_sel_op_version + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 13
        {
            ...
            auto tmp = ((main_sel_op_block_number * (-main_sel_op_block_number + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 14
        {
            ...
            auto tmp = ((main_sel_op_coinbase * (-main_sel_op_coinbase + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 15
        {
            ...
            auto tmp = ((main_sel_op_timestamp * (-main_sel_op_timestamp + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 16
        {
            ...
            auto tmp = ((main_sel_op_fee_per_l2_gas * (-main_sel_op_fee_per_l2_gas + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 17
        {
            ...
            auto tmp = ((main_sel_op_fee_per_da_gas * (-main_sel_op_fee_per_da_gas + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 18
        {
            ...
            auto tmp = ((main_sel_op_transaction_fee * (-main_sel_op_transaction_fee + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 19
        {
            ...
            auto tmp = ((main_sel_op_l2gasleft * (-main_sel_op_l2gasleft + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 20
        {
            ...
            auto tmp = ((main_sel_op_dagasleft * (-main_sel_op_dagasleft + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 21
        {
            ...
            auto tmp = ((main_sel_op_note_hash_exists * (-main_sel_op_note_hash_exists + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 22
        {
            ...
            auto tmp = ((main_sel_op_emit_note_hash * (-main_sel_op_emit_note_hash + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 23
        {
            ...
            auto tmp = ((main_sel_op_nullifier_exists * (-main_sel_op_nullifier_exists + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 24
        {
            ...
            auto tmp = ((main_sel_op_emit_nullifier * (-main_sel_op_emit_nullifier + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 25
        {
            ...
            auto tmp = ((main_sel_op_l1_to_l2_msg_exists * (-main_sel_op_l1_to_l2_msg_exists + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 26
        {
            ...
            auto tmp = ((main_sel_op_emit_unencrypted_log * (-main_sel_op_emit_unencrypted_log + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 27
        {
            ...
            auto tmp = ((main_sel_op_emit_l2_to_l1_msg * (-main_sel_op_emit_l2_to_l1_msg + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 28
        {
            ...
            auto tmp = ((main_sel_op_get_contract_instance * (-main_sel_op_get_contract_instance + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 29
        {
            ...
            auto tmp = ((main_sel_op_sload * (-main_sel_op_sload + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 30
        {
            ...
            auto tmp = ((main_sel_op_sstore * (-main_sel_op_sstore + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 31
        {
            ...
            auto tmp = ((main_sel_op_radix_le * (-main_sel_op_radix_le + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 32
        {
            ...
            auto tmp = ((main_sel_op_sha256 * (-main_sel_op_sha256 + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 33
        {
            ...
            auto tmp = ((main_sel_op_poseidon2 * (-main_sel_op_poseidon2 + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 34
        {
            ...
            auto tmp = ((main_sel_op_keccak * (-main_sel_op_keccak + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 35
        {
            ...
            auto tmp = ((main_sel_op_pedersen * (-main_sel_op_pedersen + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 36
        {
            ...
            auto tmp = ((main_sel_op_add * (-main_sel_op_add + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 37
        {
            ...
            auto tmp = ((main_sel_op_sub * (-main_sel_op_sub + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 38
        {
            ...
            auto tmp = ((main_sel_op_mul * (-main_sel_op_mul + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 39
        {
            ...
            auto tmp = ((main_sel_op_div * (-main_sel_op_div + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 40
        {
            ...
            auto tmp = ((main_sel_op_fdiv * (-main_sel_op_fdiv + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 41
        {
            ...
            auto tmp = ((main_sel_op_not * (-main_sel_op_not + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 42
        {
            ...
            auto tmp = ((main_sel_op_eq * (-main_sel_op_eq + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 43
        {
            ...
            auto tmp = ((main_sel_op_and * (-main_sel_op_and + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 44
        {
            ...
            auto tmp = ((main_sel_op_or * (-main_sel_op_or + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 45
        {
            ...
            auto tmp = ((main_sel_op_xor * (-main_sel_op_xor + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 46
        {
            ...
            auto tmp = ((main_sel_op_cast * (-main_sel_op_cast + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 47
        {
            ...
            auto tmp = ((main_sel_op_lt * (-main_sel_op_lt + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 48
        {
            ...
            auto tmp = ((main_sel_op_lte * (-main_sel_op_lte + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 49
        {
            ...
            auto tmp = ((main_sel_op_shl * (-main_sel_op_shl + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 50
        {
            ...
            auto tmp = ((main_sel_op_shr * (-main_sel_op_shr + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 51
        {
            ...
            auto tmp = ((main_sel_internal_call * (-main_sel_internal_call + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 52
        {
            ...
            auto tmp = ((main_sel_internal_return * (-main_sel_internal_return + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 53
        {
            ...
            auto tmp = ((main_sel_jump * (-main_sel_jump + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 54
        {
            ...
            auto tmp = ((main_sel_jumpi * (-main_sel_jumpi + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 55
        {
            ...
            auto tmp = ((main_sel_halt * (-main_sel_halt + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 56
        {
            ...
            auto tmp = ((main_sel_external_call * (-main_sel_external_call + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 57
        {
            ...
            auto tmp = ((main_sel_mov * (-main_sel_mov + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 58
        {
            ...
            auto tmp = ((main_sel_cmov * (-main_sel_cmov + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 62
        {
            ...
            auto tmp = ((main_mem_op_a * (-main_mem_op_a + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 63
        {
            ...
            auto tmp = ((main_mem_op_b * (-main_mem_op_b + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 64
        {
            ...
            auto tmp = ((main_mem_op_c * (-main_mem_op_c + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 65
        {
            ...
            auto tmp = ((main_mem_op_d * (-main_mem_op_d + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 66
        {
            ...
            auto tmp = ((main_rwa * (-main_rwa + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 67
        {
            ...
            auto tmp = ((main_rwb * (-main_rwb + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 68
        {
            ...
            auto tmp = ((main_rwc * (-main_rwc + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 69
        {
            ...
            auto tmp = ((main_rwd * (-main_rwd + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 70
        {
            ...
            auto tmp = ((main_ind_op_a * (-main_ind_op_a + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 71
        {
            ...
            auto tmp = ((main_ind_op_b * (-main_ind_op_b + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 72
        {
            ...
            auto tmp = ((main_ind_op_c * (-main_ind_op_c + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 73
        {
            ...
            auto tmp = ((main_ind_op_d * (-main_ind_op_d + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 82
        {
            ...
            auto tmp =
                ((((((((main_sel_op_note_hash_exists + main_sel_op_emit_note_hash) + main_sel_op_nullifier_exists) +
                  ...
                  (-main_q_kernel_output_lookup + FF(1))) -
                 FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 83
        {
            ...
            auto tmp = ((main_sel_jump * (main_pc_shift - main_ia)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 84
        {
            ...
            auto tmp = ((main_sel_jumpi * (((-main_id_zero + FF(1)) * (main_pc_shift - main_ia)) +
        ...
        // Contribution 85
        {
            ...
            auto tmp =
                ((main_sel_internal_call * (main_internal_return_ptr_shift - (main_internal_return_ptr + FF(1)))) -
                 FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 86
        {
            ...
            auto tmp = ((main_sel_internal_call * (main_internal_return_ptr - main_mem_idx_b)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 87
        {
            ...
            auto tmp = ((main_sel_internal_call * (main_pc_shift - main_ia)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 88
        {
            ...
            auto tmp = ((main_sel_internal_call * ((main_pc + FF(1)) - main_ib)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 89
        {
            ...
            auto tmp = ((main_sel_internal_call * (main_rwb - FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 90
        {
            ...
            auto tmp = ((main_sel_internal_call * (main_mem_op_b - FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 91
        {
            ...
            auto tmp =
                ((main_sel_internal_return * (main_internal_return_ptr_shift - (main_internal_return_ptr - FF(1)))) -
                 FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 92
        {
            ...
            auto tmp = ((main_sel_internal_return * ((main_internal_return_ptr - FF(1)) - main_mem_idx_a)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 93
        {
            ...
            auto tmp = ((main_sel_internal_return * (main_pc_shift - main_ia)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 94
        {
            ...
            auto tmp = ((main_sel_internal_return * main_rwa) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 95
        {
            ...
            auto tmp = ((main_sel_internal_return * (main_mem_op_a - FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 96
        {
            ...
            auto tmp = ((((((main_gas_cost_active -
                            ...
                            (((main_sel_jump + main_sel_jumpi) + main_sel_internal_call) + main_sel_internal_return)) -
                           main_sel_op_sload) -
                          main_sel_op_sstore) -
        ...
        // Contribution 97
        {
            ...
            auto tmp =
                (((((-main_first + FF(1)) * (-main_sel_halt + FF(1))) *
                   (((((((main_sel_op_fdiv +
                          ((((((((((main_sel_op_add + main_sel_op_sub) + main_sel_op_mul) + main_sel_op_div) +
                                 main_sel_op_not) +
                                main_sel_op_eq) +
        ...
        // Contribution 98
        {
            ...
            auto tmp =
                (((-(((main_first + main_sel_internal_call) + main_sel_internal_return) + main_sel_halt) + FF(1)) *
        ...
        // Contribution 99
        {
            ...
            auto tmp = (((main_sel_internal_call + main_sel_internal_return) * (main_space_id - FF(255))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 101
        {
            ...
            auto tmp = (((main_sel_cmov + main_sel_jumpi) * (((main_id * main_inv) - FF(1)) + main_id_zero)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 102
        {
            ...
            auto tmp = ((((main_sel_cmov + main_sel_jumpi) * main_id_zero) * (-main_inv + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 103
        {
            ...
            auto tmp = (main_sel_mov_a - (main_sel_mov + (main_sel_cmov * (-main_id_zero + FF(1)))));
            tmp *= scaling_factor;
        ...
        // Contribution 104
        {
            ...
            auto tmp = (main_sel_mov_b - (main_sel_cmov * main_id_zero));
            tmp *= scaling_factor;
        ...
        // Contribution 105
        {
            ...
            auto tmp = ((main_sel_mov_a * (main_ia - main_ic)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 106
        {
            ...
            auto tmp = ((main_sel_mov_b * (main_ib - main_ic)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 107
        {
            ...
            auto tmp = (((main_sel_mov + main_sel_cmov) * (main_r_in_tag - main_w_in_tag)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 108
        {
            ...
            auto tmp =
                (main_alu_sel - ((((((((((((main_sel_op_add + main_sel_op_sub) + main_sel_op_mul) + main_sel_op_div) +
                                         main_sel_op_not) +
                                        main_sel_op_eq) +
                                       main_sel_op_lt) +
                                      main_sel_op_lte) +
        ...
        // Contribution 125
        {
            ...
            auto tmp = ((main_first * kernel_note_hash_exist_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 127
        {
            ...
            auto tmp = ((main_first * kernel_emit_note_hash_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 129
        {
            ...
            auto tmp = ((main_first * kernel_nullifier_exists_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 130
        {
            ...
            auto tmp = ((main_first * kernel_nullifier_non_exists_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 132
        {
            ...
            auto tmp = ((main_first * kernel_emit_nullifier_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 134
        {
            ...
            auto tmp = ((main_first * kernel_l1_to_l2_msg_exists_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 136
        {
            ...
            auto tmp = ((main_first * kernel_emit_unencrypted_log_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 138
        {
            ...
            auto tmp = ((main_first * kernel_emit_l2_to_l1_msg_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 140
        {
            ...
            auto tmp = ((main_first * kernel_sload_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 142
        {
            ...
            auto tmp = ((main_first * kernel_sstore_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 145
        {
            ...
            auto tmp = (main_bin_sel - ((main_sel_op_and + main_sel_op_or) + main_sel_op_xor));
            tmp *= scaling_factor;
