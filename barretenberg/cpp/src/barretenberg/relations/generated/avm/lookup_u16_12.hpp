...
class lookup_u16_12_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        ...
        return std::forward_as_tuple(in.lookup_u16_12,
...
template <typename FF_> using lookup_u16_12_relation = GenericLookupRelation<lookup_u16_12_lookup_settings, FF_>;
