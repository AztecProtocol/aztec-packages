...
Avm_DECLARE_VIEWS(0);
    ...
    auto tmp = ((-avm_main_last + FF(1)) * (avm_kernel_note_hash_exist_write_offset_shift - (avm_kernel_note_hash_exist_write_offset + avm_main_sel_op_note_hash_exists)));
    tmp *= scaling_factor;
    std::get<0>(evals) += tmp;
}
//Contribution 1
...
Avm_DECLARE_VIEWS(1);
    ...
    auto tmp = ((-avm_main_last + FF(1)) * (avm_kernel_emit_note_hash_write_offset_shift - (avm_kernel_emit_note_hash_write_offset + avm_main_sel_op_emit_note_hash)));
    tmp *= scaling_factor;
    std::get<1>(evals) += tmp;
}
//Contribution 2
...
Avm_DECLARE_VIEWS(2);
    ...
    auto tmp = ((-avm_main_last + FF(1)) * (avm_kernel_nullifier_exists_write_offset_shift - (avm_kernel_nullifier_exists_write_offset + avm_main_sel_op_nullifier_exists)));
    tmp *= scaling_factor;
    std::get<2>(evals) += tmp;
}
//Contribution 3
...
Avm_DECLARE_VIEWS(3);
    ...
    auto tmp = ((-avm_main_last + FF(1)) * (avm_kernel_emit_nullifier_write_offset_shift - (avm_kernel_emit_nullifier_write_offset + avm_main_sel_op_emit_nullifier)));
    tmp *= scaling_factor;
    std::get<3>(evals) += tmp;
}
//Contribution 4
...
Avm_DECLARE_VIEWS(4);
    ...
    auto tmp = ((-avm_main_last + FF(1)) * (avm_kernel_l1_to_l2_msg_exists_write_offset_shift - (avm_kernel_l1_to_l2_msg_exists_write_offset + avm_main_sel_op_l1_to_l2_msg_exists)));
    tmp *= scaling_factor;
    std::get<4>(evals) += tmp;
}
//Contribution 5
...
Avm_DECLARE_VIEWS(5);
    ...
    auto tmp = ((-avm_main_last + FF(1)) * (avm_kernel_emit_unencrypted_log_write_offset_shift - (avm_kernel_emit_unencrypted_log_write_offset + avm_main_sel_op_emit_unencrypted_log)));
    tmp *= scaling_factor;
    std::get<5>(evals) += tmp;
}
//Contribution 6
...
Avm_DECLARE_VIEWS(6);
    ...
    auto tmp = ((-avm_main_last + FF(1)) * (avm_kernel_emit_l2_to_l1_msg_write_offset_shift - (avm_kernel_emit_l2_to_l1_msg_write_offset + avm_main_sel_op_emit_l2_to_l1_msg)));
    tmp *= scaling_factor;
    std::get<6>(evals) += tmp;
}
//Contribution 7
...
Avm_DECLARE_VIEWS(7);
    ...
    auto tmp = ((-avm_main_last + FF(1)) * (avm_kernel_sload_write_offset_shift - (avm_kernel_sload_write_offset + avm_main_sel_op_sload)));
    tmp *= scaling_factor;
    std::get<7>(evals) += tmp;
}
//Contribution 8
...
Avm_DECLARE_VIEWS(8);
    ...
    auto tmp = ((-avm_main_last + FF(1)) * (avm_kernel_sstore_write_offset_shift - (avm_kernel_sstore_write_offset + avm_main_sel_op_sstore)));
    tmp *= scaling_factor;
    std::get<8>(evals) += tmp;
}
}
