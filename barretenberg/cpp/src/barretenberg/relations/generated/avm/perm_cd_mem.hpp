...
class perm_cd_mem_permutation_settings {
  public:
    ...
    {
        return (in.slice_sel_cd == 1 || in.mem_sel_op_cd == 1);
    }
...
template <typename FF_> using perm_cd_mem_relation = GenericPermutationRelation<perm_cd_mem_permutation_settings, FF_>;
