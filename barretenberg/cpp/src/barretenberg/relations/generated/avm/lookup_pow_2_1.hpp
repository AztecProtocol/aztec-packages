...
in.avm_alu_t_sub_s_bits,
in.avm_alu_two_pow_t_sub_s,
in.avm_main_clk,
...
in.avm_main_table_pow_2
    ...
    template <typename FF_> using lookup_pow_2_1_relation = GenericLookupRelation<lookup_pow_2_1_lookup_settings, FF_>; 
