...
in.avm_poseidon2_output
    ...
    template <typename FF_> using perm_main_pos2_perm_relation = GenericPermutationRelation<perm_main_pos2_perm_permutation_settings, FF_>; 
