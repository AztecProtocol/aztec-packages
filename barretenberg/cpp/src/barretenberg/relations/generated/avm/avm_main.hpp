...
Avm_DECLARE_VIEWS(36);
    ...
    auto tmp = (((avm_main_sel_op_eq + avm_main_sel_op_lte) + avm_main_sel_op_lt) * (avm_main_w_in_tag - FF(1)));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(37);
    ...
    auto tmp = ((avm_main_sel_op_fdiv * (-avm_main_op_err + FF(1))) * ((avm_main_ic * avm_main_ib) - avm_main_ia));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(44);
    ...
    auto tmp = (avm_main_sel_internal_call * (avm_main_internal_return_ptr_shift - (avm_main_internal_return_ptr + FF(1))));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(50);
    ...
    auto tmp = (avm_main_sel_internal_return * (avm_main_internal_return_ptr_shift - (avm_main_internal_return_ptr - FF(1))));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(56);
    ...
    auto tmp = ((-(((avm_main_first + avm_main_sel_internal_call) + avm_main_sel_internal_return) + avm_main_sel_halt) + FF(1)) * (avm_main_internal_return_ptr_shift - avm_main_internal_return_ptr));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(64);
    ...
    auto tmp = (avm_main_alu_sel - (((((((((((avm_main_sel_op_add + avm_main_sel_op_sub) + avm_main_sel_op_mul) + avm_main_sel_op_div) + avm_main_sel_op_not) + avm_main_sel_op_eq) + avm_main_sel_op_lt) + avm_main_sel_op_lte) + avm_main_sel_op_shr) + avm_main_sel_op_shl) + avm_main_sel_op_cast) * (-avm_main_tag_err + FF(1))));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(65);
    ...
    auto tmp = ((((((((((avm_main_sel_op_add + avm_main_sel_op_sub) + avm_main_sel_op_mul) + avm_main_sel_op_div) + avm_main_sel_op_not) + avm_main_sel_op_eq) + avm_main_sel_op_lt) + avm_main_sel_op_lte) + avm_main_sel_op_shr) + avm_main_sel_op_shl) * (avm_main_alu_in_tag - avm_main_r_in_tag));
    tmp *= scaling_factor;
