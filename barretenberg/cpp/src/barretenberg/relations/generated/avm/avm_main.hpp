  ...
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        // Contribution 0
        {
            ...
            auto tmp = ((avm_main_l2_out_of_gas * (-avm_main_l2_out_of_gas + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<0>(evals) += tmp;
        }
        // Contribution 1
        {
            ...
            auto tmp = ((avm_main_da_out_of_gas * (-avm_main_da_out_of_gas + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<1>(evals) += tmp;
        }
        // Contribution 2
        ...
        // Contribution 4
        {
            ...
            auto tmp = (((-avm_main_gas_cost_active + FF(1)) * avm_main_l2_gas_op) - FF(0));
            tmp *= scaling_factor;
            std::get<4>(evals) += tmp;
        }
        // Contribution 5
        {
            ...
            auto tmp = (((-avm_main_gas_cost_active + FF(1)) * avm_main_da_gas_op) - FF(0));
            tmp *= scaling_factor;
            std::get<5>(evals) += tmp;
        }
        // Contribution 6
        ...
        // Contribution 8
        {
            ...
            auto tmp = ((avm_main_sel_op_sender * (-avm_main_sel_op_sender + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<8>(evals) += tmp;
        }
        // Contribution 9
        {
            ...
            auto tmp = ((avm_main_sel_op_address * (-avm_main_sel_op_address + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<9>(evals) += tmp;
        }
        // Contribution 10
        {
            ...
            auto tmp = ((avm_main_sel_op_storage_address * (-avm_main_sel_op_storage_address + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 11
        {
            ...
            auto tmp = ((avm_main_sel_op_chain_id * (-avm_main_sel_op_chain_id + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 12
        {
            ...
            auto tmp = ((avm_main_sel_op_version * (-avm_main_sel_op_version + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 13
        {
            ...
            auto tmp = ((avm_main_sel_op_block_number * (-avm_main_sel_op_block_number + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 14
        {
            ...
            auto tmp = ((avm_main_sel_op_coinbase * (-avm_main_sel_op_coinbase + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 15
        {
            ...
            auto tmp = ((avm_main_sel_op_timestamp * (-avm_main_sel_op_timestamp + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 16
        {
            ...
            auto tmp = ((avm_main_sel_op_fee_per_l2_gas * (-avm_main_sel_op_fee_per_l2_gas + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 17
        {
            ...
            auto tmp = ((avm_main_sel_op_fee_per_da_gas * (-avm_main_sel_op_fee_per_da_gas + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 18
        {
            ...
            auto tmp = ((avm_main_sel_op_transaction_fee * (-avm_main_sel_op_transaction_fee + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 19
        {
            ...
            auto tmp = ((avm_main_sel_op_l2gasleft * (-avm_main_sel_op_l2gasleft + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 20
        {
            ...
            auto tmp = ((avm_main_sel_op_dagasleft * (-avm_main_sel_op_dagasleft + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 21
        {
            ...
            auto tmp = ((avm_main_sel_op_note_hash_exists * (-avm_main_sel_op_note_hash_exists + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 22
        {
            ...
            auto tmp = ((avm_main_sel_op_emit_note_hash * (-avm_main_sel_op_emit_note_hash + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 23
        {
            ...
            auto tmp = ((avm_main_sel_op_nullifier_exists * (-avm_main_sel_op_nullifier_exists + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 24
        {
            ...
            auto tmp = ((avm_main_sel_op_emit_nullifier * (-avm_main_sel_op_emit_nullifier + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 25
        {
            ...
            auto tmp = ((avm_main_sel_op_l1_to_l2_msg_exists * (-avm_main_sel_op_l1_to_l2_msg_exists + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 26
        {
            ...
            auto tmp =
                ((avm_main_sel_op_emit_unencrypted_log * (-avm_main_sel_op_emit_unencrypted_log + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 27
        {
            ...
            auto tmp = ((avm_main_sel_op_emit_l2_to_l1_msg * (-avm_main_sel_op_emit_l2_to_l1_msg + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 28
        {
            ...
            auto tmp =
                ((avm_main_sel_op_get_contract_instance * (-avm_main_sel_op_get_contract_instance + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 29
        {
            ...
            auto tmp = ((avm_main_sel_op_sload * (-avm_main_sel_op_sload + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 30
        {
            ...
            auto tmp = ((avm_main_sel_op_sstore * (-avm_main_sel_op_sstore + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 31
        {
            ...
            auto tmp = ((avm_main_sel_op_radix_le * (-avm_main_sel_op_radix_le + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 32
        {
            ...
            auto tmp = ((avm_main_sel_op_sha256 * (-avm_main_sel_op_sha256 + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 33
        {
            ...
            auto tmp = ((avm_main_sel_op_poseidon2 * (-avm_main_sel_op_poseidon2 + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 34
        {
            ...
            auto tmp = ((avm_main_sel_op_keccak * (-avm_main_sel_op_keccak + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 35
        {
            ...
            auto tmp = ((avm_main_sel_op_pedersen * (-avm_main_sel_op_pedersen + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 36
        {
            ...
            auto tmp = ((avm_main_sel_op_add * (-avm_main_sel_op_add + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 37
        {
            ...
            auto tmp = ((avm_main_sel_op_sub * (-avm_main_sel_op_sub + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 38
        {
            ...
            auto tmp = ((avm_main_sel_op_mul * (-avm_main_sel_op_mul + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 39
        {
            ...
            auto tmp = ((avm_main_sel_op_div * (-avm_main_sel_op_div + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 40
        {
            ...
            auto tmp = ((avm_main_sel_op_fdiv * (-avm_main_sel_op_fdiv + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 41
        {
            ...
            auto tmp = ((avm_main_sel_op_not * (-avm_main_sel_op_not + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 42
        {
            ...
            auto tmp = ((avm_main_sel_op_eq * (-avm_main_sel_op_eq + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 43
        {
            ...
            auto tmp = ((avm_main_sel_op_and * (-avm_main_sel_op_and + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 44
        {
            ...
            auto tmp = ((avm_main_sel_op_or * (-avm_main_sel_op_or + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 45
        {
            ...
            auto tmp = ((avm_main_sel_op_xor * (-avm_main_sel_op_xor + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 46
        {
            ...
            auto tmp = ((avm_main_sel_op_cast * (-avm_main_sel_op_cast + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 47
        {
            ...
            auto tmp = ((avm_main_sel_op_lt * (-avm_main_sel_op_lt + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 48
        {
            ...
            auto tmp = ((avm_main_sel_op_lte * (-avm_main_sel_op_lte + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 49
        {
            ...
            auto tmp = ((avm_main_sel_op_shl * (-avm_main_sel_op_shl + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 50
        {
            ...
            auto tmp = ((avm_main_sel_op_shr * (-avm_main_sel_op_shr + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 51
        {
            ...
            auto tmp = ((avm_main_sel_internal_call * (-avm_main_sel_internal_call + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 52
        {
            ...
            auto tmp = ((avm_main_sel_internal_return * (-avm_main_sel_internal_return + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 53
        {
            ...
            auto tmp = ((avm_main_sel_jump * (-avm_main_sel_jump + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 54
        {
            ...
            auto tmp = ((avm_main_sel_jumpi * (-avm_main_sel_jumpi + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 55
        {
            ...
            auto tmp = ((avm_main_sel_halt * (-avm_main_sel_halt + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 56
        {
            ...
            auto tmp = ((avm_main_sel_external_call * (-avm_main_sel_external_call + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 57
        {
            ...
            auto tmp = ((avm_main_sel_mov * (-avm_main_sel_mov + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 58
        {
            ...
            auto tmp = ((avm_main_sel_cmov * (-avm_main_sel_cmov + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 59
        {
            ...
            auto tmp = ((avm_main_op_err * (-avm_main_op_err + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 60
        {
            ...
            auto tmp = ((avm_main_tag_err * (-avm_main_tag_err + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 61
        {
            ...
            auto tmp = ((avm_main_id_zero * (-avm_main_id_zero + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 62
        {
            ...
            auto tmp = ((avm_main_mem_op_a * (-avm_main_mem_op_a + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 63
        {
            ...
            auto tmp = ((avm_main_mem_op_b * (-avm_main_mem_op_b + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 64
        {
            ...
            auto tmp = ((avm_main_mem_op_c * (-avm_main_mem_op_c + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 65
        {
            ...
            auto tmp = ((avm_main_mem_op_d * (-avm_main_mem_op_d + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 66
        {
            ...
            auto tmp = ((avm_main_rwa * (-avm_main_rwa + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 67
        {
            ...
            auto tmp = ((avm_main_rwb * (-avm_main_rwb + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 68
        {
            ...
            auto tmp = ((avm_main_rwc * (-avm_main_rwc + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 69
        {
            ...
            auto tmp = ((avm_main_rwd * (-avm_main_rwd + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 70
        {
            ...
            auto tmp = ((avm_main_ind_op_a * (-avm_main_ind_op_a + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 71
        {
            ...
            auto tmp = ((avm_main_ind_op_b * (-avm_main_ind_op_b + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 72
        {
            ...
            auto tmp = ((avm_main_ind_op_c * (-avm_main_ind_op_c + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 73
        {
            ...
            auto tmp = ((avm_main_ind_op_d * (-avm_main_ind_op_d + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 77
        {
            ...
            auto tmp =
                ((((avm_main_sel_op_fdiv + avm_main_sel_op_div) * avm_main_op_err) * (-avm_main_inv + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 78
        {
            ...
            auto tmp = ((avm_main_sel_op_fdiv * (avm_main_r_in_tag - FF(6))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 79
        {
            ...
            auto tmp = ((avm_main_sel_op_fdiv * (avm_main_w_in_tag - FF(6))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 80
        {
            ...
            auto tmp = ((avm_main_op_err * ((avm_main_sel_op_fdiv + avm_main_sel_op_div) - FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 83
        {
            ...
            auto tmp = ((avm_main_sel_jump * (avm_main_pc_shift - avm_main_ia)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 86
        {
            ...
            auto tmp = ((avm_main_sel_internal_call * (avm_main_internal_return_ptr - avm_main_mem_idx_b)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 87
        {
            ...
            auto tmp = ((avm_main_sel_internal_call * (avm_main_pc_shift - avm_main_ia)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 88
        {
            ...
            auto tmp = ((avm_main_sel_internal_call * ((avm_main_pc + FF(1)) - avm_main_ib)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 89
        {
            ...
            auto tmp = ((avm_main_sel_internal_call * (avm_main_rwb - FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 90
        {
            ...
            auto tmp = ((avm_main_sel_internal_call * (avm_main_mem_op_b - FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 93
        {
            ...
            auto tmp = ((avm_main_sel_internal_return * (avm_main_pc_shift - avm_main_ia)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 94
        {
            ...
            auto tmp = ((avm_main_sel_internal_return * avm_main_rwa) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 95
        {
            ...
            auto tmp = ((avm_main_sel_internal_return * (avm_main_mem_op_a - FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 96
        {
            ...
            auto tmp = ((((((avm_main_gas_cost_active -
                             (((((((avm_main_sel_op_fdiv +
                                ...
                                ((((((((((avm_main_sel_op_sender + avm_main_sel_op_address) +
        ...
        // Contribution 99
        {
            ...
            auto tmp =
                (((avm_main_sel_internal_call + avm_main_sel_internal_return) * (avm_main_space_id - FF(255))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 102
        {
            ...
            auto tmp =
                ((((avm_main_sel_cmov + avm_main_sel_jumpi) * avm_main_id_zero) * (-avm_main_inv + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 105
        {
            ...
            auto tmp = ((avm_main_sel_mov_a * (avm_main_ia - avm_main_ic)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 106
        {
            ...
            auto tmp = ((avm_main_sel_mov_b * (avm_main_ib - avm_main_ic)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 107
        {
            ...
            auto tmp = (((avm_main_sel_mov + avm_main_sel_cmov) * (avm_main_r_in_tag - avm_main_w_in_tag)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 110
        {
            ...
            auto tmp = ((avm_main_sel_op_cast * (avm_main_alu_in_tag - avm_main_w_in_tag)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 111
        {
            ...
            auto tmp = ((avm_main_sel_op_l2gasleft * (avm_main_ia - avm_main_l2_gas_remaining_shift)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 112
        {
            ...
            auto tmp = ((avm_main_sel_op_dagasleft * (avm_main_ia - avm_main_da_gas_remaining_shift)) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 113
        {
            ...
            auto tmp = ((avm_main_sel_op_sender * (avm_kernel_kernel_in_offset - FF(0))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 114
        {
            ...
            auto tmp = ((avm_main_sel_op_address * (avm_kernel_kernel_in_offset - FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 115
        {
            ...
            auto tmp = ((avm_main_sel_op_storage_address * (avm_kernel_kernel_in_offset - FF(2))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 116
        {
            ...
            auto tmp = ((avm_main_sel_op_fee_per_da_gas * (avm_kernel_kernel_in_offset - FF(35))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 117
        {
            ...
            auto tmp = ((avm_main_sel_op_fee_per_l2_gas * (avm_kernel_kernel_in_offset - FF(36))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 118
        {
            ...
            auto tmp = ((avm_main_sel_op_transaction_fee * (avm_kernel_kernel_in_offset - FF(40))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 119
        {
            ...
            auto tmp = ((avm_main_sel_op_chain_id * (avm_kernel_kernel_in_offset - FF(29))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 120
        {
            ...
            auto tmp = ((avm_main_sel_op_version * (avm_kernel_kernel_in_offset - FF(30))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 121
        {
            ...
            auto tmp = ((avm_main_sel_op_block_number * (avm_kernel_kernel_in_offset - FF(31))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 122
        {
            ...
            auto tmp = ((avm_main_sel_op_coinbase * (avm_kernel_kernel_in_offset - FF(33))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 123
        {
            ...
            auto tmp = ((avm_main_sel_op_timestamp * (avm_kernel_kernel_in_offset - FF(32))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 125
        {
            ...
            auto tmp = ((avm_main_first * avm_kernel_note_hash_exist_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 127
        {
            ...
            auto tmp = ((avm_main_first * avm_kernel_emit_note_hash_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 129
        {
            ...
            auto tmp = ((avm_main_first * avm_kernel_nullifier_exists_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 130
        {
            ...
            auto tmp = ((avm_main_first * avm_kernel_nullifier_non_exists_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 132
        {
            ...
            auto tmp = ((avm_main_first * avm_kernel_emit_nullifier_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 134
        {
            ...
            auto tmp = ((avm_main_first * avm_kernel_l1_to_l2_msg_exists_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 136
        {
            ...
            auto tmp = ((avm_main_first * avm_kernel_emit_unencrypted_log_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 138
        {
            ...
            auto tmp = ((avm_main_first * avm_kernel_emit_l2_to_l1_msg_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 140
        {
            ...
            auto tmp = ((avm_main_first * avm_kernel_sload_write_offset) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 141
        {
            ...
            auto tmp = ((avm_main_sel_op_sstore *
                         (avm_kernel_kernel_out_offset - (avm_kernel_sstore_write_offset + FF(112)))) -
                        FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 142
        {
            ...
            auto tmp = ((avm_main_first * avm_kernel_sstore_write_offset) - FF(0));
            tmp *= scaling_factor;
