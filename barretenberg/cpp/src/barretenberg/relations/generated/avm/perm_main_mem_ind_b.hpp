    ...
    #include <tuple> 
        ...
        class perm_main_mem_ind_b_permutation_settings {
            public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in) {
        return (in.avm_main_ind_op_b == 1 || in.avm_mem_ind_op_b == 1);
    }
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in) {
        ...
        return std::forward_as_tuple(
            in.perm_main_mem_ind_b,
in.avm_main_ind_op_b,
in.avm_main_ind_op_b,
in.avm_mem_ind_op_b,
in.avm_main_clk,
...
in.avm_mem_val
    ...
    template <typename FF_> using perm_main_mem_ind_b_relation = GenericPermutationRelation<perm_main_mem_ind_b_permutation_settings, FF_>; 
    template <typename FF_> using perm_main_mem_ind_b = GenericPermutation<perm_main_mem_ind_b_permutation_settings, FF_>; 
