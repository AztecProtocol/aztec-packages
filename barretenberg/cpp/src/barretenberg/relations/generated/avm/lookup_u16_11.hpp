...
class lookup_u16_11_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        ...
        return std::forward_as_tuple(in.lookup_u16_11,
...
template <typename FF_> using lookup_u16_11_relation = GenericLookupRelation<lookup_u16_11_lookup_settings, FF_>;
