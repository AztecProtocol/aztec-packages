  ...
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        // Contribution 4
        {
            ...
            auto tmp = ((mem_op_a * (-mem_op_a + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<4>(evals) += tmp;
        }
        // Contribution 5
        {
            ...
            auto tmp = ((mem_op_b * (-mem_op_b + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<5>(evals) += tmp;
        }
        // Contribution 6
        {
            ...
            auto tmp = ((mem_op_c * (-mem_op_c + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<6>(evals) += tmp;
        }
        // Contribution 7
        {
            ...
            auto tmp = ((mem_op_d * (-mem_op_d + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<7>(evals) += tmp;
        }
        // Contribution 8
        {
            ...
            auto tmp = ((mem_ind_op_a * (-mem_ind_op_a + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<8>(evals) += tmp;
        }
        // Contribution 9
        {
            ...
            auto tmp = ((mem_ind_op_b * (-mem_ind_op_b + FF(1))) - FF(0));
            tmp *= scaling_factor;
            std::get<9>(evals) += tmp;
        }
        // Contribution 10
        {
            ...
            auto tmp = ((mem_ind_op_c * (-mem_ind_op_c + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 11
        {
            ...
            auto tmp = ((mem_ind_op_d * (-mem_ind_op_d + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 13
        {
            ...
            auto tmp = ((mem_mem_sel * (mem_mem_sel - FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 14
        {
            ...
            auto tmp = ((((-main_first + FF(1)) * mem_mem_sel_shift) * (-mem_mem_sel + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 15
        {
            ...
            auto tmp = ((main_first * mem_mem_sel) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 16
        {
            ...
            auto tmp = ((((-mem_last + FF(1)) * mem_mem_sel) * (-mem_mem_sel_shift + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 20
        {
            ...
            auto tmp = ((main_first * (-mem_lastAccess + FF(1))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 32
        {
            ...
            auto tmp = ((mem_ind_op_a * (mem_r_in_tag - FF(3))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 33
        {
            ...
            auto tmp = ((mem_ind_op_b * (mem_r_in_tag - FF(3))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 34
        {
            ...
            auto tmp = ((mem_ind_op_c * (mem_r_in_tag - FF(3))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 35
        {
            ...
            auto tmp = ((mem_ind_op_d * (mem_r_in_tag - FF(3))) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 36
        {
            ...
            auto tmp = ((mem_ind_op_a * mem_rw) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 37
        {
            ...
            auto tmp = ((mem_ind_op_b * mem_rw) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 38
        {
            ...
            auto tmp = ((mem_ind_op_c * mem_rw) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 39
        {
            ...
            auto tmp = ((mem_ind_op_d * mem_rw) - FF(0));
            tmp *= scaling_factor;
        ...
        // Contribution 40
        {
            ...
            auto tmp = (((mem_sel_mov_a + mem_sel_mov_b) * mem_tag_err) - FF(0));
            tmp *= scaling_factor;
