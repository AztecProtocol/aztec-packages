...
in.avm_mem_val
    ...
    template <typename FF_> using perm_main_mem_ind_a_relation = GenericPermutationRelation<perm_main_mem_ind_a_permutation_settings, FF_>; 
