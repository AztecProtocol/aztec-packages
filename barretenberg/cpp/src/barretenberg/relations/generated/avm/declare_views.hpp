...
#define Avm_DECLARE_VIEWS(index)                                                                                       \
    ...
    [[maybe_unused]] auto avm_cmp_cmp_clk = View(new_term.avm_cmp_cmp_clk);                                            \
    [[maybe_unused]] auto avm_cmp_ia = View(new_term.avm_cmp_ia);                                                      \
    [[maybe_unused]] auto avm_cmp_ib = View(new_term.avm_cmp_ib);                                                      \
    [[maybe_unused]] auto avm_cmp_ic = View(new_term.avm_cmp_ic);                                                      \
    [[maybe_unused]] auto avm_cmp_lt_sel = View(new_term.avm_cmp_lt_sel);                                              \
    [[maybe_unused]] auto avm_cmp_lte_sel = View(new_term.avm_cmp_lte_sel);                                            \
    [[maybe_unused]] auto avm_cmp_cmp_sel = View(new_term.avm_cmp_cmp_sel);                                            \
    [[maybe_unused]] auto avm_cmp_input_ia = View(new_term.avm_cmp_input_ia);                                          \
    [[maybe_unused]] auto avm_cmp_input_ib = View(new_term.avm_cmp_input_ib);                                          \
    [[maybe_unused]] auto avm_cmp_a_lo = View(new_term.avm_cmp_a_lo);                                                  \
    [[maybe_unused]] auto avm_cmp_a_hi = View(new_term.avm_cmp_a_hi);                                                  \
    [[maybe_unused]] auto avm_cmp_b_lo = View(new_term.avm_cmp_b_lo);                                                  \
    [[maybe_unused]] auto avm_cmp_b_hi = View(new_term.avm_cmp_b_hi);                                                  \
    [[maybe_unused]] auto avm_cmp_borrow = View(new_term.avm_cmp_borrow);                                              \
    [[maybe_unused]] auto avm_cmp_p_lo = View(new_term.avm_cmp_p_lo);                                                  \
    [[maybe_unused]] auto avm_cmp_p_hi = View(new_term.avm_cmp_p_hi);                                                  \
    [[maybe_unused]] auto avm_cmp_p_sub_a_lo = View(new_term.avm_cmp_p_sub_a_lo);                                      \
    [[maybe_unused]] auto avm_cmp_p_sub_a_hi = View(new_term.avm_cmp_p_sub_a_hi);                                      \
    [[maybe_unused]] auto avm_cmp_p_a_borrow = View(new_term.avm_cmp_p_a_borrow);                                      \
    [[maybe_unused]] auto avm_cmp_p_sub_b_lo = View(new_term.avm_cmp_p_sub_b_lo);                                      \
    [[maybe_unused]] auto avm_cmp_p_sub_b_hi = View(new_term.avm_cmp_p_sub_b_hi);                                      \
    [[maybe_unused]] auto avm_cmp_p_b_borrow = View(new_term.avm_cmp_p_b_borrow);                                      \
    [[maybe_unused]] auto avm_cmp_res_lo = View(new_term.avm_cmp_res_lo);                                              \
    [[maybe_unused]] auto avm_cmp_res_hi = View(new_term.avm_cmp_res_hi);                                              \
    [[maybe_unused]] auto avm_cmp_lt_query = View(new_term.avm_cmp_lt_query);                                          \
