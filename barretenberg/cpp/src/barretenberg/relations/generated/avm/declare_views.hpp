...
#define Avm_DECLARE_VIEWS(index)                                                                                       \
    ...
    [[maybe_unused]] auto avm_mem_m_op_a = View(new_term.avm_mem_m_op_a);                                              \
    [[maybe_unused]] auto avm_mem_m_op_b = View(new_term.avm_mem_m_op_b);                                              \
    [[maybe_unused]] auto avm_mem_m_op_c = View(new_term.avm_mem_m_op_c);                                              \
    [[maybe_unused]] auto avm_mem_m_ind_op_a = View(new_term.avm_mem_m_ind_op_a);                                      \
    [[maybe_unused]] auto avm_mem_m_ind_op_b = View(new_term.avm_mem_m_ind_op_b);                                      \
    [[maybe_unused]] auto avm_mem_m_ind_op_c = View(new_term.avm_mem_m_ind_op_c);                                      \
    [[maybe_unused]] auto avm_mem_m_sel_mov = View(new_term.avm_mem_m_sel_mov);                                        \
    ...
    [[maybe_unused]] auto avm_alu_alu_in_tag = View(new_term.avm_alu_alu_in_tag);                                      \
    ...
    [[maybe_unused]] auto avm_byte_lookup_table_instr_tags = View(new_term.avm_byte_lookup_table_instr_tags);          \
    ...
    [[maybe_unused]] auto avm_binary_instr_tag = View(new_term.avm_binary_instr_tag);                                  \
    ...
    [[maybe_unused]] auto avm_binary_latch = View(new_term.avm_binary_latch);                                          \
    [[maybe_unused]] auto avm_binary_factor = View(new_term.avm_binary_factor);                                        \
    ...
    [[maybe_unused]] auto avm_binary_bin_sel_shift = View(new_term.avm_binary_bin_sel_shift);                          \
    ...
    [[maybe_unused]] auto avm_binary_factor_shift = View(new_term.avm_binary_factor_shift);                            \
