...
class perm_pos_mem_d_relation : public GenericPermutationRelation<perm_pos_mem_d_permutation_settings, FF_> {
  public:
    static constexpr const char* NAME = "PERM_POS_MEM_D";
};
