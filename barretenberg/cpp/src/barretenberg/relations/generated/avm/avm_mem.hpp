...
Avm_DECLARE_VIEWS(12);
    ...
    auto tmp = (avm_mem_mem_sel - (((((((avm_mem_op_a + avm_mem_op_b) + avm_mem_op_c) + avm_mem_op_d) + avm_mem_ind_op_a) + avm_mem_ind_op_b) + avm_mem_ind_op_c) + avm_mem_ind_op_d));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(18);
    ...
    auto tmp = (avm_mem_tsp - ((avm_mem_clk * FF(12)) + (avm_mem_mem_sel * ((((avm_mem_ind_op_b + avm_mem_op_b) + ((avm_mem_ind_op_c + avm_mem_op_c) * FF(2))) + ((avm_mem_ind_op_d + avm_mem_op_d) * FF(3))) + (((-(((avm_mem_ind_op_a + avm_mem_ind_op_b) + avm_mem_ind_op_c) + avm_mem_ind_op_d) + FF(1)) + avm_mem_rw) * FF(4))))));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(22);
    ...
    auto tmp = (avm_mem_rng_chk_sel * (((((avm_mem_lastAccess * (avm_mem_glob_addr_shift - avm_mem_glob_addr)) + ((-avm_mem_lastAccess + FF(1)) * (avm_mem_tsp_shift - avm_mem_tsp))) - (avm_mem_diff_hi * FF(4294967296UL))) - (avm_mem_diff_mid * FF(65536))) - avm_mem_diff_lo));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(23);
    ...
    auto tmp = (((-avm_mem_lastAccess + FF(1)) * (-avm_mem_rw_shift + FF(1))) * (avm_mem_val_shift - avm_mem_val));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(24);
    ...
    auto tmp = (((-avm_mem_lastAccess + FF(1)) * (-avm_mem_rw_shift + FF(1))) * (avm_mem_tag_shift - avm_mem_tag));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(26);
    ...
    auto tmp = (avm_mem_skip_check_tag - (avm_mem_sel_cmov * ((avm_mem_op_d + (avm_mem_op_a * (-avm_mem_sel_mov_a + FF(1)))) + (avm_mem_op_b * (-avm_mem_sel_mov_b + FF(1))))));
    tmp *= scaling_factor;
...
Avm_DECLARE_VIEWS(27);
    ...
    auto tmp = (((-avm_mem_skip_check_tag + FF(1)) * (-avm_mem_rw + FF(1))) * (((avm_mem_r_in_tag - avm_mem_tag) * (-avm_mem_one_min_inv + FF(1))) - avm_mem_tag_err));
    tmp *= scaling_factor;
