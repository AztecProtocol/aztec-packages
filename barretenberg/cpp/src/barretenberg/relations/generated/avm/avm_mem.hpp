  ...
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        // Contribution 10
        {
            ...
            auto tmp = ((((((avm_mem_op_a + avm_mem_op_b) + avm_mem_op_c) + avm_mem_ind_op_a) + avm_mem_ind_op_b) +
                         avm_mem_ind_op_c) *
                        ((((((avm_mem_op_a + avm_mem_op_b) + avm_mem_op_c) + avm_mem_ind_op_a) + avm_mem_ind_op_b) +
                          avm_mem_ind_op_c) -
                         FF(1)));
            tmp *= scaling_factor;
                ...
                (avm_mem_sub_clk -
                 ((((((avm_mem_op_a + avm_mem_op_b) + avm_mem_op_c) + avm_mem_ind_op_a) + avm_mem_ind_op_b) +
                  ...
                  (((avm_mem_ind_op_b + avm_mem_op_b) + ((avm_mem_ind_op_c + avm_mem_op_c) * FF(2))) +
                   (((-((avm_mem_ind_op_a + avm_mem_ind_op_b) + avm_mem_ind_op_c) + FF(1)) + avm_mem_rw) * FF(3)))));
            tmp *= scaling_factor;
