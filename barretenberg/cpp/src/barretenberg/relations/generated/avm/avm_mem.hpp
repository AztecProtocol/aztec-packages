...
Avm_DECLARE_VIEWS(20);
    ...
    auto tmp = (avm_mem_rng_chk_sel * ((((avm_mem_lastAccess * (avm_mem_addr_shift - avm_mem_addr)) + ((-avm_mem_lastAccess + FF(1)) * (avm_mem_tsp_shift - avm_mem_tsp))) - (avm_mem_diff_hi * FF(65536))) - avm_mem_diff_lo));
    tmp *= scaling_factor;
