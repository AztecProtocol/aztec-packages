...
#define AvmMini_DECLARE_VIEWS(index)                                                                                   \
    ...
    [[maybe_unused]] auto aluChip_alu_u8 = View(new_term.aluChip_alu_u8);                                              \
    [[maybe_unused]] auto aluChip_alu_u16 = View(new_term.aluChip_alu_u16);                                            \
    [[maybe_unused]] auto aluChip_alu_u32 = View(new_term.aluChip_alu_u32);                                            \
    [[maybe_unused]] auto aluChip_alu_u64 = View(new_term.aluChip_alu_u64);                                            \
    [[maybe_unused]] auto aluChip_alu_u128 = View(new_term.aluChip_alu_u128);                                          \
    [[maybe_unused]] auto aluChip_alu_s1 = View(new_term.aluChip_alu_s1);                                              \
    [[maybe_unused]] auto aluChip_alu_s2 = View(new_term.aluChip_alu_s2);                                              \
    [[maybe_unused]] auto aluChip_alu_s3 = View(new_term.aluChip_alu_s3);                                              \
    [[maybe_unused]] auto aluChip_alu_s4 = View(new_term.aluChip_alu_s4);                                              \
    [[maybe_unused]] auto aluChip_alu_s5 = View(new_term.aluChip_alu_s5);                                              \
    [[maybe_unused]] auto aluChip_alu_s6 = View(new_term.aluChip_alu_s6);                                              \
    [[maybe_unused]] auto aluChip_alu_s7 = View(new_term.aluChip_alu_s7);                                              \
    [[maybe_unused]] auto aluChip_alu_s8 = View(new_term.aluChip_alu_s8);                                              \
    [[maybe_unused]] auto aluChip_alu_s9 = View(new_term.aluChip_alu_s9);                                              \
    [[maybe_unused]] auto aluChip_alu_s10 = View(new_term.aluChip_alu_s10);                                            \
    [[maybe_unused]] auto aluChip_alu_s11 = View(new_term.aluChip_alu_s11);                                            \
    [[maybe_unused]] auto aluChip_alu_s12 = View(new_term.aluChip_alu_s12);                                            \
    [[maybe_unused]] auto aluChip_alu_s13 = View(new_term.aluChip_alu_s13);                                            \
    [[maybe_unused]] auto aluChip_alu_s14 = View(new_term.aluChip_alu_s14);                                            \
    [[maybe_unused]] auto aluChip_alu_s15 = View(new_term.aluChip_alu_s15);                                            \
    [[maybe_unused]] auto aluChip_alu_s16 = View(new_term.aluChip_alu_s16);                                            \
