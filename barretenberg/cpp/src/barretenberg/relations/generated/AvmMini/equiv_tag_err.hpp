...
class equiv_tag_err_permutation_settings {
  public:
    ...
    {
        return (in.avmMini_tag_err == 1 || in.memTrace_m_tag_err == 1);
    }
...
using equiv_tag_err_relation = GenericPermutationRelation<equiv_tag_err_permutation_settings, FF_>;
template <typename FF_> using equiv_tag_err = GenericPermutation<equiv_tag_err_permutation_settings, FF_>;
