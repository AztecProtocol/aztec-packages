...
class UltraStarknetZKFlavor : public UltraStarknetFlavor {
  public:
    ...
    static constexpr size_t BATCHED_RELATION_PARTIAL_LENGTH = UltraStarknetFlavor::BATCHED_RELATION_PARTIAL_LENGTH + 1;
    /**
     * @brief Derived class that defines proof structure for Ultra zero knowledge proofs, as well as supporting
     * functions.
     *
     */
    class Transcript : public UltraStarknetFlavor::Transcript {
      public:
        using Base = UltraStarknetFlavor::Transcript::Base;
        ...
        Transcript(const std::vector<FF>& proof)
            : UltraStarknetFlavor::Transcript(proof)
        {}
