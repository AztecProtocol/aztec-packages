...
void UltraCircuitBuilder_<ExecutionTrace>::add_gates_to_ensure_all_polys_are_non_zero()
{
    ...
    const auto dummy_accumulators =
        get_lookup_accumulators(plookup::MultiTableId::HONK_DUMMY_MULTI, left_witness_value, right_witness_value, true);
...
plookup::BasicTable& UltraCircuitBuilder_<ExecutionTrace>::get_table(const plookup::BasicTableId id)
{
    ...
    lookup_tables.emplace_back(create_basic_table(id, lookup_tables.size()));
...
template <typename ExecutionTrace> void UltraCircuitBuilder_<ExecutionTrace>::init_multi_tables()
{
#ifndef NO_MULTITHREADING
    ...
    MULTI_TABLES[plookup::MultiTableId::SHA256_CH_INPUT] =
        plookup::sha256_tables::get_choose_input_table(plookup::MultiTableId::SHA256_CH_INPUT);
    MULTI_TABLES[plookup::MultiTableId::SHA256_MAJ_INPUT] =
        plookup::sha256_tables::get_majority_input_table(plookup::MultiTableId::SHA256_MAJ_INPUT);
    MULTI_TABLES[plookup::MultiTableId::SHA256_WITNESS_INPUT] =
        plookup::sha256_tables::get_witness_extension_input_table(plookup::MultiTableId::SHA256_WITNESS_INPUT);
    MULTI_TABLES[plookup::MultiTableId::SHA256_CH_OUTPUT] =
        plookup::sha256_tables::get_choose_output_table(plookup::MultiTableId::SHA256_CH_OUTPUT);
    MULTI_TABLES[plookup::MultiTableId::SHA256_MAJ_OUTPUT] =
        plookup::sha256_tables::get_majority_output_table(plookup::MultiTableId::SHA256_MAJ_OUTPUT);
    MULTI_TABLES[plookup::MultiTableId::SHA256_WITNESS_OUTPUT] =
        plookup::sha256_tables::get_witness_extension_output_table(plookup::MultiTableId::SHA256_WITNESS_OUTPUT);
    MULTI_TABLES[plookup::MultiTableId::AES_NORMALIZE] =
        plookup::aes128_tables::get_aes_normalization_table(plookup::MultiTableId::AES_NORMALIZE);
    MULTI_TABLES[plookup::MultiTableId::AES_INPUT] =
        plookup::aes128_tables::get_aes_input_table(plookup::MultiTableId::AES_INPUT);
    MULTI_TABLES[plookup::MultiTableId::AES_SBOX] =
        plookup::aes128_tables::get_aes_sbox_table(plookup::MultiTableId::AES_SBOX);
    MULTI_TABLES[plookup::MultiTableId::UINT32_XOR] =
        plookup::uint_tables::get_uint32_xor_table(plookup::MultiTableId::UINT32_XOR);
    MULTI_TABLES[plookup::MultiTableId::UINT32_AND] =
        plookup::uint_tables::get_uint32_and_table(plookup::MultiTableId::UINT32_AND);
    MULTI_TABLES[plookup::MultiTableId::BN254_XLO] =
        plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::get_xlo_table(
            plookup::MultiTableId::BN254_XLO, plookup::BasicTableId::BN254_XLO_BASIC);
    MULTI_TABLES[plookup::MultiTableId::BN254_XHI] =
        plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::get_xhi_table(
            plookup::MultiTableId::BN254_XHI, plookup::BasicTableId::BN254_XHI_BASIC);
    MULTI_TABLES[plookup::MultiTableId::BN254_YLO] =
        plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::get_ylo_table(
            plookup::MultiTableId::BN254_YLO, plookup::BasicTableId::BN254_YLO_BASIC);
    MULTI_TABLES[plookup::MultiTableId::BN254_YHI] =
        plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::get_yhi_table(
            plookup::MultiTableId::BN254_YHI, plookup::BasicTableId::BN254_YHI_BASIC);
    MULTI_TABLES[plookup::MultiTableId::BN254_XYPRIME] =
        plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::get_xyprime_table(
            plookup::MultiTableId::BN254_XYPRIME, plookup::BasicTableId::BN254_XYPRIME_BASIC);
    MULTI_TABLES[plookup::MultiTableId::BN254_XLO_ENDO] =
        plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::get_xlo_endo_table(
            plookup::MultiTableId::BN254_XLO_ENDO, plookup::BasicTableId::BN254_XLO_ENDO_BASIC);
    MULTI_TABLES[plookup::MultiTableId::BN254_XHI_ENDO] =
        plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::get_xhi_endo_table(
            plookup::MultiTableId::BN254_XHI_ENDO, plookup::BasicTableId::BN254_XHI_ENDO_BASIC);
    MULTI_TABLES[plookup::MultiTableId::BN254_XYPRIME_ENDO] =
        plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::get_xyprime_endo_table(
            plookup::MultiTableId::BN254_XYPRIME_ENDO, plookup::BasicTableId::BN254_XYPRIME_ENDO_BASIC);
    MULTI_TABLES[plookup::MultiTableId::SECP256K1_XLO] =
        plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::get_xlo_table(
            plookup::MultiTableId::SECP256K1_XLO, plookup::BasicTableId::SECP256K1_XLO_BASIC);
    MULTI_TABLES[plookup::MultiTableId::SECP256K1_XHI] =
        plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::get_xhi_table(
            plookup::MultiTableId::SECP256K1_XHI, plookup::BasicTableId::SECP256K1_XHI_BASIC);
    MULTI_TABLES[plookup::MultiTableId::SECP256K1_YLO] =
        plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::get_ylo_table(
            plookup::MultiTableId::SECP256K1_YLO, plookup::BasicTableId::SECP256K1_YLO_BASIC);
    MULTI_TABLES[plookup::MultiTableId::SECP256K1_YHI] =
        plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::get_yhi_table(
            plookup::MultiTableId::SECP256K1_YHI, plookup::BasicTableId::SECP256K1_YHI_BASIC);
    MULTI_TABLES[plookup::MultiTableId::SECP256K1_XYPRIME] =
        plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::get_xyprime_table(
            plookup::MultiTableId::SECP256K1_XYPRIME, plookup::BasicTableId::SECP256K1_XYPRIME_BASIC);
    MULTI_TABLES[plookup::MultiTableId::SECP256K1_XLO_ENDO] =
        plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::get_xlo_endo_table(
            plookup::MultiTableId::SECP256K1_XLO_ENDO, plookup::BasicTableId::SECP256K1_XLO_ENDO_BASIC);
    MULTI_TABLES[plookup::MultiTableId::SECP256K1_XHI_ENDO] =
        plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::get_xhi_endo_table(
            plookup::MultiTableId::SECP256K1_XHI_ENDO, plookup::BasicTableId::SECP256K1_XHI_ENDO_BASIC);
    MULTI_TABLES[plookup::MultiTableId::SECP256K1_XYPRIME_ENDO] =
        plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::get_xyprime_endo_table(
            plookup::MultiTableId::SECP256K1_XYPRIME_ENDO, plookup::BasicTableId::SECP256K1_XYPRIME_ENDO_BASIC);
    MULTI_TABLES[plookup::MultiTableId::BLAKE_XOR] =
        plookup::blake2s_tables::get_blake2s_xor_table(plookup::MultiTableId::BLAKE_XOR);
    MULTI_TABLES[plookup::MultiTableId::BLAKE_XOR_ROTATE_16] =
        plookup::blake2s_tables::get_blake2s_xor_rotate_16_table(plookup::MultiTableId::BLAKE_XOR_ROTATE_16);
    MULTI_TABLES[plookup::MultiTableId::BLAKE_XOR_ROTATE_8] =
        plookup::blake2s_tables::get_blake2s_xor_rotate_8_table(plookup::MultiTableId::BLAKE_XOR_ROTATE_8);
    MULTI_TABLES[plookup::MultiTableId::BLAKE_XOR_ROTATE_7] =
        plookup::blake2s_tables::get_blake2s_xor_rotate_7_table(plookup::MultiTableId::BLAKE_XOR_ROTATE_7);
    MULTI_TABLES[plookup::MultiTableId::KECCAK_FORMAT_INPUT] =
        plookup::keccak_tables::KeccakInput::get_keccak_input_table(plookup::MultiTableId::KECCAK_FORMAT_INPUT);
    MULTI_TABLES[plookup::MultiTableId::KECCAK_THETA_OUTPUT] =
        plookup::keccak_tables::Theta::get_theta_output_table(plookup::MultiTableId::KECCAK_THETA_OUTPUT);
    MULTI_TABLES[plookup::MultiTableId::KECCAK_CHI_OUTPUT] =
        plookup::keccak_tables::Chi::get_chi_output_table(plookup::MultiTableId::KECCAK_CHI_OUTPUT);
    MULTI_TABLES[plookup::MultiTableId::KECCAK_FORMAT_OUTPUT] =
        plookup::keccak_tables::KeccakOutput::get_keccak_output_table(plookup::MultiTableId::KECCAK_FORMAT_OUTPUT);
    MULTI_TABLES[plookup::MultiTableId::FIXED_BASE_LEFT_LO] =
        plookup::fixed_base::table::get_fixed_base_table<0, 128>(plookup::MultiTableId::FIXED_BASE_LEFT_LO);
    MULTI_TABLES[plookup::MultiTableId::FIXED_BASE_LEFT_HI] =
        plookup::fixed_base::table::get_fixed_base_table<1, 126>(plookup::MultiTableId::FIXED_BASE_LEFT_HI);
    MULTI_TABLES[plookup::MultiTableId::FIXED_BASE_RIGHT_LO] =
        plookup::fixed_base::table::get_fixed_base_table<2, 128>(plookup::MultiTableId::FIXED_BASE_RIGHT_LO);
    MULTI_TABLES[plookup::MultiTableId::FIXED_BASE_RIGHT_HI] =
        plookup::fixed_base::table::get_fixed_base_table<3, 126>(plookup::MultiTableId::FIXED_BASE_RIGHT_HI);

    bb::constexpr_for<0, 25, 1>([&]<size_t i>() {
        MULTI_TABLES[static_cast<size_t>(plookup::MultiTableId::KECCAK_NORMALIZE_AND_ROTATE) + i] =
            plookup::keccak_tables::Rho<8, i>::get_rho_output_table(plookup::MultiTableId::KECCAK_NORMALIZE_AND_ROTATE);
    });
    MULTI_TABLES[plookup::MultiTableId::HONK_DUMMY_MULTI] = plookup::dummy_tables::get_honk_dummy_multitable();
    initialised = true;
}
 ...
 */
template <typename ExecutionTrace>
const plookup::MultiTable& UltraCircuitBuilder_<ExecutionTrace>::get_multitable(const plookup::MultiTableId id)
{
    if (!initialised) {
        init_multi_tables();
        initialised = true;
 ...
 */
template <typename ExecutionTrace>
plookup::ReadData<bb::fr> UltraCircuitBuilder_<ExecutionTrace>::get_lookup_accumulators(const plookup::MultiTableId id,
                                                                                        const fr& key_a,
                                                                                        const fr& key_b,
                                                                                        const bool is_2_to_1_lookup)
{
    ...
    for (size_t i = 0; i < num_lookups; ++i) {
        ...
        const plookup::BasicTable::LookupEntry lookup_entry{ { key_a_slices[i], key_b_slices[i] }, values };
        lookup.lookup_entries.emplace_back(lookup_entry);
    }

    lookup[plookup::C1].resize(num_lookups);
    lookup[plookup::C2].resize(num_lookups);
    lookup[plookup::C3].resize(num_lookups);
     ...
     *
     */
    lookup[plookup::C1][num_lookups - 1] = column_1_raw_values[num_lookups - 1];
    lookup[plookup::C2][num_lookups - 1] = column_2_raw_values[num_lookups - 1];
    lookup[plookup::C3][num_lookups - 1] = column_3_raw_values[num_lookups - 1];

    for (size_t i = num_lookups - 1; i > 0; --i) {
        lookup[plookup::C1][i - 1] =
            column_1_raw_values[i - 1] + lookup[plookup::C1][i] * multi_table.column_1_step_sizes[i];
        lookup[plookup::C2][i - 1] =
            column_2_raw_values[i - 1] + lookup[plookup::C2][i] * multi_table.column_2_step_sizes[i];
        lookup[plookup::C3][i - 1] =
            column_3_raw_values[i - 1] + lookup[plookup::C3][i] * multi_table.column_3_step_sizes[i];
    }
    return lookup;
}

template <typename ExecutionTrace>
plookup::BasicTable UltraCircuitBuilder_<ExecutionTrace>::create_basic_table(const plookup::BasicTableId id,
                                                                             const size_t index)
{
    ...
    if (id_var >= static_cast<size_t>(plookup::FIXED_BASE_0_0) &&
        id_var < static_cast<size_t>(plookup::FIXED_BASE_1_0)) {
        return plookup::fixed_base::table::generate_basic_fixed_base_table<0>(
            id, index, id_var - static_cast<size_t>(plookup::FIXED_BASE_0_0));
    }
    if (id_var >= static_cast<size_t>(plookup::FIXED_BASE_1_0) &&
        id_var < static_cast<size_t>(plookup::FIXED_BASE_2_0)) {
        return plookup::fixed_base::table::generate_basic_fixed_base_table<1>(
            id, index, id_var - static_cast<size_t>(plookup::FIXED_BASE_1_0));
    }
    if (id_var >= static_cast<size_t>(plookup::FIXED_BASE_2_0) &&
        id_var < static_cast<size_t>(plookup::FIXED_BASE_3_0)) {
        return plookup::fixed_base::table::generate_basic_fixed_base_table<2>(
            id, index, id_var - static_cast<size_t>(plookup::FIXED_BASE_2_0));
    }
    if (id_var >= static_cast<size_t>(plookup::FIXED_BASE_3_0) &&
        id_var < static_cast<size_t>(plookup::HONK_DUMMY_BASIC1)) {
        return plookup::fixed_base::table::generate_basic_fixed_base_table<3>(
            id, index, id_var - static_cast<size_t>(plookup::FIXED_BASE_3_0));
    }
    switch (id) {
    case plookup::AES_SPARSE_MAP: {
        return plookup::sparse_tables::generate_sparse_table_with_rotation<9, 8, 0>(plookup::AES_SPARSE_MAP, index);
    }
    case plookup::AES_SBOX_MAP: {
        return plookup::aes128_tables::generate_aes_sbox_table(plookup::AES_SBOX_MAP, index);
    }
    case plookup::AES_SPARSE_NORMALIZE: {
        return plookup::aes128_tables::generate_aes_sparse_normalization_table(plookup::AES_SPARSE_NORMALIZE, index);
    }
    case plookup::SHA256_WITNESS_NORMALIZE: {
        return plookup::sha256_tables::generate_witness_extension_normalization_table(plookup::SHA256_WITNESS_NORMALIZE,
                                                                                      index);
    }
    case plookup::SHA256_WITNESS_SLICE_3: {
        return plookup::sparse_tables::generate_sparse_table_with_rotation<16, 3, 0>(plookup::SHA256_WITNESS_SLICE_3,
                                                                                     index);
    }
    case plookup::SHA256_WITNESS_SLICE_7_ROTATE_4: {
        return plookup::sparse_tables::generate_sparse_table_with_rotation<16, 7, 4>(
            plookup::SHA256_WITNESS_SLICE_7_ROTATE_4, index);
    }
    case plookup::SHA256_WITNESS_SLICE_8_ROTATE_7: {
        return plookup::sparse_tables::generate_sparse_table_with_rotation<16, 8, 7>(
            plookup::SHA256_WITNESS_SLICE_8_ROTATE_7, index);
    }
    case plookup::SHA256_WITNESS_SLICE_14_ROTATE_1: {
        return plookup::sparse_tables::generate_sparse_table_with_rotation<16, 14, 1>(
            plookup::SHA256_WITNESS_SLICE_14_ROTATE_1, index);
    }
    case plookup::SHA256_CH_NORMALIZE: {
        return plookup::sha256_tables::generate_choose_normalization_table(plookup::SHA256_CH_NORMALIZE, index);
    }
    case plookup::SHA256_MAJ_NORMALIZE: {
        return plookup::sha256_tables::generate_majority_normalization_table(plookup::SHA256_MAJ_NORMALIZE, index);
    }
    case plookup::SHA256_BASE28: {
        return plookup::sparse_tables::generate_sparse_table_with_rotation<28, 11, 0>(plookup::SHA256_BASE28, index);
    }
    case plookup::SHA256_BASE28_ROTATE6: {
        return plookup::sparse_tables::generate_sparse_table_with_rotation<28, 11, 6>(plookup::SHA256_BASE28_ROTATE6,
                                                                                      index);
    }
    case plookup::SHA256_BASE28_ROTATE3: {
        return plookup::sparse_tables::generate_sparse_table_with_rotation<28, 11, 3>(plookup::SHA256_BASE28_ROTATE3,
                                                                                      index);
    }
    case plookup::SHA256_BASE16: {
        return plookup::sparse_tables::generate_sparse_table_with_rotation<16, 11, 0>(plookup::SHA256_BASE16, index);
    }
    case plookup::SHA256_BASE16_ROTATE2: {
        return plookup::sparse_tables::generate_sparse_table_with_rotation<16, 11, 2>(plookup::SHA256_BASE16_ROTATE2,
                                                                                      index);
    }
    case plookup::UINT_XOR_SLICE_6_ROTATE_0: {
        return plookup::uint_tables::generate_xor_rotate_table<6, 0>(plookup::UINT_XOR_SLICE_6_ROTATE_0, index);
    }
    case plookup::UINT_AND_SLICE_6_ROTATE_0: {
        return plookup::uint_tables::generate_and_rotate_table<6, 0>(plookup::UINT_AND_SLICE_6_ROTATE_0, index);
    }
    case plookup::UINT_XOR_SLICE_2_ROTATE_0: {
        return plookup::uint_tables::generate_xor_rotate_table<2, 0>(plookup::UINT_XOR_SLICE_2_ROTATE_0, index);
    }
    case plookup::UINT_AND_SLICE_2_ROTATE_0: {
        return plookup::uint_tables::generate_and_rotate_table<2, 0>(plookup::UINT_AND_SLICE_2_ROTATE_0, index);
    }
    case plookup::BN254_XLO_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::generate_xlo_table(plookup::BN254_XLO_BASIC,
                                                                                              index);
    }
    case plookup::BN254_XHI_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::generate_xhi_table(plookup::BN254_XHI_BASIC,
                                                                                              index);
    }
    case plookup::BN254_YLO_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::generate_ylo_table(plookup::BN254_YLO_BASIC,
                                                                                              index);
    }
    case plookup::BN254_YHI_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::generate_yhi_table(plookup::BN254_YHI_BASIC,
                                                                                              index);
    }
    case plookup::BN254_XYPRIME_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::generate_xyprime_table(
            plookup::BN254_XYPRIME_BASIC, index);
    }
    case plookup::BN254_XLO_ENDO_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::generate_xlo_endo_table(
            plookup::BN254_XLO_ENDO_BASIC, index);
    }
    case plookup::BN254_XHI_ENDO_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::generate_xhi_endo_table(
            plookup::BN254_XHI_ENDO_BASIC, index);
    }
    case plookup::BN254_XYPRIME_ENDO_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<bb::g1>::generate_xyprime_endo_table(
            plookup::BN254_XYPRIME_ENDO_BASIC, index);
    }
    case plookup::SECP256K1_XLO_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::generate_xlo_table(
            plookup::SECP256K1_XLO_BASIC, index);
    }
    case plookup::SECP256K1_XHI_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::generate_xhi_table(
            plookup::SECP256K1_XHI_BASIC, index);
    }
    case plookup::SECP256K1_YLO_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::generate_ylo_table(
            plookup::SECP256K1_YLO_BASIC, index);
    }
    case plookup::SECP256K1_YHI_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::generate_yhi_table(
            plookup::SECP256K1_YHI_BASIC, index);
    }
    case plookup::SECP256K1_XYPRIME_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::generate_xyprime_table(
            plookup::SECP256K1_XYPRIME_BASIC, index);
    }
    case plookup::SECP256K1_XLO_ENDO_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::generate_xlo_endo_table(
            plookup::SECP256K1_XLO_ENDO_BASIC, index);
    }
    case plookup::SECP256K1_XHI_ENDO_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::generate_xhi_endo_table(
            plookup::SECP256K1_XHI_ENDO_BASIC, index);
    }
    case plookup::SECP256K1_XYPRIME_ENDO_BASIC: {
        return plookup::ecc_generator_tables::ecc_generator_table<secp256k1::g1>::generate_xyprime_endo_table(
            plookup::SECP256K1_XYPRIME_ENDO_BASIC, index);
    }
    case plookup::BLAKE_XOR_ROTATE0: {
        return plookup::blake2s_tables::generate_xor_rotate_table<6, 0>(plookup::BLAKE_XOR_ROTATE0, index);
    }
    case plookup::BLAKE_XOR_ROTATE0_SLICE5_MOD4: {
        return plookup::blake2s_tables::generate_xor_rotate_table<5, 0, true>(plookup::BLAKE_XOR_ROTATE0_SLICE5_MOD4,
                                                                              index);
    }
    case plookup::BLAKE_XOR_ROTATE2: {
        return plookup::blake2s_tables::generate_xor_rotate_table<6, 2>(plookup::BLAKE_XOR_ROTATE2, index);
    }
    case plookup::BLAKE_XOR_ROTATE1: {
        return plookup::blake2s_tables::generate_xor_rotate_table<6, 1>(plookup::BLAKE_XOR_ROTATE1, index);
    }
    case plookup::BLAKE_XOR_ROTATE4: {
        return plookup::blake2s_tables::generate_xor_rotate_table<6, 4>(plookup::BLAKE_XOR_ROTATE4, index);
    }
    case plookup::HONK_DUMMY_BASIC1: {
        return plookup::dummy_tables::generate_honk_dummy_table<plookup::HONK_DUMMY_BASIC1>(plookup::HONK_DUMMY_BASIC1,
                                                                                            index);
    }
    case plookup::HONK_DUMMY_BASIC2: {
        return plookup::dummy_tables::generate_honk_dummy_table<plookup::HONK_DUMMY_BASIC2>(plookup::HONK_DUMMY_BASIC2,
                                                                                            index);
    }
    case plookup::KECCAK_INPUT: {
        return plookup::keccak_tables::KeccakInput::generate_keccak_input_table(plookup::KECCAK_INPUT, index);
    }
    case plookup::KECCAK_THETA: {
        return plookup::keccak_tables::Theta::generate_theta_renormalization_table(plookup::KECCAK_THETA, index);
    }
    case plookup::KECCAK_CHI: {
        return plookup::keccak_tables::Chi::generate_chi_renormalization_table(plookup::KECCAK_CHI, index);
    }
    case plookup::KECCAK_OUTPUT: {
        return plookup::keccak_tables::KeccakOutput::generate_keccak_output_table(plookup::KECCAK_OUTPUT, index);
    }
    case plookup::KECCAK_RHO_1: {
        return plookup::keccak_tables::Rho<1>::generate_rho_renormalization_table(plookup::KECCAK_RHO_1, index);
    }
    case plookup::KECCAK_RHO_2: {
        return plookup::keccak_tables::Rho<2>::generate_rho_renormalization_table(plookup::KECCAK_RHO_2, index);
    }
    case plookup::KECCAK_RHO_3: {
        return plookup::keccak_tables::Rho<3>::generate_rho_renormalization_table(plookup::KECCAK_RHO_3, index);
    }
    case plookup::KECCAK_RHO_4: {
        return plookup::keccak_tables::Rho<4>::generate_rho_renormalization_table(plookup::KECCAK_RHO_4, index);
    }
    case plookup::KECCAK_RHO_5: {
        return plookup::keccak_tables::Rho<5>::generate_rho_renormalization_table(plookup::KECCAK_RHO_5, index);
    }
    case plookup::KECCAK_RHO_6: {
        return plookup::keccak_tables::Rho<6>::generate_rho_renormalization_table(plookup::KECCAK_RHO_6, index);
    }
    case plookup::KECCAK_RHO_7: {
        return plookup::keccak_tables::Rho<7>::generate_rho_renormalization_table(plookup::KECCAK_RHO_7, index);
    }
    case plookup::KECCAK_RHO_8: {
        return plookup::keccak_tables::Rho<8>::generate_rho_renormalization_table(plookup::KECCAK_RHO_8, index);
    }
    default: {
