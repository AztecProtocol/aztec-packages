...
class table : public FixedBaseParams {
  public:
    ...
    {
        static affine_element LHS_GENERATOR_POINT =
            crypto::generator_data<curve::Grumpkin>::get_precomputed_generators()[0];
        return LHS_GENERATOR_POINT;
    }

    static affine_element RHS_GENERATOR_POINT()
    {
        static affine_element RHS_GENERATOR_POINT =
            crypto::generator_data<curve::Grumpkin>::get_precomputed_generators()[1];
        return RHS_GENERATOR_POINT;
    }
