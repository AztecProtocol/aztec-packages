...
BasicTable create_basic_table(const BasicTableId id, const size_t index)
{
    ...
    case UINT_XOR_SLICE_2_ROTATE_0: {
        return uint_tables::generate_xor_rotate_table<2, 0>(UINT_XOR_SLICE_6_ROTATE_0, index);
    }
    case UINT_AND_SLICE_2_ROTATE_0: {
        return uint_tables::generate_and_rotate_table<2, 0>(UINT_AND_SLICE_6_ROTATE_0, index);
    }
