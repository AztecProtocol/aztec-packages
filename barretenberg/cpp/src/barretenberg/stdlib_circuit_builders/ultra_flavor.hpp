    ...
    class VerificationKey : public VerificationKey_<PrecomputedEntities<Commitment>, VerifierCommitmentKey> {
      public:
        ...
        MSGPACK_FIELDS(circuit_size,
                       ...
                       lagrange_first,
                       lagrange_last);
        std::vector<bb::fr> to_field_elements()
        {
            std::vector<bb::fr> elements;
            std::vector<bb::fr> circuit_size_elements = bb::field_conversion::convert_to_bn254_frs(this->circuit_size);
            elements.insert(elements.end(), circuit_size_elements.begin(), circuit_size_elements.end());
            // do the same for the rest of the fields
            std::vector<bb::fr> num_public_inputs_elements =
            ...
            std::vector<bb::fr> pub_inputs_offset_elements =
            ...
            for (Commitment& comm : this->get_all()) {
                std::vector<bb::fr> comm_elements = bb::field_conversion::convert_to_bn254_frs(comm);
