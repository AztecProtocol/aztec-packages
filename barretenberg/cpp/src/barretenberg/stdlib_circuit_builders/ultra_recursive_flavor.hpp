    ...
    class VerificationKey
      ...
      public:
        ...
        VerificationKey(CircuitBuilder* builder, const std::shared_ptr<NativeVerificationKey>& native_key)
        {
            ...
            this->num_public_inputs = stdlib::witness_t<CircuitBuilder>::create_constant_witness(builder, native_key->num_public_inputs);
            this->pub_inputs_offset = stdlib::witness_t<CircuitBuilder>::create_constant_witness(builder, native_key->pub_inputs_offset);
