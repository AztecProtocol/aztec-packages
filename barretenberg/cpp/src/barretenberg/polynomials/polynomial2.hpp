...
//  * The polynomial has a maximum degree in the underlying VirtualZerosArray, dictated by the circuit size, this is
//  just
...
//      * @details Set the size of self to match the input then set coefficients equal to right shift of input. Note:
//      The
