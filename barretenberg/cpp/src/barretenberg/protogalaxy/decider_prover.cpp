...
template <IsUltraFlavor Flavor> plonk::proof& DeciderProver_<Flavor>::export_proof()
{
    proof.proof_data = transcript->proof_data;
    return proof;
}

template <IsUltraFlavor Flavor> plonk::proof& DeciderProver_<Flavor>::construct_proof()
{
