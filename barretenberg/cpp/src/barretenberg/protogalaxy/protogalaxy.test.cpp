...
//     static void check_accumulator_target_sum_manual(std::shared_ptr<ProverInstance>& accumulator, bool
//     expected_result)
//     {
...
//         auto perturbator = ProtoGalaxyProver::construct_perturbator_coefficients(betas, deltas,
//         full_honk_evaluations); std::vector<FF> expected_values = { FF(648), FF(936), FF(432), FF(64) };
