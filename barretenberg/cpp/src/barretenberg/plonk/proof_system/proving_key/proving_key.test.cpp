...
TEST(proving_key, proving_key_from_serialized_key)
{
    ...
    EXPECT_EQ(p_key.contains_pairing_point_accum, proving_key->contains_pairing_point_accum);
}
...
StandardComposer(); fr a = fr::one(); builder.add_public_variable(a);
    ...
    EXPECT_EQ(p_key.contains_pairing_point_accum, pk_data.contains_pairing_point_accum);
}
#endif
*/
