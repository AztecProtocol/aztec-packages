...
class ECCVMTranscriptTests : public ::testing::Test {
  public:
    ...
    TranscriptManifest construct_eccvm_honk_manifest()
    {
        ...
        size_t frs_per_Fq = FrCodec::template calc_num_fields<FF>();
        size_t frs_per_Fr = FrCodec::template calc_num_fields<Flavor::BF>();
        size_t frs_per_G = FrCodec::template calc_num_fields<typename Flavor::Commitment>();
