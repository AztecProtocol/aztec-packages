...
// SUBRELATION_PARTIAL_LENGTHS incremented by the corresponding SUBRELATION_WITNESS_DEGREES over all relations included
// in UltraFlavor, which also affects the size of ExtendedEdges univariate containers. Moreover, the container
// SumcheckTupleOfTuplesOfUnivariates is resized to reflect that masked witness polynomials are of degree at most
// \f$2\f$ in each variable, and hence, for any subrelation, the corresponding univariate accumuluator size has to be
// increased by the subrelation's witness degree. See more in \ref docs/src/sumcheck-outline.md "Sumcheck Outline".
// */
// class ECCVMFlavorWithZK : public bb::ECCVMFlavor {
//   public:
...
//     using SumcheckTupleOfTuplesOfUnivariatese =
