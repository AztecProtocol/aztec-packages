    ...
    class ProverPolynomials : public AllEntities<Polynomial> {
      public:
        ...
        ProverPolynomials(CircuitBuilder& builder)
        {
            ...
            // WORKTODO: maybe singly threading this solves the issue of reproducibility?
            for (size_t i = 0; i < msm_state.size(); i++) {
                ...
                //     if (i == 5921) {
                //         info("msm_transition[i]:", msm_transition[i]);
                //         info("msm_add[i]:", msm_add[i]);
                //         info("msm_double[i]:", msm_double[i]);
                //         info("msm_skew[i]:", msm_skew[i]);
                //         info("msm_accumulator_x[i]:", msm_accumulator_x[i]);
                //         info("msm_accumulator_y[i]:", msm_accumulator_y[i]);
                //         info("msm_pc[i]:", msm_pc[i]);
                //         info("msm_size_of_msm[i]:", msm_size_of_msm[i]);
                //         info("msm_count[i]:", msm_count[i]);
                //         info("msm_round[i]:", msm_round[i]);
                //         info("msm_add1[i]:", msm_add1[i]);
                //         info("msm_add2[i]:", msm_add2[i]);
                //         info("msm_add3[i]:", msm_add3[i]);
                //         info("msm_add4[i]:", msm_add4[i]);
                //         info("msm_x1[i]:", msm_x1[i]);
                //         info("msm_y1[i]:", msm_y1[i]);
                //         info("msm_x2[i]:", msm_x2[i]);
                //         info("msm_y2[i]:", msm_y2[i]);
                //         info("msm_x3[i]:", msm_x3[i]);
                //         info("msm_y3[i]:", msm_y3[i]);
                //         info("msm_x4[i]:", msm_x4[i]);
                //         info("msm_y4[i]:", msm_y4[i]);
                //         info("msm_collision_x1[i]:", msm_collision_x1[i]);
                //         info("msm_collision_x2[i]:", msm_collision_x2[i]);
                //         info("msm_collision_x3[i]:", msm_collision_x3[i]);
                //         info("msm_collision_x4[i]:", msm_collision_x4[i]);
                //         info("msm_lambda1[i]:", msm_lambda1[i]);
                //         info("msm_lambda2[i]:", msm_lambda2[i]);
                //         info("msm_lambda3[i]:", msm_lambda3[i]);
                //         info("msm_lambda4[i]:", msm_lambda4[i]);
                //         info("msm_slice1[i]:", msm_slice1[i]);
                //         info("msm_slice2[i]:", msm_slice2[i]);
                //         info("msm_slice3[i]:", msm_slice3[i]);
                //         info("msm_slice4[i]:", msm_slice4[i]);
                //         info("hehe: ", i, " ", msm_lambda1[i]);
                //         info("hehe: ", i, " ", msm_lambda2[i]);
                //         info("hehe: ", i, " ", msm_lambda3[i]);
                //         info("hehe: ", i, " ", msm_lambda4[i]);
                //     }
            }
