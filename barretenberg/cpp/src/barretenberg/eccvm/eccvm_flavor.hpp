    ...
    class ProverPolynomials : public AllEntities<Polynomial> {
      public:
        ...
        ProverPolynomials(const CircuitBuilder& builder)
        {
            ...
            parallel_for_threshold(transcript_rows.size(), [&](size_t start, size_t end) {
            ...
            parallel_for_threshold(point_table_rows.size(), [&](size_t start, size_t end) {
                for (size_t i = start; i < end; i++) {
            ...
            parallel_for_threshold(msm_rows.size(), [&](size_t start, size_t end) {
                for (size_t i = start; i < end; i++) {
