...
typename ECCVMVerifier_<Flavor>::ReductionResult ECCVMVerifier_<Flavor>::reduce_to_ipa_opening()
{
    ...
    BB_BENCH_NAME("ECCVMVerifier::reduce_to_ipa_opening");
    ...
    {
        BB_BENCH_NAME("ECCVMVerifier::receive_wire_commitments");
        commitments.gemini_masking_poly =
    ...
    {
        BB_BENCH_NAME("ECCVMVerifier::compute_beta_gamma_challenges");
        ...
        relation_parameters.eccvm_set_permutation_delta =
            (gamma + first_term_tag) * (gamma + beta_sqr + first_term_tag) *
            (gamma + beta_sqr + beta_sqr + first_term_tag) * (gamma + beta_sqr + beta_sqr + beta_sqr + first_term_tag);
    ...
    {
        BB_BENCH_NAME("ECCVMVerifier::get_gate_challenges");
    ...
    {
        BB_BENCH_NAME("ECCVMVerifier::sumcheck_verify");
        sumcheck_output = sumcheck.verify(relation_parameters, gate_challenges, padding_indicator_array);
    }
    ...
    auto [sumcheck_batch_opening_claims, consistency_checked] = [&] {
        BB_BENCH_NAME("ECCVMVerifier::shplemini_compute_batch");
    ...
    {
        BB_BENCH_NAME("ECCVMVerifier::shplonk_reduce_verification");
        batch_opening_claim = Shplonk::reduce_verification(pcs_g1_identity, opening_claims, transcript);
    }
...
{
    BB_BENCH_NAME("ECCVMVerifier::compute_translation_opening_claims");
