...
//  */
// OpeningClaim<ECCVMVerifier::Curve> ECCVMVerifier::verify_proof(const ECCVMProof& proof)
// {
...
//     transcript->load_proof(proof.proof);
...
//     receive_from_prover<Commitment>("Gemini:masking_poly_comm"); for (auto [comm, label] :
...
//     polynomials std::array<Commitment, NUM_TRANSLATION_EVALUATIONS> translation_commitments = {
...
//     // Store verification flags for caller to check
...
//     NUM_DISABLED_ROWS_IN_SUMCHECK} shift_translation_masking_term_eval(evaluation_challenge_x,
//     translation_masking_term_eval); compute_accumulated_result();
// };
