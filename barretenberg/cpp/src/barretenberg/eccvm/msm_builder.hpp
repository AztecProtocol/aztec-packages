...
class ECCVMMSMMBuilder {
  public:
                                                   ...
                                                   const size_t num_msm_rows)
    {
        ...
        // For now, only multithread some parts of this builder for circuits that are larger than ones we see or test.
        static constexpr uint32_t HACK_TO_FIX_VANILLA = uint32_t(1) << 31;
