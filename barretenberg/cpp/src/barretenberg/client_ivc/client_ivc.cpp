    ...
    const std::shared_ptr<RecursiveTranscript>& accumulation_recursive_transcript)
{
    ...
    case QUEUE_TYPE::PG_FINAL: {
        ...
        // WORKTODO: We shouldn't need to do this pub inputs conversion at all anymore!
        // BB_ASSERT_EQ(num_public_inputs, 0UL, "number of public inputs in tail should be 0!");
