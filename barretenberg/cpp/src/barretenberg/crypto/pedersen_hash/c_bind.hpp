...
WASM_EXPORT void pedersen__hash(fr::vec_in_buf inputs_buffer, fr::out_buf output);
WASM_EXPORT void pedersen__hash_multiple(fr::vec_in_buf inputs_buffer, fr::out_buf output);

WASM_EXPORT void pedersen__hash_with_hash_index(fr::vec_in_buf inputs_buffer,
