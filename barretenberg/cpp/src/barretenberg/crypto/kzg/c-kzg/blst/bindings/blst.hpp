...
public:
#endif
    void keygen(const byte* IKM, size_t IKM_len, const std::string& info = "")
    {
        blst_keygen(&key, IKM, IKM_len, C_bytes(info.data()), info.size());
    }
    void keygen_v3(const byte* IKM, size_t IKM_len, const std::string& info = "")
    {
        blst_keygen_v3(&key, IKM, IKM_len, C_bytes(info.data()), info.size());
    }
    void keygen_v4_5(const byte* IKM, size_t IKM_len, const byte* salt, size_t salt_len, const std::string& info = "")
    {
        blst_keygen_v4_5(&key, IKM, IKM_len, salt, salt_len, C_bytes(info.data()), info.size());
    }
    void keygen_v5(const byte* IKM, size_t IKM_len, const byte* salt, size_t salt_len, const std::string& info = "")
    {
        blst_keygen_v5(&key, IKM, IKM_len, salt, salt_len, C_bytes(info.data()), info.size());
    }
#if __cplusplus >= 201703L
    ...
    void keygen_v4_5(const app__string_view IKM, // string_view by value, cool!
                     ...
                     const std::string& info = "")
    {
        keygen_v4_5(C_bytes(IKM.data()), IKM.size(), C_bytes(salt.data()), salt.size(), info);
    }
    void keygen_v5(const app__string_view IKM, // string_view by value, cool!
                   const app__string_view salt,
                   const std::string& info = "")
    {
        keygen_v5(C_bytes(IKM.data()), IKM.size(), C_bytes(salt.data()), salt.size(), info);
    }
#endif
    void derive_master_eip2333(const byte* IKM, size_t IKM_len) { blst_derive_master_eip2333(&key, IKM, IKM_len); }
...
class Scalar {
  ...
  public:
    ...
    Scalar(const byte* scalar, size_t nbits) { blst_scalar_from_le_bytes(&val, scalar, (nbits + 7) / 8); }
    Scalar(const byte* msg, size_t msg_len, const std::string& DST) { (void)hash_to(msg, msg_len, DST); }
#if __cplusplus >= 201703L
    ...
    {
        byte elem[48];
        blst_expand_message_xmd(elem, sizeof(elem), msg, msg_len, C_bytes(DST.data()), DST.size());
    ...
    {
        blst_scalar_from_be_bytes(&val, msg, msg_len);
        return this;
    }
    Scalar* from_lendian(const byte* msg, size_t msg_len)
    {
        blst_scalar_from_le_bytes(&val, msg, msg_len);
        return this;
    }
    void to_bendian(byte out[32]) const { blst_bendian_from_scalar(out, &val); }
    void to_lendian(byte out[32]) const { blst_lendian_from_scalar(out, &val); }
...
class P1_Affine {
  ...
  public:
    ...
    void serialize(byte out[96]) const { blst_p1_affine_serialize(out, &point); }
    void compress(byte out[48]) const { blst_p1_affine_compress(out, &point); }
    ...
    bool is_equal(const P1_Affine& p) const { return blst_p1_affine_is_equal(&point, &p.point); }
    BLST_ERROR core_verify(const P2_Affine& pk,
                           bool hash_or_encode,
                           const byte* msg,
                           size_t msg_len,
                           const std::string& DST = "",
                           const byte* aug = nullptr,
                           size_t aug_len = 0) const;
#if __cplusplus >= 201703L
    BLST_ERROR core_verify(const P2_Affine& pk,
                           bool hash_or_encode,
...
#endif
    static P1_Affine generator() { return P1_Affine(blst_p1_affine_generator()); }
...
class P1 {
  ...
  public:
    ...
    bool is_equal(const P1& p) const { return blst_p1_is_equal(&point, &p.point); }
    ...
    {
        blst_sign_pk_in_g2(&point, &point, &sk.key);
        return this;
    }
    P1* sign_with(const Scalar& scalar)
    {
        blst_sign_pk_in_g2(&point, &point, scalar);
        return this;
    }
    P1* hash_to(
        const byte* msg, size_t msg_len, const std::string& DST = "", const byte* aug = nullptr, size_t aug_len = 0)
    {
        blst_hash_to_g1(&point, msg, msg_len, C_bytes(DST.data()), DST.size(), aug, aug_len);
        return this;
    }
    P1* encode_to(
        const byte* msg, size_t msg_len, const std::string& DST = "", const byte* aug = nullptr, size_t aug_len = 0)
    {
        blst_encode_to_g1(&point, msg, msg_len, C_bytes(DST.data()), DST.size(), aug, aug_len);
        return this;
    }
#if __cplusplus >= 201703L
    P1* hash_to(const app__string_view msg, const std::string& DST = "", const app__string_view aug = None)
    {
        return hash_to(C_bytes(msg.data()), msg.size(), DST, C_bytes(aug.data()), aug.size());
    }
    P1* encode_to(const app__string_view msg, const std::string& DST = "", const app__string_view aug = None)
    {
        return encode_to(C_bytes(msg.data()), msg.size(), DST, C_bytes(aug.data()), aug.size());
    }
#endif
    P1* mult(const byte* scalar, size_t nbits)
    {
        blst_p1_mult(&point, &point, scalar, nbits);
        return this;
    }
    P1* mult(const Scalar& scalar)
    {
        blst_p1_mult(&point, &point, scalar, 255);
        return this;
    }
    P1* cneg(bool flag)
    {
    ...
    {
        P1 ret;
        blst_p1_add_or_double(ret, a, b);
        return ret;
    }
    static P1 add(const P1& a, const P1_Affine& b)
    {
        P1 ret;
        blst_p1_add_or_double_affine(ret, a, b);
        return ret;
    }
    static P1 dbl(const P1& a)
    {
        P1 ret;
        blst_p1_double(ret, a);
        return ret;
    }
#endif
    static P1 generator() { return P1(blst_p1_generator()); }
  ...
  public:
    ...
    P1_Affines(size_t wbits, const P1_Affine* const points[], size_t npoints)
    {
        ...
        blst_p1s_mult_wbits_precompute(
            table[0], wbits, reinterpret_cast<const blst_p1_affine* const*>(points), npoints);
    }
    ...
    P1_Affines(size_t wbits, const std::vector<P1_Affine> points) { P1_Affines(wbits, &points[0], points.size()); }
    ...
    P1_Affines(size_t wbits, const P1* const points[], size_t npoints)
    {
        ...
        this->npoints = npoints;
        table.resize(cap);
        blst_p1s_to_affine(table[cap - npoints], reinterpret_cast<const blst_p1* const*>(points), npoints);
    ...
    P1_Affines(size_t wbits, const std::vector<P1> points) { P1_Affines(wbits, &points[0], points.size()); }
    ...
    P1_Affines(const P1* const points[], size_t npoints)
    {
        ...
        blst_p1s_to_affine(table[0], reinterpret_cast<const blst_p1* const*>(points), npoints);
    }
    ...
    P1_Affines(const std::vector<P1> points) { P1_Affines(&points[0], points.size()); }
    ...
    P1 mult(const byte* const scalars[], size_t nbits) const
    {
        ...
        if (wbits != 0) {
            ...
            blst_p1s_mult_wbits(ret, table[0], wbits, npoints, scalars, nbits, scratch.get());
        } else {
            size_t sz = blst_p1s_mult_pippenger_scratch_sizeof(npoints);
            std::unique_ptr<limb_t[]> scratch{ new limb_t[sz / sizeof(limb_t)] };
            const blst_p1_affine* const ptrs[2] = { table[0], nullptr };
            blst_p1s_mult_pippenger(ret, ptrs, npoints, scalars, nbits, scratch.get());
        }
        return ret;
    }
    ...
    static std::vector<P1_Affine> from(const P1* const points[], size_t npoints)
    {
        ...
        ret.resize(npoints);
        blst_p1s_to_affine(ret[0], reinterpret_cast<const blst_p1* const*>(points), npoints);
        return ret;
    }
    ...
    static std::vector<P1_Affine> from(std::vector<P1> points) { return from(&points[0], points.size()); }
#endif

    static P1 mult_pippenger(const P1_Affine* const points[], size_t npoints, const byte* const scalars[], size_t nbits)
    {
        P1 ret;
        size_t sz = blst_p1s_mult_pippenger_scratch_sizeof(npoints);
        std::unique_ptr<limb_t[]> scratch{ new limb_t[sz / sizeof(limb_t)] };
        blst_p1s_mult_pippenger(
            ret, reinterpret_cast<const blst_p1_affine* const*>(points), npoints, scalars, nbits, scratch.get());
        return ret;
    }
#ifndef SWIG
    static P1 mult_pippenger(const P1_Affine points[], size_t npoints, const byte* const scalars[], size_t nbits)
    {
        const P1_Affine* const ptrs[2] = { points, nullptr };
        return mult_pippenger(ptrs, npoints, scalars, nbits);
    }
    static P1 mult_pippenger(const std::vector<P1_Affine> points, const byte* const scalars[], size_t nbits)
    {
    ...
    {
        P1 ret;
        blst_p1s_add(ret, reinterpret_cast<const blst_p1_affine* const*>(points), npoints);
        return ret;
    }
#ifndef SWIG
    ...
    static P1 add(const std::vector<P1_Affine> points) { return add(&points[0], points.size()); }
#endif
};
...
class P2_Affine {
  ...
  public:
    ...
    void serialize(byte out[192]) const { blst_p2_affine_serialize(out, &point); }
    void compress(byte out[96]) const { blst_p2_affine_compress(out, &point); }
    ...
    bool is_equal(const P2_Affine& p) const { return blst_p2_affine_is_equal(&point, &p.point); }
    BLST_ERROR core_verify(const P1_Affine& pk,
                           bool hash_or_encode,
                           const byte* msg,
                           size_t msg_len,
                           const std::string& DST = "",
    ...
    BLST_ERROR core_verify(const P1_Affine& pk,
                           ...
                           const app__string_view aug = None) const;
#endif
    static P2_Affine generator() { return P2_Affine(blst_p2_affine_generator()); }
...
class P2 {
  ...
  public:
    ...
    bool is_equal(const P2& p) const { return blst_p2_is_equal(&point, &p.point); }
    ...
    {
        blst_sign_pk_in_g1(&point, &point, &sk.key);
        return this;
    }
    P2* sign_with(const Scalar& scalar)
    {
        blst_sign_pk_in_g1(&point, &point, scalar);
        return this;
    }
    P2* hash_to(
        const byte* msg, size_t msg_len, const std::string& DST = "", const byte* aug = nullptr, size_t aug_len = 0)
    {
        blst_hash_to_g2(&point, msg, msg_len, C_bytes(DST.data()), DST.size(), aug, aug_len);
        return this;
    }
    P2* encode_to(
        const byte* msg, size_t msg_len, const std::string& DST = "", const byte* aug = nullptr, size_t aug_len = 0)
    {
        blst_encode_to_g2(&point, msg, msg_len, C_bytes(DST.data()), DST.size(), aug, aug_len);
        return this;
    }
#if __cplusplus >= 201703L
    P2* hash_to(const app__string_view msg, const std::string& DST = "", const app__string_view aug = None)
    {
        return hash_to(C_bytes(msg.data()), msg.size(), DST, C_bytes(aug.data()), aug.size());
    }
    P2* encode_to(const app__string_view msg, const std::string& DST = "", const app__string_view aug = None)
    {
        return encode_to(C_bytes(msg.data()), msg.size(), DST, C_bytes(aug.data()), aug.size());
    }
#endif
    ...
    {
        blst_p2_mult(&point, &point, scalar, nbits);
        return this;
    }
    P2* mult(const Scalar& scalar)
    {
        blst_p2_mult(&point, &point, scalar, 255);
        return this;
    }
    P2* cneg(bool flag)
    {
    ...
    {
        P2 ret;
        blst_p2_add_or_double(ret, a, b);
        return ret;
    }
    static P2 add(const P2& a, const P2_Affine& b)
    {
        P2 ret;
        blst_p2_add_or_double_affine(ret, a, b);
        return ret;
    }
    static P2 dbl(const P2& a)
    {
        P2 ret;
        blst_p2_double(ret, a);
        return ret;
    }
#endif
    static P2 generator() { return P2(blst_p2_generator()); }
  ...
  public:
    ...
    P2_Affines(size_t wbits, const P2_Affine* const points[], size_t npoints)
    {
        ...
        blst_p2s_mult_wbits_precompute(
            table[0], wbits, reinterpret_cast<const blst_p2_affine* const*>(points), npoints);
    }
    ...
    P2_Affines(size_t wbits, const std::vector<P2_Affine> points) { P2_Affines(wbits, &points[0], points.size()); }
    ...
    P2_Affines(size_t wbits, const P2* const points[], size_t npoints)
    {
        ...
        this->npoints = npoints;
        table.resize(cap);
        blst_p2s_to_affine(table[cap - npoints], reinterpret_cast<const blst_p2* const*>(points), npoints);
    ...
    P2_Affines(size_t wbits, const std::vector<P2> points) { P2_Affines(wbits, &points[0], points.size()); }
    ...
    P2_Affines(const P2* const points[], size_t npoints)
    {
        ...
        this->npoints = npoints;
        table.resize(npoints);
        blst_p2s_to_affine(table[0], reinterpret_cast<const blst_p2* const*>(points), npoints);
    }
    ...
    P2_Affines(const std::vector<P2> points) { P2_Affines(&points[0], points.size()); }
    ...
    P2 mult(const byte* const scalars[], size_t nbits) const
    {
        ...
        if (wbits != 0) {
            ...
            std::unique_ptr<limb_t[]> scratch{ new limb_t[sz / sizeof(limb_t)] };
            blst_p2s_mult_wbits(ret, table[0], wbits, npoints, scalars, nbits, scratch.get());
        } else {
            size_t sz = blst_p2s_mult_pippenger_scratch_sizeof(npoints);
            std::unique_ptr<limb_t[]> scratch{ new limb_t[sz / sizeof(limb_t)] };
            const blst_p2_affine* const ptrs[2] = { table[0], nullptr };
            blst_p2s_mult_pippenger(ret, ptrs, npoints, scalars, nbits, scratch.get());
        }
        return ret;
    }
    ...
    static std::vector<P2_Affine> from(const P2* const points[], size_t npoints)
    {
        ...
        ret.resize(npoints);
        blst_p2s_to_affine(ret[0], reinterpret_cast<const blst_p2* const*>(points), npoints);
        return ret;
    }
    ...
    static std::vector<P2_Affine> from(std::vector<P2> points) { return from(&points[0], points.size()); }
#endif

    static P2 mult_pippenger(const P2_Affine* const points[], size_t npoints, const byte* const scalars[], size_t nbits)
    {
        P2 ret;
        size_t sz = blst_p2s_mult_pippenger_scratch_sizeof(npoints);
        std::unique_ptr<limb_t[]> scratch{ new limb_t[sz / sizeof(limb_t)] };
        blst_p2s_mult_pippenger(
            ret, reinterpret_cast<const blst_p2_affine* const*>(points), npoints, scalars, nbits, scratch.get());
        return ret;
    }
#ifndef SWIG
    static P2 mult_pippenger(const P2_Affine points[], size_t npoints, const byte* const scalars[], size_t nbits)
    {
        const P2_Affine* const ptrs[2] = { points, nullptr };
        return mult_pippenger(ptrs, npoints, scalars, nbits);
    }
    static P2 mult_pippenger(const std::vector<P2_Affine> points, const byte* const scalars[], size_t nbits)
    {
        return mult_pippenger(&points[0], points.size(), scalars, nbits);
    }
#endif
    ...
    {
        P2 ret;
        blst_p2s_add(ret, reinterpret_cast<const blst_p2_affine* const*>(points), npoints);
        return ret;
    }
#ifndef SWIG
    ...
    static P2 add(const std::vector<P2_Affine> points) { return add(&points[0], points.size()); }
#endif
};
...
inline P1 P1_Affine::to_jacobian() const
{
    P1 ret(*this);
    return ret;
}
inline P2 P2_Affine::to_jacobian() const
{
    P2 ret(*this);
    return ret;
}
...
inline BLST_ERROR P1_Affine::core_verify(const P2_Affine& pk,
                                         ...
                                         const std::string& DST,
                                         const byte* aug,
                                         size_t aug_len) const
{
    return blst_core_verify_pk_in_g2(
        pk, &point, hash_or_encode, msg, msg_len, C_bytes(DST.data()), DST.size(), aug, aug_len);
}
...
{
    return core_verify(pk, hash_or_encode, C_bytes(msg.data()), msg.size(), DST, C_bytes(aug.data()), aug.size());
}
inline BLST_ERROR P2_Affine::core_verify(const P1_Affine& pk,
                                         bool hash_or_encode,
                                         const app__string_view msg,
...
class PT {
  ...
  public:
    ...
    PT(const P2_Affine& q, const P1_Affine& p) { blst_miller_loop(&value, q, p); }
    PT(const P1_Affine& p, const P2_Affine& q)
        : PT(q, p)
    {}
    PT(const P2& q, const P1& p) { blst_miller_loop(&value, P2_Affine(q), P1_Affine(p)); }
    ...
    bool is_equal(const PT& p) const { return blst_fp12_is_equal(&value, p); }
    PT* sqr()
    {
    ...
    void to_bendian(byte out[48 * 12]) const { blst_bendian_from_fp12(out, &value); }

    static bool finalverify(const PT& gt1, const PT& gt2) { return blst_fp12_finalverify(gt1, gt2); }
...
class Pairing {
  private:
    operator blst_pairing*() { return reinterpret_cast<blst_pairing*>(this); }
    operator const blst_pairing*() const { return reinterpret_cast<const blst_pairing*>(this); }
  ...
  public:
#ifndef SWIG
    void* operator new(size_t) { return new uint64_t[blst_pairing_sizeof() / sizeof(uint64_t)]; }
    void operator delete(void* ptr) { delete[] static_cast<uint64_t*>(ptr); }

    Pairing(bool hash_or_encode, const std::string& DST) { init(hash_or_encode, C_bytes(DST.data()), DST.size()); }
#if __cplusplus >= 201703L
    Pairing(bool hash_or_encode, const app__string_view DST) { init(hash_or_encode, C_bytes(DST.data()), DST.size()); }
#endif
#endif
#ifndef SWIGJAVA
    Pairing(bool hash_or_encode, const byte* DST, size_t DST_len) { init(hash_or_encode, DST, DST_len); }
    ~Pairing() { delete[] blst_pairing_get_dst(*this); }
#endif

    BLST_ERROR aggregate(const P1_Affine* pk,
                         const P2_Affine* sig,
                         const byte* msg,
                         size_t msg_len,
                         const byte* aug = nullptr,
                         size_t aug_len = 0)
    {
        return blst_pairing_aggregate_pk_in_g1(*this, *pk, *sig, msg, msg_len, aug, aug_len);
    }
    BLST_ERROR aggregate(const P2_Affine* pk,
                         const P1_Affine* sig,
                         const byte* msg,
                         size_t msg_len,
                         const byte* aug = nullptr,
                         size_t aug_len = 0)
    {
        return blst_pairing_aggregate_pk_in_g2(*this, *pk, *sig, msg, msg_len, aug, aug_len);
    }
    BLST_ERROR mul_n_aggregate(const P1_Affine* pk,
                               const P2_Affine* sig,
                               const byte* scalar,
                               size_t nbits,
                               const byte* msg,
                               ...
                               size_t aug_len = 0)
    {
        return blst_pairing_mul_n_aggregate_pk_in_g1(*this, *pk, *sig, scalar, nbits, msg, msg_len, aug, aug_len);
    }
    BLST_ERROR mul_n_aggregate(const P2_Affine* pk,
                               const P1_Affine* sig,
                               const byte* scalar,
                               size_t nbits,
                               const byte* msg,
                               ...
                               size_t aug_len = 0)
    {
        return blst_pairing_mul_n_aggregate_pk_in_g2(*this, *pk, *sig, scalar, nbits, msg, msg_len, aug, aug_len);
    }
#if __cplusplus >= 201703L
    BLST_ERROR aggregate(const P1_Affine* pk,
                         const P2_Affine* sig,
    ...
    {
        return aggregate(pk, sig, C_bytes(msg.data()), msg.size(), C_bytes(aug.data()), aug.size());
    }
    BLST_ERROR aggregate(const P2_Affine* pk,
                         const P1_Affine* sig,
                         const app__string_view msg,
    ...
    BLST_ERROR mul_n_aggregate(const P1_Affine* pk,
                               ...
                               const app__string_view aug = None)
    {
        return mul_n_aggregate(
            pk, sig, scalar, nbits, C_bytes(msg.data()), msg.size(), C_bytes(aug.data()), aug.size());
    }
    BLST_ERROR mul_n_aggregate(const P2_Affine* pk,
                               const P1_Affine* sig,
                               const byte* scalar,
...
#endif
    void commit() { blst_pairing_commit(*this); }
    BLST_ERROR merge(const Pairing* ctx) { return blst_pairing_merge(*this, *ctx); }
    bool finalverify(const PT* sig = nullptr) const
    {
        return sig == nullptr ? blst_pairing_finalverify(*this, nullptr) : blst_pairing_finalverify(*this, *sig);
    }
    void raw_aggregate(const P2_Affine* q, const P1_Affine* p) { blst_pairing_raw_aggregate(*this, *q, *p); }
    PT as_fp12() { return PT(blst_pairing_as_fp12(*this)); }
};
