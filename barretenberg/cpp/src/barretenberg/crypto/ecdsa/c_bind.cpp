                                            ...
                                            uint8_t* output_sig_v)
{
    ...
    auto priv_key = from_buffer<secp256k1::fr>(private_key);
    secp256k1::g1::affine_element pub_key = secp256k1::g1::one * priv_key;
    bb::crypto::ecdsa::ecdsa_key_pair<secp256k1::fr, secp256k1::g1> key_pair = { priv_key, pub_key };

    auto sig = bb::crypto::ecdsa::ecdsa_construct_signature<Sha256Hasher, secp256k1::fq, secp256k1::fr, secp256k1::g1>(
                                                          ...
                                                          uint8_t* output_pub_key)
{
    ...
    bb::crypto::ecdsa::ecdsa_signature sig = { r, s, v };
    auto recovered_pub_key =
        bb::crypto::ecdsa::ecdsa_recover_public_key<Sha256Hasher, secp256k1::fq, secp256k1::fr, secp256k1::g1>(
                                         ...
                                         uint8_t const* sig_v)
{
    ...
    bb::crypto::ecdsa::ecdsa_signature sig = { r, s, v };
    return bb::crypto::ecdsa::ecdsa_verify_signature<Sha256Hasher, secp256k1::fq, secp256k1::fr, secp256k1::g1>(
