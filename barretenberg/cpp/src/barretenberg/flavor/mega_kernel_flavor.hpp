...
#include "barretenberg/flavor/generated/mega_kernel_flavor_generated.hpp"
...
class MegaKernelFlavor : public MegaKernelFlavor_Generated {
  public:
    using Generated = MegaKernelFlavor_Generated;
    ...
    static_assert(NUM_BUS_COLUMNS == bb::NUM_BUS_COLUMNS,
                  "MegaKernelFlavor databus count must match the builder databus");
