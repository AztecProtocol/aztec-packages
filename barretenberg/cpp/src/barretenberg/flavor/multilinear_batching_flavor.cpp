                                                  ...
                                                  MultilinearBatchingProverClaim&& instance_claim)
{
    ...
    // Move polynomials from claims - zero-copy transfer of ownership
    ...
    // Construct eq polynomials (these are newly computed, not moved)
    ...
    // Copy commitments (small, cheap to copy)
    ...
    // Move preshifted polynomials for new claim computation
