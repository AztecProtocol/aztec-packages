    ...
    class Transcript : public BaseTranscript {
      public:
        ...
        void deserialize_full_transcript()
        {
            ...
            avmMini_m_clk = deserialize_from_buffer<Commitment>(BaseTranscript::proof_data, num_bytes_read);
            avmMini_m_sub_clk = deserialize_from_buffer<Commitment>(BaseTranscript::proof_data, num_bytes_read);
            avmMini_m_addr = deserialize_from_buffer<Commitment>(BaseTranscript::proof_data, num_bytes_read);
            avmMini_m_val = deserialize_from_buffer<Commitment>(BaseTranscript::proof_data, num_bytes_read);
            avmMini_m_lastAccess = deserialize_from_buffer<Commitment>(BaseTranscript::proof_data, num_bytes_read);
            avmMini_m_rw = deserialize_from_buffer<Commitment>(BaseTranscript::proof_data, num_bytes_read);
        ...
        void serialize_full_transcript()
        {
            ...
            serialize_to_buffer<Commitment>(avmMini_m_clk, BaseTranscript::proof_data);
            serialize_to_buffer<Commitment>(avmMini_m_sub_clk, BaseTranscript::proof_data);
            serialize_to_buffer<Commitment>(avmMini_m_addr, BaseTranscript::proof_data);
            serialize_to_buffer<Commitment>(avmMini_m_val, BaseTranscript::proof_data);
            serialize_to_buffer<Commitment>(avmMini_m_lastAccess, BaseTranscript::proof_data);
            serialize_to_buffer<Commitment>(avmMini_m_rw, BaseTranscript::proof_data);
