...
class AvmMiniFlavor {
  public:
    ...
    static constexpr size_t NUM_ALL_ENTITIES = 33;
  ...
  private:
    ...
    template <typename DataType> class WitnessEntities {
      public:
        ...
        {
            return { memTrace_m_clk,     memTrace_m_sub_clk,    memTrace_m_addr,    memTrace_m_tag,
                     memTrace_m_val,     memTrace_m_lastAccess, memTrace_m_last,    memTrace_m_rw,
                     avmMini_sel_op_add, avmMini_sel_op_sub,    avmMini_sel_op_mul, avmMini_sel_op_div,
                     avmMini_op_err,     avmMini_inv,           avmMini_ia,         avmMini_ib,
                     avmMini_ic,         avmMini_mem_op_a,      avmMini_mem_op_b,   avmMini_mem_op_c,
                     avmMini_rwa,        avmMini_rwb,           avmMini_rwc,        avmMini_mem_idx_a,
    ...
    template <typename DataType> class AllEntities {
      public:
        ...
        RefVector<DataType> get_wires()
        {
            return { avmMini_clk,         avmMini_first,       memTrace_m_clk,       memTrace_m_sub_clk,
                     memTrace_m_addr,     memTrace_m_tag,      memTrace_m_val,       memTrace_m_lastAccess,
                     memTrace_m_last,     memTrace_m_rw,       avmMini_sel_op_add,   avmMini_sel_op_sub,
                     avmMini_sel_op_mul,  avmMini_sel_op_div,  avmMini_op_err,       avmMini_inv,
                     avmMini_ia,          avmMini_ib,          avmMini_ic,           avmMini_mem_op_a,
                     avmMini_mem_op_b,    avmMini_mem_op_c,    avmMini_rwa,          avmMini_rwb,
                     avmMini_rwc,         avmMini_mem_idx_a,   avmMini_mem_idx_b,    avmMini_mem_idx_c,
                     avmMini_last,        memTrace_m_rw_shift, memTrace_m_val_shift, memTrace_m_addr_shift,
                     memTrace_m_tag_shift };
        };
