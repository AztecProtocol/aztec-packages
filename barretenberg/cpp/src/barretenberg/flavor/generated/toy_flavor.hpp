...
class ToyFlavor {
  public:
    ...
    static constexpr size_t NUM_WITNESS_ENTITIES = 22;
    static constexpr size_t NUM_WIRES = NUM_WITNESS_ENTITIES + NUM_PRECOMPUTED_ENTITIES;
    // We have two copies of the witness entities, so we subtract the number of fixed ones (they have no shift), one for
    // the unshifted and one for the shifted
    static constexpr size_t NUM_ALL_ENTITIES = 23;
      ...
      public:
        ...
        RefVector<DataType> get_wires()
        {
            return { toy_q_tuple_set,   toy_set_1_column_1, toy_set_1_column_2, toy_set_2_column_1, toy_set_2_column_2,
                     toy_xor_a,         toy_xor_b,          toy_xor_c,          toy_table_xor_a,    toy_table_xor_b,
                     toy_table_xor_c,   toy_q_xor,          toy_q_xor_table,    toy_q_err,          toy_q_err_check,
                     toy_clk,           toy_m_clk,          two_column_perm,    lookup_xor,         lookup_err,
      ...
      public:
        ...
        RefVector<DataType> get_wires()
        {
            return { toy_first,          toy_q_tuple_set,   toy_set_1_column_1, toy_set_1_column_2, toy_set_2_column_1,
                     ...
                     toy_table_xor_b,    toy_table_xor_c,   toy_q_xor,          toy_q_xor_table,    toy_q_err,
                     toy_q_err_check,    toy_clk,           toy_m_clk,          two_column_perm,    lookup_xor,
