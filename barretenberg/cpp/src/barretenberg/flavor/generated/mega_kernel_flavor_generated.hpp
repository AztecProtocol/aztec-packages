...
//
// Source: barretenberg/cpp/scripts/flavor-codegen/src/flavors/mega_kernel.ts
#pragma once
...
class MegaKernelFlavor_Generated {
  public:
    ...
    enum class EntityId : uint16_t {
        ...
        fourth_app_calldata_indicator = 28,
        q_5 = 29,
        fifth_app_calldata_indicator = 30,
        return_data_indicator = 31,
        q_poseidon2_external = 32,
        q_poseidon2_external_initial = 33,
        q_poseidon2_quad_internal = 34,
        ...
        ecc_op_wire_4 = 45,
        kernel_calldata = 46,
        kernel_calldata_read_counts = 47,
        kernel_calldata_inverses = 48,
        first_app_calldata = 49,
        first_app_calldata_read_counts = 50,
        first_app_calldata_inverses = 51,
        second_app_calldata = 52,
        second_app_calldata_read_counts = 53,
        second_app_calldata_inverses = 54,
        third_app_calldata = 55,
        third_app_calldata_read_counts = 56,
        third_app_calldata_inverses = 57,
        fourth_app_calldata = 58,
        fourth_app_calldata_read_counts = 59,
        fourth_app_calldata_inverses = 60,
        fifth_app_calldata = 61,
        fifth_app_calldata_read_counts = 62,
        fifth_app_calldata_inverses = 63,
        return_data = 64,
        return_data_read_counts = 65,
        return_data_inverses = 66,
        w_l_shift = 67,
        w_r_shift = 68,
        w_o_shift = 69,
        w_4_shift = 70,
    ...
    using Relations_ = std::tuple<bb::ArithmeticRelation<FF>,
                                  ...
                                  bb::SingleBusLookupRelation<FF,
                                                              ...
                                                              EntityId::q_l>,
                                  bb::SingleBusLookupRelation<FF,
                                                              EntityId::first_app_calldata,
                                                              EntityId::first_app_calldata_read_counts,
                                                              EntityId::first_app_calldata_inverses,
                                                              EntityId::first_app_calldata_indicator,
                                                              EntityId::q_r>,
                                  bb::SingleBusLookupRelation<FF,
                                                              EntityId::second_app_calldata,
                                                              EntityId::second_app_calldata_read_counts,
                                                              EntityId::second_app_calldata_inverses,
                                                              EntityId::second_app_calldata_indicator,
                                                              EntityId::q_o>,
                                  bb::SingleBusLookupRelation<FF,
                                                              EntityId::third_app_calldata,
                                                              EntityId::third_app_calldata_read_counts,
                                                              EntityId::third_app_calldata_inverses,
    ...
    template <typename DataType> class AllEntities {
      public:
        using EntityId = MegaKernelFlavor_Generated::EntityId;
        ...
        DataType& first_app_calldata_indicator()
        {
            return data[static_cast<size_t>(EntityId::first_app_calldata_indicator)];
        }
        const DataType& first_app_calldata_indicator() const
        {
            return data[static_cast<size_t>(EntityId::first_app_calldata_indicator)];
        }
        DataType& second_app_calldata_indicator()
        {
            return data[static_cast<size_t>(EntityId::second_app_calldata_indicator)];
        }
        const DataType& second_app_calldata_indicator() const
        {
            return data[static_cast<size_t>(EntityId::second_app_calldata_indicator)];
        }
        DataType& third_app_calldata_indicator()
        {
            return data[static_cast<size_t>(EntityId::third_app_calldata_indicator)];
        }
        const DataType& third_app_calldata_indicator() const
        {
            return data[static_cast<size_t>(EntityId::third_app_calldata_indicator)];
        }
        ...
        DataType& first_app_calldata() { return data[static_cast<size_t>(EntityId::first_app_calldata)]; }
        const DataType& first_app_calldata() const { return data[static_cast<size_t>(EntityId::first_app_calldata)]; }
        DataType& first_app_calldata_read_counts()
        {
            return data[static_cast<size_t>(EntityId::first_app_calldata_read_counts)];
        }
        const DataType& first_app_calldata_read_counts() const
        {
            return data[static_cast<size_t>(EntityId::first_app_calldata_read_counts)];
        }
        DataType& first_app_calldata_inverses()
        {
            return data[static_cast<size_t>(EntityId::first_app_calldata_inverses)];
        }
        const DataType& first_app_calldata_inverses() const
        {
            return data[static_cast<size_t>(EntityId::first_app_calldata_inverses)];
        }
        DataType& second_app_calldata() { return data[static_cast<size_t>(EntityId::second_app_calldata)]; }
        const DataType& second_app_calldata() const { return data[static_cast<size_t>(EntityId::second_app_calldata)]; }
        DataType& second_app_calldata_read_counts()
        {
            return data[static_cast<size_t>(EntityId::second_app_calldata_read_counts)];
        }
        const DataType& second_app_calldata_read_counts() const
        {
            return data[static_cast<size_t>(EntityId::second_app_calldata_read_counts)];
        }
        DataType& second_app_calldata_inverses()
        {
            return data[static_cast<size_t>(EntityId::second_app_calldata_inverses)];
        }
        const DataType& second_app_calldata_inverses() const
        {
            return data[static_cast<size_t>(EntityId::second_app_calldata_inverses)];
        }
        DataType& third_app_calldata() { return data[static_cast<size_t>(EntityId::third_app_calldata)]; }
        const DataType& third_app_calldata() const { return data[static_cast<size_t>(EntityId::third_app_calldata)]; }
        DataType& third_app_calldata_read_counts()
        {
            return data[static_cast<size_t>(EntityId::third_app_calldata_read_counts)];
        }
        const DataType& third_app_calldata_read_counts() const
        {
            return data[static_cast<size_t>(EntityId::third_app_calldata_read_counts)];
        }
        DataType& third_app_calldata_inverses()
        {
            return data[static_cast<size_t>(EntityId::third_app_calldata_inverses)];
        }
        const DataType& third_app_calldata_inverses() const
        {
            return data[static_cast<size_t>(EntityId::third_app_calldata_inverses)];
        }
    ...
    template <typename DataType_> class PrecomputedEntities {
      public:
        ...
        DataType& fourth_app_calldata_indicator() { return data[28]; }
        const DataType& fourth_app_calldata_indicator() const { return data[28]; }
        DataType& q_5() { return data[29]; }
        const DataType& q_5() const { return data[29]; }
        DataType& fifth_app_calldata_indicator() { return data[30]; }
        const DataType& fifth_app_calldata_indicator() const { return data[30]; }
        DataType& return_data_indicator() { return data[31]; }
        const DataType& return_data_indicator() const { return data[31]; }
        DataType& q_poseidon2_external() { return data[32]; }
        const DataType& q_poseidon2_external() const { return data[32]; }
        DataType& q_poseidon2_external_initial() { return data[33]; }
        const DataType& q_poseidon2_external_initial() const { return data[33]; }
        DataType& q_poseidon2_quad_internal() { return data[34]; }
        const DataType& q_poseidon2_quad_internal() const { return data[34]; }
    ...
    template <typename DataType_> class WitnessEntities {
      public:
        ...
        DataType& first_app_calldata() { return data[12]; }
        const DataType& first_app_calldata() const { return data[12]; }
        DataType& first_app_calldata_read_counts() { return data[13]; }
        const DataType& first_app_calldata_read_counts() const { return data[13]; }
        DataType& first_app_calldata_inverses() { return data[14]; }
        const DataType& first_app_calldata_inverses() const { return data[14]; }
        DataType& second_app_calldata() { return data[15]; }
        const DataType& second_app_calldata() const { return data[15]; }
        DataType& second_app_calldata_read_counts() { return data[16]; }
        const DataType& second_app_calldata_read_counts() const { return data[16]; }
        DataType& second_app_calldata_inverses() { return data[17]; }
        const DataType& second_app_calldata_inverses() const { return data[17]; }
        DataType& third_app_calldata() { return data[18]; }
        const DataType& third_app_calldata() const { return data[18]; }
        DataType& third_app_calldata_read_counts() { return data[19]; }
        const DataType& third_app_calldata_read_counts() const { return data[19]; }
        DataType& third_app_calldata_inverses() { return data[20]; }
        const DataType& third_app_calldata_inverses() const { return data[20]; }
        DataType& fourth_app_calldata() { return data[21]; }
        const DataType& fourth_app_calldata() const { return data[21]; }
        DataType& fourth_app_calldata_read_counts() { return data[22]; }
        const DataType& fourth_app_calldata_read_counts() const { return data[22]; }
        DataType& fourth_app_calldata_inverses() { return data[23]; }
        const DataType& fourth_app_calldata_inverses() const { return data[23]; }
        DataType& fifth_app_calldata() { return data[24]; }
        const DataType& fifth_app_calldata() const { return data[24]; }
        DataType& fifth_app_calldata_read_counts() { return data[25]; }
        const DataType& fifth_app_calldata_read_counts() const { return data[25]; }
        DataType& fifth_app_calldata_inverses() { return data[26]; }
        const DataType& fifth_app_calldata_inverses() const { return data[26]; }
        DataType& return_data() { return data[27]; }
        const DataType& return_data() const { return data[27]; }
        DataType& return_data_read_counts() { return data[28]; }
        const DataType& return_data_read_counts() const { return data[28]; }
        DataType& return_data_inverses() { return data[29]; }
        const DataType& return_data_inverses() const { return data[29]; }
