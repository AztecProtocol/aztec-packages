  ...
  private:
    ...
    template <typename DataType> class PrecomputedEntities {
      public:
        ...
        RefArray<DataType, 0> get_sigma_polynomials() { return {}; };
        RefArray<DataType, 0> get_id_polynomials() { return {}; };
        RefArray<DataType, 0> get_table_polynomials() { return {}; };
    };
    ...
    template <typename DataType> class AllEntities {
      public:
        FLAVOR_MEMBERS(NUM_ALL_ENTITIES,
                       ...
                       lagrange_second,                    // column 1
                       lagrange_last,                      // column 2
                       transcript_add,                     // column 3
                       transcript_mul,                     // column 4
                       transcript_eq,                      // column 5
                       transcript_collision_check,         // column 6
                       transcript_msm_transition,          // column 7
                       transcript_pc,                      // column 8
                       transcript_msm_count,               // column 9
                       transcript_Px,                      // column 10
                       transcript_Py,                      // column 11
                       transcript_z1,                      // column 12
                       transcript_z2,                      // column 13
                       transcript_z1zero,                  // column 14
                       transcript_z2zero,                  // column 15
                       transcript_op,                      // column 16
                       transcript_accumulator_x,           // column 17
                       transcript_accumulator_y,           // column 18
                       transcript_msm_x,                   // column 19
                       transcript_msm_y,                   // column 20
                       precompute_pc,                      // column 21
                       precompute_point_transition,        // column 22
                       precompute_round,                   // column 23
                       precompute_scalar_sum,              // column 24
                       precompute_s1hi,                    // column 25
                       precompute_s1lo,                    // column 26
                       precompute_s2hi,                    // column 27
                       precompute_s2lo,                    // column 28
                       precompute_s3hi,                    // column 29
                       precompute_s3lo,                    // column 30
                       precompute_s4hi,                    // column 31
                       precompute_s4lo,                    // column 32
                       precompute_skew,                    // column 33
                       precompute_dx,                      // column 34
                       precompute_dy,                      // column 35
                       precompute_tx,                      // column 36
                       precompute_ty,                      // column 37
                       msm_transition,                     // column 38
                       msm_add,                            // column 39
                       msm_double,                         // column 40
                       msm_skew,                           // column 41
                       msm_accumulator_x,                  // column 42
                       msm_accumulator_y,                  // column 43
                       msm_pc,                             // column 44
                       msm_size_of_msm,                    // column 45
                       msm_count,                          // column 46
                       msm_round,                          // column 47
                       msm_add1,                           // column 48
                       msm_add2,                           // column 49
                       ...
                       msm_x4,                             // column 58
                       msm_y4,                             // column 59
                       msm_collision_x1,                   // column 60
                       msm_collision_x2,                   // column 61
                       msm_collision_x3,                   // column 62
                       msm_collision_x4,                   // column 63
                       msm_lambda1,                        // column 64
                       msm_lambda2,                        // column 65
                       msm_lambda3,                        // column 66
                       msm_lambda4,                        // column 67
                       msm_slice1,                         // column 68
                       msm_slice2,                         // column 69
                       msm_slice3,                         // column 70
                       msm_slice4,                         // column 71
                       transcript_accumulator_empty,       // column 72
                       transcript_reset_accumulator,       // column 73
                       precompute_select,                  // column 74
                       lookup_read_counts_0,               // column 75
                       lookup_read_counts_1,               // column 76
                       z_perm,                             // column 77
                       lookup_inverses,                    // column 78
                       transcript_mul_shift,               // column 79
                       transcript_msm_count_shift,         // column 80
                       transcript_accumulator_x_shift,     // column 81
                       transcript_accumulator_y_shift,     // column 82
                       precompute_scalar_sum_shift,        // column 83
                       precompute_s1hi_shift,              // column 84
                       precompute_dx_shift,                // column 85
                       precompute_dy_shift,                // column 86
                       precompute_tx_shift,                // column 87
                       precompute_ty_shift,                // column 88
                       msm_transition_shift,               // column 89
                       msm_add_shift,                      // column 90
                       msm_double_shift,                   // column 91
                       msm_skew_shift,                     // column 92
                       msm_accumulator_x_shift,            // column 93
                       msm_accumulator_y_shift,            // column 94
                       msm_count_shift,                    // column 95
                       msm_round_shift,                    // column 96
                       msm_add1_shift,                     // column 97
                       msm_pc_shift,                       // column 98
                       precompute_pc_shift,                // column 99
                       transcript_pc_shift,                // column 100
                       precompute_round_shift,             // column 101
                       transcript_accumulator_empty_shift, // column 102
                       precompute_select_shift,            // column 103
                       z_perm_shift);                      // column 104
        ...
        RefVector<DataType> get_wires()
        {
            ...
            // Just witness entities
            for (size_t i = NUM_PRECOMPUTED_ENTITIES; i < NUM_PRECOMPUTED_ENTITIES + NUM_WITNESS_ENTITIES; i++) {
                wires.push_back(*view[i]);
            }
            return wires;
        };
        ...
        RefVector<DataType> get_unshifted() override
        {
            RefVector<DataType> wires;
            auto view = pointer_view();
            // Just precomputed entities and witness entitities
            for (size_t i = 0; i < NUM_PRECOMPUTED_ENTITIES + NUM_WITNESS_ENTITIES; i++) {
                wires.push_back(*view[i]);
            }
            return wires;
        };
        ...
        RefVector<DataType> get_shifted() override
        {
            RefVector<DataType> wires;
            auto view = pointer_view();
            // Just shifted entities
            for (size_t i = NUM_PRECOMPUTED_ENTITIES + NUM_WITNESS_ENTITIES; i < NUM_ALL_ENTITIES; i++) {
                wires.push_back(*view[i]);
            }
            return wires;
        };
