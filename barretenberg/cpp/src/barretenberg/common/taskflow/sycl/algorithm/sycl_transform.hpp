...
template <typename I, typename C, typename... S> auto syclFlow::_transform_cgh(I first, I last, C&& op, S... srcs)
{
...
// Function: transform
template <typename I, typename C, typename... S> syclTask syclFlow::transform(I first, I last, C&& op, S... srcs)
{
...
void syclFlow::transform(syclTask task, I first, I last, C&& op, S... srcs)
{
