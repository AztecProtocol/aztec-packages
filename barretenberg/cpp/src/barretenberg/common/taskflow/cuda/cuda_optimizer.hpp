...
// Function: _levelize
inline std::vector<std::vector<cudaFlowNode*>> cudaFlowOptimizerBase::_levelize(cudaFlowGraph& graph)
{
...
The algorithm is based on the following paper published in Euro-Par 2021:
  + Dian-Lun Lin and Tsung-Wei Huang, &quot;Efficient GPU Computation using %Task Graph Parallelism,&quot; <i>European
Conference on Parallel and Distributed Computing (Euro-Par)</i>, 2021
