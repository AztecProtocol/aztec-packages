...
// Constructor
inline cudaTask::cudaTask(cudaFlowNode* node)
    : _node{ node }
{}
...
inline cudaTaskType cudaTask::type() const
{
    ...
    case cudaFlowNode::EMPTY:
        return cudaTaskType::EMPTY;
    case cudaFlowNode::HOST:
        return cudaTaskType::HOST;
    case cudaFlowNode::MEMSET:
        return cudaTaskType::MEMSET;
    case cudaFlowNode::MEMCPY:
