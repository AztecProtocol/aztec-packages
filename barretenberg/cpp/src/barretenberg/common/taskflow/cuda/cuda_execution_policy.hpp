...
template <unsigned NT, unsigned VT> class cudaExecutionPolicy {
  ...
  public:
     ...
     */
    explicit cudaExecutionPolicy(cudaStream_t s)
        : _stream{ s }
    {}
    ...
    */
    template <typename T> static unsigned reduce_bufsz(unsigned count);
    ...
    tf::cuda_min_element.
    */
    template <typename T> static unsigned min_element_bufsz(unsigned count);
    ...
    tf::cuda_max_element.
    */
    template <typename T> static unsigned max_element_bufsz(unsigned count);
    ...
    */
    template <typename T> static unsigned scan_bufsz(unsigned count);
