...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
    ...
    struct basic_variant
        ...
        basic_variant(basic_variant const& other)
        ...
        basic_variant(char const* p)
            : base(std::string(p))
        {}
        basic_variant(char v) { int_init(v); }
        basic_variant(signed char v) { int_init(v); }
        basic_variant(unsigned char v)
            : base(uint64_t(v))
        {}
        basic_variant(signed int v) { int_init(v); }
        basic_variant(unsigned int v)
            : base(uint64_t(v))
        {}
        basic_variant(signed long v) { int_init(v); }
        basic_variant(unsigned long v)
            : base(uint64_t(v))
        {}
        basic_variant(signed long long v) { int_init(v); }
        basic_variant(unsigned long long v)
            : base(uint64_t(v))
        {}
        basic_variant(float v) { double_init(v); }
        basic_variant(double v) { double_init(v); }

        bool is_nil() const { return boost::get<msgpack::type::nil_t>(this) != MSGPACK_NULLPTR; }
        bool is_bool() const { return boost::get<bool>(this) != MSGPACK_NULLPTR; }
        bool is_int64_t() const { return boost::get<int64_t>(this) != MSGPACK_NULLPTR; }
        bool is_uint64_t() const { return boost::get<uint64_t>(this) != MSGPACK_NULLPTR; }
        bool is_double() const { return boost::get<double>(this) != MSGPACK_NULLPTR; }
        bool is_string() const { return boost::get<std::string>(this) != MSGPACK_NULLPTR; }
#if (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
        bool is_boost_string_ref() const { return boost::get<boost::string_ref>(this) != MSGPACK_NULLPTR; }
#endif // (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
        bool is_vector_char() const { return boost::get<std::vector<char>>(this) != MSGPACK_NULLPTR; }
        bool is_vector_char() { return boost::get<std::vector<char>>(this) != MSGPACK_NULLPTR; }
        bool is_raw_ref() const { return boost::get<raw_ref>(this) != MSGPACK_NULLPTR; }
        bool is_ext() const { return boost::get<ext>(this) != MSGPACK_NULLPTR; }
        bool is_ext_ref() const { return boost::get<ext_ref>(this) != MSGPACK_NULLPTR; }
        ...
        bool as_bool() const { return boost::get<bool>(*this); }
        int64_t as_int64_t() const { return boost::get<int64_t>(*this); }
        uint64_t as_uint64_t() const { return boost::get<uint64_t>(*this); }
        ...
        std::string const& as_string() const { return boost::get<std::string>(*this); }
#if (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
        boost::string_ref const& as_boost_string_ref() const { return boost::get<boost::string_ref>(*this); }
#endif // (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
        std::vector<char> const& as_vector_char() const { return boost::get<std::vector<char>>(*this); }
        raw_ref const& as_raw_ref() const { return boost::get<raw_ref>(*this); }
        ext const& as_ext() const { return boost::get<ext>(*this); }
        ext_ref const& as_ext_ref() const { return boost::get<ext_ref>(*this); }
      ...
      private:
        template <typename T> void int_init(T v)
        {
            if (v < 0) {
    ...
    {
        return static_cast<typename basic_variant<STR, BIN, EXT>::base const&>(lhs) <
    ...
    template <typename STR, typename BIN, typename EXT> struct as<type::basic_variant<STR, BIN, EXT>> {
    ...
    template <typename STR, typename BIN, typename EXT> struct convert<type::basic_variant<STR, BIN, EXT>> {
    ...
    template <typename Stream> struct pack_imp : boost::static_visitor<void> {
        template <typename T> void operator()(T const& value) const { pack<T>()(o_, value); }
    ...
    template <typename STR, typename BIN, typename EXT> struct pack<type::basic_variant<STR, BIN, EXT>> {
        template <typename Stream>
        msgpack::packer<Stream>& operator()(msgpack::packer<Stream>& o,
                                            const type::basic_variant<STR, BIN, EXT>& v) const
        {
    ...
    struct object_imp : boost::static_visitor<void> {
        void operator()(msgpack::type::nil_t const& v) const { object<msgpack::type::nil_t>()(o_, v); }
        void operator()(bool const& v) const { object<bool>()(o_, v); }
        void operator()(uint64_t const& v) const { object<uint64_t>()(o_, v); }
        void operator()(int64_t const& v) const { object<int64_t>()(o_, v); }
        void operator()(double const& v) const { object<double>()(o_, v); }
        template <typename T> void operator()(T const&) const { THROW msgpack::type_error(); }
    ...
    template <typename STR, typename BIN, typename EXT> struct object<type::basic_variant<STR, BIN, EXT>> {
    ...
    struct object_with_zone_imp : boost::static_visitor<void> {
        template <typename T> void operator()(T const& v) const { object_with_zone<T>()(o_, v); }
    ...
    template <typename STR, typename BIN, typename EXT> struct object_with_zone<type::basic_variant<STR, BIN, EXT>> {
