...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
    ...
    template <typename Stream> class packer {
      ...
      public:
         ...
         */
        template <typename T> packer<Stream>& pack(const T& v);
         ...
         * You need to call `pack_str_body(const char* b, uint32_t l)` after this function calling with the same `l`
         ...
         * You need to call `pack_v4raw_body(const char* b, uint32_t l)` after this function calling with the same `l`
         * value. See https://github.com/msgpack/msgpack/blob/master/spec.md#formats-str
         *
         * @param l The length of string.
         *
         ...
         * The minimum byte size length expression is used.
         * You need to call `pack_bin_body(const char* b, uint32_t l)` after this function calling with the same `l`
         ...
         * You need to call `pack_ext_body(const char* b, uint32_t l)` after this function calling with the same `l`
      ...
      private:
        template <typename T> void pack_imp_uint8(T d);
        template <typename T> void pack_imp_uint16(T d);
        template <typename T> void pack_imp_uint32(T d);
        template <typename T> void pack_imp_uint64(T d);
        template <typename T> void pack_imp_int8(T d);
        template <typename T> void pack_imp_int16(T d);
        template <typename T> void pack_imp_int32(T d);
        template <typename T> void pack_imp_int64(T d);

        void append_buffer(const char* buf, size_t len) { append_buffer(&Stream::write, buf, len); }
    ...
    template <typename T> inline char take8_8(T d)
    {
        return static_cast<char>(reinterpret_cast<uint8_t*>(&d)[0]);
    }
    template <typename T> inline char take8_16(T d)
    {
        return static_cast<char>(reinterpret_cast<uint8_t*>(&d)[0]);
    }
    template <typename T> inline char take8_32(T d)
    {
        return static_cast<char>(reinterpret_cast<uint8_t*>(&d)[0]);
    }
    template <typename T> inline char take8_64(T d)
    {
        return static_cast<char>(reinterpret_cast<uint8_t*>(&d)[0]);
    }
...
#error msgpack-c supports only big endian and little endian
    ...
    inline packer<Stream>::packer(Stream * s)
        : m_stream(*s)
    {}
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_uint8(uint8_t d)
    {
        pack_imp_uint8(d);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_uint16(uint16_t d)
    {
        pack_imp_uint16(d);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_uint32(uint32_t d)
    {
        pack_imp_uint32(d);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_uint64(uint64_t d)
    {
        pack_imp_uint64(d);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_int8(int8_t d)
    {
        pack_imp_int8(d);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_int16(int16_t d)
    {
        pack_imp_int16(d);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_int32(int32_t d)
    {
        pack_imp_int32(d);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_int64(int64_t d)
    {
        pack_imp_int64(d);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_fix_uint8(uint8_t d)
    {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_fix_uint16(uint16_t d)
    {
        char buf[3];
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_fix_uint32(uint32_t d)
    {
        char buf[5];
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_fix_uint64(uint64_t d)
    {
        char buf[9];
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_fix_int8(int8_t d)
    {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_fix_int16(int16_t d)
    {
        char buf[3];
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_fix_int32(int32_t d)
    {
        char buf[5];
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_fix_int64(int64_t d)
    {
        char buf[9];
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_char(char d)
    {
#if defined(CHAR_MIN)
#if CHAR_MIN < 0
        pack_imp_int8(d);
...
#error CHAR_MIN is not defined
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_wchar(wchar_t d)
    {
        if (d < 0) {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_signed_char(signed char d)
    {
        pack_imp_int8(d);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_short(short d)
    {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_int(int d)
    {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_long(long d)
    {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_long_long(long long d)
    {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_unsigned_char(unsigned char d)
    {
        pack_imp_uint8(d);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_unsigned_short(unsigned short d)
    {
#if defined(SIZEOF_SHORT)
#if SIZEOF_SHORT == 2
        pack_imp_uint16(d);
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_unsigned_int(unsigned int d)
    {
#if defined(SIZEOF_INT)
#if SIZEOF_INT == 2
        pack_imp_uint16(d);
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_unsigned_long(unsigned long d)
    {
#if defined(SIZEOF_LONG)
#if SIZEOF_LONG == 2
        pack_imp_uint16(d);
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_unsigned_long_long(unsigned long long d)
    {
#if defined(SIZEOF_LONG_LONG)
#if SIZEOF_LONG_LONG == 2
        pack_imp_uint16(d);
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_float(float d)
    {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_double(double d)
    {
        if (d == d) { // check for nan
            // compare d to limits to avoid undefined behaviour
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_nil()
    {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_true()
    {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_false()
    {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_array(uint32_t n)
    {
        if (n < 16) {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_map(uint32_t n)
    {
        if (n < 16) {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_str(uint32_t l)
    {
        if (l < 32) {
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_str_body(const char* b, uint32_t l)
    {
        append_buffer(b, l);
        return *this;
    }
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_v4raw(uint32_t l)
    {
        if (l < 32) {
            unsigned char d = static_cast<uint8_t>(0xa0u | l);
            char buf = take8_8(d);
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_v4raw_body(const char* b, uint32_t l)
    {
        append_buffer(b, l);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_bin(uint32_t l)
    {
        if (l < 256) {
            char buf[2];
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_bin_body(const char* b, uint32_t l)
    {
        append_buffer(b, l);
        return *this;
    }

    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_ext(size_t l, int8_t type)
    {
        switch (l) {
        case 1: {
            char buf[2];
    ...
    template <typename Stream> inline packer<Stream>& packer<Stream>::pack_ext_body(const char* b, uint32_t l)
    {
        append_buffer(b, l);
        return *this;
    }

    template <typename Stream> template <typename T> inline void packer<Stream>::pack_imp_uint8(T d)
    {
        if (d < (1 << 7)) {
            /* fixnum */
            char buf = take8_8(d);
    ...
    template <typename Stream> template <typename T> inline void packer<Stream>::pack_imp_uint16(T d)
    {
        if (d < (1 << 7)) {
            /* fixnum */
            char buf = take8_16(d);
    ...
    template <typename Stream> template <typename T> inline void packer<Stream>::pack_imp_uint32(T d)
    {
        if (d < (1 << 8)) {
            if (d < (1 << 7)) {
                /* fixnum */
    ...
    template <typename Stream> template <typename T> inline void packer<Stream>::pack_imp_uint64(T d)
    {
        if (d < (1ULL << 8)) {
            if (d < (1ULL << 7)) {
                /* fixnum */
    ...
    template <typename Stream> template <typename T> inline void packer<Stream>::pack_imp_int8(T d)
    {
        if (d < -(1 << 5)) {
            /* signed 8 */
            char buf[2] = { static_cast<char>(0xd0u), take8_8(d) };
    ...
    template <typename Stream> template <typename T> inline void packer<Stream>::pack_imp_int16(T d)
    {
        if (d < -(1 << 5)) {
            if (d < -(1 << 7)) {
                /* signed 16 */
    ...
    template <typename Stream> template <typename T> inline void packer<Stream>::pack_imp_int32(T d)
    {
        if (d < -(1 << 5)) {
            if (d < -(1 << 15)) {
                /* signed 32 */
    ...
    template <typename Stream> template <typename T> inline void packer<Stream>::pack_imp_int64(T d)
    {
        if (d < -(1LL << 5)) {
            if (d < -(1LL << 15)) {
                if (d < -(1LL << 31)) {
