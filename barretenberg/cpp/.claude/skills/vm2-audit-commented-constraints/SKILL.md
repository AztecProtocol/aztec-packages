...
- **ID**: `vm2-audit-commented-constraints-filename-123-issue-type` (MUST use full skill name: `vm2-audit-commented-constraints`)
...
Write a `vm2-audit-commented-constraints.json` file to the output directory with:
