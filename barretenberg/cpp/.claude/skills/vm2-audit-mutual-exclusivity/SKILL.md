...
#### Finding vm2-audit-mutual-exclusivity-[file]-[line]-[subtype] [SEVERITY]
...
{
  "skill": "vm2-audit-mutual-exclusivity",
  "finding_prefix": "vm2-audit-mutual-exclusivity",
  "status": "COMPLETED_WITH_FINDINGS | COMPLETED_NO_FINDINGS | ERROR",
  "target": "pil/vm2",
  "files_scanned": 0,
  "findings": [
    {
      "id": "vm2-audit-mutual-exclusivity-filename-line-subtype",
...
- Format: `vm2-audit-mutual-exclusivity-[filename]-[line]-[subtype]`
- Example: `vm2-audit-mutual-exclusivity-alu-123-SEL`
