...
- **ID**: `vm2-audit-first-row-special-cases-filename-123-issue-type` (MUST use full skill name: `vm2-audit-first-row-special-cases`)
...
Write a `vm2-audit-first-row-special-cases.json` file to the output directory with:
