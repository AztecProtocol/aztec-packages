...
- **ID**: `vm2-audit-missing-initialization-filename-123-issue-type` (MUST use full skill name: `vm2-audit-missing-initialization`)
...
Write a `vm2-audit-missing-initialization.json` file to the output directory with:
