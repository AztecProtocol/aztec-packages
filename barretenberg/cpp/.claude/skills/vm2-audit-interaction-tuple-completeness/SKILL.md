...
- **ID**: `vm2-audit-interaction-tuple-completeness-filename-123-issue-type` (MUST use full skill name: `vm2-audit-interaction-tuple-completeness`)
...
Write a `vm2-audit-interaction-tuple-completeness.json` file to the output directory with:
...
```json
{
  ...
  "findings": [
    {
      "id": "vm2-audit-interaction-tuple-completeness-filename-123-issue-type",
      "severity": "critical",
