...
EOF
  exit 0
    ...
    BOOTSTRAP_TO=yarn-project $root/bootstrap.sh # bootstrap aztec-packages from root
    $root/yarn-project/end-to-end/bootstrap.sh build_bench # build bench to generate IVC inputs
