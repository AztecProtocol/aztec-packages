...
function(barretenberg_module_with_sources MODULE_NAME)
    ...
    if(TEST_SOURCE_FILES AND NOT FUZZING)
        ...
        if(NOT WASM)
            ...
            # Use longer timeout for macOS (Gatekeeper verification on first run)
            if(APPLE)
                set(_discovery_timeout 30)
            else()
                set(_discovery_timeout 5)
            endif()
            gtest_discover_tests(${MODULE_NAME}_tests WORKING_DIRECTORY ${CMAKE_BINARY_DIR} TEST_FILTER -*_SKIP_CI* DISCOVERY_TIMEOUT ${_discovery_timeout})
        endif()
    endif()
