...
//pol commit sel_opcode_error;               // From execution.pil

// rop[0]: addressOffset
// rop[1]: dstOffset
// rop[1]: memberEnum
// register[0]: M[addressOffset} aka address (input - read from memory by execution)
// register[1]: M[dstOffset] aka exists (output - written to memory by execution)
// M[rop[1]+1]: M[dstOffset+1] aka memberValue (output - written to memory *manually* here)
...
#### 2. Contract Instance Retrieval Interface (core gadget)
```pil
// Lookup Interface to Contract Instance Retrieval - for use by execution/opcode and bc retrieval
sel {
    ...
    contract_instance_retrieval.exists // does the contract address nullifier exist
};
...
```pil
// Similar to current interactions in bc retrieval
...
contract_instance_retrieval.sel {
    ...
    contract_instance_retrieval.address, // the deployment nullifier
...
contract_instance_retrieval.nullifier_exists {
    contract_instance_retrieval.address,
    contract_instance_retrieval.salt, // hinted
    contract_instance_retrieval.deployer_addr,
    contract_instance_retrieval.original_class_id,
    contract_instance_retrieval.init_hash,
    contract_instance_retrieval.nullifier_key_x,
    contract_instance_retrieval.nullifier_key_y,
    contract_instance_retrieval.incoming_viewing_key_x,
    contract_instance_retrieval.incoming_viewing_key_y,
    contract_instance_retrieval.outgoing_viewing_key_x,
    contract_instance_retrieval.outgoing_viewing_key_y,
    contract_instance_retrieval.tagging_key_x,
    contract_instance_retrieval.tagging_key_y
} in address_derivation.sel {
    address_derivation.address,
    address_derivation.salt,
    address_derivation.deployer_addr,
    address_derivation.original_class_id,
...
// Contract update validation check (only when nullifier exists)
#[UPDATE_CHECK]
contract_instance_retrieval.nullifier_exists {
    contract_instance_retrieval.address,
    contract_instance_retrieval.current_class_id,
