...
fn test_pedersen_hash_basic() {
    ...
    let inputs = vec![Fr::from_u64(1).to_buffer(), Fr::from_u64(2).to_buffer()];
...
fn test_pedersen_hash_deterministic() {
    ...
    let inputs = vec![Fr::from_u64(42).to_buffer(), Fr::from_u64(123).to_buffer()];
...
fn test_pedersen_hash_different_inputs() {
    ...
    let inputs1 = vec![Fr::from_u64(1).to_buffer(), Fr::from_u64(2).to_buffer()];
