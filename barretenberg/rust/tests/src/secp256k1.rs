...
//! These tests verify the secp256k1 elliptic curve API compatibility.
//!
//! These tests require the BB binary to be built. They are skipped if the binary is not found.

#[cfg(test)]
use barretenberg_rs::{backends::PipeBackend, generated_types::Secp256k1Point, BarretenbergApi};
#[cfg(test)]
