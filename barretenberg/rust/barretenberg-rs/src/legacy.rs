...
use crate::generated::bb_types::{
    Bn254FqSqrtResponse, Bn254FrSqrtResponse, Bn254G1MulResponse, Bn254G1Point, Bn254G2MulResponse,
    Bn254G2Point, EcdsaSecp256k1ComputePublicKeyResponse, EcdsaSecp256k1ConstructSignatureResponse,
    EcdsaSecp256r1ComputePublicKeyResponse, EcdsaSecp256r1ConstructSignatureResponse, Fq, Fr,
    GrumpkinBatchMulResponse, GrumpkinMulResponse, GrumpkinPoint, PedersenCommitResponse,
    PedersenHashResponse, Poseidon2HashResponse, Poseidon2PermutationResponse,
    SchnorrComputePublicKeyResponse, SchnorrConstructSignatureResponse, Secp256k1Fr,
    Secp256k1MulResponse, Secp256k1Point, Secp256r1Fr,
};
...
impl<B: Backend> BarretenbergApi<B> {
    ...
    pub fn grumpkin_mul(
        ...
        self.0.grumpkin_mul(point, to_fq_array(scalar))
    }

    pub fn grumpkin_batch_mul(
        &mut self,
        points: Vec<GrumpkinPoint>,
        scalar: &[u8],
    ) -> Result<GrumpkinBatchMulResponse> {
        self.0.grumpkin_batch_mul(points, to_fq_array(scalar))
    }
    ...
    pub fn secp256k1_mul(
        ...
        self.0.secp256k1_mul(point, to_secp256k1_fr(scalar))
    }
    ...
    pub fn bn254_g1_mul(
        ...
        self.0.bn254_g1_mul(point, to_fr_array(scalar))
    }
    ...
    pub fn bn254_g2_mul(
        ...
        self.0.bn254_g2_mul(point, to_fr_array(scalar))
    }

    pub fn schnorr_compute_public_key(
        &mut self,
        private_key: &[u8],
    ) -> Result<SchnorrComputePublicKeyResponse> {
        self.0.schnorr_compute_public_key(to_fq_array(private_key))
    }
    ...
    pub fn schnorr_construct_signature(
        ...
        self.0
            .schnorr_construct_signature(message, to_fq_array(private_key))
    }

    pub fn ecdsa_secp256k1_compute_public_key(
        &mut self,
        private_key: &[u8],
    ) -> Result<EcdsaSecp256k1ComputePublicKeyResponse> {
        self.0
    ...
    pub fn ecdsa_secp256r1_compute_public_key(
        &mut self,
        private_key: &[u8],
    ) -> Result<EcdsaSecp256r1ComputePublicKeyResponse> {
        self.0
