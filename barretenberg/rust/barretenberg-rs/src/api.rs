...
/// Barretenberg API - works with any backend implementation
///
/// # Example
///
/// ```ignore
...
impl<B: Backend> BarretenbergApi<B> {
    /// Create a new API instance with the given backend
    ...
    pub fn circuit_prove(&mut self, circuit: CircuitInput, witness: Vec<u8>, settings: ProofSystemSettings) -> Result<CircuitProveResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected CircuitProveResponse".to_string())),
        }
    }
    ...
    pub fn circuit_compute_vk(&mut self, circuit: CircuitInputNoVK, settings: ProofSystemSettings) -> Result<CircuitComputeVkResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected CircuitComputeVkResponse".to_string())),
        }
    }
    ...
    pub fn circuit_stats(&mut self, circuit: CircuitInput, include_gates_per_opcode: bool, settings: ProofSystemSettings) -> Result<CircuitInfoResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected CircuitInfoResponse".to_string())),
        }
    }
    ...
    pub fn circuit_verify(&mut self, verification_key: Vec<u8>, public_inputs: Vec<Vec<u8>>, proof: Vec<Vec<u8>>, settings: ProofSystemSettings) -> Result<CircuitVerifyResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected CircuitVerifyResponse".to_string())),
        }
    }
    ...
    pub fn client_ivc_compute_standalone_vk(&mut self, circuit: CircuitInputNoVK) -> Result<ClientIvcComputeStandaloneVkResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected ClientIvcComputeStandaloneVkResponse".to_string())),
        }
    }
    ...
    pub fn client_ivc_compute_ivc_vk(&mut self, circuit: CircuitInputNoVK) -> Result<ClientIvcComputeIvcVkResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected ClientIvcComputeIvcVkResponse".to_string())),
        }
    }
    ...
    pub fn client_ivc_start(&mut self, num_circuits: u64) -> Result<ClientIvcStartResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected ClientIvcStartResponse".to_string())),
        }
    }
    ...
    pub fn client_ivc_load(&mut self, circuit: CircuitInput) -> Result<ClientIvcLoadResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected ClientIvcLoadResponse".to_string())),
        }
    }
    ...
    pub fn client_ivc_accumulate(&mut self, witness: Vec<u8>) -> Result<ClientIvcAccumulateResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected ClientIvcAccumulateResponse".to_string())),
        }
    }
    ...
    pub fn client_ivc_prove(&mut self, ) -> Result<ClientIvcProveResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected ClientIvcProveResponse".to_string())),
        }
    }
    ...
    pub fn client_ivc_verify(&mut self, proof: ClientIVCProof, vk: Vec<u8>) -> Result<ClientIvcVerifyResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected ClientIvcVerifyResponse".to_string())),
        }
    }
    ...
    pub fn vk_as_fields(&mut self, verification_key: Vec<u8>) -> Result<VkAsFieldsResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected VkAsFieldsResponse".to_string())),
        }
    }
    ...
    pub fn mega_vk_as_fields(&mut self, verification_key: Vec<u8>) -> Result<MegaVkAsFieldsResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected MegaVkAsFieldsResponse".to_string())),
        }
    }
    ...
    pub fn circuit_write_solidity_verifier(&mut self, verification_key: Vec<u8>, settings: ProofSystemSettings) -> Result<CircuitWriteSolidityVerifierResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected CircuitWriteSolidityVerifierResponse".to_string())),
        }
    }
    ...
    pub fn client_ivc_check_precomputed_vk(&mut self, circuit: CircuitInput) -> Result<ClientIvcCheckPrecomputedVkResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected ClientIvcCheckPrecomputedVkResponse".to_string())),
        }
    }
    ...
    pub fn client_ivc_stats(&mut self, circuit: CircuitInputNoVK, include_gates_per_opcode: bool) -> Result<ClientIvcStatsResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected ClientIvcStatsResponse".to_string())),
        }
    }
    ...
    pub fn poseidon2_hash(&mut self, inputs: Vec<Vec<u8>>) -> Result<Poseidon2HashResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected Poseidon2HashResponse".to_string())),
        }
    }
    ...
    pub fn poseidon2_permutation(&mut self, inputs: [Vec<u8>; 4]) -> Result<Poseidon2PermutationResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected Poseidon2PermutationResponse".to_string())),
        }
    }
    ...
    pub fn poseidon2_hash_accumulate(&mut self, inputs: Vec<Vec<u8>>) -> Result<Poseidon2HashAccumulateResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected Poseidon2HashAccumulateResponse".to_string())),
        }
    }
    ...
    pub fn pedersen_commit(&mut self, inputs: Vec<Vec<u8>>, hash_index: u32) -> Result<PedersenCommitResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected PedersenCommitResponse".to_string())),
        }
    }
    ...
    pub fn pedersen_hash(&mut self, inputs: Vec<Vec<u8>>, hash_index: u32) -> Result<PedersenHashResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected PedersenHashResponse".to_string())),
        }
    }
    ...
    pub fn pedersen_hash_buffer(&mut self, input: Vec<u8>, hash_index: u32) -> Result<PedersenHashBufferResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected PedersenHashBufferResponse".to_string())),
        }
    }
    ...
    pub fn blake2s(&mut self, data: Vec<u8>) -> Result<Blake2sResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected Blake2sResponse".to_string())),
        }
    }
    ...
    pub fn blake2s_to_field(&mut self, data: Vec<u8>) -> Result<Blake2sToFieldResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected Blake2sToFieldResponse".to_string())),
        }
    }
    ...
    pub fn aes_encrypt(&mut self, plaintext: Vec<u8>, iv: Vec<u8>, key: Vec<u8>, length: u32) -> Result<AesEncryptResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected AesEncryptResponse".to_string())),
        }
    }
    ...
    pub fn aes_decrypt(&mut self, ciphertext: Vec<u8>, iv: Vec<u8>, key: Vec<u8>, length: u32) -> Result<AesDecryptResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected AesDecryptResponse".to_string())),
        }
    }
    ...
    pub fn grumpkin_mul(&mut self, point: AffineElement, scalar: Vec<u8>) -> Result<GrumpkinMulResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected GrumpkinMulResponse".to_string())),
        }
    }
    ...
    pub fn grumpkin_add(&mut self, point_a: AffineElement, point_b: AffineElement) -> Result<GrumpkinAddResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected GrumpkinAddResponse".to_string())),
        }
    }
    ...
    pub fn grumpkin_batch_mul(&mut self, points: Vec<AffineElement>, scalar: Vec<u8>) -> Result<GrumpkinBatchMulResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected GrumpkinBatchMulResponse".to_string())),
        }
    }
    ...
    pub fn grumpkin_get_random_fr(&mut self, dummy: u8) -> Result<GrumpkinGetRandomFrResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected GrumpkinGetRandomFrResponse".to_string())),
        }
    }
    ...
    pub fn grumpkin_reduce512(&mut self, input: Vec<u8>) -> Result<GrumpkinReduce512Response> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected GrumpkinReduce512Response".to_string())),
        }
    }
    ...
    pub fn secp256k1_mul(&mut self, point: AffineElement, scalar: Vec<u8>) -> Result<Secp256k1MulResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected Secp256k1MulResponse".to_string())),
        }
    }
    ...
    pub fn secp256k1_get_random_fr(&mut self, dummy: u8) -> Result<Secp256k1GetRandomFrResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected Secp256k1GetRandomFrResponse".to_string())),
        }
    }
    ...
    pub fn secp256k1_reduce512(&mut self, input: Vec<u8>) -> Result<Secp256k1Reduce512Response> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected Secp256k1Reduce512Response".to_string())),
        }
    }
    ...
    pub fn bn254_fr_sqrt(&mut self, input: Vec<u8>) -> Result<Bn254FrSqrtResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected Bn254FrSqrtResponse".to_string())),
        }
    }
    ...
    pub fn schnorr_compute_public_key(&mut self, private_key: Vec<u8>) -> Result<SchnorrComputePublicKeyResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected SchnorrComputePublicKeyResponse".to_string())),
        }
    }
    ...
    pub fn schnorr_construct_signature(&mut self, message: Vec<u8>, private_key: Vec<u8>) -> Result<SchnorrConstructSignatureResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected SchnorrConstructSignatureResponse".to_string())),
        }
    }
    ...
    pub fn schnorr_verify_signature(&mut self, message: Vec<u8>, public_key: AffineElement, s: Vec<u8>, e: Vec<u8>) -> Result<SchnorrVerifySignatureResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected SchnorrVerifySignatureResponse".to_string())),
        }
    }
    ...
    pub fn ecdsa_secp256k1_compute_public_key(&mut self, private_key: Vec<u8>) -> Result<EcdsaSecp256k1ComputePublicKeyResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected EcdsaSecp256k1ComputePublicKeyResponse".to_string())),
        }
    }
    ...
    pub fn ecdsa_secp256r1_compute_public_key(&mut self, private_key: Vec<u8>) -> Result<EcdsaSecp256r1ComputePublicKeyResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected EcdsaSecp256r1ComputePublicKeyResponse".to_string())),
        }
    }
    ...
    pub fn ecdsa_secp256k1_construct_signature(&mut self, message: Vec<u8>, private_key: Vec<u8>) -> Result<EcdsaSecp256k1ConstructSignatureResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected EcdsaSecp256k1ConstructSignatureResponse".to_string())),
        }
    }
    ...
    pub fn ecdsa_secp256r1_construct_signature(&mut self, message: Vec<u8>, private_key: Vec<u8>) -> Result<EcdsaSecp256r1ConstructSignatureResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected EcdsaSecp256r1ConstructSignatureResponse".to_string())),
        }
    }
    ...
    pub fn ecdsa_secp256k1_recover_public_key(&mut self, message: Vec<u8>, r: Vec<u8>, s: Vec<u8>, v: u8) -> Result<EcdsaSecp256k1RecoverPublicKeyResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected EcdsaSecp256k1RecoverPublicKeyResponse".to_string())),
        }
    }
    ...
    pub fn ecdsa_secp256r1_recover_public_key(&mut self, message: Vec<u8>, r: Vec<u8>, s: Vec<u8>, v: u8) -> Result<EcdsaSecp256r1RecoverPublicKeyResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected EcdsaSecp256r1RecoverPublicKeyResponse".to_string())),
        }
    }
    ...
    pub fn ecdsa_secp256k1_verify_signature(&mut self, message: Vec<u8>, public_key: AffineElement, r: Vec<u8>, s: Vec<u8>, v: u8) -> Result<EcdsaSecp256k1VerifySignatureResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected EcdsaSecp256k1VerifySignatureResponse".to_string())),
        }
    }
    ...
    pub fn ecdsa_secp256r1_verify_signature(&mut self, message: Vec<u8>, public_key: AffineElement, r: Vec<u8>, s: Vec<u8>, v: u8) -> Result<EcdsaSecp256r1VerifySignatureResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected EcdsaSecp256r1VerifySignatureResponse".to_string())),
        }
    }
    ...
    pub fn srs_init_srs(&mut self, points_buf: Vec<u8>, num_points: u32, g2_point: Vec<u8>) -> Result<SrsInitSrsResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected SrsInitSrsResponse".to_string())),
        }
    }
    ...
    pub fn srs_init_grumpkin_srs(&mut self, points_buf: Vec<u8>, num_points: u32) -> Result<SrsInitGrumpkinSrsResponse> {
        ...
        match self.execute(cmd)? {
            ...
            _ => Err(BarretenbergError::InvalidResponse("Expected SrsInitGrumpkinSrsResponse".to_string())),
        }
    }
