...
cp build-wasm-threads/bin/barretenberg-debug.wasm.gz ../ts/dest/esm/barretenberg_wasm/barretenberg-threads.wasm.gz
```
...
cp build-wasm-threads-dbg/bin/barretenberg-debug.wasm.gz ../ts/dest/esm/barretenberg_wasm/barretenberg-threads.wasm.gz
```
