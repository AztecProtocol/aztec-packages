// Resolves the native bb-avm shipped by the matching @aztec-foundation/bb-avm-<platform> package.
...
const PLATFORM_PACKAGES = {
  'linux-x64': '@aztec-foundation/bb-avm-linux-x64',
  'linux-arm64': '@aztec-foundation/bb-avm-linux-arm64',
};

export const BINARY_ENV_VAR = 'BB_AVM_BINARY_PATH';
...
export function findBinary() {
  ...
  if (!pkg) return null;
  const file = process.platform === 'win32' ? 'bb-avm.exe' : 'bb-avm';
