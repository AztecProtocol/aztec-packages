...
${packLines.join('\n')}
  ...
  // Stream-walker accumulator (design-knob variant): TPB=64 with workgroup
  // pref_scratch (KNOB 1) and precomputed task_cuts (KNOB 2). Same field /
  // batched-inversion context as the streaming accumulator.
