...
export const smvp_tree_count_active = `// Counts the number of distinct contiguous bucket runs in
...
export const smvp_tree_layer_batch_inverse = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
{{> fr_pow_funcs }}
...
export const smvp_tree_layer_prelude = `// Tree-reduce per-layer prelude. Replaces the host's
...
export const smvp_tree_layer_scan = `// Tree-reduce per-layer scan + dispatch-args writer.
//
// Inputs:
...
export const smvp_tree_phase1_a = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
{{> fr_pow_funcs }}
...
export const smvp_tree_phase1_d = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
{{> fr_pow_funcs }}
...
export const smvp_tree_phase2_a = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
{{> fr_pow_funcs }}
...
export const smvp_tree_phase2_d = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
{{> fr_pow_funcs }}
...
// Phase 2-D of the tree-reduce SMVP (iter 4 — layer-wide batch inverse).
// Sister of \`smvp_tree_phase1_d\` for layers L >= 1. Re-runs Phase B
// locally over the spilled per-thread block_totals to derive the
// exclusive prefix/suffix, then runs the Phase D back-walk + UNPAIRED
// write-out. Uses the per-WG inverse produced by
// \`smvp_tree_layer_batch_inverse\`.
...
export const smvp_tree_scatter_args = `// Computes the scatter dispatch geometry from the final tree-reduce
