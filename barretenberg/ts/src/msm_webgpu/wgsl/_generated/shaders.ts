...
export const ba_reduce_fused_bench = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
{{> fr_pow_funcs }}
...
export const demont_scalars = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
...
export const straus_combine_fold_bn254 = `// straus_combine tree-fold pass for BN254 G1.
//
...
export const straus_lookup_precompute_bn254 = `// straus_msm lookup-precompute kernel for BN254 G1 — **window-shifted**
...
export const straus_main_bn254 = `// straus_main kernel for BN254 G1 — per-thread small MSM over a chunk of
...
export const straus_to_affine_bn254 = `// Final Jacobian → affine conversion for the straus_msm WebGPU port.
//
