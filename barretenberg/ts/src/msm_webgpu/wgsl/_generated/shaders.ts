...
fn montgomery_product_f8(x: array<u32, 8>, y: array<u32, 8>) -> array<u32, 8> {
    ...
    // Relaxed->strict carry-normalise s0..s17 in place (no carry register);
    // s18 stays wide (low 13 = limb 18, high = top carry = limb 19).
    ...
    // Pack the strict limbs into 8x u32 (limbs 18 & 19 read from the wide s18).
    var out: array<u32, 8>;
