...
export const batch_test = `// GPU batch_over_relations: reduce the flat 345-Fr per-edge-summed relation
...
export const fold_test = `// Test kernel: sumcheck fold (partially_evaluate). Halves every polynomial
...
export const gate_separator_gather_test = `// Gate-separator per-round edge-scaling gather. The relation accumulate kernels
...
export const gate_separator_scan_test = `// Gate-separator beta_products scan (polynomials/gate_separator.hpp). Builds the
...
export const poseidon2_transcript_par_test = `// Lane-parallel variant of poseidon2_transcript_test: identical math and bindings,
...
export const poseidon2_transcript_test = `// GPU Fiat-Shamir for sumcheck: derive a round challenge from the round univariate
...
export const reduce_test = `// Test kernel: edge reduction for the sumcheck accumulate. Sums a relation's
