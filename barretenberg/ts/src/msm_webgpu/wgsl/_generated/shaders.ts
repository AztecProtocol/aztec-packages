...
export const ba_walker_pt_coop_tail = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
{{> fr_pow_funcs }}
...
export const ba_walker_pt_dispatch_chain = `// Pair-tree v3: chained dispatch_compute, with cooperative-tail switchover.
//
