...
export const batch_affine_tree_finalize = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
...
export const batch_affine_tree_finalize_apply = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
...
export const smvp_tree_meta_phase1 = `// Tree-reduce Phase 1 metadata kernel. Extracts Steps 1-6 of the
...
export const smvp_tree_meta_phase2 = `// Tree-reduce Phase 2 metadata kernel. Companion to
