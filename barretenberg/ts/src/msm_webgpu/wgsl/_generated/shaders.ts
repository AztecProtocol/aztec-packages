...
export const ba_walker_combine_pairtree = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
{{> fr_pow_funcs }}
...
export const ba_walker_pt_chunk_build = `// Chunk-pass: emit chunk descriptors for buckets with count > 1.
//
...
export const ba_walker_pt_chunk_combine = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
{{> fr_pow_funcs }}
...
export const ba_walker_pt_combine = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
{{> fr_pow_funcs }}
...
export const ba_walker_pt_dispatch = `// Pair-tree v2: write pt_combine's indirect dispatch args.
//
...
export const ba_walker_pt_finalize = `// Pair-tree v2: write each hot bucket's final partial to bucket_sums.
//
...
export const ba_walker_pt_packer = `// Persistent kernel preprocessor — assigns hot buckets to workgroups via
...
export const ba_walker_pt_persistent = `{{> structs }}
{{> bigint_funcs }}
{{> montgomery_product_funcs }}
{{> field_funcs }}
{{> fr_pow_funcs }}
