...
export const transpose_parallel_count_priv = `// Parallel transpose — Phase 1 of 3: count nonzeros per column.
//
...
export const transpose_parallel_scatter_priv = `// Parallel transpose — Phase 3 of 3: scatter point indices into CSC slots.
//
