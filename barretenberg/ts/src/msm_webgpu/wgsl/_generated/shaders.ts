...
export const ec_bn254_f32 = `// 23-bit f32 mirror of \`ec_bn254.template.wgsl\`. Jacobian-coordinate EC
...
export const batch_affine_apply_f32 = `// 23-bit f32 mirror of \`batch_affine_apply.template.wgsl\`. Parallel
...
export const batch_affine_apply_scatter_f32 = `// 23-bit f32 mirror of \`batch_affine_apply_scatter.template.wgsl\`.
...
export const batch_affine_dispatch_args_f32 = `// Per-round indirect-dispatch argument writer for the batch-affine f32
...
export const batch_affine_finalize_apply_f32 = `// 23-bit f32 mirror of \`batch_affine_finalize_apply.template.wgsl\`.
...
export const batch_affine_finalize_collect_f32 = `// 23-bit f32 mirror of \`batch_affine_finalize_collect.template.wgsl\`.
...
export const batch_affine_finalize_f32 = `// 23-bit f32 mirror of \`batch_affine_finalize.template.wgsl\`.
...
export const batch_affine_init_f32 = `// 23-bit f32 mirror of \`batch_affine_init.template.wgsl\`. Wire format
...
export const batch_affine_schedule_f32 = `// 23-bit f32 mirror of \`batch_affine_schedule.template.wgsl\`.
//
...
export const batch_inverse_f32 = `// 23-bit f32 mirror of \`batch_inverse.template.wgsl\`. Montgomery's
...
export const batch_inverse_parallel_f32 = `// 23-bit f32 mirror of \`batch_inverse_parallel.template.wgsl\`. Parallel
...
export const bpr_bn254_f32 = `// 23-bit f32 mirror of \`bpr_bn254.template.wgsl\`. Parallel bucket
...
export const decompress_g1_bn254_f32 = `// 23-bit f32 mirror of \`decompress_g1_bn254.template.wgsl\`. Decompresses
...
export const horner_reduce_bn254_f32 = `// 23-bit f32 mirror of \`horner_reduce_bn254.template.wgsl\`. Per-subtask
...
export const smvp_bn254_f32 = `// 23-bit f32 mirror of \`smvp_bn254.template.wgsl\`. SMVP per-bucket
...
export const field_f32 = `// 23-bit f32 mirror of \`field.template.wgsl\`. Inputs/outputs are in
...
export const fr_pow_f32 = `// 23-bit f32 mirror of \`fr_pow.template.wgsl\`. All values are in
...
export const mont_pro_product_f32 = `// W, W_INV, BIAS come from \`mulhilo.wgsl\` — do not redeclare here.
...
export const mont_pro_product_f32_19_sos3cf = `// 19-bit-limb Mont product. SOS structure, deferred drain.
//
...
export const mont_pro_product_f32_19_sos3uv3cf = `// 19-bit-limb f32 Montgomery product — sos3uv3 SHAPE without per-iter drain.
...
export const mont_pro_product_f32_22 = `// 22-bit-limb variant of \`mont_pro_product_f32.template.wgsl\`. Same
...
export const mont_pro_product_f32_22_sos3 = `// 22-bit-limb f32 Montgomery product, SOS3 variant: 3-FMA mulhilo with a
...
export const mont_pro_product_f32_22_sos3u = `// 22-bit-limb f32 Montgomery product, SOS3-UNROLLED variant.
//
...
export const mont_pro_product_f32_22_sos3u32 = `// 22-bit-limb f32 Montgomery product with i32 accumulators — breaks the
...
export const mont_pro_product_f32_22_sos3uv2 = `// 22-bit-limb f32 Montgomery product, sos3u v2.
//
...
export const mont_pro_product_f32_22_sos3wasm = `// 22-bit-limb f32 Montgomery product, WASM-style: SOS structure with i32
...
export const mont_pro_product_f32_22_unrolled = `// 22-bit-limb f32 Montgomery product, UNROLLED variant of V1.
//
...
export const mont_pro_product_f32_22_v2 = `// 22-bit-limb f32 Montgomery product, V2: wide column accumulator
...
export const mont_pro_product_f32_sos = `// 22-bit-limb f32 Montgomery product in SOS (Separated Operand Scanning)
...
export const mulhilo = `// Branchless 23-bit hi/lo split of an integer product, in f32 FMA.
//
