...
import {
  ...
  ProofAsFields,
  ProofAsFieldsResponse,
  VkAsFields,
  VkAsFieldsResponse,
  CircuitWriteSolidityVerifier,
  CircuitWriteSolidityVerifierResponse,
  CircuitProveAndVerify,
  CircuitProveAndVerifyResponse,
  CircuitBenchmark,
  CircuitBenchmarkResponse,
  ClientIvcCheckPrecomputedVk,
  ClientIvcCheckPrecomputedVkResponse,
  fromCircuitBenchmark,
  fromCircuitCheck,
  fromCircuitComputeVk,
  fromCircuitInfo,
  fromCircuitProve,
  fromCircuitProveAndVerify,
  fromCircuitVerify,
  fromCircuitWriteSolidityVerifier,
  fromClientIvcAccumulate,
  fromClientIvcCheckPrecomputedVk,
  fromClientIvcComputeIvcVk,
  fromClientIvcComputeStandaloneVk,
  fromClientIvcLoad,
  fromClientIvcProve,
  fromClientIvcStart,
  fromProofAsFields,
  fromVkAsFields,
  toCircuitBenchmarkResponse,
  toCircuitCheckResponse,
  toCircuitComputeVkResponse,
  toCircuitInfoResponse,
  toCircuitProveAndVerifyResponse,
  toCircuitProveResponse,
  toCircuitVerifyResponse,
  toCircuitWriteSolidityVerifierResponse,
  toClientIvcAccumulateResponse,
  toClientIvcCheckPrecomputedVkResponse,
  toClientIvcComputeIvcVkResponse,
  toClientIvcComputeStandaloneVkResponse,
  toClientIvcLoadResponse,
  toClientIvcProveResponse,
  toClientIvcStartResponse,
  toProofAsFieldsResponse,
  toVkAsFieldsResponse,
} from './api_types.js';
...
export class NativeApi {
  ...
  async clientIvcStart(command: ClientIvcStart): Promise<ClientIvcStartResponse> {
    ...
    console.log([variantName, result]);
