// AUTO-GEN float-limb FP32 multiply B=22-bit (NL=12), deferred-carry G=1.
// 16 independent unrolled multiplies, distinct buffer operands+outputs (arith-bound).

const CHI: f32 = 35184372088832.0;
const CN: f32 = 52776558133248.0;
const RINV: f32 = 2.384185791015625e-7;
const R: f32 = 4194304.0;
...
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
  ...
  { // multiply #0
    ...
    let m0_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m0_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m0_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m0_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m0_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m0_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m0_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m0_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m0_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m0_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m0_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m0_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m0_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m0_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m0_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m0_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m0_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m0_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m0_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m0_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m0_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m0_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m0_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m0_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
    ...
    { let du = u32(c1); o0 = o0 | (du << 22u); o1 = o1 | (du >> 10u); }
    { let du = u32(c2); o1 = o1 | (du << 12u); o2 = o2 | (du >> 20u); }
    { let du = u32(c3); o2 = o2 | (du << 2u); }
    { let du = u32(c4); o2 = o2 | (du << 24u); o3 = o3 | (du >> 8u); }
    { let du = u32(c5); o3 = o3 | (du << 14u); o4 = o4 | (du >> 18u); }
    { let du = u32(c6); o4 = o4 | (du << 4u); }
    { let du = u32(c7); o4 = o4 | (du << 26u); o5 = o5 | (du >> 6u); }
    { let du = u32(c8); o5 = o5 | (du << 16u); o6 = o6 | (du >> 16u); }
    { let du = u32(c9); o6 = o6 | (du << 6u); }
    { let du = u32(c10); o6 = o6 | (du << 28u); o7 = o7 | (du >> 4u); }
    { let du = u32(c11); o7 = o7 | (du << 18u); }
  ...
  { // multiply #1
    ...
    let m1_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m1_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m1_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m1_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m1_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m1_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m1_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m1_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m1_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m1_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m1_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m1_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m1_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m1_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m1_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m1_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m1_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m1_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m1_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m1_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m1_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m1_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m1_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m1_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #2
    ...
    let m2_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m2_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m2_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m2_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m2_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m2_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m2_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m2_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m2_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m2_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m2_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m2_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m2_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m2_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m2_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m2_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m2_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m2_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m2_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m2_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m2_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m2_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m2_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m2_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #3
    ...
    let m3_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m3_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m3_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m3_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m3_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m3_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m3_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m3_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m3_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m3_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m3_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m3_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m3_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m3_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m3_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m3_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m3_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m3_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m3_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m3_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m3_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m3_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m3_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m3_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #4
    ...
    let m4_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m4_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m4_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m4_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m4_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m4_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m4_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m4_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m4_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m4_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m4_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m4_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m4_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m4_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m4_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m4_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m4_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m4_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m4_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m4_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m4_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m4_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m4_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m4_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #5
    ...
    let m5_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m5_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m5_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m5_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m5_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m5_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m5_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m5_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m5_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m5_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m5_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m5_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m5_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m5_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m5_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m5_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m5_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m5_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m5_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m5_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m5_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m5_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m5_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m5_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #6
    ...
    let m6_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m6_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m6_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m6_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m6_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m6_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m6_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m6_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m6_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m6_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m6_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m6_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m6_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m6_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m6_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m6_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m6_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m6_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m6_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m6_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m6_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m6_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m6_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m6_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #7
    ...
    let m7_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m7_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m7_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m7_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m7_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m7_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m7_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m7_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m7_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m7_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m7_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m7_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m7_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m7_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m7_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m7_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m7_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m7_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m7_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m7_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m7_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m7_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m7_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m7_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #8
    ...
    let m8_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m8_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m8_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m8_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m8_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m8_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m8_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m8_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m8_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m8_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m8_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m8_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m8_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m8_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m8_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m8_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m8_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m8_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m8_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m8_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m8_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m8_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m8_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m8_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #9
    ...
    let m9_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m9_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m9_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m9_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m9_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m9_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m9_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m9_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m9_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m9_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m9_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m9_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m9_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m9_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m9_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m9_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m9_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m9_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m9_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m9_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m9_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m9_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m9_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m9_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #10
    ...
    let m10_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m10_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m10_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m10_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m10_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m10_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m10_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m10_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m10_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m10_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m10_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m10_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m10_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m10_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m10_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m10_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m10_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m10_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m10_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m10_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m10_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m10_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m10_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m10_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #11
    ...
    let m11_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m11_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m11_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m11_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m11_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m11_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m11_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m11_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m11_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m11_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m11_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m11_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m11_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m11_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m11_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m11_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m11_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m11_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m11_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m11_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m11_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m11_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m11_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m11_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #12
    ...
    let m12_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m12_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m12_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m12_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m12_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m12_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m12_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m12_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m12_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m12_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m12_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m12_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m12_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m12_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m12_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m12_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m12_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m12_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m12_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m12_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m12_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m12_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m12_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m12_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #13
    ...
    let m13_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m13_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m13_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m13_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m13_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m13_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m13_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m13_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m13_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m13_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m13_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m13_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m13_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m13_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m13_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m13_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m13_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m13_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m13_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m13_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m13_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m13_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m13_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m13_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #14
    ...
    let m14_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m14_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m14_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m14_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m14_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m14_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m14_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m14_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m14_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m14_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m14_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m14_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m14_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m14_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m14_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m14_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m14_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m14_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m14_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m14_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m14_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m14_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m14_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m14_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
  ...
  { // multiply #15
    ...
    let m15_x0 = f32((a0.x >> 0u) & 0x3fffffu);
    let m15_x1 = f32(((a0.x >> 22u) | (a0.y << 10u)) & 0x3fffffu);
    let m15_x2 = f32(((a0.y >> 12u) | (a0.z << 20u)) & 0x3fffffu);
    let m15_x3 = f32((a0.z >> 2u) & 0x3fffffu);
    let m15_x4 = f32(((a0.z >> 24u) | (a0.w << 8u)) & 0x3fffffu);
    let m15_x5 = f32(((a0.w >> 14u) | (a1.x << 18u)) & 0x3fffffu);
    let m15_x6 = f32((a1.x >> 4u) & 0x3fffffu);
    let m15_x7 = f32(((a1.x >> 26u) | (a1.y << 6u)) & 0x3fffffu);
    let m15_x8 = f32(((a1.y >> 16u) | (a1.z << 16u)) & 0x3fffffu);
    let m15_x9 = f32((a1.z >> 6u) & 0x3fffffu);
    let m15_x10 = f32(((a1.z >> 28u) | (a1.w << 4u)) & 0x3fffffu);
    let m15_x11 = f32((a1.w >> 18u) & 0x3fffffu);
    let m15_y0 = f32((b0.x >> 0u) & 0x3fffffu);
    let m15_y1 = f32(((b0.x >> 22u) | (b0.y << 10u)) & 0x3fffffu);
    let m15_y2 = f32(((b0.y >> 12u) | (b0.z << 20u)) & 0x3fffffu);
    let m15_y3 = f32((b0.z >> 2u) & 0x3fffffu);
    let m15_y4 = f32(((b0.z >> 24u) | (b0.w << 8u)) & 0x3fffffu);
    let m15_y5 = f32(((b0.w >> 14u) | (b1.x << 18u)) & 0x3fffffu);
    let m15_y6 = f32((b1.x >> 4u) & 0x3fffffu);
    let m15_y7 = f32(((b1.x >> 26u) | (b1.y << 6u)) & 0x3fffffu);
    let m15_y8 = f32(((b1.y >> 16u) | (b1.z << 16u)) & 0x3fffffu);
    let m15_y9 = f32((b1.z >> 6u) & 0x3fffffu);
    let m15_y10 = f32(((b1.z >> 28u) | (b1.w << 4u)) & 0x3fffffu);
    let m15_y11 = f32((b1.w >> 18u) & 0x3fffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
