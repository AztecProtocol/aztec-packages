// AUTO-GEN float-limb FP32 multiply B=18-bit (NL=15), deferred-carry G=31.
// 16 independent unrolled multiplies, distinct buffer operands+outputs (arith-bound).

const CHI: f32 = 2199023255552.0;
const CN: f32 = 3298534883328.0;
const RINV: f32 = 0.000003814697265625;
const R: f32 = 262144.0;
...
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
  ...
  { // multiply #0
    ...
    let m0_x0 = f32((a0.x >> 0u) & 0x3ffffu);
    let m0_x1 = f32(((a0.x >> 18u) | (a0.y << 14u)) & 0x3ffffu);
    let m0_x2 = f32((a0.y >> 4u) & 0x3ffffu);
    let m0_x3 = f32(((a0.y >> 22u) | (a0.z << 10u)) & 0x3ffffu);
    let m0_x4 = f32((a0.z >> 8u) & 0x3ffffu);
    let m0_x5 = f32(((a0.z >> 26u) | (a0.w << 6u)) & 0x3ffffu);
    let m0_x6 = f32((a0.w >> 12u) & 0x3ffffu);
    let m0_x7 = f32(((a0.w >> 30u) | (a1.x << 2u)) & 0x3ffffu);
    let m0_x8 = f32(((a1.x >> 16u) | (a1.y << 16u)) & 0x3ffffu);
    let m0_x9 = f32((a1.y >> 2u) & 0x3ffffu);
    let m0_x10 = f32(((a1.y >> 20u) | (a1.z << 12u)) & 0x3ffffu);
    let m0_x11 = f32((a1.z >> 6u) & 0x3ffffu);
    let m0_x12 = f32(((a1.z >> 24u) | (a1.w << 8u)) & 0x3ffffu);
    let m0_x13 = f32((a1.w >> 10u) & 0x3ffffu);
    let m0_x14 = f32((a1.w >> 28u) & 0x3ffffu);
    let m0_y0 = f32((b0.x >> 0u) & 0x3ffffu);
    let m0_y1 = f32(((b0.x >> 18u) | (b0.y << 14u)) & 0x3ffffu);
    let m0_y2 = f32((b0.y >> 4u) & 0x3ffffu);
    let m0_y3 = f32(((b0.y >> 22u) | (b0.z << 10u)) & 0x3ffffu);
    let m0_y4 = f32((b0.z >> 8u) & 0x3ffffu);
    let m0_y5 = f32(((b0.z >> 26u) | (b0.w << 6u)) & 0x3ffffu);
    let m0_y6 = f32((b0.w >> 12u) & 0x3ffffu);
    let m0_y7 = f32(((b0.w >> 30u) | (b1.x << 2u)) & 0x3ffffu);
    let m0_y8 = f32(((b1.x >> 16u) | (b1.y << 16u)) & 0x3ffffu);
    let m0_y9 = f32((b1.y >> 2u) & 0x3ffffu);
    let m0_y10 = f32(((b1.y >> 20u) | (b1.z << 12u)) & 0x3ffffu);
    let m0_y11 = f32((b1.z >> 6u) & 0x3ffffu);
    let m0_y12 = f32(((b1.z >> 24u) | (b1.w << 8u)) & 0x3ffffu);
    let m0_y13 = f32((b1.w >> 10u) & 0x3ffffu);
    let m0_y14 = f32((b1.w >> 28u) & 0x3ffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
    ...
    { let t = fma(m0_x0, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x0, m0_y13, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m0_x0, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x0, m0_y14, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    ...
    { let t = fma(m0_x1, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x1, m0_y13, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m0_x1, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x1, m0_y14, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    ...
    { let t = fma(m0_x2, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x2, m0_y13, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m0_x2, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x2, m0_y14, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    ...
    { let t = fma(m0_x3, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x3, m0_y13, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m0_x3, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x3, m0_y14, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    ...
    { let t = fma(m0_x4, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x4, m0_y13, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m0_x4, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x4, m0_y14, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    ...
    { let t = fma(m0_x5, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x5, m0_y13, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m0_x5, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x5, m0_y14, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    ...
    { let t = fma(m0_x6, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x6, m0_y13, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m0_x6, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x6, m0_y14, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    ...
    { let t = fma(m0_x7, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x7, m0_y13, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m0_x7, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x7, m0_y14, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    ...
    { let t = fma(m0_x8, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x8, m0_y13, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m0_x8, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x8, m0_y14, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    ...
    { let t = fma(m0_x9, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x9, m0_y13, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m0_x9, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x9, m0_y14, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    ...
    { let t = fma(m0_x10, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x10, m0_y13, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m0_x10, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x10, m0_y14, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    ...
    { let t = fma(m0_x11, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x11, m0_y13, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m0_x11, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x11, m0_y14, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    ...
    { let t = fma(m0_x12, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x12, m0_y13, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m0_x12, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x12, m0_y14, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m0_x13, m0_y0, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y0, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m0_x13, m0_y1, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y1, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m0_x13, m0_y2, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y2, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m0_x13, m0_y3, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y3, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m0_x13, m0_y4, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y4, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m0_x13, m0_y5, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y5, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m0_x13, m0_y6, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y6, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m0_x13, m0_y7, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y7, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m0_x13, m0_y8, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y8, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m0_x13, m0_y9, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y9, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m0_x13, m0_y10, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y10, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m0_x13, m0_y11, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y11, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m0_x13, m0_y12, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y12, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m0_x13, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y13, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m0_x13, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x13, m0_y14, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m0_x14, m0_y0, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y0, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m0_x14, m0_y1, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y1, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m0_x14, m0_y2, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y2, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m0_x14, m0_y3, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y3, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m0_x14, m0_y4, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y4, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m0_x14, m0_y5, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y5, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m0_x14, m0_y6, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y6, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m0_x14, m0_y7, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y7, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m0_x14, m0_y8, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y8, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m0_x14, m0_y9, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y9, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m0_x14, m0_y10, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y10, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m0_x14, m0_y11, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y11, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m0_x14, m0_y12, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y12, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m0_x14, m0_y13, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y13, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m0_x14, m0_y14, CHI); let hi = t - CHI; let lo = fma(m0_x14, m0_y14, -hi); c28 = c28 + lo; c29 = c29 + hi * RINV; }
    ...
    { let hv = floor(c27 * RINV); c27 = c27 - hv * R; c28 = c28 + hv; }
    { let hv = floor(c28 * RINV); c28 = c28 - hv * R; c29 = c29 + hv; }
    { let hv = floor(c29 * RINV); c29 = c29 - hv * R; c30 = c30 + hv; }
    { let hv = floor(c30 * RINV); c30 = c30 - hv * R; c31 = c31 + hv; }
    var o0=0u; var o1=0u; var o2=0u; var o3=0u; var o4=0u; var o5=0u; var o6=0u; var o7=0u;
    { let du = u32(c0); o0 = o0 | (du << 0u); }
    { let du = u32(c1); o0 = o0 | (du << 18u); o1 = o1 | (du >> 14u); }
    { let du = u32(c2); o1 = o1 | (du << 4u); }
    { let du = u32(c3); o1 = o1 | (du << 22u); o2 = o2 | (du >> 10u); }
    { let du = u32(c4); o2 = o2 | (du << 8u); }
    { let du = u32(c5); o2 = o2 | (du << 26u); o3 = o3 | (du >> 6u); }
    { let du = u32(c6); o3 = o3 | (du << 12u); }
    { let du = u32(c7); o3 = o3 | (du << 30u); o4 = o4 | (du >> 2u); }
m2_y14, CHI); let hi = t - CHI; let lo = fma(m2_x11, m2_y14, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    ...
    { let t = fma(m2_x12, m2_y13, CHI); let hi = t - CHI; let lo = fma(m2_x12, m2_y13, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m2_x12, m2_y14, CHI); let hi = t - CHI; let lo = fma(m2_x12, m2_y14, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m2_x13, m2_y0, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y0, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m2_x13, m2_y1, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y1, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m2_x13, m2_y2, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y2, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m2_x13, m2_y3, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y3, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m2_x13, m2_y4, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y4, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m2_x13, m2_y5, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y5, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m2_x13, m2_y6, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y6, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m2_x13, m2_y7, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y7, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m2_x13, m2_y8, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y8, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m2_x13, m2_y9, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y9, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m2_x13, m2_y10, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y10, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m2_x13, m2_y11, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y11, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m2_x13, m2_y12, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y12, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m2_x13, m2_y13, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y13, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m2_x13, m2_y14, CHI); let hi = t - CHI; let lo = fma(m2_x13, m2_y14, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m2_x14, m2_y0, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y0, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m2_x14, m2_y1, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y1, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m2_x14, m2_y2, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y2, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m2_x14, m2_y3, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y3, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m2_x14, m2_y4, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y4, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m2_x14, m2_y5, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y5, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m2_x14, m2_y6, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y6, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m2_x14, m2_y7, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y7, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m2_x14, m2_y8, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y8, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m2_x14, m2_y9, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y9, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m2_x14, m2_y10, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y10, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m2_x14, m2_y11, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y11, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m2_x14, m2_y12, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y12, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m2_x14, m2_y13, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y13, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m2_x14, m2_y14, CHI); let hi = t - CHI; let lo = fma(m2_x14, m2_y14, -hi); c28 = c28 + lo; c29 = c29 + hi * RINV; }
    { let hv = floor(c0 * RINV); c0 = c0 - hv * R; c1 = c1 + hv; }
    { let hv = floor(c1 * RINV); c1 = c1 - hv * R; c2 = c2 + hv; }
    { let hv = floor(c2 * RINV); c2 = c2 - hv * R; c3 = c3 + hv; }
    { let hv = floor(c3 * RINV); c3 = c3 - hv * R; c4 = c4 + hv; }
  ...
  { // multiply #3
    ...
    let m3_x0 = f32((a0.x >> 0u) & 0x3ffffu);
    let m3_x1 = f32(((a0.x >> 18u) | (a0.y << 14u)) & 0x3ffffu);
    let m3_x2 = f32((a0.y >> 4u) & 0x3ffffu);
    let m3_x3 = f32(((a0.y >> 22u) | (a0.z << 10u)) & 0x3ffffu);
    let m3_x4 = f32((a0.z >> 8u) & 0x3ffffu);
    let m3_x5 = f32(((a0.z >> 26u) | (a0.w << 6u)) & 0x3ffffu);
    let m3_x6 = f32((a0.w >> 12u) & 0x3ffffu);
    let m3_x7 = f32(((a0.w >> 30u) | (a1.x << 2u)) & 0x3ffffu);
    let m3_x8 = f32(((a1.x >> 16u) | (a1.y << 16u)) & 0x3ffffu);
    let m3_x9 = f32((a1.y >> 2u) & 0x3ffffu);
    let m3_x10 = f32(((a1.y >> 20u) | (a1.z << 12u)) & 0x3ffffu);
    let m3_x11 = f32((a1.z >> 6u) & 0x3ffffu);
    let m3_x12 = f32(((a1.z >> 24u) | (a1.w << 8u)) & 0x3ffffu);
    let m3_x13 = f32((a1.w >> 10u) & 0x3ffffu);
    let m3_x14 = f32((a1.w >> 28u) & 0x3ffffu);
    let m3_y0 = f32((b0.x >> 0u) & 0x3ffffu);
    let m3_y1 = f32(((b0.x >> 18u) | (b0.y << 14u)) & 0x3ffffu);
    let m3_y2 = f32((b0.y >> 4u) & 0x3ffffu);
    let m3_y3 = f32(((b0.y >> 22u) | (b0.z << 10u)) & 0x3ffffu);
    let m3_y4 = f32((b0.z >> 8u) & 0x3ffffu);
    let m3_y5 = f32(((b0.z >> 26u) | (b0.w << 6u)) & 0x3ffffu);
    let m3_y6 = f32((b0.w >> 12u) & 0x3ffffu);
    let m3_y7 = f32(((b0.w >> 30u) | (b1.x << 2u)) & 0x3ffffu);
    let m3_y8 = f32(((b1.x >> 16u) | (b1.y << 16u)) & 0x3ffffu);
    let m3_y9 = f32((b1.y >> 2u) & 0x3ffffu);
    let m3_y10 = f32(((b1.y >> 20u) | (b1.z << 12u)) & 0x3ffffu);
    let m3_y11 = f32((b1.z >> 6u) & 0x3ffffu);
    let m3_y12 = f32(((b1.z >> 24u) | (b1.w << 8u)) & 0x3ffffu);
    let m3_y13 = f32((b1.w >> 10u) & 0x3ffffu);
    let m3_y14 = f32((b1.w >> 28u) & 0x3ffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
    ...
    { let t = fma(m3_x0, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x0, m3_y13, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m3_x0, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x0, m3_y14, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    ...
    { let t = fma(m3_x1, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x1, m3_y13, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m3_x1, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x1, m3_y14, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    ...
    { let t = fma(m3_x2, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x2, m3_y13, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m3_x2, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x2, m3_y14, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    ...
    { let t = fma(m3_x3, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x3, m3_y13, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m3_x3, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x3, m3_y14, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    ...
    { let t = fma(m3_x4, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x4, m3_y13, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m3_x4, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x4, m3_y14, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    ...
    { let t = fma(m3_x5, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x5, m3_y13, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m3_x5, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x5, m3_y14, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    ...
    { let t = fma(m3_x6, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x6, m3_y13, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m3_x6, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x6, m3_y14, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    ...
    { let t = fma(m3_x7, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x7, m3_y13, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m3_x7, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x7, m3_y14, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    ...
    { let t = fma(m3_x8, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x8, m3_y13, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m3_x8, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x8, m3_y14, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    ...
    { let t = fma(m3_x9, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x9, m3_y13, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m3_x9, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x9, m3_y14, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    ...
    { let t = fma(m3_x10, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x10, m3_y13, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m3_x10, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x10, m3_y14, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    ...
    { let t = fma(m3_x11, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x11, m3_y13, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m3_x11, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x11, m3_y14, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    ...
    { let t = fma(m3_x12, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x12, m3_y13, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m3_x12, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x12, m3_y14, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m3_x13, m3_y0, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y0, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m3_x13, m3_y1, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y1, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m3_x13, m3_y2, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y2, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m3_x13, m3_y3, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y3, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m3_x13, m3_y4, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y4, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m3_x13, m3_y5, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y5, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m3_x13, m3_y6, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y6, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m3_x13, m3_y7, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y7, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m3_x13, m3_y8, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y8, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m3_x13, m3_y9, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y9, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m3_x13, m3_y10, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y10, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m3_x13, m3_y11, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y11, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m3_x13, m3_y12, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y12, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m3_x13, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y13, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m3_x13, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x13, m3_y14, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m3_x14, m3_y0, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y0, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m3_x14, m3_y1, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y1, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m3_x14, m3_y2, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y2, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m3_x14, m3_y3, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y3, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m3_x14, m3_y4, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y4, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m3_x14, m3_y5, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y5, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m3_x14, m3_y6, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y6, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m3_x14, m3_y7, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y7, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m3_x14, m3_y8, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y8, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m3_x14, m3_y9, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y9, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m3_x14, m3_y10, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y10, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m3_x14, m3_y11, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y11, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m3_x14, m3_y12, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y12, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m3_x14, m3_y13, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y13, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m3_x14, m3_y14, CHI); let hi = t - CHI; let lo = fma(m3_x14, m3_y14, -hi); c28 = c28 + lo; c29 = c29 + hi * RINV; }
    { let hv = floor(c0 * RINV); c0 = c0 - hv * R; c1 = c1 + hv; }
    { let hv = floor(c1 * RINV); c1 = c1 - hv * R; c2 = c2 + hv; }
    { let hv = floor(c2 * RINV); c2 = c2 - hv * R; c3 = c3 + hv; }
    { let hv = floor(c3 * RINV); c3 = c3 - hv * R; c4 = c4 + hv; }
  ...
  { // multiply #4
    ...
    let m4_x0 = f32((a0.x >> 0u) & 0x3ffffu);
    let m4_x1 = f32(((a0.x >> 18u) | (a0.y << 14u)) & 0x3ffffu);
    let m4_x2 = f32((a0.y >> 4u) & 0x3ffffu);
    let m4_x3 = f32(((a0.y >> 22u) | (a0.z << 10u)) & 0x3ffffu);
    let m4_x4 = f32((a0.z >> 8u) & 0x3ffffu);
    let m4_x5 = f32(((a0.z >> 26u) | (a0.w << 6u)) & 0x3ffffu);
    let m4_x6 = f32((a0.w >> 12u) & 0x3ffffu);
    let m4_x7 = f32(((a0.w >> 30u) | (a1.x << 2u)) & 0x3ffffu);
    let m4_x8 = f32(((a1.x >> 16u) | (a1.y << 16u)) & 0x3ffffu);
    let m4_x9 = f32((a1.y >> 2u) & 0x3ffffu);
    let m4_x10 = f32(((a1.y >> 20u) | (a1.z << 12u)) & 0x3ffffu);
    let m4_x11 = f32((a1.z >> 6u) & 0x3ffffu);
    let m4_x12 = f32(((a1.z >> 24u) | (a1.w << 8u)) & 0x3ffffu);
    let m4_x13 = f32((a1.w >> 10u) & 0x3ffffu);
    let m4_x14 = f32((a1.w >> 28u) & 0x3ffffu);
    let m4_y0 = f32((b0.x >> 0u) & 0x3ffffu);
    let m4_y1 = f32(((b0.x >> 18u) | (b0.y << 14u)) & 0x3ffffu);
    let m4_y2 = f32((b0.y >> 4u) & 0x3ffffu);
    let m4_y3 = f32(((b0.y >> 22u) | (b0.z << 10u)) & 0x3ffffu);
    let m4_y4 = f32((b0.z >> 8u) & 0x3ffffu);
    let m4_y5 = f32(((b0.z >> 26u) | (b0.w << 6u)) & 0x3ffffu);
    let m4_y6 = f32((b0.w >> 12u) & 0x3ffffu);
    let m4_y7 = f32(((b0.w >> 30u) | (b1.x << 2u)) & 0x3ffffu);
    let m4_y8 = f32(((b1.x >> 16u) | (b1.y << 16u)) & 0x3ffffu);
    let m4_y9 = f32((b1.y >> 2u) & 0x3ffffu);
    let m4_y10 = f32(((b1.y >> 20u) | (b1.z << 12u)) & 0x3ffffu);
    let m4_y11 = f32((b1.z >> 6u) & 0x3ffffu);
    let m4_y12 = f32(((b1.z >> 24u) | (b1.w << 8u)) & 0x3ffffu);
    let m4_y13 = f32((b1.w >> 10u) & 0x3ffffu);
    let m4_y14 = f32((b1.w >> 28u) & 0x3ffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
    ...
    { let t = fma(m4_x0, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x0, m4_y13, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m4_x0, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x0, m4_y14, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    ...
    { let t = fma(m4_x1, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x1, m4_y13, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m4_x1, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x1, m4_y14, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    ...
    { let t = fma(m4_x2, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x2, m4_y13, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m4_x2, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x2, m4_y14, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    ...
    { let t = fma(m4_x3, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x3, m4_y13, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m4_x3, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x3, m4_y14, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    ...
    { let t = fma(m4_x4, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x4, m4_y13, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m4_x4, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x4, m4_y14, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    ...
    { let t = fma(m4_x5, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x5, m4_y13, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m4_x5, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x5, m4_y14, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    ...
    { let t = fma(m4_x6, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x6, m4_y13, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m4_x6, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x6, m4_y14, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    ...
    { let t = fma(m4_x7, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x7, m4_y13, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m4_x7, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x7, m4_y14, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    ...
    { let t = fma(m4_x8, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x8, m4_y13, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m4_x8, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x8, m4_y14, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    ...
    { let t = fma(m4_x9, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x9, m4_y13, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m4_x9, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x9, m4_y14, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    ...
    { let t = fma(m4_x10, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x10, m4_y13, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m4_x10, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x10, m4_y14, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    ...
    { let t = fma(m4_x11, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x11, m4_y13, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m4_x11, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x11, m4_y14, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    ...
    { let t = fma(m4_x12, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x12, m4_y13, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m4_x12, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x12, m4_y14, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m4_x13, m4_y0, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y0, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m4_x13, m4_y1, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y1, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m4_x13, m4_y2, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y2, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m4_x13, m4_y3, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y3, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m4_x13, m4_y4, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y4, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m4_x13, m4_y5, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y5, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m4_x13, m4_y6, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y6, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m4_x13, m4_y7, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y7, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m4_x13, m4_y8, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y8, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m4_x13, m4_y9, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y9, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m4_x13, m4_y10, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y10, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m4_x13, m4_y11, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y11, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m4_x13, m4_y12, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y12, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m4_x13, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y13, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m4_x13, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x13, m4_y14, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m4_x14, m4_y0, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y0, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m4_x14, m4_y1, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y1, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m4_x14, m4_y2, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y2, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m4_x14, m4_y3, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y3, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m4_x14, m4_y4, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y4, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m4_x14, m4_y5, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y5, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m4_x14, m4_y6, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y6, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m4_x14, m4_y7, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y7, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m4_x14, m4_y8, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y8, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m4_x14, m4_y9, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y9, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m4_x14, m4_y10, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y10, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m4_x14, m4_y11, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y11, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m4_x14, m4_y12, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y12, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m4_x14, m4_y13, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y13, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m4_x14, m4_y14, CHI); let hi = t - CHI; let lo = fma(m4_x14, m4_y14, -hi); c28 = c28 + lo; c29 = c29 + hi * RINV; }
    { let hv = floor(c0 * RINV); c0 = c0 - hv * R; c1 = c1 + hv; }
    { let hv = floor(c1 * RINV); c1 = c1 - hv * R; c2 = c2 + hv; }
    { let hv = floor(c2 * RINV); c2 = c2 - hv * R; c3 = c3 + hv; }
    { let hv = floor(c3 * RINV); c3 = c3 - hv * R; c4 = c4 + hv; }
  ...
  { // multiply #5
    ...
    let m5_x0 = f32((a0.x >> 0u) & 0x3ffffu);
    let m5_x1 = f32(((a0.x >> 18u) | (a0.y << 14u)) & 0x3ffffu);
    let m5_x2 = f32((a0.y >> 4u) & 0x3ffffu);
    let m5_x3 = f32(((a0.y >> 22u) | (a0.z << 10u)) & 0x3ffffu);
    let m5_x4 = f32((a0.z >> 8u) & 0x3ffffu);
    let m5_x5 = f32(((a0.z >> 26u) | (a0.w << 6u)) & 0x3ffffu);
    let m5_x6 = f32((a0.w >> 12u) & 0x3ffffu);
    let m5_x7 = f32(((a0.w >> 30u) | (a1.x << 2u)) & 0x3ffffu);
    let m5_x8 = f32(((a1.x >> 16u) | (a1.y << 16u)) & 0x3ffffu);
    let m5_x9 = f32((a1.y >> 2u) & 0x3ffffu);
    let m5_x10 = f32(((a1.y >> 20u) | (a1.z << 12u)) & 0x3ffffu);
    let m5_x11 = f32((a1.z >> 6u) & 0x3ffffu);
    let m5_x12 = f32(((a1.z >> 24u) | (a1.w << 8u)) & 0x3ffffu);
    let m5_x13 = f32((a1.w >> 10u) & 0x3ffffu);
    let m5_x14 = f32((a1.w >> 28u) & 0x3ffffu);
    let m5_y0 = f32((b0.x >> 0u) & 0x3ffffu);
    let m5_y1 = f32(((b0.x >> 18u) | (b0.y << 14u)) & 0x3ffffu);
    let m5_y2 = f32((b0.y >> 4u) & 0x3ffffu);
    let m5_y3 = f32(((b0.y >> 22u) | (b0.z << 10u)) & 0x3ffffu);
    let m5_y4 = f32((b0.z >> 8u) & 0x3ffffu);
    let m5_y5 = f32(((b0.z >> 26u) | (b0.w << 6u)) & 0x3ffffu);
    let m5_y6 = f32((b0.w >> 12u) & 0x3ffffu);
    let m5_y7 = f32(((b0.w >> 30u) | (b1.x << 2u)) & 0x3ffffu);
    let m5_y8 = f32(((b1.x >> 16u) | (b1.y << 16u)) & 0x3ffffu);
    let m5_y9 = f32((b1.y >> 2u) & 0x3ffffu);
    let m5_y10 = f32(((b1.y >> 20u) | (b1.z << 12u)) & 0x3ffffu);
    let m5_y11 = f32((b1.z >> 6u) & 0x3ffffu);
    let m5_y12 = f32(((b1.z >> 24u) | (b1.w << 8u)) & 0x3ffffu);
    let m5_y13 = f32((b1.w >> 10u) & 0x3ffffu);
    let m5_y14 = f32((b1.w >> 28u) & 0x3ffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
    ...
    { let t = fma(m5_x0, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x0, m5_y13, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m5_x0, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x0, m5_y14, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    ...
    { let t = fma(m5_x1, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x1, m5_y13, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m5_x1, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x1, m5_y14, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    ...
    { let t = fma(m5_x2, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x2, m5_y13, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m5_x2, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x2, m5_y14, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    ...
    { let t = fma(m5_x3, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x3, m5_y13, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m5_x3, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x3, m5_y14, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    ...
    { let t = fma(m5_x4, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x4, m5_y13, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m5_x4, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x4, m5_y14, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    ...
    { let t = fma(m5_x5, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x5, m5_y13, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m5_x5, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x5, m5_y14, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    ...
    { let t = fma(m5_x6, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x6, m5_y13, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m5_x6, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x6, m5_y14, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    ...
    { let t = fma(m5_x7, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x7, m5_y13, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m5_x7, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x7, m5_y14, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    ...
    { let t = fma(m5_x8, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x8, m5_y13, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m5_x8, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x8, m5_y14, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    ...
    { let t = fma(m5_x9, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x9, m5_y13, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m5_x9, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x9, m5_y14, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    ...
    { let t = fma(m5_x10, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x10, m5_y13, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m5_x10, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x10, m5_y14, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    ...
    { let t = fma(m5_x11, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x11, m5_y13, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m5_x11, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x11, m5_y14, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    ...
    { let t = fma(m5_x12, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x12, m5_y13, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m5_x12, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x12, m5_y14, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m5_x13, m5_y0, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y0, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m5_x13, m5_y1, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y1, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m5_x13, m5_y2, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y2, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m5_x13, m5_y3, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y3, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m5_x13, m5_y4, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y4, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m5_x13, m5_y5, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y5, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m5_x13, m5_y6, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y6, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m5_x13, m5_y7, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y7, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m5_x13, m5_y8, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y8, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m5_x13, m5_y9, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y9, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m5_x13, m5_y10, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y10, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m5_x13, m5_y11, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y11, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m5_x13, m5_y12, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y12, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m5_x13, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y13, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m5_x13, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x13, m5_y14, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m5_x14, m5_y0, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y0, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m5_x14, m5_y1, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y1, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m5_x14, m5_y2, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y2, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m5_x14, m5_y3, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y3, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m5_x14, m5_y4, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y4, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m5_x14, m5_y5, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y5, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m5_x14, m5_y6, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y6, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m5_x14, m5_y7, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y7, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m5_x14, m5_y8, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y8, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m5_x14, m5_y9, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y9, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m5_x14, m5_y10, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y10, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m5_x14, m5_y11, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y11, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m5_x14, m5_y12, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y12, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m5_x14, m5_y13, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y13, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m5_x14, m5_y14, CHI); let hi = t - CHI; let lo = fma(m5_x14, m5_y14, -hi); c28 = c28 + lo; c29 = c29 + hi * RINV; }
    { let hv = floor(c0 * RINV); c0 = c0 - hv * R; c1 = c1 + hv; }
    { let hv = floor(c1 * RINV); c1 = c1 - hv * R; c2 = c2 + hv; }
    { let hv = floor(c2 * RINV); c2 = c2 - hv * R; c3 = c3 + hv; }
    { let hv = floor(c3 * RINV); c3 = c3 - hv * R; c4 = c4 + hv; }
  ...
  { // multiply #6
    ...
    let m6_x0 = f32((a0.x >> 0u) & 0x3ffffu);
    let m6_x1 = f32(((a0.x >> 18u) | (a0.y << 14u)) & 0x3ffffu);
    let m6_x2 = f32((a0.y >> 4u) & 0x3ffffu);
    let m6_x3 = f32(((a0.y >> 22u) | (a0.z << 10u)) & 0x3ffffu);
    let m6_x4 = f32((a0.z >> 8u) & 0x3ffffu);
    let m6_x5 = f32(((a0.z >> 26u) | (a0.w << 6u)) & 0x3ffffu);
    let m6_x6 = f32((a0.w >> 12u) & 0x3ffffu);
    let
CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y3, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m7_x14, m7_y4, CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y4, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m7_x14, m7_y5, CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y5, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m7_x14, m7_y6, CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y6, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m7_x14, m7_y7, CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y7, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m7_x14, m7_y8, CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y8, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m7_x14, m7_y9, CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y9, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m7_x14, m7_y10, CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y10, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m7_x14, m7_y11, CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y11, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m7_x14, m7_y12, CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y12, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m7_x14, m7_y13, CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y13, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m7_x14, m7_y14, CHI); let hi = t - CHI; let lo = fma(m7_x14, m7_y14, -hi); c28 = c28 + lo; c29 = c29 + hi * RINV; }
    { let hv = floor(c0 * RINV); c0 = c0 - hv * R; c1 = c1 + hv; }
    { let hv = floor(c1 * RINV); c1 = c1 - hv * R; c2 = c2 + hv; }
    { let hv = floor(c2 * RINV); c2 = c2 - hv * R; c3 = c3 + hv; }
    { let hv = floor(c3 * RINV); c3 = c3 - hv * R; c4 = c4 + hv; }
  ...
  { // multiply #8
    ...
    let m8_x0 = f32((a0.x >> 0u) & 0x3ffffu);
    let m8_x1 = f32(((a0.x >> 18u) | (a0.y << 14u)) & 0x3ffffu);
    let m8_x2 = f32((a0.y >> 4u) & 0x3ffffu);
    let m8_x3 = f32(((a0.y >> 22u) | (a0.z << 10u)) & 0x3ffffu);
    let m8_x4 = f32((a0.z >> 8u) & 0x3ffffu);
    let m8_x5 = f32(((a0.z >> 26u) | (a0.w << 6u)) & 0x3ffffu);
    let m8_x6 = f32((a0.w >> 12u) & 0x3ffffu);
    let m8_x7 = f32(((a0.w >> 30u) | (a1.x << 2u)) & 0x3ffffu);
    let m8_x8 = f32(((a1.x >> 16u) | (a1.y << 16u)) & 0x3ffffu);
    let m8_x9 = f32((a1.y >> 2u) & 0x3ffffu);
    let m8_x10 = f32(((a1.y >> 20u) | (a1.z << 12u)) & 0x3ffffu);
    let m8_x11 = f32((a1.z >> 6u) & 0x3ffffu);
    let m8_x12 = f32(((a1.z >> 24u) | (a1.w << 8u)) & 0x3ffffu);
    let m8_x13 = f32((a1.w >> 10u) & 0x3ffffu);
    let m8_x14 = f32((a1.w >> 28u) & 0x3ffffu);
    let m8_y0 = f32((b0.x >> 0u) & 0x3ffffu);
    let m8_y1 = f32(((b0.x >> 18u) | (b0.y << 14u)) & 0x3ffffu);
    let m8_y2 = f32((b0.y >> 4u) & 0x3ffffu);
    let m8_y3 = f32(((b0.y >> 22u) | (b0.z << 10u)) & 0x3ffffu);
    let m8_y4 = f32((b0.z >> 8u) & 0x3ffffu);
    let m8_y5 = f32(((b0.z >> 26u) | (b0.w << 6u)) & 0x3ffffu);
    let m8_y6 = f32((b0.w >> 12u) & 0x3ffffu);
    let m8_y7 = f32(((b0.w >> 30u) | (b1.x << 2u)) & 0x3ffffu);
    let m8_y8 = f32(((b1.x >> 16u) | (b1.y << 16u)) & 0x3ffffu);
    let m8_y9 = f32((b1.y >> 2u) & 0x3ffffu);
    let m8_y10 = f32(((b1.y >> 20u) | (b1.z << 12u)) & 0x3ffffu);
    let m8_y11 = f32((b1.z >> 6u) & 0x3ffffu);
    let m8_y12 = f32(((b1.z >> 24u) | (b1.w << 8u)) & 0x3ffffu);
    let m8_y13 = f32((b1.w >> 10u) & 0x3ffffu);
    let m8_y14 = f32((b1.w >> 28u) & 0x3ffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
    ...
    { let t = fma(m8_x0, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x0, m8_y13, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m8_x0, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x0, m8_y14, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    ...
    { let t = fma(m8_x1, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x1, m8_y13, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m8_x1, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x1, m8_y14, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    ...
    { let t = fma(m8_x2, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x2, m8_y13, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m8_x2, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x2, m8_y14, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    ...
    { let t = fma(m8_x3, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x3, m8_y13, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m8_x3, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x3, m8_y14, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    ...
    { let t = fma(m8_x4, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x4, m8_y13, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m8_x4, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x4, m8_y14, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    ...
    { let t = fma(m8_x5, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x5, m8_y13, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m8_x5, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x5, m8_y14, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    ...
    { let t = fma(m8_x6, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x6, m8_y13, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m8_x6, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x6, m8_y14, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    ...
    { let t = fma(m8_x7, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x7, m8_y13, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m8_x7, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x7, m8_y14, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    ...
    { let t = fma(m8_x8, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x8, m8_y13, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m8_x8, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x8, m8_y14, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    ...
    { let t = fma(m8_x9, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x9, m8_y13, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m8_x9, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x9, m8_y14, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    ...
    { let t = fma(m8_x10, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x10, m8_y13, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m8_x10, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x10, m8_y14, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    ...
    { let t = fma(m8_x11, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x11, m8_y13, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m8_x11, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x11, m8_y14, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    ...
    { let t = fma(m8_x12, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x12, m8_y13, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m8_x12, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x12, m8_y14, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m8_x13, m8_y0, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y0, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m8_x13, m8_y1, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y1, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m8_x13, m8_y2, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y2, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m8_x13, m8_y3, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y3, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m8_x13, m8_y4, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y4, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m8_x13, m8_y5, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y5, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m8_x13, m8_y6, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y6, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m8_x13, m8_y7, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y7, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m8_x13, m8_y8, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y8, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m8_x13, m8_y9, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y9, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m8_x13, m8_y10, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y10, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m8_x13, m8_y11, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y11, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m8_x13, m8_y12, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y12, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m8_x13, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y13, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m8_x13, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x13, m8_y14, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m8_x14, m8_y0, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y0, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m8_x14, m8_y1, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y1, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m8_x14, m8_y2, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y2, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m8_x14, m8_y3, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y3, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m8_x14, m8_y4, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y4, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m8_x14, m8_y5, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y5, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m8_x14, m8_y6, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y6, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m8_x14, m8_y7, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y7, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m8_x14, m8_y8, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y8, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m8_x14, m8_y9, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y9, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m8_x14, m8_y10, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y10, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m8_x14, m8_y11, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y11, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m8_x14, m8_y12, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y12, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m8_x14, m8_y13, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y13, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m8_x14, m8_y14, CHI); let hi = t - CHI; let lo = fma(m8_x14, m8_y14, -hi); c28 = c28 + lo; c29 = c29 + hi * RINV; }
    { let hv = floor(c0 * RINV); c0 = c0 - hv * R; c1 = c1 + hv; }
    { let hv = floor(c1 * RINV); c1 = c1 - hv * R; c2 = c2 + hv; }
    { let hv = floor(c2 * RINV); c2 = c2 - hv * R; c3 = c3 + hv; }
    { let hv = floor(c3 * RINV); c3 = c3 - hv * R; c4 = c4 + hv; }
  ...
  { // multiply #9
    ...
    let m9_x0 = f32((a0.x >> 0u) & 0x3ffffu);
    let m9_x1 = f32(((a0.x >> 18u) | (a0.y << 14u)) & 0x3ffffu);
    let m9_x2 = f32((a0.y >> 4u) & 0x3ffffu);
    let m9_x3 = f32(((a0.y >> 22u) | (a0.z << 10u)) & 0x3ffffu);
    let m9_x4 = f32((a0.z >> 8u) & 0x3ffffu);
    let m9_x5 = f32(((a0.z >> 26u) | (a0.w << 6u)) & 0x3ffffu);
    let m9_x6 = f32((a0.w >> 12u) & 0x3ffffu);
    let m9_x7 = f32(((a0.w >> 30u) | (a1.x << 2u)) & 0x3ffffu);
    let m9_x8 = f32(((a1.x >> 16u) | (a1.y << 16u)) & 0x3ffffu);
    let m9_x9 = f32((a1.y >> 2u) & 0x3ffffu);
    let m9_x10 = f32(((a1.y >> 20u) | (a1.z << 12u)) & 0x3ffffu);
    let m9_x11 = f32((a1.z >> 6u) & 0x3ffffu);
    let m9_x12 = f32(((a1.z >> 24u) | (a1.w << 8u)) & 0x3ffffu);
    let m9_x13 = f32((a1.w >> 10u) & 0x3ffffu);
    let m9_x14 = f32((a1.w >> 28u) & 0x3ffffu);
    let m9_y0 = f32((b0.x >> 0u) & 0x3ffffu);
    let m9_y1 = f32(((b0.x >> 18u) | (b0.y << 14u)) & 0x3ffffu);
    let m9_y2 = f32((b0.y >> 4u) & 0x3ffffu);
    let m9_y3 = f32(((b0.y >> 22u) | (b0.z << 10u)) & 0x3ffffu);
    let m9_y4 = f32((b0.z >> 8u) & 0x3ffffu);
    let m9_y5 = f32(((b0.z >> 26u) | (b0.w << 6u)) & 0x3ffffu);
    let m9_y6 = f32((b0.w >> 12u) & 0x3ffffu);
    let m9_y7 = f32(((b0.w >> 30u) | (b1.x << 2u)) & 0x3ffffu);
    let m9_y8 = f32(((b1.x >> 16u) | (b1.y << 16u)) & 0x3ffffu);
    let m9_y9 = f32((b1.y >> 2u) & 0x3ffffu);
    let m9_y10 = f32(((b1.y >> 20u) | (b1.z << 12u)) & 0x3ffffu);
    let m9_y11 = f32((b1.z >> 6u) & 0x3ffffu);
    let m9_y12 = f32(((b1.z >> 24u) | (b1.w << 8u)) & 0x3ffffu);
    let m9_y13 = f32((b1.w >> 10u) & 0x3ffffu);
    let m9_y14 = f32((b1.w >> 28u) & 0x3ffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
    ...
    { let t = fma(m9_x0, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x0, m9_y13, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m9_x0, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x0, m9_y14, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    ...
    { let t = fma(m9_x1, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x1, m9_y13, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m9_x1, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x1, m9_y14, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    ...
    { let t = fma(m9_x2, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x2, m9_y13, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m9_x2, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x2, m9_y14, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    ...
    { let t = fma(m9_x3, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x3, m9_y13, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m9_x3, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x3, m9_y14, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    ...
    { let t = fma(m9_x4, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x4, m9_y13, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m9_x4, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x4, m9_y14, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    ...
    { let t = fma(m9_x5, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x5, m9_y13, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m9_x5, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x5, m9_y14, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    ...
    { let t = fma(m9_x6, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x6, m9_y13, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m9_x6, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x6, m9_y14, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    ...
    { let t = fma(m9_x7, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x7, m9_y13, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m9_x7, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x7, m9_y14, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    ...
    { let t = fma(m9_x8, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x8, m9_y13, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m9_x8, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x8, m9_y14, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    ...
    { let t = fma(m9_x9, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x9, m9_y13, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m9_x9, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x9, m9_y14, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    ...
    { let t = fma(m9_x10, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x10, m9_y13, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m9_x10, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x10, m9_y14, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    ...
    { let t = fma(m9_x11, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x11, m9_y13, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m9_x11, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x11, m9_y14, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    ...
    { let t = fma(m9_x12, m9_y13, CHI); let hi = t - CHI; let lo = fma(m9_x12, m9_y13, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m9_x12, m9_y14, CHI); let hi = t - CHI; let lo = fma(m9_x12, m9_y14, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m9_x13, m9_y0, CHI); let hi = t - CHI; let lo = fma(m9_x13, m9_y0, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m9_x13, m9_y1, CHI); let hi = t - CHI; let lo = fma(m9_x13, m9_y1, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(
y13, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m11_x6, m11_y14, CHI); let hi = t - CHI; let lo = fma(m11_x6, m11_y14, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    ...
    { let t = fma(m11_x7, m11_y13, CHI); let hi = t - CHI; let lo = fma(m11_x7, m11_y13, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m11_x7, m11_y14, CHI); let hi = t - CHI; let lo = fma(m11_x7, m11_y14, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    ...
    { let t = fma(m11_x8, m11_y13, CHI); let hi = t - CHI; let lo = fma(m11_x8, m11_y13, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m11_x8, m11_y14, CHI); let hi = t - CHI; let lo = fma(m11_x8, m11_y14, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    ...
    { let t = fma(m11_x9, m11_y13, CHI); let hi = t - CHI; let lo = fma(m11_x9, m11_y13, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m11_x9, m11_y14, CHI); let hi = t - CHI; let lo = fma(m11_x9, m11_y14, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    ...
    { let t = fma(m11_x10, m11_y13, CHI); let hi = t - CHI; let lo = fma(m11_x10, m11_y13, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m11_x10, m11_y14, CHI); let hi = t - CHI; let lo = fma(m11_x10, m11_y14, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    ...
    { let t = fma(m11_x11, m11_y13, CHI); let hi = t - CHI; let lo = fma(m11_x11, m11_y13, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m11_x11, m11_y14, CHI); let hi = t - CHI; let lo = fma(m11_x11, m11_y14, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    ...
    { let t = fma(m11_x12, m11_y13, CHI); let hi = t - CHI; let lo = fma(m11_x12, m11_y13, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m11_x12, m11_y14, CHI); let hi = t - CHI; let lo = fma(m11_x12, m11_y14, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m11_x13, m11_y0, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y0, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m11_x13, m11_y1, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y1, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m11_x13, m11_y2, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y2, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m11_x13, m11_y3, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y3, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m11_x13, m11_y4, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y4, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m11_x13, m11_y5, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y5, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m11_x13, m11_y6, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y6, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m11_x13, m11_y7, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y7, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m11_x13, m11_y8, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y8, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m11_x13, m11_y9, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y9, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m11_x13, m11_y10, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y10, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m11_x13, m11_y11, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y11, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m11_x13, m11_y12, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y12, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m11_x13, m11_y13, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y13, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m11_x13, m11_y14, CHI); let hi = t - CHI; let lo = fma(m11_x13, m11_y14, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m11_x14, m11_y0, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y0, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m11_x14, m11_y1, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y1, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m11_x14, m11_y2, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y2, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m11_x14, m11_y3, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y3, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m11_x14, m11_y4, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y4, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m11_x14, m11_y5, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y5, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m11_x14, m11_y6, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y6, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m11_x14, m11_y7, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y7, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m11_x14, m11_y8, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y8, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m11_x14, m11_y9, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y9, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m11_x14, m11_y10, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y10, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m11_x14, m11_y11, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y11, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m11_x14, m11_y12, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y12, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m11_x14, m11_y13, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y13, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m11_x14, m11_y14, CHI); let hi = t - CHI; let lo = fma(m11_x14, m11_y14, -hi); c28 = c28 + lo; c29 = c29 + hi * RINV; }
    { let hv = floor(c0 * RINV); c0 = c0 - hv * R; c1 = c1 + hv; }
    { let hv = floor(c1 * RINV); c1 = c1 - hv * R; c2 = c2 + hv; }
    { let hv = floor(c2 * RINV); c2 = c2 - hv * R; c3 = c3 + hv; }
    { let hv = floor(c3 * RINV); c3 = c3 - hv * R; c4 = c4 + hv; }
  ...
  { // multiply #12
    ...
    let m12_x0 = f32((a0.x >> 0u) & 0x3ffffu);
    let m12_x1 = f32(((a0.x >> 18u) | (a0.y << 14u)) & 0x3ffffu);
    let m12_x2 = f32((a0.y >> 4u) & 0x3ffffu);
    let m12_x3 = f32(((a0.y >> 22u) | (a0.z << 10u)) & 0x3ffffu);
    let m12_x4 = f32((a0.z >> 8u) & 0x3ffffu);
    let m12_x5 = f32(((a0.z >> 26u) | (a0.w << 6u)) & 0x3ffffu);
    let m12_x6 = f32((a0.w >> 12u) & 0x3ffffu);
    let m12_x7 = f32(((a0.w >> 30u) | (a1.x << 2u)) & 0x3ffffu);
    let m12_x8 = f32(((a1.x >> 16u) | (a1.y << 16u)) & 0x3ffffu);
    let m12_x9 = f32((a1.y >> 2u) & 0x3ffffu);
    let m12_x10 = f32(((a1.y >> 20u) | (a1.z << 12u)) & 0x3ffffu);
    let m12_x11 = f32((a1.z >> 6u) & 0x3ffffu);
    let m12_x12 = f32(((a1.z >> 24u) | (a1.w << 8u)) & 0x3ffffu);
    let m12_x13 = f32((a1.w >> 10u) & 0x3ffffu);
    let m12_x14 = f32((a1.w >> 28u) & 0x3ffffu);
    let m12_y0 = f32((b0.x >> 0u) & 0x3ffffu);
    let m12_y1 = f32(((b0.x >> 18u) | (b0.y << 14u)) & 0x3ffffu);
    let m12_y2 = f32((b0.y >> 4u) & 0x3ffffu);
    let m12_y3 = f32(((b0.y >> 22u) | (b0.z << 10u)) & 0x3ffffu);
    let m12_y4 = f32((b0.z >> 8u) & 0x3ffffu);
    let m12_y5 = f32(((b0.z >> 26u) | (b0.w << 6u)) & 0x3ffffu);
    let m12_y6 = f32((b0.w >> 12u) & 0x3ffffu);
    let m12_y7 = f32(((b0.w >> 30u) | (b1.x << 2u)) & 0x3ffffu);
    let m12_y8 = f32(((b1.x >> 16u) | (b1.y << 16u)) & 0x3ffffu);
    let m12_y9 = f32((b1.y >> 2u) & 0x3ffffu);
    let m12_y10 = f32(((b1.y >> 20u) | (b1.z << 12u)) & 0x3ffffu);
    let m12_y11 = f32((b1.z >> 6u) & 0x3ffffu);
    let m12_y12 = f32(((b1.z >> 24u) | (b1.w << 8u)) & 0x3ffffu);
    let m12_y13 = f32((b1.w >> 10u) & 0x3ffffu);
    let m12_y14 = f32((b1.w >> 28u) & 0x3ffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
    ...
    { let t = fma(m12_x0, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x0, m12_y13, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m12_x0, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x0, m12_y14, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    ...
    { let t = fma(m12_x1, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x1, m12_y13, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m12_x1, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x1, m12_y14, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    ...
    { let t = fma(m12_x2, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x2, m12_y13, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m12_x2, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x2, m12_y14, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    ...
    { let t = fma(m12_x3, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x3, m12_y13, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m12_x3, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x3, m12_y14, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    ...
    { let t = fma(m12_x4, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x4, m12_y13, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m12_x4, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x4, m12_y14, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    ...
    { let t = fma(m12_x5, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x5, m12_y13, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m12_x5, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x5, m12_y14, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    ...
    { let t = fma(m12_x6, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x6, m12_y13, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m12_x6, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x6, m12_y14, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    ...
    { let t = fma(m12_x7, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x7, m12_y13, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m12_x7, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x7, m12_y14, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    ...
    { let t = fma(m12_x8, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x8, m12_y13, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m12_x8, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x8, m12_y14, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    ...
    { let t = fma(m12_x9, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x9, m12_y13, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m12_x9, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x9, m12_y14, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    ...
    { let t = fma(m12_x10, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x10, m12_y13, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m12_x10, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x10, m12_y14, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    ...
    { let t = fma(m12_x11, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x11, m12_y13, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m12_x11, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x11, m12_y14, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    ...
    { let t = fma(m12_x12, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x12, m12_y13, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m12_x12, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x12, m12_y14, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m12_x13, m12_y0, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y0, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m12_x13, m12_y1, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y1, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m12_x13, m12_y2, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y2, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m12_x13, m12_y3, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y3, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m12_x13, m12_y4, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y4, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m12_x13, m12_y5, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y5, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m12_x13, m12_y6, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y6, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m12_x13, m12_y7, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y7, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m12_x13, m12_y8, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y8, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m12_x13, m12_y9, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y9, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m12_x13, m12_y10, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y10, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m12_x13, m12_y11, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y11, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m12_x13, m12_y12, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y12, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m12_x13, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y13, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m12_x13, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x13, m12_y14, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m12_x14, m12_y0, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y0, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m12_x14, m12_y1, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y1, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m12_x14, m12_y2, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y2, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m12_x14, m12_y3, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y3, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m12_x14, m12_y4, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y4, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m12_x14, m12_y5, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y5, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m12_x14, m12_y6, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y6, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m12_x14, m12_y7, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y7, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m12_x14, m12_y8, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y8, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m12_x14, m12_y9, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y9, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m12_x14, m12_y10, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y10, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m12_x14, m12_y11, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y11, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m12_x14, m12_y12, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y12, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m12_x14, m12_y13, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y13, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m12_x14, m12_y14, CHI); let hi = t - CHI; let lo = fma(m12_x14, m12_y14, -hi); c28 = c28 + lo; c29 = c29 + hi * RINV; }
    { let hv = floor(c0 * RINV); c0 = c0 - hv * R; c1 = c1 + hv; }
    { let hv = floor(c1 * RINV); c1 = c1 - hv * R; c2 = c2 + hv; }
    { let hv = floor(c2 * RINV); c2 = c2 - hv * R; c3 = c3 + hv; }
    { let hv = floor(c3 * RINV); c3 = c3 - hv * R; c4 = c4 + hv; }
  ...
  { // multiply #13
    ...
    let m13_x0 = f32((a0.x >> 0u) & 0x3ffffu);
    let m13_x1 = f32(((a0.x >> 18u) | (a0.y << 14u)) & 0x3ffffu);
    let m13_x2 = f32((a0.y >> 4u) & 0x3ffffu);
    let m13_x3 = f32(((a0.y >> 22u) | (a0.z << 10u)) & 0x3ffffu);
    let m13_x4 = f32((a0.z >> 8u) & 0x3ffffu);
    let m13_x5 = f32(((a0.z >> 26u) | (a0.w << 6u)) & 0x3ffffu);
    let m13_x6 = f32((a0.w >> 12u) & 0x3ffffu);
    let m13_x7 = f32(((a0.w >> 30u) | (a1.x << 2u)) & 0x3ffffu);
    let m13_x8 = f32(((a1.x >> 16u) | (a1.y << 16u)) & 0x3ffffu);
    let m13_x9 = f32((a1.y >> 2u) & 0x3ffffu);
    let m13_x10 = f32(((a1.y >> 20u) | (a1.z << 12u)) & 0x3ffffu);
    let m13_x11 = f32((a1.z >> 6u) & 0x3ffffu);
    let m13_x12 = f32(((a1.z >> 24u) | (a1.w << 8u)) & 0x3ffffu);
    let m13_x13 = f32((a1.w >> 10u) & 0x3ffffu);
    let m13_x14 = f32((a1.w >> 28u) & 0x3ffffu);
    let m13_y0 = f32((b0.x >> 0u) & 0x3ffffu);
    let m13_y1 = f32(((b0.x >> 18u) | (b0.y << 14u)) & 0x3ffffu);
    let m13_y2 = f32((b0.y >> 4u) & 0x3ffffu);
    let m13_y3 = f32(((b0.y >> 22u) | (b0.z << 10u)) & 0x3ffffu);
    let m13_y4 = f32((b0.z >> 8u) & 0x3ffffu);
    let m13_y5 = f32(((b0.z >> 26u) | (b0.w << 6u)) & 0x3ffffu);
    let m13_y6 = f32((b0.w >> 12u) & 0x3ffffu);
    let m13_y7 = f32(((b0.w >> 30u) | (b1.x << 2u)) & 0x3ffffu);
    let
CHI); let hi = t - CHI; let lo = fma(m14_x14, m14_y8, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m14_x14, m14_y9, CHI); let hi = t - CHI; let lo = fma(m14_x14, m14_y9, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m14_x14, m14_y10, CHI); let hi = t - CHI; let lo = fma(m14_x14, m14_y10, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m14_x14, m14_y11, CHI); let hi = t - CHI; let lo = fma(m14_x14, m14_y11, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m14_x14, m14_y12, CHI); let hi = t - CHI; let lo = fma(m14_x14, m14_y12, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m14_x14, m14_y13, CHI); let hi = t - CHI; let lo = fma(m14_x14, m14_y13, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m14_x14, m14_y14, CHI); let hi = t - CHI; let lo = fma(m14_x14, m14_y14, -hi); c28 = c28 + lo; c29 = c29 + hi * RINV; }
    { let hv = floor(c0 * RINV); c0 = c0 - hv * R; c1 = c1 + hv; }
    { let hv = floor(c1 * RINV); c1 = c1 - hv * R; c2 = c2 + hv; }
    { let hv = floor(c2 * RINV); c2 = c2 - hv * R; c3 = c3 + hv; }
    { let hv = floor(c3 * RINV); c3 = c3 - hv * R; c4 = c4 + hv; }
  ...
  { // multiply #15
    ...
    let m15_x0 = f32((a0.x >> 0u) & 0x3ffffu);
    let m15_x1 = f32(((a0.x >> 18u) | (a0.y << 14u)) & 0x3ffffu);
    let m15_x2 = f32((a0.y >> 4u) & 0x3ffffu);
    let m15_x3 = f32(((a0.y >> 22u) | (a0.z << 10u)) & 0x3ffffu);
    let m15_x4 = f32((a0.z >> 8u) & 0x3ffffu);
    let m15_x5 = f32(((a0.z >> 26u) | (a0.w << 6u)) & 0x3ffffu);
    let m15_x6 = f32((a0.w >> 12u) & 0x3ffffu);
    let m15_x7 = f32(((a0.w >> 30u) | (a1.x << 2u)) & 0x3ffffu);
    let m15_x8 = f32(((a1.x >> 16u) | (a1.y << 16u)) & 0x3ffffu);
    let m15_x9 = f32((a1.y >> 2u) & 0x3ffffu);
    let m15_x10 = f32(((a1.y >> 20u) | (a1.z << 12u)) & 0x3ffffu);
    let m15_x11 = f32((a1.z >> 6u) & 0x3ffffu);
    let m15_x12 = f32(((a1.z >> 24u) | (a1.w << 8u)) & 0x3ffffu);
    let m15_x13 = f32((a1.w >> 10u) & 0x3ffffu);
    let m15_x14 = f32((a1.w >> 28u) & 0x3ffffu);
    let m15_y0 = f32((b0.x >> 0u) & 0x3ffffu);
    let m15_y1 = f32(((b0.x >> 18u) | (b0.y << 14u)) & 0x3ffffu);
    let m15_y2 = f32((b0.y >> 4u) & 0x3ffffu);
    let m15_y3 = f32(((b0.y >> 22u) | (b0.z << 10u)) & 0x3ffffu);
    let m15_y4 = f32((b0.z >> 8u) & 0x3ffffu);
    let m15_y5 = f32(((b0.z >> 26u) | (b0.w << 6u)) & 0x3ffffu);
    let m15_y6 = f32((b0.w >> 12u) & 0x3ffffu);
    let m15_y7 = f32(((b0.w >> 30u) | (b1.x << 2u)) & 0x3ffffu);
    let m15_y8 = f32(((b1.x >> 16u) | (b1.y << 16u)) & 0x3ffffu);
    let m15_y9 = f32((b1.y >> 2u) & 0x3ffffu);
    let m15_y10 = f32(((b1.y >> 20u) | (b1.z << 12u)) & 0x3ffffu);
    let m15_y11 = f32((b1.z >> 6u) & 0x3ffffu);
    let m15_y12 = f32(((b1.z >> 24u) | (b1.w << 8u)) & 0x3ffffu);
    let m15_y13 = f32((b1.w >> 10u) & 0x3ffffu);
    let m15_y14 = f32((b1.w >> 28u) & 0x3ffffu);
    var c0: f32 = 0.0;
    var c1: f32 = 0.0;
    var c2: f32 = 0.0;
    var c3: f32 = 0.0;
    ...
    { let t = fma(m15_x0, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x0, m15_y13, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m15_x0, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x0, m15_y14, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    ...
    { let t = fma(m15_x1, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x1, m15_y13, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m15_x1, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x1, m15_y14, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    ...
    { let t = fma(m15_x2, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x2, m15_y13, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m15_x2, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x2, m15_y14, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    ...
    { let t = fma(m15_x3, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x3, m15_y13, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m15_x3, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x3, m15_y14, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    ...
    { let t = fma(m15_x4, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x4, m15_y13, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m15_x4, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x4, m15_y14, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    ...
    { let t = fma(m15_x5, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x5, m15_y13, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m15_x5, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x5, m15_y14, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    ...
    { let t = fma(m15_x6, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x6, m15_y13, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m15_x6, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x6, m15_y14, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    ...
    { let t = fma(m15_x7, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x7, m15_y13, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m15_x7, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x7, m15_y14, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    ...
    { let t = fma(m15_x8, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x8, m15_y13, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m15_x8, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x8, m15_y14, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    ...
    { let t = fma(m15_x9, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x9, m15_y13, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m15_x9, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x9, m15_y14, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    ...
    { let t = fma(m15_x10, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x10, m15_y13, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m15_x10, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x10, m15_y14, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    ...
    { let t = fma(m15_x11, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x11, m15_y13, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m15_x11, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x11, m15_y14, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    ...
    { let t = fma(m15_x12, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x12, m15_y13, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m15_x12, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x12, m15_y14, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m15_x13, m15_y0, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y0, -hi); c13 = c13 + lo; c14 = c14 + hi * RINV; }
    { let t = fma(m15_x13, m15_y1, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y1, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m15_x13, m15_y2, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y2, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m15_x13, m15_y3, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y3, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m15_x13, m15_y4, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y4, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m15_x13, m15_y5, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y5, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m15_x13, m15_y6, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y6, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m15_x13, m15_y7, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y7, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m15_x13, m15_y8, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y8, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m15_x13, m15_y9, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y9, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m15_x13, m15_y10, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y10, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m15_x13, m15_y11, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y11, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m15_x13, m15_y12, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y12, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m15_x13, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y13, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m15_x13, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x13, m15_y14, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m15_x14, m15_y0, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y0, -hi); c14 = c14 + lo; c15 = c15 + hi * RINV; }
    { let t = fma(m15_x14, m15_y1, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y1, -hi); c15 = c15 + lo; c16 = c16 + hi * RINV; }
    { let t = fma(m15_x14, m15_y2, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y2, -hi); c16 = c16 + lo; c17 = c17 + hi * RINV; }
    { let t = fma(m15_x14, m15_y3, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y3, -hi); c17 = c17 + lo; c18 = c18 + hi * RINV; }
    { let t = fma(m15_x14, m15_y4, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y4, -hi); c18 = c18 + lo; c19 = c19 + hi * RINV; }
    { let t = fma(m15_x14, m15_y5, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y5, -hi); c19 = c19 + lo; c20 = c20 + hi * RINV; }
    { let t = fma(m15_x14, m15_y6, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y6, -hi); c20 = c20 + lo; c21 = c21 + hi * RINV; }
    { let t = fma(m15_x14, m15_y7, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y7, -hi); c21 = c21 + lo; c22 = c22 + hi * RINV; }
    { let t = fma(m15_x14, m15_y8, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y8, -hi); c22 = c22 + lo; c23 = c23 + hi * RINV; }
    { let t = fma(m15_x14, m15_y9, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y9, -hi); c23 = c23 + lo; c24 = c24 + hi * RINV; }
    { let t = fma(m15_x14, m15_y10, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y10, -hi); c24 = c24 + lo; c25 = c25 + hi * RINV; }
    { let t = fma(m15_x14, m15_y11, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y11, -hi); c25 = c25 + lo; c26 = c26 + hi * RINV; }
    { let t = fma(m15_x14, m15_y12, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y12, -hi); c26 = c26 + lo; c27 = c27 + hi * RINV; }
    { let t = fma(m15_x14, m15_y13, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y13, -hi); c27 = c27 + lo; c28 = c28 + hi * RINV; }
    { let t = fma(m15_x14, m15_y14, CHI); let hi = t - CHI; let lo = fma(m15_x14, m15_y14, -hi); c28 = c28 + lo; c29 = c29 + hi * RINV; }
    { let hv = floor(c0 * RINV); c0 = c0 - hv * R; c1 = c1 + hv; }
    { let hv = floor(c1 * RINV); c1 = c1 - hv * R; c2 = c2 + hv; }
    { let hv = floor(c2 * RINV); c2 = c2 - hv * R; c3 = c3 + hv; }
    { let hv = floor(c3 * RINV); c3 = c3 - hv * R; c4 = c4 + hv; }
