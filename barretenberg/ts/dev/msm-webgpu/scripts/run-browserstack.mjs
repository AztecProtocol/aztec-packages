...
async function main() {
  ...
  // Walker sweep knobs, passed through verbatim: e.g. --knobs "pref=private&swalk=4&wtpb=128&dxcache=1".
  if (argv.knobs) {
    for (const [k, v] of new URLSearchParams(argv.knobs)) qp.set(k, v);
  }
