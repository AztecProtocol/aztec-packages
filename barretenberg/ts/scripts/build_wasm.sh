...
mkdir -p ./dest/browser-esm/barretenberg_wasm
...
cp ../cpp/build-wasm-threads/bin/barretenberg.wasm.gz ./dest/browser-esm/barretenberg_wasm/barretenberg-threads.wasm.gz
cp ../cpp/build-wasm/bin/barretenberg.wasm.gz ./dest/browser-esm/barretenberg_wasm/barretenberg.wasm.gz
