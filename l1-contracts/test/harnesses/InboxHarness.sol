...
contract InboxHarness is Inbox {
  ...
  constructor(address _rollup, IERC20 _feeAsset, uint256 _version, uint256 _height, uint256 _lag, uint256 _ringSize)
    Inbox(_rollup, _feeAsset, _version, _height, _lag, _ringSize)
  {}
