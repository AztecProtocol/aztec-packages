...
contract RewardLibWrapper {
  ...
  function handleRewardsAndFees(SubmitEpochRootProofArgs calldata _args, Epoch _endEpoch) external {
    ...
    RewardLib.handleRewardsAndFees(_args, _endEpoch, new address[](0), registryRewardOverrides);
  }
  ...
  function handleRewardsAndFees(
    ...
    RewardLib.handleRewardsAndFees(_args, _endEpoch, _committee, _registryRewardOverrides);
  }
