...
contract ConstructorTest is StakingAssetHandlerBase {
  function test_WhenDepositsPerMintIs0() external {
    ...
    new StakingAssetHandler(address(this), address(0), registry, address(0), 0, 0, zkPassportVerifier, new address[](0));
  }
  ...
  function test_WhenDepositsPerMintIsNot0(
    ...
    stakingAssetHandler = new StakingAssetHandler(
      _owner, _stakingAsset, registry, _withdrawer, _mintInterval, _depositsPerMint, zkPassportVerifier, unhinged
    );
