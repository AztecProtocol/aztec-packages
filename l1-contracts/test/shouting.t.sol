...
contract ScreamAndShoutTest is Test {
  ...
  function test_GovernanceCreationCode() public pure {
    ...
    assertEq(codeHash, 0x8660a25b0d480424b950324ef5d078cfb12a06d5c807ab09ade301968ac20ae1, ERR_STRING);
  }
  ...
  function test_HonkVerifierCreationCode() public pure {
    ...
    assertEq(codeHash, 0x892b4a5c70e2e665b147db8ae02a0410ae400adefd02d85feb56847593d4b9dd, ERR_STRING);
  }
  ...
  function test_RegistryCreationCode() public pure {
    ...
    assertEq(codeHash, 0x1c9e54944cd8c92ee57305f1fba26284638268a934f9fab38b7c6a4facb92ee5, ERR_STRING);
  }
  ...
  function test_RollupCreationCode() public pure {
    ...
    assertEq(codeHash, 0xddd8431ed52d33e28fb5072e1dd57fbecb5fd919da403bc20cdad17ca2113726, ERR_STRING);
  }
}
