 ...
 * mainnet rollup version is deployed by a bespoke pinned `DeployRollupForUpgradeV<N>.s.sol`. Its
 * defaults are test-network conveniences, not mainnet configuration.
 */
