...
src/core/libraries/HeaderLib.sol#L150
 ...
 - [ ] ID-2
[TxsDecoder.decode(bytes).vars](src/core/libraries/decoders/TxsDecoder.sol#L82) is a local variable never initialized

src/core/libraries/decoders/TxsDecoder.sol#L82
...
src/core/messagebridge/Inbox.sol#L45-L91
 ...
 - [ ] ID-6
Dubious typecast in [MessagesDecoder.read1(bytes,uint256)](src/core/libraries/decoders/MessagesDecoder.sol#L151-L153):
	bytes => bytes1 casting occurs in [uint256(uint8(bytes1(_data)))](src/core/libraries/decoders/MessagesDecoder.sol#L152)

src/core/libraries/decoders/MessagesDecoder.sol#L151-L153


 - [ ] ID-7
Dubious typecast in [TxsDecoder.read4(bytes,uint256)](src/core/libraries/decoders/TxsDecoder.sol#L355-L357):
	bytes => bytes4 casting occurs in [uint256(uint32(bytes4(slice(_data,_offset,4))))](src/core/libraries/decoders/TxsDecoder.sol#L356)

src/core/libraries/decoders/TxsDecoder.sol#L355-L357
...
src/core/libraries/HeaderLib.sol#L145-L189
 ...
 - [ ] ID-9
Dubious typecast in [MessagesDecoder.read4(bytes,uint256)](src/core/libraries/decoders/MessagesDecoder.sol#L161-L163):
	bytes => bytes4 casting occurs in [uint256(uint32(bytes4(_data)))](src/core/libraries/decoders/MessagesDecoder.sol#L162)

src/core/libraries/decoders/MessagesDecoder.sol#L161-L163


 - [ ] ID-10
Dubious typecast in [TxsDecoder.read1(bytes,uint256)](src/core/libraries/decoders/TxsDecoder.sol#L345-L347):
	bytes => bytes1 casting occurs in [uint256(uint8(bytes1(slice(_data,_offset,1))))](src/core/libraries/decoders/TxsDecoder.sol#L346)

src/core/libraries/decoders/TxsDecoder.sol#L345-L347
...
Confidence: High
 - [ ] ID-22
[MessagesDecoder.decode(bytes)](src/core/libraries/decoders/MessagesDecoder.sol#L53-L143) uses assembly
	- [INLINE ASM](src/core/libraries/decoders/MessagesDecoder.sol#L72-L74)
	- [INLINE ASM](src/core/libraries/decoders/MessagesDecoder.sol#L105-L111)

src/core/libraries/decoders/MessagesDecoder.sol#L53-L143


 - [ ] ID-23
[TxsDecoder.computeRoot(bytes32[])](src/core/libraries/decoders/TxsDecoder.sol#L287-L306) uses assembly
	- [INLINE ASM](src/core/libraries/decoders/TxsDecoder.sol#L294-L296)

src/core/libraries/decoders/TxsDecoder.sol#L287-L306
