...
- [ ] ID-12
      ...
      External calls: - [inbox.batchConsume(l1ToL2Msgs,msg.sender)](src/core/Rollup.sol#L85) - [outbox.sendL1Messages(l2ToL1Msgs)](src/core/Rollup.sol#L88)
      Event emitted after the call(s): - [L2BlockProcessed(header.globalVariables.blockNumber)](src/core/Rollup.sol#L90)
...
- [ ] ID-13
      ...
      Dangerous comparisons: - [block.timestamp > entry.deadline](src/core/messagebridge/Inbox.sol#L136)
...
- [ ] ID-14
      ...
      Dangerous comparisons: - [\_header.globalVariables.timestamp > block.timestamp](src/core/libraries/HeaderLib.sol#L122)
...
- [ ] ID-15
      ...
      Dangerous comparisons: - [\_deadline <= block.timestamp](src/core/messagebridge/Inbox.sol#L54)
...
- [ ] ID-16
      ...
      Dangerous comparisons: - [block.timestamp <= \_message.deadline](src/core/messagebridge/Inbox.sol#L108)
...
- [ ] ID-22
      [TxsDecoder.computeRoot(bytes32[])](src/core/libraries/decoders/TxsDecoder.sol#L294-L313) uses assembly - [INLINE ASM](src/core/libraries/decoders/TxsDecoder.sol#L301-L303)

src/core/libraries/decoders/TxsDecoder.sol#L294-L313

- [ ] ID-23
      [MessagesDecoder.decode(bytes)](src/core/libraries/decoders/MessagesDecoder.sol#L60-L150) uses assembly - [INLINE ASM](src/core/libraries/decoders/MessagesDecoder.sol#L79-L81) - [INLINE ASM](src/core/libraries/decoders/MessagesDecoder.sol#L112-L118)
...
- [ ] ID-30
      Low level call in [Inbox.withdrawFees()](src/core/messagebridge/Inbox.sol#L148-L153): - [(success) = msg.sender.call{value: balance}()](src/core/messagebridge/Inbox.sol#L151)
