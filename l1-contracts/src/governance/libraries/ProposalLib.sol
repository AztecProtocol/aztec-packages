 ...
 *             - Yea votes must be > requiredApprovalVotes to pass (strict inequality to avoid ties)
 ...
 *             - Quorum met: 500 ≥ 400 ✓
 *             - Yea limit = ceil(500 * ceil(1.1e18/2) / 1e18) = ceil(500 * 0.55) = 275
 *             - Proposal passes: 300 yea > 275 yea limit ✓
 *
