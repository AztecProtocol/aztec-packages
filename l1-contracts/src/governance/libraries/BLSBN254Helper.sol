...
// Add: hashToPoint, mapToPoint, hashtofield, and constants taken from https://github.com/thehubbleproject/hubble-contracts/blob/master/contracts/libs/BLS.sol
// Add: point at infinity check for valid G1/G2
// Change: Updated comment for constant N to be base field, prev. scalar field (not audited?)
// Add: G1 Generator
...
library BLS {
  ...
  // G1 Generator
    ...
    uint256[2] constant G1 = [G1X, G1Y];
    uint256[2] constant nG1 = [G1X, N - G1Y]; // for convenience
  ...
  uint256[4] constant nG2 = [nG2x1, nG2x0, nG2y1, nG2y0];
  ...
  uint256 private constant ODD_NUM =
    ...
    bytes32 constant DST_INIT = 0x4d7950726f746f2d504f502d424e32353447312d763100000000000000000000;
