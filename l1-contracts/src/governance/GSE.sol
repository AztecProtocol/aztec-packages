...
contract GSECore is IGSECore, Ownable {
  ...
  // The amount of staking asset required to deposit an attester on the rollup.
  uint256 public constant DEPOSIT_AMOUNT = 100e18;
  // The minimum amount of staking asset required to be in the set to be considered an attester.
