...
library Constants {
  ...
  uint256 internal constant CONTRACT_STORAGE_UPDATE_REQUEST_LENGTH = 4;
  uint256 internal constant CONTRACT_STORAGE_READ_LENGTH = 3;
  uint256 internal constant PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 232;
  uint256 internal constant GET_NOTES_ORACLE_RETURN_LENGTH = 674;
  uint256 internal constant EMPTY_NULLIFIED_COMMITMENT = 1000000;
  uint256 internal constant CALL_PRIVATE_FUNCTION_RETURN_SIZE = 227;
  uint256 internal constant PUBLIC_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 145;
  uint256 internal constant PRIVATE_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 210;
