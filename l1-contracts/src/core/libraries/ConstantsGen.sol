...
library Constants {
  ...
  uint256 internal constant CONTENT_COMMITMENT_LENGTH = 3;
  ...
  uint256 internal constant COMBINED_CONSTANT_DATA_LENGTH = 42;
  uint256 internal constant PRIVATE_ACCUMULATED_DATA_LENGTH = 1144;
  uint256 internal constant PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1968;
  ...
  uint256 internal constant VM_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2470;
  uint256 internal constant KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 662;
  ...
  uint256 internal constant SLOT_NUMBER_SELECTOR = 31;
