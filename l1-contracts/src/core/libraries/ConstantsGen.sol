...
library Constants {
  ...
  uint256 internal constant COMBINED_ACCUMULATED_DATA_LENGTH = 552;
  ...
  uint256 internal constant PRIVATE_TO_PUBLIC_ACCUMULATED_DATA_LENGTH = 550;
  ...
  uint256 internal constant PRIVATE_TO_PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1143;
