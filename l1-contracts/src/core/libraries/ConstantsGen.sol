...
library Constants {
  ...
  uint256 internal constant CANONICAL_KEY_REGISTRY_ADDRESS =
    21414858474770477497924360445354039669527783524722836464452726404711895322795;
  uint256 internal constant DEPLOYER_CONTRACT_ADDRESS =
    592916725151940401704449614788758129459843145507331352293468545034454216547;
  uint256 internal constant REGISTERER_CONTRACT_ADDRESS =
    17003886560895840142619672952684306678521880458513576014184194934333315632430;
  uint256 internal constant GAS_TOKEN_ADDRESS =
    20909639093745312012024674145221445992719764713152958135577556496795041149213;
