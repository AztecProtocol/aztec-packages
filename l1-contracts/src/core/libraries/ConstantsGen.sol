...
library Constants {
  ...
  uint256 internal constant MAX_PRIVATE_LOG_SIZE_IN_BYTES = 558;
  ...
  uint256 internal constant PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 746;
  ...
  uint256 internal constant PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2897;
  ...
  uint256 internal constant PRIVATE_TO_PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2996;
  uint256 internal constant KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1531;
