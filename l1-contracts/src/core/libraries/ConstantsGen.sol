...
library Constants {
  ...
  uint256 internal constant COMBINED_ACCUMULATED_DATA_LENGTH = 245;
  uint256 internal constant COMBINED_CONSTANT_DATA_LENGTH = 40;
  uint256 internal constant CALL_REQUEST_LENGTH = 7;
  uint256 internal constant PRIVATE_ACCUMULATED_DATA_LENGTH = 1184;
  uint256 internal constant PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2771;
  uint256 internal constant PUBLIC_ACCUMULATED_DATA_LENGTH = 895;
  uint256 internal constant PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 3594;
  uint256 internal constant KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 295;
