...
library Constants {
  ...
  uint256 internal constant NOTE_HASHES_NUM_BYTES_PER_BASE_ROLLUP = 32 * MAX_NEW_NOTE_HASHES_PER_TX;
  uint256 internal constant NULLIFIERS_NUM_BYTES_PER_BASE_ROLLUP = 32 * MAX_NEW_NULLIFIERS_PER_TX;
  uint256 internal constant PUBLIC_DATA_WRITES_NUM_BYTES_PER_BASE_ROLLUP =
    64 * MAX_TOTAL_PUBLIC_DATA_UPDATE_REQUESTS_PER_TX;
