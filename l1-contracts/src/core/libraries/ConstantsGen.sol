...
library Constants {
  ...
  uint256 internal constant GLOBAL_VARIABLES_LENGTH = 7;
  uint256 internal constant HEADER_LENGTH = 26;
  ...
  uint256 internal constant PRIVATE_CALL_STACK_ITEM_LENGTH = 220;
  uint256 internal constant PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 215;
