...
library Constants {
  ...
  uint256 internal constant MAX_NEW_COMMITMENTS_PER_CALL = 32;
  uint256 internal constant MAX_NEW_NULLIFIERS_PER_CALL = 32;
  ...
  uint256 internal constant MAX_READ_REQUESTS_PER_CALL = 128;
  uint256 internal constant MAX_NEW_COMMITMENTS_PER_TX = 128;
  uint256 internal constant MAX_NEW_NULLIFIERS_PER_TX = 128;
  ...
  uint256 internal constant MAX_READ_REQUESTS_PER_TX = 512;
  ...
  uint256 internal constant PRIVATE_DATA_SUBTREE_HEIGHT = 8;
  uint256 internal constant PRIVATE_DATA_SUBTREE_SIBLING_PATH_LENGTH = 24;
  uint256 internal constant NULLIFIER_SUBTREE_HEIGHT = 8;
  uint256 internal constant HISTORIC_BLOCKS_TREE_HEIGHT = 16;
  uint256 internal constant NULLIFIER_SUBTREE_SIBLING_PATH_LENGTH = 8;
  ...
  uint256 internal constant PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 266;
  uint256 internal constant CONTRACT_STORAGE_UPDATE_REQUEST_LENGTH = 3;
  uint256 internal constant CONTRACT_STORAGE_READ_LENGTH = 2;
  uint256 internal constant PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 173;
  uint256 internal constant GET_NOTES_ORACLE_RETURN_LENGTH = 2690;
  uint256 internal constant EMPTY_NULLIFIED_COMMITMENT = 1000000;
  uint256 internal constant CALL_PRIVATE_FUNCTION_RETURN_SIZE = 272;
  uint256 internal constant PUBLIC_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 119;
  uint256 internal constant PRIVATE_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 256;
  uint256 internal constant COMMITMENTS_NUM_BYTES_PER_BASE_ROLLUP = 8192;
  uint256 internal constant NULLIFIERS_NUM_BYTES_PER_BASE_ROLLUP = 8192;
