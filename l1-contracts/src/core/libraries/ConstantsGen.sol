...
library Constants {
  ...
  uint256 internal constant CONSTANT_ROLLUP_DATA_LENGTH =
    APPEND_ONLY_TREE_SNAPSHOT_LENGTH + 1 + 1 + 1 + 1 + GLOBAL_VARIABLES_LENGTH;
  uint256 internal constant BASE_OR_MERGE_PUBLIC_INPUTS_LENGTH = 1 + 1 + CONSTANT_ROLLUP_DATA_LENGTH
    + PARTIAL_STATE_REFERENCE_LENGTH + PARTIAL_STATE_REFERENCE_LENGTH + 1 + 1;
