...
library Constants {
  ...
  uint256 internal constant HONK_VERIFICATION_KEY_LENGTH_IN_FIELDS = 127;
  uint256 internal constant ROLLUP_HONK_VERIFICATION_KEY_LENGTH_IN_FIELDS = 138;
  uint256 internal constant CLIENT_IVC_VERIFICATION_KEY_LENGTH_IN_FIELDS = 142;
