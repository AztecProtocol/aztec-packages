...
library Constants {
  ...
  uint256 internal constant PRIVATE_LOG_LENGTH = 19;
  uint256 internal constant PRIVATE_LOG_DATA_LENGTH = 21;
  uint256 internal constant SCOPED_PRIVATE_LOG_DATA_LENGTH = 22;
  uint256 internal constant PUBLIC_LOG_SIZE_IN_FIELDS = 13;
  uint256 internal constant PUBLIC_LOG_LENGTH = 15;
  uint256 internal constant CONTRACT_CLASS_LOG_SIZE_IN_FIELDS = 3019;
  uint256 internal constant CONTRACT_CLASS_LOG_LENGTH = 3021;
  uint256 internal constant LOG_HASH_LENGTH = 2;
  uint256 internal constant COUNTED_LOG_HASH_LENGTH = 3;
  uint256 internal constant SCOPED_LOG_HASH_LENGTH = 3;
  uint256 internal constant SCOPED_COUNTED_LOG_HASH_LENGTH = 4;
