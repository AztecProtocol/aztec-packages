...
library Constants {
  ...
  uint256 internal constant COMMITMENTS_NUM_BYTES_PER_ROLLUP =
    KERNELS_PER_ROLLUP * COMMITMENTS_PER_TX * 0x20;
  uint256 internal constant NULLIFIERS_NUM_BYTES_PER_ROLLUP =
    KERNELS_PER_ROLLUP * NULLIFIERS_PER_TX * 0x20;
  uint256 internal constant PUBLIC_DATA_WRITES_NUM_BYTES_PER_ROLLUP =
    KERNELS_PER_ROLLUP * PUBLIC_DATA_WRITES_PER_TX * 0x40;
  uint256 internal constant CONTRACTS_NUM_BYTES_PER_ROLLUP =
