...
import BlankContractArtifactJson from '../src/contracts/target/blank-Blank.json' assert { type: 'json' };
export const BlankContractArtifact = loadContractArtifact(BlankContractArtifactJson as NoirCompiledContract);
