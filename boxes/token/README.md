...
This box is a one-stop-shop for Aztec that will deploy a full React web page featuring a wallet. You can use it as a boilerplate to start developing your own Aztec app in seconds!
