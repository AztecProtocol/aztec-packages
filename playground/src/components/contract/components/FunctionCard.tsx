...
import { ConfigureInteractionDialog } from '../../../wallet/embedded/components/ConfigureInteractionDialog';
import { CreateAuthwitDialog } from '../../../wallet/embedded/components/CreateAuthwitDialog';
