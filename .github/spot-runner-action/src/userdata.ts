...
export class UserData {
  ...
  async getUserDataForGithubRunners(): Promise<string> {
    ...
    const setupRunnerCmds = [
      ...
      "export ACTIONS_RUNNER_HOOK_JOB_COMPLETED=~/delay_shutdown.sh",
      "mkdir -p actions-runner && cd actions-runner",
      'echo "ACTIONS_RUNNER_HOOK_JOB_STARTED=~/delay_shutdown.sh" > .env',
      'echo "ACTIONS_RUNNER_HOOK_JOB_COMPLETED=~/delay_shutdown.sh" > .env',
