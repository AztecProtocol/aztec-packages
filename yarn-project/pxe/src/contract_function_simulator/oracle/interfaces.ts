...
import type { ContractClassLog, MessageContext, PendingTaggedLog } from '@aztec/stdlib/logs';
...
export interface IPrivateExecutionOracle {
  ...
  getAppTaggingSecret(sender: AztecAddress, recipient: AztecAddress): Promise<Fr>;
  getNextTaggingIndex(secret: Fr, mode: number): Promise<number>;
}
