...
describe('Private Execution test suite', () => {
  ...
  const runSimulator = async ({
    ...
    return acirSimulator.run(txRequest, contractAddress, selector, msgSender, senderForTags, undefined, TEST_JOB_ID);
  };
  ...
  describe('consuming messages', () => {
    ...
    describe('L1 to L2', () => {
      ...
      it('Invalid membership proof', async () => {
        ...
        // Mock the store to return the previous block header
        anchorBlockStore.getBlockHeader.mockResolvedValue(previousAnchorBlock);
