...
export class PrivateExecutionOracle extends UtilityExecutionOracle implements IPrivateExecutionOracle {
  ...
  public privateValidatePublicCalldata(calldataHash: Fr) {
  ...
  public privateNotifyRevertiblePhaseStart(minRevertibleSideEffectCounter: number): Promise<void> {
    return this.noteCache.setMinRevertibleSideEffectCounter(minRevertibleSideEffectCounter);
  }

  public privateInRevertiblePhase(sideEffectCounter: number): Promise<boolean> {
