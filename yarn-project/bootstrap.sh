...
function bench_cmds {
  ...
  echo "$hash BENCH_OUTPUT=bench-out/tag_sync.bench.json yarn-project/scripts/run_test.sh pxe/src/tagging/recipient_sync/sync_tagged_private_logs.bench.test.ts"
