...
function bench_cmds {
  ...
  echo "$hash BENCH_OUTPUT=bench-out/p2p_client_proposal_tx_collector.bench.json yarn-project/scripts/run_test.sh p2p/src/client/test/p2p_client.proposal_tx_collector_bench.test.ts"
