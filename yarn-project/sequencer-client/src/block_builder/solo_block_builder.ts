...
import { LowNullifierWitnessData, MerkleTreeOperations } from '@aztec/world-state';
...
export class SoloBlockBuilder implements BlockBuilder {
  ...
  protected async buildBaseRollupInput(left: ProcessedTx, right: ProcessedTx) {
    ...
    const [nullifierWitnesses, newNullifiersSubtreeSiblingPath] = await this.db.performBaseRollupBatchInsertionProofs(
