...
export type PublisherConfig = L1TxUtilsConfig &
  BlobClientConfig & {
    ...
    /** Min ETH balance (in wei) below which a publisher gets funded. Undefined = funding disabled. */
    publisherFundingThreshold?: bigint;
    /** Amount of ETH (in wei) to send when funding a publisher. Undefined = funding disabled. */
