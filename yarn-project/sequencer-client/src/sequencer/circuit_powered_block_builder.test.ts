...
import { makeBaseRollupPublicInputs, makePrivateKernelPublicInputs, makeRootRollupPublicInputs } from "@aztec/circuits.js/factories";
...
describe('sequencer/circuit_block_builder', () => {
  ...
  beforeEach(async () => {
    ...
    prover = mock<Prover>();
    builder = new TestSubject(
      db, blockNumber, vks, simulator, prover
    );
