...
export class Tx {
  ...
  protected constructor(
     ...
     */
    public readonly encryptedLogs?: EventLogs,
    /**
     * Unencrypted logs generated by the tx.
     */
    // public readonly unencryptedLogs?: EventLogs,
    /**
  ...
  public static createPrivate(
    ...
    proof: Proof,
    encryptedLogs: EventLogs,
    // unencryptedLogs: EventLogs,
  ...
  static clone(tx: Tx): Tx {
    ...
    const encryptedLogs =
      tx.encryptedLogs === undefined ? undefined : EventLogs.fromBuffer(tx.encryptedLogs.toBuffer());
