...
describe('EncryptedLogPayload', () => {
  describe('encrypt and decrypt a full log', () => {
    ...
    beforeAll(() => {
      ...
      const publicValuesAppended = Math.random() > 0.5; // random boolean
      original = new EncryptedLogPayload(
        PLACEHOLDER_TAG,
        PLACEHOLDER_TAG,
  ...
  it('encrypted tagged log matches Noir', () => {
    ...
    const publicValuesAppended = true;
    const log = new EncryptedLogPayload(new Fr(0), new Fr(0), publicValuesAppended, contract, plaintext);
    ...
    expect(encrypted).toMatchInlineSnapshot(
      `""`,
    );
