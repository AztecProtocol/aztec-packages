import { AztecAddress, Fr, NotOnCurveError, Point, PrivateLog, derivePublicKeyFromSecretKey } from '@aztec/circuits.js';
import type { GrumpkinScalar } from '@aztec/circuits.js';
