...
export type ProvingRequestResultFor<T extends ProvingRequestType> = { type: T; result: ProvingRequestResults[T] };

export type ProvingRequestResult = {
  [K in keyof ProvingRequestResults]: { type: K; result: ProvingRequestResults[K] };
}[keyof ProvingRequestResults];
