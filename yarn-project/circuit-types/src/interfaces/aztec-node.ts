...
export interface AztecNode
   ...
   * array implies no logs match that tag. There can be multiple logs for 1 tag because it could happen that a tag
   * would be reused --> e.g. when sending a note from multiple unsynched devices.
   */
