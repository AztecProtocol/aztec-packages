...
import { EncryptedEventTxL2Logs, EncryptedNoteTxL2Logs, UnencryptedTxL2Logs } from '../logs/tx_l2_logs.js';
...
export class Tx {
  constructor(
     ...
     */
    public readonly encryptedLogs: EncryptedEventTxL2Logs,
    /**
  ...
  public static fromJSON(obj: any) {
    ...
    const encryptedLogs = EncryptedEventTxL2Logs.fromBuffer(Buffer.from(obj.encryptedLogs, 'hex'));
  ...
  static clone(tx: Tx): Tx {
    ...
    const encryptedLogs = EncryptedEventTxL2Logs.fromBuffer(tx.encryptedLogs.toBuffer());
