...
import { type ClientIvcProof } from '../interfaces/proof_creator.js';
...
export class Tx {
  constructor(
     ...
     */
    // LONDONTODO: we assume these are the publics inputs to decider recursive verifier in tube
    public readonly data: PrivateKernelTailCircuitPublicInputs,
    /**
     * Proof from the private kernel circuit.
     */
    // LONDONTODO(Client): This becomes a ClientIVC proof.
    public readonly proof: Proof,

    // LONDONTODO(Client): Temporarily adding a ClientIVC proof member to avoid refactoring.
    public readonly clientIvcProof: ClientIvcProof|undefined,
    /**
  ...
  static fromBuffer(buffer: Buffer | BufferReader): Tx {
    ...
    return new Tx(
      ...
      undefined, // LONDONTODO no serialization for ClientIvcProof yet
