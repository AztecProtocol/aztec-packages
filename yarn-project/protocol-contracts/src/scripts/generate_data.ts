...
function generateLogTags() {
  return `
    ...
    export const REGISTERER_CONTRACT_CLASS_REGISTERED_TAG = Fr.fromString('${poseidon2Hash([
      REGISTERER_CONTRACT_ADDRESS,
      REGISTERER_CONTRACT_CLASS_REGISTERED_MAGIC_VALUE,
    ])}');
    export const REGISTERER_PRIVATE_FUNCTION_BROADCASTED_TAG = Fr.fromString('${poseidon2Hash([
      DEPLOYER_CONTRACT_ADDRESS,
      REGISTERER_PRIVATE_FUNCTION_BROADCASTED_MAGIC_VALUE,
    ])}');
    export const REGISTERER_UNCONSTRAINED_FUNCTION_BROADCASTED_TAG = Fr.fromString('${poseidon2Hash([
      DEPLOYER_CONTRACT_ADDRESS,
      REGISTERER_UNCONSTRAINED_FUNCTION_BROADCASTED_MAGIC_VALUE,
    ])}');
  `;
