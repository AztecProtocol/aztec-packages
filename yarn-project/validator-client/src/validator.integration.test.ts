...
describe('ValidatorClient Integration', () => {
  ...
  describe('happy path', () => {
    ...
    it('validates and attests with txs anchored to proposed blocks and non-empty l1-to-l2 messages', async () => {
      ...
      await proposer.archiver.dataStores.messageStore.addL1ToL2Messages(l1ToL2Messages);
      await attestor.archiver.dataStores.messageStore.addL1ToL2Messages(l1ToL2Messages);
  ...
  describe('failure conditions', () => {
    ...
    it('refuses block proposal with mismatching l1 to l2 messages', async () => {
      ...
      await attestor.archiver.dataStores.messageStore.addL1ToL2Messages(otherL1ToL2Messages);
