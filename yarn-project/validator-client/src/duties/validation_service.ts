import { BlockAttestation, BlockProposal, ConsensusPayload, SignatureDomainSeperator, type TxHash } from '@aztec/circuit-types';
...
export class ValidationService {
  ...
  async attestToProposal(proposal: BlockProposal): Promise<BlockAttestation> {
    ...
    const buf = Buffer32.fromBuffer(keccak256(proposal.payload.getPayloadToSign(SignatureDomainSeperator.blockAttestation)));
