...
export class KernelProver {
  ...
  //   return new UInt8Vector(Buffer.alloc(256));
  // }

  // private makeFakeAggregationObject() {
  //   return new AggregationObject(
  //     new AffineElement(new Fq(1n), new Fq(2n)),
  //     new AffineElement(new Fq(1n), new Fq(2n)),
  //     [],
  //     Array(16).fill(0).map((_, i) => i + 3027),
  //     false,
  //   );
  // }

  // private makeFakeVerificationKey() {
  ...
  //     this.makeProofData(),
  //     this.makeFakeVerificationKey(),
  //     0x42,
  //     Array(VK_TREE_HEIGHT).fill(0).map(() => new Fr(0n)),
  //   );
  // }
}
