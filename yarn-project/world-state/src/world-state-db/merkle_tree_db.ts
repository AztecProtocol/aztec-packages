...
export interface MerkleTreeAdminDatabase {
   ...
   */
  handleL2BlockAndMessages(block: L2Block, l1ToL2Messages: Fr[]): Promise<WorldStateStatusSummary>;
   ...
   */
  removeHistoricalBlocks(toBlockNumber: bigint): Promise<WorldStateStatusSummary>;
   ...
   * @returns The new WorldStateStatus
   */
  unwindBlocks(toBlockNumber: bigint): Promise<WorldStateStatusSummary>;
