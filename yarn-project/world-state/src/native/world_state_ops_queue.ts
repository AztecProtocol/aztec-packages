...
// These operations require exclusive access to their given forks.
export const MUTATING_OPERATIONS = new Set<WorldStateOperationName>([
  'appendLeaves',
  'batchInsert',
  'sequentialInsert',
  'updateArchive',
...
export class WorldStateOpsQueue {
  ...
  public execute(request: () => Promise<any>, operation: WorldStateOperationName, committedOnly: boolean) {
