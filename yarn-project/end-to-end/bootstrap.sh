...
function avm_check_circuit_cmds {
  ...
  # Specify timeout and resources. Large e2e transactions, such as multi-blob block-building inputs,
  # can exceed the old 30s cap while still being valid, so keep the timeout configurable.
