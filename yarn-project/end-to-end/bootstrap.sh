...
function avm_check_circuit_cmds {
  ...
  # Larger public-input cases, such as multiple-blob transactions, can exceed 30s while still making
  # progress. Keep a per-input timeout to catch stuck checks, but leave enough headroom for them.
