...
function test_cmds {
  ...
  echo "$prefix:TIMEOUT=25m:NAME=e2e_block_building $dump_avm $run_test_script simple e2e_block_building"
  dump_avm=""
  [ -n "$dump_avm_base" ] && dump_avm="DUMP_AVM_INPUTS_TO_DIR=$dump_avm_base/e2e_avm_simulator"
  echo "$prefix:TIMEOUT=30m:NAME=e2e_avm_simulator $dump_avm $run_test_script simple src/e2e_avm_simulator.test.ts"
