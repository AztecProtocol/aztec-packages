...
function avm_check_circuit_cmds {
  ...
  # The heaviest dumped tx (e2e_multiple_blobs with emit_full_size_public_log) takes ~20s on a
  # 4-vCPU ubuntu-latest runner, so 30s left no headroom and started timing out on slow runners.
