...
function bench_cmds {
  ...
  echo "$hash:ISOLATE=1:NAME=tx_stats BENCH_OUTPUT=bench-out/tx_stats.bench.json BB_IVC_CONCURRENCY=1 BB_NUM_IVC_VERIFIERS=8 yarn-project/end-to-end/scripts/run_test.sh simple tx_stats_bench"
