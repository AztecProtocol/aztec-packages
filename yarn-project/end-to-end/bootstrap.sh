...
function avm_check_circuit_cmds {
  ...
  # In that case, they might start timing out. Large generated traces, such as multi-blob txs,
  # can need more than 30s while still fitting in the default memory limit.
