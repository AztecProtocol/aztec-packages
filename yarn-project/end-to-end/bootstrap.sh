...
function avm_check_circuit_cmds {
  ...
  # In that case, they might start timing out. The e2e_block_building inputs can generate traces that
  # exceed 30 seconds on CI, so keep a bounded but less aggressive per-input timeout.
