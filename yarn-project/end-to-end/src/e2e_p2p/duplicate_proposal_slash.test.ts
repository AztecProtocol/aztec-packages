...
const BLOCK_DURATION = undefined;
const AZTEC_SLOT_DURATION = ETHEREUM_SLOT_DURATION * (BLOCK_DURATION === undefined ? 2 : 3);
  ...
  beforeEach(async () => {
    t = await P2PNetworkTest.create({
      ...
      initialConfig: {
        ...
        blockDurationMs: BLOCK_DURATION === undefined ? undefined : BLOCK_DURATION * 1000,
