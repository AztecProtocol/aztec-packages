    ...
    t = await P2PNetworkTest.create({
      ...
      initialConfig: {
        env: {
          ...
          SEQ_BLOCK_DURATION_MS: String(BLOCK_DURATION * 1000),
          SEQ_L1_PUBLISHING_TIME_ALLOWANCE_IN_SLOT: '1',
          SLASH_DUPLICATE_PROPOSAL_PENALTY: String(slashingUnit),
          SLASH_DUPLICATE_ATTESTATION_PENALTY: String(slashingUnit),
