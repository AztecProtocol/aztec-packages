    ...
    t = await P2PNetworkTest.create({
      ...
      initialConfig: {
        env: {
          ...
          AZTEC_SLASHING_OFFSET_IN_ROUNDS: String(SLASH_OFFSET_IN_ROUNDS),
          ...
          AZTEC_SLASHING_ROUND_SIZE_IN_EPOCHS: String(SLASHING_ROUND_SIZE / EPOCH_DURATION),
          AZTEC_SLASHING_QUORUM: String(SLASHING_QUORUM),
          SLASH_INACTIVITY_TARGET_PERCENTAGE: String(SLASH_INACTIVITY_TARGET_PERCENTAGE),
          SLASH_SELF_ALLOWED: 'true',
        },
