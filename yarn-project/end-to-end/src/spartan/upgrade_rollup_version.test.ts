...
describe('spartan_upgrade_rollup_version', () => {
  ...
  it(
    ...
    async () => {
      ...
      // TODO: https://github.com/AztecProtocol/aztec-packages/issues/12160
      // We should still be building blocks on the old rollup
      ...
      await expect(
        retryUntil(
          ...
          config.AZTEC_PROOF_SUBMISSION_WINDOW * config.AZTEC_SLOT_DURATION,
          5,
        ),
      ).resolves.toBe(true);
    },
