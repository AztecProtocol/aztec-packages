...
export const cliTestSuite = (
  ...
  describe(name, () => {
    ...
    it('creates & retrieves an account', async () => {
      existingAccounts = await pxeClient.getRegisteredAccounts();
      ...
      const accountsAfter = await pxeClient.getRegisteredAccounts();
    ...
    it('deploys a contract & sends transactions', async () => {
      ...
      const deployedContract = await pxeClient.getContractData(contractAddress);
      ...
      const existingAccounts = await pxeClient.getRegisteredAccounts();
