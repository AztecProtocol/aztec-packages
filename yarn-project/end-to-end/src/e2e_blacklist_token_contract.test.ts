...
describe('e2e_blacklist_token_contract', () => {
  ...
  const updateSlowTree = async (tree: SparseTree, wallet: Wallet, index: AztecAddress, value: bigint) => {
    await wallet.addMint(getUpdateMint(await getUpdateProof(value, index.toBigInt())));
  ...
  describe('Transfer', () => {
    ...
    describe('private', () => {
      ...
      it('transfer on behalf of other', async () => {
        ...
        await wallets[1].addMint(getMembershipMint(await getMembershipProof(accounts[1].address.toBigInt(), true)));
        await wallets[1].addMint(getMembershipMint(await getMembershipProof(accounts[0].address.toBigInt(), true)));
      ...
      describe('failure cases', () => {
        ...
        it('transfer on behalf of other, wrong designated caller', async () => {
          ...
          await wallets[2].addMint(getMembershipMint(await getMembershipProof(accounts[1].address.toBigInt(), true)));
          await wallets[2].addMint(getMembershipMint(await getMembershipProof(accounts[0].address.toBigInt(), true)));
