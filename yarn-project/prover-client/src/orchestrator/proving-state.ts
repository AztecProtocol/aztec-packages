...
export class ProvingState {
  ...
  private rootParityInputs: Array<RootParityInput<typeof RECURSIVE_PROOF_LENGTH_IN_FIELDS> | undefined> = [];
  private finalRootParityInputs: RootParityInput<typeof NESTED_RECURSIVE_PROOF_LENGTH_IN_FIELDS> | undefined;
  ...
  public set finalRootParityInput(input: RootParityInput<typeof NESTED_RECURSIVE_PROOF_LENGTH_IN_FIELDS> | undefined) {
  ...
  public setRootParityInputs(inputs: RootParityInput<typeof RECURSIVE_PROOF_LENGTH_IN_FIELDS>, index: number) {
