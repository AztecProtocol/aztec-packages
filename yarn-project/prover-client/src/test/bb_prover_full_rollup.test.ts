...
import { NUMBER_OF_L1_L2_MESSAGES_PER_ROLLUP, PAIRING_POINT_ACCUMULATOR_SIZE } from '@aztec/constants';
  ...
  it.each([
    ...
    async (blockCount, totalBlocks, nonEmptyTxs, totalTxs) => {
      ...
      if (prover) {
        ...
        epochResult.proof.numPublicInputs -= PAIRING_POINT_ACCUMULATOR_SIZE;
