...
describe('p2p client integration', () => {
  ...
  describe('BlockTxs protocol', () => {
    ...
    it(
      'responds with NOT_FOUND when peer does not have the requested block proposal',
      async () => {
    ...
    it(
      "responds with FAILURE when block numbers don't match",
      async () => {
    ...
    describe('when the peer has the block proposal', () => {
      ...
      it(
        'responds with all requested txs when the peer has them',
        async () => {
      ...
      it(
        'responds with partial txs when the peer has only some of them',
        async () => {
      ...
      it(
        'responds with empty txs when the peer has none of the requested txs',
        async () => {
