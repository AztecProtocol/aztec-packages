...
describe('SlasherOffensesStore', () => {
  ...
  describe('addOffense', () => {
    ...
    it('should preserve offense data across store operations', async () => {
      ...
      const offense = createOffense(validator, 12345n, OffenseType.PROPOSED_DESCENDANT_OF_INVALID, 54321n);
      ...
      expect(pendingOffenses[0].offenseType).toBe(OffenseType.PROPOSED_DESCENDANT_OF_INVALID);
