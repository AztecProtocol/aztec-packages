...
import { PublicKernelData } from '../kernel/public_kernel_data.js';
...
export class ConstantRollupData {
  ...
  static getFields(fields: FieldsOf<ConstantRollupData>) {
    return [fields.lastArchive, fields.baseRollupVkHash, fields.mergeRollupVkHash, fields.globalVariables] as const;
  }
...
export class BaseRollupInputs {
  constructor(
    ...
    public kernelData: PublicKernelData,
