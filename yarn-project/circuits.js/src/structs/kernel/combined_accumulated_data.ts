...
/**
 * Data that is accumulated during the execution of the private kernel.
 */
...
/**
 * Data that is accumulated during the execution of the public kernel.
 */
export class PublicAccumulatedData {
   ...
   */
  static fromString(str: string) {
    return PublicAccumulatedData.fromBuffer(Buffer.from(str, 'hex'));
  }
 ...
 */
export class PrivateAccumulatedDataFinal {
  constructor(
    /**
     * Aggregated proof of all the previous kernel iterations.
     */
   ...
   * @returns Deserialized object.
   */
  static fromBuffer(buffer: Buffer | BufferReader): PrivateAccumulatedDataFinal {
    const reader = BufferReader.asReader(buffer);
   ...
   */
  static fromString(str: string) {
    return PrivateAccumulatedDataFinal.fromBuffer(Buffer.from(str, 'hex'));
  }
