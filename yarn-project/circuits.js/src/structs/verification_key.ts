...
export class VerificationKeyAsFields {
   ...
   */
  static makeFake(len = VERIFICATION_KEY_LENGTH_IN_FIELDS): VerificationKeyAsFields {
    return new VerificationKeyAsFields(makeTuple(len, Fr.random), Fr.random());
  }
   ...
   */
  static makeEmpty(len = VERIFICATION_KEY_LENGTH_IN_FIELDS): VerificationKeyAsFields {
    return new VerificationKeyAsFields(makeTuple(len, Fr.zero), Fr.zero());
  }
}
...
export class VerificationKeyData {
  ...
  static makeFake(len = VERIFICATION_KEY_LENGTH_IN_FIELDS): VerificationKeyData {
