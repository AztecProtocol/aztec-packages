...
export const MAX_NEW_COMMITMENTS_PER_TX = 16; // PRIVATE_CALL_STACK_LENGTH * MAX_NEW_COMMITMENTS_PER_CALL
export const MAX_NEW_NULLIFIERS_PER_TX = 16; // PRIVATE_CALL_STACK_LENGTH * MAX_NEW_NULLIFIERS_PER_CALL
