import { CircuitError, MAX_KERNEL_PUBLIC_DATA_READS_PER_TX, makeTuple, simulatePublicKernelCircuit } from '../index.js';
...
describe('kernel/public_kernel', () => {
  ...
  it('simulating public kernel circuit fails when aggregating proofs will overflow', async function () {
    ...
    const fullStateReadsObject = makeTuple(MAX_KERNEL_PUBLIC_DATA_READS_PER_TX, makePublicDataRead, 0x01);
