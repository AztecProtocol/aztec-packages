...
export const MAX_PUBLIC_DATA_UPDATE_REQUESTS_PER_TX = 127;
export const PROTOCOL_PUBLIC_DATA_UPDATE_REQUESTS_PER_TX = 1;
export const MAX_TOTAL_PUBLIC_DATA_UPDATE_REQUESTS_PER_TX = 128;
...
export const PUBLIC_DATA_SUBTREE_HEIGHT = 7;
export const ARCHIVE_HEIGHT = 16;
export const NULLIFIER_SUBTREE_SIBLING_PATH_LENGTH = 14;
export const PUBLIC_DATA_SUBTREE_SIBLING_PATH_LENGTH = 33;
...
<<<<<<< HEAD
export const COMBINED_ACCUMULATED_DATA_LENGTH = 519;
...
export const PUBLIC_ACCUMULATED_DATA_LENGTH = 1169;
export const PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 4142;
export const KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 569;
=======
...
export const PUBLIC_DATA_WRITES_NUM_BYTES_PER_BASE_ROLLUP = 8192;
