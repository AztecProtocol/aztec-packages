...
export const IPA_PROOF_LENGTH = 129;
export const RECURSIVE_PROOF_LENGTH = 602;
export const NESTED_RECURSIVE_PROOF_LENGTH = 602;
export const TUBE_PROOF_LENGTH = 602;
