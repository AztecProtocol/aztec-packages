...
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 123;
...
export const CALL_PRIVATE_FUNCTION_RETURN_SIZE = 129;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 87;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 112 + 32 + 16 + 16 * 2; // adding side effect counters
...
export enum GeneratorIndex {
  ...
  BLOCK_HASH = 28,
  SIDE_EFFECT = 29,
  SIDE_EFFECT_LINKED_TO_NOTE_HASH = 30,
  SIDE_EFFECT_WITH_RANGE = 31,
  TX_REQUEST = 33,
