...
export const KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH =
  ...
  1 +
  AZTEC_ADDRESS_LENGTH;
export const CONSTANT_ROLLUP_DATA_LENGTH = APPEND_ONLY_TREE_SNAPSHOT_LENGTH + 1 + 1 + 1 + 1 + GLOBAL_VARIABLES_LENGTH;
export const BASE_OR_MERGE_PUBLIC_INPUTS_LENGTH =
  1 + 1 + CONSTANT_ROLLUP_DATA_LENGTH + PARTIAL_STATE_REFERENCE_LENGTH + PARTIAL_STATE_REFERENCE_LENGTH + 1 + 1;
