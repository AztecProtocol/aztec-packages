...
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 673;
export const PRIVATE_CALL_STACK_ITEM_LENGTH = 503;
...
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1887;
export const PUBLIC_ACCUMULATED_DATA_LENGTH = 1055;
export const NUM_PUBLIC_ACCUMULATED_DATA_ARRAYS = 8;
export const PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2996;
export const VM_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2373;
...
export const AVM_PUBLIC_INPUTS_FLATTENED_SIZE = 2721;
