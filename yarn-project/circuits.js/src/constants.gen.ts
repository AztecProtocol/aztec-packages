...
export const MAX_ENCRYPTED_LOGS_PER_CALL = 2;
export const MAX_UNENCRYPTED_LOGS_PER_CALL = 2;
...
export const PRIVATE_CALL_STACK_ITEM_LENGTH = 217;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 213;
