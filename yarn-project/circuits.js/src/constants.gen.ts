...
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 499;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 865;
export const PRIVATE_CALL_STACK_ITEM_LENGTH = 502;
...
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1877;
...
export const PRIVATE_TO_PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1198;
...
export const BASE_OR_MERGE_PUBLIC_INPUTS_LENGTH = 51;
export const BLOCK_ROOT_OR_BLOCK_MERGE_PUBLIC_INPUTS_LENGTH = 156;
export const ROOT_ROLLUP_PUBLIC_INPUTS_LENGTH = 140;
...
export const AVM_PROOF_LENGTH_IN_FIELDS = 4176;
export const AVM_PUBLIC_COLUMN_MAX_SIZE = 1024;
export const AVM_PUBLIC_INPUTS_FLATTENED_SIZE = 2913;
...
export const NOTE_ENCRYPTED_LOGS_PREFIX = 7;
export const ENCRYPTED_LOGS_PREFIX = 8;
export const UNENCRYPTED_LOGS_PREFIX = 9;
