...
export const COMBINED_ACCUMULATED_DATA_LENGTH = 552;
...
export const PRIVATE_TO_PUBLIC_ACCUMULATED_DATA_LENGTH = 550;
...
export const PRIVATE_TO_PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1143;
