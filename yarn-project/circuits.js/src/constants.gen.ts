...
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 188;
...
export const CALL_PRIVATE_FUNCTION_RETURN_SIZE = 194;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 87;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 176;
