...
export const DEPLOYER_CONTRACT_ADDRESS = 0x06d4e6f227dd9ff2e9e2b9e9df4fb4f650a1776499a7acc0d273f5dbb2704d59n;
...
export const PRIVATE_CALL_STACK_ITEM_LENGTH = 225;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 221;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 205;
