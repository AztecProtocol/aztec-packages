...
export const MAX_PUBLIC_DATA_WRITES_PER_CALL = 16;
...
export const MAX_PUBLIC_DATA_WRITES_PER_TX = 16;
...
export const STORAGE_WRITE_LENGTH = 3;
export const STORAGE_READ_LENGTH = 2;
