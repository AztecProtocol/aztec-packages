...
export const MAX_NEW_L2_TO_L1_MSGS_PER_TX = 16;
...
export const COMBINED_ACCUMULATED_DATA_LENGTH = 245;
export const COMBINED_CONSTANT_DATA_LENGTH = 40;
export const CALL_REQUEST_LENGTH = 7;
export const PRIVATE_ACCUMULATED_DATA_LENGTH = 1184;
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2771;
export const PUBLIC_ACCUMULATED_DATA_LENGTH = 895;
export const PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 3594;
export const KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 295;
...
export const L2_TO_L1_MSGS_NUM_BYTES_PER_BASE_ROLLUP = 512;
