...
export const MAX_PHASE_TRANSITIONS_PER_CALL = 3;
...
export const MAX_PHASE_TRANSITIONS_PER_TX = 3;
...
export const PHASE_FEE_PREP = 1;
export const PHASE_APPLICATION_LOGIC = 2;
export const PHASE_FEE_DISTRIBUTION = 3;
...
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 195;
...
export const CALL_PRIVATE_FUNCTION_RETURN_SIZE = 205;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 87;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 183;
