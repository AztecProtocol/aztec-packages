...
export const MAX_NON_REVERTIBLE_PUBLIC_DATA_UPDATE_REQUESTS_PER_TX = 4;
export const MAX_REVERTIBLE_PUBLIC_DATA_UPDATE_REQUESTS_PER_TX = 12;
export const MAX_PUBLIC_DATA_READS_PER_TX = 16;
export const MAX_NON_REVERTIBLE_PUBLIC_DATA_READS_PER_TX = 4;
export const MAX_REVERTIBLE_PUBLIC_DATA_READS_PER_TX = 12;
