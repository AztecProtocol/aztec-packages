...
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2898;
...
export const PRIVATE_TO_PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2997;
export const KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1532;
