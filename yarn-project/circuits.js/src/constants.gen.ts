...
export const PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 3125;
export const VM_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2470;
export const KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 662;
export const CONSTANT_ROLLUP_DATA_LENGTH = 12;
export const FEE_RECIPIENT_LENGTH = 2;
export const BASE_OR_MERGE_PUBLIC_INPUTS_LENGTH = 50;
