...
export const COMBINED_ACCUMULATED_DATA_LENGTH = 545;
...
export const PRIVATE_TO_PUBLIC_ACCUMULATED_DATA_LENGTH = 576;
...
export const PRIVATE_TO_PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1196;
