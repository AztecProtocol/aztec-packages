...
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 187;
...
export const CALL_PRIVATE_FUNCTION_RETURN_SIZE = 193;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 86;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 175;
