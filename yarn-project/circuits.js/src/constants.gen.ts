...
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 392;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 481;
export const PRIVATE_CALL_STACK_ITEM_LENGTH = 395;
...
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2163;
