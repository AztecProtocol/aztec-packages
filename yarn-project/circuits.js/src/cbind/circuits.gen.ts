...
export async function abisComputeArgsHash(wasm: CircuitsWasm, arg0: Tuple<Fr, 8>): Promise<Fr> {
  return Fr.fromBuffer(await callCbind(wasm, 'abis__compute_args_hash', [mapTuple(arg0, (v: Fr) => v.toBuffer())]));
}
