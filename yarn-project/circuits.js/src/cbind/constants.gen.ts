...
export const MAX_NEW_COMMITMENTS_PER_CALL = 32;
export const MAX_NEW_NULLIFIERS_PER_CALL = 32;
...
export const MAX_READ_REQUESTS_PER_CALL = 128;
export const MAX_NEW_COMMITMENTS_PER_TX = 128;
export const MAX_NEW_NULLIFIERS_PER_TX = 128;
...
export const MAX_READ_REQUESTS_PER_TX = 512;
...
export const PRIVATE_DATA_SUBTREE_HEIGHT = 8;
export const PRIVATE_DATA_SUBTREE_SIBLING_PATH_LENGTH = 24;
export const NULLIFIER_SUBTREE_HEIGHT = 8;
export const HISTORIC_BLOCKS_TREE_HEIGHT = 16;
export const NULLIFIER_SUBTREE_SIBLING_PATH_LENGTH = 8;
...
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 266;
export const CONTRACT_STORAGE_UPDATE_REQUEST_LENGTH = 3;
export const CONTRACT_STORAGE_READ_LENGTH = 2;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 173;
export const GET_NOTES_ORACLE_RETURN_LENGTH = 2690;
export const EMPTY_NULLIFIED_COMMITMENT = 1000000;
export const CALL_PRIVATE_FUNCTION_RETURN_SIZE = 272;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 119;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 256;
export const COMMITMENTS_NUM_BYTES_PER_BASE_ROLLUP = 8192;
export const NULLIFIERS_NUM_BYTES_PER_BASE_ROLLUP = 8192;
