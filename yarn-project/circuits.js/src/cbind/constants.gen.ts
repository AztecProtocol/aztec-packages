...
export const MAX_NEW_NOTE_HASHES_PER_CALL = 4;
...
export const MAX_NEW_NOTE_HASHES_PER_TX = 16;
...
export const EMPTY_NULLIFIED_NOTE_HASH = 1000000;
...
export const NOTE_HASHES_NUM_BYTES_PER_BASE_ROLLUP = 1024;
