...
export const L1_TO_L2_MESSAGE_LEN = 8;
export const L1_TO_L2_MESSAGE_ORACLE_CALL_LENGTH = 26;
export const MAX_NOTE_FIELDS_SIZE = 20;
export const GET_NOTE_ORACLE_RETURN_SIZE = 82;
export const MAX_NOTES_PER_PAGE = 10;
export const VIEW_NOTE_ORACLE_RETURN_SIZE = 202;
export const CALL_CONTEXT_SIZE = 6;
export const COMMITMENT_TREES_ROOTS_SIZE = 4;
export const FUNCTION_DATA_SIZE = 3;
export const CONTRACT_DEPLOYMENT_DATA_SIZE = 4;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 49;
export const CONTRACT_STORAGE_UPDATE_REQUEST_SIZE = 3;
export const CONTRACT_STORAGE_READ_SIZE = 2;
