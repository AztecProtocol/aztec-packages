...
export const CONTRACT_STORAGE_UPDATE_REQUEST_LENGTH = 4;
export const CONTRACT_STORAGE_READ_LENGTH = 3;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 232;
export const GET_NOTES_ORACLE_RETURN_LENGTH = 674;
export const EMPTY_NULLIFIED_COMMITMENT = 1000000;
export const CALL_PRIVATE_FUNCTION_RETURN_SIZE = 227;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 145;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_HASH_INPUT_LENGTH = 210;
