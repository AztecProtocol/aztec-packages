...
// Equals 400.
// The additional 4 and 4 are for the serialized lengths of empty logs,
// since we need to store the length of both encrypted and unencrypted logs.
export const MIN_DA_GAS_USED = new GasUsed(BigInt(FIXED_DA_GAS + 4 * DA_GAS_PER_BYTE + 4 * DA_GAS_PER_BYTE));
