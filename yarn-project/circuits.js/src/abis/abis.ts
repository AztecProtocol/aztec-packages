...
function computePrivateInputsHash(input: PrivateCircuitPublicInputs) {
  const toHash = [
    ...
    input.historicalBlockData.noteHashTreeRoot.toBuffer(),
    input.historicalBlockData.nullifierTreeRoot.toBuffer(),
    input.historicalBlockData.contractTreeRoot.toBuffer(),
    input.historicalBlockData.l1ToL2MessagesTreeRoot.toBuffer(),
    input.historicalBlockData.blocksTreeRoot.toBuffer(),
    input.historicalBlockData.publicDataTreeRoot.toBuffer(),
    input.historicalBlockData.globalVariablesHash.toBuffer(),
