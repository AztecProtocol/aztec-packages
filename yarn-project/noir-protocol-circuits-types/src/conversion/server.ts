...
import type {
  ...
  BigCurve,
  BigNum, // BlobCommitment as BlobCommitmentNoir,
 ...
 * @returns The number
 */
export function mapBLS12FrFromNoir(bignum: BigNum<3>): BLS12Fr {
  return BLS12Fr.fromNoirBigNum(bignum);
}

export function mapBLS12FrToNoir(number: BLS12Fr): BigNum<3> {
  // TODO(MW): Cleanup
  return {
    limbs: assertLength(number.toNoirBigNum().limbs, 3),
  };
}
 ...
 * @returns The number
 */
export function mapBLS12FqFromNoir(bignum: BigNum<4>): BLS12Fq {
  return BLS12Fq.fromNoirBigNum(bignum);
}

export function mapBLS12FqToNoir(number: BLS12Fq): BigNum<4> {
  // TODO(MW): Cleanup
  return {
    limbs: assertLength(number.toNoirBigNum().limbs, 4),
  };
}
...
export function mapBlobAccumulatorPublicInputsToNoir(
  ...
  return {
    v: mapFieldToNoir(blobPublicInputs.v),
...
export function mapBlobAccumulatorPublicInputsFromNoir(
  ...
  return new BlobAccumulatorPublicInputs(
    mapFieldFromNoir(blobPublicInputs.v),
...
export function mapFinalBlobAccumulatorPublicInputsFromNoir(
  ...
  return new FinalBlobAccumulatorPublicInputs(
    mapFieldFromNoir(finalBlobPublicInputs.v),
    mapFieldFromNoir(finalBlobPublicInputs.z),
    mapBLS12FrFromNoir(finalBlobPublicInputs.y),
    mapBLS12PointFromNoir({ x: finalBlobPublicInputs.c[0], y: finalBlobPublicInputs.c[1], is_infinity: false }),
  );
}
