...
export function mapCombinedAccumulatedDataFromNoir(
  ...
  return new CombinedAccumulatedData(
    ...
    mapTupleFromNoir(combinedAccumulatedData.unencrypted_logs, MAX_UNENCRYPTED_LOGS_PER_TX, mapScopedLogHashFromNoir),
...
export function mapCombinedAccumulatedDataToNoir(
  ...
  return {
    ...
    unencrypted_logs: mapTuple(combinedAccumulatedData.unencryptedLogsHashes, mapScopedLogHashToNoir),
