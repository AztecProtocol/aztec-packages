...
import EmptyNestedSimulatedJson from '../artifacts/empty_nested.json' assert { type: 'json' };
...
import PrivateKernelEmptySimulatedJson from '../artifacts/private_kernel_empty.json' assert { type: 'json' };
import PrivateKernelInitJson from '../artifacts/private_kernel_init.json' assert { type: 'json' };
import PrivateKernelInitSimulatedJson from '../artifacts/private_kernel_init.json' assert { type: 'json' };
import PrivateKernelInnerJson from '../artifacts/private_kernel_inner.json' assert { type: 'json' };
import PrivateKernelInnerSimulatedJson from '../artifacts/private_kernel_inner.json' assert { type: 'json' };
import PrivateKernelResetJson from '../artifacts/private_kernel_reset.json' assert { type: 'json' };
import PrivateKernelResetSimulatedJson from '../artifacts/private_kernel_reset.json' assert { type: 'json' };
import PrivateKernelResetBigJson from '../artifacts/private_kernel_reset_big.json' assert { type: 'json' };
import PrivateKernelResetBigSimulatedJson from '../artifacts/private_kernel_reset_big.json' assert { type: 'json' };
import PrivateKernelResetMediumJson from '../artifacts/private_kernel_reset_medium.json' assert { type: 'json' };
import PrivateKernelResetMediumSimulatedJson from '../artifacts/private_kernel_reset_medium.json' assert { type: 'json' };
import PrivateKernelResetSmallSimulatedJson from '../artifacts/private_kernel_reset_small.json' assert { type: 'json' };
import PrivateKernelResetSmallJson from '../artifacts/private_kernel_reset_small.json' assert { type: 'json' };
import PrivateKernelResetTinySimulatedJson from '../artifacts/private_kernel_reset_tiny.json' assert { type: 'json' };
...
import PrivateKernelTailSimulatedJson from '../artifacts/private_kernel_tail.json' assert { type: 'json' };
import PrivateKernelTailToPublicJson from '../artifacts/private_kernel_tail_to_public.json' assert { type: 'json' };
import PrivateKernelTailToPublicSimulatedJson from '../artifacts/private_kernel_tail_to_public.json' assert { type: 'json' };
import PublicKernelAppLogicJson from '../artifacts/public_kernel_app_logic.json' assert { type: 'json' };
import PublicKernelAppLogicSimulatedJson from '../artifacts/public_kernel_app_logic.json' assert { type: 'json' };
import PublicKernelSetupJson from '../artifacts/public_kernel_setup.json' assert { type: 'json' };
import PublicKernelSetupSimulatedJson from '../artifacts/public_kernel_setup.json' assert { type: 'json' };
import PublicKernelTailJson from '../artifacts/public_kernel_tail.json' assert { type: 'json' };
import PublicKernelTailSimulatedJson from '../artifacts/public_kernel_tail.json' assert { type: 'json' };
import PublicKernelTeardownJson from '../artifacts/public_kernel_teardown.json' assert { type: 'json' };
import PublicKernelTeardownSimulatedJson from '../artifacts/public_kernel_teardown.json' assert { type: 'json' };
import BaseRollupJson from '../artifacts/rollup_base.json' assert { type: 'json' };
import BaseRollupSimulatedJson from '../artifacts/rollup_base.json' assert { type: 'json' };
