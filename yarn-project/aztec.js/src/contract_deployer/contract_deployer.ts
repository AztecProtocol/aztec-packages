...
export class ContractDeployer {
  constructor(private abi: ContractAbi, private arc: PXE, private publicKey?: PublicKey) {}
   ...
   * @returns A DeployMethod instance configured with the ABI, PXEClient, and constructor arguments.
   */
