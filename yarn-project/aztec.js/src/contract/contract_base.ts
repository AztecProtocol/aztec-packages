...
export class ContractBase {
   ...
   * The function will return a promise that resolves when all contracts have been added to the PXEClient.
   ...
   * @returns A promise that resolves when all contracts are successfully added to the PXEClient.
   */
