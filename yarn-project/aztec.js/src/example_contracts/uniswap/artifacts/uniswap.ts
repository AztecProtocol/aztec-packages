...
const UniswapContractAbi = UniswapJson as ContractAbi;
...
export class UniswapContract extends ContractBase {
  ...
  public static async create(
    ...
    return new UniswapContract(address, wallet);
  }
  ...
  public static deploy(rpc: AztecRPC) {
    return new DeployMethod<UniswapContract>(Point.ZERO, rpc, UniswapContractAbi, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKey(rpc: AztecRPC, publicKey: PublicKey) {
    return new DeployMethod<UniswapContract>(publicKey, rpc, UniswapContractAbi, Array.from(arguments).slice(2));
  }
