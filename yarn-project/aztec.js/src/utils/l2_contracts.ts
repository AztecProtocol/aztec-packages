 ...
 * @param aztecRpcClient - The PXE client to use to obtain the information.
 * @param contractAddress - The address of the contract to check.
 * @returns A flag indicating whether the contract is deployed.
 */
export async function isContractDeployed(aztecRpcClient: PXE, contractAddress: AztecAddress): Promise<boolean> {
