  ...
  libraries: {
    ...
    libraryCode: {
      ...
      ConsensusDeploymentExtLib: {
        name: 'ConsensusDeploymentExtLib',
        contractAbi: ConsensusDeploymentExtLibAbi,
        contractBytecode: ConsensusDeploymentExtLibBytecode as Hex,
      },
      EmpireDeploymentExtLib: {
        name: 'EmpireDeploymentExtLib',
        contractAbi: EmpireDeploymentExtLibAbi,
        contractBytecode: EmpireDeploymentExtLibBytecode as Hex,
      },
    },
  },
};
