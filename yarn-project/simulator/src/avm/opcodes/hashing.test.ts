...
describe('Hashing Opcodes', () => {
  ...
  describe('Poseidon2', () => {
    it('Should (de)serialize correctly', () => {
      ...
      const inst = new Poseidon2(/*indirect=*/ 1, /*dstOffset=*/ 0x12345678, /*hashOffset=*/ 0x23456789, /*hashSize=*/ 0x3456789a);
  ...
  describe('Keccak', () => {
    it('Should (de)serialize correctly', () => {
      ...
      const inst = new Keccak(/*indirect=*/1, /*dstOffset=*/ 0x12345678, /*hashOffset=*/ 0x23456789, /*hashSize=*/ 0x3456789a);
  ...
  describe('Sha256', () => {
    it('Should (de)serialize correctly', () => {
      ...
      const inst = new Sha256(/*indirect=*/1, /*dstOffset=*/ 0x12345678, /*hashOffset=*/ 0x23456789, /*hashSize=*/ 0x3456789a);
  ...
  describe('Pedersen', () => {
    it('Should (de)serialize correctly', () => {
      ...
      const inst = new Pedersen(/*indirect=*/ 1,/*dstOffset=*/ 0x12345678, /*hashOffset=*/ 0x23456789, /*hashSize=*/ 0x3456789a);
