...
export class Field extends MemoryValue {
  ...
  public add(rhs: Field): Field {
    return new Field(this.rep.add(new Fr(rhs.rep)));
  }
  ...
  public lt(rhs: Field): boolean {
    return this.rep.toBigInt() < rhs.rep.toBigInt();
  }

  public and(rhs: Field): Field {
    return new Field(this.rep.toBigInt() & rhs.rep.toBigInt());
  }
