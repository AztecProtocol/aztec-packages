...
export class AvmExecutionEnvironment {
  ...
  public deriveEnvironmentForNestedCall(address: AztecAddress, calldata: Fr[], temporaryFunctionSelector: FunctionSelector): AvmExecutionEnvironment {
  ...
  public deriveEnvironmentForNestedStaticCall(address: AztecAddress, calldata: Fr[], temporaryFunctionSelector: FunctionSelector): AvmExecutionEnvironment {
    return new AvmExecutionEnvironment(
      address,
      /*storageAddress=*/ address,
      this.origin,
  ...
  public newDelegateCall(address: AztecAddress, calldata: Fr[], temporaryFunctionSelector: FunctionSelector): AvmExecutionEnvironment {
    return new AvmExecutionEnvironment(
      address,
      this.storageAddress,
      this.origin,
