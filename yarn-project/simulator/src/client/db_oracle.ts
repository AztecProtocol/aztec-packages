import type { L2Block, MerkleTreeId, NoteStatus, PublicDataWitness, TxScopedL2Log } from '@aztec/circuit-types';
...
import type { FunctionArtifact, FunctionSelector } from '@aztec/circuits.js/abi';
