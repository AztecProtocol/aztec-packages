import { type AvmSimulator, AvmSimulatorPool, type AvmSimulatorPoolOptions } from './avm_simulator_pool.js';
 ...
 */
export class ForkedAvmSimulator implements AvmSimulator {
  constructor(
 ...
 * than the pair. Per-fork work goes through {@link forFork}, which hands out a {@link ForkedAvmSimulator} and
 * keeps the CDB server private.
 */
export class AvmExecutor implements AsyncDisposable {
  ...
  forFork(forkId: number, contractsDB: PublicContractsDB, timestamp: bigint): ForkedAvmSimulator {
