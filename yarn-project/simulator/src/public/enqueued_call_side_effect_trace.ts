...
export class PublicEnqueuedCallSideEffectTrace implements PublicSideEffectTraceInterface {
  ...
  public fork(incrementSideEffectCounter: boolean = false, additionalPreviousNullifiers = 0) {
    this.log.debug(`additionalPreviousNullifiers: ${additionalPreviousNullifiers}`);
    return new PublicEnqueuedCallSideEffectTrace(
      ...
      new PublicAccumulatedDataArrayLengths(
        ...
        this.previousAccumulatedDataArrayLengths.nullifiers + this.nullifiers.length + additionalPreviousNullifiers,
