...
import {
  ...
  type PublicTreesDBFactoryInterface,
} from '../public_db_sources.js';
...
describe('public_tx_simulator', () => {
  ...
  let treesDBFactory: PublicTreesDBFactoryInterface;
  ...
  beforeEach(async () => {
    ...
    treesDBFactory = new PublicTreesDBFactoryFromObject(new PublicTreesDB(merkleTrees)); // Non-hinting.
