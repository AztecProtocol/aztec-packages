...
import { AvmPersistableState } from '../avm/journal/index.js';
import {
...
import type { CommitmentsDB, NullifiersDB, PublicContractsDB, PublicStateDB } from './db.js';
...
export class PublicExecutor {
  ...
  public async simulateAvm(
    ...
    const worldStateJournal = new AvmPersistableState(hostStorage);
    ...
    const newWorldState = context.worldState.getWorldStateAccessTrace();
