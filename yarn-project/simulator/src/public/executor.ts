...
export class PublicExecutor {
   ...
   * @param prevArrayLengths - Side effect array lengths from previous kernel.
  ...
  public async simulate(
    ...
    prevArrayLengths: PublicKernelAccumulatedArrayLengths = PublicKernelAccumulatedArrayLengths.empty(),
    ...
    const enqueuedCallTrace = new PublicEnqueuedCallSideEffectTrace(startSideEffectCounter, prevArrayLengths);
