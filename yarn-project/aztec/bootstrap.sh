...
function test_cmds {
  ...
  # Pure deploy-graph scheduling tests: no network/toolchain, safe in the fast gate. The heavier
  # deploy integration suite spins up a local network and is run on demand, not here.
