...
Additional commands:
  ...
  init [options]           creates a new Aztec Noir workspace in the current directory.
  new <name> [options]     creates a new Aztec Noir workspace in its own directory (or creates a new contract-test crates pair and adds it to the current workspace if run in workspace).
