...
export const alphaTestnetL2ChainConfig: L2ChainConfig = {
  ...
  slashProposeInvalidAttestationsPenalty: DefaultL1ContractsConfig.depositAmount,
  slashProposeInvalidAttestationsMaxPenalty: DefaultL1ContractsConfig.depositAmount,
  slashAttestDescendantOfInvalidPenalty: DefaultL1ContractsConfig.depositAmount,
  slashAttestDescendantOfInvalidMaxPenalty: DefaultL1ContractsConfig.depositAmount,
