...
async function deployCanonicalKeyRegistry(deployer: Wallet) {
  ...
  if (
    ...
    !(keyRegistry.address.equals(AztecAddress.fromBigInt(CANONICAL_KEY_REGISTRY_ADDRESS)) || keyRegistry.address.equals(AztecAddress.fromString('0x1e0e3e49b5af1fd9c81de11004797d0150d7025fd634550ce5460169d1defab6')))
  ) {
    throw new Error(
