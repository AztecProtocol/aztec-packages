...
async function executePrivateKernelInitWithACVM(input: InitInputType): Promise<ReturnType> {
  const initialWitnessMap = abiEncode(PrivateKernelInitSimulatedJson.abi as any, input as any);
  ...
  const decodedInputs: DecodedInputs = abiDecode(PrivateKernelInitSimulatedJson.abi as any, _witnessMap);
...
async function executePrivateKernelInnerWithACVM(input: InnerInputType): Promise<ReturnType> {
  const initialWitnessMap = abiEncode(PrivateKernelInnerSimulatedJson.abi as any, input as any);
  ...
  // Decode the witness map into two fields, the return values and the inputs
  const decodedInputs: DecodedInputs = abiDecode(PrivateKernelInnerSimulatedJson.abi as any, _witnessMap);
...
async function executePrivateKernelOrderingWithACVM(input: OrderingInputType): Promise<FinalReturnType> {
  const initialWitnessMap = abiEncode(PrivateKernelOrderingSimulatedJson.abi as any, input as any);
  ...
  // Decode the witness map into two fields, the return values and the inputs
  const decodedInputs: DecodedInputs = abiDecode(PrivateKernelOrderingSimulatedJson.abi as any, _witnessMap);
...
async function executePublicKernelPrivatePreviousWithACVM(
  ...
  const initialWitnessMap = abiEncode(PublicKernelPrivatePreviousSimulatedJson.abi as any, input as any);
  ...
  // Decode the witness map into two fields, the return values and the inputs
  const decodedInputs: DecodedInputs = abiDecode(PublicKernelPrivatePreviousSimulatedJson.abi as any, _witnessMap);
  // Cast the inputs as the return type
...
async function executePublicKernelPublicPreviousWithACVM(
  ...
  const initialWitnessMap = abiEncode(PublicKernelPublicPreviousSimulatedJson.abi as any, input as any);
  ...
  // Decode the witness map into two fields, the return values and the inputs
  const decodedInputs: DecodedInputs = abiDecode(PublicKernelPublicPreviousSimulatedJson.abi as any, _witnessMap);
...
async function executeRootRollupWithACVM(input: RootRollupInputType): Promise<RootRollupReturnType> {
  const initialWitnessMap = abiEncode(RootRollupJson.abi as any, input as any);
  ...
  // Decode the witness map into two fields, the return values and the inputs
  const decodedInputs: DecodedInputs = abiDecode(RootRollupJson.abi as any, _witnessMap);
...
async function executeMergeRollupWithACVM(input: MergeRollupInputType): Promise<MergeRollupReturnType> {
  const initialWitnessMap = abiEncode(MergeRollupJson.abi as any, input as any);
  ...
  // Decode the witness map into two fields, the return values and the inputs
  const decodedInputs: DecodedInputs = abiDecode(MergeRollupJson.abi as any, _witnessMap);
...
async function executeBaseRollupWithACVM(input: BaseRollupInputType): Promise<BaseRollupReturnType> {
  const initialWitnessMap = abiEncode(BaseRollupJson.abi as any, input as any);
  ...
  // Decode the witness map into two fields, the return values and the inputs
  const decodedInputs: DecodedInputs = abiDecode(BaseRollupJson.abi as any, _witnessMap);
