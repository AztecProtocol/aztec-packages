...
import { ContractDatabase, ContractNoteHashProvider } from '@aztec/types';
...
export class ContractDataOracle {
  ...
  constructor(private db: ContractDatabase, private contractNoteHashProvider: ContractNoteHashProvider) {}
  ...
  private async getTree(contractAddress: AztecAddress) {
    ...
    if (!tree) {
      ...
      tree = new ContractTree(contract, this.contractNoteHashProvider, wasm);
