...
describe('ACIR simulator', () => {
  ...
  describe('empty constructor', () => {
    const historicRoots = new PrivateOldTreeRoots(new Fr(0n), new Fr(0n), new Fr(0n), new Fr(0n));
  ...
  describe('zk token contract', () => {
    ...
    it('should run the transfer function', async () => {
      ...
      const historicRoots = new PrivateOldTreeRoots(Fr.fromBuffer(tree.getRoot(false)), new Fr(0n), new Fr(0n), new Fr(0n));
