...
import { Opcode, OperandPair, OperandType, deserialize, serialize } from "../serialization/instruction_serialization.js";
...
export abstract class TwoOperandInstruction extends Instruction {
    ...
    ): ConstructorParameters<typeof TwoOperandInstruction> {
...
export abstract class ThreeOperandInstruction extends Instruction {
    ...
    protected static deserializeBase(
      buf: BufferCursor | Buffer,
    ): ConstructorParameters<typeof ThreeOperandInstruction> {
