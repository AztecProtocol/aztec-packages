import { CircuitsWasm, ConstantBlockHashData, FunctionData, PrivateHistoricTreeRoots, PrivateKey } from '@aztec/circuits.js';
...
describe('Unconstrained Execution test suite', () => {
  ...
  describe('zk token contract', () => {
    ...
    it('should run the getBalance function', async () => {
      ...
      const constantBlockHashData = ConstantBlockHashData.empty();
