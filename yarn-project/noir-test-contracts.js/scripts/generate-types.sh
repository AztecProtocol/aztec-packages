...
TEST_CONTRACTS=$(grep "contracts/test/" ../../noir-projects/labs/noir-contracts/Nargo.toml | sed 's/.*\/\([^/"]*\)_contract.*/\1/')
...
echo "// Auto generated module - do not edit! (generated by $SCRIPT_PATH)" >"$INDEX"
