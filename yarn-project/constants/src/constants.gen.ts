...
export const CHONK_JOINT_PROOF_LENGTH = 504;
export const CHONK_PROOF_LENGTH = 1358;
export const ULTRA_VK_LENGTH_IN_FIELDS = 115;
export const MEGA_VK_LENGTH_IN_FIELDS = 163;
export const CHONK_VK_LENGTH_IN_FIELDS = 163;
...
export enum DomainSeparator {
  ...
  HANDSHAKE_SECRET_HASH = 3596796143,
