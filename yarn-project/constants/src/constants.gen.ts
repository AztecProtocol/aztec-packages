...
export const AVM_CIRCUIT_PUBLIC_INPUTS_LENGTH = 4997;
...
export const AVM_PUBLIC_INPUTS_AVM_ACCUMULATED_DATA_PUBLIC_DATA_WRITES_ROW_IDX = 4608;
export const AVM_PUBLIC_INPUTS_TRANSACTION_FEE_ROW_IDX = 4672;
export const AVM_PUBLIC_INPUTS_REVERTED_ROW_IDX = 4673;
export const AVM_PUBLIC_INPUTS_COLUMNS_MAX_LENGTH = 4674;
export const AVM_NUM_PUBLIC_INPUT_COLUMNS = 4;
export const AVM_PUBLIC_INPUTS_COLUMNS_COMBINED_LENGTH = 18696;
