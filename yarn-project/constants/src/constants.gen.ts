...
export const BLS12_FR_SERIALIZED_FIELDS = 2;
export const BLS12_FQ_SERIALIZED_FIELDS = 2;
export const BLS12_POINT_LENGTH = 9;
export const BLS12_POINT_SERIALIZED_LENGTH = 5;
export const BLS12_POINT_COMPRESSED_BYTES = 48;
export const BLOB_ACCUMULATOR_LENGTH = 12;
export const FINAL_BLOB_BATCHING_CHALLENGES_LENGTH = 3;
...
export const CHECKPOINT_ROLLUP_PUBLIC_INPUTS_LENGTH = 136;
