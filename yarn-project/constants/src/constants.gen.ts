...
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 854;
...
export const PRIVATE_VALIDATION_REQUESTS_LENGTH = 707;
...
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2809;
