...
export const BLS12_POINT = 8;
export const BLOB_ACCUMULATOR_PUBLIC_INPUTS = 17;
export const BLOCK_BLOB_PUBLIC_INPUTS = 38;
...
export const BLOCK_ROOT_OR_BLOCK_MERGE_PUBLIC_INPUTS_LENGTH = 206;
