...
export const GENESIS_BLOCK_HEADER_HASH = 6551417544883665873456328017782433997345264442591862482015827744892259451090n;
export const GENESIS_ARCHIVE_ROOT = 10619256997260439436842531499967995403253967496480475679746178797053672406517n;
...
export const DEFAULT_MSPK_M_X = 376604625977751683916174973150925911104291823095102990065366659597425722296n;
export const DEFAULT_MSPK_M_Y = 6401736487141786437369922081657103422778081213225821992340733703460199150021n;
export const DEFAULT_FBPK_M_X = 11572348468544340050763207926758553848489417025671995953147359609999720016266n;
export const DEFAULT_FBPK_M_Y = 11774107091164614768010125692190151838649080987589360468021169521798921524563n;
export const DEFAULT_NPK_M_HASH = 9490941203163884203266873379528043162885952552009707050511473783876867365414n;
export const DEFAULT_OVPK_M_HASH = 6503635668323258394266152634006889881423098283582185344306514598322956522059n;
export const DEFAULT_TPK_M_HASH = 3696996950890211715833095099359687729113787313245035143274671977290400579312n;
export const DEFAULT_MSPK_M_HASH = 9339255027081995322829531434846677508514443987752207871815765570767379563350n;
export const DEFAULT_FBPK_M_HASH = 6817041416194035981444514907304573239615033139388669881213007796289638159510n;
...
export const CONTRACT_INSTANCE_LENGTH = 12;
...
export const KEY_VALIDATION_REQUEST_LENGTH = 2;
export const KEY_VALIDATION_REQUEST_AND_GENERATOR_LENGTH = 3;
export const SCOPED_KEY_VALIDATION_REQUEST_AND_GENERATOR_LENGTH = 4;
...
export const PRIVATE_VALIDATION_REQUESTS_LENGTH = 643;
...
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2745;
...
export const CHONK_ECCVM_PROOF_LENGTH = 612;
export const CHONK_JOINT_PROOF_LENGTH = 477;
export const CHONK_PROOF_LENGTH = 1271;
export const ULTRA_VK_LENGTH_IN_FIELDS = 115;
export const MEGA_APP_VK_LENGTH_IN_FIELDS = 147;
export const MEGA_KERNEL_VK_LENGTH_IN_FIELDS = 139;
export const MEGA_ZK_VK_LENGTH_IN_FIELDS = 115;
export const CHONK_VK_LENGTH_IN_FIELDS = 115;
...
export const AVM_V2_PROOF_LENGTH_IN_FIELDS = 15516;
...
export const MAX_PROCESSABLE_L2_GAS = 6540000;
...
export const L2_GAS_PER_CONTRACT_CLASS_LOG = 73000;
...
export const AVM_SENDL2TOL1MSG_BASE_L2_GAS = 5239;
...
export enum DomainSeparator {
  ...
  SINGLE_USE_CLAIM_NULLIFIER = 1465998995,
  ...
  NULLIFIER_MERKLE = 1157584160,
  PUBLIC_DATA_MERKLE = 3756303423,
  WRITTEN_SLOTS_MERKLE = 2292766212,
  RETRIEVED_BYTECODES_MERKLE = 2789215184,
  PRIVATE_FUNCTION_LEAF = 1389398688,
  PUBLIC_BYTECODE = 260313585,
  CONTRACT_CLASS_ID = 3923495515,
  SALTED_INITIALIZATION_HASH = 2763052992,
  ...
  CONTRACT_ADDRESS_V2 = 4099338721,
  ...
  APP_SILOED_ECDH_SHARED_SECRET = 1707851664,
  ECDH_SUBKEY = 4277646631,
  ECDH_FIELD_MASK = 190532684,
  PARTIAL_NOTE_VALIDITY_COMMITMENT = 623934423,
  INITIALIZATION_NULLIFIER = 1653084894,
  PUBLIC_INITIALIZATION_NULLIFIER = 3342006647,
  PRIVATE_INITIALIZATION_NULLIFIER = 3990889078,
  SECRET_HASH = 4199652938,
  TX_NULLIFIER = 1025801951,
  SIGNATURE_PAYLOAD = 463525807,
  BLOCK_HEADERS_HASH = 515582467,
  BLOB_HASHED_Y_LIMBS = 2949331415,
  BLOB_CHALLENGE_Z = 60345710,
  BLOB_Z_ACC = 1003392952,
  BLOB_GAMMA_ACC = 855632775,
  BLOB_GAMMA_FINAL = 1755883835,
}