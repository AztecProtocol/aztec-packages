...
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 908;
...
export const ROOT_ROLLUP_PUBLIC_INPUTS_LENGTH = 169;
...
export const AVM_PUBLIC_INPUTS_FLATTENED_SIZE = 2956;
