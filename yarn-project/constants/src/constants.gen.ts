...
export const PRIVATE_BASE_ROLLUP_VK_INDEX = 8;
export const PUBLIC_BASE_ROLLUP_VK_INDEX = 9;
export const MERGE_ROLLUP_VK_INDEX = 10;
...
export const ROOT_ROLLUP_INDEX = 21;
export const BASE_PARITY_INDEX = 22;
export const ROOT_PARITY_INDEX = 23;
