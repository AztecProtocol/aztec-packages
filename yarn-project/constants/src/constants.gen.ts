...
export const AVM_WRITTEN_PUBLIC_DATA_SLOTS_TREE_INITIAL_ROOT = 16294253357586578699891070730036964647020889873159742368897802463194356053179n;
export const AVM_WRITTEN_PUBLIC_DATA_SLOTS_TREE_INITIAL_SIZE = 1;
export const AVM_RETRIEVED_BYTECODES_TREE_HEIGHT = 5;
export const AVM_RETRIEVED_BYTECODES_TREE_INITIAL_ROOT = 18083610354539710303825988071889581522377897276274433324796818188631608225255n;
