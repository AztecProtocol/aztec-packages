...
export const HIDING_KERNEL_IO_PUBLIC_INPUTS_SIZE = 34;
...
export const CHONK_PROOF_LENGTH = 1400;
...
export const PROOF_TYPE_ULTRA_GOBLIN = 10;
export const PROOF_TYPE_GOBLIN = 11;
