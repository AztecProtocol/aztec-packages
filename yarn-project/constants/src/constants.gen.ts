...
export const HIDING_KERNEL_IO_PUBLIC_INPUTS_SIZE = 16;
...
export const CHONK_PROOF_LENGTH = 1566;
export const ULTRA_VK_LENGTH_IN_FIELDS = 115;
export const MEGA_VK_LENGTH_IN_FIELDS = 35;
export const CHONK_VK_LENGTH_IN_FIELDS = 35;
