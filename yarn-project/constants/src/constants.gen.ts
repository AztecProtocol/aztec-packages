...
export const PRIVATE_KERNEL_RESET_INDEX = 23;
...
export const GLOBAL_INDEX_PRIVATE_CALL_REQUEST_OFFSET = 64;
export const GLOBAL_INDEX_PUBLIC_CALL_REQUEST_OFFSET = 72;
export const GLOBAL_INDEX_L2_TO_L1_MSG_OFFSET = 104;
export const GLOBAL_INDEX_PRIVATE_LOG_OFFSET = 112;
export const GLOBAL_INDEX_CONTRACT_CLASS_LOG_HASH_OFFSET = 128;
export const GLOBAL_INDEX_CONTRACT_MIN_REVERTIBLE_SIDE_EFFECT_COUNTER_OFFSET = 129;
export const TOTAL_COUNTED_SIDE_EFFECTS_PER_CALL = 130;
...
export const AVM_V2_PROOF_LENGTH_IN_FIELDS_PADDED = 16500;
