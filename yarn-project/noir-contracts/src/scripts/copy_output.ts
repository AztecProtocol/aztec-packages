...
const PROJECT_CONTRACTS = [
  { name: 'SchnorrSingleKeyAccount', target: '../aztec.js/src/abis/', exclude: ['verificationKey'] },
  { name: 'SchnorrMultiKeyAccount', target: '../aztec.js/src/abis/', exclude: ['verificationKey'] },
  { name: 'EcdsaAccount', target: '../aztec.js/src/abis/', exclude: ['verificationKey'] },
];
