...
import TouchIdAccountContractJson from './touch_id_account_contract.json' assert { type: 'json' };
...
export const TouchIdAccountContractAbi = TouchIdAccountContractJson as ContractAbi;
