...
- `noir-projects/aztec-nr/standard_addresses/src/lib.nr` — `AUTH_REGISTRY_ADDRESS` (Noir global)
- `yarn-project/standard-contracts/src/auth-registry/address.gen.ts` — TS twin
