import { BLOBS_PER_BLOCK, BLOB_ACCUMULATOR_PUBLIC_INPUTS, BLOB_PUBLIC_INPUTS } from '@aztec/constants';
...
import { BatchedBlob, BatchedBlobAccumulator } from './blob_batching.js';
import {
...
describe('FinalBlobAccumulatorPublicInputs', () => {
  ...
  it('converts correctly from BatchedBlob class', async () => {
    ...
    expect(converted.v).toEqual(batched.v);
