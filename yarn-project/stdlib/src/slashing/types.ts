...
export enum OffenseType {
  ...
  PROPOSED_DESCENDANT_OF_INVALID = 7,
...
export function getOffenseTypeName(offense: OffenseType) {
  switch (offense) {
    ...
    case OffenseType.PROPOSED_DESCENDANT_OF_INVALID:
      return 'proposed_descendant_of_invalid';
...
export const OffenseToBigInt: Record<OffenseType, bigint> = {
  ...
  [OffenseType.PROPOSED_DESCENDANT_OF_INVALID]: 7n,
...
export function bigIntToOffense(offense: bigint): OffenseType {
  switch (offense) {
    ...
    case 7n:
      return OffenseType.PROPOSED_DESCENDANT_OF_INVALID;
    case 8n:
