...
export class Tx extends Gossipable {
  ...
  constructor(
     ...
     */
    public contractClassLogPreimages: ContractClassLogFields[],
    /**
  ...
  toBuffer() {
    return serializeToBuffer([
      this.data,
      this.clientIvcProof,
      serializeArrayOfBufferableToVector(this.contractClassLogPreimages, 1),
  ...
  static get schema(): ZodFor<Tx> {
    return z
      .object({
        ...
        contractClassLogPreimages: z.array(ContractClassLogFields.schema),
  ...
  static from(fields: FieldsOf<Tx>) {
    return new Tx(fields.data, fields.clientIvcProof, fields.contractClassLogPreimages, fields.publicFunctionCalldata);
  }
  ...
  async filterContractClassLogs(logHashes: ScopedLogHash[], silo: boolean = false): Promise<ContractClassLog[]> {
    ...
    for (const fields of this.contractClassLogPreimages) {
  ...
  getSize() {
    return (
      ...
      arraySerializedSizeOfNonEmpty(this.contractClassLogPreimages) +
  ...
  static clone(tx: Tx): Tx {
    ...
    const contractClassLogs = tx.contractClassLogPreimages.map(p => p.clone());
  ...
  public async filterRevertedLogs() {
    this.contractClassLogPreimages = (await this.getSplitContractClassLogs(false)).map(log => log.fields);
  }
