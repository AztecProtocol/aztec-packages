...
import { DelayedPublicMutableValues, SHARED_MUTABLE_VALUES_LEN } from './delayed_public_mutable_values.js';
...
export class DelayedPublicMutableValuesWithHash {
  ...
  static async getContractUpdateSlots(contractAddress: AztecAddress) {
    ...
    const delayedPublicMutableHashSlot = delayedPublicMutableSlot.add(new Fr(SHARED_MUTABLE_VALUES_LEN));
