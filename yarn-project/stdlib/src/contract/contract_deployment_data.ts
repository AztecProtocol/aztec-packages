...
export class ContractDeploymentData {
  constructor(
    private readonly contractClassLogs: ContractClassLog[],
    private readonly privateLogs: PrivateLog[],
  ) {}
  ...
  public static get schema() {
    return z
      ...
      .transform(({ contractClassLogs, privateLogs }) => new ContractDeploymentData(contractClassLogs, privateLogs));
  }
}
...
export class AllContractDeploymentData {
  constructor(
    private readonly nonRevertibleContractDeploymentData: ContractDeploymentData,
    private readonly revertibleContractDeploymentData: ContractDeploymentData,
  ) {}
