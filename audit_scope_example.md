...
12. `stdlib_circuit_builders/ultra_circuit_builder.cpp` (**limit to methods:** `create_ecc_add_gate()`, `create_ecc_dbl_gate()`)
13. `relations/elliptic_relation.hpp`
14. `dsl/acir_format/ec_operations.hpp`
15. `dsl/acir_format/ec_operations.cpp`
16. `dsl/acir_format/multi_scalar_mul.hpp`
17. `dsl/acir_format/multi_scalar_mul.cpp`
18. `dsl/acir_format/witness_constant.hpp`
19. `dsl/acir_format/witness_constant.cpp`
